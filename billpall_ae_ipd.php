...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eid' and status in ('RECEIVED','SEEN','DONE') order by `id` DESC;";
...
$inves = "SELECT SUM(price) FROM einves where pmrn='$pmrn' and eid='$eid' and status in ('RECEIVED','SEEN','DONE')"; 
...
<input type="hidden" name="room_charge" value="<?php echo '3000';?>">
