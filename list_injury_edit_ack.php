...
$sel_query="Select * from injury where estatus= 'Waiting For Acknowledgement' order by id desc;";
 $count=1;	 
...
<a target='_blank' href="injuryedit_ack.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>">Acknowledge Injury Certificate</a>
</td>
  ...
  $sel_query="Select * from injury where status= 'Waiting For Acknowledgement' order by id desc;";
   $count=1;	 
  $result = mysqli_query($con,$sel_query);
  ...
  <td colspan="2"align="center">
  <a target='_blank' href="injuryedit_ack_1.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>">Acknowledge Injury Certificate</a>
  </td>
