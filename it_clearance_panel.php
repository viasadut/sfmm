...
<p align="center" class="style1">IT Clearance Panel</p> 
...
<th width="5%"><strong>Clearance</strong> 
	   </tr>
  </thead>
  <tbody>
...
$count=1;
$sel_query="Select * from staff3 where clear='Clearance Requested'order by sid desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="it_clearance?sid=<?php echo $row["sid"]; ?>">Clearance</a> </td>
