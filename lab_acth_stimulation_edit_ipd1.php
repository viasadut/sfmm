...
<?php 
    ...
    $eid=$data['eid'];
    $iname=$data['medi'];
    $query5 = mysqli_query($con,"select * from lab_acth_stimulation where inid='$id'");
...
<?php
    ...
    $rr='S. Cortisol at 0 min:'.$min0."<br />".'S. Cortisol at 60 min:'.$min60."<br />".'Interpretation:'.$interpretation;
    $rr1='S. Cortisol at 0 min:'.$min0."<br />".'S. Cortisol at 60 min:'.$min60."<br />".'Interpretation:'.$interpretation;

    
    $ins_query1="UPDATE lab_acth_stimulation SET 
        `pname`='$pname',
        `pmrn`='$pmrn',
        `psex`='$psex',
        `page`='$page',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="0min" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['0min']?>" required>
            <label for="tibc"><strong>At 30 min:</strong></label>
            <input name="30min" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['30min']?>" required>
            <label for="tibc"><strong>At 60 min:</strong></label>
            <input name="60min" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['60min']?>" required>
            <label for="tibc"><strong>Interpretation:</strong></label>
            <textarea name="interpretation" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['interpretation']?>" required>
            </textarea>
        </fieldset>
        <table>
            <tr>
