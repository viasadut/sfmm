...
$url = "endochargenurse2_new?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
...
$url = "otcsendo_nurse.php?pmrn=$pmrn&dname=$dname&eeid=$eid";
header("Location: $url");
}
...
$url = "consent?pmrn=$pmrn&pro=$pro&eeid=$eid&dname=$dname";
header("Location: $url");
}
...
{
$url = "endochargenurse1?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
...
{
$url = "photo333?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "inassessmentnurseview1endo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "endodocnotenurse?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
...
{
$url = "idocmediendonurse?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>

<?php
if(isset($_POST['Submit690_mmd']))
{
$url = "photo333?pmrn=$pmrn&eid=$eid&pro=$pro";
header("Location: $url");
}
?>
...
{
$url = "idocinfusionendonurse?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "idocstretendonurse?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "anaesvitalsnurse?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
<?php
if(isset($_POST['Submit_inves']))
{
$url = "otcsendo_nurse?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
$url = "endonursenote?pmrn=$pmrn&ID=$ID";
header("Location: $url");
}
?>
<?php
...
$url = "endoreport2test1?ID=$ID&pmrn=$pmrn";
header("Location: $url");
}
?>
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="history11dochis?pmrn=<?php echo "$pmrn"; ?>"><b>Patient's Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="opdradreport?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Radiology Report<b></a>&nbsp;&nbsp;<a target='_blank' href="endoreportin?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Endoscopy Report<b></a>&nbsp;&nbsp<a target='_blank' href="http://192.168.100.254?pmrn=<?php echo "$pmrn"; ?>"><b>LAB REPORT<b></a></td></tr>
				...
				<tr>	  
				<td colspan="10"><input type="text" name="dname" value="<?php echo $data["dreffer"]; ?>"disabled></td>
				<td colspan="10"><input type="text" name="dname" value="<?php echo $data["anes"]; ?>"disabled></td>
				</tr>
...
<tr>				<td colspan="2"><input type="text" name="pmrn" value="<?php echo $data["pmrn"]; ?>"disabled> </td>
				...
				<td colspan="6"><input type="text" name="eid" value="<?php echo $data["tname"]; ?>"disabled> </td>
...
<td colspan="4" align="center"><button type="submit" name="Submit991">Histo Request</butto</td>
<td colspan="4" align="center"><button type="submit" name="Submit1001">Doctor Charges</button></td>
<td colspan="4" align="center"><button type="submit" name="photo">Upload Photo</button></td>		
...
<td colspan="4" align="center"><button type="submit" name="Submit_inves">Investigation Request</button></td>


</tr>
<tr>

<td colspan="4" align="center"><button type="submit" name="Submit690_mmd">Upload Image</button></td>
