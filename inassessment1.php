...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessment?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessment2?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
