...
$query21 = "SELECT COUNT(status) FROM conleavedetails where sname='$full' and  status='Approved By ALL'"; 
...
<tr><td colspan="20"align="center"bgcolor="lightgreen"><h3> Details of The Leave</h3></td></tr>

 <tr>
	
			<td colspan="20" align="left">Annual Leave - </a></td></tr>
	<td colspan="20" align="left">Training Leave - This leave will be deducted from Balance Annual Leave</a></td></tr>
	<td colspan="20" align="left">Conference Leave - This leave will be deducted from Balance Annual Leave</a></td></tr>
	<td colspan="20" align="left">Sick Leave - Maximum 14 Days, If requires More the balance will be deducted from Annual Leave..(Must Submit Medical Certificate)</a></td></tr>
	<td colspan="20" align="left">Maternity Leave - Maximum 60 Days</a></td></tr>
	<td colspan="20" align="left">Unpaid Leave - </a></td></tr>
