...
<!-- Form Title -->
      ...
      <input name="surine" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>pH, Urine:</strong></label>
      <input name="purine" type="text" size="70" style="text-transform:uppercase" value=""required>
      ...
      <input name="wurine" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>RBC, Urine:</strong></label>
      <input name="rurine" type="text" size="70" style="text-transform:uppercase" value="Nil"required>
	  <label for="age"><strong>Epithelial Cell, Urine:</strong></label>
      <input name="eurine" type="text" size="70" style="text-transform:uppercase" value=""required>
