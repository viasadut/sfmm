...
<tr>
      ...
      <td align="center"><strong>Account Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from pms_tb where date='2025-12-29' group by acct_code";
                    ...
                    while($row = mysqli_fetch_array($result) ){
                       ...
                       $acct_group=$row['acct_code'];
                        ...
                        $query2 = "select SUM(amount) FROM pms_tb WHERE trans_type='CR' and acct_code='$acct_group' and date='2025-12-29'"; 
                        $result2 = mysqli_query($con,$query2) or die ( mysqli_error());
                        
                        $data_cr = mysqli_fetch_array($result2);	   


                        $query1 = "select SUM(amount) FROM pms_tb WHERE trans_type='DR' and acct_code='$acct_group' and date='2025-12-29'"; 
                        $result1 = mysqli_query($con,$query1) or die ( mysqli_error());
                        
                        $data_dr = mysqli_fetch_array($result1);	

                       // $query3 = "select SUM(amount) FROM pms_tb WHERE trans_type='DR' and acct_code='0' and date='2025-12-29'"; 
                        ...
                        $querydr = "select COUNT(id) FROM pms_tb WHERE acct_code='$acct_group' and trans_type='DR' and date='2025-12-29'"; 
                        $resultdr = mysqli_query($con,$querydr) or die ( mysqli_error());
                        
                        $datadr = mysqli_fetch_array($resultdr);	   
                        $dr=$datadr['COUNT(id)'];

                        $querycr = "select COUNT(id) FROM pms_tb WHERE acct_code='$acct_group' and trans_type='CR' and date='2025-12-29'"; 
                        ...
                        else if($data22['acct_type']=='L')
{
     ...
     <td align="center" ><?php echo $count; ?></td>
      ...
      <td align="center" ><a href="report_tb_details?id=<?php echo $data22["acct_name"]; ?>"><?php echo $data22["acct_name"].' ('.$data22['acct_type'].')'; ?></a></td>
