            ...
            /* =========================
               ...
               ========================= */
                ...
                if($sno === ''){
                    ...
                    // get exact sno stock row (SNO wise)
                    ...
                    if(!$st){
                        ...
                        if($pdos > $stock_qty){
                            ...
                            try {
                                ...
                                // update purchase_stock3 (same sno + code + location)
...
// treat medical icu / surgicalicu as ICU style
else if(loc === "medical icu") $f.addClass("loc-icu");
else if(loc === "surgicalicu") $f.addClass("loc-icu");

// floors can use neutral style (no-stock style) unless you create css
else if(loc === "5th floor block ab") $f.addClass("loc-nostock");
else if(loc === "5th floor block cd") $f.addClass("loc-nostock");
else if(loc === "6th floor block (a+b)") $f.addClass("loc-nostock");
else if(loc === "6th floor block c") $f.addClass("loc-nostock");
else if(loc === "6th floor block d") $f.addClass("loc-nostock");

// other allowed places → neutral
...
function validateAddButton(){
  ...
  if(type === "STOCK"){
    ...
    if(!ALLOWED_STOCK_LOCS.includes(loc)){
      disable = true;
      reason = "Only CCU/ICU/NICU stock allowed";
...
$(function(){
  ...
  $("#chargeForm").on("submit", function(e){
    ...
    if(!ALLOWED_STOCK_LOCS.includes(loc)){
      e.preventDefault();
      alert("Only CCU/ICU/NICU stock can be issued from this form.");
      return false;
    }
