...
$rrd5=date('Y-m-d 23:59:59', strtotime('-2 days') );
...
$sel_query="Select * from ot where status='received' and dname='$full' and dnamestatus !='Written' and e_status='2' and e_req_app>='$rrd5'";
...
$sel_query="Select * from ot where status='received' and dname1='$full' and dname1status !='Written' and e_status='2' and e_req_app>='$rrd5' ";
...
$sel_query="Select * from ot where status='received' and dname2='$full' and dname2status !='Written' and e_status='2' and e_req_app>='$rrd5'";
...
$sel_query="Select * from ot where status='received' and dname3='$full' and dname2status !='Written' and e_status='2' and e_req_app>='$rrd5'";
...
$sel_query="Select * from ot where status='received' and dname4='$full' and dname2status !='Written' and e_status='2' and e_req_app>='$rrd5'";
...
$sel_query="Select * from ot where status='received' and nanes='$full' and e_status='2';";
...
$sel_query="Select * from ot where status='received' and anes2='$full' and e_status='2';";
...
$sel_query="Select * from ot where status='received' and anes3='$full' and e_status='2';";
...
$sel_query="Select * from ot where status='done' and dname='$full' and otdate='$date' and e_status='2';";
...
$sel_query="Select * from ot where status='done' and nanes='$full' and otdate='$date' and e_status='2';";
...
$sel_query="Select * from ot where status='done' and anes2='$full' and otdate='$date' and e_status='2';";
...
$sel_query="Select * from ot where status='done' and anes3='$full' and otdate='$date' and e_status='2';";
