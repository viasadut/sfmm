...
$update212="update endopapp set fname='$fname', mname='$mname', peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',nidcard='$nidcard',bcard='$bcard',vgcard='$vgcard',ocard='$ocard',wcard='$wcard',hcard='$hcard',fcard='$fcard',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Pending',pphone='$pphone',user='$user',scase='$scase',vpoor='$vpoor',aldate='$aldate',pvno='$pvno',pvdate='$pvdate',spcase='$spcase', qc='805',md='md',cfo='cfo',ceo='ceo',dd01='dd01',apstatus='Waiting For Finance Approval',dsign='$aid.jpg' where `ID`='$id'";
...
<!-- Form Title -->
	  ...
	  <input name="page" type="text" size="2"value="<?php echo $data59['page'];?>" placeholder="Age" required readonly/>
	  		...
	  		<label for="age"><strong>Patient's Diagnosis:</strong></label>
			  	...
			  	<textarea name="diagno" readonly><?php echo $data444['dia1'];?></textarea>
