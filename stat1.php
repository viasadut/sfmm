...
$query45 = mysqli_query($db,"select * from stat where pmrn='$pmrn' and id='$id'");
...
$update="update stat set dtime='$dtime',status='updated', udone='$user' where `id`='$id'";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>STAT MEDICATION</strong></label></td> </tr>
...
<td colspan="8" align="center"><label><strong>Infusion</strong></label></td> 
