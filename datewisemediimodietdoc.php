...
$count=1;
$sel_query="Select * from dietfollow where pmrn= '$pmrn' and eid='$eid' and odate BETWEEN '$start' and '$end';";
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="1"><a href="inmediadddiet?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&time=<?php echo $row["time"]; ?>&instruc=<?php echo $row["instruc"]; ?>&orderby=<?php echo $user; ?>&root=<?php echo $row["root"]; ?>&alert=<?php echo $row["alert"]; ?>">ADD</a></td>
      </tr>
