...
<body>
    ...
    <p align="center" class="style1">LAB INVESTIGATION STATS</p>
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198j_bed = "SELECT SUM(price) FROM alltest where type in('lab','LAB','Lab') and billdate between '$start' and '$end' and `billstatus`='Billed'"; 
...
$query198e = "SELECT SUM(price) FROM einves where type in('lab','LAB','Lab') and ndate between '$start' and '$end' and rstatus ='RECEIVED'"; 
	 //Select * from pappnew where adate= '$date' and `bill`='Billed' and status ='SEEN'
...
$query198i = "SELECT SUM(price) FROM iinves where type in('lab','LAB','Lab') and rdate between '$start' and '$end' and rstatus ='RECEIVED'"; 
	 //Select * from pappnew where adate= '$date' and `bill`='Billed' and status ='SEEN'
...
$test1i=	$row198i['SUM(price)'];
	...
	if(isset($_POST['bsearch'])){echo'
	<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>OPD-'.$test1c_bed.' BDT<br>A&E-'.$test1e.' BDT<br>IPD-'.$test1i.' BDT</strong></td></tr>
	
<tr><td colspan="20"><h1 align="center" >INVESTIGATION LIST(OPD)</h1></td></tr>    
	<tr>
...
$end=date('Y-m-d',strtotime($_REQUEST["endate"]));
                        ...
                        $count=1;
	$sel_query="Select * from alltest where type in('lab','LAB','Lab') and billdate between '$start' and '$end' and `billstatus`='Billed' order by `id` DESC;";
...
<?php if(isset($_POST['bsearch'])){echo'				
				<tr><td colspan="20"> <h1><align="center"style="background-color:lightgreen;">INVESTIGATION LIST(A&E)<h1></td></tr>
...
$count=1;
$sel_query="Select * from einves where type in('lab','LAB','Lab') and rstatus ='RECEIVED' and status ='RECEIVED' and ndate between '$start' and '$end'  order by `id` DESC;";
...
<tr><td colspan="20"> <h1><align="center"style="background-color:lightgreen;">INVESTIGATION LIST (IPD)<h1></td></tr>
...
$test=date('Y-m-d', strtotime('-30 days') );
$count=1;
$sel_query="Select * from iinves where type in('lab','LAB','Lab') and rstatus ='RECEIVED' and status ='RECEIVED' and rdate between '$start' and '$end'  order by `id` DESC;";
