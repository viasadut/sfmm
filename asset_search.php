...
$query44 = "SELECT COUNT(id) FROM storenew where etype='Asset' and estatus!='Deleted' and installdate between'$start' and '$end' ORDER BY id asc"; 
...
<h1 align="center">Asset Tracking Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="8%"><strong>Installation Date</strong>
...
$sel_query="Select * from storenew where etype='Asset' and estatus!='Deleted' and installdate between'$start' and '$end' ORDER BY id asc";
$count=1;
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["installdate"]; ?></td>
...
$ss=$row40['sname'];
   ...
   ?>
      ...
      <td align="center"><?php echo $row["trans_to"]; ?></td>
      
	  <td align="center"><?php echo $row["supplier"]; ?></td>
	  <td align="center"><?php echo $row["warrenty"]; ?></td>
	  <td align="center"><?php echo $row["p_by"]; ?></td>
...
<?php if($es!=$dd)
			...
			{ 
echo "<a target='_blank' href='$url5'>Details</a>";
...
<?php $count++; } }?>
            ...
            <td colspan ="7" align="right"><a target='_blank' href="asset_list_print?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
  </tbody>
</table>
