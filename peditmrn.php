...
$update="update patient set pmrn='$pmrn',pname='$name',padd='$padd',pphone='$pphone',page='$page',psex='$psex' where `ID`='$id'";
mysqli_query($con,$update) or die(mysql_error());

$update1="update pappnew set pmrn='$pmrn',pname='$name',padd='$padd',pphone='$pphone',page='$page',psex='$psex' where `pmrn`='$pmrn'";
mysqli_query($con,$update1) or die(mysql_error());

$update2="update presnew set pmrn='$pmrn',pname='$name',pphone='$pphone',page='$page',psex='$psex' where `pmrn`='$pmrn'";
mysqli_query($con,$update2) or die(mysql_error());

$update3="update inpatient set pmrn='$pmrn',pname='$name',padd='$padd',pphone='$pphone',age='$page',gender='$psex' where `pmrn`='$pmrn'";
mysqli_query($con,$update3) or die(mysql_error());


$update4="update emergency set pmrn='$pmrn',pname='$name',padd='$padd',pphone='$pphone',age='$page',gender='$psex' where `pmrn`='$pmrn'";
mysqli_query($con,$update4) or die(mysql_error());

$update5="update discharge1 set pmrn='$pmrn',pname='$name' where `pmrn`='$pmrn'";
mysqli_query($con,$update5) or die(mysql_error());

$update6="update idischarge1 set pmrn='$pmrn',pname='$name' where `pmrn`='$pmrn'";
mysqli_query($con,$update6) or die(mysql_error());

$update7="update bed set pmrn='$pmrn',pname='$name' where `pmrn`='$pmrn'";
mysqli_query($con,$update7) or die(mysql_error());


$update8="update preadm set pmrn='$pmrn',pname='$name' where `pmrn`='$pmrn'";
mysqli_query($con,$update8) or die(mysql_error());

$update8="update alltest set pmrn='$pmrn',pname='$name' where `pmrn`='$pmrn'";
mysqli_query($con,$update8) or die(mysql_error());
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Patient's Details :</strong></label>
            ...
            <input name="psex" type="text" size="15" style="text-transform:uppercase" value="<?php echo $data["psex"]; ?>">
            <input name="pmrn" type="text" size="15" style="text-transform:uppercase" value="<?php echo $data["pmrn"]; ?>">
      <input name="pphone" type="text" size="13" style="text-transform:uppercase" value="<?php echo $data["pphone"]; ?>">	  
	  <input name="page" type="text" size="11" style="text-transform:uppercase" value="<?php echo $data["page"]; ?>">
