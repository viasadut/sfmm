...
$query45 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and discharge='' ");
...
$url = "otidocblood?pmrn=$pmrn&id=$id&eid=$eid";
header("Location: $url");
}
...
$url = "endochargenurse2?pmrn=$pmrn&id=$id";
header("Location: $url");
}
...
$url = "noteviewdoc?id=$id&pmrn=$pmrn";
header("Location: $url");
}
?>
...
<td colspan="4" align="center"><button type="submit" name="Submit991">Histo Request</button></td>
