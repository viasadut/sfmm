...
{
$ins_query1="insert into promediused (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`code`,`adate`,`price`) 
...
{
$ins_query1="update promediused set pdos='$pdos2',price='$tprice2' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
{
$ins_query1="insert into promediused (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`reuse`,`adate`,`code`,`price`) values 
...
{
$ins_query1="update promediused set pdos='$pdos2',price='$new_charge_price1' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
