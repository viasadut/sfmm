...
<h1 align="center">Records of Investigation</h1>
...
$count=1;
$sel_query="Select * from iinvesstat where pmrn= '$pmrn' and infusion ='$infu' order by id desc;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="10"><?php echo $row["infusion"]; ?>
