...
$query43 = "SELECT COUNT(dname) FROM pappnew where dname= '$bt' and adate BETWEEN '$start' and '$end'and status in('NOT SEEN','HISTORY UPDATED');"; 
...
$query44 = "SELECT COUNT(dname) FROM pappnew where adate BETWEEN '$start' and '$end' and status in('NOT SEEN','HISTORY UPDATED');"; 
...
<h1 align="center">Number of Unseen OPD Patient Report</h1>
...
$sel_query="Select * from pappnew where  adate BETWEEN '$start' and '$end' and status in('NOT SEEN','HISTORY UPDATED') order by status asc";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pappnew where dname='$bt' and adate BETWEEN '$start' and '$end' and status in('NOT SEEN','HISTORY UPDATED') order by status asc";
 } 
$count=1;
