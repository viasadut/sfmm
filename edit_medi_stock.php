...
//$ins_query2="update medi_stock set `g_name`='$g_name',`b_name`='$b_name', `code`='$code', `exdate`='$exdate', `remarks`='$remarks', `code`='$code', `add_qty`='$add_qty', `p_stock`='$add_qty', `batch_no`='$batch_no', `p_by`='$user',`edit_time`='$ittime1',status='Served', edit_time='$ittime1', edit_by='$user' where id='$id'";
$ins_query2="update medi_stock set `g_name`='$g_name',`b_name`='$b_name', `code`='$code', `exdate`='$exdate', `remarks`='$remarks', `code`='$code', `batch_no`='$batch_no', `p_by`='$user',`edit_time`='$ittime1',status='Served', edit_time='$ittime1', edit_by='$user' where id='$id'";
...
<label for="age"><strong>Brand Name:</strong></label>						
		...
		<tr>				
						<td colspan="3"><input type="text" name="b_name" id="brand" required value="<?php echo $re['b_name'];?>" style="font-weight: bold;font-size:22px;color:green"></td>
		</tr>
...
<tr>
<td colspan="3" ><input type="text" name="add_qty" id="tqty" required value="<?php echo $re['add_qty'];?>"  style="font-weight: bold;font-size:22px;color:green"></td>

<label for="age"><strong>Batch No:</strong></label>	
<td colspan="3" ><input type="text" name="batch_no" id="" required value="<?php echo $re['batch_no'];?>" style="font-weight: bold;font-size:22px;color:green"></td>
      ...
      <input type="date" name="exdate" id="text" value="<?php echo $re['exdate'];?>" size="15" style="font-weight: bold;font-size:22px;color:green">
	  <tr>
	  
	  	  
	  	 <label for="age"><strong>Remarks:</strong></label>
      <input name="remarks" type="text" size="70" style="text-transform:uppercase" value="<?php echo $re['remarks'];?>"required>
	      </tr>  
  </fieldset>
