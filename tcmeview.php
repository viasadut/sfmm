...
<p align="center" class="style1">Todays  <?php echo $full; ?>'s In-Patients List </p> 
	...
	<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
	 ...
	 <tr>
	  ...
	  <th width="14%"><strong>Cast Attendance</strong>
...
$date= date('m/d/Y');
$count=1;
$sel_query1="Select * from cme where status='Approved'";
//$start=$row["aadate"];
...
while($row2 = mysqli_fetch_assoc($row1)) { ?>
      ...
      <td align="center"><?php echo $row2["topic"]; ?></a></td>
      <td align="center"><?php echo $row2["speaker"]; ?>
	  <td align="center"><?php echo $row2["date"]; ?>
      <td align="center"><?php echo $row2["time"]; ?>
      <td align="center"><?php echo $row2["venue"]; ?>  
	  <td align="center"><?php echo $row2["audience"]; ?>  
