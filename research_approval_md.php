...
$ins_query1="update research set status='$status',atime='$ortime',aby='$user',dis='$dis',pname='$mname',md_comment='$md_comment' where id='$id';";
...
<option value="Call For Presentation">Call For Presentation</option>
