...
$pbp1_e = implode(",",$_POST["pbp1_e"]);
$pbp1_c = implode(",",$_POST["pbp1_c"]);
...
$treat3=explode(',',$pbp1_e);
$treat4=explode(',',$pbp1_c);
//$treat2=explode(',',$pbp3);
...
$querycz = "SELECT COUNT(mor) FROM roaster_2 where date ='$r_date' and mor='$item' and emor='Early'"; 
$resultcz = mysqli_query($con, $querycz) or die(mysqli_error());
$rowcz = mysqli_fetch_array($resultcz);
$c1z=$rowcz['COUNT(mor)'];
...
$querycz = "SELECT COUNT(mor) FROM roaster_2 where date ='$r_date' and mor='$item' and emor='On-Call'"; 
$resultcz = mysqli_query($con, $querycz) or die(mysqli_error());
$rowcz = mysqli_fetch_array($resultcz);
$c1z=$rowcz['COUNT(mor)'];
...
<label>Late</label>  
						  <select type="text" name="pbp1_1[]" id="pbp1_1" multiple="multiple" class="3col active" required>
						<option value=""></option>
...
<label>Night</label>  
						  <select type="text" name="pbp1_2[]" id="pbp1_2" multiple="multiple" class="3col active" required>
						<option value=""></option>
