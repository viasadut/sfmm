...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="historynewdiet?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo $row["eid"]?>&date=<?php echo $row["date"]?>&dname=<?php echo "$full"?>"><b>Details<b></a></td>
