...
$query43 = "SELECT COUNT(dname) FROM pappnew where dname='Ms. Maisha Musharrat Nazia' and adate BETWEEN '$start' and '$end';"; 
...
$query44 = "SELECT COUNT(dname) FROM pappnew where dname='Ms. Maisha Musharrat Nazia' and dreffer='$bt' and adate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Consultant wise Diet Referral Stats</h1>
...
$sel_query="Select * from pappnew where dname='Ms. Maisha Musharrat Nazia' and adate BETWEEN '$start' and '$end' order by adate";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
$sel_query="Select * from pappnew where dname='Ms. Maisha Musharrat Nazia' and dreffer='$bt' and adate BETWEEN '$start' and '$end'order by adate";
 } 
$count=1;
