...
<p align="center" class="style1">Occupied Beds List</p> 
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='5A' and bed_status='Active' order by status asc";	
...
$pmrn=$row['pmrn'];
$query43 = "SELECT * FROM inpatient where pmrn= '$pmrn' order by id desc limit 1;"; 
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='5B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='5C' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='5D' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='6A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='6B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='6C' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='6D' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='7A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='7B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='7C' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='7D' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='ICU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='HDU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='CCU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='NICU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='Covid ICU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='Any Block' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='NC5A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Occupied') and block='NC5B' and bed_status='Active' order by status asc";	
