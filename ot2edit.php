...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
 ...
 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
		...
		<tr><td colspan="20"><select name="xl[]" multiple="multiple" class="3col active" placeholder="Select Procedure"value="<?php echo $row1['proce'];?> selected">
...
<tr><td colspan="20"><input type="text" name="Indication" value="<?php echo $row1['Indication'];?>"</td>  </tr>
<tr><td colspan="20"><label><strong>Prep and Drape::</strong></label></td></tr>	
<tr><td colspan="20"><input type="text" name="prep" value="<?php echo $row1['prep'];?>"</td>  </tr>
<tr><td colspan="20"><label><strong>Incision/port placement:</strong></label></td></tr>	
<tr><td colspan="20"><input type="text" name="incision" value="<?php echo $row1['incision'];?>"</td>  </tr>
<tr><td colspan="20"><label><strong>Findings:</strong></label></td></tr>	
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="findings" rows="5"><?php echo $row1['findings'];?></textarea></td>  </tr>
<tr><td colspan="20"><label><strong>Procedure:</strong></label></td></tr>	
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="procedure2" rows="5"><?php echo $row1['procedure2'];?></textarea></td>  </tr>
<tr><td colspan="20"><label><strong>Peroperative complications:</strong></label></td></tr>	
<tr><td colspan="20"><input type="text" name="peroperative" value="<?php echo $row1['peroperative'];?>"</td>  </tr>
<tr><td colspan="20"><label><strong>Drain:</strong></label></td></tr>	
<tr><td colspan="20"><input type="text" name="drain" value="<?php echo $row1['drain'];?>"</td>  </tr>
<tr><td colspan="20"><label><strong>Any CS?:</strong></label></td></tr>	
<tr><td colspan="20"><input type="text" name="cs" value="<?php echo $row1['cs'];?>"</td>  </tr>
...
<tr><td colspan="20"><input type="text" name="biopsyspe" value="<?php echo $row1['biopsyspe'];?>"></td>  </tr>
<tr><td colspan="20"><label><strong>Biopsy For:</strong></label></td></tr>	
<tr><td colspan="12"><select name="biopsy">

       
						<option value='<?php echo $row1['biopsy'];?>'><?php echo $row1['biopsy'];?></option>
...
<tr><td colspan="20"><input type="text" name="bloss" value="<?php echo $row1['bloss'];?>"></td>  </tr>
<tr><td colspan="20"><label><strong>Immediate Postoperative plan:</strong></label></td></tr>	
<tr><td colspan="20"><input type="text" name="pplan" value="<?php echo $row1['pplan'];?>"></td>  </tr>
<tr><td colspan="20"><label><strong></strong>Hospital stay plan:</label></td></tr>	
<tr><td colspan="20"><input type="text" name="hplan" value="<?php echo $row1['hplan'];?>"></td>  </tr>
						 
					
		<tr><td colspan="20"><label><strong>Nurse Name:</strong></label></td>  </tr>
		<td colspan="20"><input type="text" name="xl2" value="<?php echo $row1['nurse'];?>"</td>  
...
<tr>
						...
						<tr>				
						<td colspan="20"><input type="text" name="remarks" value="<?php echo $row1['remarks'];?>"</td>  
...
<tr><td colspan="20"><input type="text" name="o2" value="<?php echo $row1['o2'];?>"></td>  </tr>

	<tr><td colspan="20"><label><strong>Infusion Order :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="inorder" value="<?php echo $row1['inorder'];?>"</td>  </tr>

	<tr><td colspan="20"><label><strong>Medication Order :</strong></label></td></tr>													
<td align="center"colspan="20"><textarea class="form-control" id="exampleTextarea" name="morder" rows="10"><?php echo $row1['morder'];?></textarea></td>

	<tr><td colspan="20"><label><strong>Non Medication Order :</strong></label></td></tr>													
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="nmorder" rows="10"><?php echo $row1['nmorder'];?></textarea></td>  </tr>
	<tr><td colspan="20"><label><strong>Dietary Instruction :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="di" value="<?php echo $row1['di'];?>"></td>  </tr>

	<tr><td colspan="20"><label><strong>NG Instruction :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="ngi" value="<?php echo $row1['ngi'];?>"></td>  </tr>

	<tr><td colspan="20"><label><strong>Catheter Instruction :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="ci" value="<?php echo $row1['ci'];?>"</td>  </tr>

	<tr><td colspan="20"><label><strong>Other Order :</strong></label></td></tr>													
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="oo" rows="10"><?php echo $row1['oo'];?></textarea></td>  </tr>
