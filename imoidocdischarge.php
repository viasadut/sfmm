...
$update2_nn="update newbed set discharge='Discharged' where pmrn='$pmrn' and eid='$eid'";
mysqli_query($con,$update2_nn) or die(mysqli_error(gg));



$update2_n="update newbed set adatenew1='$adatenew',tby1='$user',charge='$fday',tdays='$fday_t',b_charge='$b_charge1' where type='$ward_no' and bno='$bed_no' and pmrn='$pmrn' and eid='$eid' and adatenew1 IS NULL";
