...
$medi_1 = $chk_row["medi"];
			$code_1 = $chk_row["code"];	
			$m_rfid = $chk_row["rfid"];	
			$loc=$chk_row['location'];
					//$sale_loc = $chk_row["location"];	
	
	
	
	
$qq1 = mysqli_query($db,"select * from medi_stock where rfid='$m_rfid' and location='$loc' order by asc limit 1");
...
$rdate = date('Y-m-d H:i:s');			
			...
			if($rqty=='0' and $eqty2<=$mqty)
	{
			...
			$strSQL = "update medi_stock set add_qty='$u_qty' where id='$mid' and location='$loc'";
