...
$query3 = "SELECT * FROM endo_extra_charge where pmrn= '$pmrn' and eid='$eid' and date='$date1' and medi='$medi1'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM endo_extra_charge where pmrn= '$pmrn' and eid='$eid' and date='$date1'and medi='$medi1'"; 
...
if($user!=''){
$ins_query1="insert into endo_extra_charge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`,`qty`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$price','$code','$price','$date2','$user','$time','$qty')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$count=1;
$sel_query="Select * from endo_extra_charge where pmrn= '$pmrn' and eid='$eid' and delete_status='0' order by `date` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
			...
			<td align="center"colspan="5"><?php echo $row["date"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="other_charge_delete_endo?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&code=<?php echo $row['code'];?>&price=<?php echo $row['price'];?>">DELETE</a></td>
