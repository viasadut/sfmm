...
$query = mysqli_query($db,"select * from birth where pmrn='$pmrn'");
...
$pdf->Cell('48',5,$idate,0,0,'L');

$pdf->ln(16);
$pdf->SetFont('Arial' , 'BI' , 16);
$pdf->Cell('253',5,'THIS IS TO CERTIFY THAT THE BABY',0,1,'C');
$pdf->ln(8);
$pdf->Cell('253',5,$data['bname'].' (MRN-'.''.$data['pmrn'].')',0,1,'C');
$pdf->ln(8);
...
$pdf->Cell('253',12,'WAS BORN IN THIS HOSPITAL AT  '.$data['btime'].' ON '.$bdate,0,1,'C');
