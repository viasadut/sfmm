...
<td colspan="20" align="center"><textarea rows="30"  name="sreport" value=""><?php if(isset($_POST['load'])==1){echo $data45['sformat'];}?></textarea></td>
...
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="inorder" rows="25"><?php if(isset($_POST['load'])==1){echo $data45['porder'];}?></textarea></td>  </tr>


<tr><td colspan="20" align="left"bgcolor="lightgreen"><label><strong>Charge</strong></label></td> </tr><tr>
<td colspan="20" ><input type="number" name="charge"  value="<?php if(isset($_POST['load'])==1){echo $data45['charge'];}?>"></td>
</tr>
<tr>
