...
$ins_query="insert into histo (`dname`,`date`,`time`,`pmrn`,`pname`,`pphone`,`page`,`psex`,`shistory`,`noperation`,`indication`,`find`,`bio1`,`bio2`,`eid`,`status`,`bstatus`,`bsize`) 
values ('$full','$date1', '$time','$pmrn','$pname','$pphone','$page','$psex','$shistory','$noperation','$indication','$find','$bio1','$bio2','$count1','NOT SEEN','Not Confirm','$bsize')";
...
header("Location: histoview?pmrn=$pmrn&eid=$count1");
...
<!-- Form Title -->
		...
		<a target='_blank' href="https://medex.com.bd"><b>Reference Drug Index of Bangladesh(medex.com.bd)<b></a></td></tr>
				...
				<tr>	  
				<td colspan="20">
				<input list="tname45" name="dname" size=75% class="form-control" value="">
