...
$eqty27 = $_POST['eqty27_'.$updateid];
	...
	//echo date('i').''.rand();
			...
			$qq1 = mysqli_query($db,"select * from purchase_stock where id='".$updateid."'");
...
$u_price=$eqty2*$p_price;
			...
			$qq1 = mysqli_query($db,"select * from purchase_stock where id='".$eqty26."'");
			$dd1 = mysqli_fetch_assoc($qq1);
	...
	if($eqty5 >= $eqty2 and $eqty2==$req_qty5)
	{
			
$ins_query3="update purchase_stock set `add_qty`='$nqty4' where id='$eqty26' and location='Store'";
mysqli_query($con,$ins_query3) or die(mysql_error());



$strSQL1 = "update purchase_stock set status='Served',add_qty='$eqty2',given_qty='$eqty2',exdate='$eqty25',u_price='$p_price',t_price='$u_price',batch_no='$eqty27',add_by='$user',add_time='$add_time' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
		

$strSQL3 = "insert into purchase_stock2 (`code`,`location`,`g_name`,`b_name`,`given_qty`,`req_qty`,`exdate`,`batch_no`,`sno`)
values('$code_1','$req_loc','$medi_1','$brand','$eqty2','$req_qty5','$eqty25','$eqty27','$ss_no')";
	...
	$strSQL2 = "insert into purchase_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`brand`,`ins`,`location`,`code`,`pmrn`,`pname`) values
	...
	else if($eqty5 >= $eqty2 and $req_qty5!=$add_qty_new)
	{
...
$strSQL1 = "update purchase_stock set status='Partially Served',add_qty='$add_qty_new',given_qty='$add_qty_new',exdate='$eqty25',u_price='$p_price',t_price='$u_price',batch_no='$eqty27',add_by='$user',add_time='$add_time' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
$strSQL1 = "update purchase_stock set status='Served',add_qty='$add_qty_new',given_qty='$add_qty_new',exdate='$eqty25',u_price='$p_price',t_price='$u_price',batch_no='$eqty27',add_by='$user',add_time='$add_time' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
<tr>
	  ...
	  <td colspan="1" align="center"><strong>Code</strong></td>
	    ...
	    <?php 
                    $query = "select * from purchase_stock where rfid='$sno' and req_loc='$req_loc' and status in('Pending','Partially Served','Served')";
...
$query1 = "select * from storenew where code='$ccode' and status='Active'";
...
$sum5 = "SELECT * FROM purchase_stock where code='$mcode' and location='Store' and add_qty>='$rr_qty' order by exdate asc limit 1" ;
...
$sum6 = "SELECT * FROM purchase_stock where code='$mcode' and location='Store' and add_qty>0 order by exdate asc limit 1" ;
...
$sum_r = "SELECT SUM(add_qty) FROM purchase_stock where code='$mcode' and location='$req_loc' and add_qty>0 and status='Served'" ;
...
?>
	 ...
	 <td align="center"colspan="1">
	 <?php
	                $queryg = "select COUNT(id) from purchase_stock2 where sno='$pno' and g_name='$medi'";
	 ...
	 <a target="_blank" href="department_bar_transfer_new_purchase?sno='.$pno.'"><img src="phar_pic/barcode.png" title="Print Instruction" width="20" height="20" /></a>';}
	 ?>
	 </td>						
