...
$sel_query="Select * from injury where estatus= 'Waiting For Confirmation' and econfirmby='$full' order by id desc;";
 $count=1;	 
...
{ ?>    <tr>
      ...
      <a target='_blank' href="injuryeditprint.php?id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a>
...
<a target='_blank' href="injuryedit_con.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>">Confirm Injury Certificate</a>
</td>
...
$sel_query="Select * from injury where status= 'Waiting For Confirmation' and confirmby='$full' order by id desc;";
 $count=1;	 
$result = mysqli_query($con,$sel_query);
...
<td colspan="2"align="center">
<a target='_blank' href="injuryedit_con_1.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>">Confirm Injury Certificate</a>
</td>
