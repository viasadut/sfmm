...
$pdf->Cell('10',5,'Stain:',0,0,'L');
$pdf->Cell('100',5,$data6['stain'],0,1,'L');

$pdf->Cell('14',5,'Culture:',0,0,'L');
$pdf->Cell('100',5,$data6['culture'],0,1,'L');


$pdf->Cell('24',5,'Analysis Time:',0,0,'L');
...
$pdf->Cell('24',5,'Final Status:',0,0,'L');
...
{
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('180',5,'No pathogen is isolated at 37 degree centigrade after'.' '.$data6['atime'].' '.'of anaerobic incubation.',0,1,'L');	
}
...
if($sm11 !='' and $smm1 !='' and $sm22 ='' and $sm2='')
{
$pdf->Cell('90',5,'Antibiotic Susceptiblity Testing (AST) :',0,0,'L');
...
$pdf->Cell('30' , 5,'   '.$data1['mic1'].'                     '.$data1['ins1'].'                          '.$data1['mic2'].'                '.$data1['ins2'],0,1);
}
