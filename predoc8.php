...
<tr><td colspan="20" align="center"bgcolor="lightblue"><h2><label><strong>Pending Privilege List </strong></label><h2></td> </tr>
<tr bgcolor="#F08080">
...
$count=1;
$sel_query="Select * from predoc where rby='$fname' and status='pending' order by `rdate1` asc;";
...
{ ?>    <tr>
	...
	<td align="center" colspan="1"><?php echo $count; ?></td>      
	 ...
	 <td colspan="1" align="left"><?php echo $row["status"]; ?></td>
