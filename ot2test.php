...
ptype='$tp',tanes='$x3',nanes='$na',proce='$lx',duration1='$duration',Otherins='$otherins',sprequire='$sprequire',remarks='$remarks',otdate='$otdate',nurse='$x2',asdoc='$lx4',oo='$oo',ci='$ci',ngi='$ngi',di='$di',morder='$morder',nmorder='$nmorder',inorder='$inorder',o2='$o2',otcharge='$otcharge' where `id`='$id'";

$tt=mysqli_query($con,$update);

if($tt)
{
	
	$ins_query="insert into ivisit (`pmrn`,`eid`,`odate`,`infusion`,`user`,`room`,`vtype`,`cdate`) values 
( '$pmrn','$eid','$odate','$full','$user','$otcharge','$lx','$date')";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
             		...
             		<td colspan="3"><input type="text" name="adate" value="<?php echo "$adate";?>"readonly/></td>					 	
...
<tr><td colspan="20"><input type="text" name="o2" value=""</td>  </tr>

	<tr><td colspan="20"><label><strong>Infusion Order :</strong></label></td></tr>													
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="inorder" rows="10"></textarea></td>  </tr>

	<tr><td colspan="20"><label><strong>Medication Order :</strong></label></td></tr>													
<td align="center"colspan="20"><textarea class="form-control" id="exampleTextarea" name="morder" rows="10"></textarea></td>

	<tr><td colspan="20"><label><strong>Non Medication Order :</strong></label></td></tr>													
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="nmorder" rows="10"></textarea></td>  </tr>
	<tr><td colspan="20"><label><strong>Dietary Instruction :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="di" value=""</td>  </tr>

	<tr><td colspan="20"><label><strong>NG Instruction :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="ngi" value=""</td>  </tr>

	<tr><td colspan="20"><label><strong>Catheter Instruction :</strong></label></td></tr>													
<tr><td colspan="20"><input type="text" name="ci" value=""</td>  </tr>

	<tr><td colspan="20"><label><strong>Other Order :</strong></label></td></tr>													
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="oo" rows="10"></textarea></td>  </tr>

<tr>					<td colspan="20"><label><strong>OT Charge</strong></label></td></tr>

<tr><td colspan="20"><input type="text" name="otcharge" required value="" /></td>  </tr>	
