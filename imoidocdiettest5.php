...
$ins_query1="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`,`dmenu`,`diettime`,`room`,`bed`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate','$d1','Morning','$room','$bed')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query2="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`,`dmenu`,`diettime`,`room`,`bed`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate','$d2','Mid Morning','$room','$bed')";
mysqli_query($con,$ins_query2) or die(mysql_error());

$ins_query3="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`,`dmenu`,`diettime`,`room`,`bed`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate','$d3','Lunch','$room','$bed')";
mysqli_query($con,$ins_query3) or die(mysql_error());

$ins_query4="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`,`dmenu`,`diettime`,`room`,`bed`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate','$d4','Evening','$room','$bed')";
mysqli_query($con,$ins_query4) or die(mysql_error());

$ins_query5="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`,`dmenu`,`diettime`,`room`,`bed`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate','$d5','Dinner','$room','$bed')";
mysqli_query($con,$ins_query5) or die(mysql_error());


$ins_query6="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`,`dmenu`,`diettime`,`room`,`bed`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate','$d6','Supper','$room','$bed')";
mysqli_query($con,$ins_query5) or die(mysql_error());
