...
<?php 
    ...
    $query5 = mysqli_query($con,"select * from dengue where pmrn='$pmrn' and sno='$sno'");
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['dengue1']?>" required>
            <label for="tibc"><strong>Anti TB IgG</strong></label>
            <input name="chikun2" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['dengue2']?>" required>
        </fieldset>
        <table>
            <tr>
