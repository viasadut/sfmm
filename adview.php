...
$query43 = "SELECT COUNT(status) FROM ipres where status= '$bt' and date BETWEEN '$start' and '$end';"; 
"select * from ipres where pmrn='$pmrn' and dname='$dname' and date='$date'
...
<div id='cssmenu'>
<ul>
   <li><a href='tes.php'><span>Home</span></a></li>
   <li class='active has-sub'><a href='#'><span>Prescription</span></a>
      <ul>
         <li class='has-sub'><a href='tes.php'><span>OPD Prescription</span></a>
      ...
      <ul>
         <li class='has-sub'><a href='tes5.php'><span>Prescription Status Wise Report </span></a>
            
         </li>
         <li class='has-sub'><a href='tes6.php'><span>Consultant Wise Report</span></a>
...
<h1 align="center">PRESCRIPTION SERVED REPORT </h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select End Date:</strong></label></td>	
							...
							<td colspan="3"><label><strong> Select Status</strong></label></td> 
...
$count=1;
$sel_query="Select * from presnew where status='$bt' and date BETWEEN '$start' and '$end';";
...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="pharreport.php?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"];?>&date=<?php echo $row["date"];?>"><img src="print.png" title="Print Report" width="60" height="20" /></a></td>
    ...
    <?php $count++; } }?>
      ...
      <td colspan="10" align="right"><a target='_blank' href="pp.php?status=<?php echo "$bt";?>&date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
  </tbody>
</table>
