...
'TCO2:'.$tco2."<br />".'sO2:'.$so2."<br />".'Lac:'.$lac;


$rr1='pH:'.$ph.' '.''."<br />".'PCO2:'.$pco2.' '.'mmHg'."<br />".'PO2:'.$po2.' '.'mmHg'."<br />".'BEecf:'.$beecf.' '.'mmol/L'."<br />".'HCO3:'.$hco3.' '.'mmol/L'."<br />".
'TCO2:'.$tco2.' '.'mmol/L'."<br />".'sO2:'.$so2.' '.'%'."<br />".'Lac:'.$lac.' '.'mmol/L';



$ins_query1="update b_gas_a set `ph`='$ph',`pco2`='$pco2',`po2`='$po2',`beecf`='$beecf',`hco3`='$hco3',`tco2`='$tco2',`so2`='$so2',`lac`='$lac' where sno='$sno'";
...
//{
	...
	$url = "new_inves_1_edit?sno=$sno&id=$id&pmrn=$pmrn&eid=$eid" ;
header("Location:$url");
...
document.getElementById('rdw').onchange= f_color9;
	  ...
	  <label for="age"><strong>LAC:</strong></label>
      <input name="lac" id="pla" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['lac'];?>"required/>
