...
?>
	  ...
	  <td align="center"><?php if($mname=='Present') {echo $mname; } else {echo '<span style="color:red;text-align:center;">Absent';}?></td>
	  <td align="center"><?php if($location=='Hospital' && $mname=='Present') {echo $location; } else if($location !=='Hospital' && $mname=='Present'){echo '<span style="color:red;text-align:center;">Outside';} else {echo '<span style="background-color:red;text-align:center;">';}?></td>
