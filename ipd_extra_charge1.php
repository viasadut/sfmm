...
$ins_query1="insert into ipd_extra_charge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`) values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$user','$time')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
