...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$date','$plan','$instruction','$date1','$remarks','$doc','A&E')";

$ins_query1="insert into patient (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone')";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<select name="doc" value="" class="style1"required>
