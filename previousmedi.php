...
<li class='last'><a href='appmedi'><span>Set Patient Appointment</span></a></li>
<li class='last'><a href='previousmedi'><span>Search Previous Patient</span></a></li>
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="previousmedi1?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">GO</a></td>
