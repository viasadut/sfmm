...
$po_q = "SELECT * from po_table where id='$id' "; 
$po_r = mysqli_query($con, $po_q) or die ( mysqli_error());
$data = mysqli_fetch_assoc($po_r);
?>
...
$ins_query1="update po_table  set 
...
header("Location: po_prepare1_purchase?ono=$ono1");
...
<table width="95%" height ="100%" border="0" align="center" bgcolor="lightblue" style="border-collapse:collapse;">	
		...
		<select name="po_type" required style="font-weight: bold;font-size:14px;color:green" required>
	   
	   	   
		   <option value='<?php echo $data['po_type'];?>'><?php echo $data['po_type'];?></option>
		...
		<select class="department" name="req_department" required style="font-weight: bold;font-size:14px;color:green;height:40px">

		
	
		
		<option><?php echo $data['req_department'];?></option>
	   

		<?php 
				
				//$sql = "select * from add_company order by com_name asc";
				$sql6 = "select distinct(dept) from staff3";
				$res6 = mysqli_query($con, $sql6);
				if(mysqli_num_rows($res6) > 0) {
					while($row6 = mysqli_fetch_object($res6)) {
						echo "<option value='".$row6->dept."'>".$row6->dept."</option>";
					}
				}

				$sql67 = "select distinct(subdept) from staff3";
				$res67 = mysqli_query($con, $sql67);
				if(mysqli_num_rows($res67) > 0) {
					while($row67 = mysqli_fetch_object($res67)) {
						echo "<option value='".$row67->subdept."'>".$row67->subdept."</option>";
					}
				}
				?>
...
"jsnew/select2.min.css" />
		...
		<tr>				
						<td colspan="5">
							...
							<select name="d_department" required style="font-weight: bold;font-size:14px;color:green"> <option><?php echo 'Central Store';?></option>
		...
		<td colspan="5"><input name="ex_date" type="date" style="text-transform:uppercase" value="<?php echo $data['ex_date'];?>"required></td>
		<td colspan="5"><input name="expiry_date" type="date" style="text-transform:uppercase" value="<?php echo $data['expiry_date'];?>"required></td>
		<td colspan="5">
		...
		<option value='<?php echo $data['payment_terms'];?>' selected><?php echo $data['payment_terms'];?></option>
	   ...
	   <option value='Cash'>Cash</option>
		...
		<td colspan="10" style="font-weight: bold;font-size:14px;color:red"> Address</td>
		...
		<tr>				
						...
						<option value='<?php echo $data['sup_code'];?>' selected><?php echo $data['sup_code'];?></option>
	   	   <?php 
...
"jsnew/select2.min.css" />					
		...
		<input name="creditor_code" id="con_name" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data['creditor_code'];?>" readonly required>
		
		
		</td>
		<td colspan="10"><input name="com_add" id="com_add" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data['com_add'];?>" readonly required></td>
		...
		<tr>				
		<td colspan="5"><input type="number" name="amount_discount" id="location" required value="<?php echo $data['amount_discount'];?>" style="font-weight: bold;font-size:14px;color:green"></td>
		

		<td colspan="5"><input name="percentage_dis" type="number" size="70" style="text-transform:uppercase" value="<?php echo $data['percentage_dis'];?>"required></td>
		<td colspan="5"></td>
		<td colspan="5"><input name="subamount" type="number" size="70" style="text-transform:uppercase" value="<?php echo $data['subamount'];?>"required></td>
		...
		<td colspan="5"><input name="issue_date" type="date" size="70" style="text-transform:uppercase" value="<?php echo $data['issue_date'];?>"required  ></td>
		<td colspan="5"></td>
		<td colspan="5"><input name="total_amount" type="number" size="70" style="text-transform:uppercase" value="<?php echo $data['total_amount'];?>"readonly ></td>
  ...
  <tr>
		...
		<tr>				
						<td colspan="5"><input type="text" name="auth_person" id="location" required value="<?php echo $data['auth_person'];?>" style="font-weight: bold;font-size:14px;color:green"></td>
		

		<td colspan="5"><input name="auth_date" type="date" size="70" style="text-transform:uppercase" value="<?php echo $data['auth_date'];?>"required></td>
		<td colspan="5"></td>
		<td colspan="5"><input name="record_status" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data['record_status'];?>" readonly required></td>
		...
		<tr>				
						<td colspan="5"><input type="date" name="po_date" id="location" required value="<?php echo $data['po_date'];?>" style="font-weight: bold;font-size:14px;color:green"></td>
		

		<td colspan="5"><input name="record_no" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data['record_no'];?>"required readonly></td>
		<td colspan="5"></td>
		<td colspan="5"><input name="enter_date" type="date" size="70" style="text-transform:uppercase" value="<?php echo $data['enter_date'];?>"required></td>
				...
				<tr><td colspan="20"><textarea name="remarks" style="text-transform:uppercase" value=""required rows="5" cols="130"><?php echo $data['remarks'];?>
			</textarea></td>
				...
				<tr><td colspan="20"><textarea name="terms" style="text-transform:uppercase" required rows="15" cols="130"><?php echo $data['terms'];?>			</textarea></td>
