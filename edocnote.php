...
$ins_query="insert into ecnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`visit`,`pnote`,`user`,`status`,`vtype`,`daten`,`infusion`,`dname`,`type`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$visit','$pnote','$user','Data Updated','$vtype','$daten','$infu','$full','doctor')";
...
<td colspan="8" align="center"><label><strong>Doctor's Note</strong></label></td> 
<td colspan="6" align="center"><label><strong>Investigation/Treatment Plan</strong></label></td>
<td colspan="2" align="center"><label><strong>Charge</strong></label></td>
<td colspan="2" align="center"><label><strong>Charge Type</strong></label></td>
</tr>
...
<td colspan="8" align="center"><textarea rows="2"  name="pnote" required value=""></textarea></td>
<td colspan="6" align="center"><textarea rows="2"  name="inves" required value=""></textarea></td>

<td colspan="2" align="center"><input name="visit" type="text"  style="text-transform:uppercase" value=""required></td>

						<td colspan="2" align="center"><select name="vtype" placeholder="Select Dosage" required>
...
<tr>
	  ...
	  <td colspan="7" align="center"><strong>Investigation/Treatment Plan</strong></td>
<td colspan="1" align="center"><strong>Charge Type</strong></td>
	   </tr>
 <?php
...
$count=1;
$sel_query="Select * from ecnote where pmrn= '$pmrn' and eid='$eid' and type='doctor'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="7"><?php echo $row["inves"]; ?></td>
