...
$extra=	$row198j_extra['SUM(price)'];
	...
	?>
    <td align="center"><a target='_blank' href="ipall_new_1_new_00_new?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Summary Bill</a></td>

    <td align="center"><a target='_blank' href="ipall_new_1_new_00_new?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><?php if($total_day<1){echo $bed_charge_new+$test1am+$test1al+$test1al_rad+$test1as+$test1+$opd_pro_summary+$opd_cath_summary+$opd_msuite_summary+$endo_summary+$test1_dis+$emer_all_bill+$ot_payment+$implant+$extra;}
    ...
    <td align="center"><a target='_blank' href="ipall_new_1_new_00_new?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><?php echo $test1c+$opd_procedure_sum_doc+$opd_cath_sum_doc+$opd_msuite_sum_doc+$endo_doc_sum+$emer_evisit_bill+$test1c_doc?></a></td>
