...
$ins_query1="insert into dic (`pname`,`pmrn`,`pphone`,`psex`,`page`,`ptime`,`pcontrol`,`apt`,`inr`,`atime`,`appt`,`flevel`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$ptime','$pcontrol','$apt','$inr','$atime','$appt','$flevel','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
      ...
      <input name="apt" type="text" size="70" style="text-transform:uppercase" value=""required/>
      ...
      <input name="atime" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>aPTT Control:</strong></label>
      <input name="appt" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>Fibrinogen Level:</strong></label>
      <input name="flevel" type="text" size="70" style="text-transform:uppercase" value=""required/>
