...
$queryem = "SELECT COUNT(mor) FROM roaster_2 where date ='$rdate' and mor='$rmor'"; 
$resultem = mysqli_query($con, $queryem) or die(mysqli_error());
$rowem = mysqli_fetch_array($resultem);
$c1em=$rowem['COUNT(mor)'];
//$a_status=$rowem['a_status'];
	  
	  
      if($_POST["employee_id"] != '' and $c1em>0 and $a_status!='Pending')  
      ...
      {  
           ...
           $query = "update roaster_2 set e_emor='$pbp3',location='$pbp1',e_send_by='$user',e_send_time='$etime',e_status='Pending' WHERE id = '".$_POST["employee_id"]."'";  
...
//mysqli_query($con,$update33) or die("Problem in Update pappnew");
	  ...
	  else if($_POST["employee_id"] != '' and $c1em>0 and $a_status=='Pending')  
      ...
      {  
           ...
           $query = "update roaster_2 set emor='$pbp3',location='$pbp1',e_send_by='$user',e_send_time='$etime' WHERE id = '".$_POST["employee_id"]."'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
