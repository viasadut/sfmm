...
$query = mysqli_query($db,"select * from medicineedit where ittime1='$ed'");
...
$pdf->Cell('95',5,'UPDATE CODE',0,1,'L');

$pdf->Cell('25',5,'Request From:',0,0,'L');
$pdf->Cell('95',5,'Pharmacy',0,1,'L');
...
$count=1;
$query1 = mysqli_query($db,"select * from medicineedit where ittime1='$ed'");
...
$pdf->Cell('70' , 5,$data1['mname'],1,0,'L');
$pdf->Cell('10' , 5,'',1,0,'L');
$pdf->Cell('10' , 5,'',1,0,'L');
$pdf->Cell('15' , 5,$data1['cprice'],1,0,'L');
$pdf->Cell('15' , 5,$data1['oprice'],1,0,'L');
$pdf->Cell('15' , 5,$data1['oprice1'],1,0,'L');
$pdf->Cell('15' , 5,$data1['uprice'],1,0,'L');
$pdf->Cell('15' , 5,$data1['uprice1'],1,1,'L');
...
$pdf->Cell('50',5,'Request By: '.' '.$data['eby'],1,0,'L');
...
$pdf->Cell('50',5,$data['etime'],1,0,'L');
...
$pdf->Cell('30' , 5,'',1,0,'L');
$pdf->Cell('30' , 5,'',1,0,'L');
$pdf->Cell('30' , 5,$data1['uprice'],1,0,'L');
$pdf->Cell('30' , 5,$data1['uprice1'],1,1,'L');
...
$pdf->Cell('70',5,'Done By: '.' '.$data['it'],1,0,'L');


$pdf->Cell('15',5);
$pdf->Cell('90',5,'Verified By: '.' '.'CFO',1,1,'L');
