...
$query = mysqli_query($con,"select * from mc_report_format where id='$id'");
...
<table width="100%">
					...
					<tr>
                        ...
                        <td width="100%" align="center" style="font-size:12px;text-decoration: underline;"><b>'.$data['type'].' REPORT</b></td>
