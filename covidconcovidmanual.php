...
$count=1;
$sel_query="Select * from staff1 where astatus='Active' and ugroup='doctor' order by sdepartment asc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="coviddoccovidmanual?id=<?php echo $row["id"]; ?>&rd=<?php echo $rd; ?>">Add</a> </td>
