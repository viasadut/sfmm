...
$query10 = mysqli_query($db,"select * from procedure1 where pmrn='$pmrn' and eid='$eid'");
...
values 
('$dname', '$pmrn','$ppname','$eid1','$medi','$pins','$date','$type','$price','$code','$link','$ndate','$linkv','$report','$reportv','Procedure_Room','$page','$pgender','$type1','$pphone')";
...
$count=1;
$sel_query="Select * from alltest where pmrn= '$pmrn' and date1='$date_endo' order by `id` DESC;";
