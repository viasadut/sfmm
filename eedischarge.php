...
$ins_query="insert into discharge1 (`dname`,`pname`,`pphone`,`pmrn`,`page`,`psex`,`discharge`,`ddia`,`surgery`,`ill`,`other`,`plan`, `ddate`,`eid`,`emo`,`dinves`)
 values ('$dname', '$pname','$pphone','$pmrn','$page','$psex','$discharge','$ddia','$surgery','$ill','$other','$plan','$date1','$eid','$full','$dinves')";
mysqli_query($con,$ins_query) or die("Problem in presnew");

$update="update emergency set discharge='Discharged', disstatus='SEEN',fstatustime='$date1', duser='$user',ddate1='$ddate1' where `eid`='$eid' and pmrn='$pmrn'";
...
<tr><td colspan="20"><input list=dis name="discharge" placeholder="-Select Discharge Type-" class="form-control" >
					<datalist id="dis">	
...
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="ddia" rows="5" ></textarea></td>  </tr>
<tr><td colspan="20"><label><strong>History Of present Illness (Optional) :</strong></label></td></tr>
<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="ill" rows="5"></textarea></td>  </tr>
...
<tr><td align="left" colspan="3"><a target='_blank' href="dinves?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>"><img src="test1.jpg" title="test" width="130" height="90" /></a></td><td align="left" colspan="3"><a target='_blank' href="dismedi?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>"><img src="medicine1.jpg" title="medicine" width="120" height="90" /></a></td></tr>
