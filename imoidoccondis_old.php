...
$sel_query1="Select * from inpatient where eid='$eid' and pmrn='$pmrn' and disstatus='Discharge Bill Confirmed' and confirmdn!='' ORDER BY id asc;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idisupdate1?eid=<?php echo $row1["eid"]; ?>&pmrn=<?php echo $row1["pmrn"]; ?>&room1=<?php echo "$room1"; ?>&room=<?php echo "$room"; ?>&vc=<?php echo "$vc"; ?>&vc1=<?php echo "$vc1"; ?>&ac=<?php echo "$ac"; ?>&user=<?php echo "$fullname"; ?>">Click To Vacant the Bed</a></td>
