...
$query43 = "SELECT COUNT(medi) FROM alltest where rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(infusion) FROM iinves where rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(infusion) FROM einves where rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
...
$query43r = "SELECT COUNT(medi) FROM alltest where rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED' and dname !='Outside Referral';"; 
...
$query43rr = "SELECT COUNT(medi) FROM alltest where rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED' and dname ='Outside Referral';"; 
	 
$result43rr = mysqli_query($con, $query43rr) or die(mysqli_error());
$row43rr = mysqli_fetch_assoc($result43rr);


$query44r = "SELECT COUNT(infusion) FROM iinves where rdate BETWEEN '$start' and '$end' and type='lab'and rstatus='RECEIVED';"; 
	 
$result44r = mysqli_query($con, $query44r) or die(mysqli_error());
$row44r = mysqli_fetch_assoc($result44r);


$query45r = "SELECT COUNT(infusion) FROM einves where rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
...
<h1 align="center">Datewise Sample Received stats</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3">
        <select  name="bt" style="text-transform:uppercase"required>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Received Date</strong></th>
      <th width="15%"><strong>Patient Name</strong>
      <th width="14%"><strong>Investigation</strong>  
	        <th width="14%"><strong>Received Status</strong>  
...
echo "   OPD-  ";	 
echo $row43['COUNT(medi)'].' ( In-House- '.$row43r['COUNT(medi)'].' ,Outside Referral- '.$row43rr['COUNT(medi)'].' )';
...
$sel_query1="Select * from alltest where rdate BETWEEN '$start' and '$end' and type in ('lab','LAB','Lab') and rstatus='RECEIVED' order by rdate desc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row1["barcode1"]; ?>
	  <td align="center"><?php echo $row1["rdate"]; ?>
	  <td align="center"><?php echo $row1["pname"]; ?>
      <td align="center"><?php echo $row1["medi"]; ?>
	  <td align="center"><?php echo $row1["rstatus"]; ?>
	  <td align="center"><?php echo $row1["result"]; ?>
        <td><?php
		$type=$row1["type"];
		$report5=$row1["report"];
		$pmrn=$row1["pmrn"];
...
?>
	...
	$sel_query2="Select * from iinves where rdate BETWEEN '$start' and '$end' and type in ('lab','LAB','Lab') and rstatus='RECEIVED' order by rdate desc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row2["barcode"]; ?>
	  <td align="center"><?php echo $row2["rdate"]; ?>
	  <td align="center"><?php echo $row2["pname"]; ?>
      <td align="center"><?php echo $row2["infusion"]; ?>
       <td align="center"><?php echo $row2["rstatus"]; ?>
	  <td align="center"><?php echo $row2["result"]; ?> 
	  <td><?php
		$type=$row2["type"];
		$report5=$row2["report"];
		$pmrn5=$row2["pmrn"];
...
?>
	...
	<?php
	$sel_query3="Select * from einves where rdate BETWEEN '$start' and '$end' and type in ('lab','LAB','Lab') and rstatus='RECEIVED' order by rdate desc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row3["barcode"]; ?>
	  <td align="center"><?php echo $row3["rdate"]; ?>
	  <td align="center"><?php echo $row3["pname"]; ?>
      <td align="center"><?php echo $row3["infusion"]; ?>
        <td align="center"><?php echo $row3["rstatus"]; ?>
	  <td align="center"><?php echo $row3["result"]; ?>
	  <td><?php
		$type=$row3["type"];
		$report5=$row3["report"];
		$pmrn5=$row3["pmrn"];
...
echo "<a target='_blank' href='$url'><img src='print.png' title='Print Report' width='50' height='60' /></a>";
	...
	{ 
echo "<a target='_blank' href='$url2'><img src='print.png' title='Print Report' width='50' height='60' /></a>";
	}
?>
	  </td>
      </tr>
