...
$update="update otslot set status='Booked' where `otdate`='$otdate' and otname='$bt2' and `ottime` between '$bt3' and '$bt4'";
...
<td colspan="3"><label><strong>Select OT</strong></label></td>
				...
				<td colspan="3"><select name="bt2" value="" class="country" required>
			        
<option ="">--Select OT Name--</option>
<option value='<?php echo $otdate.','.'OT01';?>'>OT01(RED)</option>
						<option value='<?php echo $otdate.','.'OT02';?>'>OT02(GREEN)</option>
						<option value='<?php echo $otdate.','.'OT03';?>'>OT03(BLUE)</option>
						<option value='<?php echo $otdate.','.'OT04';?>'>OT04(YELLOW)</option>
						<option value='<?php echo $otdate.','.'OT05';?>'>OT05(WHITE)</option>
						<option value='<?php echo $otdate.','.'OT06';?>'>OT06(ORANGE)</option>
						<option value='<?php echo $otdate.','.'OT07';?>'>OT07(PINK)</option>
						<option value='<?php echo $otdate.','.'OT08';?>'>OT08(PURPLE)</option>
</select>
					...
					<input name="ID" type="hidden" value="<?php echo $row['id'];?>" />
					 ...
					 <td colspan="2"><select name="bt3" class="3col1">
        
</select></td>  
				
						
						
					 <td colspan="3"><select name="bt4" class="3col1">
