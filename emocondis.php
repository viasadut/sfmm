...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Issue Death Certificate</strong>  
	  <th width="14%"><strong>Issue Brought in Death Certificate</strong>  
...
$res_d=mysqli_num_rows($result_d);
	  ...
	  ?>
	    <td align="center"><b><?php if($res_d==0){echo "<a href='$url_d'>Prepare Discharge Note</a>";} else if($res_d>0){echo "<a href='$url_d'>Edit Discharge Note</a>";} ?></td>


	<td><a href="death2emo?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><b>Issue Death Certificate<b></a></td>  	  
	<td><a href="death1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><b>Issue Brought in Death Certificate<b></a></td>  	  
...
$res_d=mysqli_num_rows($result_d);
	  ...
	  if($row['disstatus']=='Discharge Bill Confirmed' and $res_d>0){
		  echo
	  '
