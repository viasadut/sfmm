...
$query4 = mysqli_query($db,"select * from death1 where id='$id'");
...
//$update3="update death1 set name='$name',pmrn='$pmrn',fname='$fname',padd='$padd',ppadd='$ppadd',pphone='$pphone',page='$page',psex='$psex' where id='$id'";
//mysqli_query($con,$update3) or die(mysqli_error(oo));

$ins_query="insert into death1 (`name`,`pmrn`,`fname`,`padd`,`ppadd`,`rdoc`,`rdate`,`rdate1`,`rtime`,`pphone`,`page`,`psex`,`diag`,`ward`,`bed`,`adm`,`cdeath`,`eid`,`iby`,`idate`,`year`,`estatus`,`rto`,`ecby`) values 
('$name', '$pmrn','$fname','$padd','$ppadd','$rdoc','$rdate','$rdate1','$rtime','$pphone','$page','$psex','$diag','$ward','$bed','$adm','$cdeath','$count1','$iiby','$idate','$year','Waiting Approval','waiting','$fullname')";
...
<label for="age"><strong>Ward / Bed / Admission Date:</strong></label>
	   ...
	   <input name="adm" type="text" size="15" value="<?php echo $data["adm"]; ?>"readonly>	  
			...
			<input name="rdoc" type="text" size="80" value="<?php echo $data["rdoc"]; ?>" >
			<label for="age"><strong>Diagnosis :</strong></label>
      <input name="diag" type="text" size="80" value="<?php echo $data["diag"]; ?>" />
	  
	  <label for="mail"><strong>Date and Time of Death :</strong></label>
									<p>
									  <input type="date" name="rdate" value="<?php echo $data["rdate"]; ?>" size="15" required min="2023-01-01" max="2050-12-31">
									  <input name="rtime" type="text" size="80" value="<?php echo $data["rtime"]; ?>" required>
  			
			
	  
	  <label for="age"><strong>Cause Of Death :</strong></label>
      <textarea size="100" name="cdeath" ><?php echo $data["cdeath"]; ?></textarea>
  </fieldset>
