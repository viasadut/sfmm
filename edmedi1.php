...
$query4 = mysqli_query($db,"select * from emergency where id='$id'");
...
$pmrn=$data["pmrn"];
$pname=$data["pname"];
$ins_query1="insert into edmedi (`dname`,`pmrn`,`pname`,`medi`,`pdos`,`eid`) values ('$full','$pmrn','$pname','$medi1','$pdos','$eid')";
...
require('db1.php');
$id=$_REQUEST['id'];
$query23 = "DELETE FROM edmedi WHERE id=$id"; 
...
$count=1;
$sel_query="Select * from edmedi where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="edelete?id2=<?php echo "$id"; ?>&pmrn=<?php echo $data["pmrn"]; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&id1=<?php echo $row["id"]; ?>">DELETE</a></td>
