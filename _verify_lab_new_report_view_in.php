...
$query = mysqli_query($con,"select * from lab_test where lid='$id'");
			...
			$query4 = mysqli_query($con,"select * from iinves where id='$id1'");
...
lab_render_approval_footer($pdf, $con, (isset($data4['subtype'])?$data4['subtype']:''), (isset($data4['resultby'])?$data4['resultby']:''), (isset($data4['checked_by'])?$data4['checked_by']:''), (isset($data4['conby'])?$data4['conby']:''));
