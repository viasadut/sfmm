...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For CFO Approval' and cfo='$user' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For CEO Approval' and ceo='$user' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For IT Entry' and itby='$user' and type in ('LAB','lab','Lab')order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For IT Entry' and itby='$user' and type in ('rad','Rad','RAD') order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For IT Entry' and itby='$user' and type not in ('LAB','lab','Lab','rad','Rad','RAD') order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from edit_inves where status='Waiting For CFO Approval' and cfo='$user' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from edit_inves where status='Waiting For IT Entry' and itby='$user' and type='lab' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from edit_inves where status='Waiting For IT Entry' and itby='$user' and type='rad' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from edit_inves where status='Waiting For IT Entry' and itby='$user' order by id desc;";
