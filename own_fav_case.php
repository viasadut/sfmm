...
$count=1;
$sel_query="Select * from presnew where dname='$full' and fav='1' order by id desc;";
...
<?php	  $date=$row["date"] ;?>
    ...
    <?php if($row["fav"]>0 and $row["dname"]==$full){?>  
      ...
      <a onclick="return confirm_click_can();" href="fav_opd_can1?id=<?php echo $row['id']; ?>&pmrn=<?php echo "$pmrn"?>"><img src="fav_icon.png" title="Fav" width="50" height="40" /></a></td>
	  <?php } 

else if($row["fav"]=='0' and $row["dname"]==$full){?>  
    
    <a onclick="return confirm_click();" href="fav_opd?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn'];?>">Add To Favorite</a></td>
	  <?php } ?>
      </tr>
    <?php $count++; } ?>
  </tbody>
...
$count=1;
$sel_query="Select * from inpatient where adoc='$full' and fav='1' order by id desc;";
...
<?php if($row["fav"]>0 and $row["adoc"]==$full){?>  
    ...
    <a onclick="return confirm_click_can();" href="fav_ipd_can1?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn'];?>"><img src="fav_icon.png" title="Fav" width="50" height="40" /></a></td>
  <?php } 
