...
$date= date('m/d/Y');
$year= date('Y-01-01');
$year1= date('2025-12-31');
//$count=1;
$sel_query="Select * from conleavedetails where status in ('Approved By Replacement Consultant','Approval Pending')  and sdate between '$year' and '$year1'";
//$start=$row["aadate"];
...
<td align="center"><a onclick="return confirm_click();" href="leaveapprove2md_test?id=<?php echo $row["id"]; ?>"><strong>Approve</strong></a></td>
