...
$query = "UPDATE einves set rby='$user',rtime='$dtime', rstatus='RECEIVED', barcode='$result',status='RECEIVED' where id='$id'"; 
...
values ( '$pmrn','$eid','$pname','$page','$psex','$redate','$rinfusion','$ruser','$rodate','$user','$dtime','$result','AE','$sno','$link','$linkv','$reportv','$report')";
