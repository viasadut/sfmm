...
$count=1;
$sel_query="Select * from staff1 where astatus='Deactive' and ugroup='doctor' and stype in('permanent','Contractual')order by sdepartment asc;";
...
<td align="center"><?php echo $row["sdepartment"]; ?>  </td>
<td align="center"><?php echo $row["category"]; ?>  </td>
	  <td align="center"><a target='_blank' href="membertestmng?sid=<?php echo $row["sid"]; ?>"><b>Details<b></a></td>
...
$count=1;
$sel_query="Select * from staff1 where astatus='Deactive' and ugroup='doctor' and stype in('Sessional','out')order by sdepartment asc;";
