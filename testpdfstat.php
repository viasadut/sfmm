...
function Header()
{
    ...
    $this->Cell(0,6,' Daily Stat Order Sheet',0,1,'C');
...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers:  Ambulance:  +880244077029, +8801791987466, Appointments: +880244077030, +8801703788561 (SFMMKPJSH/IPD/MR-04)',0,0,'C');
...
$eid=$_REQUEST['eid'];
$dd=date('m/d/Y');
$query = mysqli_query($link,"SELECT * from istat where pmrn='$pmrn' and eid='$eid' " );
...
$pdf->AddCol('infusion',145,'Medicine');
$pdf->AddCol('room',60,'Instruction');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from istat where pmrn='$pmrn' and eid='$eid' and odate1='$dd'order by odate",$prop);
$pdf->Output();
?>