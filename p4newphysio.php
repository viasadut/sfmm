...
$query2 = mysqli_query($db,"select * from pappnew where pmrn='$pmrn' and dname='$dname' and adate='$date' and eid='$eid'");
...
$pdf->Cell('60',5,'Physiotherapist Name:',0,0,'L');
$pdf->Cell('60',5,$data['dname'],0,1,'L');
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Treatment:',0,1,'L');
$pdf->ln(1);
$query1 = mysqli_query($db,"select * from tphysio where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
