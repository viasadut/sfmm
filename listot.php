...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>Item ID</strong></th>
      <th width="10%"><strong>Item Name</strong></th>
      <th width="15%"><strong>Item Type </strong>
      <th width="14%"><strong>Current Location</strong> 
      <th width="14%"><strong>Status</strong>
      <th width="14%"><strong>Qty in Hand</strong>  
...
$sel_query="Select * from store where etype='Disposable' and estatus= 'Active' and elocation in ('ot1','ot2','ot3','ot4') ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["eqty"]; ?>  
	        ...
	        <td colspan="10" align="center"><a target='_blank' href="dmtransfer.php?id=<?php echo $row['id']; ?>">Transfer</a></td>	
