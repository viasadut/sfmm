...
$update212="update preadm set pname='$pname',fname='$fname', mname='$mname', peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Pending',pphone='$pphone2',user='$user',scase='$scase',vpoor='$vpoor',aldate='$aldate',pvno='$pvno',pvdate='$pvdate',diagnosis='$diagno' where `id`='$id'";
mysqli_query($con,$update212);

$update22="update inpatient set bfigure='$bfigure',dia1='$dia1',cinfo='$cinfo',ecost1='$ecost1',arequest='$arequest',user='$user',aldate='$aldate',pvno='$pvno',pvdate='$pvdate' where `pmrn`='$pmrn' and eid='$eid1'";
...
<input type="text" name="aldate" id="datepicker2" placeholder="MM/DD/YYYY" size="15" value="<?php echo date('m/d/Y',strtotime($data444['aldate']));?>" required>
