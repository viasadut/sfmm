...
$ins_query="insert into inprocedure (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated')";
...
<tr>
	  ...
	  <td colspan="4" align="center"><strong>Note</strong></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from inprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
