...
$query4 = mysqli_query($db,"select * from dialysispapp where pmrn='$pmrn' and eid='$eid'");
...
$sel90="SELECT * FROM dialysismedi WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu1' and `status`='Active';";
$result90 = mysqli_query($con,$sel90);

$sel91="SELECT * FROM dialysismedi WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu2' and `status`='Active';";
$result91 = mysqli_query($con,$sel91);


$sel92="SELECT * FROM dialysismedi WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu3' and `status`='Active';";
$result92 = mysqli_query($con,$sel92);


$sel93="SELECT * FROM dialysismedi WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu4' and `status`='Active';";
$result93 = mysqli_query($con,$sel93);


$sel94="SELECT * FROM dialysismedi WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu5' and `status`='Active';";
...
$ins_query6="insert into dialysismedi (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
mysqli_query($con,$ins_query6);}

if(!empty ($_POST['infu2'])){
$ins_query7="insert into dialysismedi (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
mysqli_query($con,$ins_query7);}

if(!empty ($_POST['infu3'])){
$ins_query8="insert into dialysismedi (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
mysqli_query($con,$ins_query8);}

if(!empty ($_POST['infu4'])){
$ins_query9="insert into dialysismedi (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
mysqli_query($con,$ins_query9);}

if(!empty ($_POST['infu5'])){
$ins_query10="insert into dialysismedi (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
...
{
return confirm("Are You Sure The Medicine Is Given ?");
}
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><button onClick="goBack()">Back</button></td></tr>
				...
				<tr>	  
				<td colspan="20"><?php echo $data59["dreffer"]; ?></td></tr>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from dialysismedi where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pstatus='Ordered'order by `infusion` and `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="5"><a href="addpharmediimodetailsdoc?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&infu=<?php echo $row['infusion'];?>"><?php echo $row["infusion"]; ?></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="dialysismedigiven?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Given</a></td>
...
<tr><td colspan="20"><b> Given Medicine List<b></td></tr>	
	 <?php
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from dialysismedi where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pstatus='given'order by `infusion` and `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"<?php if($row['alert']== "H. Medi"): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightblue;" <?php endif ; ?>>
        <?php echo $row['alert'];?></td>
  	  <td align="center"colspan="1"><?php echo $row["pstatus"]; ?></td>
<td align="center" colspan="1">Already Given</a></td>
