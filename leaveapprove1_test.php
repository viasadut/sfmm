...
$query3 = "SELECT * FROM staff3 where sid= '$uname' and status in ('Active','active')"; 
...
$query1 = "UPDATE staff3 set ataken='$ataken' where sid='$uname' and status in ('Active','active')"; 
...
$query1 = "UPDATE staff3 set sleave='$staken',staken='$staken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set eleave='$etaken',etaken='$etaken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set maleave='$mataken', mataken='$mataken'where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set paleave='$pataken',pataken='$pataken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set rleave='$rltaken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set lwl='$lwpltaken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set comltaken='$comltaken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set intaken='$intaken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set martaken='$martaken' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
...
$query1 = "UPDATE staff3 set insleave='$insleave' where sid='$uname' and status in ('Active','active')"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());
