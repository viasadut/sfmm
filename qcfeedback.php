...
$ins_query="insert into feedback (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`pnote`,`user`,`otime`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$pnote','$user','$otime')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Patient's Feedback</strong></label></td> </tr>
...
<td colspan="20" align="center"><textarea rows="2"  name="pnote" required value=""></textarea></td>
...
<tr>
	  ...
	  <td colspan="13" align="center"><strong>Patient's Feedback</strong></td>
...
$count=1;
$sel_query="Select * from feedback where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="13"><?php echo $row["pnote"]; ?></td>  
