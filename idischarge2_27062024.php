...
$date1= date('d/m/Y');
$dnew= date('Y-m-d');
$update="update inpatient set disstatus='Discharge Bill Confirmed', bstatustime='$adate1', buser='$user',billdate='$date1',damount='$damount',dtype='$dtype',dnew='$dnew' where `id`='$id'";
mysqli_query($con,$update) or die(mysql_error());

$update4="update preadm set dnew='$dnew' where `pmrn`='$pmrn' and eid='$eid'";
mysqli_query($con,$update4) or die(mysql_error());

$update5="update dis_request set disstatus='Discharge Bill Confirmed', bstatustime='$adate1', buser='$user' where `pmrn`='$pmrn' and `eid`='$eid'";
mysqli_query($con,$update5) or die(mysql_error());

$update55="update iinves set dis_date='$dnew' where `pmrn`='$pmrn' and `eid`='$eid'";
mysqli_query($con,$update55) or die(mysql_error());
