...
$query44 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tp='$bt' and status='collected'"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query44p = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tp='$bt' and status='collected' and tresult='P'"; 
	 
$result44p = mysqli_query($con, $query44p) or die(mysqli_error());
$row44p = mysqli_fetch_assoc($result44p);


$query44n = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end'  and tp='$bt' and status='collected' and tresult='N'"; 
	 
$result44n = mysqli_query($con, $query44n) or die(mysqli_error());
$row44n = mysqli_fetch_assoc($result44n);

$query44no = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end'  and tp='$bt' and status='collected' and tresult=''"; 
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and tp='$bt' and status='collected' order by sid asc;";}
...
{ ?>    <tr>
     ...
     <td align="center"><?php echo $count; ?></td>
      ...
      <td align="center"><?php echo $row["ssent1"]; ?>
...
<?php $count++; } }?>
      ...
      <td colspan ="2" align="right"><a target='_blank' href="covidstatprintnew2?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>&bt=<?php echo "$bt"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
<td colspan ="2" align="right"><a target='_blank' href="cate_covid_report?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>&type=<?php echo "$bt";?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>		  
  </tbody>
</table>
