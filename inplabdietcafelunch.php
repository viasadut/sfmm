...
$date= date('Y-m-d');
$count=1;
$sel_query="Select * from iidiet where diettime in ('Lunch','Extra Food') and status1 !='Cancel' and status='Diet Ordered' and odate='$date'order by id asc";
...
<td colspan="2" align="center"><a onclick="return confirm_click();" href="dietconfirml?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>&user=<?php echo "$fullname"; ?>"><strong>Served</strong></a></td>	  

	 </tr>
    <?php $count++; } ?>
   </tbody>
   <tr><td colspan="10" align="right"><a target='_blank' href="printdiet3.php?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
</form>
