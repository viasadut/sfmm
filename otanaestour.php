...
$ins_query="insert into otanaestour (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`,`pad`,`atime`,`rtime`) values 
('$pmrn','$id','$pname','$page','$adm','$psex','$pphone','$odate','$infu','$user','Data Updated','$odate1','$time','$date','Active','$remarks','$pad','$atime','$rtime')";
...
$count=1;
$sel_query="Select * from otanaestour where pmrn= '$pmrn' and eid='$id' and status1='Active'order by `id` DESC;";
