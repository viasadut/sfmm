...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <td colspan="1"align="center"><strong>Admission Advise</strong></td>
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="docadm?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"; ?>">Admission Advise</a></td>
