...
$query43 = "SELECT COUNT(dname) FROM pappnew where dname= '$bt' and adate1 BETWEEN '$start' and '$end' and bill='Billed';"; 
...
$query44 = "SELECT COUNT(dname) FROM pappnew where adate1 BETWEEN '$start' and '$end' and bill='Billed';"; 
    ...
    $(document).ready(function () {
        $('input[id$=aa]').datepicker({});
					 ...
					 <td colspan="3"><select name="bt" >
						...
						<?php 
			$sql = "select distinct(dname) from `pappnew` where liver_opd='SFMM LIVER CLINIC' and dname !='SFMM LIVER CLINIC' order by aslot asc";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pappnew where dname='$bt' and adate1 BETWEEN '$start' and '$end' and bill='Billed' order by dname asc";
