...
$(document).ready(function() {
	 ...
	 */
	$.ajax({
		url : "http://192.168.100.252:8080/sfmm/pain1.php?pmrn=<?php echo $pmrn?>&eid=<?php echo $eid?>&odate1=<?php echo $odate1?>",
//		var pmrn =data.pmrn;
		type : "GET",
		success : function(data){
			...
			for (var i = 0; i < len; i++) {
				if (data[i].vitails1 == "Pain") {
					score1.Pain.push(data[i].score1);
				}
