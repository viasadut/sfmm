...
$sel90="SELECT * FROM radio WHERE `iname`='$infu';";
...
$ins_query="insert into iinves (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`ordate`,`type`,`code`,`price`,`subtype`,`rstatus`,`link`,`report`,`location`,`ndate`,`linkv`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$fname','$remarks','Data Updated','$ordate','$type','$code','$price','$subtype','Ordered','$link','$report','IPD','$ndate','$linkv')";
...
{ ?>    <tr>
 ...
 <td align="center" colspan="2"><a href="delete1iinvesimo?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>  	  
	...
	<table width="88%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="4"><?php echo $row["infusion"]; ?></td>
        ...
        <?php echo $row['rstatus'];?></td>
		  ...
		  <td align="center"colspan="3"><?php echo $row["result"]; ?></td>
		<td align="center"colspan="1"><?php echo $row["resultstatus"]; ?></td>
  	    <td align="center"colspan="2"><form action="http://192.168.100.202/Launch_Viewer.asp?" method="post" id='tt' >
<input type="hidden" name="AccessionNumber" value="<?php echo 'I'.$row['id'];?>"></input>
...
<tr><td colspan="2"><a target='_blank' href="piinves.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="lab.png" title="Print Report" width="150" height="60" /></a></td>
	<td colspan="2"><a target='_blank' href="piinves1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="rad.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
