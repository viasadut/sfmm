...
$query3 = $db->query("select * from inpatient where pmrn='$pmrn'and eid='$eid'");
...
$pdf->Cell(80,5,$data->infusion,0,0);
$pdf->Cell(50,5,$data->result,0,0);
$pdf->Cell(30,5,$data->pdos,0,0);
$pdf->Cell(30,5,$data->ins,0,1);
...
lab_render_approval_footer($pdf, $db, '', (isset($data->resultby)?$data->resultby:''), (isset($data->checked_by)?$data->checked_by:''), (isset($data->conby)?$data->conby:''));
$pdf->Ln(10);
