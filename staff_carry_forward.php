	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$b_leave1 = $_REQUEST["b_leave"][$i];
						$aa_leave = $_REQUEST["aa_leave"][$i];
			
			$b_leave2 = $_REQUEST["b_leave"][$i];
						
			//$sid_n = $_REQUEST["b_leave"][$i];
			/*$qq = mysqli_query($db,"select * from staff3 where id='".$_POST["chkDel"][$i]."'");
			$dd = mysqli_fetch_assoc($qq);
			$sid_n=$dd['sid'];
			
			$qq1 = mysqli_query($db,"select SUM() from staff3 where id='".$_POST["chkDel"][$i]."'");
			...
			*/
			...
			$strSQL = "update staff3 set cfleave='5',ataken='',etaken='',staken='',mataken='',pataken='',l_y_ataken='$aa_leave',maleave='112',paleave='2',b_leave='$b_leave1'";
			...
			{
			$strSQL = "update staff3 set cfleave='$b_leave1',ataken='',etaken='',staken='',mataken='',pataken='',l_y_ataken='$aa_leave',b_leave='$b_leave1'";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect1,$strSQL);}
		}
	}
...
$strSQL = "SELECT * FROM staff3 where status in ('Active','active')";
...
?>
  ...
  <tbody>
	  ...
	  $sid=$row['sid'];
	  $query39 = "SELECT * FROM staff3 where sid= '$sid' and status in ('Active','active')"; 
...
<td align="center" colspan="1" ><input type="text" name="aa_leave[]" id="aa_leave<?php echo $i;?>" value="<?php echo $row["ataken"];?>" readonly></td>
