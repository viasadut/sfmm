...
?>
 ...
 {  
	  ...
	  $pause_remarks = mysqli_real_escape_string($connect, $_POST["pause_remarks"]);  
...
$data = mysqli_fetch_assoc($query4);
      if($_POST["employee_id"] != '')  {
		...
		if($data['pause_by']=='' and $data['pause_by1']=='' and $data['pause_by2']=='')
        
      {  
           $query = "update iblood set pause_remarks='$pause_remarks',pause_by='$user',pause_time='$dtime' WHERE id = '".$_POST["employee_id"]."'";  
	  ...
	  else if($data['pause_by']!='' and $data['pause_by1']=='' and $data['pause_by2']=='')
        
      {  
           $query = "update iblood set pause1_remarks='$pause_remarks',pause_by1='$user',pause_time1='$dtime' WHERE id = '".$_POST["employee_id"]."'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
      ...
      {  
           $query = "update iblood set pause2_remarks='$pause_remarks',pause_by2='$user',pause_time2='$dtime' WHERE id = '".$_POST["employee_id"]."'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
