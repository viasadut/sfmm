...
$ins_query="insert into death1 (`name`,`pmrn`,`fname`,`padd`,`ppadd`,`rdoc`,`rdate`,`rdate1`,`rtime`,`pphone`,`page`,`psex`,`diag`,`ward`,`bed`,`adm`,`cdeath`) values 
('$name', '$pmrn','$fname','$padd','$ppadd','$rdoc','$rdate','$rdate1','$rtime','$pphone','$page','$psex','$diag','$ward','$bed','$adm','$cdeath')";
...
<!-- Form Title -->
	  ...
	  <label for="mail"><strong>Date and Time of Death :</strong></label>
									<p>
									  <input type="text" name="rdate" id="datepicker" placeholder="Select Date" size="15" required>
