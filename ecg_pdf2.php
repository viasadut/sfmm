...
$id=$_REQUEST['id'];
            ...
            $query = mysqli_query($con,"select * from ecg_test where lid='$ac_no'");
...
<table width="100%">
                    <tr>
                        ...
                        <td width="100%" align="center" style="font-size:17px;text-decoration:underline;"><span style="text-transform:uppercase;"><b>'.$data['ron'].' REPORT</b></span></td>
