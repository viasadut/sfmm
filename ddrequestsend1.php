...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <td colspan="1"align="center"><strong>Amount Given</strong></td>
...
$dd=date('Y-m-d');
$sel_query="Select * from preadm where drsend between '$test' and '$dd' and ddrequest='settled' and apstatus ='Approved' order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><?php echo $row["bfigure"]; ?> </td>
...
<td colspan="1"align="center"><?php echo $row["apstatus"]; ?> </td> 	  
	  ...
	  <td colspan="5">		<a target='_blank' href="finalprintdd1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
	  
	  <td colspan="5">		<a target='_blank' href="dd_pv?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
...
$sel_query5="Select * from endopapp where drsend between '$test' and '$dd' and ddrequest='settled' and apstatus ='Approved'   order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><?php echo $row5["bfigure"]; ?> </td>
	  ...
	  <td colspan="5">		<a target='_blank' href="finalprintdd1endo?pmrn=<?php echo $row5["pmrn"]; ?>&eid=<?php echo $row5["eid"]; ?>&id=<?php echo $row5["ID"]; ?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
	  <td colspan="5">		<a target='_blank' href="dd_pv1?pmrn=<?php echo $row5["pmrn"]; ?>&eid=<?php echo $row5["eid"]; ?>&id=<?php echo $row5["ID"]; ?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
...
$sel_query5="Select * from preadm where drsend between '$test' and '$dd' and ddrequest ='pending' and apstatus !='Approved' order by id desc;";
...
$sel_query5="Select * from endopapp where drsend between '$test' and '$dd' and ddrequest ='pending' and apstatus !='Approved'  order by id desc;";
