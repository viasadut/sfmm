...
<a target="_blank" href="po_prepare_mng?ono=<?php echo $encryption; ?>">View/Edit</a>
...
$sel_query="Select * from po_table where status='Approved' ORDER BY id desc;";
...
<a target="_blank" href="po_prepare1_purchase_grn?ono=<?php echo $ono1; ?>&grn=<?php echo $grn; ?>">View/Edit</a>
