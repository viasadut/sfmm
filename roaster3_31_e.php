...
?>
 ...
 {  
      $output = '';  
      $message = '';  
      $pmrn = mysqli_real_escape_string($connect, $_POST["pmrn11"]);  
...
$dept=$res90['dept'];
           ...
           $query = "insert into roaster_2 (`emor`,`e_emor`,`location`,`mor`,`date`,`aby`,`dept`,`adate`,`e_send_by`,`e_send_time`,`e_status`) values 
		   ('Off Day','$pbp3','$pbp1','$pmrn','$date','$user','$dept','$adate','$user','$etime','Pending')";  
