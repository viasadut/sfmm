...
$count=1;
$sel_query="Select * from presnew where date1= '$date1' order by ID desc;";
...
<?php	  $date=$row["date"] ;?>
<td align="center"><a target='_blank' href="p5new?pmrn=<?php echo $row["pmrn"]; ?>&date=<?php echo $row["date"]?>&dname=<?php echo $row["dname"]?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="50" height="20" /></a></td>
