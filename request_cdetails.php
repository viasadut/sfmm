...
$sel90="SELECT * FROM cdetails WHERE `cname`='$cname' and `user`='$user';";
...
/*echo '<script language="javascript">';
    ...
    */
    ...
    $ins_query1="update cdetails set `cdescription`='$cdescription' where cname='$cname' and user='$user'";
...
$ins_query1="insert into cdetails (`cname`,`cdescription`,`user`) values ('$cname','$cdescription','$user')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<!-- Form Title -->
	  ...
	  <input list="browsers111" name="cname"  size="80"  style="text-transform:uppercase"required onchange="GetDetail1(this.value)" autocomplete="off">
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "prescription/prescription/cdetails_data.php?pmrn=" + str, true);
