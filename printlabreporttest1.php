...
$eeid=$data7['emerid'];
            ...
            $output = "";
				...
				<table width="100%">
				<tr>
                                    <td style="font-family: freesans; font-size: 18px; text-align:center"><b>RADIOLOGY INVESTIGATION RECORD (INPATIENT)<br></b></td>
                                </tr>
				';
			 ...
			 $query1r = mysqli_query($con,"Select * from radreport where pmrn='$pmrn' and emerid='$eeid' order by id desc");
                ...
                while ($data11r = mysqli_fetch_array($query1r)) {
                    $output .='
                            ...
                            <tr>
                                <td style="font-family: freesans; font-size: 15px;"><b>'.$count.') '.$data11r['type'].' </b>
							...
							<tr>
                               ...
                               <td style="font-family:freesans;font-size: 15px;">'.$data11r['report1'].'</td>
                            </tr>
			  ...
			  //$output .='';
                $query1r = mysqli_query($con,"Select * from radreport where pmrn='$pmrn' and ineid='$eid' order by id desc");
                //$count=1;
                while ($data11r = mysqli_fetch_array($query1r)) {
                    $output .='
