...
$ins_query="insert into endopapp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`dreffer`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$yy5','$psex','$tname23')";
...
<!-- Form Title -->
      ...
      <input name="padd" type="text" size="70" class="style1" value="<?php echo $row40['padd'];?>"readonly>

	  <label for="age"><strong>Patient's Details :</strong></label>
      <input name="psex" type="text" size="11" class="style1" value="<?php echo $row39['psex'];?>" placeholder="Gender"readonly>
	  
      <input name="pmrn" type="text" size="15"Placeholder="MRN" class="style1" value="<?php echo $row39['pmrn'];?>"readonly >
      <input name="pphone" type="text" size="13" Placeholder="Phone NO" class="style1"value="<?php echo $row39['pphone'];?>" readonly>	  
	  <input name="page" type="text" size="5"Placeholder="AGE" class="style1" value="<?php echo $row39['page'];?>"  readonly>
...
?>" size="57" readonly>
		...
		<label for="mail"><strong>Appointment Date :</strong></label>
									<p>
									  <input type="date" class="style1" name="date" placeholder="Select Date" size="15" value="<?php echo $row39['date'];?>">
									  <input name="date1" type="text" size=48% class="style1" value="<?php if(isset($_POST['load'])==1)
{ $date1 = date('m/d/Y',strtotime($_REQUEST['date']));
echo $date1;
}
?>" size ="57" readonly>
