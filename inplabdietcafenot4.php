...
<p align="center" class="style1">Welcome!!  <?php echo $row39['fullname']; ?>- Today's Dinner Order Status</p> 
...
$query43 = "SELECT COUNT(status) FROM iidiet where pmrn= '$pmrn1' and odate='$dd1' and status1!='Cancel' and diettime='Dinner' and status in ('Diet Ordered','Data Updated','Given') ;"; 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);
