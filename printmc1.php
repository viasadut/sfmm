...
$query = mysqli_query($db,"select * from mcertificate where pmrn='$pmrn' and eid='$eid' and ct='fit'");
...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers:  Ambulance:  +880244077029, +8801791987466, Appointments: +880244077030, +8801703788561 (SFMMKPJSH/OPD/MR-04)',0,0,'C');
...
$pdf->Cell('253',10,'FITNESS CERTIFICATE',1,1,'C');
...
$pdf->ln(8);
$pdf->Cell('253',5,strtoupper($data['m2'].' ' .'IS FIT FOR '.' '.$data['ffor'].' '.'ON / FROM -'.' ' .$data['fdate1']),0,1,'C');
