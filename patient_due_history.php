...
require('db1.php');
//include("auth.php");
$patient_mrn=$_REQUEST['pmrn'];
$fullname = $_SESSION['sess_username'];
$query39 = "SELECT * FROM patient where pmrn= '$patient_mrn'"; 
...
$sel_query="Select * from patient_payment where pmrn='$patient_mrn'  ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center" style="text-transform:uppercase"><?php echo $row39["pname"]; ?></td>
	  
	  
	  
	  <td align="Left"><?php echo $row["pmrn"]; ?></td>
      ...
      <td align="center"><?php echo $row["due_clear_time"]; ?>  </td>
