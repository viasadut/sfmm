...
$sel96="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' and `exdate`>'$ex_date' order by exdate asc limit 1";
...
//else if($res95=mysqli_num_rows($result95)>0 and $mqty=='' and $mm_qty<$tprice)
{
	...
	$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`ins`,`brand`,`pname`,`pmrn`,`location`,`rfid`,`code`,`ip`,`op`,`acct_code`,`ccentre`) values
			('$medi','$tprice','$uprice','$charge','$user','$adate','$sno','$ins','$brand','$p_name1','$p_mrn1','OTC','$rf','$code','$ip','$op','$acct_code','$ccentre')";
...
//#1
			...
			else if($tqty >= $tprice and $mqty=='' and $mm_qty<$tprice and $tprice>0)
	{
			...
			$sel97="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97b="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97c="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97d="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97e="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97f="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97g="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97h="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
$sel97i="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty>0 and location='Pharmacy' order by exdate asc limit 1;";
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "phar_out1_new2.php?pmrn=" + str, true);
