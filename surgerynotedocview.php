...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="ot2view?id=<?php echo $row["id"]; ?>">View</a></td>

 

	  	  	  <td align="center"><a target='_blank' href="otnote?id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
