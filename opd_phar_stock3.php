...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"style="font-size:18px;font-weight:bold;color:red;"><strong>GRN Qty</strong></th>
	  ...
	  <th width="14%"style="font-size:18px;font-weight:bold;color:red;"><strong>Served Qty</strong> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select SUM(add_qty),SUM(s_qty),SUM(given_qty),g_name,b_name,code from medi_stock where add_qty>0 and location='Pharmacy' and status in('Served','Partially Served') group by code ORDER BY code asc;";
...
$ed=date('Y-m-31 00:00:00');
$queryq = "SELECT SUM(given_qty) from medi_stock where code='".$cc."' and add_time between '$sd' and '$ed' and location NOT IN ('Pharmacy')"; 
...
<?php if($cc1==''){echo '
<a target="_blank" href="store_hoscharge_details.php?code='.$row['code'].'">

'.$rowq["SUM(given_qty)"].'';}?> </td>
