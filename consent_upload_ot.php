...
<html>
<head>
    <title>Consent Form Upload</title>
...
<div class="container">
    ...
    <form action="consentupload_ot.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from consent_form where pmrn='$pmrn' and eid='$eid' and status='Active';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="otpic/<?php echo $image['file'] ?>">
                        <img class="img-responsive" alt="" src="otpic/<?php echo $image['file'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['file'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="consent_delete_ot.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $image['id'] ?>">
					
					<input type="hidden" name="pmrn" value="<?php echo $pmrn ?>">
					<input type="hidden" name="eid" value="<?php echo $eid ?>">
					  <input type="hidden" name="name" value="<?php echo $image['file'] ?>">
