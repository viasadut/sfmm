...
$ins_query1="Update asset_new set solvetime='$adate1',btime='$stime',bioby='$user',bremarks='$fremarks',estatus='$estatus',status='$estatus' where id='$id'";
...
header("location:tender/equipment/asset_management_dept_faulty.php");
}
?>
