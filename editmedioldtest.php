...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
			      <td align="center"colspan="5"><input type="text" name="test" id="test<?php echo $row["id"];?>" value="<?php echo $row["pdos"]; ?>";></td>
				  
				  
				  <td align="center" colspan="2"><a href="delete1test?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid1=<?php echo "$eid1"; ?>&eid=<?php echo "$eid"; ?>&pname=<?php echo $row["pname"]; ?>&medi=<?php echo $row["medi"]; ?>&test="onclick="this.href+=document.getElementById('$("#test<?php echo $row['id'];?>")').value;return true" >ADD</a></td>
