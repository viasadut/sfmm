...
{
return confirm("Are you Sure to Reject This?");
}
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>Consent Name</strong></th>
      <th width="10%"><strong>Added By</strong></th>
      <th width="15%"><strong>Added Time </strong>
...
$sel_query="Select * from mc_report_format where status='Waiting'  ORDER BY id asc;";

$result = mysqli_query($con,$sel_query);
//echo   $bt;
echo "Pending Consent Form List For Approval"; 
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target="_blank" href="mc_format_view1?id=<?php echo $row["id"]; ?>"><strong>View</a> </td>
	  
	  <td align="center"><a href="edit_consent?id=<?php echo $row["id"]; ?>"><strong>Edit</strong></a></td>
	  
	  <td align="center"><a onclick="return confirm_click();" href="con_approve?id=<?php echo $row["id"]; ?>"><strong>Approve</strong></a></td>
	  
	  	  
	  
	  
	  <td align="center"><a onclick="return confirm_click1();" href="con_reject?id=<?php echo $row["id"]; ?>"><strong>Reject</strong></a></td>
