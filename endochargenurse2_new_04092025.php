...
$ins_query1="insert into endohoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`rfid`,`adate`,`brand`,`price`,`ieid`) values 
...
{
$ins_query1="update endohoscharge1 set pdos='$pdos2',price='$tprice2' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into endohoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`rfid`,`adate`,`brand`,`reuse`,`price`,`ieid`) values 
...
{
$ins_query1="update endohoscharge1 set pdos='$pdos2',price='$new_charge_price1' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<td colspan="10" align="center"><input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="browsers2" autocomplete="off" name='medi1' required style="font-weight: bold;font-size:22px;color:green">
  <datalist id="browsers2">
        ...
        <?php } ?>  </datalist></td>
			...
			<td  colspan="5"align="center"><input type="browsers11" name="pdos" class="form-control" required>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="endohosdelete1_new?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&id1=<?php echo "$id"; ?>&rfid=<?php echo $row['rfid']; ?>&pdos=<?php echo $row['pdos']; ?>&reuse=<?php echo $row['reuse']; ?>">DELETE</a></td>
