...
$query = mysqli_query($db,"select * from imedi3 where id='$id'");
$data = mysqli_fetch_array($query);

$query3 = mysqli_query($db,"select * from phar_sale where iidd='$id'");
$data3 = mysqli_fetch_array($query3);


$mo_name=$data['orderby'];
...
$query_pa = mysqli_query($db,"select * from inpatient where eid='$patient_eid' and pmrn='$patient_pmrn'");
...
$pdf->Cell('38',5,$data['donet'],1,0,'L');
$pdf->Cell('13',5,'Area:',1,0,'L');
$pdf->Cell('49',5,$data3['location'],1,1,'L');

$pdf->ln(3);

$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('40',5,'Doctor Name:',1,0,'L');
$pdf->Cell('141', 5,$data_patient['adoc'],1,1,'L');
