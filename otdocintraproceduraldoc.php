...
$sel_query="SELECT * from otpac where pmrn='$pmrn' and eid='$id'"; 
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td colspan="10"><a target='_blank' href="otanaesprint?id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
