<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('ot','bio','staff','nurse','emergency','endo')"; 
...
$sel_query="Select * from storenew where trans_to in ('Nursing Services','ICU','OT','IPD','EPI','NICU','A&E','Endoscopy','Dialysis') ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
  ...
  <td><a target='_blank' href="transfer_to_nurse.php?id=<?php echo $row['id']; ?>">Transfer to</a></td>	
				        
	       
 <td><a target='_blank' href="dmsend.php?id=<?php echo $row['id']; ?>">Send For Servecing</a></td>	
