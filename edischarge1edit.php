...
$update="update discharge1 set dname='$dname', discharge='$discharge',ddia='$ddia', surgery='$surgery', ill='$ill', other='$other', plan='$plan', dinves='$dinves' where `eid`='$eid' and pmrn='$pmrn'";
