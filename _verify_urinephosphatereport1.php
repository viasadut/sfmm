...
$query = mysqli_query($db,"select * from 24urinephosphate where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('31',5,'mL/24hrs',1,0,'C');
$pdf->Cell('40',5,'800-1500',1,1,'C');

$pdf->Cell('80',5,'24 Hours Urine Phosphate',1,0,'C');
$pdf->Cell('30',5,$data['uc'],1,0,'C');
$pdf->Cell('31',5,'mg/24hrs',1,0,'C');
$pdf->Cell('40',5,'400-1300',1,1,'C');
