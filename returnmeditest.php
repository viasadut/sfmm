...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status in('Cancel','Active') and status1 in('Rupdated','Cancel') and pstatus='Served' order by `infusion` asc;",$prop);
...
$prop = array('HeaderColor'=>array(255,150,100),
			...
			'color4'=>array(255,255,210),
            'padding'=>2);
$pdf->Table($link,"Select * from iinfusion where pmrn= '$pmrn' and eid='$eid'and status in('Cancel','Data Updated') and status1 in('Active','Cancel') and pstatus='Served' order by `infusion` asc;",$prop);
$pdf->Output();
?>