...
else if(empty($_REQUEST['add']) && empty($_REQUEST['add1'])){
	

 	
       $ins_query="insert into otendoinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
values ( '$pmrn','$id','$pname','','$page','$adm','$psex','$pphone','$date','$infu','$user','Data Updated','$alert','Active','$adate','$time','NA','$otime1','$infu1','NA','NA','NA','Ordered','$ortime')";
mysqli_query($con,$ins_query) or die(mysql_error());
       ...
       $ins_query="insert into otendoinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
values ( '$pmrn','$id','$pname','','$page','$adm','$psex','$pphone','$date','$infu','$user','Data Updated','$alert','Active','$adate','$time',' $add','$otime1','$infu1','NA','$qty1','NA','Ordered','$ortime')";
mysqli_query($con,$ins_query) or die(mysql_error());
       ...
       $ins_query="insert into otendoinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
values ( '$pmrn','$id','$pname','','$page','$adm','$psex','$pphone','$date','$infu','$user','Data Updated','$alert','Active','$adate','$time','NA','$otime1','$infu1','$add1','NA','$qty2','Ordered','$ortime')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
$ins_query="insert into otendoinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
values ( '$pmrn','$id','$pname','','$page','$adm','$psex','$pphone','$date','$infu','$user','Data Updated','$alert','Active','$adate','$time',' $add','$otime1','$infu1',' $add1','$qty1','$qty2','Ordered','$ortime')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
<tr>
	  ...
	  <td colspan="20"align="right"><strong><button type="submit" name="Submit">Confirm</button></td>
</tr>
...
//$episode=$data["eid"];
$count=1;
$sel_query="Select * from otendoinfusion where pmrn= '$pmrn'and eid='$id'and odate='$ad' and status1='Active' and status !='given' order by `ddate` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="otiinfuupdate1endo?id3=<?php echo $row["id"]; ?>&id=<?php echo $id; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
...
//$episode=$data["eid"];
$count=1;
$sel_query="Select * from otendoinfusion where pmrn= '$pmrn'and eid='$id'and odate='$ad' and status='given' order by `ddate` DESC;";
...
<td align="center"colspan="1"><?php echo $row["cdate"]; ?></td>
