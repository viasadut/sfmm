...
$ins_query="insert into fnac (`dname`,`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`cfind`,`rfor`,`guide`,`remarks`,`adate`,`adate1`,`specimen`) values 
('$doc','$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$rfor','$guide','NOT SEEN','$adate','$adate1','$specimen')";
...
<!-- Form Title -->
		<h1>FNAC / CORE BIOPSY REQUEST FORM</h1>
        ...
        <fieldset>
			...
			<input name="doc" type="text" size="70" value="<?php echo $full;?>"required readonly />
	  ...
	  <tr><td colspan="20"><label><strong>Specimen:</strong></label></td>  </tr>
						 <tr><td colspan="20"><input type="text" size="75" name="specimen" style="text-transform:uppercase" required value="" /></td>  </tr>
      <label for="age"><strong>Clinical Findings :</strong></label>
	  	<textarea size="100" name="diagnosis"></textarea>
		      <label for="age"><strong>Request For :</strong></label>
		<select name="rfor" value="" class="style1"required>
			        <option value=''>-Select-</option>
					<option value='FNAC'>FNAC</option>
					<option value='Core Biopsy'>Core Biopsy</option>
				
			</select>
		<label for="age"><strong>Guidance :</strong></label>
	  	<select name="guide" value="" class="style1"required>
			        <option value=''>-Select-</option>
