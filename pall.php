...
<h1 align="center"style="background-color:lightgreen;">INPATIENT DETAILS TREATMENT SUMMARY </h1>
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
		<tr><td colspan="20" align="right"><a href="edocgcs?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Patient Triage<b></a></td></tr>
...
<tr><td colspan="20"><?php echo $data["padd"]; ?></td></tr>
		...
		<tr>
             		...
             		<td colspan="5"><?php echo $data["date"]; ?></td>					 	
...
<tr><td colspan="20" align="center"bgcolor="skyblue"><label><strong>Patient's Infusion Summary</strong></label></td> </tr>
...
$episode=$data59["eid"];
$count=1;
$sel_query="Select * from infusion where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
<tr><td colspan="20" align="center"bgcolor="skyblue"><label><strong>Patient's Investigation Summary</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Patient's Name</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
...
$count=1;
$sel_query="Select * from inves where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
{ ?>    <tr>
    ...
    <?php $count++; } ?>
<tr><td colspan="20" align="center"bgcolor="skyblue"><label><strong>Patient's Stat Medication Summary</strong></label></td> </tr>	
	<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Patient's Name</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
...
$count=1;
$sel_query="Select * from stat where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
{ ?>    <tr>
    ...
    <?php $count++; } ?>
	<tr><td colspan="20" align="center"bgcolor="skyblue"><label><strong>Patient's High Alert Medication</strong></label></td> </tr>
	<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Patient's Name</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      ...
      <td colspan="4" align="center"><strong>Done Date</strong></td>
      <td colspan="2" align="center"><strong>Done Time</strong></td>
       <td colspan="3" align="center"><strong>High Alert Medication</strong></td>
...
$count=1;
$sel_query="Select * from hmedi where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
<tr><td colspan="20" align="center" bgcolor="skyblue"><label><strong>Patient's Special Treatment</strong></label></td> </tr>	
...
$count=1;
$sel_query="Select * from stret where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
{ ?>    <tr>
	...
	<tr><td colspan="20" align="center" bgcolor="skyblue"><label><strong>Patient's Diet</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from idiet where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
<tr><td colspan="20" align="center"bgcolor="skyblue"><label><strong>Nurse's Note</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from cnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
