...
$querya = mysqli_query($db,"select COUNT(pmrn) from weight_loss where pmrn='$pmrn' and status='Active'");
...
if($dataa['COUNT(pmrn)']>0){
	
echo '<script language="javascript">';
    echo 'alert("Sorry !! Patient is Already Enrolled in the Weight Loss program"); ';
    echo '</script>';
	
}
else if ($dataa['COUNT(pmrn)']==0){
$ins_query="insert into weight_loss (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`,`sdate`,`remarks`,`status`,`sid`,`type`) values
('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$sdate','$remarks','Active','$sid','$staff')";
mysqli_query($con,$ins_query);

$message = 'Dear '.$pname.', Your Enrollment under Weight Loss Program is successful. wish you success in this program.';
			header("location:/sfmm/weight_loss/public/posprint?message=$message&phone=$pphone");
...
<!-- Form Title -->
      ...
      <input name="pphone" type="number" size="13" value="<?php echo $data59['pphone'];?>" placeholder="Phone No" required readonly>	  
