...
$query2 = mysqli_query($db,"select * from endolab where pmrn='$pmrn' and eid='$eid'");
...
$pdf->Cell('95',5,$data['dreffer'],0,1,'L');
...
$query1 = mysqli_query($db,"select * from endolab where pmrn='$pmrn' and eid='$eid'");
