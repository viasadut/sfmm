...
$ins_query1="insert into endohoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`ieid`,`type`) values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$tprice','$ieid','$sub_type')";
