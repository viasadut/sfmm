...
{ ?>    <tr>
	  ...
	  if($ddt<=$row['date1'])
	  {echo
  	  '<td colspan="1"><input type="button" name="edit_co" value="Edit" id="'.$row['id'].'" class="btn btn-info btn-xs edit_data_co" /></td>';
	  }
	  ?>
      </tr>
    <?php $count++; } ?>
...
{ ?>    <tr>
 ...
 <?php 
	  ...
	  if($ddt<=$row['date1'])
	  {echo
  	  '<td colspan="1"><input type="button" name="edit_co_p" value="Edit" id="'.$row['id'].'" class="btn btn-info btn-xs edit_data_cop" /></td>';
	  }
	  ?>
...
<?php 
	  ...
	  if($ddt<=$row['date4'])
	  {echo
  	  '<td colspan="1"><input type="button" name="edit_co_sp" value="Edit" id="'.$row['id'].'" class="btn btn-info btn-xs edit_data_cosp" /></td>';
	  }
	  ?>
...
<?php 
	  ...
	  if($ddt<=$row['date7'])
	  {echo
  	  '<td colspan="1"><input type="button" name="edit_co_temp" value="Edit" id="'.$row['id'].'" class="btn btn-info btn-xs edit_data_cotemp" /></td>';
	  }
	  ?>
...
<?php 
	  ...
	  if($ddt<=$row['date7'])
	  {echo
  	  '<td colspan="1"><input type="button" name="edit_co_rr" value="Edit" id="'.$row['id'].'" class="btn btn-info btn-xs edit_data_corr" /></td>';
	  }
	  ?>
