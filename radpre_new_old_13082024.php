...
$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`report1`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`ac_no`,`status1`,`ineid`,`emerid`,`price`,`done_date`,`code`) 
values ('$full', '$pm','$pn','$pa','$ps','$pp','$dreffer','$cdetails','$plaintext','$pd','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no','Updated By Technologist','$ineid','$emerid','$price','$date_d','$price_code')";
...
if($location=='OPD'){
  $update="update alltest set resultstatus='Confirmed By Consultant',rdate='$date',resulttime='$add_time' where `id`='$a_no'";
  mysqli_query($con,$update);
...
if($location=='Inpatient'){
  $update="update iinves set resultstatus='Confirmed By Consultant',resulttime='$add_time' where `id`='$new_ano'";
  mysqli_query($con,$update);
...
if($location=='A&E'){
  $update="update einves set resultstatus='Confirmed By Consultant',resulttime='$add_time' where `id`='$new_ano'";
  mysqli_query($con,$update);
...
if($location=='Inpatient'){
  $update="update iinves set resultstatus='Confirmed By Consultant',rdate='$date',resulttime='$add_time' where `id`='$new_ano'";
  mysqli_query($con,$update);
...
if($location=='A&E'){
  $update="update einves set resultstatus='Confirmed By Consultant',rdate='$date',resulttime='$add_time' where `id`='$new_ano'";
  mysqli_query($con,$update);
