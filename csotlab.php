...
$query = mysqli_query($db,"select * from ot where pmrn='$pmrn' and id='$eid'");
$data = mysqli_fetch_array($query);

$query2 = mysqli_query($db,"select * from otlab where pmrn='$pmrn' and eid='$eid'");
...
$pdf->Cell('183',6,'CS REQUEST FORM',1,1,'C');
//$this->SetFont('Arial','B',);
$pdf->ln(1);
$pdf->SetFont('Arial' , 'b' , 9);

$pdf->Cell('160',5,'DATE:',0,0,'R');
$pdf->Cell('23',5,$data2['date'],0,0,'R');
...
$pdf->Cell('182',5,'CS Request:',0,1,'L');
$query1 = mysqli_query($db,"select * from otlab where pmrn='$pmrn' and eid='$eid'");
