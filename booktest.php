...
('$dname', '$pname','$pmrn','$pphone','$diagnosis','$psex','$page','$adate','$otdate','$bkdate','$bt','$tp','$lx3','$lx','$duration','$otherins','$sprequire','$remarks','$typeo','$bt3','$bt4','$date5','$typeot')";
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="10"><input type="text" name="dname1" required value="<?php echo $full; ?>" readonly/>
