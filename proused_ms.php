...
$query = mysqli_query($db,"select * from m_suite where id='$id'");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from prohoscharge_ms where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from promediused_ms where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
