...
$query43 = "SELECT COUNT(sid) FROM conleavedetails where sid= '$bt' and status='Approved By ALL' and sdate BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from conleavedetails where sid= '$bt' and status='Approved By ALL' and sdate BETWEEN '$start' and '$end' order by id desc;"; 
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo date('d/m/Y',strtotime($row["sdate"])); ?>
      <td align="center"><?php echo date('d/m/Y',strtotime($row["edate"])); ?>  
