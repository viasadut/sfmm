...
*/
$sql = "insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`,`remarks`,`ip`,`op`,`acct_code`,`ccentre`) values 
('$pmrn','$pname','$ii','$eid','$date1','$pdos','$dcode','$t_price','$date2','$sub_type','Package','$ip','$op','$acode','$ccentre')";
...
$sql = "insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`,`ip`,`op`,`acct_code`,`ccentre`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$sub_type','$ip','$op','$acode','$ccentre')";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
         ...
         <a href="inhosdelete?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&invoice_no=<?php echo $row['invoice_no']; ?>&admission_no=<?php echo $api_adminssion_no; ?>&code=<?php echo $rrt; ?>&pdos=<?php echo $row['pdos']; ?>">DELETE</a>
