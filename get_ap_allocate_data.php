...
$sql="SELECT * FROM acct_ap WHERE creditor_code = '".$q1."' and status in ('AP DONE','Partially Paid') order by id asc";
$result = mysqli_query($con,$sql);
$count=1;

echo "<form><table width='100%' height ='100%' border='1' align='center' bgcolor='#FFFF99' style='border-collapse:collapse;'>
<tr>
...
$sql4="SELECT COUNT(id) as t_count FROM acct_ap WHERE creditor_code = '".$q1."' and status in('AP DONE','Partially Paid') order by id asc";
$result4 = mysqli_query($con,$sql4);
$data_count=mysqli_fetch_array($result4);


echo"<tr><td colspan='30' align='right'>";


if($data_count['t_count']>0)
{echo "<a target='_Blank' href='prepare_ap_cheque?cname=".$q1."'>Prepare Cheque</a>";}
