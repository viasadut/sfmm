...
$query = mysqli_query($db,"select * from chikun where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'Chikungunya IgM',1,0,'C');
$pdf->Cell('30',5,$data['chikun1'],1,0,'C');
$pdf->Cell('31',5,'',1,0,'C');
$pdf->Cell('40',5,'Negative',1,1,'C');

$pdf->Cell('80',5,'Chikungunya IgG',1,0,'C');
$pdf->Cell('30',5,$data['chikun2'],1,0,'C');
$pdf->Cell('31',5,'',1,0,'C');
$pdf->Cell('40',5,'Negative',1,1,'C');
