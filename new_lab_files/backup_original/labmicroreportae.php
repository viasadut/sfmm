...
$eid=$_REQUEST['eid'];
$sno=$_REQUEST['sno'];
$query3 = mysqli_query($db1,"select * from einves where pmrn='$pmrn' and eid='$eid' and id='$id'");
...
{
	$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('30',5,'Other Comments:',0,1,'L');
$pdf->MultiCell('180',5,$data6['ocom'],0,1);
}
...
$pdf->SetFont('Arial' , 'b' , 10);
//$pdf->Cell('182',5,'Printed by:'.$user.' ('.$date.')                                      Computer Generated Report, No Signature Required.',0,1,'R');
$pdf->Cell('182',5,'Printed by:'.$user.' ('.$date.')',0,1,'L');
