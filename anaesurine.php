...
$query198 = mysqli_query($db,"SELECT SUM(infusion) FROM anaesurine where pmrn='$pmrn'and eid='$eid'"); 
...
$ins_query="insert into anaesurine (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
$count=1;
$sel_query="Select * from anaesurine where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
