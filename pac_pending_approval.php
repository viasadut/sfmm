...
<tr> <td colspan="20"></td> </tr>
  ...
  <tr> <td colspan="20"></td> </tr>
  <tr> <td colspan="20"></td> </tr>
  <tr> <td colspan="20" bgcolor="#ffbd1b" style="font-weight:bold;color:black;font-size:24px;"><b>Pending PAC Report<b> </td> </tr>
  <tr> <td colspan="20"></td> </tr>
  <tr> <td colspan="20"></td> </tr>
  <tr> <td colspan="20"></td> </tr>
  <tr> <td colspan="20"></td> </tr>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from pac_new where status1='Updated' and dname1='$full' order by id desc;";
    ...
    <tr>
	  ...
	  <td align="center"><?php echo $row["ron"]; ?></td>
	  	  <td align="center"><?php echo $row["location"]; ?></td>
	  	   <td align="center"><a target='_blank' href="pac_report1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Report</a></td>
	  ...
	  <a href="pac_report_edit_doc_new?id='.$row["id"].'&pmrn='.$row["pmrn"].'&loc='.$row["location"].'&lid='.$row["lid"].'">Edit/Confirm</a>';
	  }
