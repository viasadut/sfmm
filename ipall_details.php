...
$count=1;
$sel_query="Select * from inhoscharge where pmrn= '$pmrn' and eid='$eid' and medi='$medi' order by `date` DESC;";
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198 = "SELECT SUM(price) FROM inhoscharge where pmrn= '$pmrn' and eid='$eid' and medi='$medi'"; 
