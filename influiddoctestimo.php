...
$count=1;
$sel_query="Select * from influid where pmrn= '$pmrn' and eid='$eid' group by date desc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><font size="6.5" ><a target='_blank' href="influiddoctest1imo.php?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&date=<?php echo $row["date"]; ?>"><strong><?php echo $row["date"]; ?></td>
