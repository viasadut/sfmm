...
$query2 = "SELECT * from emergency where pmrn='$pmrn' and eid='$eeid'"; 
...
$ins_query="insert into ecg (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`ron`,`vent`,`qwave`,`arate`,`st`,`rhy`,`twave`,`pwave`,`qt`,`pr`,`qtc`,`qrs`,`uwave`,`qrsc`,`ebeats`,`qrsvol`,`others`,`eaxis`,`poro`,`comments`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`,`datenew`) 
values('$dname','$select','$pmrn','$pname','$page','$psex','$pphone','$ron','$vent','$qwave','$arate','$st','$rhy','$twave','$pwave','$qt','$pr','$qtc','$qrs','$uwave','$qrsc','$ebeats','$qrsvol','$others','$eaxis','$poro','$comments','$count1','$date1','$date2','$stime','Updated','AE','$datenew')";
...
//$id1=$_REQUEST['ID'];
//$url = "tescath";
$query90 = "UPDATE einves set rby='$fullname',rtime='$dtime',rstatus='RECEIVED' where id='$id'"; 
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="viewradrecord?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo $row['dreffer'];?>"><b>See Clinical Details<b></a></td></tr>
				...
				<td colspan="10" ><input type="text" name="dname"  required value="A&E" readonly/></td>
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $row2['pmrn'];?>" readonly/></td>
					 <td colspan="10"><input type="text" name="pname" required value="<?php echo $row2['pname'];?>" readonly/></td>
		...
		<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="page" required value="<?php echo $row2['age'];?>" readonly/></td>  
             		
					 <td colspan="5"><input type="text" name="psex" required value="<?php echo $row2['gender'];?>" readonly/></td>
					 <td colspan="5"><input type="text" name="pphone" required value="<?php echo $row2['pphone'];?>" readonly/></td>  
