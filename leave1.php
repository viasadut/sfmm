...
if($tleave=='Annual Leave' && $diff1<$al){
	...
	$ins_query1="insert into dleave (`sdate`,`edate`,`uname`,`tleave`,`total`,`reason`,`HOS`,`dept`,`hstatus`,`type`,`bal`) values ('$sdate','$edate','$user','$tleave','$diff1','$reason','$hos','$idept','Approval Pending','aleave','$al1')";
...
else if($tleave=='Emergency Leave' && $diff1<$el){
	
	$ins_query1="insert into dleave (`sdate`,`edate`,`uname`,`tleave`,`total`,`reason`,`HOS`,`dept`,`hstatus`,`type`,`bal`) values ('$sdate','$edate','$user','$tleave','$diff1','$reason','$hos','$idept','Approval Pending','eleave','$el1')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>
						...
						<td colspan="7"><label><strong>Annual Leave</strong></label></td>
						<td colspan="7"><label><strong>Emergency Leave</strong></label></td>				
						<td colspan="6"><label><strong>Sick Leave</strong></label></td>
...
<tr>				 
					<td colspan="7"><input type="text1" name="aleave"   value="<?php echo $al;?>" readonly/></td>
					<td colspan="7"><input type="text1" name="eleave"  value="<?php echo $el;?>" readonly/></td>
					<td colspan="6"><input type="text1" name="sleave" required value="<?php echo $sl;?>" /></td>  	
