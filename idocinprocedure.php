...
$ins_query="insert into iprocedure (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Consultant Procedure Charge Form</strong></label></td> </tr>
<tr><td colspan="12" align="center"bgcolor="lightblue"><label><strong>Name Of the Procedure</strong></label></td>
<td colspan="8" align="center"bgcolor="lightblue"><label><strong>Charge</strong></label></td>
 </tr>
<tr>
