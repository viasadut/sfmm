...
$query5 = mysqli_query($con,"select * from urinepcratio where pmrn='$pmrn' and sno='$sno'");
...
if(isset($_POST['Submit'])){
    ...
    $adate1= date('m/d/Y');
    $rr='Protine, Urine:'.$chikun1."<br />".'Creatinine Urine:'.$chikun2."<br />".'Urine Protine / Creatinine Ratio:'.$chikun3;
    $rr1='Protine, Urine:'.$chikun1.' '.'mg/L'."<br />".'Creatinine Urine:'.$chikun2.' '.'mmol/L'.'Urine Protine / Creatinine Ratio:'.$chikun3.' '.'mg/mmoL';

// $ins_query1="insert into urinepcratio (`pname`,`pmrn`,`psex`,`page`,`uv`,`uc`,`ratio`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
// ('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$chikun3','$user','$adate','$eid','$iname','$id','$sno')";
// mysqli_query($con,$ins_query1) or die(mysql_error());

    $ins_query1="UPDATE urinepcratio SET
        `uv`='$chikun1',
        `uc`='$chikun2',
        `ratio`='$chikun3',
        `uby`='$user',
...
<body>
    ...
    <form action="" method="post">
        <!-- Form Title -->
        <h1>Urine Protein/Creatinine Ratio 24hrs </h1>
        <fieldset>
            <legend></legend>
            <!-- Name Input -->
            ...
            <label for="age"><strong>URINE PROTINE / CREATININE RATIO Report:</strong></label>

            <label for="tibc"><strong>Protine, Urine</strong></label>
            ...
            <label for="tibc"><strong>Urine Protine / Creatinine</strong></label>
