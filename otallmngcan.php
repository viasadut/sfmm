...
$query43 = "SELECT COUNT(pmrn) FROM ot where date5 BETWEEN '$start' and '$end' and status IN ('Cancel');"; 
...
<h1 align="center">All Cancel OT Stats</h1>
...
$count=1;
$sel_query="Select * from ot where date5 BETWEEN '$start' and '$end' and status IN ('Cancel');";
