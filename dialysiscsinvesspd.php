...
function Header()
{
    ...
    $this->Cell(0,6,' Dialysis Suite Investigation Request Form',0,1,'C');
...
$dd=date('m/d/Y');
$dd1=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from dialysislab where pmrn='$pmrn' and eid='$eid' " );
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from dialysislab where pmrn='$pmrn' and eid='$eid' and date='$dd' and status='Ordered' and type='spd1'",$prop);
$pdf->Output();
?>