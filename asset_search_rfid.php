...
<ul>
 ...
 <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><input name="CheckAll" type="text" id="CheckAll" ></td>  
					<td>	<button type="submit" name="bsearch">Search</button></td>
					<button type="button" name="view" class="btn btn-info view" id="'.$row["id"].'" >View</button>
					 </tr>
  <br /><br />
  <div class="container">
...
<p align="right"><div2>
   ...
   <table border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;" id="myTable">
     ...
     <tr>
	  ...
	  <tr><input style="background-color: lightgreen;" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search By Product Name.." title="Type in a Discipline"></tr>
     </tr>
