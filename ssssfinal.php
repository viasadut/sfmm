...
?> 
		...
		<td colspan="3"><input type="text" name="add" id="add"class="form-control"/></td>

		<td colspan="3"><input type="text" name="con" id="con"class="form-control"/></td>
		
			<td colspan="3">
			<input type="text" name="con1" id="con1"class="form-control"/>
