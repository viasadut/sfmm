...
<tr>				<td colspan="10"><?php echo $pm;?></td>
		...
		<tr>
			    	 ...
			    	 <td colspan="2"><?php echo $row['mstatus'];?></td>
              		 <td colspan="2"><?php echo $row['height'];?></td>	
					 <td colspan="2"><?php echo $row['weight'];?></td>    
					 <td colspan="2"><?php echo $row['temp'];?></td>  
             		 <td colspan="2"><?php echo $row['ppluse'];?></td>					 	
					 <td colspan="2"><?php echo $row['pbp'];?></td>
					 <td colspan="2"><?php echo $row['pbmi'];?></td>  
...
<td colspan="2"><?php echo $row['pthyroid'];?></td>
<td colspan="2"><?php echo $row['pneuro'];?></td>
<td colspan="2"><?php echo $row['psurgery'];?></td>
...
<tr>
<td colspan="2"><?php echo $row['palcohol'];?></td>
<td colspan="2"><?php echo $row['psmoking'];?></td>
<td colspan="2"><?php echo $row['pperiod'];?></td>
<td colspan="2"><?php echo $row['plmp'];?></td>
<td colspan="2"><?php echo $row['pnochild'];?></td>
<td colspan="2"><?php echo $row['plchild'];?></td>
<td colspan="2"><?php echo $row['pmeno'];?></td>
<td colspan="2"><?php echo $row['pfamily'];?></td>
<td colspan="2"><?php echo $row['pdrug'];?></td>
<td colspan="2"></td>
