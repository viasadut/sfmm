...
$query5 = mysqli_query($db,"select * from liver where sno='$sno'");
...
/*$rr='Total Bilirubin:'.$tb."<br />".'SGOT/AST:'.$sgot."<br />".'SGPT/ALT:'.$sgpt."<br />".'Alkaline Phosphatase:'.$al."<br />".'Direct Bilirubin:'.$ddb;

$rr1='Total Bilirubin:'.$tb.' '.'umol/L'."<br />".'SGOT/AST:'.$sgot.' '.'U/L'."<br />".'SGPT/ALT:'.$sgpt.' '.'U/L'."<br />".'Alkaline Phosphatase:'.$al.' '.'U/L'."<br />".'Direct Bilirubin:'.$ddb.' '.'mg/dL';
...
$ins_query1="update liver set `tb`='$tb',`sgot`='$sgot',`sgpt`='$sgpt',`al`='$al',`db`='$ddb' where sno='$sno'";
...
<!-- Form Title -->
      ...
      <input name="tb" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['tb'];?>"required>
	  <label for="age"><strong>SGOT/AST:</strong></label>
      <input name="sgot" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['sgot'];?>"required>
	  <label for="age"><strong>SGPT /ALT:</strong></label>
      <input name="sgpt" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['sgpt'];?>"required>
	  <label for="age"><strong>Alkaline Phosphatase:</strong></label>
      <input name="al" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['al'];?>"required>
	  
      <label for="age"><strong>Direct Bilirubin:</strong></label>
      <input name="ddb" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['db'];?>"required>
