...
<h1 align="center"style="background-color:lightgreen;">TODAY'S TRANING AND EDUCATION TOPIC </h1>
<!-- Form Title -->
...
<td align="center"colspan="2"><a  target='_blank' href="tcmeview2?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">Details</td>  		
