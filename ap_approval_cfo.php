<?php  
 ...
 {  
      $query = "SELECT SUM(gtotal) as gtotal,creditor_name,bankno,date,remarks,chequeno FROM pms_bill_payment WHERE chequeno = '".$_POST["employee_id"]."' and approve_status in ('2','1','3')";  
