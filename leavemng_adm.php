...
$date= date('Y-m-d');
$count=1;
$sel_query="Select * from conleavedetails where status in ('Approved By ALL','Approval Pending','Approved By Replacement Consultant') and '$date' between sdate and edate";
//$start=$row["aadate"];
