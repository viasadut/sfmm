...
$ins_query="insert into iidiet (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
{
return confirm("Are you Sure to Order The Diet ?");
}
...
<h1 align="center"style="background-color:lightgreen;">INPATIENT STAT MEDICATION </h1>
<!-- Form Title -->
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Diet</strong></td>   
	  <td colspan="1" align="center"><strong>Route</strong></td>
	  
	  <td colspan="9" align="center"><strong>Detail Menu </strong></td>
	  <td colspan="2" align="center"><strong>Diet Time</strong></td>
	  <td colspan="2" align="center"><strong>Forward to Cafe</strong></td>
...
$dd=date('Y/m/d');
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$eid'and status1 !='Cancel' and status='Data Updated'and odate='$dd'order by `rtime` and `infusion` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row["dtime"]; ?></td>
	  	  
	  
	  
	  
	  <td align="center"colspan="9" > <?php echo $row["dmenu"];?></td>;
		
		  	  <td align="center"colspan="2"><?php echo $row["diettime"]; ?></td>

<td colspan="2" align="center"><a onclick="return confirm_click();" href="dietorder?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>&user=<?php echo "$user"; ?>"><strong>Order Diet</strong></a></td>	  
	...
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Diet Order Already Forwaded to Cafeteria</strong></label></td> </tr>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Diet</strong></td>   
	  <td colspan="1" align="center"><strong>Route</strong></td>
	  <td colspan="1" align="center"><strong>User Forwarded</strong></td>
      
      <td colspan="2" align="center"><strong>Forward Time</strong></td>
...
$dd=date('Y-m-d');
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$eid'and status='Diet Ordered'and odate='$dd'order by `rtime` and `infusion` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="2"><?php echo $row["otime"]; ?></td>
	  	  <td align="center"colspan="8"><?php echo $row["dmenu"]; ?></td>
		  	  <td align="center"colspan="2"><?php echo $row["diettime"]; ?></td>
