...
$query3 = "SELECT * FROM hos_discount where pmrn= '$pmrn' and eid='$eid' and date='$date1' and medi='$medi1' and location='IPD'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM hos_discount where pmrn= '$pmrn' and eid='$eid' and date='$date1'and medi='$medi1' and location='IPD'"; 
...
('$pmrn','$pname','$medi1','$eid','$date1','$price','$dcode','$price','$date2','$user','$time','$adoc','IPD')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query6="update preadm set dia1='$inves',cinfo='Improving',ddin='$adate2',ddrequest='Request',arequest='$price',aid='$sid',drsend='$drsend' where pmrn='$pmrn' and eid='$eid'";
...
<select name="item" class="con_charge21" id="con_charge1_test" onchange="GetDetail(this.value)">
