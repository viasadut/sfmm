...
$rr1='Dengue IgM- :'.$chikun1."<br />".'Dengue IgG:'.$chikun2;

$rr='Dengue IgM- :'.$chikun1."<br />".'Dengue IgG:'.$chikun2;
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Dengue Test:</strong></label>
	  <label for="iron"><strong>Dengue IgM</strong></label>
      <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="tibc"><strong>Dengue IgG</strong></label>
