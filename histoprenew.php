...
$date2=date('d/m/Y');
$stime=date("h:i:sa");
$ins_query="insert into fnacreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`date1`,`guide`,`hno`,`specimen`,`anote`,`date5`) 
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$date1','$guide','$hno','$specimen','$anote','$dd')";
