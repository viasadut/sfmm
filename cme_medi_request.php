<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','doctor')"; 
...
$sel_query="Select * from medicinerequest where rby='$full' ORDER BY id desc;";

$result = mysqli_query($con,$sel_query);
//echo   $bt;
//echo "Pending Generic Name's List For Approval"; 9
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["pcat"]; ?>  
		  ...
		  <td align="Left"><?php echo $row["rstatus"]; ?>  
