...
<h1 align="center">View Datewise Infusion List</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="20%"><strong>Infusion</strong></th>
      <th width="10%"><strong>Instruction</strong>
      <th width="5%"><strong>Order By</strong>   
      <th width="8%"><strong>Done Time</strong>
...
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid' and odate1 BETWEEN '$start' and '$end';";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["infusion"],'+',$row["addi"],'+',$row["add1"]; ?></td>
	  <td align="center"><?php echo $row["room"],'+',$row["qty1"],'+',$row["qty2"]; ?></td>      <td align="center"><?php echo $row["user"]; ?>  
	  <td align="center"><?php echo $row["ddate"]; ?>  

	  <td align="center"><?php echo $row["duser"]; ?>  
	  <td align="center" colspan="1"><a href="addinfusion?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo "$eid"; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["room"]; ?>&dname=<?php echo $user; ?>&alert=<?php echo $row["alert"]; ?>">ADD</a></td>
      </tr>
