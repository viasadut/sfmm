...
<p align="center" class="style1">Cathlab Stock </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medi_stock where add_qty>0 and location in('Cathlab') and status in('Served','Partially Served') ORDER BY g_name asc;";
