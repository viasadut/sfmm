...
$ins_query="insert into eidiet (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
{
return confirm("Are you Sure to UPDATE Medicine Status ?");
}
...
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid' and status!='Cancel' and status1='Rupdated' and odate='$dd' order by `time` asc;";
...
$idd=$row['id'];
$ps=$row['pstatus'];
$url8 = "imedi2test_new?pmrn=$pm&eid=$ed&id=$idd&user=$user"; 
?>
	  
<td colspan="1" align="center"><?php if($ps=='Served'){echo"<a href='$url8'><strong>UPDATE<strong></a>";} else{echo'';} ?></a></td>	  
...
//$episode=$data["eid"];
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn'and eid='$eid'and odate='$dd' and status1='Active' and status='Data Updated'order by `id` DESC;";
...
$idd=$row['id'];
$ps=$row['pstatus'];
$url8 = "inurseinfusion_new?pmrn=$pm&eid=$ed&id=$idd"; 
?>

	  
	  
	  
	  <td colspan="1" align="center"><?php if($ps=='Served'){echo"<a onclick='return confirm_click();' href='$url8'><strong>UPDATE<strong></a>";} else{echo'';} ?></a></td>	  
