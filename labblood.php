...
$ins_query="insert into iblood (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`bed`,`status`,`otime`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','$infu1','Data Updated','$otime')";
...
<tr>
      ...
      <td colspan="3" align="center"><strong>Done Date</strong></td>
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$episode' and bbstatus='' and status!='Cancel'  order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><?php echo $row["otime"]; ?></td>
  	  <td align="center"colspan="1"><?php echo $row["duser"]; ?></td>
	  
	  <td colspan="1"><a target='_blank' href="bar_patient.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$episode"; ?>&pname=<?php echo $row['pname']; ?>&bar=<?php echo $row['barcode']; ?>&rinfusion=<?php echo $row['room']; ?>">Barcode</a></td>
...
//$bno=$_REQUEST['bagno'];
//$url = "labblood23?id=$id1&pmrn=$pmrn1&eid=$eid1"; 

$url = "bcrosscom1?id=$id1&pmrn=$pmrn1&eid=$eid1&bbtype=$bbtype&bg=$bg"; 

	
{
echo"<a href='$url'><strong>Issue</strong></a>";
}
}
...
<td colspan="1"><a target='_blank' href="bloodrequest_test.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&id=<?php echo $row['id']; ?>"><img src="lab.png" title="Print Report" width="50" height="40" /></a></td>
	...
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Issued Blood List</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Requested By</strong></td>
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$episode' and bbstatus!=''  order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["location"]; ?></td>

  	  <td align="center">
<?php echo $row["bbstatus"]; ?>
