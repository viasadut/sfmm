...
if($m1==$_SESSION['sess_username']){
	
	$ins_query1="update incident1 set m1com='$com',status='Forwarded',m1date='$adate1' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());

 echo '<script language="javascript">';
    echo 'alert("successful !!"); ';
    echo '</script>';
$url = "incidentviewstaff1" ;
header("Location:$url");
}

else if($m2==$_SESSION['sess_username']){
	
	$ins_query1="update incident1 set m2com='$com',status='Forwarded',m2date='$adate1' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
header("Location:$url");
	...
	$ins_query1="update incident1 set m3com='$com',status='Forwarded',m3date='$adate1' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
header("Location:$url");
	...
	$ins_query1="update incident1 set m4com='$com',status='Forwarded',m4date='$adate1' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
header("Location:$url");
	...
	$ins_query1="update incident1 set m5com='$com',status='Forwarded',m5date='$adate1' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());
