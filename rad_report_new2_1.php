...
$query = mysqli_query($con,"select * from radreport where pmrn='$pmrn' and ac_no='$ac_no' and status='SEEN'");
            $data = mysqli_fetch_array($query);
                    
$dname1=$data['dname'];					
            $query3 = mysqli_query($con,"select * from doctor1 where dname='$dname1'");
