...
<!-- Form Title -->
      ...
      <input name="wcc" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>Neutrophil:</strong></label>
      <input name="ne" type="text" size="70" style="text-transform:uppercase" value=""required>
