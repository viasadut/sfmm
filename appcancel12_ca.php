...
$query43 = "SELECT COUNT(dname) FROM pappnew where dname= '$bt' and adate BETWEEN '$start' and '$end'and status NOT IN ('seen','Cancel') and bill !='Billed';";
...
$query139 = "SELECT * FROM staff3 where sid= '$user'"; 
...
<!-- Form Title -->
 ...
 <select id="pmrn" class="con_charge" list="categoryname" autocomplete="off" name='bt' required>

						<option value=''>-Select-</option>
				
				<?php 
			$sql = "select * from `doctor` where status='Active' and opd='$opd'";
...
$count=1;
$sel_query="Select * from pappnew where dname='$bt' and adate BETWEEN '$start' and '$end' and status NOT IN ('seen','Cancel') order by aslot asc;";
...
{ ?>    <tr>
	  ...
	  <td colspan="2" align="center"><a href="cancelapp_ca?id=<?php echo "$row[ID]"; ?>&user=<?php echo "$user"; ?>"><strong>CANCEL</strong></a></td>	  
      </tr>
