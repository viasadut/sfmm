...
$ins_query1="insert into edit_inves (`iname`,`iid`,`price`,`cprice`,`eid`,`fby`,`status`,`ceo`,`cfo`,`itby`,`md`,`code`,`aby`,`atime`,`type`,`oprice`,`ittime1`,`com_remarks`,`mar`,`com_price`) values 
('$mname','$id','$price','$cprice','$eid','338','Waiting For Finance Fowrading','ceo','cfo','322','md','$cat','$user','$adate','spd','$oprice','$ittime1','$com_remarks','$mar','$com_price')";
...
<!-- Form Title -->
	 ...
	 <label for="age"><strong>Code :</strong></label>
      <input name="cat" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["code"];?>"readonly>
	  ...
	  <label for="age"><strong>Present Price :</strong></label>
      <input name="price44" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["price"];?>"readonly>
	  
	  <label for="age"><strong>Proposed Price :</strong></label>
      <input name="price" id="price" type="text" size="70" style="text-transform:uppercase" value=""required>
  ...
  $("input").on("change", function() {
   // var ret = parseInt($("#field1").val()) - parseInt($("#field2").val())
    ...
    $("#mar").val(ret5);
      ...
      <input name="com_price" id="com_price" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  
	  	  <label for="age"><strong>Remarks:</strong></label>
      <textarea name="com_remarks" required rows='20'></textarea>
