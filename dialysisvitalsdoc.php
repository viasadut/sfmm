...
$query3 = "SELECT COUNT(hrd) FROM diaetco2 where pmrn='$pmrn' and date1='$odate1'"; 
...
$querybp = "SELECT COUNT(hrd) FROM diasbp where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypulse = "SELECT COUNT(hrd) FROM diapulse where pmrn='$pmrn' and date1='$odate1'"; 
...
$queryspo2 = "SELECT COUNT(hrd) FROM diaspo2 where pmrn='$pmrn' and date1='$odate1'"; 
...
$querytemp = "SELECT COUNT(hrd) FROM diatemp where pmrn='$pmrn' and date1='$odate1'"; 
...
$queryrr = "SELECT COUNT(hrd) FROM diarr where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypscore = "SELECT COUNT(hrd) FROM diacvp where pmrn='$pmrn' and date1='$odate1'"; 
...
$ins_query21="insert into diaetco2 (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','SPO2','$spo2','$count1','$user','$odate','$time')";
mysqli_query($con,$ins_query21) or die("Problem in entry");}

if (!empty ($_POST['sbp'])){
$ins_querybp="insert into diasbp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`vitails2`,`score2`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','sbp','$sbp','dbp','$dbp','$countbp1','$user','$odate','$time')";
mysqli_query($con,$ins_querybp) or die("Problem in entry");}

if (!empty ($_POST['pulse'])){
$ins_querypulse="insert into diapulse (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','Pulse','$pulse','$countpulse1','$user','$odate','$time')";
mysqli_query($con,$ins_querypulse) or die("Problem in entry");}

if (!empty ($_POST['spo2'])){
$ins_queryspo2="insert into diaspo2 (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','SPO2','$spo2','$countspo21','$user','$odate','$time')";
mysqli_query($con,$ins_queryspo2) or die("Problem in entry");}

if (!empty ($_POST['temp'])){
$ins_querytemp="insert into diatemp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','Temperature','$temp','$counttemp1','$user','$odate','$time')";
mysqli_query($con,$ins_querytemp) or die("Problem in entry");}

if (!empty ($_POST['rr'])){
$ins_queryrr="insert into diarr (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','RR','$rr','$countrr1','$user','$odate','$time')";
mysqli_query($con,$ins_queryrr) or die("Problem in entry");}

if (!empty ($_POST['cvp'])){
$ins_querypscore="insert into diacvp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','SPO2','$spo2','$countpscore1','$user','$odate','$time')";
...
$count=1;
$sel_query="Select * from diasbp where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from diapulse where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from diaspo2 where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from diatemp where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from diarr where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from diaetco2 where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from diacvp where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
