...
echo   $row43['COUNT(liver_opd)'];

echo $adate3;
	 $sel_query="Select * from pappnew where dname in ('SFMM LIVER CLINIC','Dr. Dinesh Jothimani','Dr. Naresh P Shanmugam','Dr. Kumar Palaniappan') and adate1='$adate3' and bill='BILLED' order by dname asc";
