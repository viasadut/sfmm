...
$mm = $_REQUEST['mm'];
$yy = $_REQUEST['yy'];
$approx_amount=$_REQUEST['approx_amount'];
//$fdate='$dd-$mm-$yy';
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`sid`,`approx_amount`) values 
('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','pending','$snew','$btype','$sid','$approx_amount')";
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`sid`,`approx_amount`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','pending','$snew','$btype','$sid','$approx_amount')";
mysqli_query($con,$ins_query);
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`approx_amount`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','Approved','$snew','$btype','$approx_amount')";
mysqli_query($con,$ins_query);
...
mysqli_query($con,$ins_query);
	...
	else if ($staff=='Corporate'){
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`approx_amount`) values 
('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','Approved','$snew','$btype','$approx_amount')";
mysqli_query($con,$ins_query);
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<legend></legend>
            <!-- Name Input -->
<label for="age" align="right"><strong><a target='_blank' href="con_ot_bill"><font size="4.5">Search Previous Procedure Cost</a></strong></label>
...
<label for="name"><strong>Patients Type:</strong></label>
			<select name="staff" required>
					...
					<option value='Staff Spouse'>Staff's Spouse</option>
...
<label for="age"><strong>Staff ID:</strong></label>
 ...
 <label for="age"><strong>Probable Date of Discharge  :</strong></label>
		...
		<label for="age"><strong>Approximate Cost :</strong></label>
		<input type="text" class="style1" name="approx_amount"  placeholder="Approximate Cost" size="15" required>
...
<td colspan="10">		<a target='_blank' href="admdoc?pmrn=<?php echo "$pmrn"; ?>&adoc=<?php echo $full; ?>&rdate=<?php echo $date6;?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>
