...
$pdf->AddCol('room',80,'Blood Type');
$pdf->AddCol('bed',30,'Unit','C');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iblood where pmrn='$pmrn' and eid='$eid' and otime='$dd1' and status ='Data Updated'",$prop);
$pdf->Output();
?>