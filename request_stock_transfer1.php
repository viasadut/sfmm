...
$ins_query1m="insert into medi_stock1 (`code`,`g_name`,`b_name`,`add_qty`,`exdate`,`u_price`,`t_price`,`batch_no`,`rfid`)
 values ('$code_m','$g_name_m','$b_name_m','$mm_qty','$exdate_m','$u_price_m','$t_price_m','$batch_no_m','$code')";
...
$ins_query1m1="insert into medi_stock1 (`code`,`g_name`,`b_name`,`add_qty`,`exdate`,`u_price`,`t_price`,`batch_no`,`rfid`)
 values ('$code_m1','$g_name_m1','$b_name_m1','$sec_qty','$exdate_m1','$u_price_m1','$t_price_m1','$batch_no_m1','$rfid1')";
