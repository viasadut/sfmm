...
$sel_query="Select * from m_suite where pphone= '$pmrn' and ustatus='paid' and dname='$full'";}
 else{
	 $sel_query="Select * from m_suite where pmrn= '$pmrn' and ustatus='paid' and dname='$full';";
 } 
$count=1;	 
