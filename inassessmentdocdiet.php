...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessmentdoc1diet?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessmentdoceditdiet?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
								<tr>
