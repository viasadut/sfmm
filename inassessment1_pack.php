...
$query11 = "SELECT * from massess_pack where pmrn= '$pmrn' and eid='$eid'"; 
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessment_pack?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessment2_pack?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
...
<tr>				<td colspan="2"><?php echo $pm1;?></td>
					 ...
					 <td colspan="1"><?php echo $row['psex'];?></td>
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Personal Particulars / History :</strong></label></td></tr>
		...
		<tr>
					 ...
					 <td colspan="4"><?php echo $row11['aform'];?></td>
             		 <td colspan="4"><?php echo $row['sdate'];?></td>					 	
