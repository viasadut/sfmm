...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <th width="15%"><strong>eid</strong>
      <th width="14%"><strong>Doctor Name</strong>   
      <th width="14%"><strong>ADM Date</strong>
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="other_doc_upload?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
