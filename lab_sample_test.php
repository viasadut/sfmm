...
$two = substr($pincode, -2);
$three = substr($pincode, -3);
$one = substr($pincode, -1);
$four = substr($pincode, -4);

$pdate=date('Y-m-d H:i:s');  
$pdate1=date('d/m/Y H:i:s');  

echo $new_bar4=$two.date('md').'000'.'4';
...
//$one=			
			...
			$result=$_REQUEST['result'][$i];
			$new_bar1=$two.date('ymd').'000'.$mno;
			$new_bar2=$two.date('ymd').'00'.$mno;
			$new_bar3=$two.date('ymd').'0'.$mno;
			$new_bar4=$two.date('ymd').$mno;
