...
$query44 = "SELECT COUNT(pmrn) FROM deathn where rdoc='$full' and rdate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Datewise Death Stats</h1>
...
//$id=$_REQUEST["id"];
	 ...
	 $sel_query="Select * from deathn where rdoc='$full' and rdate BETWEEN '$start'and '$end' order by rdate asc";
