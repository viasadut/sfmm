...
$count1 = $count+1;
$query = "SELECT * from dialysispapp where pmrn= '$pmrn' and eid='$eid'"; 
...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from nurseassessedialysis where pmrn='$pmrn' and eid='$eid'"; 
...
$update="update nurseassedialysis set cname='$cname',crelation='$crelation',cphone='$cphone', astime='$astime', ma='$ma', acc='$acc', shistory='$shistory', language='$language', nip='$nip', edus='$edus', comor='$comor', valueableb='$valueableb', bodys='$bodys', du='$du', remarks='$remarks',cpatient='$cpatient',csite='$csite',cposition='$cposition',ctaken='$ctaken' where eid='$eid' and pmrn='$pmrn'";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"   value="<?php echo $pm1;?>" readonly/></td>
					 ...
					 <td colspan="5"><input type="text" name="pname"  value="<?php echo $pn1;?>" readonly/></td>
					  <td colspan="6"><input type="text" name="cname"  value="<?php echo $row3['cname'];?>" ></td>
					   <td colspan="3"><input type="text" name="crelation"  value="<?php echo $row3['crelation'];?>" ></td>
					    <td colspan="3"><input type="text" name="cphone"  value="<?php echo $row3['cphone'];?>" ></td>
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Personal Particulars / History :</strong></label></td></tr>
		...
		<tr>
					 ...
					 <td colspan="4"><select name="aform" placeholder="Admitted From" >
						<option value='<?php echo $row3['aform'];?>'><?php echo $row3['aform'];?></option>
					 ...
					 <td colspan="4"><input type="text" name="astime" style="background-color:skyblue;"required value="<?php echo $row3['astime'];?>" /></td>
...
<td colspan="3"><select name="ma" placeholder="Arrival Mode" >
						<option value='<?php echo $row3['ma'];?>'selected><?php echo $row3['ma'];?></option>
...
<td colspan="3"><select name="acc" placeholder="Arrival Mode" >
						<option value='<?php echo $row3['acc'];?>'selected><?php echo $row3['acc'];?></option>
						...
						<option value='<?php echo $row3['shistory'];?>'selected><?php echo $row3['shistory'];?></option>
						...
						<option value='<?php echo $row3['language'];?>'selected><?php echo $row3['language'];?></option>
						...
						<option value='<?php echo $row3['nip'];?>'selected><?php echo $row3['nip'];?></option>
						...
						<option value='<?php echo $row3['edus'];?>'selected><?php echo $row3['edus'];?></option>
...
<option value='<?php echo $row3['comor'];?>'selected><?php echo $row3['comor'];?></option>
...
<tr><td colspan="20"><textarea id="exampleTextarea" name="valueableb" rows="5" placeholder="Source Of History"><?php echo $row3['valueableb'];?></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Body/safety search:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="bodys" rows="5" placeholder="Chief Complaints"><?php echo $row3['bodys'];?></textarea></td>  </tr>	
...
<td colspan="10"><select name="du" placeholder="" >
						<option value='<?php echo $row3['du'];?>'selected><?php echo $row3['du'];?></option>
						<option value='Yes'>Yes</option>
						<option value='No'>No</option>
						</select></td>
						
						<td colspan="10"><input type="text" name="remarks" style="background-color:skyblue;"required value="<?php echo $row3['remarks'];?>" /></td>
</tr>
...
<td colspan="5"><input type="radio" name="cpatient" value="YES"<?php if($row3['cpatient']=="YES"){ echo "checked";}?>> YES &nbsp;&nbsp;<input type="radio" name="phyper" value="NO"<?php if($row3['cpatient']=="NO"){ echo "checked";}?>> NO &nbsp;&nbsp;</td>
<td colspan="5"><input type="radio" name="csite" value="YES"<?php if($row3['csite']=="YES"){ echo "checked";}?>> YES &nbsp;&nbsp;<input type="radio" name="phyper" value="NO"<?php if($row3['csite']=="NO"){ echo "checked";}?>> NO &nbsp;&nbsp;</td>
<td colspan="5"><input type="radio" name="cposition" value="YES"<?php if($row3['cposition']=="YES"){ echo "checked";}?>> YES &nbsp;&nbsp;<input type="radio" name="phyper" value="NO"<?php if($row3['cposition']=="NO"){ echo "checked";}?>> NO &nbsp;&nbsp;</td>
<td colspan="5"><input type="radio" name="ctaken" value="YES" <?php if($row3['ctaken']=="YES"){ echo "checked";}?>> YES &nbsp;&nbsp;<input type="radio" name="phyper" value="NO"<?php if($row3['ctaken']=="NO"){ echo "checked";}?>> NO &nbsp;&nbsp;</td>
						
						
</tr>


<tr><td colspan="20" bgcolor="lightgreen"><h3><a target='_blank' href="fallriskchemo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">Fall Risk Assessment(John Hopkins Tool)  </a></td></tr>					
