...
var countDownDate1 = new Date("Dec 31, 2024 18:59:59").getTime();
...
<img src="countdown/new_year_countdown.gif" height="150" width="290">

<p id="demo"></p>
<video height="190" width="300" loop autoplay muted controls id="vid">
         <source type="video/mp4" src="2025_1.mp4"></source>
...
<img src="countdown/sports_carnival.gif" height="170" width="290">


<p id="demo1"></p>
<img src="countdown/sport_back_drop.jpeg" height="170" width="290">
	...
	<div id="slider1_container1" style="visibility: hidden; position: absolute; left: 30px; top: 455px; width: 400px; height: 230px; overflow: hidden; align:center;">
			...
			<?php
					...
					//Get image data from database
					$result = $db->query("SELECT id, created FROM images_other order by created DESC  limit 3");
