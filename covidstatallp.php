...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="8%"><strong>Last date of contact with positive case</strong>
	  <th width="8%"><strong>contact duration</strong></th>
...
echo   $row43['COUNT(name)'];
	 ...
	 $sel_query="Select * from covid where fresult='P' order by ssent desc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php if($row["ldate"]=='1970-01-01') {echo '';} else {echo date('d/m/Y',strtotime($row["ldate"]));}?></td>
