...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and infusion ='$infu' and rstatus IN ('RECEIVED','REJECTED') order by rtime desc;";
...
{ ?>  
	  ...
	  <td align="center"><b><?php echo $row["rtime"]; ?></b><br><br><?php echo $row["result"]; ?></td>
