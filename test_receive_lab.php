...
$objConnect6 = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB6 = mysqli_select_db($objConnect6,"sfmmkpjnew");
$strSQL6 = "Select * from alltest where pmrn= '$pmrn' and location='Endoscopy' and type='lab' and rstatus ='RECEIVED' and billdate between '$test' and '$dd'";
$objQuery6 = mysqli_query($objConnect6,$strSQL6) or die ("Error Query [".$strSQL6."]");
?>
