...
`pasp`='$pasp',`padp`='$padp',`mvalve`='$lx12',`dvalve`='$lx13',`avalve`='$lx14',
`pvalve`='$lx15',`eorg`='$lx16',`tee`='$tee',`impression`='$impression',`advice`='$advice',`status1`='Confirmed',`find`='$find',`ewin`='$ewin',`ivc`='$lx115' where `pmrn`='$pmrn' and `eid`='$eid'";
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
					 ...
					 <tr>
						...
						<option value='<?php echo $rowett['ewin'];?>'><?php echo $rowett['ewin'];?></option>
...
<option value="<?php echo $rowett['ivc'];?>"selected></option>
<option value="Normal">Normal</option>
...
<tr><td colspan="20"><label><strong>Wall Motion:</strong></label></td>  </tr>
						 ...
						 <tr><td  colspan="20"align="center"><input list="browsers13" name="advice" class="form-control">
  <datalist id="browsers13">

						
						<option value='ECHO Colour Doppler'>ECHO Colour Doppler</option>
						<option value='Trans Esophageal ECHO'>Trans Esophageal ECHO</option>
						<option value='Follow up ECHO After.... Days'>Follow up ECHO After.... Days</option>
