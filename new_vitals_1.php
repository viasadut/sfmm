...
<td style='background-color:lightgreen;font-size:18px;font-weight:bold'>Value</td>
</tr>";

  echo "<tr>";
  echo "<td style='background-color:lightbllue;font-size:18px;font-weight:bold'>" . $q2 ."<br>8:00AM</td>";
