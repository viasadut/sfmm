...
if($res95=mysqli_num_rows($result95)==0)
{
    ...
    echo '</script>';
			...
			*/
			...
			$ins_query1="insert into medi_stock (`code`,`g_name`,`b_name`,`req_qty`,`add_qty`,`req_loc`,`status`,`location`,`rfid`,`sno`,`req_time`,`req_by`)
 values ('$code','$medi','$brand','$tprice','','$p_mrn1','Pending','$p_mrn1','$sno','$runningTime','$req_time','$user')";
mysqli_query($con,$ins_query1) or die(mysql_error());
			
			
$url = "phar_transfer_rad?sno=$sno";
header("Location: $url"); 
...
<input type="text" id="dept" class="form-control action" list="ddd" autocomplete="off" name='dept' required style="font-weight: bold;font-size:22px;color:green" value="<?php echo 'RAD';?>"readonly>
