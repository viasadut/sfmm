...
<tr>
      ...
      <td colspan="8" align="center"><strong>Medicine Code</strong></td>
	  <td colspan="5" align="center"><strong>Stock Table</strong></td>
     	  <td colspan="5" align="center"><strong>Medicine Table</strong></td>
	    ...
	    <?php 
                    $query = "select distinct(code) from medi_stock where location='Pharmacy' and code!='0'";
...
$sum2 = "SELECT tqty FROM medicine where code='$mcode'" ;
...
<td align="center"colspan="8"><input name="eqty1_<?= $count ?>" id="eqty1" type="text" value="<?php echo $mcode;?>" readonly style="font-size:20px;font-weight:bold;color:green;"></td>		       
...
<td align="center"colspan="5"><input class="iprice" name="eqty2uuu_<?= $id ?>" id="eqty2yyy" type="text" value="<?php echo $new_qty2;?>" style="font-size:20px;font-weight:bold;color:green;"></td>	
	 ...
	 <td align="center"colspan="1"><input type='checkbox' name='update[]' value='<?= $count ?>' ></td>						
