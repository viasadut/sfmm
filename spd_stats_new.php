...
$query43 = "SELECT COUNT(id) FROM ecg_test where ron= '$bt' and datenew BETWEEN '$start' and '$end' and con_by='$user';"; 
...
$query44 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by='$user';"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select End Date:</strong></label></td>	
							...
							<td colspan="3"><label><strong> Select Procedure</strong></label></td> 
					 ...
					 <td colspan="3"><select name="bt">
						...
						<?php 
			$sql = "select distinct(ron) from `ecg_test`";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->ron."'>".$row->ron."</option>";
				}
			}
			?>
...
$sel_query="Select * from ecg_test where  datenew BETWEEN '$start' and '$end' and con_by='$user' order by datenew desc";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['COUNT(id)'];
echo " ,  From  ";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from ecg_test where ron='$bt' and datenew BETWEEN '$start' and '$end' and con_by='$user' order by datenew desc ";
 } 
$count=1;
