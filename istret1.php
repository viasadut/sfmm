...
$query45 = mysqli_query($db,"select * from istret where pmrn='$pmrn' and id='$id'");
...
$update="update istret set bed='$dtime',ddate='$ddate', status='Rupdated', duser='$user' where `id`='$id'";
