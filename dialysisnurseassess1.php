...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessmentnurseendo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="nursesassessedit?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
