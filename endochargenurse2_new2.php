...
$ins_query1="insert into endohoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`rfid`,`adate`,`brand`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$code','$rfid','$adate','$bb_name')";
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`brand`,`pmrn`,`eid`,`rfid`,`status`,`location`,`code`) values
			('$g_name','$pdos','$u_price','$u_price','$user','$adate','$bb_name','$pmrn','$eid','$rfid','Sale','ENDOSCOPY','$code')";
...
{
$ins_query1="update endohoscharge1 set pdos='$pdos2' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into endohoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`rfid`,`adate`,`brand`,`reuse`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$c_code','$rfid','$adate','$bb_name','Yes')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`brand`,`pmrn`,`eid`,`rfid`,`status`,`location`,`code`,`reuse`) values
			('$g_name','$pdos','$u_price','$u_price','$user','$adate','$bb_name','$pmrn','$eid','$rfid','Sale','ENDOSCOPY','$c_code','Yes')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery2 = mysqli_query($con,$strSQL2);
...
<td colspan="10" align="center"><input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="browsers2" autocomplete="off" name='medi1' required style="font-weight: bold;font-size:22px;color:green">
  <datalist id="browsers2">
            ...
            require('db1.php');
            $uname = '';
            $query = "select * from `medi_stock` where add_qty>0 and location='ENDOSCOPY' and status='Served'";
