<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','staff','store','qc','doctor')"; 
...
{
return confirm("Are you Sure to Approve this ?");
}
...
<br><br><h2 align="center"style="background-color:red;"><strong>Present Members - <?php echo $data59["attn"]; ?></h2>
...
<tr><td colspan="20" align="center"bgcolor="lightblue"><h2><label><strong>Pending Request for Approval</strong></label><h2></td> </tr>
<tr bgcolor="#F08080">
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="10" align="center"><strong>Procedure Name</strong></td>
	  <td colspan="6" align="center"><strong>Request By</strong></td>
	  <td colspan="1" align="center"><strong>Request Date</strong></td>
      <td colspan="1" align="center"><strong>Approve</strong></td>
...
$count=1;
$sel_query="Select * from predoc where status='Pending' order by `rdate1` asc;";
...
{ ?>    <tr>
	...
	<td align="center" colspan="1"><?php echo $count; ?></td>      
     <td colspan="10" align="left"><?php echo $row["proname"]; ?></td>
	 <td colspan="6" align="left"><?php echo $row["rby"]; ?></td>
	 <td colspan="1" align="left"><?php echo $row["rdate"]; ?></td>
	 <td align="center"colspan="2"><a  onclick="return confirm_click1();" href="predoc3?id=<?php echo $row["id"]; ?>&id1=<?php echo $id; ?>&topic=<?php echo $ctopic; ?>">Approve</td>  		
	 <td align="center"><a href="predoc4?id=<?php echo $row["id"]; ?>&id1=<?php echo $id; ?>&topic=<?php echo $ctopic; ?>"><strong>Reject</strong></a></td>	   
