...
$count=1;
$sel_query="Select * from covidopd where sid= '$pmrn' and tp='staff' order by ID desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="isoadd?id=<?php echo $row["id"]; ?>">Add</a> </td>
