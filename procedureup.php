...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus='' order by ll asc ;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["proname"]; ?>  
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="procedureup1?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">UPDATE</a> </td>
		   <td align="center"><a onclick="return confirm_click();" href="procancel?id=<?php echo $row["id"]; ?>&cby=<?php echo $fullname; ?>"> Cancel</a></td>
...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus='Updated' and type='OPD' order by ll asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["proname"]; ?>  
	       ...
	       <td align="left" ><a target='_blank' href="prohoscharge?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>&type=<?php echo $row["type"];?>&ieid=<?php echo $row["ieid"];?>">Add Hospital Charges</a></td>
		   <td align="left" ><a target='_blank' href="promedicineused_new1?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>&type=<?php echo $row["type"];?>&ieid=<?php echo $row["ieid"];?>">Add Used Medication</a></td>
...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus='Updated' and type='inpatient' order by ll asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["proname"]; ?>  
	       ...
	       <td align="left" ><a target='_blank' href="prohoscharge?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>&type=<?php echo $row["type"];?>&ieid=<?php echo $row["ieid"];?>">Add Hospital Charges</a></td>
		   <td align="left" ><a target='_blank' href="promedicineused_new1?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>&type=<?php echo $row["type"];?>&ieid=<?php echo $row["ieid"];?>">Add Used Medication</a></td>
  		   <td align="left"><a target='_blank' href="proused.php?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
		   <td align="left"><a target='_blank' href="proreport.php?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
