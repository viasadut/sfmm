<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','staff','mng','ot','endo','imo','mofficer','nurse','emergency','moopd','lab','rad','admin1')"; 
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from conleavedetails where sdate between '2022-01-01' and '2022-12-31' and tleave='Annual Leave'order by id desc";
//$start=$row["aadate"];
