...
//mysqli_select_db($db,'sfmmkpjnew');
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			...
			//$strSQL = "UPDATE medi_stock set given_qty='$staff'";
...
$strSQL = "Select * from medi_stock where add_qty>0 and status!='Pending'";
...
?>
  ...
  <tr>
    <td align="center"><?php echo $count; ?></td>
      <td align="center"><input type="text" name="sname[]" id="sname<?php echo $i;?>" value="<?php echo $row["id"]; ?>" readonly></td>
	  
	  <td align="center"><input type="text" value="<?php echo $row["given_qty"]; ?>" readonly></td>
	  <td align="center"><input type="text" name="staff[]" id="staff<?php echo $i;?>" value="<?php echo $row["add_qty"]; ?>" readonly></td>
