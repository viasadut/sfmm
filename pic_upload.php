    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-4 mb-15">
                ...
                <input type="text" name="identity_no" value="<?php echo $row['ID'];?>" required readonly>
            </div>
            <div class="col-4 mb-15">
                <label>Patient Name</label>
                <input type="text" name="patient_name" value="<?php echo $row['pname'];?>"  required readonly>
            </div>
            <div class="col-4 mb-15">
                <label>MRN</label>
                <input type="text" name="mrn" value="<?php echo $row['pmrn'];?>" readonly>
            </div>

            <div class="col-4 mb-15">
                <label>Visit Date</label>
                <input type="date" name="visit_date" value="<?php echo $row['adate'];?>" readonly>
            </div>
            <div class="col-4 mb-15">
                <label>Age / Sex</label>
                <input type="text" name="age_sex" value="<?php echo $row['page'];?>" readonly>
            </div>
            <div class="col-4 mb-15">
                <label>Bed</label>
                <input type="text" name="bed" value="<?php echo 'ENDOSCOPY-01';?>" readonly>
            </div>

            <div class="col-6 mb-15">
                <label>Referrer</label>
                <input type="text" name="referrer" value="<?php echo $row['dreffer'];?>" readonly>
            </div>
        ...
        <div class="row">
            <div class="col-4 mb-15">
                ...
                <input type="text" name="procedure_name" value="<?php echo $row['tname'];?>" readonly>
            </div>

            <div class="col-4 mb-15">
                <label>Indication</label>
                <input type="text" name="indication" value="">
            </div>
            <div class="col-4 mb-15">
            ...
            <div class="col-12 mb-15">
                ...
                <input type="text" name="surgeon_name" value="<?php echo $row['dreffer'];?>">
            </div>
