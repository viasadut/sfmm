...
<?php
$full = $row39['fullname'];
$sel453="SELECT * FROM dialysispapp WHERE `pmrn`='$pmrn' and eid='$eid' ;";
...
$sel90="SELECT * FROM dialysisconsent2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and `pro`='$pro';";
...
$ins_query="insert into dialysisconsent2 (`pmrn`,`eid`,`pname`,`dname`,`padd`,`psex`,`tdate`,`pro`,`page`,`user`,`tdate1`,`ward`,`bed`) values 
('$pmrn','$eid','$ppname','$anes','$padd','$psex','$idate','$pro','$page','$user','$idate1','Endoscopy','Daycare')";
...
<td><a target='_blank' href="dialysisconsentprint2.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&pro=<?php echo "$pro"; ?>&dname=<?php echo "$dname"; ?>&anes=<?php echo "$anes"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
