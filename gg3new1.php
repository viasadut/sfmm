...
$ins_query="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`room`,`room1`,`eid`) values ('$dname', '$pname','$pmrn','$padd','$psex','$page','$adate','$btype','$bno','$count1')";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<p>
			<select name="btype" placeholder="Select Bed Type" >
			        ...
			        <input name="btype1" type="text" size =50% value="<?php	  if(isset($_POST['load'])==1)
{ $btype1 = $_REQUEST['btype'];
echo $btype1;
}
?>" size="57">
<input name="load" type="submit" id="load" value="Check Available Bed"></p>
		<!-- E-mail Input -->
		...
		<label for="mail"><strong>Avaiable Bed :</strong></label>
			...
			<select name="bno" placeholder="Select Bed Type" >
...
<label for="age"><strong>Select Doctor Name :</strong></label>
      ...
      <input name="pname" type="text" size="70" value="<?php echo $data["pname"]; ?>">
 	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" type="text" size="70" value="<?php echo $data["padd"]; ?>">

	  <label for="age"><strong>Patient's Details :</strong></label>
	  	
            <input name="psex" type="text" size="15" value="<?php echo $data["psex"]; ?>">
            <input name="pmrn" type="text" size="15" value="<?php echo $data["pmrn"]; ?>">
      <input name="pphone" type="text" size="13" value="<?php echo $data["pphone"]; ?>">	  
	  <input name="page" type="text" size="2"value="<?php echo $data["page"]; ?>">
...
<label for="age"><strong>Patient's Clinical Details :</strong></label>
			<p><textarea id="exampleTextarea" name="cdetails" size =50% ></textarea></p>
<label for="age"><strong>Patient's Diagnosis :</strong></label>
<p>			<textarea class="form-control" id="exampleTextarea" name="diagnosis" rows="5"size =50%></textarea></p>
...
$id=$_REQUEST['ID'];
//$adate=$_REQUEST['adate'];
$query44 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and discharge=''");
