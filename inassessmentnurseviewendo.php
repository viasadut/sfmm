...
$count1 = $count+1;
$query = "SELECT * from endopapp where pmrn= '$pmrn' and eid='$eid'"; 
...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from nurseassessendo where pmrn='$pmrn' and eid='$eid'"; 
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="nurseassessmentendoprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>		</tr>
