...
$ins_query1="insert into antihbc (`pname`,`pmrn`,`psex`,`page`,`result`,`opinion`,`crate`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`type`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Anti-Hbc- IgM:</strong></label>
