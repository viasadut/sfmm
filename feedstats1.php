...
$query43 = "SELECT COUNT(ctype) FROM feed where ctype= '$bt' and adate = '$start';"; 
...
$query44 = "SELECT COUNT(ctype) FROM feed where adate = '$start' ;"; 
...
$sel_query="Select * from feed where  adate = '$start'";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['COUNT(ctype)'];
echo $start;
	 $sel_query="Select * from feed where ctype='$bt' and adate = '$start'";
 } 
$count=1;
