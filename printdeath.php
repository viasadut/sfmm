...
$sel_query="Select * from death1 where pphone= '$pmrn' and estatus != 'Waiting Approval';";}
 else{
	 $sel_query="Select * from death1 where pmrn= '$pmrn' and estatus != 'Waiting Approval';";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="deathprint11.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
