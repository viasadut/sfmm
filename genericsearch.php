...
$query43 = "SELECT COUNT(mname) FROM medicine where mname= '$bt'and status='Active';"; 
...
<h1 align="center">Genericname wise Medicine List</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
							...
							<td colspan="3"><label><strong> Select Generic</strong></label></td> 
					 ...
					 <td colspan="3"><input list=diet1 name="bt" placeholder="Select Generic" class="form-control" autocomplete="off" required>
					<datalist id="diet1">	
						
						<option value=''>-Select Generic-</option>
						<?php 
			$sql = "Select DISTINCT mname  from medicine where status='Active';";
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="15%"><strong>Form </strong>
...
echo   $row43['COUNT(mname)'];

$count=1;
$sel_query="Select * from medicine where mname='$bt'and status='Active';";
