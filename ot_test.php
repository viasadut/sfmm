...
$sel90="SELECT * FROM otreport WHERE `pmrn`='$pmrn' and `eid`='$id' and `pname`='$proname' and sname='$full' and c_status!='Cancelled';";
...

{
	...
	echo '<script language="javascript">';
    echo 'alert("Unsuccessful !!! !!! Please Update Procedure Name"); ';
    echo '</script>';
}	
...
<input list="browsers1" name="infu" size=60% class="form-control" autocomplete="off" id="pmrn" onkeyup="GetDetail(this.value)">
...
<tr><td colspan="20" id="uu3">
	...
	<input type="text" id="pmrn2" onkeyup="GetDetail1(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='vtype' placeholder='Use Template Discharge Plan & Follow Up Plan' style="color:green;font-size:22px; font-weight:bold">
...
<input type="hidden" name="pnote" id="sformat1" class="test" cols="30" rows="10" >
...
<td colspan="20" ><input type="number" name="charge"  value=""></td>
</tr>
...
<script>
		...
		function GetDetail(str) {
			if (str.length == 0) {
				document.getElementById("sformat1").value = "";
...
//var variables = "pmrn=str&string=$pd";
				...
				// xhttp.open("GET", "filename", true);
				xmlhttp.open("GET", "ot_pull.php?pmrn=" + str + "&porder=<?php echo 'Dr. Razeeb Hassan';?>", true);
