...
$query43 = "SELECT COUNT(pmrn) FROM newbed where pmrn= '$bt' and eid='$bt1';"; 
...
<h1 align="center">DETAIL BED TRANSFER REPORT </h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select MRN:</strong></label></td>
						<td colspan="3"><label><strong> Select Episode</strong></label></td> 
					 ...
					 <td colspan="2"><input type="text" name="bt"></td>  
					 <td colspan="3"><input type="text" name="bt1"></td>  
...
$count=1;
$sel_query="Select * from newbed where pmrn='$bt' and eid='$bt1';";
...
{ ?>     <tr>
    ...
    <?php $count++; } }?>
      ...
      <td colspan="10" align="right"><a target='_blank' href="ppbed1?pmrn=<?php echo "$bt";?>&eid=<?php echo "$bt1"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
  </tbody>
</table>
