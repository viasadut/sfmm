...
<?php $test=date('Y-m-d', strtotime('-1 days') );
$sdate3=date('Y-m-d');
  //echo $test;
...
$count=1;
$sel_query="Select * from covidopd where status= 'collected' and sentto='SFMMKPJSH' and ssent between '$test' and '$sdate' and lstatus=''order by `id` asc;";
...
<td colspan="2" align="center"><a href="covidreceive?id=<?php echo $row['id']; ?>"><strong>RECEIVE</strong></a></td>	  	
	...
	<br><br><br><br>
<h1 align="center"style="background-color:lightgreen;">Yesterdays Covid Sample Received List</h1>
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
...
$count=1;
$sel_query="Select * from covidopd where status= 'collected' and sentto='SFMMKPJSH' and ssent ='$test' and lstatus='Received' order by `lid` asc;";
...
<td align="center"><?php echo $row["tp"]; ?>  </td>
<td align="center"><?php echo $row["bstatus"]; ?>  </td>
<td colspan="2" align="center"><?php echo $row["lstatus"]; ?>  </td>	  	
<?php 
$tr=$row['tresult'];
$id2=$row['id'];
