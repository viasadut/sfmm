...
$query198 = mysqli_query($db,"SELECT SUM(infusion) FROM otanaesother where pmrn='$pmrn'and id='$id'"); 
...
$ins_query="insert into otanaesother (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
$count=1;
$sel_query="Select * from otanaesother where pmrn= '$pmrn' and eid='$id' and status1='Active'order by `id` DESC;";
