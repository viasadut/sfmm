...
$pdf->SetXY(1,1);
//$pdf->SetXY(23,1);
$pdf->Cell('5',1.5,$data1['barcode1'],0,0,'L');

$pdf->SetXY(25,1);
$pdf->SetFont('arial' , '' , 5);
$pdf->Cell('5',1.5,$data1['date1'],0,1,'L');
//$pdf->Cell('5',2,$data1['barcode'],0,0,'L');
$pdf->SetXY(1,3.4);
$pdf->SetFont('arial' , 'b' , 6);
$pdf->Cell('5',1.5,'MRN-'. $data1['pmrn'],0,1,'L');
$pdf->SetFont('arial' , '' , 4);
$pdf->SetXY(1,5);

$pdf->Cell('30',1.5,$data1['pname'],0,0,'L');

$pdf->SetXY(1,6.5);
$pdf->SetFont('arial' , '' , 4);
$pdf->Cell('30',1,$data1['medi'],0,0,'L');
//$pdf->SetXY(1,7.5);
$pdf->Code128(2,9,$data1['barcode1'],27,10);
//$pdf->ln(10);
}
