...
<div class="container">
  ...
  <div class="form-group">
    ...
    <select id="tokens" class="selectpicker form-control" multiple data-live-search="true">
      ...
      <option data-tokens="last">I am "three"</option>      <option data-tokens="last">I am "three"</option>
	        <option data-tokens="last">I am "three"</option>
			      <option data-tokens="last">I am "three"</option>
				        <option data-tokens="last">I am "three"</option>
						      <option data-tokens="last">I am "three"</option>      <option data-tokens="last">I am "three"</option>      <option data-tokens="last">I am "three"</option>      <option data-tokens="last">I am "three"</option>
							        <option data-tokens="last">I am "three"</option>
									      <option data-tokens="last">I am "three"</option>
										        <option data-tokens="last">I am "three"</option>
												      <option data-tokens="last">I am "three"</option>
