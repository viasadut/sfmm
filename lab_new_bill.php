...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
                ...
                foreach($_POST['update'] as $updateid){
                    ...
                    $query4 = mysqli_query($db,"select * from alltest where id='$updateid'");
$data = mysqli_fetch_assoc($query4);
$pmrn=$data['pmrn'];
//$eid=$data['eid'];
$dname=$data['dname'];
$pname=$data['pname'];
$inves_type=$data['type'];
$inves_name=$data['medi'];


if($inves_type=='Package'){
                    $query159 = mysqli_query($db,"select * from package_inves where iname='$inves_name' and status='Active");
                    ...
                    $sel9=mysqli_query($db,"SELECT * FROM radio WHERE `iname`='$ii'");
                    $result9 = mysqli_fetch_assoc($sel9);
                    $type=$result9["type"];
                    $subtype=$result9["subtype"];
                    //echo $type;
                    //echo $type;
