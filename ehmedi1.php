...
$query45 = mysqli_query($db,"select * from ehmedi where pmrn='$pmrn' and id='$id'");
...
$update="update ehmedi set dtime='$dtime',ddate='$ddate', status='Rupdated', udone='$user' where `id`='$id'";
...
<td colspan="4" align="center"><label><strong>Order Date</strong></label></td> 
<td colspan="8" align="center"><label><strong>High Alert Medication</strong></label></td> 
<td colspan="4" align="center"><label><strong>Status</strong></label></td></tr>
<tr><td colspan="4" align="center"><input type="text"  name="odate" required value="<?php echo $data45["user"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="otime" required value="<?php echo $data45["odate"]; ?>" readonly/></td>
...
$count=1;
$sel_query="Select * from ehmedi where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
