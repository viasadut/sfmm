...
$pdf->Cell('100',5,$data['procharge'],0,1,'L');
...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from cathhoscharge where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from cathmediused where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
