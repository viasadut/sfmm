...
var countDownDate = new Date("Dec 31, 2023 19:00:00").getTime();
...
<img src="kpj_new_logo_add2.png" height="30" width="120">
...
<form method="post" action="auth11.php">
	...
	<marquee behavior="scroll" direction="left" scrollamount="10">New Generic:
...
include_once 'slider/dbconnect.php';
					...
					$result = $db->query("SELECT * FROM medicine order by id DESC  limit 15");
	...
	<div id="slider1_container1" style="visibility: hidden; position: absolute; left: 30px; top: 455px; width: 400px; height: 230px; overflow: hidden; align:center;">
			...
			<?php
					...
					//Get image data from database
					$result = $db->query("SELECT id, created FROM images_other order by created DESC  limit 10");
