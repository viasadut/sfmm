...
$lmenu='Morning Menu- :'.$d1."<br />".'Mid Morning Menu:'.$d2."<br />".'Lunch Menu:'.$d3."<br />".'Evening Menu:'.$d4."<br />".'Dinner Menu:'.$d5."<br />".'Supper Menu:'.$d6."<br />".'KCAL:'.$kcal;
...
$query = "Insert into dietchart (`tcustomer`,`cserving`,`cost`,`pcost`,`remarks`,`recipe`,`sdate`,`d1`,`d2`,`d3`,`d4`,`d5`,`d6`,`status`,`sby`,`dtype`,`lmenu`,`type`)

values('$tcustomer','$cserving','$cost','$pcost','$remarks','$recipe','$sdate','$d1','$d2','$d3','$d4','$d5','$d6','Proposed','$user','$dtype','$lmenu','$type')"; 
...
<td>
 <div>
                                           <textarea name="recipe" class="form-control" placeholder="Details"rows="40"cols="25"></textarea>
...
<tr><td colspan="2" align="center"><input type="text"  name="cserving"  value="" ></td></tr> 
...
<tr><td colspan="2" align="center"><input type="text"  name="cost"  value="" ></td></tr> 
...
<tr><td colspan="2" align="center"><input type="text"  name="pcost"  value="" ></td></tr> 			
...
<tr><td colspan="2" align="center"><input type="text"  name="remarks"  value="" ></td></tr> 			
...
<tr><td colspan="2" align="center"><input type="text"  name="d1"  value="" ></td>
...
<tr><td colspan="2" align="center"><input type="text"  name="d2"  value="" ></td></tr> 
