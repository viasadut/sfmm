...
('$ename','$eid','$elocation','$etype','$eqty','WAITING FOR CFO APPROVAL','$remarks','$adate','$adate1','$user','$vendor','cfo','ceo','338','$uprice','$cprice','$uom','md','322','$adate1','$p_by','$charge','$description','$uprice1')";
