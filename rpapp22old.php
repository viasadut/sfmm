...
{
       echo '<script language="javascript">';
    echo 'alert("Patient Page is Blank!!"); ';
    echo '</script>';
...
$ins_query="insert into radpapp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`dreffer`,`tname`,`btime`,`link`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$page','$psex','$tname23','$tname2','$btime','$link')";
...
?>" size ="57" readonly>
	  ...
	  <input name="page" type="text" size="5"Placeholder="Patient's AGE" class="style1" value="">
