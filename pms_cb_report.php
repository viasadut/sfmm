...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><h1 style="color:red"><strong>Datewise Card / Bkash Report</strong></h1></label></td> </tr>
...
';
                    ...
                    $query = "Select * from pms_payment where date between '$start' and '$end' and p_mode='$mode' and refund='0' order by user";
   ...
   <tr>
     <td align="center" ><?php echo $count; ?></td>
      ...
      <td align="center" ><a target='_blank' href="?id=<?php echo $data22["acct_name"]; ?>&start=<?php echo $start; ?>&end=<?php echo $end; ?>"><?php echo $row["amount"]; ?></a></td>
      
      <td align="center" ><?php echo date('d/m/Y', strtotime($row["date"])); ?></td>
      <td align="center" ><?php echo $row['location']; ?></td>
      <td align="center" ><?php echo $row['p_mode']; ?></td>
      <td align="center" ><?php echo $row['p_remarks']; ?></td>
...
<?php $count++;}
  ...
  $querydr = "select SUM(amount) FROM pms_payment WHERE date between '$start' and '$end' and p_mode='$mode' and refund='0'"; 
...
<tr>
  <td colspan="20" style="text-align:center; padding:15px;">
    <a href="datewise_card_bkash_pdf.php?stdate='.urlencode($start).'&endate='.urlencode($end).'&mode='.urlencode($mode).'" 
       target="_blank"
