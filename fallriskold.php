...
<tr><td colspan="20" bgcolor="lightgreen" align="center"><label><strong>Fall risk assessment Form (John Hopkins Tool)  :</strong></label></td></tr>
					<tr>
					<td colspan="20"><b>Age: <br><br><input type="radio" name="fage" value="1"required/> 60-69 Years (Score- 1) &nbsp;<input type="radio" name="fage" value="2"required/> 70-79 Years (Score- 2) &nbsp;&nbsp;<input type="radio" name="fage" value="3"required/> Grater than or Equal of 80 Years (Score- 3) </td>
					</tr>
					<tr>
					<td colspan="20"><b>Fall History: <br><br><input type="radio" name="fallhistory" value="5"required/> One fall within 6 months before admission (5 points) </td>
					
					</tr>

<tr>
					<td colspan="20"><b>Elimination, Bowel and Urine: <br><br><input type="radio" name="eli" value="2"required/> Incontinence (2 points) &nbsp;<input type="radio" name="eli" value="2"required/> Urgency or frequency (2 points)  &nbsp;&nbsp;<input type="radio" name="eli" value="4"required/> Urgency/frequency and incontinence (4 points)</td>
					</tr>
					<tr>
					<td colspan="20"><b>Medications: Includes PCA/opiates, anticonvulsants, anti-hypertensives, diuretics, hypnotics,
laxatives, sedatives, and psychotropics  <br><br><input type="radio" name="fmedi" value="3"required/> On 1 high fall risk drug (3 points) &nbsp;&nbsp;&nbsp; <input type="radio" name="fmedi" value="5"required/> On 2 or more high fall risk drugs (5 points)&nbsp;&nbsp;&nbsp; <input type="radio" name="fmedi" value="7"required/> Sedated procedure within past 24 hours (7 points)  </td>
					
					</tr>

					<tr>
					<td colspan="20"><b>Patient Care Equipment: Any equipment that tethers patient (e.g., IV infusion, chest tube, indwelling
catheter, SCDs, etc.)   <br><br><input type="radio" name="fpc" value="1"required/> One present (1 point)  &nbsp;&nbsp;&nbsp; <input type="radio" name="fpc" value="2"required/> Two present (2 points)&nbsp;&nbsp;&nbsp; <input type="radio" name="fpc" value="3"required/>3 or more present (3 points)</td>
...
<td colspan="10"><select name="fmob1" placeholder="" >
						<option value=''>NONE</option>
						<option value='2'>Requires assistance or supervision for mobility, transfer, or ambulation (2 points) </option>
						<option value='2'>Unsteady gait (2 points)</option>
						<option value='2'>Visual or auditory impairment affecting mobility (2 points)</option>
						</select></td>
						
						<td colspan="5"><select name="fmob2" placeholder="" >
						<option value=''>NONE</option>
						<option value='2'>Requires assistance or supervision for mobility, transfer, or ambulation (2 points) </option>
						<option value='2'>Unsteady gait (2 points)</option>
						<option value='2'>Visual or auditory impairment affecting mobility (2 points)</option>
						...
						<td colspan="5"><select name="fmob3" placeholder="" >
						<option value=''>NONE</option>
						<option value='2'>Requires assistance or supervision for mobility, transfer, or ambulation (2 points) </option>
						<option value='2'>Unsteady gait (2 points)</option>
						<option value='2'>Visual or auditory impairment affecting mobility (2 points)</option>
...
<td colspan="10"><select name="fcong1" placeholder="" >
						<option value=''>NONE</option>
						<option value='1'>Altered awareness of immediate physical environment (1 point) </option>
						<option value='2'>Impulsive (2 points)</option>
						<option value='4'>Lack of understanding of one's physical and cognitive limitations (4 points)</option>
						</select></td>
						
						<td colspan="5"><select name="fcong2" placeholder="" >
						<option value=''>NONE</option>
						<option value='1'>Altered awareness of immediate physical environment (1 point) </option>
						<option value='2'>Impulsive (2 points)</option>
						<option value='4'>Lack of understanding of one's physical and cognitive limitations (4 points)</option>
						...
						<td colspan="5"><select name="fcong3" placeholder="" >
						<option value=''>NONE</option>
						<option value='1'>Altered awareness of immediate physical environment (1 point) </option>
						<option value='2'>Impulsive (2 points)</option>
						<option value='4'>Lack of understanding of one's physical and cognitive limitations (4 points)</option>
