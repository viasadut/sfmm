...
$sel90="SELECT * FROM otreport WHERE `pmrn`='$pmrn' and `eid`='$id' and `pname`='$lx' and `others`='$otherins' and sname='$full';";
$result90 = mysqli_query($con,$sel90);
if($res90=mysqli_num_rows($result90)==1)
{
 	
       echo '<script language="javascript">';
    echo 'alert("Unsuccessful !!! Note Already Written.. To Modify Please go to Edit Option"); ';
    echo '</script>';
    }


else {
$ins_query="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`others`) values ( '$pmrn','$id','$lx','$otdate','$full','$sreport','$ottype','$date1','-$otherins')";
...
<tr><td colspan="20"><input type="text" name="otherins" placeholder="Name if other Procedure" ></td>	 </tr>
...
$count=1;
$sel_query="Select * from otreport where pmrn= '$pmrn' and eid='$id'order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="10"><?php echo $row["sreport"]; ?></td>
