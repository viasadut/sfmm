...
$pname=$data1["pname"];
$date1 = date('d/m/Y');
$ins_query1="insert into dismedi (`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`) values ('$pmrn','$pname','$medi1','$pdos','$eid','$date1')";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="dismedidelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
