...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','staff','mng','ot','endo','imo','mofficer','nurse','emergency','moopd','diet','physio','mrd','adminmng','lab','call','bill','cath','gpopd')"; 
...
<tr>	<td colspan="20"align="left"><a href="incident"><font size="4.5">Incident Request</a></td></tr>

<tr>	<td colspan="20"align="left"><a href="incidentviewstaff1"><font size="4.5">Pending Incident Request</a>
...
<?php if($fullname=='82' || $fullname=='1585'){	echo'	

<tr>	<td colspan="20"align="left"><a href="incidentviewstaff12"><font size="4.5">Closed Incident Report</a>
...
<?php if($fullname=='82'){	echo'	
<tr>	<td colspan="20"align="left"><a href="incidentviewstaff13"><font size="4.5">Final Closing Pending From TM</a>
...
<?php if($cat=='HOD' || $cat=='Incharge'){	echo'		  
</tr>

<tr><td colspan="20"align="left"><a href="close_incident_dept"><font size="4.5">Departmental Closed Incident</a></td></tr>';

}

?>

<tr><td align="left" style="font-size:22px;font-weight:bold"><a target='_BLANK' href="<?php echo 'incident_work_flow.jpg'; ?>">Work Flow</a></td></tr>
