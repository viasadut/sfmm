...
$query45 = mysqli_query($db,"select * from eidiet where pmrn='$pmrn' and id='$id'");
...
$update="update eidiet set dtime='$dtime',ddate='$ddate', status='Rupdated', duser='$user' where `id`='$id'";
