...
$dd1=date('d/m/Y');
            ...
            $output = "";
                ...
                $output .='<table style="border:0px;border-collapse:collapse;border-spacing:0px;" width="100%">
                            ...
                            ';
                $query1 = mysqli_query($con,"select * from iidiet where odate ='$dd' and status='Diet Ordered' and diettime in ('Supper','Extra Food') and status1!='Cancel'order by room");
                $count=1;
            ...
            $mpdf->SetHTMLHeader('
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="80%" align="center"><b><h1 align="center"> Supper Diet Order Sheet</h1> </b></td>
