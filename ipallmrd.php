...
$query59 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and eid='$eid'and discharge=''");
$data59 = mysqli_fetch_assoc($query59);


$query_f = mysqli_query($db,"select * from frisk where pmrn='$pmrn' and eid='$eid'");
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="docassessprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Doctor's Assessment</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="nurseassessmentprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>nurse's Assessment</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="dietassessprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Diet Assessment</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="g_chart_temp_test.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Vitals Graph</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="deathstatdetailsmngmrd?pmrn=<?php echo "$pmrn"; ?>"><b>Patient's Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<a target='_blank' href="handover_notes?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Handover Notes<b></a>&nbsp;&nbsp;<a target='_blank' href="surnotemngmrd?pmrn=<?php echo "$pmrn"; ?>"><b>Surgery Note<b></a>&nbsp;&nbsp;<a target='_blank' href="influiddoctestnurse?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Fluid Chart<b></a>
    &nbsp;&nbsp;<a style="color:red;font-weight:bold;"target='_blank' href="mrd_vitals?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Vitals<b></a>&nbsp;&nbsp;<a style="color:red;font-weight:bold;"target='_blank' href="idocnote_mrd?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Daily Dietary Notes<b></a>
    </td></tr>
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong><span style="font-size:30px;font_weight:bold;color:red;">Fallrisk assessment:<?php if($data_f['fscore']!=''){echo $data_f['fscore'];} else {echo "NOT DONE";} ?></strong></label></td> </tr>
