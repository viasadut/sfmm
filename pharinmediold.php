...
$update="update imedi2 set pstatus='served' where `pmrn`='$pmrn' and `eid`='$eid' and `odate`='$dd' and status !='Cancel'";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pstatus='Ordered' order by `time` and `infusion` asc;";
...
{ ?>    <tr>
    ...
    <?php $count++; } ?>
	 ...
	 <td colspan="15" align="right"><button type="submit" name="Submit">Serverd</button></td></tr>
