...
if(!isset($_POST['rfid_card']) and $attn_id!='')
{echo'



<h1 style="color:green;font-size:60px;font-weight:bold">Attendance Confirmed<img  src="tick_m.gif" width="80"  height="80" align="center"><h1>
...
<tr><td colspan="20"align="center"bgcolor="lightgreen"><img  src="staff_pic/'.$row3["pic"].'" width="180"  height="180" align="center">
