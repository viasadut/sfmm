...
$ins_query="insert into feedhistory (`dname`,`pmrn`,`pname`,`ins`,`date`) values ('$full', '$pmrn','$pname','$pins','$date')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Feeding History</strong></label></td> </tr>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
      	  ...
      	  <td colspan="16" align="center"><strong>Feeding History</strong></td>
...
$count=1;
$sel_query="Select * from feedhistory where pmrn= '$pmrn' order by `id` DESC;";
