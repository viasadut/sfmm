...
$query = mysqli_query($db,"select * from discharge where pmrn='$pmrn' and ddate='$ddate' and dname='$dname' and eid='$eid'");
...
$pdf->Cell('183',6,'DISCHARGE RECORD',1,1,'C');
...
$pdf->SetFont('Arial' , 'b' , 9);
$pdf->Cell('25',5,'Discharge Date:',0,0,'L');
$pdf->Cell('30',5,$data['ddate'],0,0,'L');
$pdf->ln(10);
...
$pdf->Cell('27',5,'Admission Date:',1,0,'L');
$pdf->Cell('35',5,$data['pheight'],1,0,'L');
$pdf->Cell('30',5,'Ward:',1,0,'L');
$pdf->Cell('30',5,$data['pweight'],1,0,'L');
$pdf->Cell('30',5,'Bed NO:',1,0,'L');
...
$query1 = mysqli_query($db,"select * from dmedi where pmrn='$pmrn' and ddate='$ddate' and dname='$dname' and eid='$eid'");
