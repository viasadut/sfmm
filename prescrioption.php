...
$sel90 = "SELECT * from presnew where pmrn='$pmrn' and dname='$dname' and date='$pdate' "; 
$result90 = mysqli_query($con,$sel90);
if($row90=mysqli_num_rows($result90)>0)
	{
echo '<script language="javascript">';
    echo 'alert("Unsuccessful !! The Prescription alreday saved one Time..pls go back and edit !!"); ';
