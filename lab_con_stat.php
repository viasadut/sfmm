...
$query43 = "SELECT COUNT(medi) FROM alltest where cby= '$bt'and rdate BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(infusion) FROM iinves where conby= '$bt'and ndate BETWEEN '$start' and '$end';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(infusion) FROM einves where conby= '$bt'and ndate BETWEEN '$start' and '$end';"; 
...
$query43r = "SELECT COUNT(medi) FROM alltest where cby='$bt' and rdate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
	 
$result43r = mysqli_query($con, $query43r) or die(mysqli_error());
$row43r = mysqli_fetch_assoc($result43r);

$query44r = "SELECT COUNT(infusion) FROM iinves where conby= '$bt' and ndate BETWEEN '$start' and '$end' and type='lab'and rstatus='RECEIVED';"; 
	 
$result44r = mysqli_query($con, $query44r) or die(mysqli_error());
$row44r = mysqli_fetch_assoc($result44r);


$query45r = "SELECT COUNT(infusion) FROM einves where conby= '$bt' and ndate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
...
<h1 align="center">Consultant Investigation Confirmed StatsReport</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<option value='153'>Dr. Kamrun Nahar</option>
						<option value='910'>Dr. Nazma Shaheen</option>
						<option value='865'>Dr. Abu Anis Khan</option>
...
$sel_query1="Select * from alltest where cby='$bt' and rdate BETWEEN '$start' and '$end' order by id";
...
{ ?>    <tr>
      ...
      <td align="center"><a target='_blank' href="allreportdocnew?pmrn=<?php echo $row1['pmrn']; ?>"><?php echo $row1["pmrn"]; ?></a></td>
	...
	$sel_query2="Select * from iinves where conby='$bt' and ndate BETWEEN '$start' and '$end' order by id";
...
{ ?>    <tr>
      ...
      <td align="center"><a target='_blank' href="allreportdocnew?pmrn=<?php echo $row2['pmrn']; ?>"><?php echo $row2["pmrn"]; ?></a></td>
	...
	<?php
	$sel_query3="Select * from einves where conby='$bt' and ndate BETWEEN '$start' and '$end' order by id";
...
{ ?>    <tr>
      ...
      <td align="center"><a target='_blank' href="allreportdocnew?pmrn=<?php echo $row3['pmrn']; ?>"><?php echo $row3["pmrn"]; ?></a></td>
