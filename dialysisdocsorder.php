...
$count=1;
$sel_query="Select * from endostret where pmrn= '$pmrn' and eid='$eid' and odate='$odate'and status1 != 'Cancel' and status= 'Data Updated' order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="dialysissogiven?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Given</a></td>
	  
      </tr>
    <?php $count++; } ?>
	
	<tr><td colspan="20"><b> Given Special Treatment List<b></td></tr>	
...
$count=1;
$sel_query="Select * from dialysisstret where pmrn= '$pmrn' and eid='$eid' and odate='$odate'and status = 'Given' order by `id` DESC;";
