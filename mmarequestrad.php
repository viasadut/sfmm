...
$sel90="SELECT * FROM privilege WHERE `pname`='$mname' and did='$user';";
...
$ins_query1="insert into privilege (`pname`,`dname`,`did`,`status`,`comments`,`adate`,`adate1`,`discipline`,`sformat`) values ('$mname','$fname','$user','Pending','$remarks','$adate','$adate1','$dis','$sformat')";
...
<input list="browsers111" name="mname"  size="80"  style="text-transform:ucfirst"required autocomplete='off' value='<?php echo $tname;?>'>
  <datalist id="browsers111">
	  ...
	  <input list="browsers45" name="dis"  size="80"  style="text-transform:ucfirst"required value='<?php echo 'Radiology';?>'>
 ...
 <label for="age"><strong>Template:</strong></label> 
<td colspan="15" align="center"> <textarea rows="40" name="sformat" required></textarea></td>
 ...
 <label for="age"><strong>Comments / Remarks / Findings:</strong></label> 
