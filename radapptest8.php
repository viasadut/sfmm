...
$ins_query906="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:00AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query906);
$ins_query907="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:10AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query907);
$ins_query908="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:20AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query908);
$ins_query909="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:30AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query909);
$ins_query910="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:40AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query910);
$ins_query911="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:50AM','AVAILABLE','$user')";
...
$ins_query901="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:10AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query901);
$ins_query902="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:20AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query902);
$ins_query903="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:30AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query903);
$ins_query904="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:40AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query904);
$ins_query905="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:50AM','AVAILABLE','$user')";
...
$ins_query912="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query912);
$ins_query913="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:10PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query913);
$ins_query914="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:20PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query914);
$ins_query915="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query915);
$ins_query916="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:40PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query916);
$ins_query917="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:50PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query917);


$ins_query918="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query918);
$ins_query919="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:10PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query919);
$ins_query920="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:20PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query920);
$ins_query921="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query921);
$ins_query922="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:40PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query922);
$ins_query923="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:50PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query923);

$ins_query924="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query924);
$ins_query925="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:10PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query925);
$ins_query926="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:20PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query926);
$ins_query927="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query927);
$ins_query928="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:40PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query928);
$ins_query929="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:50PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query929);


$ins_query930="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query930);
$ins_query931="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:10PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query931);
$ins_query932="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:20PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query932);
$ins_query933="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query933);
$ins_query934="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:40PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query934);
$ins_query935="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:50PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query935);


$ins_query936="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query936);
$ins_query937="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:10PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query937);
$ins_query938="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:20PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query938);
$ins_query939="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query939);
$ins_query940="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:40PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query940);
$ins_query941="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:50PM','AVAILABLE','$user')";
...
$ins_query2190="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:00AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query2190);
$ins_query2191="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:20AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query2191);
$ins_query2192="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:40AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query2192);


$ins_query3190="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:00AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query3190);
$ins_query3191="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:20AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query3191);
$ins_query3192="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:40AM','AVAILABLE','$user')";
...
$ins_query1190="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:00AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query1190);
$ins_query1191="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:20AM','AVAILABLE','$user')";
mysqli_query($con,$ins_query1191);
$ins_query1192="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:40AM','AVAILABLE','$user')";
...
$ins_query4190="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','01:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query4190);
$ins_query4191="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','01:20PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query4191);
$ins_query4192="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','01:40PM','AVAILABLE','$user')";
...
$ins_query141="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','12:00AM','AVAILABLE','$user')";
...
$ins_query215="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query215);
$ins_query216="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','05:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query216);
$ins_query217="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query217);
$ins_query218="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','06:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query218);


$ins_query219="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query219);
$ins_query220="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','07:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query220);
$ins_query221="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query221);
$ins_query222="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','08:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query222);


$ins_query223="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query223);
$ins_query224="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','09:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query224);
$ins_query225="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','10:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query225);
$ins_query226="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','10:30PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query226);

$ins_query227="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','11:00PM','AVAILABLE','$user')";
mysqli_query($con,$ins_query227);
$ins_query228="insert into rapp (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$checkbox', '$date','11:30PM','AVAILABLE','$user')";
