...
$update="update radio set s_data='$cdetails' where `id`='$id'";
...
<h1 align="center">Short Format Setting Panel</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<tr>
						<td colspan="20" style="font-size:18px;color:green;"><label><strong>Investigation Name: <?php echo $pn;?></strong></label></td></tr>
				<tr>


						 <tr><td colspan="20"><label><strong>Set Format:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="charge" name="cdetails" rows="2" ><?php echo $row['s_data'];?></textarea></td>  </tr>
