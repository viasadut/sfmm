...
$ins_query1="insert into doc_inves (`dname`,`iname`,`medi`,`pdos`,`duration`,`frelation`) values 
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Add Investigation in set Investigation <?php echo $iname;?></strong></label></td> </tr>
...
<td  colspan="10"align="center"><input list="21" name="pdos"  class="form-control" value="">
...
<tr>
      ...
      <td colspan="3" align="center"><strong>Set Investigation Name</strong></td>
     	  <td colspan="8" align="center"><strong>Investigation Name</strong></td>
...
$count=1;
$sel_query="Select * from doc_inves where iname= '$iname'order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="3"><?php echo $row["iname"]; ?></td>
	        ...
	        <td align="center"colspan="8"><?php echo $row["brand"].' ('.$row["medi"].')'; ?></td>
			      <td align="center"colspan="6"><?php echo $row["pdos"]; ?> <input type="button" name="edit_co" value="E" id="<?php echo $row['id']; ?>" class="btn btn-info btn-xs edit_data_co" /></td>
				  
				  <td align="center" colspan="1"><a href="delete1_inves?id=<?php echo $row["id"]; ?>&iname=<?php echo $row["iname"]; ?>">DELETE</a></td>
