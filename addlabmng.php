...
$sel90="SELECT * FROM radio WHERE `iname`='$mname';";
$result90 = mysqli_query($con,$sel90);
if($res90=mysqli_num_rows($result90)>0)
{
echo '<script language="javascript">';
    echo 'alert("This Investigation is Already Added in The Database !!"); ';
...
$ins_query1="insert into radio (`iname`,`type`,`subtype`,`price`,`code`,`aby`,`atime`) values ('$mname','$bname','$cname','$form','$cat','$user','$adate')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query2="insert into radio1 (`iname`,`type`,`subtype`,`price`,`code`,`aby`,`atime`) values ('$mname','$bname','$cname','$form','$cat','$user','$adate')";
mysqli_query($con,$ins_query2) or die(mysql_error());

$ins_query3="insert into radio2 (`iname`,`type`,`subtype`,`price`,`code`,`aby`,`atime`) values ('$mname','$bname','$cname','$form','$cat','$user','$adate')";
