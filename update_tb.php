...
$date=$err_p['adate1'];
     ...
     /* $strSQL1 = "insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`status`,`amount`) values 
      ...
      $strSQL1 = "insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`dcode`,`c_centre`,`date`,`status`,`amount`) values 
      ('$updateid','DR','$dr_code','$dcode','$cost_centre','$date','1','$amount')";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Brand Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from pappnew where adate1 between '2025-09-27' and '2025-09-27' and bill='BILLED'";
     ...
     <td align="center" colspan="1" ><?php echo $count; ?></td>
      ...
      <td align="center"colspan="9" ><?php echo $row["dname"]; ?></td>
	  ...
	  <td align="center"colspan="5" ><?php echo $row["payment"]; ?></td>
