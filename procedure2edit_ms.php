...
$ins_query="update m_suite set proname1='$proname1', pnote='$pnote', diagnosis='$diagnosis', procharge='$procharge' where id='$id'";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
				...
				<tr>	  
				<td colspan="20" align="center"><input list="rr" name="proname1"  class="form-control">
  <datalist id="rr">

						<option selected value="<?php echo $proname1;?>"><?php echo $proname1;?></option>
				<?php 
			...
			?>  </datalist></td>
				...
				<tr>
					 <td colspan="20"><textarea name="pnote" rows="8"><?php echo "$pnote";?></textarea></td></tr>
<tr><td align="left" colspan="20"><a target='_blank' href="promedicine_ms?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"?>&eid=<?php echo "$eid"?>&id=<?php echo "$id"?>"><img src="medicine1.jpg" title="test" width="130" height="90" /></a></td></tr>
<tr><td colspan="20"></td></tr>
<tr>					<td colspan="20"><label><strong>Procedure Charge</strong></label></td></tr>

<tr><td colspan="20"><input type="text" name="procharge" required value="<?php echo $procharge;?>" /></td>  </tr>
<tr>
