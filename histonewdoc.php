...
$ins_query="insert into doctor1 (`dname`,`degree`,`hname`) values ('$docname', '$degree','$hname')";
if (mysqli_query($con,$ins_query)==1)
{
   
    echo '<script language="javascript">';
    echo 'alert("Doctor Name Successfully Added "); ';
    echo '</script>';
...
{
       echo '<script language="javascript">';
    echo 'alert("Doctor Name NOT Added"); ';
    echo '</script>';
...
<!-- Form Title -->
		<h2 align="center">ADD NEW DOCTOR'S INFORMATION</h2>
		...
		<fieldset>
			...
			<input name="docname" type="text" size="30" Placeholder="Doctor Name" class="style1"value="" required/>	  			
<!-- E-mail Input -->
			<label for="mail"><strong>Credentials :</strong></label>
			<input name="degree" type="text" size="30" Placeholder="Doctor Credentials" class="style1"value="" required/>	  			
<label for="mail"><strong>Hospital Name :</strong></label>
			<input name="hname" type="text" size="30" Placeholder="Hospital Name" class="style1"value="" required/>	  			
