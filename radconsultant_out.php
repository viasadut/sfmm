...
$query43 = "SELECT COUNT(dname) FROM radreport where dname='$bt' and rdate BETWEEN '$start' and '$end' and type1 in ('DX','DX1','DX2','DX3','CR','MR','CT');"; 
...
<h1 align="center">Done Report Stats</h1>
...
$rr=date('2022-04-02');
?>
<td align="center"><?php echo $row["date2"].' '.$row["time"]; ?>  
	   <?php if($row['rdate']>=$rr)
	   {echo'
