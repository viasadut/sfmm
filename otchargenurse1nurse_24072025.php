...
//else {
$ins_query1="insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`) values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$sub_type')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
...
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$pp3','$date2','$sub_type')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
