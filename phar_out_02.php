...
$sel96="SELECT * FROM medi_stock WHERE `sno`='$code3' and add_qty>0 and location='2nd Fl Pharmacy' order by exdate asc limit 1";
...
//else if($res95=mysqli_num_rows($result95)>0 and $mqty=='' and $mm_qty<$tprice)
{
	...
	$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`ins`,`brand`,`pname`,`pmrn`,`location`,`rfid`,`code`) values
			('$medi','$tprice','$uprice','$charge','$user','$adate','$sno','$ins','$brand','$p_name1','$p_mrn1','OPD-2nd','$rf','$code')";
...
<input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='code3' required style="font-weight: bold;font-size:22px;color:green">
	...
	<option value=''>-Select-</option>
        ...
        <?php } ?>
							...
							<td colspan="2"><input type="text" name="code" id="ppcode" required value="" readonly style="font-weight: bold;font-size:22px;color:green"></td>	
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "phar_out1_new2_02_02.php?pmrn=" + str, true);
