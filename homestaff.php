...
if($cat=='HOD' or $cat=='Incharge'){
	...
	<tr>
	  ...
	  <th colspan="3"style="color:blue;text-align:center;font-size:25px;font-weight:bold;"><strong>Taotl Manpower<br>  '.$row26["COUNT(id)"].'</strong></th>
...
<tr><td colspan="20" align="left"><a href="tender/equipment/asset_management"><font size="4.5">New(RFID)</a></td></tr>
	...
	<tr><td colspan="20"align="left"><a href="reporting-portal/index"><font size="4.5">Reporting Portal</td></tr>
'
;}
...
<tr>	<td colspan="20"align="left"><a href="otdash"><font size="4.5">OT</a></td></tr>	
...
<tr><td colspan="20"align="left"><a href="ccapp1"><font size="4.5">Appointment Report</a></td><tr>
<tr><td colspan="20"align="left"><a href="appcancel12"><font size="4.5">Cancel Appointment</a></td><tr>
...
;}
	...
	<?php if($user=='1274' || $user=='327' || $user=='414' || $user=='1546' || $user=='1725' || $user=='47' || $user=='170' || $user=='167' || $user=='1881'){	echo'	
...
;}
	...
	<?php if($user=='1861' || $user=='459'){	echo'	

<tr>	<td colspan="20"align="left"><a href="gstat"><font size="4.5" style="color:red;font-weight;bold">Guest House</a></td></tr>
<tr><td colspan="20"align="left"><a href="new_room_home"><font size="4.5" style="color:red;font-weight;bold">Hospital Room Management</a></td></tr>
<tr><td colspan="3" align="left"><a href="g_house_bed"><font size="4.5" style="color:red;font-weight;bold">Guest House Room Management(New Format)</a></td></tr>
<tr><td colspan="3" align="left"><a href="cafe/index"><font size="4.5" style="color:red;font-weight;bold">Cafeteria</a></td></tr>
...
;}
	...
	<?php if($user=='75'){	echo'	
<tr>	<td colspan="20"align="left"><a href="acct_home" style="color:red;font-size:22px;font-weight:bold"><font size="4.5">Accounts</a></td></tr>
<tr>	<td colspan="20"align="left"><a href="DRP/index.php" style="color:red;font-size:22px;font-weight:bold"><font size="4.5">Diagnostic Reporting Portal</a></td></tr>
<tr>	<td colspan="20"align="left"><a href="bedviewbill"><font size="4.5">Edit Bed Details</a></td></tr>
...
;}
	...
	?>	
		...
		<?php if($user=='338' || $user=='322' || $user=='621'){	echo'	
...
<tr>	<td colspan="20"align="left"><a href="add_product"><span style="color:green; font-size:20px;">Add New Items</a></span></td></tr>';
}?>
...
<tr>	<td colspan="20"align="left"><a href="dc_note_confirm"><font size="4.5">Clear DC Note Confirmation</a></td></tr>
<tr><td colspan="20"align="left"><a href="purchase_transfer_store?sno='.$runningTime1.'"><font size="4.5">Request For New Purchase</td></tr>'
...
;}
	...
	<?php if($user=='370' || $user=='47' || $user=='170' || $user=='167'){	echo'	
...
;}?>	
	...
	<?php if($dept=='Information Technology Services'){	echo'	
...
;}
	...
	?>		
<?php if($user=='370' || $user=='1098' || $user=='47' || $user=='170' || $user=='167'){	echo'	
...
<tr>	<td colspan="20"align="left"><a href="all_dept_stock_all"><font size="4.5">Departmental Stock Report</a></td></tr>
<tr>	<td colspan="20"align="left"><a href="all_doc_stats_all" style="color:green;font-size:22px;font-weight:bold"><font size="4.5">Doctor Income Stats (ALL)</a></td></tr>
...
<tr>	<td colspan="20"align="left"><a href="accounts_tb" style="color:green;font-size:22px;font-weight:bold"><font size="4.5">Accounts</a></td></tr>
...
<?php if($user=='71' || $user=='54' || $user=='534' || $user=='1912'){	echo'	
...
<?php if($user=='1601' || $user=='327' || $user=='47' || $user=='170' || $user=='167' || $user=='1881'){	echo'	
...
<td colspan="20"align="left"><a href="oes1/index"><span><font size="5.5" color="green" font-weight="bold">Online Exam Module</span></a></td>
	...
	<tr><td colspan="20"align="left"><a href="dispose_medicine_outpatient"><font size="4.5">Discard Medicine</a></td></tr>
		';}?>
...
<?php if($user=='294'){	echo'	
	...
	<tr><td colspan="20"align="left"><a href="reporting-portal/index"><font size="4.5" color="green">Reporting Portal</td></tr>
	
		';}?>


<?php if($dept=='Pharmacy Services'){	echo'	
	<tr><td colspan="20" align="left"><a href="phar_home_opd" style="font-size:25px; color:red; font-weight:bold"><font size="4.5">Pharmacy (OPD)</a></td></tr>
	
	<tr><td colspan="20" align="left"><a href="collection_report" style="font-size:25px; color:red; font-weight:bold"><font size="4.5">Collection Report</a></td></tr>
	<tr><td colspan="20" align="left"><a href="phar_home_ipd" style="font-size:25px; color:red; font-weight:bold"><font size="4.5">Pharmacy (IPD)</a></td></tr>
	<tr><td colspan="20" align="left"><a href="phar_home" style="font-size:25px; color:red; font-weight:bold"><font size="4.5">Pharmacy (Store)</a></td></tr>
...
<tr><td colspan="5" align="left"><a href="opd_phar_stock3"><span style="font-size:20px; color:green;font-weight:bold;">Store Pharmacy Stats</span></a></td></tr>
		...
		<?php if($user=='322' || $user=='1603' || $user=='71' || $user=='534' || $user=='54' || $user=='45' || $user=='1912'){	echo'	
...
<?php if($dept=='Radiology And Imaging Services'){	echo'	
	<tr><td colspan="20" align="left"><a href="tesrad" style="font-size:25px; color:red; font-weight:bold"><font size="4.5">Radiology</a></td></tr>
		...
		<?php if($user=='322' || $user=='1603' || $user=='71' || $user=='534' || $user=='54' || $user=='45' || $user=='1912' || $user=='310' || $user=='790'){	echo'	
...
<?php if($user=='294' || $user=='1186' || $user=='1206' || $user=='621'){	echo'	

<tr>	<td colspan="20"align="left"><a href="acct_payable" style="color:red;font-size:22px;font-weight:bold"><font size="4.5">Account Payable</a></td></tr>
...
<tr>	<td colspan="20"align="left"><a href="'.$purchase.'" style="color:red;font-size:22px;font-weight:bold"><font size="4.5">Generate PRF </a></td></tr>
...
<?php if($user=='322' || $user=='45'){	echo'	
	<tr><td colspan="20" align="left"><a href="pms_phar_report"><font size="4.5" color="green">Pharmacy Report</a></td></tr>
