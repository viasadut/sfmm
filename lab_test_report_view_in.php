...
$dreffer=$row['dreffer'];
  ...
  $query43 = "SELECT * FROM lab_test where lid= '$lid';"; 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$old_details=$row43['details'];
?>
...
$ins_query="update lab_test set details='$cdetails' where lid='$lid'";
...
$ins_query2="insert into lab_test1 (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`details`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`,`datenew`,`ron`,`lid`,`r_u_by`,`r_u_t`) 
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$old_details','$count1','$date1','$date2','$stime','Updated','IPD','$date_d','$inves','$lid','$user','$add_time')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>All Records<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>All Reports<b></a></td></tr>
				<tr><td colspan="10" style="font-size:18px;color:green;"><label><strong> Report Uploaded BY : <?php echo $row43['r_u_by'];?></strong></label></td>
				...
				<td colspan="10"><select name="dname" required>
					...
					<option value='<?php echo $row43['dname1'];?>'><?php echo $row43['dname1'];?></option>
...
<tr>
	...
	<td colspan="10"><button type="submit" name="Submit">Edit</button></td>
	  ...
	  <td colspan="10"><a target='_blank' href="lab_new_report_view.php?id=<?php echo "$lid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
