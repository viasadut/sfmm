...
<tr>
	...
	<td colspan="5"align="center"><button type="submit" name="Submit13">Nurse's Note</button></td>
		<td colspan="5" align="center"><button type="submit" name="Submit12">Doctor's Note</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row26['COUNT(pmrn)']; ?>)<b></td>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit98">Doctor Procedure Note</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row25['COUNT(pmrn)']; ?>)<b></td>
		<td colspan="4" align="center"><button type="submit" name="Submit10">Vitals</button><font size="4.5" color="#FF0000"><br><b>(<?php echo  $row22['COUNT(pmrn)']; ?>)<b></td>
