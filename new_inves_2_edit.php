...
$query6 = mysqli_query($db,"select * from b_gas_a where sno='$sno'");
...
$ins_query1="update b_gas_a set `ph`='$ph',`pco2`='$pco2',`po2`='$po2',`beecf`='$beecf',`hco3`='$hco3',`tco2`='$tco2',`so2`='$so2',`na`='$na',`k`='$k',`ica`='$ica',`glu`='$glu',`hct`='$hct',`hb`='$hb' where `sno`='$sno'";
...
<!-- Form Title -->
      ...
      <input name="ph" id="haemo" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['ph'];?>"required/>
...
document.getElementById('haemo').onchange= f_color15;
      ...
      <input name="pco2" id="red" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['pco2'];?>"required/>
...
document.getElementById('red').onchange= f_color14;
      ...
      <input name="po2" id="pcv" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['po2'];?>"required/>
...
document.getElementById('pcv').onchange= f_color13;
      ...
      <input name="beecf" id="mcv" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['beecf'];?>"required/>
...
document.getElementById('mcv').onchange= f_color12;
      ...
      <input name="hco3" id="mch" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['hco3'];?>"required/>
...
document.getElementById('mch').onchange= f_color11;
      ...
      <input name="tco2" id="mchc" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['tco2'];?>"required/>
...
document.getElementById('mchc').onchange= f_color10;
      ...
      <input name="so2" id="rdw" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['so2'];?>"required/>
...
document.getElementById('rdw').onchange= f_color9;
      ...
      <input name="na" id="pla" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['na'];?>"required/>
...
<label for="age"><strong>K:</strong></label>
      <input name="k" id="mpv" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['k'];?>"required/>
...
document.getElementById('mpv').onchange= f_color7;
	 ...
	 <label for="age"><strong>iCa:</strong></label>
      <input name="ica" id="wbc" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['ica'];?>"required/>
...
document.getElementById('wbc').onchange= f_color6;
      ...
      <input name="giu" id="neu" type="text"  style="font-weight: bold;font-size:22px;" value="<?php echo $data6['giu'];?>"required/>
...
document.getElementById('neu').onchange= f_color5;
      ...
      <input name="hct" id="lym" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['hct'];?>"required/>
...
document.getElementById('lym').onchange= f_color4;
      ...
      <input name="hb" id="eos" type="text" style="font-weight: bold;font-size:22px;" value="<?php echo $data6['hb'];?>"required/>
