...
$count=1;
$sel_query="Select * from iblood where return_by!='' and return_received_by='' order by `id` DESC;";
...
<td colspan="2"><a target='_blank' href="blood_order.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&id=<?php echo $row['id']; ?>"><img src="lab.png" title="Print Report" width="150" height="60" /></a></td>
...
<label>Medication Given</label>                          
                                ...
                                <label>Information of ABO Rh Type(Recipient) Pre-Transfusion Anti-Serum</label>                          
                                <select name="anti_serum_re_pre" id="anti_serum_re_pre" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Recipient) Pre-Transfusion Known Cell</label>                          
                                <select name="anti_serum_kc_pre" id="anti_serum_kc_pre" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Recipient) Pre-Transfusion Blood Group</label>                          
                                <select name="anti_serum_bg_pre" id="anti_serum_bg_pre" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<option value="AB(-)">AB(-)</option>
                                ...
                                <label>Information of ABO Rh Type(Recipient) Post-Transfusion Anti-Serum</label>                          
                                <select name="anti_serum_re_post" id="anti_serum_re_post" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Recipient) Post-Transfusion Known Cell</label>                          
                                <select name="anti_serum_kc_post" id="anti_serum_kc_post" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Recipient) Post-Transfusion Blood Group</label>                          
                                <select name="anti_serum_bg_post" id="anti_serum_bg_post" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Donor) Anti-Serum</label>                          
                                <select name="anti_serum_re_post_d" id="anti_serum_re_post_d" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Donor) Known Cell</label>                          
                                <select name="anti_serum_kc_post_d" id="anti_serum_kc_post_d" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<label>Information of ABO Rh Type(Donor) Blood Group</label>                          
                                <select name="anti_serum_bg_post_d" id="anti_serum_bg_post_d" class="form-control"required style="font-size:18px;color:red;font-weight:blod;">
...
<script>  
 $(document).ready(function(){  
      ...
      $('#insert_form4').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"update_transfusion_data_lab.php",  
                     method:"POST",  
