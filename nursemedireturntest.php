...
$objDB = mysql_select_db("sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			$strSQL = "UPDATE imedi2 set status1='Returned', ruser='$user', rdate='$pdate' ";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status in ('Cancel','Active') and status1 in ('Rupdated','Cancel') and pstatus='Served' order by `infusion` asc;";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and status1='Returned' and pstatus='Served' order by `infusion` asc;";
