...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><h1 style="color:red"><strong>Activity Report</strong></h1></label></td> </tr>
...
<td colspan="2"><label><strong>Select Patient MRN:</strong></label></td>
			    	 ...
			    	 <td colspan="2"><input type="text" name="stdate"  size="15"></td>  
...
';
                    ...
                    $query = "Select * from pms_bill where pmrn='$pmrn' and amount>(amount_receive+dis_amount) and dname !='IPD ADVANCE' and amount!='0' order by date desc";
...
<?php $count++;}
  ...
  $querydr = "select SUM(amount) FROM pms_bill WHERE pmrn='$pmrn' and amount>(amount_receive+dis_amount) and dname !='IPD ADVANCE' and amount!='0' order by date desc"; 
...
$bill=$data['SUM(amount)'];
 ...
 $querycr = "select SUM(amount_receive) FROM pms_bill WHERE pmrn='$pmrn' and amount>(amount_receive+dis_amount) and dname !='IPD ADVANCE' and amount!='0' order by date desc"; 
 $resultcr = mysqli_query($con,$querycr) or die ( mysqli_error());
 $data1 = mysqli_fetch_assoc($resultcr);	

$receive=$data1['SUM(amount_receive)'];

$querycr1 = "select SUM(dis_amount) FROM pms_bill WHERE pmrn='$pmrn' and amount>(amount_receive+dis_amount) and dname !='IPD ADVANCE' and amount!='0' order by date desc"; 
