...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="15%"><strong>Referral Doc</strong>
      <th width="14%"><strong>Diagnosis</strong>   
      <th width="14%"><strong>Plan</strong>
	  <th width="14%"><strong>Suggested Date of Admission</strong>
	  <th width="14%"><strong>Hos_Note</strong>
...
if($dept=='Talent Management Services'){		
...
$date1= date('Y-12-31');
$count=1;
$sel_query="Select * from preadm where tstatus='pending' and snew between '$date' and '$date1' order by snew desc";
//$start=$row["aadate"];
...
$hos = $row3['hos'];
	  ...
	  <td align="center"><?php echo $row["hos_com"]; ?>  
	  
<td align="center"><a href="approverequest?id=<?php echo $row['id']; ?>"><strong>Approve</strong></a></td>
      <td align="center"><a href="rejectaddrequest?id=<?php echo $row['id']; ?>"><strong>Write Comments</strong></a></td>	
