...
$query1 = mysqli_query($db,"select distinct code, pmrn, infusion,ndate from estat where pmrn='$pmrn' and eid='$eid' and pstatus !='Served' and status !='Cancel' and ndate='$nn'");
