...
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','$infu1','Data Updated','$otime','$datenew','OT')";
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$episode' and status!='Cancel' and location='OT'  order by `id` DESC;";
...
//$bno=$_REQUEST['bagno'];
$url = "imoidocblood11_ot?id2=$id1&pmrn=$pmrn1&eid=$eid1&bb=$bb&id=$id"; 
$url6 = "cancel_blood_order_imo?id2=$id1&pmrn=$pmrn1&eid=$eid1&id=$id"; 
