...
$medi1_details=$b_chk_m['g_name'].'-MS';
...
*/
      ...
      $charge_name=(int)$dd1['charge_name'];
      $charge_name_details=$dd1['charge_name'].'-MS';
...

{
  ...
  $sql = "insert into promediused_ms (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`code`,`adate`,`price`,`ip`,`op`,`acct_code`,`ccentre`) 
  ...
  //    $response = curl_exec($ch);
      ...
      $invoice_no=$decoded_response['invoice_id'];
       ...
       if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
        ...
        $ins_query="UPDATE promediused_ms SET api_status='1', invoice_no='$invoice_no' WHERE id='$last_id'";
...
$sql = "insert into promediused_ms (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`reuse`,`adate`,`code`,`price`,`ip`,`op`,`acct_code`,`ccentre`) values 
