...
<tr>
	<td colspan="5"align="center"><a href="nnote1?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	Nurses Note</a></td>
		<td colspan="5" align="center"><a href="cnote?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	Doctors Note</a></td>
		<td colspan="3" align="center"><a href="inpatient333?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	Infusion</a></td>
		<td colspan="3" align="center"><a href="inves?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	Investigation</a></td>
		<td colspan="2" align="center"><a href="stat?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	STAT Medication</a></td>
...
<tr>
	<td colspan="5"align="center"><a href="idiet?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	Diet</a></td>
		...
		<td colspan="3" align="center"><a href="pall?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	Summary</a></td>
		<td colspan="3" align="center"><a href="inmedi1?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">Medication</a></td>
		<td colspan="2" align="center"><a href="stat?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">	STAT Medication</a></td>
		<td colspan="2" align="center"><a href="hmedi?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>"><font size="4.5">High Alert Medication</a></td>
