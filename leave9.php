...
if($tleave=='Annual Leave' && $diff1<$aday){
...
<tr>				 
					<td colspan="4"><input type="text1" name="aleave"   value="<?php echo $aday;?>" readonly/></td>
					<td colspan="4"><input type="text1" name="eleave"  value="<?php echo $aday1;?>" readonly/></td>
					<td colspan="4"><input type="text1" name="sleave" required value="<?php echo $sl;?>" /></td>
<td colspan="4"><input type="text1" name="maleave" required value="<?php echo $ma;?>" /></td>
<td colspan="4"><input type="text1" name="paleave" required value="<?php echo $pa;?>" /></td>					
