<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','staff','imo','doctor','admin1','imo','mofficer','nurse','emergency')"; 
...
<tr bgcolor="#F08080">
      ...
      <td colspan="1" align="center"><strong>Name</strong></td>
...
$count=1;
$sel_query="Select * from cmea where sid= '$user' order by `cdate` DESC;";
...
{ ?>    <tr>
  ...
  <td align="center"colspan="4"><?php echo $row["ctime"]; ?></td>  
	  ...
	  $ctopic=$row['ctopic'];
	  $cdate=$row['cdate'];
	  $q = "SELECT * FROM cme where topic='$ctopic' and date='$cdate'"; 
