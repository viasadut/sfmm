...
$ins_query="insert into iinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user')";
...
{
return confirm("Are you Sure to UPDATE Infusion Status ?");
}
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status1='Active' and status='Data Updated'order by `id` DESC;";
...
$idd=$row['id'];
$ps=$row['pstatus'];
$url8 = "inurseinfusion?pmrn=$pm&eid=$ed&id=$idd"; 
?>
