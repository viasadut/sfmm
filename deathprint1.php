...
$query = mysqli_query($db,"select * from death1 where pmrn='$pmrn' order by id desc");
$data = mysqli_fetch_array($query);
$rdate1=$data['rdate'];
$rdate2=date("d/m/Y", strtotime($rdate1));
...
$pdf->ln(1);
$pdf->SetFont('Arial' , '' , 9);
$pdf->Cell('100',5,'Serial No:',0,0,'R');
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('132' , 5,date('d/m/Y',strtotime($data['rdate'])).' ,'.$data['rtime'],0,1);
...
$pdf->Cell('70',5,$data['iby'],0,1,'C');
$pdf->Cell('70',5,$data1['desig'],0,1,'C');
