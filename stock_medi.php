...
if ($pmrn !== "") {
	...
	$query1 = mysqli_query($con, "SELECT * FROM medi_stock WHERE code='$pmrn' and location='Pharmacy'");
...
//$mcode = $row['code'];
	  $sum = "SELECT SUM(add_qty) FROM medi_stock where code='$pmrn' and location='Pharmacy' and add_qty>0" ;
