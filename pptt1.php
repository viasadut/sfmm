...
$this->Cell('183',6,'Number of Prescription Report ',0,1,'C');
$this->Ln();
}
...
$stmt = $db->query("Select * from presnew where dname='$bt' and date BETWEEN '$start' and '$end'");
$data = $stmt->Fetch(PDO::FETCH_OBJ);
$stmt1 = $db->query("SELECT COUNT(dname) as tt FROM presnew where dname= '$bt' and date BETWEEN '$start' and '$end'");
...
$this->Cell(25,10,$data->date,1,0,'L');
