...
$ins_query="insert into einves (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`type`,`code`,`price`,`odate1`,`subtype`,`link`,`linkv`,`report`,`reportv`,`ndate`,`dname`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated','$type','$code','$price','$odate1','$subtype','$link','$linkv','$report','$reportv','$ndate','$d_name')";
