...
<?php $test=date('Y-m-d', strtotime('-7 days') );
  //echo $test;
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where date1 between '$test' and '$date' and type='rad' and status='' order by date desc;";
...
<input type="submit" name="Submit90" value='PACS VIEW'align="right"></input></td>
