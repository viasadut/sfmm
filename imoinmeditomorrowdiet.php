...
$url = "idprocedurediet.php?pmrn=$pmrn&eid=$eid";

$sel90="SELECT * FROM dietfollow WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `time`='$time' and `status`='Active';";
...
$query="insert into dietfollow (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values 
