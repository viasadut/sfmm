...
$sel_query="Select * from birth where phone= '$pmrn';";}
 else{
	 $sel_query="Select * from birth where pmrn= '$pmrn';";
 } 
$count=1;	 
...
{ ?>    <tr>
     ...
     <?php if($row['i_date']==NULL) {echo 'birthceredit.php';}else {echo 'birthceredit_new.php';}?>?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
