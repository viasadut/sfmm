...
{
$url = "chemodocmedi1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocddfund?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocinfu1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocsorder1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemovitalsdoc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemoinassessmentdoc1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocnote1?pmrn=$pmrn&ID=$ID";
header("Location: $url");
}
?>
...
$url = "chemonursenotedoc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
{
$url = "chemodocinves?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocadm?pmrn=$pmrn&eid=$eid&dname=$full";
header("Location: $url");
}
?>
