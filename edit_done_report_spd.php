...
<form action="edit_done_report_spd" method="POST">
...
$count=1;
$sel_query="Select * from ecg_test where pmrn= '$pmrn' and dname1='$full';";
...
while($row = mysqli_fetch_assoc($result)) { ?>
   <tr>
	  ...
	  <a target="_blank" href="spd_report_edit_doc_new?id='.$row["id"].'&pmrn='.$row["pmrn"].'&loc='.$row["location"].'&lid='.$row["lid"].'">Edit/Confirm</a>';
	  }
