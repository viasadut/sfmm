...
echo '<script language="javascript">';
	...
	$ins_query1="insert into storenew (`ename`,`ename1`,`eid`,`elocation`,`etype`,`eqty`,`estatus`,`remarks`,`adate`,`adate1`,`aby`,`supplier`,`model`,`serialno`,`manu`,`origin`,`installdate`,`warrenty`,`cfo`,`ceo`,`finance`,`price`,`cprice`,`uom`,`md`,`it`,`ittime1`,`p_by`,`charge`,`elocation_s`,`description`,`eid1`,`uprice`) values 
('$ename','$ename1','$eid','$elocation','$etype','$eqty','WAITING FOR CFO APPROVAL','$remarks','$adate','$adate1','$user','$vendor','$model','$serialno','$manu','$origin','$installdate','$warrenty','cfo','ceo','338','$uprice','$cprice','$uom','md','322','$adate1','$p_by','$charge','$elocation_s','$description','$eid1','$uprice1')";
  ...
  <datalist id="browsers111">
	 ...
	 <select name="elocation_s" value="" class="style1"required>
		...
		<br><br>	
			...
			<input  name="eqty" type="text" size="70" value="1" readonly />
