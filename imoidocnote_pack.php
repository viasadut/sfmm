...
$ins_query="insert into icnote_pack (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`entry_time`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','$entry_time','$daten')";
...
<h1 align="center"style="background-color:lightgreen;">package_screening PROGRESS NOTE </h1>
<!-- Form Title -->
...
<td colspan="3" align="center"><label><strong>Time</strong></label></td> 
<td colspan="9" align="center"><label><strong>Progress Note</strong></label></td> 
<td colspan="8" align="center"><label><strong>Investigation/Treatment Plan</strong></label></td></tr>

<tr>

<td colspan="3" align="center"><select name="infu"  value="" required>
...
<td colspan="9" align="center"><textarea rows="2"  name="pnote" required value=""></textarea></td>
<td colspan="8" align="center"><textarea rows="2"  name="inves" required value=""></textarea></td>
</tr>
...
$count=1;
$sel_query="Select * from icnote_pack where pmrn= '$pmrn' and eid='$eid' order by `id` DESC;";
...
$diff_minutes = round(abs($to_time - $from_time) / 60,2);
	  ...
	  $url7 = "idoccnoteedit_imo_pack?pmrn=$pmrn&eid=$eid&id=$id"; 
	  
	  if($diff_minutes<=60 and $row['user']==$full){echo"
