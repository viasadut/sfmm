...
<h1 align="center"style="background-color:lightgreen;">ENDOSCOPY INVESTIGATION REQUEST</h1>
<!-- Form Title -->
...
$rr=date('Y-m-d', strtotime('-15 days') );
$rr1=date('Y-m-d');

$count=1;
$sel_query="Select * from alltest where  pmrn='$pmrn' and date1='$rr1' and location='Endoscopy' and type in ('lab','Lab','LAB') order by `id` DESC;";
...
<td colspan="2" align="center"><a href="labreceiveopd?pmrn=<?php echo $row['pmrn']; ?>&id=<?php echo $row['id']; ?>&eid=<?php echo $row['eid']; ?>"><strong>RECEIVE</str8ong></a></td>	  
