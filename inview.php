		...
		<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
			<thead>
				...
				<tr>
					...
					<th width="14%"><strong>Nusring Form</strong>
			...
			<tbody>
				...
				?>
					<tr>
						...
						?>
						<td align="center" <?php if($count55>0):?> style="background-color:LIGHTGREEN;"<?php else: ?> <?php endif ; ?>><a href="idetails?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><?php echo $row["pname"]; ?></a></td>
						<td align="center"><a href="nurse_assign?mrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&name=<?php echo $row["pname"]; ?>"><?php echo $row["pmrn"]; ?></a>
...
$n1=$data_baby1['beid'];
 ...
 echo'
		  <a target="_blank" href="idetails?pmrn='.$n.'&eid='.$n1.'"><strong><img src="baby1.png" title="Baby Details Of MRN-'.$n.'" width="50" height="50" /></strong></a>
	  ...
	  ?>
						...
						<td align="center">
							<?php
								...
								?>
									<a href="summary_treatment_nurse?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Summary Treatment</a>
								<?php
								}
							?>
						</td>
						...
						<td align="center"> <a target="_blank" href="nursing_form?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>">Nursing Form</a> </td>
							<?php
