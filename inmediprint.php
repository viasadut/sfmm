...
$query = mysqli_query($db,"SELECT * from imedi2 where pmrn='$pmrn' and eid='$eid' and odate='$dd'" );
...
$pdf->Cell('100',5,'Medi Advised:',1,1,'L');
$pdf->Cell('20',5,'LAB :',1,0,'L');
$pdf->Cell('20',5,'LAB :',1,0,'L');
$pdf->Cell('30',5,'LAB :',1,1,'L');
$query1 = mysqli_query($db,"select * from imedi2 where pmrn='$pmrn' and eid='$eid' ");
...
$pdf->Cell('150' , 5,$data1['infusion']. " -" .$data1['instruc'],1,1);
