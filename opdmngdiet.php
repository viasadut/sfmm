...
$query43 = "SELECT COUNT(dname) FROM pappnew where dname= '$full' and adate1 BETWEEN '$start' and '$end'and status='Seen';"; 
...
$query44 = "SELECT COUNT(infusion) FROM icnote where user= '$full' and daten BETWEEN '$start' and '$end';"; 
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pappnew where dname='$full' and adate1 BETWEEN '$start' and '$end' and status='Seen'";
...
//$id=$_REQUEST["id"];
	 ...
	 $sel_query="Select * from icnote where user='$full' and daten BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["inves"]; ?>  
		...
		$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$query4 = mysqli_query($db,"select * from inpatient where pmrn='$pp' and eid='$ee'");
$data = mysqli_fetch_assoc($query4);
$dd=$data['adoc'];
?>
