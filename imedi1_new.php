...
$sel94="SELECT * FROM imedi3 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$datem1' and `time`='$infu1' and `status`='Active' and status1 in ('SEEN','Rupdated');";
...
$sel94="SELECT * FROM imedi3 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$ii' and odate='$datem1' and `time`='$infu1' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result94 = mysqli_query($con,$sel94);
...
echo '<script language="javascript">';
    ...
    echo '</script>';
			...
			{
			$strSQL = "insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`uprice`,`code`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime','$dilu','$uprice1','$p_code')";
			...
			{
			$strSQL = "insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`reuse`,`uprice`,`code`) values 
...
$strSQL = "Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and status!='Cancel' and status1='Rupdated' and odate='$dd' order by `time` asc;";
...
$ii=$row['id'];
$query43 = "SELECT COUNT(pstatus) FROM imedi3 where id= '$ii' and pstatus='Ordered' and status !='Cancel';"; 
...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and status1 in ('implemented','SEEN') and odate='$dd'order by `donet` desc;";
