...
$query = "SELECT * from cath_receive where id='$id'"; 
...
$query43l = "SELECT COUNT(id) FROM cath_receive where id= '$id' and report='1';"; 
...
//$url = 'cath_receive2?pmrn='.$row["pmrn"].'&dname='.$row["dname"].'&eid='.$row["eid"].'&id='.$row["id"].'&type='.$row["type"].'&ieid='.$row["ieid"].''; 
$date_d= date('Y-m-d');
$url = 'cath_receive2';
...
$update="update cath_receive set report='1' where `id`='$id'";
