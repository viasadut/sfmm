...
$ins_query6="insert into inmedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`) values ('$pmrn','$dname','$eid','$infu','$infu1')";
mysqli_query($con,$ins_query6) or die(mysql_error());}

if (!empty ($_POST['infu2'])){
$ins_query61="insert into inmedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`) values ('$pmrn','$dname','$eid','$infu','$infu2')";
mysqli_query($con,$ins_query61) or die(mysql_error());}

if (!empty ($_POST['infu3'])){
$ins_query62="insert into inmedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`) values ('$pmrn','$dname','$eid','$infu','$infu3')";
mysqli_query($con,$ins_query62) or die(mysql_error());}

if (!empty ($_POST['infu4'])){
$ins_query63="insert into inmedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`) values ('$pmrn','$dname','$eid','$infu','$infu4')";
mysqli_query($con,$ins_query63) or die(mysql_error());}

if (!empty ($_POST['infu5'])){
$ins_query64="insert into inmedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`) values ('$pmrn','$dname','$eid','$infu','$infu5')";
...
<tr>
      ...
      <td colspan="4" align="center"><strong>Medicine</strong></td>
...
$sel_query22="Select * from inmedi1 where pmrn= '$pmrn' and eid='$episode'";

$result22 = mysqli_query($con,$sel_query22);

$row22 = mysqli_fetch_assoc($result22);

$sel_query="Select * from inmedi2 where pmrn= '$pmrn' and eid='$episode'and status ='' order by `time` ASC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><?php echo $row["instruc"]; ?></td>
      	  <td align="center"colspan="2"><font size="4.5" color="#FF0000"><b><?php echo $row["alert"]; ?></td>
<td colspan="2" align="center"><a href="inmedi2?pmrn=<?php echo $data["pmrn"]; ?>&eid=<?php echo $data59["eid"]; ?>&id=<?php echo $row["id"]; ?>"><font size="4.5">Update</a></td>
