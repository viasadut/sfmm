...
//$pbp1= implode(",",$pbp2);
 ...
 if($user=='1601')       
      {  
           ...
           $query = "update pms_bill_payment set approve_status='2',cfo_date='$date2' WHERE chequeno = '".$_POST["employee_id"]."' and approve_status='1'";  
      ...
      {  
           ...
           $query = "update pms_bill_payment set approve_status='3',ceo_date='$date2' WHERE chequeno = '".$_POST["employee_id"]."' and approve_status='2'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
           $_SESSION['success'] = 'Successfully Approved.';
      }  
