...
$query4 = mysqli_query($db,"select * from micro where sno='$sno'");
...
$query = "UPDATE iinves set eby='$user',etime='$dtime' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());


$query1 = "UPDATE micro set ins1='$infu' where sno='$sno'"; 
...
<td colspan="8" align="center"><label><strong>Result</strong></label></td>
...
<td colspan="8" align="center"><textarea name="infu" required><?php echo $data["ins1"]; ?></textarea></td>
