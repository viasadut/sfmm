...
<!-- Form Title -->
	  ...
	  <input list=poss name="poss" placeholder="Select Possession" size="70"">
		...
		<br><br>
			...
			<input list="browsers131" name="btype1" class="country"size="70"">
...
?>
		...
		<label for="mail"><strong>Avaiable Bed :</strong></label>
									<p>
		<input list="browsers11" name="bno14" class="state" value="">
		
		<datalist id="browsers11"name="bno" class="state" value=''required></datalist>

		<input list="browsers111" name="bno7" class="state1" value="">
		<datalist id="browsers111"name="bno2" class="state1" value=''required></datalist>
		<label for="mail"><strong>Avaiable Bed :</strong></label>
									<p>
...
<input type="text" name="bno" class="state" size="70" value="<?php echo $row['brand1']; ?>"required  />
