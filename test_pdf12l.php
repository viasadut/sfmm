...
$this->Cell(20,10,'District',1,0,'C');
...
$stmt = $db->query("Select * from covidopd where ssent BETWEEN '$start' and '$end' and status='collected' order by lid asc ");
...
$this->Cell(100,($line * $cellHeight),strtoupper($data->name),1,0);
$this->SetFont('Times', '',7);
$this->Cell(7,($line * $cellHeight),strtolower($data->page),1,0);
$this->Cell(9,($line * $cellHeight),strtolower($data->psex),1,0);

$this->Cell(25,($line * $cellHeight),strtolower($data->phone),1,0);




$this->Cell(15,($line * $cellHeight),strtolower($data->sam),1,0);
...
$this->Cell(20,($line * $cellHeight),strtolower($data->ward),1,0);
$this->Cell(20,($line * $cellHeight),strtolower($data->district),1,0);

if($data->tresult=='P'){
	$this->SetFont('Times', 'b',11);
$this->Cell(25,($line * $cellHeight),'POSITIVE',1,0);
}

else if($data->tresult=='N'){
	$this->SetFont('Times', '',11);
$this->Cell(25,($line * $cellHeight),'NEGATIVE',1,0);
}
	...
	$this->SetFont('Times', '',11);
$this->Cell(25,($line * $cellHeight),'--',1,0);
}
