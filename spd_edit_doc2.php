...
$update="update alltest set status='SEEN', report='$plaintext' where `id`='$id'";
...
<tr>
    ...
    function EnableDisableTextBox(chkPassport) {
	 ...
	 <input type="text" id="txtPassportNumber" name='type' disabled="disabled" required style="background-color:lightgreen;" placeholder="Name The Template">
	  ...
	  <td colspan="5"><a target='_blank' href="ecg_pdf1.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
