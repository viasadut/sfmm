...
$querybp = "SELECT COUNT(hrd) FROM vitalsbp where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypulse = "SELECT COUNT(hrd) FROM vitalspulse where pmrn='$pmrn' and date1='$odate1'"; 
...
if (!empty ($_POST['sbp'])){
$ins_querybp="insert into vitalsbp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`vitails2`,`score2`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','sbp','$sbp','dbp','$dbp','$countbp1','$user','$odate','$time')";
mysqli_query($con,$ins_querybp) or die("Problem in entry");}

if (!empty ($_POST['pulse'])){
$ins_querypulse="insert into vitalspulse (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','Pulse','$pulse','$countpulse1','$user','$odate','$time')";
...
if (!empty ($_POST['temp'])){
$ins_querytemp="insert into vitalstemp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','Temperature','$temp','$countspo21','$user','$odate','$time')";
...
<tr>
<td colspan="2" align="center"><label><strong>Height(KG)</strong></label></td> 
...
<td colspan="2" align="center"><select name="time"  value="" >
...
<tr>
      ...
      <td colspan="3" align="center"><strong>Temp</strong></td>
      <td colspan="2" align="center"><strong>BP</strong></td>
...
$count=1;
$sel_query="Select * from gcs1 where pmrn= '$pmrn' and eid='$episode' and date2='$odate1'order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><?php echo $row["score"]; ?></td>  
      <td align="center"colspan="2"><?php echo $row["score1"]; ?></td>
      <td align="center"colspan="4"><?php echo $row["hr"]; ?></td>  
