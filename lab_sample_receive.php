...
$sel_query="Select * from presnew where id='$pmrn' order by id desc;";}
 else{
	 $sel_query="Select distinct pmrn from presnew where pmrn= '$pmrn' order by id desc;";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  $pid=$row['ID'];
	  $pid1=$row['id'];
	  $url = "lab_sample_receive1?pmrn=$pm&ID=$pid1"; 
	  $url1 = "lab_sample_receive1?pmrn=$pm&ID=$pid1"; 
	  ?>
	  
	  <td align="center"><?php if($_POST['select']=="id")
	  
	  {echo "<a href='$url1'>GO</a>";}
