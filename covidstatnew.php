...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','qc','mrd','covid','covid1','lab')"; 
...
$query43 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sam='NEW' and status='collected' and sentto='SFMMKPJSH'"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sam='FollowUp' and status='collected'and sentto='SFMMKPJSH'"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);

$query45 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sam='Death' and status='collected'and sentto='SFMMKPJSH'"; 
	 
$result45 = mysqli_query($con, $query45) or die(mysqli_error());
$row45 = mysqli_fetch_assoc($result45);


$query46 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tresult!='' and status='collected'and sentto='SFMMKPJSH'"; 
	 
$result46 = mysqli_query($con, $query46) or die(mysqli_error());
$row46 = mysqli_fetch_assoc($result46);


$query47 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tresult='P' and status='collected'and sentto='SFMMKPJSH'"; 
	 
$result47 = mysqli_query($con, $query47) or die(mysqli_error());
$row47 = mysqli_fetch_assoc($result47);

$query48 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tresult='N' and status='collected'and sentto='SFMMKPJSH'"; 
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and status='Collected' and sentto='SFMMKPJSH' order by lid asc;";
...
<td align="center"><?php if($tt=='P'){echo "<span style='color:red;text-align:center;'><b>POSITIVE"; }else if($tt=='N'){echo "<span style='color:green;text-align:center;'><b>NEGATIVE"; }else {echo "";} ?>  </td>
...
<?php $count++; } }?>
	  ...
	  <td colspan ="7" align="right"><a target='_blank' href="covid_excel_report?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>">Download In Excel</a></td>	
  </tbody>
</table>
