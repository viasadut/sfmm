...
$id1 = '".$_POST["chkDel"][$i]."';
$query45 = mysqli_query($db,"select * from alltest where id='$id1'");
...
$dname=$data6['dname'];
			...
			$strSQL = "UPDATE alltest set reby='$user',retime='$dtime', rstatus='RECEIVED', barcode='$result',status='RECEIVED' ";
...
values ( '$pmrn','$eid','$pname','$page','$psex','$redate','$rinfusion','$dname','$adate','$user','$dtime','$result','OPD','$sno','$link','$linkv','$reportv','$report')";
...
<td colspan="4" align="center"><input type="text" name="result" required value=""></td></td>	
		...
		<tr>
						...
						<tr>				
						<td colspan="5"><?php echo $data["bdate"]; ?></td>  
...
$objConnect = mysql_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysql_select_db("sfmmkpjnew");
$strSQL = "Select * from alltest where pmrn= '$pmrn' and type='lab' and status='' order by date1 desc;";
