...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`,`location`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','available','Compatible','$sno','$bgroup','$adate1','$remarks','$location')";
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`,`location`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edateffp','available','Compatible','$sno','$bgroup','$adate1','$remarks','$location')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
else if (empty($data2b) and $btype=='PLATELET CONCENTRATE' and $vdrl=='Non-Reactive' and $hiv=='Negative' and $plas=='Negative' and $plas1=='Negative' and $hbs=='Negative' and $hcv=='Negative')
{

$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`,`location`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edateplt','available','Compatible','$sno','$bgroup','$adate1','$remarks','$location')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
else if (empty($data2b) and $btype=='PLATELET APHERESIS' and $vdrl=='Non-Reactive' and $hiv=='Negative' and $plas=='Negative' and $plas1=='Negative' and $hbs=='Negative' and $hcv=='Negative')
{
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`,`location`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','not available','Non Compatible','$sno','$bgroup','$adate1','$remarks','$location')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`,`location`) values 
n('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','not available','Non Compatible','$sno','$bgroup','$adate1','$remarks','$location')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<!-- Form Title -->
      ...
      <label for="age"><strong>Collect From:</strong></label>
...
<option value="">--Select--</option>
	  ...
	  <option value="PRBC">Packed red blood cell</option>
...
<label for="age"><strong>Remarks:</strong></label>
    ...
    <textarea name="remarks" type="text" size="13"value="" required>Screening test of HBsAg, HIV ( 1+2 ), HCV, Malaria Parasite & Syphilis are carried out by Immunochromatography ( ICT ) method . Cross Match was done by room temperature in saline method
