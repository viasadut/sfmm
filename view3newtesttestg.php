...
<?php	  $date=$row["date"] ;?>
	  ...
	  <?php
		...
		$url = "historynewtestm?pmrn=$pm&eido=$eido&date=$dateo&dname=$full&eid=$eid"; 
		$url1 = "historynewtestf?pmrn=$pm&eido=$eido&date=$dateo&dname=$full&eid=$eid"; 
	if($gender=='F')
	{ 
echo "<a target='_blank' href='$url1'>Details</a>";
	}
	
	else{
		echo "<a target='_blank' href='$url'>Details</a>";
