...
$query = mysqli_query($db,"select * from histo where pmrn='$pmrn' and eeid='$eeid' and dname='$dname1'");
...
$pdf->Cell('182',6,$data['bio2'].' Request',1,1,'C');
//$this->SetFont('Arial','B',);

$pdf->ln(10);
$pdf->SetFont('Arial' , 'b' , 12);
$pdf->Cell('40',5,'Consultant Name:',0,0,'L');
$pdf->Cell('90',5,$data2['dname'],0,0,'L');
$pdf->ln(4);
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('119',5,'Details of the Request:',1,0,'L');
$pdf->Cell('62',5,'Date & Time: '.$data['date'].' '.$data['time'],1,1,'L');

$pdf->SetFont('Arial' , '' , 10);

$pdf->SetFont('Arial' , 'b' , 10);
$pdf->ln(5);
$pdf->Cell('182',5,'Short History',0,0,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->ln(5);
$pdf->MultiCell('182' , 5,$data['shistory'],0,1);

$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Name Of Operation:',0,0,'L');
$pdf->ln(5);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['noperation'],0,1);
$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Indication:',0,0,'L');
$pdf->ln(5);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['indication'],0,1);
$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Findings:',0,0,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->ln(5);
$pdf->MultiCell('182' , 5,$data['find'],0,1);
$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Biospy Specimen:',0,0,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->ln(5);
$query1 = mysqli_query($db,"select * from histo where pmrn='$pmrn' and eeid='$eeid'");
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data1['bio1'],0,1);

$pdf->ln(1);
}
$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Biopsy For:',0,0,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->ln(5);
$pdf->MultiCell('182' , 5,$data['bio2'],0,1);
//$pdf->ln(2);
