...
$sel_query="Select * from store where etype='Disposable' and estatus= 'Active' ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["estatus"]; ?>  
	        ...
	        <td colspan="10"><a target='_blank' href="dmtransfer.php?id=<?php echo $row['id']; ?>">Send to Boimedical</a></td>	
