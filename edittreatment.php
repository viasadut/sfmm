...
$sel43="SELECT * FROM mtreatment WHERE `id`='$id' ;";
...
$ins_query="update mtreatment set `nid`='$passno',`nid1`='$passno1',`ffor`='$ufor',`fdate`='$fdate',`fdate1`='$fdate1',`tdate`='$tdate',`tdate1`='$tdate1',`rdate`='$rdate',`rdate1`='$rdate1',`tdays`='$e',`diagnosis`='$diag',`staff`='$staff' where id='$id'"; 
mysqli_query($con,$ins_query) or die(mysql_error());


  echo '<script language="javascript">';
    echo 'alert("Treatment Certificate Edited Successfully !!"); ';
echo '</script>';}
...
<label for="name"><strong>Paients Identify:</strong></label>
      ...
      <textarea rows="5"  name="ufor" required><?php echo $row3['ffor'];?></textarea>
		...
		<label for="mail"><strong>From :</strong></label>
									<p>
									  <input type="text" name="fdate" id="datepicker" placeholder="Select Date" size="15" value="<?php echo $row3['fdate'];?>" required>
									  
									  
									  <label for="mail"><strong>TO :</strong></label>
									<p>
									  <input type="text" name="tdate" id="datepicker1" placeholder="Select Date" size="15" value="<?php echo $row3['tdate'];?>"required>
									  
									  
									  
									  
		<label for="age"><strong>Remarks :</strong></label>
      <textarea rows="5"  name="rdate" value=''><?php echo $row3['rdate'];?></textarea>
...
<td><a target='_blank' href="printtreatment1.php?id=<?php echo "$id"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
