...
$ins_query="insert into m_suite (`dname`,`pname`,`pmrn`,`pphone`,`page`,`psex`,`pdate`,`ptime`,`proname`,`type`,`ieid`,`date1`,`ll`) values 
('$dname', '$pname','$pmrn','$pphone','$page','$psex','$pdate','$ptime','$proname','Inpatient','$eid','$date1','$ll')";
...
<td colspan="4"><select name="ll">
            ...
            <option value='Maternity Procedure Room'>Maternity Procedure Room</option>
