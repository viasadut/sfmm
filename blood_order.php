...
function Header()
{
    ...
    $this->Cell(0,6,' Blood Transfusion Order Details',0,1,'C');
...
$dd=date('m/d/Y');
$dd1=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from iblood where pmrn='$pmrn' and eid='$eid' " );
...
$pdf->Cell('45',5,'Consultant Name:',0,0,'L');
...
$pdf->Cell('7',5,$data2['gender'],1,0,'L');
$pdf->Cell('14',5,'AGE:',1,0,'L');
$pdf->Cell('37',5,$data2['age'],1,1,'L');
...
$pdf->ln(10);
$pdf->Cell('100',5,'Location:'. $data['location'],1,0,'C');
$pdf->Cell('146',5,'Blood Type:'. $data['room'],1,1,'L');


$pdf->ln(10);
$pdf->SetFont('Arial' , 'b' , 8);
$pdf->AddCol('ooby1',35,'Order BY','L');
$pdf->AddCol('first',45,'First 10 Mins Drop Rates/Mins','L');
$pdf->AddCol('second',30,'Then Increase to');
$pdf->AddCol('amount',80,'Amount');
$pdf->AddCol('finish',30,'Finish By (Hour)','C');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iblood where id='$id' and ooby1!=''",$prop);

$pdf->ln(10);
$pdf->SetFont('Arial' , 'ub' , 12);
$pdf->MultiCell('245',5,'NOTE:',0);
$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->MultiCell('245',5,'If Any Reaction Occurs, Immediately Stop Transfusion and please give-
 - Inj. hydrocortisone 1vial I/v
 - Inj chlorpheniramine I/m
 - Inform The Duty Doctor Immediately  ',0);
$pdf->Output();
?>