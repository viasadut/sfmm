...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from pappnew where dname= 'Physiotherapy' and adate= '$date' and status not in ('SEEN','Cancel') ORDER BY aslot asc;";
...
$url1 = "newcdetails_et_physio?ID=$ID&pmrn=$pmrn"; 
...
?>
	  ...
	  <td align="center">
	   <?php if($bstatus=='BILLED' and $status!='HISTORY UPDATED'){echo"<span style='color:green;text-align:center;'><b><a href='$url1'><strong>Update Vitals</strong></a>";} else if($bstatus!='BILLED' and $status!='HISTORY UPDATED'){echo "<span style='color:red;text-align:center;'><b>UNPAID";}
