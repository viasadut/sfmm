...
<h1 align="center"style="background-color:lightgreen;">PENDING INVESTIGATION LIST FOR CONFIRMATION(A&E)</h1>
<!-- Form Title -->
...
$count=1;
$sel_query="Select * from einves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and ndate between $test and '$apdate'  order by `id` DESC;";
