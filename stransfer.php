...
$ins_query="insert into stransfer (`sid`,`cname`,`institue`,`cyear`,`remarks`,`date`,`user`,`status`) values ('$sid', '$cname','$institue','$cyear','$remarks','$date','$user','active')";
mysqli_query($con,$ins_query) or die(mysql_error());

$query = "update staff1 set department='$cname', sdepartment='$institute' where sid='$sid'"; 
...
<tr><td colspan="4" align="center"><label><strong>New Department</strong></label></td> 
<td colspan="4" align="center"><label><strong>New Sub Department</strong></label></td> 
...
<tr>
<td colspan="4"><input list="tname45" name="cname" class="form-control" value="">
	...
	<datalist id="tname45">
				  ...
				  <td colspan="4"><input list="tname46" name="institute" class="form-control" value="">
	
	<datalist id="tname46">

						<option value=''>-Select Sub Department-</option>
				  </datalist></td>  
<td colspan="4"><input type="text" name="cyear" id="datepicker" placeholder="Select Date" required></td>  
...
<tr>
      ...
      <td colspan="2" align="center"><strong>SID</strong></td>
     	  <td colspan="4" align="center"><strong>New Department</strong></td>
		  <td colspan="4" align="center"><strong>New Sub Department</strong></td>
...
$count=1;
$sel_query="Select * from stransfer where sid= '$sid' and status='active' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["sid"]; ?></td>
						...
						<td align="center"colspan="4"><?php echo $row["institute"]; ?></td>
			
				  <td align="center"colspan="2"><?php echo $row["cyear"]; ?></td>
				  <td align="center"colspan="3"><?php echo $row["remarks"]; ?></td>
				  <td align="center" colspan="1"><a href="deletetransfer?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>">DELETE</a></td>
