...
<tr><td align="right" colspan="20"><a target='_blank' href="docassessprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Doctor's Assessment</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="deathstatdetailsmngmrddiet?pmrn=<?php echo "$pmrn"; ?>"><b>Patient's Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="opdradreportmrddiet?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Radiology Report<b></a>&nbsp;&nbsp;<a target='_blank' href="endoreportinmrddiet?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Endoscopy Report<b></a>&nbsp;&nbsp<a target='_blank' href="http://192.168.100.254?pmrn=<?php echo "$pmrn"; ?>"><b>LAB REPORT<b></a>&nbsp;&nbsp;<a target='_blank' href="surnotemngmrddiet?pmrn=<?php echo "$pmrn"; ?>"><b>Surgery Note<b></a>&nbsp;&nbsp;<a target='_blank' href="cardiolinkmngmrddiet?pmrn=<?php echo "$pmrn"; ?>"><b>Cardiology Report<b></a></td></tr>
...
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'order by `time` asc;";
