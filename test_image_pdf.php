...
$query = mysqli_query($con,"select * from patient_pic where pmrn='$pmrn' and id='15'");
...
$pdf->Image($image4, 40, 90, 100, 100, 'JPG', '', '', true, 150, '', false, false, 0, false, false, false);
...
<br><br><br>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="75%" style="font-weight: bold !important;font-size:14px;" align="left"><b>'.$data['add_by'].'</b></td>
                    </tr>
                    <tr>
...
<br><br>
                ...
                <table style="border: 1px solid black"  cellspacing="0" cellpadding="1">
                    <tr>
                        <td align="left" width="45%"><b>Patient Name : '.$data['cat'].'</b></td>
