...
<ul>
   ...
   <li class='last'><a target='_blank' href='appcancel12_ca'><span style="color:red;font-weight:bold;font-size:14px;">Cancel Appointment</span></a></li>
...
function showUser() {
  ...
  xmlhttp.open("GET","auto_re22_sticker.php",true);
  xmlhttp.send();
}
