...
$ins_query1="insert into rubella (`pname`,`pmrn`,`psex`,`page`,`result`,`opinion`,`crate`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`type`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Rubella-IgM:</strong></label>
