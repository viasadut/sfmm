...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from inpatient where discharge= '' and api_status in ('1','2') order by room asc";
...
echo $diff->format("%R%a days");?>  </td>
     ...
     <td align="center"><a href="inpatient_api_phar?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Pending Invoice</a></td>
