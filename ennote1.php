...
$ins_query="insert into ennote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`user`,`status`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$user','Rupdated')";
...
<td colspan="20" align="center"><label><strong>Nurses Note</strong></label></td>
</tr>


<td colspan="20" align="center"><textarea rows="2" cols="50" name="inves" required value=""></textarea></td>
</tr>
