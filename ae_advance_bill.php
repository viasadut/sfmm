...
$count = "SELECT COUNT(id) FROM advance_bill where pmrn='$pmrn'and eid='$eid' and billno='' and dname='AE ADVANCE'"; 
...
$query198 = "SELECT SUM(amount) FROM advance_bill where pmrn='$pmrn'and eid='$eid' and dname='AE ADVANCE'"; 
...
$query198_r = "SELECT SUM(amount) FROM advance_bill where pmrn='$pmrn'and eid='$eid' and dname='AE Refund'"; 
...
if($db1->commit()){
  ...
  $ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
    values ('$last_id','CR','111999','$date','$price','AE ADVANCE')";
    ...
    values ('$last_id','DR','619210','$date','$price','AE ADVANCE')";
    ...
    {
    $ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
    values ('$last_id','DR','619230','$date','$price','AE ADVANCE')";
    mysqli_query($con,$ins_query2) or die(mysql_error());
    }
    ...
    {
    $ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
    values ('$last_id','DR','619220','$date','$price','AE ADVANCE')";
    mysqli_query($con,$ins_query2) or die(mysql_error());
    }


  header("Location: ae_advance_bill.php?pmrn=$pmrn&eid=$eid");
}
}
...
$row45=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(amount) FROM advance_bill WHERE location='AE' and pmrn='$pmrn' and eid='$eid' and dname='AE ADVANCE'"));

$row455=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(amount) FROM advance_bill WHERE location='AE'and pmrn='$pmrn' and eid='$eid' and dname='AE Refund'"));
...
if($db1->commit()){
  ...
  $date=date('Y-m-d');
  $ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
    values ('$last_id','DR','111999','$date','$price','AE REFUND')";
    mysqli_query($con,$ins_query) or die(mysql_error());
    ...
    {
    $ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
    values ('$last_id','CR','619210','$date','$price','AE REFUND')";
    mysqli_query($con,$ins_query2) or die(mysql_error());
    }
    ...
    {
    $ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
    values ('$last_id','CR','619230','$date','$price','AE REFUND')";
    mysqli_query($con,$ins_query2) or die(mysql_error());
    }
  ...
  {
  $ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
  values ('$last_id','CR','619220','$date','$price','AE REFUND')";
  mysqli_query($con,$ins_query2) or die(mysql_error());
  }
...
header("Location: ipd_bill_paper_advance_ae.php?adate1=$adate1&pmrn=$pmrn&dname=$dname&billno=$last_id&eid=$eid");
}
...
<tr>
    ...
    href="ae_bill_paper_advance?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>">Print</a></td>  	  
...
$count=1;
$sel_query="Select * from advance_bill where pmrn= '$pmrn' and eid='$eid' and location='AE' order by `id` DESC;";
