...
$sel_query="Select * from store1 where eid='$eid' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <?php if($row['estatus']=='Active')echo'
	  <td align="center" style="font-size:22px; color:green;font-weight:bold">'.$row["estatus"].'</td>';  
	  
	  else if($row['estatus']=='Non-Functional')echo'
	  <td align="center" style="font-size:22px; color:red;font-weight:bold">'.$row["estatus"].'</td>';  
...
<td align="center"><?php echo $row["solvetime"]; ?>  	  
<td align="center"><?php echo $row["rm"]; ?>  	  
