...
$ins_query1="insert into othoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`ins`) values ('$pmrn','$pname','$medi1','$id','$date1','$pdos','$dcode','$pp1')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into othoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`ins`) values 
('$pmrn','$pname','$d_name','$id','$date1','$pdos','$medi1','$pp1')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<td colspan="15" align="center"><input list="browsers2" name="medi1" size=60%  class="form-control" autocomplete="off" required/>
  <datalist id="browsers2">
				...
				<?php 
			$sql76 = "select * from `storenew` where estatus='Active'";
...
{ echo'
				 ...
				 <td align="center" colspan="2"><a href="othosdelete?id3='.$row["id"].'&pmrn='.$pmrn.'&id='.$id.'">DELETE</a></td>';
