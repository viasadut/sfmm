<?php 
	...
	try {
		$patientQuery	= "SELECT * FROM `inpatient` WHERE `eid`='$eid' AND `pmrn`='$pmrn' AND `confirmdn`!=''";
			...
			try {
				...
				$dbh->query("INSERT INTO `rfid_transaction` (
						...
						'$patient_rfid_v',
							'Receive',
								'$user_id',
									'Card Status Clear, MRN-.$pmrn',
										'$transaction_by_dept',
											'$transaction_by_dept'
					)");
				$dbh->commit();
				header("location:it_rfid_inpatient_card_clear.php");
			} catch (\Throwable $e) {
				$dbh->rollback();
				throw $e;
                            ...
                            <form class="form-horizontal" action=""  method="post">
								...
								?>
									<div class="form-group row">
										<label for="staticEmail" class="col-sm-4 col-form-label">Patient RFID Tag(<?php echo $patient_rfid_s;?>):</label>
										<div class="col-sm-8">
								...
								?>
									<div class="form-group row">
										<label for="inputPassword" class="col-sm-4 col-form-label">Attendant RFID(<?php echo $attendant_rfid_s;?>):</label>
										<div class="col-sm-8">
								...
								?>
									<div class="form-group row">
										<label for="inputPassword" class="col-sm-4 col-form-label">Visitor RFID(<?php echo $visitor_rfid_s;?>):</label>
										<div class="col-sm-8">
