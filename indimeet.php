...
$count=1;
$sel_query="Select * from cme where status= 'Approved' and category='$cname' order by `id` DESC;";
...
<td align="center"><a  target='_blank' href="minutesview?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">View Minutes</td>
<td align="center"><a  target='_blank' href="meetingminutes/<?php echo $row["minutes_p"]; ?>">View Minutes(pdf)</td>  		  		
