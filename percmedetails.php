...
$query4 = mysqli_query($db,"select * from cme where topic='$ctopic'");
...
$count=1;
$sel_query="Select * from cmea where sid= '$user' and ctopic='$ctopic' order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["mname"]; ?></td>
