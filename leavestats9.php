...
$query43 = "SELECT COUNT(sname) FROM conleavedetails where sname= '$bt' and status='Approved By ALL';"; 
...
$sel_query="Select * from conleavedetails where sname='$bt' and status='Approved By ALL'";
