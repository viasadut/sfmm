...
$queryd = "SELECT * from medicine where id='".$id."'"; 
...
$gg=$rowd['code'];
$count=1;
$sel_query="Select * from medi_stock where code='$gg' and status='Pending' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  $queryr = "SELECT SUM(add_qty) from medi_stock where code='".$gg."' and status='Pending'"; 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicine where id='$id' ORDER BY id desc;";
...
$ccode=$row['code'];
	  ...
	  $queryrv = "SELECT SUM(add_qty) from medi_stock where code='".$ccode."' and location='Pharmacy' and add_qty>0"; 
...
$sum=$rowrv['SUM(add_qty)'];
	  ...
	  <span style='color:green;font-weight:bold'>".$cc.".".$rowr['company']."</span><br>";}
	  
	  else {echo "
	  
	  <span style='color:red;font-weight:bold'>".$cc.".".$rowr['company']."</span><br>";}?>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from add_com_product where mid='$id' ORDER BY status asc;";
