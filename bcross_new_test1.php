...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','available','Compatible','$sno','$bgroup')";
...
else if  ($vdrl=='Reactive' || $hiv=='Positive' || $plas=='Positive' || $plas1=='Positive' || $hbs=='Positive' || $hcv=='Positive')
{

$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`) values 
n('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','not available','Non Compatible','$sno','$bgroup')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edateffp','available','Compatible','$sno','$bgroup')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','','$edateffp','not available','Non Compatible','$sno','$bgroup')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edateplt','available','Compatible','$sno','$bgroup')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','','$edateplt','not available','Non Compatible','$sno','$bgroup')";
mysqli_query($con,$ins_query1) or die(mysql_error());
