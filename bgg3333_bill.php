...
//mysqli_query($con,$update1) or die(mysql_error());
   ...
   //    echo '<script language="javascript">';
    ...
    if(mysqli_query($con,$update33)==true and mysqli_query($con,$update87)==true and mysqli_query($con,$update1)==true){

      header("Location: opd_bill_pdf22.php?id=$id&pmrn=$pmrn&eid=$eid");
      }
      else {
...
if(mysqli_query($con,$ins_query1)==true and mysqli_query($con,$update33)==true and mysqli_query($con,$update87)==true){
...
?>
		...
		<a href="opd_bill_pdf2.php?id=<?php echo $data['ID'];?> " target="_blank" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
