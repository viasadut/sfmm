...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status not in ('Active') and type in ('spd','spd1') and status !='Rejected' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from edit_inves where status not in ('Active') and type in ('spd','spd1') order by id desc;";
