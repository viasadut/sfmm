...
//$rr1='Result- :'.$chikun1."<br />".'Interpretation:'.$chikun2;

//$rr='Result- :'.$chikun1."<br />".'Interpretation:'.$chikun2;




$update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$chikun1',result1='$chikun1',room='$chikun2' where id='$id'";
