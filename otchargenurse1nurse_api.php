...
/*$ins_query1="insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`,`remarks`) values 
('$pmrn','$pname','$ii','$eid','$date1','$pdos','$dcode','$t_price','$date2','$sub_type','Package')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
*/
$sql = "insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`,`remarks`) values 
('$pmrn','$pname','$ii','$eid','$date1','$pdos','$dcode','$t_price','$date2','$sub_type','Package')";
...
$invoice_no=$decoded_response['invoice_id'];
 ...
 $api_query = "update inhoscharge set api_status='1', invoice_no='$invoice_no' where id='".$last_id."'"; 
...
/*else if($res90=mysqli_num_rows($result3)>0 and $dis_pack<=0){
...
//else {
/*$ins_query1="insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$sub_type')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
*/
...
$sql = "insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$sub_type')";
...
<tr>
<td colspan="15" align="center"><select class="con_charge21"
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
         ...
         <a href="inhosdelete_api1?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&invoice_no=<?php echo $row['invoice_no']; ?>&admission_no=<?php echo $api_adminssion_no; ?>&code=<?php echo $rrt; ?>&pdos=<?php echo $row['pdos']; ?>"></a>

         <form action="inhosdelete_api1" method="post" id="tt" >
<input type="hidden" name="id3" value="<?php echo $row['id'];?>"</input>
<input type="hidden" name="pmrn" value="<?php echo $pmrn;?>"></input>
<input type="hidden" name="eid" value="<?php echo $eid;?>"></input>
<input type="hidden" name="invoice_no" value="<?php echo $row['invoice_no'];?>"></input>
<input type="hidden" name="admission_no" value="<?php echo $api_adminssion_no;?>"></input>
<input type="hidden" name="code" value="<?php echo $rrt;?>"></input>
<input type="hidden" name="pdos" value="<?php echo $row['pdos'];?>"></input>

<input type="submit" name="Submit90" id="submitButton" value="DELETE" align="right"></input>
</form>
