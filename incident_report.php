...
<div class="container">
    ...
    <form action="incident_report_upload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from incident1 where id='$id' and image!='';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    ...
                    <form action="incident_report_delete.php" method="POST">
