...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pms_payment where date BETWEEN '$start' and '$end' and refund_by='' and user='$user'";
 } 
$count=1;
...
$query43_p = "SELECT SUM(amount) FROM pms_bill where user= '$bill_user'and date='$bill_date';"; 
...
$user_name_d = mysqli_fetch_assoc($user_name_r);
      ...
      <?php echo $row43["SUM(amount)"]; ?></a>   </td>
	        <td align="center">
