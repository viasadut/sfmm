...
$querynn="select * from pappnew where pmrn='$pmrn'and status in ('HISTORY UPDATED','SEEN')";
$resnn=$dbhandle->query($querynn);
...
<?php
 while($rownn=$resnn->fetch_assoc())
{
echo"['".$rownn['adate1']."',".$rownn['weight'].",".$rownn['temp'].",".$rownn['ppluse']."],";
}
?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="curve_chart" style="width: 500px; height: 240px"></div>
        </div>
