...
function Header()
{
    ...
    $this->Cell(0,6,' Dinner Diet Order Sheet',0,1,'C');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iidiet where odate ='$dd' and status='Diet Ordered' and diettime in ('Dinner','Extra Food') and status1!='Cancel'order by room",$prop);
$pdf->Output();
?>