...
$query = mysqli_query($db,"select * from edit_inves where ittime1='$ed' and type='rad'");
...
$count=1;
$query1 = mysqli_query($db,"select * from edit_inves where ittime1='$ed'and type='rad'");
...
$pdf->Cell('70',5,'Done By: '.' '.$data['itby'],1,0,'L');
