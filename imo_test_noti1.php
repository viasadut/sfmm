   ...
   <li><a href='own_work_list'><span>Home</span></a></li>
	...
	<div class="demo-content">
		<div id="notification-header">
			   ...
			   <button style="width:50px;"id="notification-icon" name="button" onclick="myFunction()" class="dropbtn"><span id="notification-count"><?php if($count>0) { echo"<span style='font-weight:bold;font-size:20px;'>".$count."</span>"; } ?></span><img src="bell.png" style="width:50px;height:50px;">
			</button>
...
<input style="background-color: lightblue; width:250px;" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search by Ward" title="Search by Ward"><input style="background-color: lightgreen;width:250px;" type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by Consultant Name" title="Search by Consultant Name">
</div>
