...
*/
	...
	// }
		...
		if ($patient_rfid_count==1 and $attendant_rfid_count==1 and $visitor_rfid_count==1) {
			...
			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`,`acard`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`,`rfid_acard_status`,`rfid_card2_status`,`acard`,`card2`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1','$acard','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1','1','1','$attendant_rfid','$visitor_rfid')";
		...
		else if ($patient_rfid_count==1 and $attendant_rfid_count==0 and $visitor_rfid_count==1) {
			$update212="update preadm set status='Admitted',eid='$count1', fname='$fname', mname='$mname', peradd='$peradd', nid='$nid', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political', vcard='$vcard', vcard1='$vcard1',acard='$acard', pmode='$pmode', premarks='$premarks',anew='$anew' where `id`='$id'";
			mysqli_query($con,$update212);

			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`,`acard`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`,`rfid_card2_status`,`card2`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1','$acard','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1','1','$visitor_rfid')";
			mysqli_query($con,$ins_query33);
		...
		else if ($patient_rfid_count==1 and $attendant_rfid_count==1 and $visitor_rfid_count==0) {
			$update212="update preadm set status='Admitted',eid='$count1', fname='$fname', mname='$mname', peradd='$peradd', nid='$nid', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political', vcard='$vcard', vcard1='$vcard1',acard='$acard', pmode='$pmode', premarks='$premarks',anew='$anew' where `id`='$id'";
			mysqli_query($con,$update212);

			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`,`acard`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`,`rfid_acard_status`,`acard`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1','$acard','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1','1','$attendant_rfid')";
			mysqli_query($con,$ins_query33);
		...
		else if ($patient_rfid_count==1 and $attendant_rfid_count==0 and $visitor_rfid_count==0) {
			$update212="update preadm set status='Admitted',eid='$count1', fname='$fname', mname='$mname', peradd='$peradd', nid='$nid', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political', vcard='$vcard', vcard1='$vcard1',acard='$acard', pmode='$pmode', premarks='$premarks',anew='$anew' where `id`='$id'";
			mysqli_query($con,$update212);

			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`,`acard`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1','$acard','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1')";
			mysqli_query($con,$ins_query33);
		...
		if ($patient_rfid_count==1 and $attendant_rfid_count==1 and $visitor_rfid_count==1) {
			...
			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`,`rfid_acard_status`,`rfid_card2_status`,`acard`,`card2`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1','1','1','$attendant_rfid','$visitor_rfid')";
			mysqli_query($con,$ins_query33);
			...
			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`,`rfid_card2_status`,`card2`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1','1','$visitor_rfid')";
			mysqli_query($con,$ins_query33);
			...
			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`,`rfid_acard_status`,`acard`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1','1','$attendant_rfid')";
			mysqli_query($con,$ins_query33);
			...
			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`,`rfid_status`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid','1')";
			mysqli_query($con,$ins_query33);
...
?>
		...
		<input name="attendant_rfid" type="text" size="70"  />

		<label for="age"><strong>Visitor RFID (Do not edit the number):</strong></label>
		<input name="visitor_rfid" type="text" size="70" />
