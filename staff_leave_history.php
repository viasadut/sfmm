...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>Type Of Leave</strong></th>
      <th width="15%"><strong>Start Date</strong>
      <th width="14%"><strong>End Date</strong>   
      <th width="14%"><strong>Total Days</strong>
...
$sel_query="Select * from dleave where dept in ('$dept','$gd1') and sdate between '$date' and '$date1' order by uname asc";
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <?php   
	  $ee=$row["uname"];
	  $query39 = "SELECT * FROM staff3 where sid= '$ee'"; 
	 
$result39 = mysqli_query($con, $query39) or die(mysqli_error());

// Print out result
$row39 = mysqli_fetch_array($result39);?>
      <td align="center"><?php echo $row39["sname"]; ?></a></td>
	
	  
	  <td align="center"><?php echo $row["tleave"]; ?></a></td>
	  <td align="center"><?php echo $row["sdate"]; ?></a></td>
	  <td align="center"><?php echo $row["total"]; ?></a></td>
