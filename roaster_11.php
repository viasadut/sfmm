...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from roaster_location where dept='$dept'";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><a href="roaster_5?loc=<?php echo $row["loc"]; ?>&date=<?php echo $date3; ?>"><?php echo $row["loc"]; ?></a>  
	  </td>
	  <?php
	  $id_in=$row['loc'];
	  ?>
 ...
 $rr=$row['loc'];
	...
	$sel_query1c="Select * from roaster_2 where date ='$date3' and location='$rr' and emor='Morning'  order by id asc";	
...
";}
 ...
 $rr=$row['loc'];
	...
	$sel_query1c="Select * from roaster_2 where date ='$date3' and location='$rr' and emor='Late'  order by id asc";	
...
";}
 ...
 $rr=$row['loc'];
	...
	$sel_query1c="Select * from roaster_2 where date ='$date3' and location='$rr' and emor='Night'  order by id asc";	
