...
$ins_query1="update medicinerequest set mname='$mname',brand1='$bname',brand2='$cname',pre='$form',pcat='$cat',pby='$user',ptime='$adate', aname1='1175',aname2='md',aname3='cfo',aname4='ceo', rstatus='WAITING FOR Chairman APPROVAL',phar_remarks='$remarks',a1='waiting',a2='waiting',a3='waiting',a4='waiting', 
frequency='$frequency',frelation='$frelation',pcategory='$pcategory',duration='$duration',contrain='$contrain',meffect='$meffect',uprice='$uprice',uprice1='$uprice1',cprice='$cprice',reuse='$reuse',code='$code',r_status='$r_status',mtest='$stest'
where id='$id';";
...
<!-- Form Title -->
	  ...
	  <select name="r_status" required>
						...
						<option value='New Generic'>New Generic</option>
      ...
      <input name="code" type="text" size="70" style="text-transform:uppercase" value=""required>
