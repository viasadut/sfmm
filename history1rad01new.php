...
$count=1;
$sel_query="Select * from radpapp where pmrn= '$pmrn' order by ID desc;";
...
{ ?>    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["tname"];?> 

	  <td align="center"><a target='_blank' href="historynewrad01?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo $row["eid"]?>&date=<?php echo $row["date"]?>&dname=<?php echo $row["dname"]?>"><b>Details<b></a></td>
