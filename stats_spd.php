...
$query43 = "SELECT COUNT(ron), ron FROM ecg_test where datenew BETWEEN '$start' and '$end' group by ron order by ron;"; 
...
<h1 align="center">ECG & ECHO STATS Report</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select End Date:</strong></label></td>	
							...
							<td colspan="3"><label><strong></strong></label></td> 
...
while($row88 = mysqli_fetch_assoc($result43)) {
  echo "<font color=blue font size=5>";
  echo $row88['ron'];
  echo ": ";
  echo "<font color=green font size=5>";
  echo $row88['COUNT(ron)'];
  echo "</font> <br />";
}

$sel_query="Select * from ecg_test where datenew BETWEEN '$start' and '$end'  order by id desc";
$count=1;
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["datenew"]; ?>
      <td align="center"><?php echo $row["dname1"]; ?>  </td>
	  <td align="center"><?php echo $row['ron']; ?>  </td>
<td align="center"><a target='_blank' href="ecgreport.php?eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname1"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	      
