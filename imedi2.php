...
$query45 = mysqli_query($db,"select * from imedi2 where pmrn='$pmrn' and id='$id'");
...
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status ='rupdated'order by `id` DESC;";
