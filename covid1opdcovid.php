...
<option value='NC Student'>NC Student</option>			
<option value='Foreign_Passenger'>Foreign_Passenger</option>	
</select>
...
<input type="text" name="nid" id="email" class="input-text" placeholder="NID" size="70" value=""required>

<label for="age"><strong>Passport NO(Mendatory For Foreign Passenger):</strong></label>
<input type="text" name="pass_no" id="email" class="input-text" placeholder="Passport NO" size="70" value=""required>
...
<input type="text" name="com" id="com" class="input-text" placeholder="Company Name" size="70"value="" required>     
