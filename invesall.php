...
<tr>
<td colspan="4" align="center"><label><strong>Type Of Visit</strong></label></td> 
...
<td colspan="12" align="center"><select name="infu" class="country" placeholder="Select Visitor Card" >
						
						<option value=''>-Select Visit Type-</option>
				 <?php 
			$sql = "select distinct type from `radio` ";
			...
			<td colspan="8" align="center"><select name="remarks" class="state" value=''required/>
