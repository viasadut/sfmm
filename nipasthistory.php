...
$ins_query="insert into pasthistory (`dname`,`pmrn`,`pname`,`ins`,`date`) values ('$full', '$pmrn','$pname','$pins','$date')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Past History</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from pasthistory where pmrn= '$pmrn' order by `id` DESC;";
