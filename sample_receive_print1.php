...
$pdf->Cell('182',6,$data->medi.' (Received)',0,1,'C');
$pdf->Ln(2);
...
$pdf->Cell('110',5,'Sample Date: '.$data->date,0,0,'L');	
$pdf->Cell('50',5,'Receive Time: '.$data->retime,0,1,'L');

$pdf->Cell('110',5,'',0,0,'L');
$pdf->Cell('50',5,'Received By: '. $data->reby,0,1,'L');
