...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','emergency')"; 
...
<input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='code' required style="font-weight: bold;font-size:22px;color:green">
	...
	<option value=''>-Select-</option>
            ...
            require('db1.php');
            $uname = '';
            $query = "select * from `medi_stock` where add_qty>0 and location in ('AE')";
...
$count=1;
//$count=1;
$sel_query="Select * from medi_stock where rfid= '$sno' and req_loc in ('AE') order by `id` DESC;";
