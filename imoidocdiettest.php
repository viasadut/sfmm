...
$sel="SELECT * FROM diet WHERE `dietn`='$infu';";
$result90 = mysqli_query($con,$sel);
if($res90=mysqli_num_rows($result90)==0)
{
 	
       echo '<script language="javascript">';
    echo 'alert("Unsuccessful !!! The Diet Menu is not in the Database.. Please contact with IT Department"); ';
    echo '</script>';
    }
...
<tr>
<td colspan="14" align="center"><label><strong>Diet</strong></label></td> 
<td colspan="6" align="center"><label><strong>Remarks</strong></label></td></tr>
<tr>
<td colspan="14" align="center"><input list="rr" name="infu" size=60% class="form-control">
  <datalist id="rr">
...
<td colspan="6" align="center"><input type="text" name="remarks"  value="" ></td>
