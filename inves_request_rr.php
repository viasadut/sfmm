...
$query4 = mysqli_query($db,"select * from edit_inves where id='$id'");
...
//$id1=$_REQUEST['ID'];
$url = "inves_request_a";
$query = "UPDATE edit_inves set status='Rejected',rf6='$dtime',rejectby='$user',rejectcom='$recom' where id='$id'"; 
