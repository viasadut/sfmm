...
//$id =$_GET['id'];
$count=1;
$sel_query="SELECT * from othoscharge1 where rfid='".$rf."' and ndate between '$sd' and '$ed' and remarks='Finished'";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"style="font-size:18px;font-weight:bold;color:green;"><?php echo $row["medi"]; ?></td>
	  <td align="center"style="font-size:18px;font-weight:bold;color:green;"><?php echo $row["pdos"]; ?></td>
	  <td align="center"style="font-size:18px;font-weight:bold;color:green;"><?php echo $row["ndate"]; ?></td>
