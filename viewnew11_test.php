...
$lab = "SELECT COUNT(id),resultstatus from alltest where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and date1 between '$test' and '$apdate'"; 
$lab_result= mysqli_query($con, $lab) or die(mysqli_error());
$lab_row = mysqli_fetch_array($lab_result);
$lab_r=$lab_row['COUNT(id)'];

$lab1 = "SELECT COUNT(id),resultstatus from iinves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and ndate between '$test' and '$apdate'"; 
$lab_result1= mysqli_query($con, $lab1) or die(mysqli_error());
$lab_row1 = mysqli_fetch_array($lab_result1);
$lab_r1=$lab_row1['COUNT(id)'];

$lab2 = "SELECT COUNT(id),resultstatus from einves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and ndate between '$test' and '$apdate'"; 
...
//$_SESSION["myvar"] = $lab_all;

// save variable you want to have after the reload

//echo $_SESSION['$lab_all'] = $_POST['$lab_all'];
