...
mysqli_query($con,$update) or die(mysql_error());
$url = "iphyiocharge?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
{
$url = "ipallphysio?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
{
$url = "idocnotephysio?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>"><b>Patient's Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>"><b>All REPORTS<b></a></td></tr>
...
<tr><td colspan="20"align="Right"bgcolor="lightgreen"><a target='_blank' href="docadmdoc?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>View Consultant Plan Upon Admission<b></a>&nbsp;&nbsp;</td></tr>
<tr>
		
		<td colspan="5" align="center"><button type="submit" name="Submit98">Physiotherapist's Note</button></td>
			<td colspan="5"align="center"><button type="submit" name="Submit4">Visit</button><font size="4.5" color="#FF0000"><br><b>(<?php echo  $row17['COUNT(pmrn)']; ?>)<b></td>
		<td colspan="5" align="center"><button type="submit" name="Submit50">Summary</button></td>
</tr>		
