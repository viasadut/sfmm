...
$pac_f = "SELECT * FROM pac_request where pmrn='$pmrn' order by r_s_d DESC LIMIT 1 "; 
...
{
$update="Insert pac_request (`pmrn`,`pname`,`dname`,`r_s_by`,`r_s_t`,`r_s_d`,`status`) values('$pmrn','$pname','$dname','$full','$req_time','$req_date','Pending')";
mysqli_query($con,$update) or die(mysql_error());
