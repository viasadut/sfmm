...
$update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='DONE',critical='$critical' where id='$id'";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row1["mic1"]; ?>
	  <td align="center"><?php echo $row1["ins1"]; ?>
  	  <td align="center"><?php echo $row1["mic2"]; ?>
      <td align="center"><?php echo $row1["ins2"]; ?>
      
<td align="center"><a onclick="return confirm_click1();" href="micro_delete_opd?id=<?php echo $row1['id']; ?>&eid=<?php echo $eid; ?>&pmrn=<?php echo $pmrn; ?>&id1=<?php echo $id; ?>"><strong>Delete</strong></a></td>
