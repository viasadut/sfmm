...
$strSQL = "Select * from medi_stock where location='IPD';";
...
<tr>
      ...
      <td align="center"colspan="1"><?php echo $row["g_name"]; ?></td>
	  
	  
<td colspan="1" align="center">
<input type="button" name="edit_co" value="Use From Stock" id="<?php echo $row['id'];?>" class="btn btn-info btn-xs edit_data_co" /></a>
...
?>
 ...
 <div id="add_data_Modal7" class="modal fade">  
  ...
  <datalist id="stock">
				...
				<?php 
			$sql76 = "select * from `medi_stock` where location='IPD' and add_qty!='0'";
