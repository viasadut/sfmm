...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from imedi2 where pmrn='$pmrn' and eid='$eid' and odate ='$dd' and status='Active' and pstatus='ordered' order by time",$prop);
$pdf->Output();
?>