...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','diet','physio','mrd')"; 
...
$sel95="SELECT * FROM privilege WHERE `pname`='$pp' and dname in('$full','common') and status='Approved';";
...
else if($full !='' and $rtype=='Continuous' and $charge!=''){
...
<h1 align="center"style="background-color:lightgreen;">Daily Dietary Notes </h1>
<!-- Form Title -->
...
//$count=1;
$sel_query="Select * from icnote where pmrn= '$pmrn' and eid='$eid' and user LIKE '%Maisha%' order by `id` DESC;";
...
{ ?>    <tr>
  ...
  //$count=1;
  $sel_query="Select * from icnote where pmrn= '$pmrn' and eid='$eid' and user LIKE '%Lima%' order by `id` DESC;";
