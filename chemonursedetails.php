...
$url = "chemohoscharge?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
...
$url = "chemoconsent?pmrn=$pmrn&pro=$pro&eeid=$eid&dname=$dname";
header("Location: $url");
}
...
{
$url = "chemochargehos?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
<?php
...
{
$url = "chemonurseassess?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodnotenurse?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
...
{
$url = "chemodocmedi?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocinfusion?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemodocsorder?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
$url = "chemonotenurse?pmrn=$pmrn&ID=$ID";
header("Location: $url");
}
?>
<?php
