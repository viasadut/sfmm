...
if($select=='id')
{
	$runningTime = date('Ymdis')+$pmrn;
$url = "follow_scan_1?pid=$pmrn&sno=$runningTime";
header("Location: $url"); 
}
...
<td colspan="3"><input type="text" name="search"placeholder="ENTER MRN OR PRESCRIPTION ID" autofocus></td>
