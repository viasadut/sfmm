...
$otime= date('m-d-Y H:i:s');

$ins_query="insert into stat (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`otime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$otime','$infu')";
...
<tr>
<td colspan="20" align="center"><input type="text" name="infu" required value="" /></td>
</tr>
<tr>
...
$count=1;
$sel_query="Select * from stat where pmrn= '$pmrn' and eid='$episode'order by `otime` asc;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="4"><?php echo $row["udone"]; ?></td>  
