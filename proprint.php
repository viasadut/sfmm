...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus='paid' and dname='$full';";
...
$sel_query="Select * from procedure1 where pdate= '$date' and type='inpatient' and dname='$full';";
