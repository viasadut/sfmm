...
$query43_p1 = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user';"; 
...
$bill_user=$row['user'];
$bill_date=$row['date'];
$query43 = "SELECT SUM(amount_receive) FROM pms_bill where user= '$bill_user'and date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$phar_collection = mysqli_fetch_assoc($result43);

$query43_dis = "SELECT SUM(dis_amount) FROM pms_bill where user= '$bill_user'and date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user';"; 
...
$cash_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode='Cash' and user='$user';"; 
...
$opd_collection=$phar_collection['SUM(amount_receive)']+$temp_opd_collection_all['SUM(amount)']-$opd_collection_dis['SUM(dis_amount)']-$phar_collection_dis['SUM(dis_amount)'];
$net_collection=$phar_collection['SUM(amount_receive)']+$temp_opd_collection_all['SUM(amount)']-$opd_collection_dis['SUM(dis_amount)']-$phar_collection_dis['SUM(dis_amount)']-$opd_collection_refund['SUM(amount)']-$opd_collection_refund_phar_indu['SUM(r_amount)'];
      ?>
...
$query43_t = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user';"; 
$result43_t = mysqli_query($con, $query43_t) or die(mysqli_error());
$phar_collection_t = mysqli_fetch_assoc($result43_t);

$query43_dis_t = "SELECT SUM(dis_amount) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user';"; 
...
$bkash_t=$bkash_data_t['SUM(amount)'];
