...
$query43 = "SELECT COUNT(pmrn) FROM endoreport where r1date BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from endoreport where r1date BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
	  ...
	  <td colspan="10"><a target='_blank' href="endopdf1.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>"><img src="print.png" title="Print Report" width="100" height="60" /></a></td>	
      </tr>
