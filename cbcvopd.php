...
."<br />".'NRBC:'.$nrbc."<br />".'Remarks:'.$remarks;
...
."<br />".'Promyclocyte:'.$promyclocyte.' '.'%'."<br />".'Metamyclocyte:'.$metamyclocyte.' '.'%'."<br />".'Lymphoblast:'.$lymphoblast.' '.'%'."<br />".'Myoblast:'.$myoblast
.' '.'%'."<br />".'NRBC:'.$nrbc.' '.'10^3/uL'."<br />".'Remarks:'.$remarks;
	*/
...
.' '.'%'."<br />".'NRBC:'.$nrbc.' '.'10^3/uL'."<br />".'Atypical, Cells:'.$acell.' '.'%'."<br />".'Remarks:'.$rekarks;
    ...
    $ins_query1="update cbctbl set `haemo`='$haemo',`red`='$red',`pcv`='$pcv',`mcv`='$mcv',`mch`='$mch',`mchc`='$mchc',`rdw`='$rdw',`pla`='$pla',`mpv`='$mpv',`wbc`='$wbc',`neu`='$neu',`lym`='$lym',`eos`='$eos',`mono`='$mono',`bas`='$bas',`crea`='$crea',`eby`='$user',`etime`='$time',`esr`='$esr',
`promyclocyte`='$promyclocyte',`metamyclocyte`='$metamyclocyte',`myoblast`='$myoblast',`lymphoblast`='$lymphoblast',`nrbc`='$nrbc', remarks='$remarks',a_cell='$acell' where sno='$sno'";
...
<body>
    ...
    <form action="" method="post">
     ...
     <?php
	  ...
	  echo '<input name="haemo" type="number" step=".01" value="'.$data1["haemo"].'" id="haemo" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="haemo" type="number" step=".01" value="'.$data1["haemo"].'" id="haemo" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('haemo').onchange= f_color15;
	  ...
	  echo '<input name="red" type="number" step=".01" value="'.$data1["red"].'" id="red" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="red" type="number" step=".01" value="'.$data1["red"].'" id="red" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('red').onchange= f_color14;
	  ...
	  echo '<input name="pcv" type="number" step=".01" value="'.$data1["pcv"].'" id="pcv" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="pcv" type="number" step=".01" value="'.$data1["pcv"].'" id="pcv" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('pcv').onchange= f_color13;
	  ...
	  echo '<input name="mcv" type="number" step=".01" value="'.$data1["mcv"].'" id="mcv" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="mcv" type="number" step=".01" value="'.$data1["mcv"].'" id="mcv" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('mcv').onchange= f_color12;
	  ...
	  echo '<input name="mch" type="number" step=".01" value="'.$data1["mch"].'" id="mch" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="mch" type="number" step=".01" value="'.$data1["mch"].'" id="mch" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('mch').onchange= f_color11;
	  ...
	  echo '<input name="mchc" type="number" step=".01" value="'.$data1["mchc"].'" id="mchc" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="mchc" type="number" step=".01" value="'.$data1["mchc"].'" id="mchc" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('mchc').onchange= f_color10;
	  ...
	  echo '<input name="rdw" type="number" step=".01" value="'.$data1["rdw"].'" id="rdw" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="rdw" type="number" step=".01" value="'.$data1["rdw"].'" id="rdw" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('rdw').onchange= f_color9;
	  ...
	  echo '<input name="pla" type="number" step=".01" value="'.$data1["pla"].'" id="pla" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="pla" type="number" step=".01" value="'.$data1["pla"].'" id="pla" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('pla').onchange= f_color8;
	  ...
	  echo '<input name="mpv" type="number" step=".01" value="'.$data1["mpv"].'" id="mpv" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="mpv" type="number" step=".01" value="'.$data1["mpv"].'" id="mpv" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('mpv').onchange= f_color7;
     ...
     <?php
	  ...
	  echo '<input name="wbc" type="number" step=".01" value="'.$data1["wbc"].'" id="wbc" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="wbc" type="number" step=".01" value="'.$data1["wbc"].'" id="wbc" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('wbc').onchange= f_color6;
	  ...
	  echo '<input name="neu" type="number" step=".01" value="'.$data1["neu"].'" id="neu" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="neu" type="number" step=".01" value="'.$data1["neu"].'" id="neu" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('neu').onchange= f_color5;
	  ...
	  echo '<input name="lym" type="number" step=".01" value="'.$data1["lym"].'" id="lym" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="lym" type="number" step=".01" value="'.$data1["lym"].'" id="lym" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('lym').onchange= f_color4;
	  ...
	  echo '<input name="eos" type="number" step=".01" value="'.$data1["eos"].'" id="eos" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="eos" type="number" step=".01" value="'.$data1["eos"].'" id="eos" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('eos').onchange= f_color3;
	  ...
	  echo '<input name="mono" type="number" step=".01" value="'.$data1["mono"].'" id="mono" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="mono" type="number" step=".01" value="'.$data1["mono"].'" id="mono" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('mono').onchange= f_color2;
	  ...
	  echo '<input name="bas" type="number" step=".01" value="'.$data1["bas"].'" id="bas" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="bas" type="number" step=".01" value="'.$data1["bas"].'" id="bas" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
document.getElementById('bas').onchange= f_color1;
	  ...
	  echo '<input name="esr" type="text" step=".01"value="'.$data1["esr"].'" id="esr" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  
	  echo '<input name="esr" type="text" step=".01" value="'.$data1["esr"].'" id="esr" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
<span>
<input name="promyclocyte" type="number" step=".01" value="<?php echo $data1['promyclocyte'];?>" style="font-weight: bold;font-size:22px;" >

</span>
	  
<label for="age"><strong>Metamyclocyte:</strong></label>
<span>
<input name="metamyclocyte" type="number" step=".01" value="<?php echo $data1['metamyclocyte'];?>" style="font-weight: bold;font-size:22px;" >
 </span>


<label for="age"><strong>Lymphoblast:</strong></label>
<span>
<input name="lymphoblast" type="number" step=".01" value="<?php echo $data1['lymphoblast'];?>" style="font-weight: bold;font-size:22px;" >
 
</span>

<label for="age"><strong>Myoblast:</strong></label>
<span>
<input name="myoblast" type="number" step=".01" value="<?php echo $data1['myoblast'];?>" style="font-weight: bold;font-size:22px;" >
...
<input name="nrbc" type="number" step=".01" value="<?php echo $data1['nrbc'];?>"required style="font-weight: bold;font-size:22px;" >
 
</span>
<label for="age"><strong>Atypical, Cells:</strong></label>
<span>

<input name="acell" type="number" value="<?php echo $data1['a_cell'];?>"required style="font-weight: bold;font-size:22px;" step=".01">
 </strong>
</span>

<label for="age"><strong>Remarks:</strong></label>
<br>
<textarea name="remarks" style="font-weight: bold;font-size:22px;" >
<?php echo $data1['remarks'];?>
