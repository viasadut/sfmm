...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <td colspan="4" align="center"><strong>Infusion</strong></td>
...
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid' and odate ='$dd' order by infusion;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="4"><?php echo $row["infusion"],$row["addi"],$row["add1"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["room"],'+',$row["qty1"],'+',$row["qty2"]; ?></td>
...
<tr><td colspan="20"><a target='_blank' href="testpdfinfut.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&dd=<?php echo "$dd"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
