...
$query43 = "SELECT COUNT(pmrn) FROM mcertificate where pmrn= '$pmrn' and ct='fit';"; 
...
$ins_query="insert into mcertificate (`pmrn`,`eid`,`pname`,`nid`,`nid1`,`ffor`,`fdate`,`fdate1`,`diagnosis`,`user`,`idate`,`ct`,`year`,`m1`,`m2`,`m3`,`staff`,`idate1`) values 
('$pmrn', '$eid','$pname','$passno','$passno1','$ffor','$fdate','$fdate1','$diag','$full','$idate','fit','$year','MR.','HE','HIS','$staff','$idate1')";
...
$ins_query="insert into mcertificate (`pmrn`,`eid`,`pname`,`nid`,`nid1`,`ffor`,`fdate`,`fdate1`,`diagnosis`,`user`,`idate`,`ct`,`year`,`m1`,`m2`,`m3`,`staff`,`idate1`) values 
('$pmrn', '$eid','$pname','$passno','$passno1','$ffor','$fdate','$fdate1','$diag','$full','$idate','fit','$year','MS.','SHE','HER','$staff','$idate1')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
<label for="age"><strong>Patient's Details (MRN/Gender) :</strong></label>
      ...
      <textarea rows="5"  name="diag" required value=""></textarea>

		
			<label for="name"><strong>Fit For:</strong></label>
			<select name="ffor" value="" required>
			        <option value='Regular Duty' selected>Regular Duty</option>
					<option value='Light Duty' >Light Duty</option>
					<option value='Going School' >Going School</option>
					<option value='Plane journey' >Plane Journey</option>
		...
		<label for="mail"><strong>From :</strong></label>
									<p>
									  <input type="text" name="fdate" id="datepicker" placeholder="Select Date" size="15" value="">
...
<td><a target='_blank' href="printmc1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
