...
$ins_query1="insert into thyroid (`pname`,`pmrn`,`psex`,`page`,`atpo`,`atg`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$psex','$page','$atpo','$atg','$user','$adate','$eid','$iname','$id','$sno')";
