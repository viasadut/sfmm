...
?>
<?php
$query88 = "SELECT COUNT(id) FROM bed where status IN ('occupied','vacant')"; 
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from bed where status= 'occupied'";
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
 ...
 <tr>
  ...
  <tbody>
   <p align="center" class="style1">Vacant Bed List </p>   
    <?php
$user=$_SESSION["sess_username"];
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from bed where status= 'vacant'";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["status"]; ?>  
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["adate"];?>  
	  <td colspan="2" align="center"><a href="attncom?id=<?php echo $row['id']; ?>"><strong>Comments</strong></a></td>	  
