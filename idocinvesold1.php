...
$ins_query="insert into iinves (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`ordate`,`type`,`code`,`price`,`subtype`,`rstatus`,`link`,`report`,`ndate`,`linkv`,`reportv`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated','$ordate','$type','$code','$price','$subtype','Ordered','$link','$report','$ndate','$linkv','$reportv')";
...
{ ?>    <tr>
	  ...
	  <?php
		...
		$url = "compareinves?pmrn=$pmrn&eid=$eid&infu=$infu"; 
		 if($type=='lab')
	{ 
