...
$query44 = "SELECT COUNT(id) FROM imedi3 where dis_date BETWEEN '$start' and '$end' and status1='implemented';"; 
...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
      ...
      $query_p = "select * FROM imedi3 WHERE id='$updateid'"; 
...
$strSQL4 = "update imedi3 set t_status='1' where id='$updateid'";
$objQuery4 = mysqli_query($objConnect,$strSQL4);
      ...
      ('$updateid','CR','$cr_code','','$cost_centre','$date','1','$amount','IPD-MEDI')";
      ...
      ('$updateid','DR','$dr_code','','$cost_centre','$date','1','$amount','IPD-MEDI')";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
echo $end;
	 ...
	 $sel_query="Select * from imedi3 where dis_date BETWEEN '$start' and '$end' and status1 ='implemented'";
