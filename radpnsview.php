...
$query22 = "SELECT COUNT(a_no) FROM radreport where a_no= '$a_no';"; 
$result22 = mysqli_query($con, $query22) or die(mysqli_error());
$row22 = mysqli_fetch_assoc($result22);
$count_ano =$row22['COUNT(a_no)'];
...
$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`status1`,`ineid`,`emerid`,`ac_no`) 
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','Updated By Technologist','$ineid','$emerid','$ano')";
