...
$sel90="SELECT * FROM user WHERE `uname`='$uname' and upass='$upass';";
$result90 = mysqli_query($con,$sel90);

$sel92="SELECT * FROM cmea WHERE `sid`='$uname' and ctopic='$ctopic';";
...
if($res90=mysqli_num_rows($result90)==0)
{
    ...
    echo 'alert("Unsuccessful !!! Username And Password not macth.. Pls Try Again"); ';
    echo '</script>';
	header("Refresh: .1;");
    }
...
$ins_query="insert into cmea (`sid`,`ctopic`,`cdate`,`ctime`,`cvenue`,`etime`,`ccat`) values ( '$uname','$ctopic','$cdate','$ctime','$cvenue','$etime','$ccat')";
...
<h1 align="center"style="background-color:lightblue;"><strong>Todays Topic : " <?php echo $data59["topic"]; ?> "<strong> <br><br>  Key Note Speaker -   <?php echo $data59["speaker"]; ?> 
<br><br>Date & Time -  <?php echo $cdate1; ?> & <?php echo $data59["time"]; ?><br><br>Venue -  <?php echo $data59["venue"]; ?></h1>
...
<h1 style="background-color:#FF6347;">Total Participant For The Topic Presentation Was: <?php echo $row21['COUNT(sid)'];?></h1>
<br><br>
...
<tr bgcolor="#F08080">
	  ...
	  <td colspan="1" align="center"><strong>Designation</strong></td>
	  ...
	  <td colspan="3" align="center"><strong>Speaker</strong></td>
...
$count=1;
$sel_query="Select * from cmea where ctopic= '$ctopic' order by `id` DESC;";
...
$a10 = "SELECT * FROM staff3 where sid= '$s9'"; 
	 
$r10 = mysqli_query($con, $a10) or die(mysqli_error());

// Print out result
$s10 = mysqli_fetch_array($r10);
$sd1=$s10['dept'];
$sd2=$s10['desig'];
	  

$a11 = "SELECT * FROM staff1 where sid= '$s9' and designation!='Medical Officer'"; 
	 
$r11 = mysqli_query($con, $a11) or die(mysqli_error());

// Print out result
$s11 = mysqli_fetch_array($r11);
$sd3=$s11['designation'];
    ...
    <td align="center"colspan="1"><?php echo $f9; ?></td>
	 ...
	 <td align="center"colspan="1"><?php if($row['sdepartment']!=''){echo $row["sdepartment"];} else {echo $sd1;}; ?></td>
	 <td align="center"colspan="1"><?php if($sd2!=''){echo $sd2;} else {echo $sd3;}; ?></td>
  ...
  <td align="center"colspan="4"><?php echo $row["ctime"]; ?></td>  
	  ...
	  <td align="center"colspan="3"><?php echo $speaker; ?></td>
