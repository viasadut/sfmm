...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status in ('Cancel','Active') and status1 in('Rupdated','Cancel') and pstatus='Served' order by `infusion` asc;";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid'and status in ('Cancel','Data Updated') and status1 in('Cancel','Active') and pstatus='Served' order by `infusion` asc;";
