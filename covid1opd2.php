...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`) values
 ...
 '$adate','$email','$user','$adate1','$sam','$tp')";
...
<input type="text" name="ssent" id="datepicker" placeholder="Select Date" size="15" value="" >
