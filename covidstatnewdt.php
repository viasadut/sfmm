...
$query43 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='NEW'and tresult!='' and dconfirm='confirmed' and sentto='SFMMKPJSH' "; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='FollowUp' and tresult!='' and dconfirm='confirmed' and sentto='SFMMKPJSH'"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);

$query45 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='Death' and tresult!='' and dconfirm='confirmed'and sentto='SFMMKPJSH'"; 
	 
$result45 = mysqli_query($con, $query45) or die(mysqli_error());
$row45 = mysqli_fetch_assoc($result45);

$query46 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and tresult!='' and dconfirm='confirmed'and sentto='SFMMKPJSH'"; 
...
echo "  To  ";
echo $end2;
	 $sel_query="Select * from covidopd where rdate BETWEEN '$start' and '$end' and tresult!='' and dconfirm='confirmed' and sentto='SFMMKPJSH' order by sid asc"; 
