...
<div style="font-size:22px;color:red; width:780px; position: relative;left:20px;bottom:0px;top:10px;border: 3px solid #73AD21;">
...
$sum=$rowrv['SUM(add_qty)'];
	...
	<div style="font-size:22px;color:blue; width:380px; position: relative;left:810px;bottom:0px;top:-154.6px;border: 3px solid orange;">
