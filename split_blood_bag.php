...
$querymax1 = "SELECT max(bagno) FROM bcross1 where date1='$datenew'"; 
$resultmax1 = mysqli_query($con, $querymax1) or die(mysqli_error());
$rowmax1 = mysqli_fetch_array($resultmax1);
$max1=$rowmax1['max(bagno)']+1;

$querymax2 = "SELECT count(bagno) FROM bcross1 where date1='$datenew'"; 
...
$queryq1 = mysqli_query($db,"select * from bcross1 where sno='$sno'");
$dataq1 = mysqli_fetch_assoc($queryq1);
$bbno=$dataq1['bagno'];
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','available','Compatible','$sno','$bgroup','$adate1','$remarks')";
...
$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edateffp','available','Compatible','$sno','$bgroup','$adate1','$remarks')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
else if (empty($data2b) and $btype=='PLATELETE CONCENTRATE' and $vdrl=='Non-Reactive' and $hiv=='Negative' and $plas=='Negative' and $plas1=='Negative' and $hbs=='Negative' and $hcv=='Negative')
{

$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edateplt','available','Compatible','$sno','$bgroup','$adate1','$remarks')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
else if  (empty($data2b)and $vdrl=='Reactive')
{

$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','not available','Non Compatible','$sno','$bgroup','$adate1','$remarks')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
else if  (empty($data2b)and $hiv=='Positive')
{
...
else if  (empty($data2b)and $plas=='Positive')
{
...
else if  (empty($data2b)and $plas1=='Positive')
{
...
else if  (empty($data2b)and $hbs=='Positive')
{
...
else if  (empty($data2b)and $hcv=='Positive')
{

$ins_query1="insert into bcross1 (`dname`,`dmrn`,`dphone`,`dsex`,`dage`,`hae`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`btype`,`bqty`,`udate1`,`bagno`,`edate`,`status`,`result`,`sno`,`bgroup`,`date1`,`remarks`) values 
n('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate1','$btype','$bqty','$adate','$bagno','$edatewb','not available','Non Compatible','$sno','$bgroup','$adate1','$remarks')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<option value="<?php echo $abo1;?>"selected><?php echo $abo1;?></option>
...
<label for="age"><strong>Sediment, Urine:</strong></label>
      ...
      <select  id="pmrn3" onkeyup="GetDetail(this.value)" name="split" required>
...
<label for="age" id="component"><strong>Component Type:</strong></label>
	  
	  <select name="btype" value=''required id="component_v">
...
<label for="age" id="component_qty"><strong>Component Quantity:</strong></label>
	  
	 <input name="bqty" type="text" size="13"value="" required id="component_qty_v">
	  
     

   <label for="age" id="component1" hidden><strong>Component Type- 1:</strong></label>
	  
	  <select name="btype" value=''required id="component1_v" hidden>
<option value="">--Select--</option>
	  <option value="Whole Blood">Whole Blood</option>
	  <option value="PRBC">Packet red blood cell</option>
	  <option value="FFP">Fresh frozen plasma</option>
...
<label for="age" id="component1_qty" hidden><strong>Component Quantity-1:</strong></label>
	  
	 <input name="bqty" type="text" size="13"value="" required id="component1_qty_v" hidden>

   <label for="age" id="component2" hidden><strong>Component Type- 2:</strong></label>
	  
	  <select name="btype" value=''required id="component2_v" hidden>
<option value="">--Select--</option>
	  <option value="Whole Blood">Whole Blood</option>
	  <option value="PRBC">Packet red blood cell</option>
	  <option value="FFP">Fresh frozen plasma</option>
...
<label for="age" id="component2_qty" hidden><strong>Component Quantity-2:</strong></label>
	  
	 <input name="bqty" type="text" size="13"value="" required id="component2_qty_v" hidden>
...
<label for="age"><strong>Remarks:</strong></label>
    ...
    <textarea name="remarks" type="text" size="13"value="" required></textarea>
...
$(document).ready(function(){
  $('#pmrn3').change(function() {
    if( $(this).val() == '1') {
        ...
        $('#component_v').prop( "disabled", false );
        $('#component_qty').prop( "disabled", false );
        $('#component_qty_v').prop( "disabled", false );

        
		$('#component').show();
    $('#component_v').show();
    $('#component_qty').show();
    $('#component_qty_v').show();

    
    $('#component1').hide();
    $('#component1_v').hide();
    $('#component1_qty').hide();
    $('#component1_qty_v').hide();
    ...
    $('#component2_v').hide();
    $('#component2_qty').hide();
    $('#component2_qty_v').hide();
    } else {       

      
      $('#component1').prop( "disabled", false );
        $('#component1_v').prop( "disabled", false );
        $('#component1_qty').prop( "disabled", false );
        $('#component1_qty_v').prop( "disabled", false );


        $('#component2').prop( "disabled", false );
        $('#component2_v').prop( "disabled", false );
        $('#component2_qty').prop( "disabled", false );
        $('#component2_qty_v').prop( "disabled", false );
    ...
    $('#component_qty').hide();
    $('#component_qty_v').hide();

    
    $('#component1').show();
    $('#component1_v').show();
    $('#component1_qty').show();
    $('#component1_qty_v').show();
