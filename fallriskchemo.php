...
$count1 = $count+1;
$query = "SELECT * from chemopapp where pmrn= '$pmrn' and eid='$eid' and discharge=''"; 
...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from friskchemo where pmrn='$pmrn' and eid='$eid'"; 
...
if($res=mysqli_num_rows($result2)>0)
{
	...
	$ins_query6="insert into friskchemo (`pmrn`,`eid`,`fscore`,`date`,`udone`,`astime`) values ('$pmrn','$eid','$all','$date','$user','$astime')";
