...
//$dname=$data['dname'];
$query2 = $db->query("select * from alltest where pmrn='$pmrn' and eid='$eid'");
...
else if($data['medi']=='Endoscopy Biopsy For Anaerobic C/S For H. pylori')
...
lab_render_approval_footer($pdf, $db1, 'BACTERIOLOGY', (isset($data['resultby'])?$data['resultby']:''), (isset($data['checked_by'])?$data['checked_by']:''), (isset($data['cby'])?$data['cby']:''));
$pdf->Ln(10);
