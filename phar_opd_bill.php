...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from phar_sale where adate='$date' and b_status!='Billed' group by sno desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="phar_update_bill?sno=<?php echo $row["sno"]; ?>">UPDATE</a></td>
