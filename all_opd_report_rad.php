...
$query = mysqli_query($con,"select * from radreport where pmrn='$pmrn'");
...
mysqli_select_db($db,'sfmmkpjnew');
			...
			$query7 = mysqli_query($db,"Select * from radreport where pmrn='$pmrn' order by id desc;");
...
$tbl .='<table width="100%" border="1">
				...
				$tbl .='<table>
				<tr>
                                    <th style="font-family: freesans; font-size: 14px;text-align:center"><b>RADIOLOGY INVESTIGATION RECORD (OPD)<br></b></th>
                                </tr>
				
				
				';
                $query1r = mysqli_query($con,"Select * from radreport where pmrn='$pmrn' order by rdate desc");
                $count=1;
                while ($data11r = mysqli_fetch_array($query1r)) {
                    $tbl .='
                            ...
                            <br><tr>
                                <td style="font-family: freesans; font-size: 12px; text-align:left"><b>'.$count.') '.$data11r['type'].' ('.$data11r['rdate'].') </b>
