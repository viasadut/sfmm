...
$query39 = "SELECT * FROM proinves where id= '$id'"; 
...
$update33="insert into  histo (`cinfo`,`spe`,`gdes`,`mdes`,`dia`,`status`,`dname1`,`rtime`,`rdate`,`hno`,`dname`,`date`,`time`,`pmrn`,`pname`,`page`,`psex`) values 
('$cinfo','$spe','$gdes','$mdes','$dia','REPORT DONE','$full','$time','$date1','$hno','$dname5','$daten','$time','$pmrn','$pname','$page','$psex')";
mysqli_query($con,$update33) or die("Problem in Update pappnew");



//$gg= $_REQUEST['pname'];
$update="update alltest set status='REPORT DONE' where `id`='$id'";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="view3newtesthisto?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>Record of Previous Visits<b></a>&nbsp;&nbsp;
		&nbsp;&nbsp;<a target='_blank' href="opdradreporthisto?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Radiology Report<b></a>&nbsp;&nbsp;
		<a target='_blank' href="https://medex.com.bd"><b>Reference Drug Index of Bangladesh(medex.com.bd)<b></a>&nbsp&nbsp<a target='_blank' href="http://192.168.100.254?pmrn=<?php echo "$pmrn"; ?>"><b>LAB REPORT<b></a>&nbsp;&nbsp;<a target='_blank' href="photo333doc?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eeid";?>"><b>Endoscopy Capture<b></a></td></tr>
