...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where  type='spd1' and status!='Received';";
    ...
    <tr>
	  ...
	  <td align="center"><?php echo $row["dname"]; ?></td>
	  	  <td align="center"><?php echo $row["medi"];?></td> 
	  	  	  ...
	  	  	  <td align="center" colspan="1"><a onclick="return confirm_click();" href="labupdate?id=<?php echo $row["id"]; ?>">UPDATE</a></td>
