...
$result_new1=nl2br($data->result);
//$result_new = br2newline($result_new1);


//$result_new = str_replace("\n", "\n", $data->result); //  This is an example and might need adjustment based on your needs
...
$pdf->Cell(50,5,$unit,0,0);
	...
	$pdf->MultiCell($cellWidth,$cellHeight,$cr,0);
