...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="coviddoccovid?id=<?php echo $row["id"]; ?>&rd=<?php echo $rd; ?>">Add</a> </td>
