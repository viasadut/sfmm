...
$update212="update preadm set fname='$fname', mname='$mname', peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',nidcard='$nidcard',bcard='$bcard',vgcard='$vgcard',ocard='$ocard',wcard='$wcard',hcard='$hcard',fcard='$fcard',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Settled',pphone='$pphone' where `id`='$id'";
...
<td colspan="10">		<a target='_blank' href="admnewdd?pmrn=<?php echo "$pmrn"; ?>&adoc=<?php echo $data49["adoc"]; ?>&adate=<?php echo $data49["adate"]; ?>&eid=<?php echo $eid; ?>&id=<?php echo $id; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>
