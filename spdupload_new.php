...
<html>
<head>
    <title>SPD Picture Upload</title>
...
<div class="container">
    ...
    <form action="spdupload1_new.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from ecg_test where pmrn='$pmrn' and eid='$eid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="spdpic/<?php echo $image['upload'] ?>">
                        <img class="img-responsive" alt="" src="spdpic/<?php echo $image['upload'] ?>" />
