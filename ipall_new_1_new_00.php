...
implant=?, extra=?, endo=?, opdpro=?, payment_status=?, dis_medi=?, emer_bill=?, cath_bill=?, msuite_bill=?,receive_amount=? WHERE pmrn=? and eid=?");
$sh->execute([$last_id, $payment, $room_charge, $inves_charge, $disposable_charge, $doc_charge, $pharmacy_charge,
$ot_hos_charge, $ot_doc_charge, $ot_phar_charge, $implant, $extra, $endo, $opdpro, $payment_status, $dis_medi, $emer_all_bill, $cath_bill, $msuite_bill, $receive_amount, $pmrn, $eid]);
...
<td align="center"colspan="2"><?php echo $row["date"]; ?></td>
  ...
  <td align="center"colspan="2"><?php echo $row_care["date"]; ?></td>
        ...
        <?php
              ...
              <td align="center"colspan="3"><?php echo $n_uom_care; ?></td>
...
$in_new_charge1=$test1c+$test1+$test1as+$test1a1+$test1al+$test1al_rad+$test1ai+$test1am+$test1c_bed+$implant+$extra+$ot_payment+$emer_all_bill+$test1_dis+$opd_pro_summary+$endo_summary+$opd_cath_summary;
$in_new_charge2=$test1c+$test1+$test1as+$test1a1+$test1al+$test1al_rad+$test1ai+$test1am+$bed_charge_new+$implant+$extra+$ot_payment+$emer_all_bill+$test1_dis+$opd_pro_summary+$endo_summary+$opd_cath_summary;
