...
<p align="center" class="style1">Today's <?php echo htmlspecialchars($full); ?>'s Rejected PO List</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href='grn_receive_full_receive' style="font-size:18px; font-weight:bold; color:red"><span>Full Received</span></a>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href='grn_receive_rejected' style="font-size:18px; font-weight:bold; color:green"><span>Rejected</span></a>
...
?>
    <tr>
      ...
      <td align="center"><?php echo htmlspecialchars($row['po_status']); ?>
      <br />
      Comments: <?php echo htmlspecialchars($row['reject_com']); ?>
