...
else if($full =='$adoc' and $charge!='' and $type_count>0){
...
if(mysqli_query($con,$ins_query)==true and mysqli_query($con,$ins_query2)==true){
header("Location:$url");}
...
else if($full !='' and $rtype=='Continuous' and $charge!='' and $type_count>0){
...
if(mysqli_query($con,$ins_query)==true and mysqli_query($con,$ins_query2)==true and mysqli_query($con,$update1)==true){
header("Location:$url");}
