...
$strSQL = "UPDATE imedi3 set pstatus='Served', puser='$user', pdate='$pdate',rfid='$runningTime',pno='$pno',rfid1='$tfid',p1='1' ";
...
$strSQL = "UPDATE imedi3 set pstatus='Served', puser='$user', pdate='$pdate',rfid='$runningTime',pno='$pno',rfid1='$tfid',p1='1' ";
			$strSQL .="WHERE pmrn ='$pmrn' and eid ='$eid' and code ='$mcode' and odate='$dd'  and pstatus!='served'";
			$objQuery = mysqli_query($objConnect,$strSQL);
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="1"><?php echo $row1["ortime"]; ?></td>
	  ...
	  $sum1 = "SELECT SUM(add_qty) FROM medi_stock where code='$mcode1' and location='Pharmacy_ipd'" ;
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid'and pstatus ='served' and odate='$dd' order by `time` and `infusion` asc;";
