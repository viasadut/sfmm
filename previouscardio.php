...
<div id='cssmenu'>
<ul>
   <li><a href='cviewsp1cardio'><span>Home</span></a></li>
...
<li class='last'><a href='appcardio'><span>Set Patient Appointment</span></a></li>
<li class='last'><a href='previouscardio'><span>Search Previous Patient</span></a></li>
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="previouscardio1?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">GO</a></td>
