...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(id) FROM phar_sale WHERE billno='$billno'"));
...
$row45=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(tprice) FROM phar_sale WHERE location='OPD-DIS' and billno='$billno'"));
