...
$ins_query="insert into estret (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,status) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$dtime','$user','Data Updated')";
...
<tr>
<td colspan="12" align="center"><label><strong>Special Treatment</strong></label></td> 

<td colspan="8" align="center"><label><strong>Done Time</strong></label></td></tr>
<tr>
<td colspan="12" align="center"><input type="text" name="infu" required value="" /></td>

<td colspan="8" align="center"><input type="text" name="dtime" required value="" /></td>
