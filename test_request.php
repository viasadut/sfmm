...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','ot','nurse','endoscopy','pharmacy','radio','bill','billin','lab','emergency','imo','emergency','mofficer','cath')"; 
...
//$p_mrn1 = str_replace("&", "'&'",$_REQUEST['p_mrn1']);
...
<input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='code' required style="font-weight: bold;font-size:22px;color:green">
	...
	<option value=''>-Select-</option>
            ...
            require('db1.php');
            $uname = '';
            $query = "select code,g_name from `purchase_stock3` where location='store'";
