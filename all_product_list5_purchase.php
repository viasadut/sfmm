...
$gg=$rowd['eid'];
$count=1;
$sel_query="Select * from purchase_stock where code='$gg' and status='Pending' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  $queryr = "SELECT SUM(add_qty) from purchase_stock where code='".$gg."' and status='Pending'"; 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from storenew where id='$id' ORDER BY id desc;";
...
$queryrt = "SELECT * from storenew where id='".$cid."'"; 
$resultrt = mysqli_query($con, $queryrt) or die ( mysqli_error());
$rowrt = mysqli_fetch_assoc($resultrt);
$ccode=$rowrt['eid'];
	  
	  $queryrv = "SELECT SUM(add_qty) from purchase_stock where code='".$ccode."' and location='store' and add_qty>0"; 
