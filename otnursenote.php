...
$ins_query="insert into otnnote (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`pnote`,`user`,`status`) values ( '$pmrn','$id','$pname','$page','$adm','$psex','$pphone','$adate1','$pnote','$user','Data Updated')";
...
<td colspan="20" align="center"><label><strong>Nurse's Note</strong></label></td> 
...
$count=1;
$sel_query="Select * from otnnote where pmrn= '$pmrn' and eid='$id'order by `id` DESC;";
