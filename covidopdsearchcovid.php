...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <th width="17%"><strong>SID</strong></th>
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covid1opd2covidp?id=<?php echo $row["id"]; ?>&rd=<?php echo $rd; ?>">Add New Record</a> </td>
