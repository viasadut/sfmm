<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','lab','rd')"; 
...
$count=1;
$sel_query="Select * from alltest where pmrn= '$pmrn' and billstatus='' order by ID desc;";
...
{ ?>    <tr>
	...
	<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a onclick="return confirm_click();" href="popdbill?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $pmrn;?>">Billed</a> </td>  
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and billstatus='' order by id desc;";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $count; ?></td>
	  <td align="center"><?php echo date('d/m/Y', strtotime($row["ndate"])); ?>  
      <td align="center"><?php echo $row["pname"]; ?></td>
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a onclick="return confirm_click();" href="pipdbill?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $pmrn;?>">Billed</a> </td>  
...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and billstatus=''  order by id desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a onclick="return confirm_click();" href="pemerbill?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $pmrn;?>">Billed</a> </td>  
