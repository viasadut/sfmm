<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','staff','store','doctor','bill')"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>PO NO</strong></th>
	  <th width="17%"><strong>Company Name</strong></th>
      
	  <th width="14%"><strong>Prepare Cheque</strong>
...
$sel_query="Select * from po_table where status='FORWARD FOR CEO APPROVAL' and '$user'='JODHJH(*(^%^' ORDER BY id asc;";
...
$sel_query="Select * from acct_ap where status='Forwarded' order by id desc";
...
?>
	  ...
	  <td align="center"><?php echo $rowc_ap["id"]; ?></td>
     <td align="center"><?php echo $row["creditor_code"]; ?></td>
	  
      
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold">
<a href="new_bill/po_vat?cname=<?php echo $row["id"]; ?>">Add Vat & Tax</a> 
</td>
