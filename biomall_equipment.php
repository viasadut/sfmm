...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<?php 
			$sql = "Select DISTINCT ename1  from storenew where etype='Asset' and trans_to!='';";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->ename1."'>".$row->ename1."</option>";
				}
			}
			?>
...
$sel_query="Select * from storenew where ename1='$bt';";
}
$count=1;
