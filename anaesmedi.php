...
$sel90="SELECT * FROM anaesmedi WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `status`='Active';";
...
$ins_query6="insert into anaesmedi (`pmrn`,`dname`,`eid`,`infusion`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
...
<tr><td colspan="20"align="right"><button type="submit" name="Submit">Confirm</button></td></tr>
	<tr>	<td colspan="20"align="right"><font size="4.5" bgcolor="#FF7F50"><b><label><strong><a href="idocmeditest?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Today's Medicine</a></strong>&nbsp;&nbsp;<font size="4.5" color="#FF0000"><b><label><strong><a href="addpharmedidoctor?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Medicine</a></strong>&nbsp;&nbsp;<a href="datewisemedi?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;</td>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from anaesmedi where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `infusion` and `time` asc;";
