...
$query43 = "SELECT SUM(price) FROM alltest where date1 BETWEEN '$start' and '$end' and subtype in('$bt');"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT SUM(price) FROM iinves where ndate BETWEEN '$start' and '$end' and subtype in('$bt');"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT SUM(price) FROM einves where ndate BETWEEN '$start' and '$end' and subtype in('$bt');"; 
...
$query43r = "SELECT COUNT(id) FROM alltest where date1 BETWEEN '$start' and '$end' and subtype in('$bt');"; 
...
$query43rr = "SELECT COUNT(id) FROM alltest where date1 BETWEEN '$start' and '$end' and subtype in('$bt');"; 
	 
$result43rr = mysqli_query($con, $query43rr) or die(mysqli_error());
$row43rr = mysqli_fetch_assoc($result43rr);


$query44r = "SELECT COUNT(id) FROM iinves where ndate BETWEEN '$start' and '$end' and subtype in('$bt');"; 
	 
$result44r = mysqli_query($con, $query44r) or die(mysqli_error());
$row44r = mysqli_fetch_assoc($result44r);


$query45r = "SELECT COUNT(id) FROM einves where ndate BETWEEN '$start' and '$end' and subtype in('$bt');"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					...
					<td colspan="3"><input list="test" name="bt" id="test1" size='50' value="" required autocomplete="off">
...
$sel_query1="Select * from alltest where billdate BETWEEN '$start' and '$end' and subtype in('$bt')";
...
{ ?>    <tr>
  ...
  <tr> <td colspan="20"></td> </tr>
	...
	$sel_query2="Select * from iinves where ndate BETWEEN '$start' and '$end' and subtype in('$bt')";
...
$ip_doc=$ip_data['adoc'];
  ...
  <tr> <td colspan="20"></td> </tr>
	...
	<?php
	$sel_query3="Select * from einves where ndate BETWEEN '$start' and '$end' and subtype in('$bt')";
