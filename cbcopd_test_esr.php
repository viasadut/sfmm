...
$query_NEUTP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='$lis_code' and machine_ATTRIB='NEUT%' and MACHINE_CODE='XN_550' order by response_no_pk desc limit 1");
$data_NEUTP= mysqli_fetch_assoc($query_NEUTP);

$query_LYMPHP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='$lis_code' and machine_ATTRIB='LYMPH%' and MACHINE_CODE='XN_550' order by response_no_pk desc limit 1");
$data_LYMPHP= mysqli_fetch_assoc($query_LYMPHP);

$query_MONOP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='$lis_code' and machine_ATTRIB='MONO%' and MACHINE_CODE='XN_550' order by response_no_pk desc limit 1");
$data_MONOP= mysqli_fetch_assoc($query_MONOP);

$query_EOP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='$lis_code' and machine_ATTRIB='EO%' and MACHINE_CODE='XN_550' order by response_no_pk desc limit 1");
$data_EOP= mysqli_fetch_assoc($query_EOP);

$query_BASOP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='$lis_code' and machine_ATTRIB='BASO%' and MACHINE_CODE='XN_550' order by response_no_pk desc limit 1");
