...
$ins_query="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`) values ( '$pmrn','$id','$proname','$otdate','$full','$sreport','$ottype','$date1','$charge')";
...
<tr>
	  ...
	  <td colspan="8" align="center"><strong>Surgery Note</strong></td>
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="8"><?php echo $row["sreport"]; ?></td>
