...
$query39 = "Select * from radpapp where ID='$ID';";
...
if($loc=='A&E')
{
$update3="update einves set status='CANCEL',can_by='$user',can_time='$can_time' where `id`='$acno1'";
...
$update="update rapp set status='AVAILABLE' where `dname`='$dname' and `ddate`='$date1' and `dslot`='$slot'";
mysqli_query($con,$update);

$update1="update radpapp set status='CANCEL',can_by='$user',can_time='$can_time',can_remarks='$can_remarks' where `ID`='$ID'";
...
echo '<script language="javascript">';
	...
	if($loc=='OPD')
{
$update3="update alltest set status='CANCEL',can_by='$user',can_time='$can_time' where `id`='$acno'";
mysqli_query($con,$update3);
...
echo '<script language="javascript">';
	...
	if($loc=='Inpatient')
{
$update3="update iinves set status='CANCEL',can_by='$user',can_time='$can_time' where `id`='$acno1'";
mysqli_query($con,$update3);
...
<!-- Form Title -->
		<h1>CANCEL PATIENT'S APPOINTMENT </h1>
      ...
      <input name="psex" type="text" size="15" class="style1" value="<?php echo $row39['psex'];?>"readonly>
      ...
      <label for="age"><strong>BOOKED DATE & SLOT :</strong></label>
      <input name="name" type="text" size="30" class="style1" value="<?php echo $row39['adate'];?>" readonly>
	  <input name="name" type="text" size="30" class="style1" value="<?php echo $row39['aslot'];?>" readonly>
	  <label for="age"><strong>Procedure Name:</strong></label>
      <input name="padd" type="text" size="70" class="style1" value="<?php echo $row39['tname'];?>"readonly>
	  
	  <label for="age"><strong>Cancel Remarks:</strong></label>
      <input name="can_remarks" type="text" size="70" class="style1" value=""required>
