...
if($res990=mysqli_num_rows($result990)==0)
{
    ...
    echo 'alert("Unsuccessful !!! The Procedure Name is not in the Database List.."); ';
    echo '</script>';
    }
...
$ins_query="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`) values ( '$pmrn','$id','$proname','$otdate','$full','$sreport','$ottype','$date1')";
...
<td colspan="20" align="center"><input list="rr1" name="proname"  class="form-control">
  <datalist id="rr1">
