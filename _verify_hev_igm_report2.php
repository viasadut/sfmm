...
$query = mysqli_query($db,"select * from hevigm where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'Sample Rate',1,0,'C');
...
if($inter!='')
	...
	{$pdf->Cell('40',5,'Interpretation:',1,1,'L');
		$pdf->MultiCell('160',5,$inter,0,1);
