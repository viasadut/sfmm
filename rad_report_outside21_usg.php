<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','rad','mng','outdoc','staff')"; 
...
$sel_query="Select * from radreport where status!= 'confirmed' and rdate between '$test' and '$rr1' and dname='$full' ORDER BY id desc;";
