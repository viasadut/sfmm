...
$this->Cell('40',5,'Authorized By',0,0,'L');
$this->Cell('50',5,'Received By',0,1,'L');


$this->SetFont('Arial' , 'b' , 8);	
$this->Cell('45',5,'Rinku chandra Debnath',0,0,'L');
$this->Cell('45',5,'Amit Kumar Dhali',0,0,'L');
$this->Cell('40',5,'Dr. Razeeb Hassan',0,0,'L');
$this->Cell('50',5,'',0,1,'L');



$this->Cell('45',5,'(BUSINESS OFFICE OFFICER)',0,0,'L');
$this->Cell('45',5,'(CHIEF FINANCE OFFICER-ACT.)',0,0,'L');
$this->Cell('40',5,'(MEDICAL DIRECTOR)',0,0,'L');
$this->Cell('50',5,'',0,1,'L');
$this->ln(20);
...
$pdf->MultiCell('183',5,'Enclosed, Cheque number-'. $chno .' being payment for very poor patients from the doridro fund of KPJ Specialized Hospital',0,1);  
