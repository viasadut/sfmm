...
$update="update nurseassess set cname='$cname',crelation='$crelation',cphone='$cphone', astime='$astime', ma='$ma', acc='$acc', shistory='$shistory', language='$language', nip='$nip', edus='$edus', comor='$comor', valueableb='$valueableb', bodys='$bodys', du='$du', remarks='$remarks',user='$full',weight='$weight',height='$height' where eid='$eid' and pmrn='$pmrn'";
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Personal Particulars / History :</strong></label></td></tr>
		...
		<tr>
					 ...
					 <td colspan="2"><input type="text" name="astime" style="background-color:skyblue;"required value="<?php echo $row3['astime'];?>" /></td>
					  <td colspan="2"><input type="text" name="height" style="background-color:skyblue;"required value="<?php echo $row3['height'];?>" /></td>
					 <td colspan="2"><input type="text" name="weight" style="background-color:skyblue;"required value="<?php echo $row3['weight'];?>" /></td>
...
<td colspan="10"><select name="du" placeholder="" >
						...
						<td colspan="10"><input type="text" name="remarks" style="background-color:skyblue;" value="<?php echo $row3['remarks'];?>" /></td>
</tr>
