...
$query5 = mysqli_query($db,"select * from gtolerance where sno='$sno'");
...
$ins_query1="update gtolerance set gfast='$gfast',gone='$gone',gtwo='$gtwo',gufast='$gufast',guone='$guone',gutwo='$gutwo',eby='$user',etime='$adate' where sno='$sno';";
...
<!-- Form Title -->
      ...
      <input name="gfast" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['gfast'];?>"required>
	  <label for="age"><strong>Glucose, Blood (1.0 Hour):</strong></label>
      <input name="gone" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['gone'];?>"required>
	  <label for="age"><strong>Glucose, Blood (2.0 Hour)::</strong></label>
      <input name="gtwo" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['gtwo'];?>"required>
	  <label for="age"><strong>Glucose, Urine (Fasting):</strong></label>
      <input name="gufast" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['gufast'];?>"required>
	  <label for="age"><strong>Glucose, Urine (1.0 Hour):</strong></label>
      <input name="guone" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['guone'];?>"required>
	  <label for="age"><strong>Glucose, Urine (2.0 Hour):</strong></label>
      <input name="gutwo" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['gutwo'];?>"required>
