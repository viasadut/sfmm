...
$update33="insert into  histo (`cinfo`,`spe`,`gdes`,`mdes`,`dia`,`status`,`dname1`,`rtime`,`rdate`,`hno`,`dname`,`date`,`time`,`pmrn`,`pname`,`page`,`psex`,`cstatus`,`ruby`,`rutime`,`date1`,`eid`) values 
('$cinfo','$spe','$gdes','$mdes','$dia','REPORT DONE','$full','$time','$date1','$hno','$dname5','$daten','$time','$pmrn','$pname','$page','$psex','Waiting For Consultant Confirmation','$full','$udate','$date_n','$count1')";
mysqli_query($con,$update33) or die("Problem in Update pappnew");



//$gg= $_REQUEST['pname'];
$update="update iinves set status='REPORT DONE' where `id`='$id'";
