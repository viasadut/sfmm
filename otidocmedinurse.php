...
$ins_query6="insert into otendomedi (`pmrn`,`dname`,`eid`,`infusion`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$id','$infu','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from otendomedi where pmrn= '$pmrn' and eid='$id'and status !='Cancel' and status1='Rupdated' and odate='$dd'order by `infusion` and `time` asc;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="otmedicineusenurse?id3=<?php echo $row["id"]; ?>&id=<?php echo $id; ?>&pmrn=<?php echo $row["pmrn"]; ?>&infusion=<?php echo $row["infusion"]; ?>&odate=<?php echo $row["odate"]; ?>&pname=<?php echo $row["pname"]; ?>&code=<?php echo $row["code"]; ?>&ins=<?php echo $row["instruc"]; ?>">Update</a></td>
