...
$update="update emergency set disstatus='Discharge Requested', dstatustime='$adate1', duser='$user' where `eid`='$eid' and pmrn='$pmrn'";
...
<td colspan="20" align="center"><input type="text" name="infu" required value="Confirm Discharge Request" ></td>
</tr> 
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from emergency where pmrn= '$pmrn' and eid='$episode' and disstatus='Discharge Requested' order by `id` DESC;";
