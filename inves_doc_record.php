...
<h1 align="center">Doctor's Patient Report</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
			...
			$sql = "select * from `inves_doc` where status='Active' and '$new_date' between `sdate` and `edate` and inves_dname='$user'";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->doc_name_full."'>".$row->doc_name_full."</option>";
				}
			}
			?>
...
echo'<tr> <td colspan="20"></td> </tr>
  ...
  <tr> <td colspan="20"></td> </tr>';
	 ...
	 $sel_query="Select * from erefferal where infusion='$bt' and ddate BETWEEN '$start' and '$end' order by ddate";
...
{ ?>    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["ddate"];?> </td>
...
//$id=$_REQUEST["id"];
 echo'<tr> <td colspan="20"></td> </tr>
  ...
  <tr> <td colspan="20"></td> </tr>';
	 ...
	 $sel_query="Select * from inpatient where adoc='$bt' and anew BETWEEN '$start' and '$end' order by anew";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["padd"]; ?></td>
      <td align="center"><?php echo $row["pphone"]; ?> </td> 
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["anew"];?> </td>
...
echo'<tr> <td colspan="20"></td> </tr>
  ...
  $sel_query="Select * from presnew where dname='$bt' and date1 BETWEEN '$start' and '$end' order by date1 desc";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["padd"]; ?></td>
      <td align="center"><?php echo $row["pphone"]; ?> </td> 
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["date1"];?> </td>
