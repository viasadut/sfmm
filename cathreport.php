...
$ins_query1="insert into serumtbl (`pname`,`pmrn`,`pphone`,`psex`,`page`,`c1`,`s1`,`p1`,`c11`,`a1`,`uby`,`udate`,`eid`,`iname`,`inid`) values 
('$pname','$pmrn','$pphone','$psex','$page','$creatinine','$sodium','$potassium','$chloride','$albumin','$user','$adate','$eid','$iname','$id')";
...
iii.	Introducer Sheath	: 
      ...
      <td colspan="3" align="center"><textarea name="iprocedure"  value="" />LM	-  
LAD	- 
LCx	- 
RCA- 
LIMA- 
