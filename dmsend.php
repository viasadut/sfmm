...
$ins_query1="Update storenew set sendtime='$adate1',stime='$stime',sendto='$sendto',sendby='$user',estatus='$fremarks',status='$estatus',remarks='$estatus' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());


$ins_query2="insert into store1 (`ename`,`eid`,`elocation`,`etype`,`eqty`,`estatus`,`fremarks`,`sendtime`,`stime`,`sendto`,`sendby`) values 
...
<!-- Form Title -->
	 ...
	 <input name="elocation" type="text" size="80"  style="text-transform:uppercase"value="<?php echo $data['trans_to'];?>" required  readonly>
