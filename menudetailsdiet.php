...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>Diet Name</strong></th>
      <th width="10%"><strong>Morning</strong></th>
      <th width="15%"><strong>Mid Morning </strong>
      <th width="14%"><strong>Lunch</strong> 
      <th width="14%"><strong>Eveing</strong>
      <th width="14%"><strong>Dinner</strong>  
	    <th width="14%"><strong>Supper</strong>  
		
      <th width="14%"><strong>KCAL</strong>
...
$sel_query="Select * from dietchart;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["dtype"]; ?></td>
      <td align="center"><?php echo $row["d1"]; ?>
      <td align="center"><?php echo $row["d2"]; ?>
      <td align="center"><?php echo $row["d3"]; ?>  
	  <td align="Left"><?php echo $row["d4"]; ?>  
	  <td align="Left"><?php echo $row["d5"]; ?>  
	  <td align="Left"><?php echo $row["d6"]; ?>  
	  <td align="Left"><?php echo $row["kcal"]; ?>  
	  	  
<td align="center"><a href="editdietmenu?id=<?php echo "$row[id]"; ?>"><strong>EDIT</strong></a></td>	  
