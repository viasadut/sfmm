...
$query = mysqli_query($db,"select * from fnacreport where pmrn='$pmrn' and eid='$eid'");
               ...
               <br>
                <table>
                    <tr>
                        ...
                        <td width="75%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$data['dname'].'</h2></b></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>'.$data2['degree'].'</td>
