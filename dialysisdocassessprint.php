...
$query = mysqli_query($db,"SELECT * from dialysismassess where pmrn='$pmrn' and eid='$eid'" );
...
$query4 = mysqli_query($db,"SELECT * from incmedi where pmrn='$pmrn'");
...
$pdf->Cell('25',5,'Dialysis',1,0,'L');
$pdf->Cell('15',5,'BED:',1,0,'L');
$pdf->Cell('33',5,'Dialysis-01',1,0,'L');
