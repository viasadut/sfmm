...
echo $dname2=$_REQUEST["dname"];
echo $date2=date('Y-m-d',strtotime($_REQUEST["date"]));
...
$update="update opd_appoint1 set status='NOT AVAILABLE',remarks='$reason' where dslot='$select' and date1='$date2' and dname='$dname2'";
...
<!-- Password Input --><!-- Age Dropdown -->
			...
			$sql = "select * from opd_appoint1 where dname='$dname2' and date1='$date2'";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->dslot."'>".$row->dslot.'-'.$row->remarks."</option>";
				}
			}
			?>
            </select> 
