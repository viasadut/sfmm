                            ...
                            <table id="example2" class="table table-striped table-bordered">
                                <thead>
                                    ...
                                    <tr>
										...
										//echo"<button type='button' class='btn btn-success float-right' data-toggle='modal' data-target='#product_view1' text-align='left' value='".$row->loc."'>
                                    //".$row->loc."<i class='fas fa-plus'></i> </button>";
...
<?php 
			...
			$sql = "Select * from roaster_location where dept='$dept' and loc='IT'";
			$res = mysqli_query($con, $sql);
...
$row0 = mysqli_fetch_array($result0);
										...
										echo "<option value='".$row0['sid']."'>".$row0['sname']"</option>";
										}*/
