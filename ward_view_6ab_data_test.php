...
$sel3="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '6A%' order by id desc limit 1";
...
$sel4="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '6B%' order by id desc limit 1";
...
$sel6="Select COUNT(id) from inpatient where room1 like '6A%' and discharge=''";

$resu6 = mysqli_query($con,$sel6);
$rw6 = mysqli_fetch_assoc($resu6);


$sel66="Select COUNT(id) from inpatient where room1 like '6B%' and discharge=''";
...
$sql="Select * from inpatient where room1 like '6A%' and discharge='' order by room1 asc";
$result = mysqli_query($con,$sql);
$count=1;



$sql1="Select * from inpatient where room1 like '6B%' and discharge='' order by room1 asc";
...
<tr>
		...
		<strong>6th Floor A Block</strong>&nbsp;&nbsp;
...
echo "<td colspan='1' style='background-color:pink;'>B. Rooming</td>";
    ...
    echo "<td colspan='1' style='background-color:pink'>B. in $baby_room1</td>";
  }
	else 
	{ 
...
<tr>
	    ...
	    <td colspan='12' style='font-size:20x;color:green;text-align:center;background-color:white;'>
		
		

		<strong>6th Floor B Block</strong>&nbsp;&nbsp;
...
$txt='One Patient is Admitted in Block - 6A, Patient Name is-'.$tt4.' And Patient- '.'MRN'.$tt3;
