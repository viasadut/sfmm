...
<div id='cssmenu'>
<ul>
   <li><a href='bill_lab_search_new'><span>Home</span></a></li>
...
$sel_query="Select * from alltest where pmrn='$pmrn' group by eid order by id desc;";
...
{ ?>    <tr>
      ...
      <td colspan="2"align="center"><?php echo $row["date1"]; ?></td>
	  ...
	  <a href="lab_bill_test2_new?ID=<?php echo $pid;?>&pmrn=<?php echo $pm;?>&date=<?php echo $dd1;?>&eid=<?php echo $row['eid'];?>"><span>Go</span></a>
