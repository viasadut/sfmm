...
$query43 = "SELECT COUNT(pname) FROM otreport where pname LIKE '%$bt%';"; 
...
<h1 align="center">Surgery Procedure Search Panel</h1>
...
<!-- Form Title -->
  ...
  <datalist id="browsers111">
				...
				<?php 
			$sql76 = "select distinct pname from `otreport` order by id LIMIT 500";
			$res76 = mysqli_query($con, $sql76);
			if(mysqli_num_rows($res76) > 0) {
				while($row76 = mysqli_fetch_object($res76)) {
					echo "<option value='".$row76->pname."'>".$row76->pname."</option>";
				}
			}
			?>					
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="15%"><strong>Surgery Type</strong>
...
$sel_query1="Select * from otreport where pname LIKE '%$bt%'  order by id desc";
...
{ ?>    <tr>
	  ...
	  $query_p = "SELECT * from patient where pmrn='$ppm'"; 
...
$ppn=$row_p['pname'];
	  ...
	  <td align="center"><?php echo $ppn; ?>
      <td align="center"><?php echo $row1["ottype"]; ?>
	  <td align="center"><?php echo $row1["sname"]; ?>
