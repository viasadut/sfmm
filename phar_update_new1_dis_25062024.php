...
$mid=$b_chk_m['id'];		
	...
	//else if($eqty5 >= $eqty2 and $mqty=='' and $mm_qty<$eqty2)
		else if($eqty5 >= $eqty2 and $mm_qty<$eqty2)
	{
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`brand`,`ins`,`location`,`code`,`pmrn`,`pname`,`rfid`,`eid`) values
			('$medi_1','$eqty2','$p_price','$u_price','$user','$adate','$sno','$brand','$ins','OPD-Discharge','$code_1','$p_mrn','$p_name','$rf','$eid')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
...
$ten_qtyd1=$eight_qtyd1-$b_chk_7i['add_qty'];
	*/
	...
	else if($eqty5 != 0 and $mm_qty>=$eqty2)
	{
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`brand`,`ins`,`location`,`code`,`pmrn`,`pname`,`eid`,`rfid`) values
			('$medi_1','$eqty2','$p_price','$u_price','$user','$adate','$sno','$brand','$ins','OPD-Discharge','$code_1','$p_mrn','$p_name','$eid','$rf')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery2 = mysqli_query($objConnect,$strSQL2);		
	}
...
$ins_query3="update medi_stock set `add_qty`='0' where id='$mmid'";
mysqli_query($con,$ins_query3) or die(mysql_error());
...
$ins_query4="update medi_stock set `add_qty`='$second_qty' where id='$mmid1'";
mysqli_query($con,$ins_query4) or die(mysql_error());
	...
	else if($eqty5 >= $eqty2 and $mqty=='' and $mm_qty>=$eqty2)
	{
			...
			$ins_query3="update medi_stock set `add_qty`='$m_qty1' where id='$mmid'";
mysqli_query($con,$ins_query3) or die(mysql_error());
			
			$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`brand`,`ins`,`location`,`code`,`pmrn`,`pname`,`rfid`) values
			('$medi_1','$eqty2','$p_price','$u_price','$user','$adate','$sno','$brand','$ins','OPD-Discharge','$code_1','$p_mrn','$p_name','$rf')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery2 = mysqli_query($objConnect,$strSQL2);
...
<td colspan="1" class='itotal' <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>></td>
	...
	<tr>
	<td colspan="10"align="right"><a target='_blank' href="phar_receipt_dis?sno=<?php echo $sno;?>"><img src="phar_pic/print.png" title="Print Receipt" width="100" height="80" /></a>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="medi_ins_p_dis?sno=<?php echo $sno;?>"><img src="phar_pic/barcode.png" title="Print Instruction" width="100" height="80" /></a>
