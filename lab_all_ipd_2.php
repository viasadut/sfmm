...
$lab2a4 = "SELECT COUNT(id) from iinves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Confirmed By Consultant' and rdate between '$test' and '$apdate'"; 
...
<body>
    ...
    <br>
    <h1 align="center" style="background-color:lightgreen;text-align:left"><a href='lab_all_opd_2'>OPD (<?php echo $lab_ra;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ipd_2' style="color:red">IPD(<?php echo $lab_r1a;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ae_2'>AE(<?php echo $lab_r2a;?>)</a></h1>
            ...
            <tbody>
                <?php
                    if($ugroup=='lab' && $status='active'){	
                        ...
                        $test=date('Y-m-d', strtotime('-3 days') );
                        $count=1;
                        $sel_query="Select * from iinves where type in ('lab','LAB','Lab') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Confirmed By Consultant' and cdate between '$test' and '$apdate'  order by `resulttime` ASC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="labreportconfirm_2?id=<?php echo $row["id"]; ?>">Confirm</a></td>
