...
$ins_query1="update incident1 set idetails='$com',edit_by='$user',edit_time='$etime',pre_report='$idetails' where id='$id'";
...
<!-- Form Title -->
      ...
      <textarea rows="25"  name="com" required value=""><?php echo $idetails;?></textarea>
