<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','qc','mrd','covid','call','imo','mofficer','nurse','emergency','moopd')"; 
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right" style="font-size:25px;color:red;font-weight:bold"><a href="idocmedi?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Order Medicine</a></td></tr>
		<tr><td colspan="21"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="addpharmediimo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Medicine</a></strong>&nbsp;&nbsp;<a href="datewisemediimo?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;&nbsp;<a href="cancelmediimo?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(Today's Cancelled Medicine List)<b></a></td></tr>
...
<tr>
	   <td colspan="20" align="left" style="font-size:20px;color:red;font-weight:bold"><strong>SPECIAL ORDER</strong></td>
	   
	   </tr>
	<tr>
      <td colspan="1" align="center" style="font-size:20px;color:green;font-weight:bold"><strong>S.No</strong></td>
      
	  <td colspan="10" align="left" style="font-size:20px;color:green;font-weight:bold"><strong>Item Name</strong></td>
	  <td colspan="9" align="left" style="font-size:20px;color:green;font-weight:bold"><strong>Instruction</strong></td>
...
$count=1;
$sel_querys="Select * from istret where pmrn='$pmrn' and eid='$eid' and odate='$dd5' order by `id` DESC;";

$results = mysqli_query($con,$sel_querys);
...
{ ?>    <tr>
      ...
      <td align="center" colspan="1" style="font-size:20px;color:green;font-weight:bold"><?php echo $count; ?></td>
      
	  <td align="left"colspan="10" style="font-size:20px;color:green;font-weight:bold"><?php echo $rows["infusion"]; ?></td>
	  <td align="left"colspan="9" style="font-size:20px;color:green;font-weight:bold"><?php echo $rows["dtime"]; ?></td>
...
<tr>
	  ...
	  <td colspan="10" align="center" style="font-size:20px;color:green;font-weight:bold"><strong>Medicine Name</strong></td>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select DISTINCT(infusion),instruc from imedi3 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pre LIKE ('%infusion%') order by `infusion` asc;";
...
if(mysqli_num_rows($result)>0){
	...
	echo'
	<tr>
	   <td colspan="20" align="left" style="font-size:20px;color:red;font-weight:bold"><strong>INFUSION</strong></td>
...
{ ?>    <tr>
	  ...
	  <td align="left"colspan="10" style="font-size:20px;color:green;font-weight:bold"><a href="addpharmediimodetailsdoc?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&infu=<?php echo $row['infusion'];?>"><?php echo $row["infusion"]; ?></a></td>
	  
	  <td align="left"colspan="9" style="font-size:20px;color:green;font-weight:bold"><?php echo $row["instruc"]; ?></td>
...
$dd=date('m/d/Y');
//$count=1;
$sel_query="Select DISTINCT(infusion),instruc from imedi3 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pre NOT LIKE ('%infusion%') order by `infusion` asc;";
...
if(mysqli_num_rows($result)>0){
	...
	echo'
	<tr>
	   <td colspan="20" align="left" style="font-size:20px;color:red;font-weight:bold"><strong>MEDICINE</strong></td>
...
<?php echo $data59["eid"]; ?>
	  ...
	  <td colspan="9" align="center" style="font-size:20px;color:green;font-weight:bold"><strong>Instruction</strong></td>
