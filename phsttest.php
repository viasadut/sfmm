...
$query159 = mysqli_query($db,"select * from medicine where mname='$medi1'");
$data159 = mysqli_fetch_assoc($query159);

$code=$data159["code"];
$brand=$data159["brand1"];




$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`,`code`,`brand`) values ('$full','$pmrn','$pname','$medi1','$pdos','$eid','$date1','$code','$brand')";
...
<tr><td colspan="15" align="center"><label><strong>Medicine</strong></label></td> 

<td colspan="5" align="center"><label><strong>Dosage</strong></label></td> 
</tr>
<tr>
<td colspan="15" align="center"><input list="browsers111" name="medi1" class="form-control" required/>
