...
$sel90="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$date1' and `time`='$infu1' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result90 = mysqli_query($con,$sel90);

$sel91="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$date1' and `time`='$infu2' and `status`='Active' and status1 in ('SEEN','Rupdated') ;";
$result91 = mysqli_query($con,$sel91);


$sel92="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$date1' and `time`='$infu3' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result92 = mysqli_query($con,$sel92);


$sel93="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$date1' and `time`='$infu4' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result93 = mysqli_query($con,$sel93);


$sel94="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$date1' and `time`='$infu5' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result94 = mysqli_query($con,$sel94);

$sel95="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$date1' and `time`='$infu6' and `status`='Active' and status1 in ('SEEN','Rupdated');";
...
$ins_query6="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`) values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice')";
mysqli_query($con,$ins_query6);}

if(!empty ($_POST['infu2'])){
$ins_query7="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice')";
mysqli_query($con,$ins_query7);}

if(!empty ($_POST['infu3'])){
$ins_query8="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice')";
mysqli_query($con,$ins_query8);}

if(!empty ($_POST['infu4'])){
$ins_query9="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice')";
mysqli_query($con,$ins_query9);}

if(!empty ($_POST['infu5'])){
$ins_query10="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice')";
mysqli_query($con,$ins_query10);}


if(!empty ($_POST['infu6'])){
$ins_query11="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`) values ('$pmrn','$dname','$eid','$infu','$infu6','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice')";
mysqli_query($con,$ins_query10);}
...
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime','$dilu','$uprice')";
			...
			{
			$strSQL = "insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`reuse`,`uprice`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime','$dilu','Reuse','$uprice')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
...
<tr>
<td colspan="4" align="center"><label><strong>Time1</strong></label></td> 
<td colspan="4" align="center"><label><strong>Time2</strong></label></td>
<td colspan="3" align="center"><label><strong>Time3</strong></label></td>
<td colspan="3" align="center"><label><strong>Time4</strong></label></td>
<td colspan="3" align="center"><label><strong>Time5</strong></label></td>
<td colspan="3" align="center"><label><strong>Time6</strong></label></td></tr>
<tr>
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="3" align="center"><select list="rr3" name="infu3"  class="form-control">
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="3" align="center"><select list="rr4" name="infu4"  class="form-control">
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="3" align="center"><select list="rr5" name="infu5" class="form-control">
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="3" align="center"><select list="rr6" name="infu6" class="form-control">
...
$strSQL = "Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and status1='RUPDATED'order by `time` and `infusion` asc;";
...
<tr>
	  ...
	  <td align="center"colspan="4"> <a href="addpharmediimodetails?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&infu=<?php echo $row['infusion'];?>"><?php echo $row["infusion"]; ?></a></td>
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($con,"sfmmkpjnew");
$strSQL = "Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and status1='SEEN'order by `time` and `infusion` asc;";
$objQuery = mysqli_query($con,$strSQL) or die ("Error Query [".$strSQL."]");
//$sel_query="Select * from pmedi where pmrn= '$pmrn' and eid='$eid1'order by `id` DESC;";
...
<tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row["odate"]; ?></td>
      <td align="center"colspan="1"><?php echo $row["time"]; ?></td>  
	  <td align="center"colspan="5"> <a href="addpharmediimodetails?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&infu=<?php echo $row['infusion'];?>"><?php echo $row["infusion"]; ?></a></td>
	  <td align="center"colspan="1"><?php echo $row["root"]; ?></td>
	  <td align="center"colspan="1"><?php echo $row["dilu"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["instruc"]; ?></td>
