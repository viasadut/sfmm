...
$query = "UPDATE dleave set hstatus='Approved By HOS',hatime='$dtime' where id='$id'"; 
...
$mail_body = "
			<p>Hi ".$row3['sname'].",</p>
			<p>Please be informed that Your Inpatient Leave from  ".$rowl['sdate']." to ".$rowl['edate']." is Rejected BY HOS / In-Charge.</p>
