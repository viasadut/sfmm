...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
					 ...
					 <td colspan="5"><input type="text" name="ptemp" value="<?php echo $pd;?>" readonly/></td>  
						 ...
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="cdetails" rows="40" >
X-RAY OF DORSO-LUMBAR SPINE B/V:

Dorso-lumbar curvature is maintained.

No bony lesion is seen.

Disc spaces are normal.

SI joints are normal.

Pre & para vertebral soft tissue opacity appear normal. 


</textarea></td>  </tr>
						<tr><td colspan="20"><label><strong>Findings / Observation / Remarks:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="find" rows="5" >Impression: No significant abnormality is detected.</textarea></td>  </tr>
