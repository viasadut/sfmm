...
$cafe= "SELECT COUNT(id) FROM restaurant_price_history where status='1' and delete_status='1'"; 
$cafe_result = mysqli_query($con, $cafe) or die(mysqli_error());
$row_cafe = mysqli_fetch_array($cafe_result);
$cafe_data=$row_cafe['COUNT(id)'];
?>
<!DOCTYPE html>
<html>
<head>
...
<ul>
      ...
      <ul>
	   <li class='has-sub'><a href='billappmng'><span>Appointment Report</span></a>
		...
		<li class='has-sub'><a href='view3newrad'><span>Radiology Report</span></a>
		 ...
		 <li class='has-sub'><a href='con2_new'><span>Consultant Wise OT Stats Report</span></a>
 ...
 <li class='active has-sub'><a href='#'><span>Admission Request</span></a>
   ...
   <li class='active has-sub'><a href='#'><span>Privilege Request</span></a>
	 ...
	 <?php if($fullname=='md'){echo "<li class='last'><a href='mmaapprove'><span>Pending Privilege List For Approval</span></a></li>";}
	 
	 else if($fullname=='md01'){echo "<li class='last'><a href='mmaapprove'><span>Pending Privilege List For Approval</span></a></li>";}
	 
	 else if($fullname=='1601'){echo "<li class='last'><a href='mmaapprove_cfo'><span>Pending Privilege List For Approval</span></a></li>";}
	 ?>
	   ...
	   <li class='last'><a href='mmarequest_md'><span>Set Consultant Privilege</span></a></li>
	   <li class='last'><a href='research_approval'><span>Approve Research Request</span></a></li>
	   <li class='last'><a href='consent_approval'><span>Approve Consent Form</span></a></li>
	   <li class='last'><a style="font-weight:bold;font-size:12px;" href="list_injury_edit_ack"><span>Pending Injury Certificate Confirmation Request</span></a></li>
   ...
   <li class='active has-sub'><a href='#'><span>BED MANAGEMENT</span></a>
      <ul>
	   ...
	   <li class='last'><a href='bed_mng_test5'><span>New Format</span></a></li>
	   <li class='last'><a href='add_new_bed'><span>Add New Bed</span></a></li>
	   <li class='last'><a href='bed_stats1'><span>Stats</span></a></li>
   ...
   <li class='active has-sub'><a href='#'><span>PO</span></a>
      <ul>
	   <li class='last'><a target='_blank' href='po_approval_pin'><span>Pending PO Request</span></a></li>
	   <li class='last'><a target='_blank' href='prf_approval'><span>Pending PRF Request</span></a></li>
	   <li class='last'><a target='_blank' href='ap_approval_pin'><span>Pending Cheque Approval Request</span></a></li>
	   <li class='last'><a target='_blank' href='bangla_test'><span>Add Instructions</span></a></li>
	   <li class='last'><a target='_blank' href='company_request_mng'><span>Pending Company Approval Request</span></a></li>
   ...
   <li class='last'><a href='ap\index'><span>AP</span></a></li>
   
   <li class='active has-sub'><a href='#'><span>Liver Clinic</span></a>
      <ul>
	   <li class='last'><a target='_blank' href='liver_clinic_app'><span>Pending Appointments</span></a></li>
	   <li class='last'><a target='_blank' href='liver_clinic_app_reassign'><span>Re-Assign Appointments</span></a></li>
	   <li class='last'><a target='_blank' href='liver_patient_stats'><span>Datewise Clinic Stats</span></a></li>
	   <li class='last'><a target='_blank' href='liver_con_patient_stats'><span>Datewise Consultant Clinic Stats</span></a></li>
	     <li class='last'><a target='_blank' href='liver_con_patient_app_stats'><span>Datewise Consultant Appointment Stats</span></a></li>
		 <li class='last'><a target='_blank' href='follow_scan'><span>Set Patient Followup Date</span></a></li>
		 <li class='last'><a target='_blank' href='today_liver_stats'><span>Today's Liver Clinic Patient</span></a></li>
		 <li class='last'><a target='_blank' href='today_app_stats'><span>Today's Appointment Report</span></a></li>
	   
	   <li class='active has-sub'><a href='all_rela_doc_upload'><span>Rela Uploaded Documents Panel</span></a></li>
	   <li class='active has-sub'><a href='liver_clinic_stats'><span>Liver Clinic Stats</span></a></li>
   ...
   <li><a href='ot_note_delay_req_panel'><span>OT Note Edit Request</span></a></li>
   
   <li class='active has-sub'><a href='all_other_doc_upload'><span>Other Uploaded Documents Panel</span></a>
   
      
   </li>
   <li class='last'><a href='birthconfirm'><span>Approve Birth Certificates</span></a></li>
   <li class='last'><a href='logbook/index' style="color:red;weight:bold"><span>Logbook</span></a></li>
   <li class='last'><a href='code_set'><span>Set Code</span></a></li>  
   
	   <li class='last'><a target='_blank' href='transplant/liver/liver_dash'><span>Transplant Portal</span></a></li>
	   
<?php	   
	   
	   if($_SERVER['HTTP_HOST']=="192.168.100.252:8081"){
echo "<li class='last'><a target='_blank' href='http://192.168.98.153:8085/ncms/login-from-pms/".$_SESSION["sess_username"]."'>NC Portal</a></li>";
}
else{
echo "<li class='last'><a target='_blank' href='http://182.160.124.36:7632/ncms/login-from-pms/".$_SESSION["sess_username"]."'>NC Portal</a></li>";
}    
	 ?>  
	   
	   <li class='last'><a href='package_approval'><span>Package</span></a></li>
	   <li class='last'><a href='con_inves_charge_xray'><span>XRAY STATS</span></a></li>
	   <li class='last'><a href='doc_all_stat_mng'><span>Consultant Income</span></a></li>
	 <?php if($user=='md' || $user=='1601' || $user=='md01'){  
	   echo "<li class='last'><a href='change_pin'><span>Change Pin</span></a></li>";


	   }?>

<li class='last'><a href='cash_collection_report_new'><span>Cashier Wise Report(Total)</span></a></li>
<li class='last'><a href='today_pms_bill'><span>Todays's Bill</span></a></li>

	   
<li class='active has-sub'><a href='#'><span>Accounts</span></a>
      <ul>
	  <li class='last'><a target='_blank' href='pms_income_report'><span>Daily Income Statement</span></a></li>  
	  <li class='last'><a target='_blank' href='cash_collection_report_modewise_1'><span>Cashier Wise Report(Payment Mode Wise)</span></a></li>
	   <li class='last'><a target='_blank' href='report_tb_new_5'><span>Trial Balance</span></a></li>
	   <li class='last'><a target='_blank' href='pms_discount_report'><span>Discount Report</span></a></li>
	   <li class='last'><a target='_blank' href='pms_outstanding_report'><span>Outstanding Report</span></a></li>
	   <li class='last'><a target='_blank' href='pms_phar_report'><span>Pharmacy Report</span></a></li>
	   <li class='last'><a target='_blank' href='pms_activity_report'><span>Patient Activity Enquiry Report</span></a></li>
	   <li class='last'><a target='_blank' href='pms_corporate_report'><span>Corporate Activity Enquiry Report</span></a></li>
	   <li class='last'><a target='_blank' href='pl_new1' style="color:white; font-weight:bold"><span>Profit & Loss Report(Test)</span></a></li>
	   <li class='last'><a target='_blank' href='balance_sheet' style="color:white; font-weight:bold"><span>Balance Sheet Report(Test)</span></a></li>
	   <li class='last'><a target='_blank' href='po_payment_report' style="color:white; font-weight:bold"><span>PO Payment Statistics</span></a></li>
	   <li class='last'><a target='_blank' href='datewise_po_report_1' style="color:white; font-weight:bold"><span>Datewise PO Approval Statistics</span></a></li>
   ...
   <li class='last'><a href='FAMS/index'><span>FAMS</span></a></li>
   <li class='last'><a href='reporting-portal/index'><span>Reporting Portal</span></a></li>
...
<tr>
	<td colspan="5"align="center"><a href="opdstatmng"><font size="4.5">OPD Stat</a></td>
		...
		<td colspan="2" align="center"><a href="labhomemng"><font size="4.5">LAB</a><font size="4.5" color="red"><strong>('.$lab_all.')</strong></font></td>
...
<tr>
	<td colspan="5"align="center"><a href="opd_home"><font size="4.5">	Todays OPD</a></td>
...
<tr>
	<td colspan="5"align="center"><a href="edocviewmng"><font size="4.5">	Emergency</a></td>
		...
		<td colspan="2" align="center"><a href="spd_stats"><font size="4.5">SPD Stats</a></td>
...
else if($c11>0 and $fullname=='ceo'){
	echo'
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
...
if($full==='Dr. J.M.H Qausar Alam' && $c11>0)
{
...
else if($full==='Dr. J.M.H Qausar Alam' && $c11>0)
{$st=$row25['COUNT(apstatus)'] + $row26['COUNT(apstatus)'];
...
else if($full==='Amit Kumar Dhali' && $c11>0)
...
<td colspan="3"align="center"><a href="leavemngdocmng"><font size="4.5">	LEAVE MANAGEMENT</a>
	...
	<tr>
	<td colspan="5"align="center"><a href="tender/project/index"><font size="4.5">Tender Portal</a></td>
	<td colspan="5"align="center"><a href="con_ot_bill_mng"><font size="4.5">Search Previous Procedure Cost</a></td>
	<td colspan="3"align="center"><a href="proposal_portal"><font size="4.5">Proposal Portal</a>
	
	<font size="4.5" color="#FF0000"><b>(
	'.$proposal_q2.')<b>
	
	</td>
	<td colspan="2" align="center"><a href="inves_doc"><font size="4.5">Add Consultant in Investigation Panel</a></td>
	<td colspan="2" align="center"><a href="all_dept_stock"><font size="4.5">View Medicine Floor Stock</a></td><tr>
	<tr>
	<td colspan="5"align="center"><a href="todolist_details"><font size="5.5" color="red" font-weight="bold">Pending Work List ('.$p_work.')</a></td>
	<td colspan="5"align="center"><a href="all_doc_stats"><font size="5.5" color="red" font-weight="bold">Consultant Wise Statement</a></td>
	<td colspan="3"align="center"><a href="con_inves_charge"><font size="5.5" color="red" font-weight="bold">Investigation Request Stats</a></td>
	<td colspan="2"align="center"><a href="staff_attn_rfid_old"><font size="5.5" color="red" font-weight="bold">Realtime Attendance</a></td>
	<td colspan="2"align="center"><a href="tender/equipment/product_cata4"><font size="5.5" color="red" font-weight="bold">Repository of Medical Equipment</a></td>
	<td colspan="2"align="center"><a href="guest_module_home"><font size="5.5" color="red" font-weight="bold">Guest Module</a></td>
	</tr>
	<tr>
	<td colspan="5"align="center"><a href="weight_loss_list_doc"><span>Weight Loss Program</span></a></td>
	<td colspan="5"align="center"><a target="_blank" href="https://sfmmkpjsh.com/login?e=accounts@sfmmkpjsh.com&p='.$encryption.'">Online Admission<a/></td>
...
<tr>
	<td colspan="5"align="center"><a href="tender/project/index"><font size="4.5">Tender Portal</a></td>
	<td colspan="5"align="center"><a href="con_ot_bill_mng"><font size="4.5">Search Previous Procedure Cost</a></td>
	<td colspan="3"align="center"><a href="proposal_portal"><font size="4.5">Proposal Portal</a></td>
	<td colspan="2" align="center"><a href="inves_doc"><font size="4.5">Add Consultant in Investigation Panel</a></td>
	<td colspan="2" align="center"><a href="all_dept_stock"><font size="4.5">View Medicine Floor Stock</a></td>
	<td colspan="2" align="center"><a href="md_discharge_view"><font size="4.5">Todays Discharge Reports</a></td>
	</tr>
	<tr>
	<td colspan="5"align="center"><a href="todolist_details"><font size="5.5" color="red" font-weight="bold">Pending Work List ('.$p_work.')</a></td>
	<td colspan="5"align="center"><a href="all_doc_stats"><font size="5.5" color="red" font-weight="bold">Consultant Wise Statement</a></td>
	...
	<tr>
	<td colspan="5" align="center"><a href="cafe/index"><font size="4.5">Cafeteria</a></td>
	<td colspan="5"align="center"><a href="weight_loss_list_doc"><span>Weight Loss Program</span></a></td>
	<td colspan="3"align="center"><a href="bio_tech_home"><span><font size="5.5" color="red" font-weight="bold">Project Bio Tech</span></a></td>
	<td colspan="3"align="center"><a href="oes1/index"><span><font size="5.5" color="green" font-weight="bold">Online Exam Module</span></a></td>
	</tr>
...
<tr>
	...
	<tr>
	<td colspan="5" align="center"><a href="cafeteria/index"><font size="4.5">Cafeteria</a></td>
	<td colspan="5"align="center"><a href="weight_loss_list_doc"><span>Weight Loss Program</span></a></td>
	<td colspan="3"align="center"><a href="bio_tech_home"><span><font size="5.5" color="red" font-weight="bold">Project Bio Tech</span></a></td>
	<td colspan="3"align="center"><a href="oes1/index"><span><font size="5.5" color="green" font-weight="bold">Online Exam Module</span></a></td>
	</tr>
...
if($full==='Amit Kumar Dhali' && $c11>0)
{
...
<tr>
	...
	<td colspan="2" align="center"><a href="inves_doc"><font size="4.5">Add Consultant in Investigation Panel</a></td>
	<td colspan="2" align="center"><a href="all_dept_stock"><font size="4.5">View Medicine Floor Stock</a></td>
	<td colspan="2" align="center"><a href="cafe/index"><font size="4.5">Cafeteria</a>
	 <font size="4.5" color="#FF0000"><b>(
	'.$row_cafe['COUNT(id)'].')<b>
...
<td colspan="5"align="center"><a href="roaster_home"><font size="4.5">Roster</a></td>
	  ...
	  <td colspan="2"align="center"><a href="tender/project/index"><font size="4.5">Tender Portal</a></td>
	  <td colspan="2"align="center"><a href="con_ot_bill_mng"><font size="4.5">Search Previous Procedure Cost</a></td>
</tr>
	
<tr>
	<td colspan="5"align="center"><a href="proposal_portal"><font size="4.5">Proposal Portal</a></td>
	  <td colspan="5" align="center"><a href="inves_doc"><font size="4.5">Add Consultant in Investigation Panel</a></td>
	    <td colspan="3" align="center"><a href="all_dept_stock"><font size="4.5">View Medicine Floor Stock</a></td>
			<td colspan="2"align="center"><a href="todolist_details"><font size="5.5" color="red" font-weight="bold">Pending Work List ('.$p_work.')</a></td>
			<td colspan="2"align="center"><a href="all_doc_stats"><font size="5.5" color="red" font-weight="bold">Consultant Wise Statement</a></td>
</tr>

<tr>
	<td colspan="5"align="center"><a href="weight_loss_list_doc"><span>Weight Loss Program</span></a></td>
	<td colspan="5"align="center"><a href="guest_module_home"><font size="5.5" color="red" font-weight="bold">Guest Module</a></td>
<td colspan="3"align="center"><a href="oes1/index"><span><font size="5.5" color="green" font-weight="bold">Online Exam Module</span></a></td>	  
</tr>
...
echo $row_in1['COUNT(id)']+$row_in3['COUNT(id)'];
echo " , ";	 
//echo "HDU- ";
