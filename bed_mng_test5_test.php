...
if($result_time<$time_now and $ad>$ad1)
{
...
$count=1;	
$sel_query="Select * from bed where status in ('occupied','Vacant','Under Housekeeping','Under Maintenance') and block='7G' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('occupied','Vacant','Under Housekeeping','Under Maintenance') and block='Dialysis Unit' and bed_status='Active' order by status asc";	
