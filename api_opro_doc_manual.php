...
$query39 = "SELECT * FROM procedure1 where id= '$id'"; 
...
if($api_status==0){
  ...
  if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
      ...
      //header("Location:$url");
       ...
       $api_query = "update procedure1 set api_status='1', invoice_no='$invoice_no' where id='".$id."'"; 
