<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('call','ev','staff')"; 
...
<form action="view4new1" method="POST">
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="#ccgg3#?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>"></a></td>
