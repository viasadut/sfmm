...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from chemoinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status1='Active' order by `ddate` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="chemodocinfucancel?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
