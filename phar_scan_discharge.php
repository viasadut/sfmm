...
$url = "dis_medi_patient?pmrn=$pmrn";
//$url = "phar_update_new1_dis?pid=$pmrn&sno=$runningTime";
header("Location: $url"); 
}
...
<td colspan="2"><select name="select" required>
	  ...
	  <option value='id'>Discharge ID</option>
	  
	  
	  
	  </select></td>

<td colspan="3"><input type="text" name="search"placeholder="ENTER MRN OR DISCHARGE ID"></td>
