...
$query22 = "SELECT * from friskchemo where pmrn='$pmrn' and eid='$eid'"; 
...
$update="update nurseassesschemo set cname='$cname',crelation='$crelation',cphone='$cphone', astime='$astime', ma='$ma', acc='$acc', shistory='$shistory', language='$language', nip='$nip', edus='$edus', comor='$comor', valueableb='$valueableb', bodys='$bodys', du='$du', remarks='$remarks' where eid='$eid' and pmrn='$pmrn'";
