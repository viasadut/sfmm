...
$(document).ready(function() {
	 ...
	 */
	$.ajax({
		url : "http://192.168.100.252:8080/sfmm/pulse1.php?pmrn=<?php echo $pmrn?>&eid=<?php echo $eid?>&odate1=<?php echo $odate1?>",
//		var pmrn =data.pmrn;
		type : "GET",
		success : function(data){
			...
			for (var i = 0; i < len; i++) {
				if (data[i].vitails1 == "Pulse") {
					score1.Pulse.push(data[i].score1);
				}
...
var len1 = data.length;
			...
			for (var i1 = 0; i1 < len1; i1++) {
				if (data[i1].hrd == "1") {
					time.rt1.push(data[i1].date1);
				}
								else if (data[i1].hrd == "2") {
					time.rt2.push(data[i1].date1);
				}
												else if (data[i1].hrd == "3") {
					time.rt3.push(data[i1].date1);
				}
												else if (data[i1].hrd == "4") {
					time.rt4.push(data[i1].date1);
				}
																else if (data[i1].hrd == "5") {
					time.rt5.push(data[i1].date1);
				}
													else if (data[i1].hrd == "6") {
					time.rt6.push(data[i1].date1);
				}
													else if (data[i1].hrd == "7") {
					time.rt7.push(data[i1].date1);
				}
												else if (data[i1].hrd == "8") {
					time.rt8.push(data[i1].date1);
				}
												else if (data[i1].hrd == "9") {
					time.rt9.push(data[i1].date1);
				}
												else if (data[i1].hrd == "10") {
					time.rt10.push(data[i1].date1);
				}
												else if (data[i1].hrd == "11") {
					time.rt11.push(data[i1].date1);
				}
												else if (data[i1].hrd == "12") {
					time.rt12.push(data[i1].date1);
				}
												else if (data[i1].hrd == "13") {
					time.rt13.push(data[i1].date1);
				}

												else if (data[i1].hrd == "14") {
					time.rt14.push(data[i1].date1);
				}

												else if (data[i1].hrd == "15") {
					time.rt15.push(data[i1].date1);
				}

												else if (data[i1].hrd == "16") {
					time.rt16.push(data[i1].date1);
				}
												else if (data[i1].hrd == "17") {
					time.rt17.push(data[i1].date1);
				}
												else if (data[i1].hrd == "18") {
					time.rt18.push(data[i1].date1);
				}
												else if (data[i1].hrd == "19") {
					time.rt19.push(data[i1].date1);
				}

												else if (data[i1].hrd == "20") {
					time.rt20.push(data[i1].date1);
				}
												else if (data[i1].hrd == "21") {
					time.rt21.push(data[i1].date1);
				}
												else if (data[i1].hrd == "22") {
					time.rt22.push(data[i1].date1);
				}
												else if (data[i1].hrd == "23") {
					time.rt23.push(data[i1].date1);
				}
												else if (data[i1].hrd == "24") {
					time.rt24.push(data[i1].date1);
				}

				
											else if (data[i1].hrd == "25") {
					time.rt25.push(data[i1].date1);
				}
											else if (data[i1].hrd == "26") {
					time.rt26.push(data[i1].date1);
				}
											else if (data[i1].hrd == "27") {
					time.rt27.push(data[i1].date1);
				}
				
											else if (data[i1].hrd == "28") {
					time.rt28.push(data[i1].date1);
				}

							else if (data[i1].hrd == "29") {
					time.rt29.push(data[i1].date1);
				}

											else if (data[i1].hrd == "30") {
					time.rt30.push(data[i1].date1);
				}

				
											else if (data[i1].hrd == "31") {
					time.rt31.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "32") {
					time.rt32.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "33") {
					time.rt33.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "34") {
					time.rt34.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "35") {
					time.rt35.push(data[i1].date1);
					...
					time.rt36.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "37") {
					time.rt37.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "38") {
					time.rt38.push(data[i1].date1);
				}
				
											else if (data[i1].hrd == "39") {
					time.rt39.push(data[i1].date1);
				}
				
											else if (data[i1].hrd == "40") {
					time.rt40.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "41") {
					time.rt41.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "42") {
					time.rt42.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "43") {
					time.rt43.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "44") {
					time.rt44.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "45") {
					time.rt45.push(data[i1].date1);
				}
				
											else if (data[i1].hrd == "46") {
					time.rt46.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "47") {
					time.rt47.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "48") {
					time.rt48.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "49") {
					time.rt49.push(data[i1].date1);
				}
				
				
											else if (data[i1].hrd == "50") {
					time.rt50.push(data[i1].date1);
				}

								else if (data[i1].hrd == "51") {
					time.rt51.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "52") {
					time.rt52.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "53") {
					time.rt53.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "54") {
					time.rt54.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "55") {
					time.rt55.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "56") {
					time.rt56.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "57") {
					time.rt57.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "58") {
					time.rt58.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "59") {
					time.rt59.push(data[i1].date1);
				}
				
								else if (data[i1].hrd == "60") {
					time.rt60.push(data[i1].date1);
				}
			...
			var options = {
				title : {
					display : true,
					position : "top",
					text : "Pluse Graph of MRN- <?php echo $pmrn;?>",
					fontSize : 18,
					fontColor : "#111"
				},
				legend : {
