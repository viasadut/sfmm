...
<p align="center" class="style1">EMERGENCY PATIENTS</p> 
<form action="" method="GET">
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">


    <tr><td align="right" colspan="20"><a href="emerraddis">See Today's Discharge Patients</a></td></tr>
...
$sel_query="Select * from emergency where discharge= '' order by room asc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="emerrad1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
	  <td align="center"><a href="radinpeditemer_old?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">EDIT</a></td>
