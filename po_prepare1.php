...
$po_value=$dataa['SUM(tprice)'];
								...
								$ciphering1,
								$encryption_key1, $options, $encryption_iv);
								$encryption1;*/
								
								$simple_string = $data['id'];
								$ciphering = "AES-256-CTR";
								$iv_length = openssl_cipher_iv_length($ciphering);
								$options = 0;
								$encryption_iv = '1234567891011121';
								$encryption_key = "kpj";
								$encryption1 = openssl_encrypt($simple_string,
								$ciphering,
...
<a target="_blank" href="po_upload?ono='.$encryption.'&eid='.$encryption1.'"><img src="upload.png" title="Upload PO" width="50" height="50" />
   </a>     

   <a target="_blank" href="po_request_comparison?sno='.$po_ono.'&id='.$po_id.'"><img src="comparison.png" title="View Comparison" width="50" height="50" />
</a>
...
<input type="text" name="b_name" id="brand" required value="" readonly style="font-weight: bold;font-size:14px;color:green">
	...
	<td colspan="3">					
		...
		<td colspan="3">					
		<input type="text" name="u_price" id="uprice" required value="" readonly style="font-weight: bold;font-size:14px;color:green">
		</td>
