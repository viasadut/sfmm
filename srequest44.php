...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('store','staff','ot','nurse','imo','mofficer','emergency','lab','diet','mng')"; 
...
$strSQL = "Select * from srequest where rdate='$sdate' and rid='$sid' order by `id` DESC;";
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Department</strong></td>
     	  <td colspan="5" align="center"><strong>Request_ID</strong></td>
		  <td colspan="5" align="center"><strong>Request Item</strong></td>
		  <td colspan="5" align="center"><strong>Issue Date</strong></td>
      	  <td colspan="1" align="center"><strong>Request QTY</strong></td>
		  <td colspan="1" align="center"><strong>Given QTY</strong></td>
...
<td align="center"colspan="2"><?php echo $row["rdept"]; ?></td>
	        ...
	        <td align="center"colspan="5"><?php echo $row["rid"]; ?></td>
			<td align="center"colspan="5"><?php echo $row["sdept"]; ?></td>
			<td align="center"colspan="5"><?php echo $row["rtime"]; ?></td>
				        <td align="center"colspan="1"><?php echo $row["eqty"]; ?></td>
						<td align="center"colspan="1"><?php echo $row["eqty1"]; ?></td>
