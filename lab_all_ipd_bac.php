...
$lab2a4 = "SELECT COUNT(id) from iinves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate'and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY') and rejectby!=''"; 
...
<body>
    ...
    <br>
    <h1 align="center" style="background-color:lightgreen;text-align:left"><a href='lab_all_opd_bac'>OPD (<?php echo $lab_ra;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ipd_bac' style="color:red">IPD(<?php echo $lab_r1a;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ae_bac'>AE(<?php echo $lab_r2a;?>)</a></h1>
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="labreportconfirm_bac?id=<?php echo $row["id"]; ?>">Confirm</a></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_ipd_bio_bac?id=<?php echo $row["id"]; ?>">Reject</a></td>
      </tr>
