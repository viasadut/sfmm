...
$query43 = "SELECT COUNT(id) FROM endoreport where rdate BETWEEN '$start' and '$end' ;"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <td width="17%"align="center"><strong>Procedure Name</strong></td>
      <td width="10%"align="center"><strong>Qty</strong></td>
      <td width="15%"align="center"><strong>Details </strong></td>
...
$sel_query="Select count(id),type from endoreport where rdate BETWEEN '$start' and '$end' group by type order by type desc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="endo_monthly_details?type=<?php echo $row['type']; ?>&sdate=<?php echo $start; ?>&edate=<?php echo $end; ?>">Details</a></td>  	  
