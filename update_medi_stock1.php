...
if(empty($_REQUEST['chkDel']))
{
    ...
    echo '</script>';
                ...
                foreach($_POST['chkDel'] as $updateid){
			...
			$strSQL = "update medicine_new set tqty='".$eqty5."' where code='".$code_1."'";
...
$strSQL = "Select distinct(code) from medi_stock where location='Pharmacy' ORDER BY g_name asc;";
...
<td align="center"colspan="1"><input class="iprice" name="eqty2_<?= $id ?>" id="eqty2" type="text" value="<?php echo $new_qty;?>" ></td>
<td align="center"colspan="1"><input class="iprice" name="eqty2uuu_<?= $id ?>" id="eqty2yyy" type="text" value="<?php echo $new_qty2;?>" ></td>			  
