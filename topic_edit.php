...
<!-- Form Title -->
		...
		<label for="age"><strong>Discipline :</strong></label>	
						...
						<select name="tt" value='' required>
						<option value=''>--Select Type--</option>
						<option value='General Information'>General Information</option>
						<option value='Topic'>Topic</option>
						<option value='Clinical Pathway'>Clinical Pathway</option>
						<option value='PMS Manual Pathway'>PMS Manual</option>
	  ...
	  <label for="age"><strong>Name Of The Topic:</strong></label>
			...
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->tname." "."'></option>";
				}
			}
			?>  </datalist>
