...
$query43 = "SELECT COUNT(pmrn) FROM deathb where rdate BETWEEN '$start' and '$end';"; 
...
$query44 = "SELECT COUNT(pmrn) FROM deathn where rdate BETWEEN '$start' and '$end';"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>B.In. Death Cer</strong></th>
...
$sel_query="Select * from deathb where  rdate BETWEEN '$start' and '$end' order by rdate asc";}
 else{
...
<td align="center"><a target='_blank' href="deathprint.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row['pmrn']; ?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
...
<td align="center"><a target="_blank" href="death_remarks.php?id='.$row["id"].'&pmrn='.$row['pmrn'].'"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
';}
...
<td align="center"><a target="_blank" href="death_remarks1.php?id='.$row["id"].'&pmrn='.$row['pmrn'].'"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
';}
?>
      </tr>
