...
$query = mysqli_query($db,"select * from urinepcratio where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'Protine, Urine',1,0,'C');
$pdf->Cell('30',5,$data['uv'],1,0,'C');
$pdf->Cell('31',5,'mg/L',1,0,'C');
$pdf->Cell('40',5,'<120',1,1,'C');

$pdf->Cell('80',5,'Creatinine, Urine',1,0,'C');
$pdf->Cell('30',5,$data['uc'],1,0,'C');
$pdf->Cell('31',5,'mmol/L',1,0,'C');
$pdf->Cell('40',5,'2.7-25.0',1,1,'C');


$pdf->Cell('80',5,'Urine Protine /Creatinine Ratio',1,0,'C');
$pdf->Cell('30',5,$data['ratio'],1,0,'C');
...
lab_render_approval_footer($pdf, $db, 'BIOCHEMISTRY', (isset($data3['resultby'])?$data3['resultby']:(isset($data['resultby'])?$data['resultby']:'')), (isset($data3['checked_by'])?$data3['checked_by']:''), (isset($data3['cby'])?$data3['cby']:''));
$pdf->Ln(10);
