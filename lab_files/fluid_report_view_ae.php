...
$query = mysqli_query($con,"select * from einves where id='$id'");
...
lab_render_approval_footer($pdf, $con, (isset($data['subtype'])?$data['subtype']:''), (isset($data['resultby'])?$data['resultby']:''), '', (isset($data['conby'])?$data['conby']:''));
