...
$query4 = mysqli_query($db,"select * from user where uname='$duser'");
...
$pdf->Cell('60',5,'Referring Consultant Name: '. $data4['fullname'],0,1,'L');
...
$pdf->Cell('80',5,'Dengue Virus NS1 Antigen',1,0,'C');
