...
$query = mysqli_query($db,"select * from thyroid where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('60',5,'Particulars',1,0,'L');
$pdf->Cell('20',5,'Value',1,0,'L');
$pdf->Cell('20',5,'Unit',1,0,'L');
$pdf->Cell('80',5,'Reference Range',1,1,'L');



$pdf->Cell('60',5,'Anti-Thyroid Peroxidase(Anti-TPO)',1,0,'L');
$pdf->Cell('20',5,$data['atpo'],1,0,'L');
$pdf->Cell('20',5,'IU/mL',1,0,'L');
$pdf->Cell('80',5,'Positive>60 U/mL    Negative<60 IU/mL',1,1,'L');

$pdf->Cell('60',5,'Anti-Thyoglobulin(Anti-TG)',1,0,'L');
$pdf->Cell('20',5,$data['atg'],1,0,'L');
$pdf->Cell('20',5,'IU/mL',1,0,'L');
$pdf->Cell('80',5,'Negative<4.5 U/mL  Positive>=4.5 IU/mL',1,1,'L');
...
lab_render_approval_footer($pdf, $db1, 'IMMUNOLOGY/SEROLOGY', (isset($data3['resultby'])?$data3['resultby']:''), (isset($data3['checked_by'])?$data3['checked_by']:''), (isset($data3['conby'])?$data3['conby']:''));
$pdf->Ln(10);
