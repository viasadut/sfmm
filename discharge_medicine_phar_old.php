...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
			...
			$qq = mysqli_query($db,"select * from idismedi where id='".$updateid."'");
...
if($eqty5 >= $eqty2 and $mqty=='' and $mm_qty>=$eqty2 and $eqty2>0)
	
	{
			...
			$strSQL1 = "update idismedi set status='Served',qty='$eqty2' where id='".$updateid."'";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><h1 style="color:red"><strong>Bill No - <?php echo $runningTime;?></strong></h1></label></td> </tr>
...
<tr>
	  ...
	  <td colspan="7" align="center"><strong>Instruction</strong></td>
	    ...
	    <?php 
                    $query = "select * from idismedi where pmrn='$pmrn' and eid='$eid' and status='Active'";
...
$new_qty=$sumr['SUM(add_qty)'];
     ...
     <td align="center" colspan="1" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>><?php echo $count; ?></td>
      ...
      <td align="center"colspan="8" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>><?php echo $row["medi"]; ?></td>
	  ...
	  <td align="center"colspan="7" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>><?php echo $row["pdos"].'<br>'.$row["frelation"].'<br>'.$row["duration"]; ?></td>
						...
						<td align="center"colspan="1" <?php if(new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>><?php echo $row["eqty1"]; ?></td>
...
<input name="eqty1_<?= $id ?>" type="text" value="0" id="eqty1" required <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="dis_medi_phar?sno=<?php echo $sno;?>&pmrn=<?php echo $pmrn;?>&eid=<?php echo $eid;?>"><img src="phar_pic/barcode.png" title="Print Instruction" width="100" height="80" /></a>
