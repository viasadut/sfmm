...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="17%"><strong>Late Time</strong></th>
...
$sel_query="Select * from staff3 where status ='Active' group by dept order by cat asc";
//$start=$row["aadate"];
$count=1;
...
$adate=date('Y-m-d');
$ssid=$row["sid1"];
$query40 = "SELECT * FROM tm3 where uid= '$ssid' and date1='$adate' order by id asc limit 1;"; 
...
?>
	   ...
	   <td align="center"><?php echo $row40['date'];?></td>
	   <td align="center"><?php echo $row40['otime'];?></td>
	  ...
	  <td align="center"><?php if($row40['time']>'00:00:00'){echo '<span style="color:red;text-align:center;"><b>'.$sstime.'<b>';}else if($row40['time']<'00:00:00'){echo '<span style="color:green;text-align:center;"><b>'.$sstime.'<b>';}?></td>
