...
$count=1;
$sel_query="Select * from stat where pmrn= '$pmrn' and eid='$episode'and status='' order by `otime` asc;";
...
<td colspan="2" align="center"><a target='_blank' href="stat1?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
