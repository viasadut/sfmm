...
$sel90="SELECT * FROM other_ins_b WHERE `cname`='$cname' and `user`='$user';";
...
$ins_query1="update other_ins_b set `cdescription`='$cdescription' where cname='$cname' and user='$user'";
...
$ins_query1="insert into other_ins_b (`cname`,`cdescription`,`user`) values ('$cname','$cdescription','$user')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<head>
  <meta charset="UTF-8">
  <title>Add Other Instruction | PMS</title>
   <link rel="icon" href=
"pms_logo_new1.png"
        type="image/x-icon" />
...
<!-- Form Title -->
		<h1>ADD Other Instruction(Bangla)</h1>
...
<td colspan="15" align="center">
                                       ...
                                       <textarea id="cdescription" name="cdescription" class="form-control" placeholder="Description"></textarea>
