...
$pdf->Cell(50,5,$unit,0,0);
	...
	$pdf->MultiCell($cellWidth,$cellHeight,$cr,0,1);
...
$pdf->SetFont('Times', 'B', 12);
$pdf->Ln(10);
$pdf->Cell(100,5,'Interpretation- '.$data->room1,0,1);
...
lab_render_approval_footer($pdf, $db, 'IMMUNOLOGY/SEROLOGY', (isset($data->resultby)?$data->resultby:''), (isset($data->checked_by)?$data->checked_by:''), (isset($data->conby)?$data->conby:''));
$pdf->Ln(10);
