...
$sel_query="Select * from injury where pmrn= '$pmrn' order by id desc;";}
 $count=1;	 
...
{ ?>    <tr>
      ...
      <td colspan="2"align="center"><?php echo $row["idate"]; ?></td>
	  ...
	  '<a target="_blank" href="injuryeditprint.php?id='.$id.'&pmrn='.$pmrn.'"><img src="print.png" title="Print Report" width="50" height="40" /></a>';}
