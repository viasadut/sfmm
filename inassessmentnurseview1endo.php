...
$query43 = "SELECT COUNT(pmrn) FROM endopapp where pmrn= '$pmrn';"; 
...
$query22 = "SELECT * from friskendo where pmrn='$pmrn' and eid='$eid'"; 
...
$update="update nurseassessendo set cname='$cname',crelation='$crelation',cphone='$cphone', astime='$astime', ma='$ma', acc='$acc', shistory='$shistory', language='$language', nip='$nip', edus='$edus', comor='$comor', valueableb='$valueableb', bodys='$bodys', du='$du', remarks='$remarks' where eid='$eid' and pmrn='$pmrn'";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessmentnurseendo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessmentnurseviewendo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
