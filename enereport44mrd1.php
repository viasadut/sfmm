...
$query43 = "SELECT COUNT(discharge) FROM emergency where adate2 BETWEEN '$start' and '$end' and discharge IN ('discharged','Admitted');"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query443 = "SELECT COUNT(discharge) FROM emergency where adate2 BETWEEN '$start' and '$end' and discharge IN ('discharged','Admitted');"; 
	 
$result443 = mysqli_query($con, $query443) or die(mysqli_error());
$row443 = mysqli_fetch_assoc($result443);

$query543 = "SELECT COUNT(discharge) FROM emergency where adate2 BETWEEN '$start' and '$end' and discharge IN ('discharged','Admitted');"; 
...
<h1 align="center">Emergency Patient Report</h1>
...
$count=1;
$sel_query="Select * from emergency where adate2 BETWEEN '$start' and '$end' and discharge IN ('discharged','Admitted') order by adate1 asc";
