...
$bbno='20210129100';  
$query6b = mysqli_query($db,"select * from bcross1 where bagno='$bbno'");
...
$hbs=$_REQUEST['hbs'];
$hcv=$_REQUEST['hcv'];
$antia=$_REQUEST['antia'];
$antib=$_REQUEST['antib'];
$antiab=$_REQUEST['antiab'];
$acell=$_REQUEST['acell'];
$bcell=$_REQUEST['bcell'];
$ocell=$_REQUEST['ocell'];
$rhd=$_REQUEST['rhd'];
...
'Plasmodium Falciparrum Ag(HRP-II P. Falciparrum):'.$plas."<br />".'Plasmodium Vivax Ag(Specific pLDH P. Vivax):'.$plas1."<br />".'HBs Antigen:'.$hbs."<br />".'Anti-HCV:'.$hcv;
if($antia=='+' and $antib=='-' and $antiab=='+' and $acell=='-' and $bcell=='+' and $ocell=='-')
{

$ins_query1="insert into bcross (`pname`,`pmrn`,`pphone`,`psex`,`page`,`haemo`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`antia`,`antib`,`antiab`,`acell`,`bcell`,`ocell`,`group1`,`rhd`,`btype`,`bqty`,`ppmrn`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate','$eid','$iname','$id','$sno','$antia','$antib','$antiab','$acell','$bcell','$ocell','A','$rhd','$btype','$bqty','$ppmrn')";
...
else if($antia=='-' and $antib=='+' and $antiab=='+' and $acell=='+' and $bcell=='-' and $ocell=='-')
{

$ins_query1="insert into bcross (`pname`,`pmrn`,`pphone`,`psex`,`page`,`haemo`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`antia`,`antib`,`antiab`,`acell`,`bcell`,`ocell`,`group1`,`rhd`,`btype`,`bqty`,`ppmrn`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate','$eid','$iname','$id','$sno','$antia','$antib','$antiab','$acell','$bcell','$ocell','B','$rhd','$btype','$bqty','$ppmrn')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross (`pname`,`pmrn`,`pphone`,`psex`,`page`,`haemo`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`antia`,`antib`,`antiab`,`acell`,`bcell`,`ocell`,`group1`,`rhd`,`btype`,`bqty`,`ppmrn`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate','$eid','$iname','$id','$sno','$antia','$antib','$antiab','$acell','$bcell','$ocell','O','$rhd','$btype','$bqty','$ppmrn')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into bcross (`pname`,`pmrn`,`pphone`,`psex`,`page`,`haemo`,`abo`,`vdrl`,`rhe`,`hiv`,`plas`,`plas1`,`hbs`,`hcv`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`antia`,`antib`,`antiab`,`acell`,`bcell`,`ocell`,`group1`,`rhd`,`btype`,`bqty`,`ppmrn`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$abo','$vdrl','$rhe','$hiv','$plas','$plas1','$hbs','$hcv','$user','$adate','$eid','$iname','$id','$sno','$antia','$antib','$antiab','$acell','$bcell','$ocell','AB','$rhd','$btype','$bqty','$ppmrn')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<label for="age"><strong>Component Quantity:</strong></label>
	 ...
	 <input name="bqty" type="text" size="13"value="<?php echo $data2b['bqty'];?>" required>
	  ...
	  <option value="<?php echo $data2b['rhe'];?>"selected><?php echo $data2b['rhe'];?></option>
...
<option value="<?php echo $data2b['vdrl'];?>"selected><?php echo $data2b['vdrl'];?></option>

</select>
	  <label for="age"><strong>HIV I/II Antigen/Antibodies:</strong></label>
      <select name="hiv" value=''required>

<option value="<?php echo $data2b['hiv'];?>"selected><?php echo $data2b['hiv'];?></option>

</select>
	  <label for="age"><strong>Plasmodium Falciparum Ag(HRP-II P. Falciparum):</strong></label>
      <select name="plas" value=''required>

<option value="<?php echo $data2b['plas'];?>"selected><?php echo $data2b['plas'];?></option>
...
<option value="<?php echo $data2b['plas1'];?>"selected><?php echo $data2b['plas1'];?></option>

</select>
	  <label for="age"><strong>HBS Antigen:</strong></label>
      <select name="hbs" value=''required>

<option value="<?php echo $data2b['hbs'];?>"selected><?php echo $data2b['hbs'];?></option>
...
<option value="<?php echo $data2b['hcv'];?>"selected><?php echo $data2b['hcv'];?></option>
	  
</select>
	 
<br><br>
<label for="age"><strong>Blood Grouping</strong></label>	 
	  <br>
	  <br>
	  
	  	  <label for="age"><strong>Anti-A:</strong></label>
       <select name="antia" value=''required>
<option value="">--Select--</option>
	  <option value="+">+</option>
<option value="-">-</option>
</select>
	  
	  <label for="age"><strong>Anti-B:</strong></label>
      <select name="antib" value=''required>
<option value="">--Select--</option>
	  <option value="+">+</option>
<option value="-">-</option>
</select>
	  
	  <label for="age"><strong>Anti-AB:</strong></label>
      <select name="antiab" value=''required>
<option value="">--Select--</option>
	  <option value="+">+</option>
<option value="-">-</option>
</select>
	  
	  <label for="age"><strong>A Cells:</strong></label>
      <select name="acell" value=''required>
<option value="">--Select--</option>
	  <option value="+">+</option>
<option value="-">-</option>
</select>
	  
	  <label for="age"><strong>B Cells:</strong></label>
      <select name="bcell" value=''required>
<option value="">--Select--</option>
	  <option value="+">+</option>
<option value="-">-</option>
</select>
	  
	  <label for="age"><strong>O Cells:</strong></label>
	  
      <select name="ocell" value=''required>
<option value="">--Select--</option>
	  <option value="+">+</option>
<option value="-">-</option>
</select>
      ...
      <select name="rhd" value=''required>
<option value="">--Select--</option>
