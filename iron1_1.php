...
$ins_query1="insert into iron (`pname`,`pmrn`,`psex`,`page`,`iron`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$psex','$page','$iron','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
      ...
      <input name="iron" type="text" size="70" style="text-transform:uppercase" value=""required>
