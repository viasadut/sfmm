...
$sel96="SELECT * FROM medi_stock WHERE `code`='$mcode' and add_qty>0 and location='Pharmacy' and `exdate`>'$ex_date' order by id asc limit 1;";
...
$ins_query4="update medi_stock set `add_qty`='$m_qty1' where code='$mcode' and location='Pharmacy' and id='$medi_id'";
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="1"><?php echo $row["ortime"]; ?></td>
	  ...
	  <?php
	  $mcode = $row['code'];
	  $sum = "SELECT SUM(add_qty) FROM medi_stock where code='$mcode' and location='Pharmacy' and `exdate`>'$ex_date'" ;
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="1"><?php echo $row1["ortime"]; ?></td>
	  ...
	  <?php
	  $mcode1 = $row1['code'];
	  $sum1 = "SELECT SUM(add_qty) FROM medi_stock where code='$mcode1' and location='Pharmacy' and `exdate`>'$ex_date'" ;
