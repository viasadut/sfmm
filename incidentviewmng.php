...
$queryin = "SELECT COUNT(id) FROM incident1 where status='Forwarded' and com3 !='' and com4 !='' and com5!='' and chaircom!='' and itype='Clinical'"; 
...
<td colspan="5"align="left"><a href="incidentview"><font size="4.5">Incident Request</a>
	<?php if($fullname=='ceo')
	{
	echo '<font size="4.5" color="#FF0000"><b>(
	'.$cin2.')<b>';
	}
...
<tr>	<td colspan="20"align="left"><a href="incidentviewstaff12"><font size="4.5">Closed Incident Report</a></td></tr>'
