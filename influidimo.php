...
<td colspan="2" align="center"><input list="rr2" name="rr2"  class="form-control" required>
  <datalist id="rr2">
<option value=''>-Select-</option>
			  ...
			  <td colspan="6" align="center"><input list="rr3" name="rr3"  class="form-control">
  <datalist id="rr3">
<option value=''>-Select-</option>
...
<td colspan="6" align="center"><input list="rr5" name="rr5"  class="form-control">
  <datalist id="rr5">
<option value=''>-Select-</option>
...
<tr><td colspan="20"align="right"font size="8.5" color="Lightgreen"><strong><a target='_blank' href="influiddoctestimo.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Summary&nbsp;&nbsp;<a target='_blank' href="fluidstat?pmrn=<?php echo "$pmrn";?>&eid=<?php echo "$eid"; ?>">Datewise Stats</a></td></tr>
<tr>
