...
$sel_query="Select * from histo where pphone= '$pmrn'and dname='$full' order by date desc;";}
 else{
	 $sel_query="Select * from histo where pmrn= '$pmrn' and dname='$full'order by date desc;";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  <td colspan="10"><a target='_blank' href="historeqreprint?id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
      </tr>
