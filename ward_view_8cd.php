...
function showUser() {
  ...
  xmlhttp.open("GET","ward_view_8cd_data_test.php",true);
  xmlhttp.send();
}
...
<?php  
	   ...
	   <tr>
		...
		<img src='kpj_logo/1.png' style='width:30px;height:30px;'>&nbsp;&nbsp;KPJ SPECIALIZED HOSPITAL
...
<div id="txtHint" ><b>Please Wait Patient List is Loading...</b></div>
