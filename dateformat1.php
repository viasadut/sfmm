...
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date10','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime')";
