...
//$query="update imedi3 set `instruc`='$instruc',`root`='$root',`dilu`='$dilu',`editby`='$user',`edittime`='$dtime' where `pmrn`='$pmrn' and `eid`='$eid' and infusion='$infu' and status1!='SEEN'";
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`brand`,`pmrn`,`eid`,`rfid`,`status`,`location`,`code`,`iidd`) values
			('$g_name','1','$u_price','$u_price','$user','$adate','$bb_name','$pmrn','$eid','$dilu','Sale','IPD STOCK','$code','$id')";
