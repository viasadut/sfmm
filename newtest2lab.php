...
values ('$dname', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','$price','$code','$link','$date77','$linkv','$report','$reportv','OPD','$bdate','$psex','$subtype','$pphone')";
...
<div id='cssmenu'>
<ul>
   <li><a href='manualesearchlab.php'><span>Home</span></a></li>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
		...
		$url = "deletelab_bill?pmrn=$pmrn&id=$id1&ID=$id"; 
