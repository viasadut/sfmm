...
$query = "SELECT * from endopapp where eid='$eeid' and pmrn='$pmrn'"; 
...
values ('$dname','$date1', '$time','$pmrn','$pname','$pphone','$page','$psex','$instruction','$count1','NOT SEEN','Not Confirm','$eeid','Endoscopy')";
