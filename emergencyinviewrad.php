...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><a href="edocgcs21?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Patient Triage<b></a></td></tr>
...
$count=1;
$sel_query100="Select * from ennote where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
$count=1;
$sel_query101="Select * from ecnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query102="Select * from enprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query103="Select * from edprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query104="Select * from einfusion where pmrn= '$pmrn'and eid='$episode' order by `ddate` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query105="Select * from estat where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from emedi2 where pmrn= '$pmrn' and eid='$eid'order by `time` asc;";
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Remarks</strong></td>   
      <td colspan="4" align="center"><strong>Done Date</strong></td>
	  <td colspan="2" align="center"><strong>R.Time</strong></td>
       	  <td colspan="2" align="center"><strong>R. By</strong></td>
