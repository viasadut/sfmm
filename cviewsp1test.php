...
$sel_query="Select * from pappnew where adate= '$date' and bill='Billed' and status='NOT SEEN' and dname IN ('DR. ABIRVAB NAHA','Dr. Farzana Sultana Borna','Dr. Ho Hon Lian','Dr.Isat-E-Rabban','Ms. Maisha Musharrat Nazia','Ms. Shanti Bormon','Md. Shahid Khan','Mr. K. Utshab Zaman','Physiotherapy','Dr. A.K.M. AKRAMUZZAMAN','Prof. Dr. Pran Gopal Datta','DR.SUVOSHREE DAS') ORDER BY dname asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('DR. ABIRVAB NAHA') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Dr. Farzana Sultana Borna') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Dr. Ho Hon Lian') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Dr.Isat-E-Rabban') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Ms. Maisha Musharrat Nazia') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Physiotherapy') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Dr. A.K.M. AKRAMUZZAMAN') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('Prof. Dr. Pran Gopal Datta') ORDER BY vtime asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED')and dname IN ('DR.SUVOSHREE DAS') ORDER BY vtime asc;";
