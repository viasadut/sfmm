...
$data = array(
  ...
  "IN_ACCOMPANIED_BY"=> "Family",
  "IN_CAUSE_OF_ADMISSION"=> "Chest pain",
  "IN_CONTACT_PERSON"=> "Jane Doe",
  "IN_CONTACT_PERSON_MOBILE"=> "01712345678",
  "IN_CONTACT_RELATION"=> "Wife",
  "IN_WARD_NO_FK"=> "$ward",
...
$adm_id=$decoded_response['OUT_ADMISSION_NO_PK'];
 ...
 header("Location:insummary_api_2");
 }
