...
$full = $row39['fullname'];
//$rr=date(strtotime)
$rr=date('Y-m-d', strtotime('-1 days') );
$rr1=date('Y-m-d');
?>
<!DOCTYPE html>
<html>
...
<form action="donereportedit" method="POST">
...
$count=1;
$sel_query="Select * from radreport where pmrn= '$pmrn' and status!= 'confirmed' order by ID desc;";
