...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Applied On</strong>   
      <th width="14%"><strong>Approved On</strong>
...
$date= date('Y-m-d');
$count=1;
$sel_query="Select * from conleavedetails where status='Approved By ALL' order by appdate desc";
//$start=$row["aadate"];
