...
$eqty5 = $_POST['eqty2_'.$updateid];
			...
			$strSQL = "update medi_stock set given_qty='".$eqty5."' where id='".$updateid."'";
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Brand Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from medi_stock where add_qty>0 and status NOT IN ('Pending','Rejected') and id between '37401' and '37500'";
...
<td align="center"colspan="1"><?php echo $row['given_qty'];?></td>					

<td align="center"colspan="1"><input name="eqty2_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row['add_qty'];?>" readonly ></td>
