...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eid' and status='Data Updated' and type='lab' order by `id` DESC;";
...
<td colspan="2" align="center"><a href="emerlab2?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong></strong></a></td>	    	  
<td colspan="2" align="center"><a onclick="return confirm_click();" href="labresult1emer?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&user=<?php echo "$user"; ?>"><strong>RECEIVE</strong></a></td>
<td colspan="2" align="center"><a href="labreject1emer?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>REJECT</strong></a></td>	  
	...
	<tr><td colspan="10"><a target='_blank' href="peinves.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>	
