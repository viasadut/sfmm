...
$query159 = mysqli_query($db,"select dcode from disposable where disname='$infu'");
$data159 = mysqli_fetch_assoc($query159);
$dcode=$data159["dcode"];

$sel90="SELECT * FROM disposable WHERE `disname`='$infu';";
...
$ins_query="insert into edisposible (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`dcode`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated','$dcode')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Disposible Item</strong></label></td> </tr>
<tr>


<td colspan="16" align="center"><label><strong>Disposible Item Name</strong></label></td> 
<td colspan="16" align="center"><label><strong>Qty</strong></label></td> 
</tr>
<tr>

<td colspan="16" align="center"><input list="rr" name="infu" size=60% class="form-control" autocomplete='off'>
  <datalist id="rr">
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="2"><a href="endisposabledelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td> 
