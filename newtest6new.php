...
$update333="update presnew set `cdetails`='$cdetails',`diagnosis`='$diagnosis',`other`='$other',`pdiet`='$pdiet',`pdiet2`='$pdiet2',`pdiet3`='$pdiet3',`pdiet4`='$pdiet4',`pdiet5`='$pdiet5',`pdiet6`='$pdiet6',`pdiet7`='$pdiet7',`reffer`='$reffer',`reffer2`='$reffer2',`reffer3`='$reffer3',`reffer4`='$reffer4',`reffer5`='$reffer5',`reffer6`='$reffer6'where `pmrn`='$pmrn' and `eid`='$eid'";
mysqli_query($con,$update333) or die("Problem in Update presnew");
...
<tr>
<td colspan="7"><input type="text" name="pperiod1" placeholder="Remarks" value="<?php echo $row['pperiod1'];?>" /></td>
<td colspan="7"><input type="text" name="plmp1" placeholder="Remarks" value="<?php echo $row['plmp1'];?>" /></td>
<td colspan="6"><input type="text" name="clist1" placeholder="Remarks" value="<?php echo $row['clist1'];?>" /></td>
</tr>
...
<td colspan="5"><input type="text" name="para1" placeholder="Remarks" value="<?php echo $row['para1'];?>" /></td>
<td colspan="5"><input type="text" name="gravida1" placeholder="Remarks" value="<?php echo $row['gravida1'];?>" /></td>
<td colspan="5"><input type="text" name="plchild1" placeholder="Remarks" value="<?php echo $row['plchild1'];?>" /></td>
<td colspan="5"><input type="text" name="pnochild1" placeholder="Remarks" value="<?php echo $row['pnochild1'];?>" /></td>
</tr>
...
<tr><td colspan="20" bgcolor="lightgreen"><h3><a target='_blank' href="vacine?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Vaccine History</a>&nbsp;&nbsp;<a target='_blank' href="bhistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Birth History</a>&nbsp;&nbsp;<a target='_blank' href="pasthistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Past History</a>&nbsp;&nbsp;<a target='_blank' href="comordoc?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Comorbidities</a></td></tr>					
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="cdetails" rows="5" required><?php echo $row49["cdetails"]; ?></textarea></td>  </tr>
						 
						 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="diagnosis" rows="5"required><?php echo $row49["diagnosis"]; ?></textarea></td>  </tr>
...
<tr><td align="left" colspan="3"><a target='_blank' href="newtest7?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&eid=<?php echo "$eid"?>"><img src="test1.jpg" title="test" width="130" height="90" /></a></td><td align="left" colspan="3"><a target='_blank' href="newtest8?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&eid=<?php echo "$eid"?>"><img src="medicine1.jpg" title="medicine" width="130" height="90" /></a></td></tr>
...
<tr><td colspan="20"><input list=diet1 name="pdiet" placeholder="Select Diet" class="form-control" value="<?php echo $row49["pdiet"]; ?>">
					<datalist id="diet1">	
						...
						<option value='<?php echo $row49["pdiet"]; ?>'selected><?php echo $row49["pdiet"]; ?></option>
				 <?php 
