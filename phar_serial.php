...
$cdate=date('Y-m-d');
    ...
    //$strSQL1 = "select DISTINCT MAX(queue) from pms_bill where date='$cdate'";
	$strSQL1 = "select MAX(queue) from pms_bill where date='$cdate'";
...
<input type="hidden" name="queue" value="<?php echo $host;?>">
