...
$pdf->Cell('182',5,'TRIAGE SUMMARY',1,1,'L');
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('122' , 5,$data12['pd'],1,1);
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data1['dcode'].' - '.$data1['infusion'],1,1);
...
$pdf->ln(1);
$query1 = mysqli_query($db,"Select * from emergency where discharge IN ('discharged','Admitted') and ddate1 BETWEEN '01/01/2019' and '01/31/2019' order by discharge asc");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data1['pmrn'],1,1);
