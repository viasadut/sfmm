...
if($res=mysqli_num_rows($result)>0)
{
    ...
    echo '</script>';
		...
		$sql = "INSERT INTO staff1 (image,sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave) VALUES 
		('".$image_name."','".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday1."')";
		//$mysqli->query($sql);
	...
	$sql3 = "INSERT INTO user (uname,upass,utype,fullname,status) VALUES 
		...
		mysqli_query($con,$sql3) or die(mysql_error());}
			...
			$sql = "INSERT INTO staff1 (image,sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave) VALUES 
		('".$image_name."','".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday2."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
...
if($tt==$doj70){
		$sql = "INSERT INTO staff1 (sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave) VALUES 
		('".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday1."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
...
$sql = "INSERT INTO staff1 (sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave) VALUES 
		('".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday2."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
...
<h1 align="center">Staff Registration Panel</h1>
