<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','billin','bill','doctor')"; 
...
$episode=$data["eid"];
$count=1;
$sel_query104="Select * from iinfusion where pmrn= '$pmrn'and eid='$episode' and status='implemented' order by `ddate` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="4"><?php echo $row104["duser"]; ?></td>
		...
		<td align="center"colspan="2"><?php echo $row104["uprice"]; ?></td>
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="4"><?php echo $row["uprice"]; ?></td>
...
<tr>
      ...
      <td colspan="3" align="center"><strong>Received Time</strong></td>
...
<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Grand Total is:<?php echo $test1c+$test1+$test1as+$test1a1+$test1al+$test1ai+$test1am+$test1c_bed;?> (BDT)</strong></td></tr>	
</table>
</form>
</body>
