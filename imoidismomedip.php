...
$ins_query="insert into alltest (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`date`,`status`,`otime`,`oby`) values ('$full', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','$date','Active','$otime','$user')";
...
$ins_query1="insert into idismedi (`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`,`brand`) values ('$pmrn','$pname','$medi1','$pdos','$eid','$date1','$brand2')";
mysqli_query($con,$ins_query1) or die(mysqli_error());}
}
?>
<?php
/*
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Discharge Medication List</strong></label></td> </tr>

<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
     
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="6" align="center"><strong>Medicine Name</strong></td>
      	  <td colspan="4" align="center"><strong>Dosage</strong></td>
		  <td colspan="4" align="center"><strong>Duration</strong></td>
		  <td colspan="3" align="center"><strong>Food Relation</strong></td>
...
$count=1;
$sel_query="Select * from idismedi where pmrn= '$pmrn' and eid='$eid' and status='Active' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        	        <td align="center"colspan="6"><?php echo $row["brand"].' ('.$row["medi"].')'; ?></td>
			      <td align="center"colspan="4"><?php echo $row["pdos"]; ?></td>
				  <td align="center"colspan="4"><?php echo $row["duration"]; ?></td>
				  			      <td align="center"colspan="3"><?php echo $row["frelation"]; ?></td>
