...
$query = mysqli_query($db,"select * from bcross where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'BLOOD DONOR PROFILE',0,1,'L');
...
$pdf->Cell('100',5,'HBs Antigen',1,0,'L');
$pdf->Cell('30',5,$data['hbs'],1,0,'C');
$pdf->Cell('21',5,'',1,0,'C');
$pdf->Cell('30',5,'',1,1,'C');

$pdf->Cell('100',5,'Anti-HCV',1,0,'L');
