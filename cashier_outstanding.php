...
$sel_query="Select * from pms_bill where date between '$billdate' and '$billdate1' and amount>(amount_receive+dis_amount) and dname !='IPD ADVANCE' and amount!='0' and user= '$billuser'";
