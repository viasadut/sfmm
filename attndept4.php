...
$dt1=date('Y', strtotime("$start"));
$dt2=date('m', strtotime("$start"));
$dt3=date('d', strtotime("$start"));

$d11=date_create("$dt1-$dt2-01");
$d1=date_format($d11,'Y-m-d');

$d12=date_create("$dt1-$dt2-02");
$d2=date_format($d12,'Y-m-d');

$d13=date_create("$dt1-$dt2-03");
$d3=date_format($d13,'Y-m-d');

$d14=date_create("$dt1-$dt2-04");
$d4=date_format($d14,'Y-m-d');

$d15=date_create("$dt1-$dt2-05");
$d5=date_format($d15,'Y-m-d');

$d16=date_create("$dt1-$dt2-06");
$d6=date_format($d16,'Y-m-d');

$d17=date_create("$dt1-$dt2-07");
$d7=date_format($d17,'Y-m-d');

$d18=date_create("$dt1-$dt2-08");
$d8=date_format($d18,'Y-m-d');

$d19=date_create("$dt1-$dt2-09");
$d9=date_format($d19,'Y-m-d');

$d119=date_create("$dt1-$dt2-10");
$d10=date_format($d119,'Y-m-d');

$d120=date_create("$dt1-$dt2-11");
$d11=date_format($d120,'Y-m-d');


$d121=date_create("$dt1-$dt2-12");
$d12=date_format($d121,'Y-m-d');

$d122=date_create("$dt1-$dt2-13");
$d13=date_format($d122,'Y-m-d');

$d123=date_create("$dt1-$dt2-14");
$d14=date_format($d123,'Y-m-d');

$d124=date_create("$dt1-$dt2-15");
$d15=date_format($d124,'Y-m-d');

$d125=date_create("$dt1-$dt2-16");
$d16=date_format($d125,'Y-m-d');

$d126=date_create("$dt1-$dt2-17");
$d17=date_format($d126,'Y-m-d');

$d127=date_create("$dt1-$dt2-18");
$d18=date_format($d127,'Y-m-d');

$d128=date_create("$dt1-$dt2-19");
$d19=date_format($d128,'Y-m-d');

$d129=date_create("$dt1-$dt2-20");
$d20=date_format($d129,'Y-m-d');

$d130=date_create("$dt1-$dt2-21");
$d21=date_format($d130,'Y-m-d');

$d131=date_create("$dt1-$dt2-22");
$d22=date_format($d131,'Y-m-d');


$d132=date_create("$dt1-$dt2-23");
$d23=date_format($d132,'Y-m-d');

$d133=date_create("$dt1-$dt2-24");
$d24=date_format($d133,'Y-m-d');

$d134=date_create("$dt1-$dt2-25");
$d25=date_format($d134,'Y-m-d');

$d135=date_create("$dt1-$dt2-26");
$d26=date_format($d135,'Y-m-d');

$d136=date_create("$dt1-$dt2-27");
$d27=date_format($d136,'Y-m-d');

$d137=date_create("$dt1-$dt2-28");
$d28=date_format($d137,'Y-m-d');

$d138=date_create("$dt1-$dt2-29");
$d29=date_format($d138,'Y-m-d');
...
$d138=date_create("$dt1-$dt2-30");
$d30=date_format($d138,'Y-m-d');

$d139=date_create("$dt1-$dt2-31");
$d31=date_format($d139,'Y-m-d');
...
$s1e="Select * from calendar where date between'$start' and '$end'";
$r1e = mysqli_query($con, $s1e) or die(mysqli_error());
$row1e = mysqli_fetch_array($r1e);
$n1e=$row1e['COUNT(distinct(uid))'];
...
$s31="Select COUNT(distinct(uid)),status from tm where date1='$d31' and uid='$uuid'";
