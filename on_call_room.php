...
<p align="center" class="style1">Oncall Room Management</p> 
...
$count=1;	
$sel_query="Select * from oncall_room where status in ('AVAILABLE','BOOKED') order by status asc";	
...
if ($rows!=0)
{
	...
	<p><h1 style="color:red;font-size:40px;text-align:left"><blink>Oncall Room</blink></h1></P>	  
...
$url1 = "oncall_room_edit?id=$id"; 
$url = "oncall_room_details1?id=$id"; 
$url_b = "oncall_room_edit_bill?id=$id"; 
$pmrn=$row['pmrn'];
...
{
$query43 = "SELECT * FROM oncall_details where rname='$rname' and status='Staying';"; 
