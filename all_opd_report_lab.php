...
$query7 = mysqli_query($db,"Select * from alltest where pmrn='$pmrn' order by id desc;");
...
$eeid=$data7['emerid'];
            ...
            $output = "";
				 ...
				 $output .='
                            <table width="100%">';
                $query11 = mysqli_query($con,"Select * from alltest where pmrn='$pmrn'  and type in ('lab','LAB','Lab') and status='RECEIVED'order by date1 desc");
                $count=1;
                while ($data111 = mysqli_fetch_array($query11)) {
                    $output .='
                            <tr>
                                <td style="font-family: freesans; font-size: 15px;"><b>'.$count.'. '.$data111['medi'].' ('.$data111['barcode'].' / '.$data111['date1'].' )</b>
			...
			$mpdf->SetHTMLHeader('
                ...
                <table style="border: 1px solid black" width="100%">
                    <tr>
                        ...
                        <td style="font-family: freesans; font-size:15px;"><b>GENDER :</b>'.$data7['psex'].'</td>
                        <td style="font-family: freesans; font-size:15px;"><b>AGE :</b>'.$data7['page'].'</td>
                    </tr>
                </table>
