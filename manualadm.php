...
('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','OPD','$date6','$staff','pending','$snew','$btype','$sid','$approx_amount')";
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`sid`,`approx_amount`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','OPD','$date6','$staff','pending','$snew','$btype','$sid','$approx_amount')";
mysqli_query($con,$ins_query);
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`approx_amount`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','OPD','$date6','$staff','Approved','$snew','$btype','$approx_amount')";
mysqli_query($con,$ins_query);
...
('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','OPD','$date6','$staff','Approved','$snew','$btype','$approx_amount')";
mysqli_query($con,$ins_query);
    ...
    <?php if($data59['remarks']=='Due'){echo'<strong><SPAN STYLE="font-size:18.0pt;color:red;">PAYMENT DUE</span> </strong>';}
      ...
      ?>
        ...
        <fieldset>
			...
			<select name="doc" required class="js-example-basic-single">
...
<td colspan="10">		<a target='_blank' href="admdoc_m?pmrn=<?php echo "$pmrn"; ?>&rdate=<?php echo $date6;?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>
