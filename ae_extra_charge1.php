...
$query3 = "SELECT * FROM ae_extra_charge where pmrn= '$pmrn' and eid='$eid' and date='$date1' and medi='$medi1'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM ae_extra_charge where pmrn= '$pmrn' and eid='$eid' and date='$date1'and medi='$medi1'"; 
...
if($user!=''){
$ins_query1="insert into ae_extra_charge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`,`qty`) values 
...
$count=1;
$sel_query="Select * from ae_extra_charge where pmrn= '$pmrn' and eid='$eid' and delete_status='0' order by `date` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
			...
			<td align="center"colspan="5"><?php echo $row["date"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="other_charge_delete_ae?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
