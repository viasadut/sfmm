...
font-size:30px;
  ...
  text-align: left;
  width:650px; /* or whatever width you want. */
...
$date_y=date('Y');
$count=1;	
$sel_query="Select * from roaster where date between '$date_n' and '$date_n1' order by id asc";	
...
<span class='font2'>".date('d/m/Y', strtotime($row["date"]))."<br><br>
<span class='font2' style='color:red;'>On Call Consultant:</span><br><br>
...
<span class='font2' style='color:red;'>Medical Officer:</span><br><br>
<span class='font1'>Morning: </span><br><br>
<span class='font1'>Late: </span><br><br>
<span class='font1'>Night: </span><br><br>
...
<span class='font2' style='color:red;'>Nursing (5A & 5B):</span><br><br>
<span class='font1'>Morning: ".$row["ln1"]."</span><br><br>
<span class='font1'>Late: ".$row["ln1_1"]."</span><br><br>
<span class='font1'>Night: ".$row["ln1_2"]."</span><br><br>


<span class='font2' style='color:red;'>Nursing (5C & 5D):</span><br><br>
<span class='font1'>Morning: ".$row["ln2"]."</span><br><br>
<span class='font1'>Late: ".$row["ln2_1"]."</span><br><br>
<span class='font1'>Night: ".$row["ln2_2"]."</span><br><br>
