...
$query43 = "SELECT COUNT(pmrn) FROM dietass where assdate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Diet Assessment Datewise Stats</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>Patient Name</strong></th>
      <th width="15%"><strong>Admission Date </strong>
      <th width="14%"><strong>Assessment Time</strong>   
      <th width="14%"><strong>Assessment By</strong>
      <th width="14%"><strong>Ward/Cabin</strong>
...
$sel_query="Select * from dietass where assdate BETWEEN '$start' and '$end'order by adate";
