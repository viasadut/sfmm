...
$count=1;
$query1 = mysqli_query($db,"select * from bcross1 where sno='$sno'");
...
$pdf->Cell('45',5,$data1['btype'],1,0,'L');
$pdf->Cell('50',5,$data1['abo'].' / '.$data1['bagno'],1,0,'C');
$pdf->Cell('15',5,$data1['sal'],1,0,'C');
$pdf->Cell('15',5,$data1['cc'],1,0,'C');
$pdf->Cell('15',5,$data1['alb'],1,0,'C');
$pdf->Cell('15',5,$data1['ahg'],1,0,'C');
$pdf->Cell('25',5,$data1['result'],1,1,'C');
$count++;
}
