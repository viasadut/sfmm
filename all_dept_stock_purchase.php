...
$sel_query="Select * from purchase_stock3 where location='$start' and status!='Pending' ORDER BY id desc;";
...
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["batch_no"]; ?></td>
	  ...
	  <td align="left" ><a target='_blank' href="department_bar_purchase.php?id=<?php echo $row['id']; ?>">bar_print</a></td>
