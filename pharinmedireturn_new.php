...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
						...
						$sel99="SELECT * FROM imedi3 WHERE `id`='".$_POST["chkDel"][$i]."'";
...
$sel96="SELECT * FROM medi_stock WHERE `rfid`='$rfid' and location='Pharmacy' order by id asc limit 1;";
...
$m_id=$b_chk_m['id'];
			...
			*/
			...
			$query13="update phar_sale set `status`='Cancel' where `rfid`='$rfid' and pmrn='$pmrn' and eid='$eid' and iidd='$iidd'";
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and status in ('Cancel','Active') and status1 in('Rupdated','Cancel') and pstatus='Served' order by `infusion` asc;";
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="1"><?php echo $row["ortime"]; ?></td>
	  <td align="center"colspan="1"><?php echo date('d/m/Y',strtotime($row["odate"])); ?></td>
...
<?php
 $count++;}
?>
<tr><td colspan="15"><a target='_blank' href="returnmedi.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
...
<tr><td colspan="5"><a target='_blank' href="testpdfpharreturn.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr>	 
</table>
