...
$ins_query="insert into procedure1 (`dname`,`pname`,`pmrn`,`pphone`,`page`,`psex`,`pdate`,`ptime`,`proname`,`type`) values 
('$dname', '$pname','$pmrn','$pphone','$page','$psex','$pdate','$ptime','$proname','OPD')";
