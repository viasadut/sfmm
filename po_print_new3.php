...
<div class="container">
    <div class="row">
     ...
     $ono=$_REQUEST['ono'];
           ...
           $query = mysqli_query($con,"select * from po_table1 where po_id='$ono'");
           //$data = mysqli_fetch_array($query);
		  
           $query22 = mysqli_query($con,"select * from po_table where id='$ono'");
...
$sid=$data22['issue_person'];
        ...
        $query222 = mysqli_query($con,"select * from suppliers_master where supplier_code='$sup_name'");
		   ...
		   $query2 = mysqli_query($con,"select SUM(t_price) from purchase_stock where po_id='$ono'");
           $data2 = mysqli_fetch_array($query2);
			
    	    $query3 = mysqli_query($con,"select * from purchase_stock where po_id='$ono'");
           ...
           $queryz = mysqli_query($con,"select SUM(tprice) from po_table1 where po_id='$ono'");
		...
		$final_price=$dataz['SUM(tprice)']-$data22['amount_discount'];	
            ...
            if(mysqli_fetch_array($query)==false){
                ...
                PO NO-'.$data22['id'].'
                    ...
                    ';
                    $count=1;
					$query15 = mysqli_query($con,"select * from po_table1 where po_id='$ono' order by id asc");
