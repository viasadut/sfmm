<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','lab')"; 
...
$query43 = "SELECT COUNT(id) FROM alltest where billdate BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and medi='$bt' and type in('lab','LAB','Lab');"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(id) FROM iinves where ndate BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and infusion='$bt' and type in('lab','LAB','Lab');"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(id) FROM einves where ndate BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and infusion='$bt' and type in('lab','LAB','Lab');"; 
...
$query43r = "SELECT COUNT(medi) FROM alltest where billdate BETWEEN '$start' and '$end' and type in('lab','LAB','Lab') and rstatus='RECEIVED' and dname !='Outside Referral';"; 
...
$query43rr = "SELECT COUNT(medi) FROM alltest where billdate BETWEEN '$start' and '$end' and type in('lab','LAB','Lab') and rstatus='RECEIVED' and dname ='Outside Referral';"; 
	 
$result43rr = mysqli_query($con, $query43rr) or die(mysqli_error());
$row43rr = mysqli_fetch_assoc($result43rr);


$query44r = "SELECT COUNT(infusion) FROM iinves where ndate BETWEEN '$start' and '$end' and type in('lab','LAB','Lab') and rstatus='RECEIVED';"; 
	 
$result44r = mysqli_query($con, $query44r) or die(mysqli_error());
$row44r = mysqli_fetch_assoc($result44r);


$query45r = "SELECT COUNT(infusion) FROM einves where ndate BETWEEN '$start' and '$end' and type in('lab','LAB','Lab') and rstatus='RECEIVED';"; 
...
<h1 align="center">Lab Investigation Done stats</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select End Date:</strong></label></td>	
							...
							<td colspan="3"><label><strong> Select Investigation Name</strong></label></td> 
        ...
        <datalist id="test">
						...
						<?php 
			$sql = "select * from `radio` where status='Active' and type in ('Lab','lab','LAB')";
...
$income=$row43['COUNT(id)'] + $row44['COUNT(id)']+ $row45['COUNT(id)'];
$pay=$income*.05;
...
$sel_query1="Select * from alltest where billdate BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and medi='$bt' and type in('lab','LAB','Lab') order by type asc";
...
{ ?>    <tr>
  ...
  <tr> <td colspan="20"></td> </tr>
	...
	$sel_query2="Select * from iinves where ndate BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and infusion='$bt' and type in('lab','LAB','Lab') order by type asc";
...
{ ?>    <tr>
  ...
  <tr> <td colspan="20"></td> </tr>
	...
	<?php
	$sel_query3="Select * from einves where ndate BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and infusion='$bt' and type in('lab','LAB','Lab') order by type asc";
