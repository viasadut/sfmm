...
$eqty2 = $_POST['eqty1_'.$updateid] - $disco;
			...
			$strSQL = "update einves set dprice='$eqty2', discount='$disco',discount_type='$discount_type',o_dis='$percentage1' where id='".$updateid."'";
...
$query44 = mysqli_query($db,"select SUM(discount) from einves where pmrn='$pmrn' and eid='$eid' and rstatus='RECEIVED'");
$data44= mysqli_fetch_assoc($query44);
$total_dis=$data44['SUM(discount)'];
			
			
			$strSQL1 = "update emergency set lab_dis='$total_dis' where pmrn='".$pmrn."' and eid='".$eid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
...
$eqty2 = $_POST['eqty1_'.$updateid] - $taka;
			...
			$strSQL = "update einves set dprice='$eqty2', discount='$taka', discount_type='$discount_type',o_dis='$taka1' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
			
			$strSQL1 = "update emergency set lab_dis='$taka1' where pmrn='".$pmrn."' and eid='".$eid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eid' and rstatus='RECEIVED' and type in ('LAB','Lab','lab','RAD','Rad','rad') order by `id` DESC;";
...
<input type="number" name="percentage" id="sdate1" class="style1" hidden placeholder="Discount In Percentage" max="10">
...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eid' and dprice>0;";
