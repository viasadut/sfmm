...
$ins_query1="update covidopd set `cp`='$cp',`name`='$name',`psex`='$psex',`page`='$page',`phone`='$phone',`padd`='$padd',`district`='$district',`ward`='$ward',`symptom`='$symptom',`phyper`='$phyper',`pdm`='$pdm',
...
`advice`='$advice',`etime`='$adate1',`email`='$email',`eby`='$user',`sam`='$sam',`tp`='$tp',`desig`='$desig',`dept`='$dept' where id='$id'";
...
<input type="text" name="ward" id="email" class="input-text" placeholder="Ward" size="70"value=""readonly>     
...
<input type="text" name="email" id="email" class="input-text" placeholder="Email" size="70"value=""readonly>     
...
<textarea rows="5" name="pcase" placeholder="Travel History"></textarea>
