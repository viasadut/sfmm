...
$ins_query="insert into enprocedure (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Nurse's Procedure note</strong></label></td> </tr>
<tr>


<td colspan="4" align="center"><label><strong>Procedure Name</strong></label></td> 
<td colspan="16" align="center"><label><strong>Note</strong></label></td> 
</tr>
<tr>

<td colspan="4" align="center"><input list="rr" name="infu" class="form-control">
  <datalist id="rr">

						<option value=''>-Select Procedure</option>
				<?php 
			$sql76 = "select * from `nprocedure`";
			$res76 = mysqli_query($con, $sql76);
			if(mysqli_num_rows($res76) > 0) {
				while($row76 = mysqli_fetch_object($res76)) {
					echo "<option value='".$row76->proname."'>".$row76->proname."</option>";
				}
			}
			?>  </datalist></td>
<td colspan="16" align="center"><textarea id="exampleTextarea2" name="infu1" rows="5" placeholder="Procedure Note"></textarea></td>
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Procedure Notes</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="6" align="center"><strong>Procedure Name</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Date & Time </strong></td>
      
      <td colspan="4" align="center"><strong>Done By</strong></td>
	  <td colspan="2" align="center"><strong>Note</strong></td>
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="2"><a href="nproceduredelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td> 
