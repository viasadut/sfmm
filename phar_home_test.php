...
$query_per = "SELECT COUNT(id) FROM medicine where status='Active' and per_qty<(select SUM(add_qty) from medi_stock where medicine.code=medi_stock.code and location='Pharmacy');"; 
...
<span><img src='phar_pic/return.png' title='Add_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_transfer?sno=<?php echo $runningTime;?>">Request Stock</a></span>
