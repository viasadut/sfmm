...
$query40 = "SELECT * FROM ghouse where id= '$id'"; 
...
if(isset($_POST['Submit']) && !empty($_FILES['test']['name']))
{
...
if(move_uploaded_file($tmp, 'gupload/'.$image_name) ){


/*$ins_query33="insert into gdetails (`gname`,`age`,`sex`,`pphone`,`type`,`fname`,`mname`,`peradd`,`nid`,`service`,`rname`,`tqty`,`remarks`,`adate`,`aadate`,`status`,`aby`,`anew`)
...
//$update199="update ghouse set status='BOOKED' where `rname`='$rname'";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Guest's Details (Gender / Phone / Age) :</strong></label>
	  	<input name="psex" type="text" size="10" value=""required placeholder="Gender">
	  ...
	  <input name="page" type="text" size="2"value="" placeholder="Age" required >
		...
		<br><br>
    <label for="age"><strong>Other Guest 01(if Any) :</strong></label>
		<input name="other1" type="text" size="70" value=""  >
		<label for="age"><strong>Other Guest 02(if Any) :</strong></label>
		<input name="other2" type="text" size="70" value=""  >

		
		<label for="age"><strong>Permanent Address :</strong></label>
		<input name="peradd" type="text" size="70" value=""required  >

    <label for="age"><strong>Nationality:</strong></label>
		<input name="nationality" type="text" size="70" value=""  required>
    ...
    <label for="age"><strong>Passport NO:</strong></label>
		<input name="passno" type="text" size="70" value=""  required>
    ...
    <label for="age"><strong>Email Address:</strong></label>
		<input name="email" type="text" size="70" value=""  required>

    <label for="age"><strong>Emergency Contact No:</strong></label>
		<input name="emergencyno" type="text" size="70" value=""  required>
      
	  
	  <label for="age"><strong>Reference Patient / Staff Name :</strong></label> <br>
	  
    <input name="reference" type="text" size="70" value=""  required>
	  	<br><br>
		
		
		
		<label for="age"><strong>Purpose :</strong></label>
...
<?php
	$stmt = $DB_con->prepare("SELECT distinct rname FROM ghouse where status='AVAILABLE'");
	$stmt->execute();
...
<label for="age"><strong>Upload National ID:</strong></label>
<input type="file" 
