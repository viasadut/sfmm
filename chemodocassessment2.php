...
$query11 = "SELECT * from chemomassess where pmrn= '$pmrn' and eid='$eid'"; 
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="chemoinassessmentdoc1?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessmentdocedit?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
