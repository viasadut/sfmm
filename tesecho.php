...
<p align="center" class="style1">Today's Pending Report Approval </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from echo where datenew between '$test' and '$date' and status1='updated' and dname='$full';";
