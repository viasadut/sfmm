...
$ins_query="insert into estat (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`otime`,`infusion`,`user`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$otime','$infu','$user')";
...
$count=1;
$sel_query="Select * from estat where pmrn= '$pmrn' and eid='$episode'order by `otime` asc;";
