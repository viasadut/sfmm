...
$ins_query="insert into evisit (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`bed`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','$rmode')";
...
<h1 align="center"style="background-color:lightgreen;">Emergency Doctor's Visit </h1>
<!-- Form Title -->
...
<tr><td colspan="12" align="center"bgcolor="lightgreen"><label><strong>Visiting Doctor List</strong></label></td>
<td colspan="4" align="center"bgcolor="lightgreen"><label><strong>Visiting Type</strong></label></td>

<td colspan="4" align="center"bgcolor="lightgreen"><label><strong>Visiting Mode</strong></label></td>
 </tr>

<tr>

<td colspan="12" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
  <datalist id="browsers1">
			...
			?>  </datalist></td>
			<td colspan="4" align="center"><input list="browsers3" name="remarks" size=60% class="form-control">
  <datalist id="browsers3">

						<option value=''>-Select Visit Type</option>
						<option value='Regular Visit'>Regular Visit</option>
						<option value='Emergency Visit'>Emergency Visit</option>
						<option value='After Hour Visit'>After Hour Visit</option>
						<option value='ICU Visit'>ICU Visit</option>
				 </datalist></td>
				 <td colspan="4" align="center"><input list="browsers4" name="rmode" size=60% class="form-control">
  <datalist id="browsers4">

						<option value=''>-Select Visit Mode</option>
						<option value='Opinion'>Opinion</option>
						<option value='Continiuous'>Continiuous</option>
...
<tr>
      ...
      <td colspan="8" align="center"><strong>Entry By</strong></td>
      <td colspan="3" align="center"><strong>Visit Date  </strong></td>
      <td colspan="3" align="center"><strong>Visiting Doctor Name</strong></td>
      <td colspan="2" align="center"><strong>Visit Mode</strong></td>  
