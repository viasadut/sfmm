...
<!-- Form Title -->
		<h2 align="center">DATEWISE BLOCK DOCTOR'S AVAILABLE SLOT</h2>
...
<!-- E-mail Input -->
			<label for="mail"><strong>Appointment Date :</strong></label>
									<input type="text" name="date" id="datepicker" placeholder="Select Date" value="<?php echo $date2;?>" required readonly>
