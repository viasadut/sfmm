<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','cath','outdoc')"; 
...
$update="update alltest set status='SEEN', report='$plaintext',resultstatus='Confirmed By Consultant' where `id`='$lid_opd'";
mysqli_query($con,$update);

$update="update ecg_test set details='$cdetails', con_by='$fullname',con_time='$add_time',charge='$doc_charge' where `id`='$id'";
mysqli_query($con,$update);
...
header('Location: spd_pending_doc_new');
}
...
$update="update iinves set status='SEEN', report='$plaintext', resultstatus='Confirmed By Consultant' where `id`='$lid_opd'";
mysqli_query($con,$update);
...
$update="update einves set status='SEEN', report='$plaintext', resultstatus='Confirmed By Consultant' where `id`='$lid_opd'";
mysqli_query($con,$update);
