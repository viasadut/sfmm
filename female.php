...
$update33="update pappnew set `pperiod`='$pperiod',`plmp`='$plmp',`clist`='$clist',`pperiod1`='$pperiod1',`plmp1`='$plmp1',
`clist1`='$clist1',`para`='$para',`gravida`='$gravida',`plchild`='$plchild',`pnochild`='$pnochild',`para1`='$para1',
`gravida1`='$gravida1',`plchild1`='$plchild1',`pnochild1`='$pnochild1' where `ID`='$id'";
...
<tr><td colspan="20" bgcolor="#00CCCC"><label class="blink"><strong>For Female :</strong></label></td></tr>
