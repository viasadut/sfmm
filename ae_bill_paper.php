...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(id) FROM emergency WHERE pmrn='$pmrn' and eid='$eid' and billno='$billno'"));
$row44['COUNT(id)'];
...
$strSQL = "Select * from emergency where pmrn='$pmrn' and eid='$eid' and billno='$billno';";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");

$strSQL1 = "Select * from emergency where pmrn='$pmrn' and eid='$eid' and billno='$billno';";
...
$strSQL16 = "Select * from pms_bill where billno='$billno' and location='AE';";
$objQuery16 = mysqli_query($objConnect,$strSQL16) or die ("Error Query [".$strSQL1."]");
$row433=mysqli_fetch_array($objQuery16);


$strSQL15 = "Select * from emergency where billno= '$billno' and pmrn='$pmrn' and eid='$eid'";
$objQuery15 = mysqli_query($objConnect,$strSQL15) or die ("Error Query [".$strSQL1."]");
$row15=mysqli_fetch_array($objQuery15);

$discount=$row15['hos_discount']+$row15['hos1_dis']+$row15['lab_dis']+$row15['rad_dis']+$row15['doc_dis'];
...
<?php if($row['medicine_charge']>0){
						echo'<tr>
                        
                        

                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="80%">Medicine Charges
                        </td>
                        <td style="font-family: freesans; text-align:center;font-size:12px;" width="20%">'.$row['medicine_charge'].'
                        </td>
                    </tr>';
					...
					?>
                        ...
                        <td style="font-family: freesans; text-align:center;font-size:12px;" width="20%">
                        </td>
                    </tr>';
...
<?php if($discount>0){
                        ...
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="80%">Discount
                        </td>
                        <td style="font-family: freesans; text-align:center;font-size:12px;" width="20%">-'.$discount.'
                        </td>
                    </tr>';
