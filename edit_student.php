...
$ins_query1="update student set sname='$name',fname='$fname',roll='$roll',
mno='$phone',mno2='$phone1',padd='$padd',peradd='$peradd',eby='$user',etime='$etime',email='$email',session='$session',year='$year' where id='$id'";
