...
//$id1=$_REQUEST['ID'];
$url = "testapprove";
$query = "UPDATE einves set eby='$user',etime='$dtime',result='$infu' where id='$id'"; 
...
<td colspan="8" align="center"><input type="text" name="infu" required value="<?php echo $data45["result"]; ?>" ></td>
