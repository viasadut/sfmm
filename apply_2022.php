...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from dleave where hstatus in ('Approval Pending','Forwarded to Incharge','Confirmed By TM','Approved') and sdate between '2022-01-01' and '2022-12-31' and tleave='Annual Leave'order by id desc";
//$start=$row["aadate"];
