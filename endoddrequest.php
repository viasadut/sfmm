...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Endoscopist's Name</strong> 
...
$sel_query="Select * from endopapp where ddrequest='Request' ORDER BY ddin asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["adate"]; ?>  
      <td align="center"><?php echo $row["dreffer"]; ?>
      <td align="center"><?php echo $row["tname"]; ?>  
	  <td align="center"><a href="ebilladmddbillendo?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["ID"]; ?>">GO</a></td>
