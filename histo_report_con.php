...
$update33="update histo set `cinfo`='$cinfo',`spe`='$spe',`gdes`='$gdes',`mdes`='$mdes',`dia`='$dia',`status`='REPORT DONE',`dname1`='$full',`rtime`='$time',`rdate`='$date1',`date1`='$dd',`hno`='$hno',edittime='$edittime',editby='$user' where `id`='$id'";
...
<tr>				 <td colspan="10"><input type="text" name="pname"  value="<?php echo $row39['pname'];?>" readonly/></td>
				...
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><label><strong>Specimen:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="spe" rows="5"><?php echo $row39['spe'];?></textarea></td>  </tr>
