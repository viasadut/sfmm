...
$query = mysqli_query($db,"select * from iron where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'Iron',1,0,'C');
$pdf->Cell('30',5,$data['iron'],1,0,'C');
$pdf->Cell('31',5,'umol/L',1,0,'C');
$pdf->Cell('40',5,'6.6-26.0',1,1,'C');

$pdf->Cell('80',5,'TIBC',1,0,'C');
$pdf->Cell('30',5,$data['tibc'],1,0,'C');
$pdf->Cell('31',5,'umol/L',1,0,'C');
$pdf->Cell('40',5,'49-77',1,1,'C');

$pdf->Cell('80',5,'UIBC',1,0,'C');
$pdf->Cell('30',5,$data['uibc'],1,0,'C');
$pdf->Cell('31',5,'umol/L',1,0,'C');
$pdf->Cell('40',5,'40-62',1,1,'C');

$pdf->Cell('80',5,'Percent Iron Saturation',1,0,'C');
$pdf->Cell('30',5,$data['isaturation'],1,0,'C');
$pdf->Cell('31',5,'%',1,0,'C');
$pdf->Cell('40',5,'15-50',1,1,'C');

$pdf->Cell('80',5,'Ferritin',1,0,'C');
$pdf->Cell('30',5,$data['ferritin'],1,0,'C');
$pdf->Cell('31',5,'ng/mL',1,0,'C');
$pdf->Cell('40',5,'14.0-233.1',1,1,'C');

$pdf->ln(15);

// -------------------- Approval-flow footer (auto-inserted) --------------------
require_once('lab_report_footer.php');
lab_render_approval_footer($pdf, $db1, 'PROFILE', (isset($data3['resultby'])?$data3['resultby']:(isset($data['resultby'])?$data['resultby']:'')), (isset($data3['checked_by'])?$data3['checked_by']:''), (isset($data3['cby'])?$data3['cby']:''));
$pdf->Ln(10);
