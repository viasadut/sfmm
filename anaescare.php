...
$ins_query="insert into otanaescare (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
<option value="23:50">23:50</option></datalist></td>
			...
			<select id="browsers1" name="tan">
						...
						<option value='Pressure care '>Pressure care </option>
...
$count=1;
$sel_query="Select * from otanaescare where pmrn= '$pmrn' and eid='$id' and status1='Active'order by `id` DESC;";
