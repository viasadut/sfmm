...
values ('$select', '$pm','$pn','$pa','$ps','$pp','$dreffer','$cdetails','$plaintext','$pd','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no','Updated By Technologist','$ineid','$emerid','$price','$date_d','$price_code')";
...
<tr>
    ...
    function EnableDisableTextBox(chkPassport) {
	  ...
	  <td colspan="10"><a target='_blank' href="rad_report_new2.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname=<?php echo "$dname3"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
