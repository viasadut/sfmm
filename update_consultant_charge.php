...
//mysqli_select_db($db,'sfmmkpjnew');
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			...
			$strSQL = "UPDATE doctor set v1='800', v2='800'";
			$strSQL .="WHERE did = '".$_POST["chkDel"][$i]."'";
		...
		else if($s_id!='Consultant')
				{
			
			
			$strSQL = "UPDATE doctor set v1='700', v2='700'";
			$strSQL .="WHERE did = '".$_POST["chkDel"][$i]."'";
			$objQuery = mysqli_query($objConnect,$strSQL);
			...
			/*$strSQL = "UPDATE doctor set given_qty='$staff'";
			$strSQL .="WHERE id = '".$s_id."'";
			$objQuery = mysqli_query($objConnect,$strSQL);
			*/
...
$strSQL = "Select * from doctor where status='active'";
...
?>
  ...
  <tr>
    <td align="center"><?php echo $count; ?></td>
      ...
      <td align="center"><input type="text" name="sname[]" id="sname<?php echo $i;?>" value="<?php echo $row['desig']; ?>" /></td>
	  
	  <td align="center"><input type="text" name="staff[]" id="staff<?php echo $i;?>" value="<?php echo $row["dname"]; ?>" /></td>
	  
    <td align="center"><input type="checkbox" name="chkDel[]" id="chkDel<?php echo $i;?>" value="<?php echo $row["did"];?>"></td>
