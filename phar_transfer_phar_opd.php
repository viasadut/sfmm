...
//$last2 = substr($user, -2);
//echo $runningTime = $last2.date('ymdsi');
...
$ins_query1="insert into medi_stock (`code`,`g_name`,`b_name`,`req_qty`,`req_loc`,`status`,`location`,`rfid`,`sno`,`req_time`,`req_by`)
 values ('$code','$medi','$brand','$tprice','$p_mrn1','Pending','$p_mrn1','$sno','$runningTime','$req_time','$user')";
mysqli_query($con,$ins_query1) or die(mysql_error());
			
			
$url = "phar_transfer_phar_opd?sno=$sno";
header("Location: $url"); 
...
<input type="text" id="dept" class="form-control action" list="ddd" autocomplete="off" name='dept' required readonly style="font-weight: bold;font-size:22px;color:green" value="<?php echo 'Pharmacy_opd';?>">
...
<td colspan="3" align="center"><label><strong>Request Qty</strong></label></td>
