...
$query159 = mysqli_query($db,"select * from radio2 where iname='$infu' and status='Active'");
...
$sel90="SELECT * FROM radio2 WHERE `iname`='$infu' and status='Active';";
...
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated','$type','$code','$price','$odate1','$subtype','$link','$linkv','$report','$reportv','$ndate','$d_name','$ip','$op','$acct_code','$ccentre')";
