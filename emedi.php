...
$sel90="SELECT * FROM emedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `time`='$infu1' and `status`='Active';";
$result90 = mysqli_query($con,$sel90);

$sel91="SELECT * FROM emedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `time`='$infu2' and `status`='Active';";
$result91 = mysqli_query($con,$sel91);


$sel92="SELECT * FROM emedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `time`='$infu3' and `status`='Active';";
$result92 = mysqli_query($con,$sel92);


$sel93="SELECT * FROM emedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `time`='$infu4' and `status`='Active';";
$result93 = mysqli_query($con,$sel93);


$sel94="SELECT * FROM emedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `time`='$infu5' and `status`='Active';";
...
$ins_query6="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
$ins_query7="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
$ins_query8="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
$ins_query9="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
$ins_query10="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
<td colspan="6" align="center"><input list="rr" name="infu" size=60% class="form-control" autocomplete="off">
  <datalist id="rr">
...
$dd=date('d/m/Y');
$count=1;
$sel_query="Select * from emedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `infusion` and `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row["odate1"]; ?></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="emediupdate1?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo $user; ?>">Stop</a></td>
	  <td align="center" colspan="1"><a href="emediupdate?id=<?php echo $row["id"]; ?>&user=<?php echo $user; ?>">Stop ALL</a></td>


      </tr>
    <?php $count++; } ?>
	 <tr><td colspan="10"><a target='_blank' href="testpdf11.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
