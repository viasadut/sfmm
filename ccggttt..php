...
$ins_query336a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 21','AVAILABLE','$user')";
mysqli_query($con,$ins_query336a);
$ins_query337a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 22','AVAILABLE','$user')";
mysqli_query($con,$ins_query337a);
$ins_query338a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 23','AVAILABLE','$user')";
mysqli_query($con,$ins_query338a);
$ins_query339a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 24','AVAILABLE','$user')";
mysqli_query($con,$ins_query339a);
$ins_query340a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 25','AVAILABLE','$user')";
mysqli_query($con,$ins_query340a);
$ins_query341a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 26','AVAILABLE','$user')";
mysqli_query($con,$ins_query341a);
$ins_query342a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 27','AVAILABLE','$user')";
mysqli_query($con,$ins_query342a);
$ins_query343a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 28','AVAILABLE','$user')";
mysqli_query($con,$ins_query343a);
$ins_query344a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 29','AVAILABLE','$user')";
mysqli_query($con,$ins_query344a);
$ins_query345a="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 30','AVAILABLE','$user')";
mysqli_query($con,$ins_query345a);



$ins_query336b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 31','AVAILABLE','$user')";
mysqli_query($con,$ins_query336b);
$ins_query337b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 32','AVAILABLE','$user')";
mysqli_query($con,$ins_query337b);
$ins_query338b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 33','AVAILABLE','$user')";
mysqli_query($con,$ins_query338b);
$ins_query339b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 34','AVAILABLE','$user')";
mysqli_query($con,$ins_query339b);
$ins_query340b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 35','AVAILABLE','$user')";
mysqli_query($con,$ins_query340b);
$ins_query341b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 36','AVAILABLE','$user')";
mysqli_query($con,$ins_query341b);
$ins_query342b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 37','AVAILABLE','$user')";
mysqli_query($con,$ins_query342b);
$ins_query343b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 38','AVAILABLE','$user')";
mysqli_query($con,$ins_query343b);
$ins_query344b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 39','AVAILABLE','$user')";
mysqli_query($con,$ins_query344b);
$ins_query345b="insert into test (`dname`,`ddate`,`dslot`,`status`,`user`) values ('$name', '$date','WALK IN 40','AVAILABLE','$user')";
mysqli_query($con,$ins_query345b);
