...
$sel90="SELECT * FROM otreport WHERE `pmrn`='$pmrn' and `eid`='$id' and `pname`='$lx' and sname='$full';";
...
$ins_query="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`) values ( '$pmrn','$id','$lx','$otdate','$full','$sreport','$ottype','$date1')";
