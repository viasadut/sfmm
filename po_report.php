...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Approval Date</strong>   
...
$date= date('m/d/Y');
$count=1;
$stdate1=$_REQUEST['stdate'];
$stdate = date('Y-m-d 00:00:00', strtotime($stdate1));
$endate1=$_REQUEST['endate'];
$endate = date('Y-m-d 23:59:59', strtotime($endate1));
if($stdate1!='' && $endate1!='')
{
$sel_query="Select * from po_table where creditor_code='$creditor' and status='Approved' and ceo_a_time between '$stdate' and '$endate' ORDER BY id desc;";
}

else 
{
$sel_query="Select * from po_table where creditor_code='$creditor' and status='Approved' and  ORDER BY id desc;";
}
$result = mysqli_query($con,$sel_query);
//echo   $bt;
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["ceo_a_time"]; ?></td>
