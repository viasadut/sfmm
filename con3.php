...
$query43 = "SELECT COUNT(adoc) FROM inpatient where adoc= '$full' and anew BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Number of Inpatient Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Admitted In</strong>
	  <th width="14%"><strong>Discharge Type</strong>
	  <th width="10%"><strong>Discharge Note</strong></th>
...
$count=1;
$sel_query="Select * from inpatient where adoc='$full' and dnew BETWEEN '$start' and '$end' order by anew desc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo date('d/m/Y',strtotime($row["dnew"])); ?></td>
      <td align="center"><?php echo $row["pphone"]; ?>  </td>
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["adoc"];?> </td>
...
$death = "SELECT COUNT(id) FROM deathn where pmrn= '$pp'"; 
...
$death1 = "SELECT * FROM idischarge1 where pmrn= '$pp' and eid='$eid'"; 
	 
$result_d1 = mysqli_query($con, $death1) or die(mysqli_error());

// Print out result
$row_d1 = mysqli_fetch_array($result_d1);


?>

	  <td align="center"><?php echo $row_d1["discharge"]; ?>  
