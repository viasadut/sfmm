...
$ins_query="insert into ot (`dname`,`pname`,`pmrn`,`pphone`,`diagnosis`,`psex`,`page`,`adate`,`otdate`,`bookingdt`,`duration`,`spereq`,`ptype`,`tanes`,`nanes`,`proce`,`duration1`,`Otherins`,`sprequire`,`remarks`,`typeo`,`eid`) values 
('$dname', '$pname','$pmrn','$pphone','$diagnosis','$psex','$page','$adate','$otdate','$bkdate','$bt','$sn','$tp','$lx3','$na','$lx','$duration','$otherins','$sprequire','$remarks','$typeo','$eid')";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
			    	 ...
			    	 <td colspan="2"><input type="text" name="otdate" id="datepicker1" placeholder="Select Date" size="15" required/></td>  
					 <td colspan="6"><select name="bt"required/>
		...
		<tr>
					 ...
					 <td colspan="3"><input type="text" name="bkdate" size="15"value="<?php echo $date;?>" required readonly/></td>  		
						...
						<td colspan="2"><select name="tp"required/>
             		...
             		<td colspan="2"><select name="na"required/>
					 ...
					 <td colspan="4"><select name="sn"required/>
