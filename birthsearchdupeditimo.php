...
$sel_query="Select * from birth where phone= '$pmrn' and idate='$dd';";}
 else{
	 $sel_query="Select * from birth where pmrn= '$pmrn' and idate='$dd';";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="birthcereditimo.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>">GO</a></td>
