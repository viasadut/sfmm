...
<h1 align="center">Previous Day's Infusion</h1>
...
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid' and odate1 ='$dd';";
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="1"><a onclick="return confirm_click();"href="addinfusion?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo "$eid"; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["room"]; ?>&dname=<?php echo $user; ?>&alert=<?php echo $row["alert"]; ?>">ADD</a></td>
      </tr>
