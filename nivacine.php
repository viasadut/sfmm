...
$ins_query="insert into allvacine (`dname`,`pmrn`,`pname`,`medi`,`ins`,`date`,`type`) values ('$full', '$pmrn','$pname','$medi','$pins','$date','$type')";
...
<td colspan="10" align="center"><label><strong>Date</strong></label></td> 
</tr>
<tr>
