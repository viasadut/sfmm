...
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`) values ('$pmrn','$pname','$medi1','$id','$date1','$pdos','$dcode')";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="othosdelete1_000?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"; ?>">DELETE</a></td>
