...
<!-- Form Title -->
		...
		<a target='_blank' href="doc_assess.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Doctor's Assessment</a>&nbsp;&nbsp;
<a target='_blank' href="patient_all_reports?pmrn=<?php echo "$pmrn"; ?>"><b>ALL Reports<b></a></td></tr>
...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and status='Active' order by `time` asc;";
