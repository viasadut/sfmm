...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <th width="14%"><strong>Address</strong> </th>  
      <th width="14%"><strong>Phone</strong></th>
      <th width="14%"><strong>Set Procedure</strong></th>
	  <th width="14%"><strong>Admission Request</strong></th>
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="con_work?pmrn=<?php echo "$pmrn"; ?>&ID=<?php echo $row["ID"]; ?>">Set procedure</a></td>
	  <td align="center"><a href="manualadm?pmrn=<?php echo "$pmrn"; ?>&ID=<?php echo $row["ID"]; ?>">Admission Request</a></td>
