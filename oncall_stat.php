<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('billin','staff','mng')"; 
...
$query43 = "SELECT COUNT(id) FROM oncall_details where anew BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from oncall_details where anew BETWEEN '$start' and '$end' order by id desc";
