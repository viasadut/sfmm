...
<form action="covidcall5" method="POST">
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Informed</strong>
...
$url8 = "covidinform?id=$id8"; 
?>
<td align="center"><?php if($inform=='' & $dstatus=='confirmed'){echo"<a onclick='return confirm_click();' href='$url8'><strong>Informed</strong></a>";} else if($inform=='Informed' and $dstatus=='confirmed'){echo "<span style='color:green;text-align:center;'><b>Already Informed";}else {echo '';}?></td>
...
<?php $count++; } }?>
      ...
      <td colspan ="2" align="right"><a target='_blank' href="covidstatprintnew?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
