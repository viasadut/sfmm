...
$query45 = mysqli_query($db,"select * from ot where pmrn='$pmrn' and id='$id5'");
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$eid' and location in ('OT','IPD') and status!='Cancel' order by `id` DESC;";
...
//$bno=$_REQUEST['bagno'];
$url = "blood_nurse_ot?id=$id1&pmrn=$pmrn1&eid=$eid1&id_ot=$id5"; 
$url1 = "blood_nurse1_ot?id=$id1&pmrn=$pmrn1&eid=$eid1&id_ot=$id5"; 
...
else if($ss=='' and $oo!='' and $bstatus=='Issued')
	
{
echo"<a href='$url'><strong>Start</strong></a>";
}

else if ($ss !='' and $ee=='')
{
echo"<a href='$url1'><strong>End</strong></a>";
}	
