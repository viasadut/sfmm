...
{
$url = "idocnotemo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
<tr>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit121">MO's Note</button><font size="4.5" color="#FF0000"><br><b>(<?php echo  $row22['COUNT(pmrn)']; ?>)<b></td>
