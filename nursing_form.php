...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','mng','ot','endo','imo','mofficer','nurse','emergency','mrd','staff')"; 
...
<input type="hidden" name="dname" value="<?php echo $adoc;?>"></input>
<input type="hidden" name="page" value="<?php echo $page;?>"></input>
<input type="hidden" name="gender" value="<?php echo $pgender;?>"></input>
<input type="submit" name="Submit90" value="Print" align="right"></input>
</form>
</td>
</tr>
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">News2 Vitals Chart </td>


<td align="center">
    <form target="_blank" action="news_chart?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">WHO Surgical Safety Checklist</td>


<td align="center">
    <form target="_blank" action="surgical_list_1?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">Pre OT Checklist</td>


<td align="center">
    <form target="_blank" action="pre_ot_checklist?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">SOP Injection Procedure</td>


<td align="center">
    <form target="_blank" action="sop_injection_procedure?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">ECOG Performance Status Scale</td>


<td align="center">
    <form target="_blank" action="ECOG_Performance_Status_Scale?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">Nursing Shift Handover</td>


<td align="center">
    <form target="_blank" action="Nursing_Shift_Handover?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">Current Ctaerf</td>


<td align="center">
    <form target="_blank" action="Current_Ctaerf?" method="post" id="tt" >
...
<td align="center" colspan="1"><?php echo $count++; ?></td>
     <td align="center"colspan="1">Patient Property Form</td>


<td align="center">
    <form target="_blank" action="patient_property_form?" method="post" id="tt" >
