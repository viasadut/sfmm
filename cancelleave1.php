...
$query39 = "SELECT * FROM conleavedetails where sid= '$fullname'"; 
...
<p align="center" class="style1">Consultant's Leave  Status  </p> 
...
<tr> 
<td colspan="10"><input type="text" name="search"></td>
...
$count=1;
$sel_query="Select * from conleavedetails where sid= '$pmrn' and status='Approved By ALL' order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a onclick="return confirm_click();" href="conleavecancel?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>&tleave=<?php echo $row["tleave"]; ?>&tdays=<?php echo $row["tdays"]; ?>"><strong>Cancel</strong></a></td>
