...
$mor = "SELECT COUNT(id) FROM ccomm where uid='$fullname' and cname='Mortality and Morbidity Review Committee (MMRC)' and status='Active'";
$mor_query = mysqli_query($con, $mor) or die(mysqli_error());
$mor_result = mysqli_fetch_array($mor_query);
$member=$mor_result['COUNT(id)'];
...
<tr><td colspan="3" align="left"><a href="deathstatmng1_con"><font size="4.5">Mortality Stats</a></td></tr>

	
		<tr>	<td colspan="5" align="left"><a href="deathstatmng1_con_indu1"><font size="4.5">Pending Mortality Discussion Case(s)</a>
...
if($member>0)
	
	{
		...
		<tr>	<td colspan="5" align="left"><a href="deathstatmng1_all"><font size="4.5">Mortality Discussion Case(s) in the Meeting</a>
