...
<?php
    ...
    $ins_query1="INSERT INTO blood_gases (`pname`,`pmrn`,`psex`,`page`,`pH`,`PCO2`,`PO2`,`Be_ecf`,`HCO3_act`,`HOC3_std`,`BE_B`,`tCO2`,`O2_SAT_est`,`Na`,`Cl`,`K`,`AnGap`,`pAtm`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
    ('$pname','$pmrn','$psex','$page','$pH','$PCO2','$PO2','$Be_ecf','$HCO3_act','$HOC3_std','$BE_B','$tCO2','$O2_SAT_est','$Na','$Cl','$K','$AnGap','$pAtm','$user','$adate','$eid','$iname','$id','$sno')";
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="PCO2" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>PO2</strong></label>
            <input name="PO2" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>Be(ecf)</strong></label>
            <input name="Be_ecf" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>HCO3-act</strong></label>
            <input name="HCO3_act" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>HOC3-std</strong></label>
            <input name="HOC3_std" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>BE(B)</strong></label>
            <input name="BE_B" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>tCO2</strong></label>
            <input name="tCO2" type="text" size="70" style="text-transform:uppercase" value="" required>

            <label for="iron"><strong>Oxygen Status 37.0 °C</strong></label>
            <label for="iron"><strong>O2 SAT (est)</strong></label>
            <input name="O2_SAT_est" type="text" size="70" style="text-transform:uppercase" value="" required>

            <label for="iron"><strong>Elecrtolytes</strong></label>
            <label for="iron"><strong>Na+</strong></label>
            <input name="Na" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>K</strong></label>
            <input name="K" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>Cl-</strong></label>
            <input name="Cl" type="text" size="70" style="text-transform:uppercase" value="" required>
            <label for="iron"><strong>AnGap</strong></label>
            <input name="AnGap" type="text" size="70" style="text-transform:uppercase" value="" required>

            <label for="iron"><strong>Metabolites</strong></label>
            <label for="iron"><strong>pAtm</strong></label>
            <input name="pAtm" type="text" size="70" style="text-transform:uppercase" value="" required>
