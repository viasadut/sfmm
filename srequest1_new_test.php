...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('store','staff','ot','nurse','imo','mofficer','emergency','lab')"; 
...
$objDB1 = mysqli_select_db($objConnect,"sfmmkpjnew");
			...
			else if($eqty > $eqty1)
	{
			...
			$strSQL = "update srequest set r_by='$user',r_time='$stime' where id='".$_POST["chkDel"][$i]."'";
...
$strSQL = "Select * from srequest where rid= '$sid' and status in ('Closed') and r_by='' and r_time='' order by `id` DESC;";
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Request_Item</strong></td>
     	  <td colspan="5" align="center"><strong>Request_Dept</strong></td>
		  <td colspan="5" align="center"><strong>Request_Time</strong></td>
...
?>
     ...
     <td align="center" colspan="1"><?php echo $count; ?></td>
      ...
      <td align="center"colspan="2"><?php echo $row["sdept"]; ?></td>
			...
			<td align="center"colspan="5"><?php echo $row["rtime"]; ?></td>
			<td align="center"colspan="2"><?php echo $row["remarks"]; ?></td>
						...
						<td align="center"colspan="2"><?php echo $row["remarks1"]; ?></td>
    ...
    <?php $count++; } ?>
	<tr><td colspan="24" align="right"><button type="submit" id="btnDelete" name="btnDelete">Received</button><input type="hidden" name="hdnCount" value="<?php echo $i;?>"></td>
