...
<!-- Form Title -->
		...
		<tr><td colspan="20"color="red"><label><strong>FALL RISK SCORE IS : <?php echo $score;?></strong></label></td>	</tr>
		<tr><td align="right" colspan="20"><b>Arrival Date & Time:<b> <?php echo $row['adate'];?></td></tr>
		<tr><td align="right" colspan="20"><h2><a href="inassessmentnurse?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessmentnurseview?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
...
<tr><td colspan="10"><a target='_blank' href="nurseassessmentprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>		</tr>
