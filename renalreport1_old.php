...
$pdf->Cell('80',5,'Albumin',1,0,'C');
$pdf->Cell('30',5,$data['albumin'],1,0,'C');
$pdf->Cell('31',5,'g/L',1,0,'C');
$pdf->Cell('40',5,'35-50',1,1,'C');


$pdf->Cell('80',5,'Albumin / Globulin (A:G) Ratio',1,0,'C');
$pdf->Cell('30',5,$data['ah'],1,0,'C');
$pdf->Cell('31',5,'',1,0,'C');
$pdf->Cell('40',5,'1.0-2.0',1,1,'C');
