...
$sel90="SELECT * FROM idischarge1 WHERE `pmrn`='$pmrn' and eid='$eid';";
...
$update="update idischarge1 set dname='$dname', emo='$full', ddate='$date1', discharge='$discharge',ddia='$ddia', surgery='$surgery', ill='$ill', other='$other', plan='$plan', dinves='$dinves',refer='$refer' where `eid`='$eid' and pmrn='$pmrn'";
...
$url = "indischarge1edit?pmrn=$pmrn&eid=$eid" ;
header("Location:$url");
}
}
?>
...
<script>
    CKEDITOR.replace('surgery', {
      width: '100%',
      height: 200,
      removePlugins: 'font,fontsize,color,styles,format'
