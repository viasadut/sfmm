...
$count=1;
$sel_query="Select * from inves where pmrn= '$pmrn' and eid='$episode' and status='' order by `id` DESC;";
...
<td colspan="2" align="center"><a target='_blank' href="inpatientd3333?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
