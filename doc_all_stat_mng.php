...
require('db1.php');
//include("auth.php");
$btname = $_SESSION['sess_username'];
$query39 = "SELECT * FROM user where uname= '$btname'"; 
...
$query48l = "SELECT COUNT(pmrn) FROM alltest where date1 between '$date77' and '$date77e' and cby='$btname' and type='lab';"; 
...
$query48l1 = "SELECT COUNT(pmrn) FROM iinves where dis_date between '$date77' and '$date77e' and conby='$btname' and type='lab';"; 
	 
$result48l1 = mysqli_query($con, $query48l1) or die(mysqli_error());
$row48l1 = mysqli_fetch_assoc($result48l1);


$query48l2 = "SELECT COUNT(pmrn) FROM einves where ndate between '$date77' and '$date77e' and conby='$btname' and type='lab';"; 
...
$query43ecg = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$btname' and ron='ECG';"; 
	 
$result43ecg = mysqli_query($con, $query43ecg) or die(mysqli_error());
$row43ecg = mysqli_fetch_assoc($result43ecg);


$query43ecg1 = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$btname' and ron='ECHO-COLOR DOPPLER';"; 
	 
$result43ecg1 = mysqli_query($con, $query43ecg1) or die(mysqli_error());
$row43ecg1 = mysqli_fetch_assoc($result43ecg1);


$query43ecg2 = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$btname' and ron='ECHO-2D';"; 
	 
$result43ecg2 = mysqli_query($con, $query43ecg2) or die(mysqli_error());
$row43ecg2 = mysqli_fetch_assoc($result43ecg2);


$query43ecg3 = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$btname' and ron='CORONARY ANGIOGRAM';"; 
