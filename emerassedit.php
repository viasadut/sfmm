...
$update2="update eassess set shistory='$shistory', ccom='$ccom',pill='$pill',gexam='$gexam',abdomen='$abdomen',res='$resp',car='$car',nsys='$nsys',ent='$ent',breast='$breast',gen='$gen',mus='$mus',ex='$ex',uro='$uro',func='$func',diag='$diag',mplan='$mplan',dplan='$dplan' where `pmrn`='$pmrn' and eid='$eid'";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessment?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a></td></tr>
				<tr>
