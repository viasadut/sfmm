...
$laba = "SELECT COUNT(id) from alltest where type in ('lab','Lab','LAB') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate' and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY') and rejectby=''"; 
$lab_resulta= mysqli_query($con, $laba) or die(mysqli_error());
$lab_rowa = mysqli_fetch_array($lab_resulta);
$lab_ra=$lab_rowa['COUNT(id)'];

$lab1a = "SELECT COUNT(id) from iinves where type in ('lab','Lab','LAB') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate' and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY') and rejectby=''"; 
...
$lab2a = "SELECT COUNT(id) from einves where type in ('lab','Lab','LAB') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate' and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY') and rejectby=''"; 
...
$lab2a4 = "SELECT COUNT(id) from einves where type in ('lab','Lab','LAB') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate'and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY') and rejectby!=''"; 
...
<body>
    ...
    <br>
    <h1 align="center" style="background-color:lightgreen;text-align:left"><a href='lab_all_opd_bac'>OPD (<?php echo $lab_ra;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ipd_bac'>IPD(<?php echo $lab_r1a;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ae_bac' style="color:red">AE(<?php echo $lab_r2a;?>)</a></h1>
    <form action="" method="POST">
        
    <h1 align="center" style="background-color:lightgreen;">PENDING INVESTIGATION LIST FOR CONFIRMATION(AE)</h1>
        <!-- Form Title -->
...
$test=date('Y-m-d', strtotime('-30 days') );
$count=1;
$sel_query="Select * from einves where type in ('lab','LAB','Lab') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between $test and '$apdate' and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY','BACTERIOLOGY ','VIROLOGY ','IMMUNOLOGY/SEROLOGY ') and rejectby=''  order by `resulttime` ASC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="labreportconfirmae_bac?id=<?php echo $row["id"]; ?>">Confirm</a></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_ae_bio_bac?id=<?php echo $row["id"]; ?>">Reject</a></td>
      </tr>
