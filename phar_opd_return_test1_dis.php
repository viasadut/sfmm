...
('$pmrn', '$eid', '$location', '0', '0', '0', '$appdate', '$apptime', '$user', '$ipd', '$location','$mno', '$vehicle1', '$due_remarks','$pid','$b_remarks')";
...
//$mcode = $row1['code'];
	  $sum = "SELECT SUM(add_qty) FROM medi_stock where code='$mcode' and location='Pharmacy' and batch_no='$batch_no'" ;
