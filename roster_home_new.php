...
<a href="homemng" class="w3-bar-item w3-button">Back To PMS</a>
...
<div class="w3-sidebar w3-bar-block" style="display:none;z-index:5" id="mySidebar">
  ...
  <a href="roaster_dept..." class="w3-bar-item w3-button">Departmental Roster</a>
  <a href="loc_staff_dept" class="w3-bar-item w3-button">Add Location</a>
  <a href="roaster_55_test" class="w3-bar-item w3-button">Add Roster Schedule</a>
  <a href="mo_staff_list" class="w3-bar-item w3-button">Set Medical Officer Duty Location</a>
...
for ($m=1; $m<=12; $m++) {
     ...
     //$month;
		 ...
		 $url = "roaster_details1_new1?id=$jan&id1=$jan1"; 
		 $url2 = "roaster_details1_new1?id=$feb&id1=$feb1"; 
		 $url3 = "roaster_details1_new1?id=$mar&id1=$mar1"; 
		 $url4 = "roaster_details1_new1?id=$apr&id1=$apr1"; 
		 $url5 = "roaster_details1_new1?id=$may&id1=$may1"; 
		 $url6 = "roaster_details1_new1?id=$jun&id1=$jun1"; 
		 $url7 = "roaster_details1_new1?id=$jul&id1=$jul1"; 
		 $url8 = "roaster_details1_new1?id=$aug&id1=$aug1"; 
		 $url9 = "roaster_details1_new1?id=$sep&id1=$sep1"; 
		 $url10 = "roaster_details1_new1?id=$oct&id1=$oct1"; 
		 $url11 = "roaster_details1_new1?id=$nov&id1=$nov1"; 
		 $url12 = "roaster_details1_new1?id=$dec&id1=$dec1"; 
