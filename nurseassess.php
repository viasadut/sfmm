...
$ins_query="insert into gcs (`pname`,`pmrn`,`gender`,`moa`,`accom`,`lcon`,`mstatus`,`ph`,`pw`,`pt`,`pp`,`pbp`,`pr`,`po`,`pb`,`pain`,`c1`,`c2`,`c3`,`c4`,`pc`,`pd`,`pcom`,`pall`,`psur`,`eid`) values ('$pname','$pmrn','$psex','$ma','$acc','$con2','$men','$pheight','$pweight','$ptemp','$ppluse','$pbp','$pmstatus','$po2','$bg','$phyper','$coma','$coma1','$coma2','$coma3','$lx','$other','$lx2','$aller','$pasts','$eid')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><b>Arrival Date & Time:<b> <?php echo $row['adate'];?></td></tr>
				<tr>
						...
						<td colspan="3"><label><strong>Admitted by:</strong></label></td>
						<td colspan="3"><label><strong>Patient Accompanied By:</strong></label></td>
						<td colspan="3"><label><strong>Date Source:</strong></label></td>
...
<tr>				<td colspan="2"><input type="text" name="pmrn"   value="<?php echo $pm1;?>" readonly/></td>
			<td colspan="3"><select name="ma" placeholder="Admitted by" >
						...
						<option value='Others'>Others</option>													
									...
									<td colspan="3"><select name="acc" placeholder="Patient accompanied by" >
						...
						<td colspan="3"><select name="con" placeholder="Date Source" >
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Personal Particulars / History :</strong></label></td></tr>
		...
		<tr>
						...
						<td colspan="2"><label><strong>Language Spoken:</strong></label></td>
					 ...
					 <td colspan="2"><input type="text" name="pphone" required value="<?php echo $row['pphone'];?>" /></td>  
              		 ...
              		 <td colspan="2"><select name="men" placeholder="Language" >
...
<option value="Altered Mental State">Altered Metal State</option>
<option value="Others">Others</option>
</select>
