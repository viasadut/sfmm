...
$query43 = "SELECT COUNT(discipline) FROM privilege where discipline= '$bt';"; 
...
$query44 = "SELECT COUNT(discipline) FROM privilege;"; 
...
<h1 align="center">Discipline wise Privilege List</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<?php 
			$sql = "Select DISTINCT discipline from privilege;";
...
echo   $row44['COUNT(discipline)'];

$sel_query="Select * from privilege";}


else{
echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['COUNT(discipline)'];


$sel_query="Select * from privilege where discipline='$bt';";
}
$count=1;
