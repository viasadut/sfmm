...
*/
	...
	$ins_query6="insert into frisk (`pmrn`,`eid`,`fscore`,`date`,`udone`,`astime`,`cname`,`relation`,`cno`) values ('$pmrn','$eid','$all','$date','$user','$astime','$cname','$relation','$cno')";
...
<!-- Form Title -->
		...
		<tr><td colspan="20"color="red"><label style="color:red;font-size:30px; font-weight:bold;"><strong>LAST FALL RISK SCORE IS : <?php echo $score;?> (Date: <?php echo $row7['date'];?>,  Time: <?php echo $row7['astime'];?>)</strong></label>
    
    <td colspan="10" align="right"><a target='_blank' href="fall_risk_print?pmrn=<?php echo "$pmrn";?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="50" height="50" /></a></td>	
    </td>	</tr>
...
<tr>				<td colspan="2"><input type="text" name="pmrn"   value="<?php echo $pm1;?>" readonly></td>
					 ...
					 <td colspan="1"><input type="text" name="psex" required value="<?php echo $row['gender'];?>" readonly></td>

					 <td colspan="5"><input type="text" name="pname"  value="<?php echo $pn1;?>" readonly></td>
					  <td colspan="6"><input type="text" name="cname"  value="<?php echo $row7['cname'];?>" required></td>
					   <td colspan="3"><input type="text" name="relation"  value="<?php echo $row7['relation'];?>" required></td>
					    <td colspan="3"><input type="text" name="cno"  value="<?php echo $row7['cno'];?>" required></td>
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Personal Particulars / History :</strong></label></td></tr>
		...
		<tr>
						...
						<tr>				
					 <td colspan="2"><input type="text" name="page" required value="<?php echo $row['age'];?>" readonly></td>  	

					 <td colspan="2"><input type="text" name="pphone" required value="<?php echo $row['pphone'];?>" readonly></td>  

              		 <td colspan="2"><input type="text" name="ward" value="<?php echo $row['room'];?>" readonly></td>	
					 <td colspan="2"><input type="text" name="bed" required value="<?php echo $row['room1'];?>" readonly></td>    
					 <td colspan="4"><select name="aform" placeholder="Admitted From" >
             		 ...
             		 <td colspan="4"><input type="text" name="adate"style="background-color:skyblue;" value="<?php echo $row['adate'];?>" readonly></td>					 	
...
<tr><td colspan="20" bgcolor="lightgreen" align="center"><label><strong>Fall risk assessment Form (John Hopkins Tool)  :</strong></label></td></tr>
					<tr>
					<td colspan="20" style="font-size:18px;color:red;"><b>Age: </td></tr><tr><td colspan="20"><input type="radio" name="fage" value="1"required> 60-69 Years (Score- 1) &nbsp;<input type="radio" name="fage" value="2"required> 70-79 Years (Score- 2) &nbsp;&nbsp;<input type="radio" name="fage" value="3"required> Grater than or Equal of 80 Years (Score- 3) &nbsp;&nbsp;<input type="radio" name="fage" value="0"required checked="checked"> N/A (0 Points) </td>
					</tr>
					<tr>
					<td colspan="20" colspan="20" style="font-size:18px;color:red;"><b>Fall History:</td></tr><tr><td colspan="20"><input type="radio" name="fallhistory" value="5"required> One fall within 6 months before admission (5 points) &nbsp;&nbsp;<input type="radio" name="fallhistory" value="0"required checked="checked"> N/A (0 points) </td>
					
					</tr>

<tr>
					<td colspan="20" colspan="20" style="font-size:18px;color:red;"><b>Elimination, Bowel and Urine:</td></tr><tr><td colspan="20"><input type="radio" name="eli" value="2"required> Incontinence (2 points) &nbsp;<input type="radio" name="eli" value="2"required> Urgency or frequency (2 points)  &nbsp;&nbsp;<input type="radio" name="eli" value="4"required> Urgency/frequency and incontinence (4 points)&nbsp;&nbsp;<input type="radio" name="eli" value="0"required checked="checked"> N/A (0 points) </td>
					</tr>
					<tr>
					<td colspan="20" colspan="20" style="font-size:18px;color:red;"><b>Medications: Includes PCA/opiates, anticonvulsants, anti-hypertensives, diuretics, hypnotics,
laxatives, sedatives, and psychotropics</td></tr><tr><td colspan="20"><input type="radio" name="fmedi" value="3"required> On 1 high fall risk drug (3 points) &nbsp;&nbsp;&nbsp; <input type="radio" name="fmedi" value="5"required> On 2 or more high fall risk drugs (5 points)&nbsp;&nbsp;&nbsp; <input type="radio" name="fmedi" value="7"required> Sedated procedure within past 24 hours (7 points)&nbsp;&nbsp;<input type="radio" name="fmedi" value="0"required checked="checked"> N/A (0 points)   </td>
					
					</tr>

					<tr>
					<td colspan="20" colspan="20" style="font-size:18px;color:red;" ><b>Patient Care Equipment: Any equipment that tethers patient (e.g., IV infusion, chest tube, indwelling
catheter, SCDs, etc.)</td></tr><tr><td colspan="20"><input type="radio" name="fpc" value="1"required> One present (1 point)  &nbsp;&nbsp;&nbsp; <input type="radio" name="fpc" value="2"required> Two present (2 points)&nbsp;&nbsp;&nbsp; <input type="radio" name="fpc" value="3"required>3 or more present (3 points)&nbsp;&nbsp;<input type="radio" name="fpc" value="0"required checked="checked"> N/A (0 points)</td>
					
					</tr>

					
					<tr>
					<td colspan="20" style="font-size:18px;color:red;"><b>Mobility (multi-select; choose all that apply and add points together)
...
<td colspan="6"><input type="radio" name="fmob3" value="2" required> Visual or auditory impairment affecting mobility (2 points)<br><input type="radio" name="fmob3" checked="checked"value="0"required> N/A</td>												
		...
		<tr>
					<td colspan="20" style="font-size:18px;color:red;"><b>Cognition (multi-select; choose all that apply and add points together)
