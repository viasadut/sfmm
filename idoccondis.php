...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Prepare Discharge Note</strong> 
	        <th width="14%"><strong>View / Edit </strong> 
			<th width="14%"><strong>Note Confirm</strong> 
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from inpatient where eid='$eid' and pmrn='$pmrn' and idisconfirm!='Confirmed'ORDER BY id asc;";
...
<td align="center"><a href="iidischarge?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Prepare Discharge Note</a></td>
	  	  

<td align="center"><a href="indocdischarge1edit?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">View / Edit</a></td>	  	  	  	  
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="dconfirm?id=<?php echo $row["id"]; ?>">Confirm</a></td>	  
      </tr>
    <?php $count++; } ?>
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idisupdate?eid=<?php echo $row1["eid"]; ?>&pmrn=<?php echo $row1["pmrn"]; ?>&room1=<?php echo "$room1"; ?>&vc=<?php echo "$vc"; ?>&vc1=<?php echo "$vc1"; ?>&ac=<?php echo "$ac"; ?>&user=<?php echo "$fullname"; ?>"></a></td>	  
      </tr>
    <?php $count++; } ?>
