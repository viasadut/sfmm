...
$query43 = "SELECT * FROM cathreport where pmrn= '$pmrn' and eid='$eid';"; 
...
$ins_query="update cathreport set `dname`='$dname',`rname`='$rname',`pperform`='$pperform',`iprocedure`='$iprocedure',
`tprocedure`='$tprocedure',`anti`='$anti',`pfind`='$pfind',`con`='$con',`plan`='$plan',`con_by`='$user',`status1`='Confirmed',
`route`='$route',`tprocedure1`='$tprocedure1',`tprocedure2`='$tprocedure2',`tprocedure3`='$tprocedure3',`pfind1`='$pfind1',
`pfind2`='$pfind2',`pfind3`='$pfind3',`pfind4`='$pfind4',`ramus`='$ramus' where `pmrn`='$pmrn' and `eid`='$eid'";
...
//{
    ...
    echo 'alert("Report Confirmed Successfully")';
    echo '</script>';
...
<!-- Form Title -->
		...
		<label for="age"><strong>Doctor's Name :</strong></label>
				...
				<option value="<?php echo $row43['dname'];?>"><?php echo $row43['dname'];?></option>
		...
		<label for="age"><strong>Referral Doctor's Name :</strong></label>
				...
				<select name="rname" value="">
			        <option value="<?php echo $row43['rname'];?>" ><?php echo $row43['rname'];?></option>
	  ...
	  <select name="pperform[]" multiple="multiple" class="3col active" placeholder="Select Investigations"required value="<?php echo $row43['pperform'];?>">

<option value="<?php echo $row43['pperform'];?>" selected><?php echo $row43['pperform'];?></option>
       <?php 
    ...
    $(function () {
      ...
      <td colspan="3" align="center"><textarea name="route"  value="" /><?php echo $row43['route'];?></textarea></td>
	  
	   <label for="age"><strong>Diagnosis:</strong></label>
      <td colspan="3" align="center"><textarea name="iprocedure"  value="" /><?php echo $row43['tprocedure'];?></textarea></td>
...
<td colspan="3" align="center"><textarea name="tprocedure1"  value="" /><?php echo $row43['tprocedure1'];?>

</textarea></td>

<label for="age"><strong>Introducer Sheath:</strong></label>
<td colspan="3" align="center"><textarea name="tprocedure2"  value="" /><?php echo $row43['tprocedure2'];?>

</textarea></td>

<label for="age"><strong>Contrast:</strong></label>
<td colspan="3" align="center"><textarea name="tprocedure3"  value="" /><?php echo $row43['tprocedure3'];?>

</textarea></td>
	  
	   <label for="age"><strong>ANTICOAGULATION & OTHER MED :</strong></label>
      <td colspan="3" align="center"><textarea name="anti"  value="" /><?php echo $row43['anti'];?></textarea></td>
	  
	   <label for="age"><strong>PROCEDURE FINDINGS :</strong></label>
	   <br><br>
	   <label for="age"><strong>LM :</strong></label>
	   
      <td colspan="3" align="center"><textarea name="pfind"  value="" /><?php echo $row43['pfind'];?>
</textarea></td>

	   <label for="age"><strong>LAD :</strong></label>
	   
      <td colspan="3" align="center"><textarea name="pfind1"  value="" /><?php echo $row43['pfind1'];?>
</textarea></td>
	  
	  
	  	   <label for="age"><strong>LCX :</strong></label>
	   
      <td colspan="3" align="center"><textarea name="pfind2"  value="" /><?php echo $row43['pfind2'];?>
</textarea></td>

<label for="age"><strong>RAMUS :</strong></label>
	   
      <td colspan="3" align="center"><textarea name="ramus"  value="" /><?php echo $row43['ramus'];?>
</textarea></td>


	   <label for="age"><strong>RCA :</strong></label>
	   
      <td colspan="3" align="center"><textarea name="pfind3"  value="" /><?php echo $row43['pfind3'];?>
</textarea></td>

	   <label for="age"><strong>LIMA :</strong></label>
	   
      <td colspan="3" align="center"><textarea name="pfind4"  value="" /><?php echo $row43['pfind4'];?>
</textarea></td>


	   <label for="age"><strong>FINDINGS : </strong></label>
      <td colspan="3" align="center"><textarea name="con"  value="" /><?php echo $row43['con'];?></textarea></td>
	  
	   <label for="age"><strong>RECOMMENDATION :</strong></label>
      <td colspan="3" align="center"><textarea name="plan"  value="" /><?php echo $row43['plan'];?></textarea></td>
