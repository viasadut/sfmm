...
<h1 align="center"style="background-color:lightgreen;">package_screening INVESTIGATION </h1>
<!-- Form Title -->
...
echo $infu;
	...
	?>	 </td>
			...
			<td align="center"colspan="2"><?php echo $row["retime"]; ?></td>  
        ...
        <?php echo $row['rstatus'];?></td>
	  	  ...
	  	  <td align="center"colspan="1"><?php echo $row["reby"]; ?></td>
