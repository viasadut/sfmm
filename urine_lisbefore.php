...
$rr1='Appearance, Urine:'.$aurine."<br />".'Specific Gravity, Urine:'.$surine."<br />".'pH, Urine:'.$purine."<br />".'Protien, Urine:'.$purine."<br />".'Glucose, Urine:'.$gurine."<br />".
'Ketone, Urine:'.$kurine."<br />".'Bilirubin Screen, Urine:'.$burine."<br />".'Urobilinogen Screen, Urine:'.$uurine."<br />".'Blood, Urine:'.$blurine
."<br />".'WBC, Urine:'.$wurine."<br />".'RBC, Urine:'.$rurine."<br />".'Epitheial Cell, Urine:'.$eurine."<br />".'Cast, Urine:'.$curine
."<br />".'Crystal, Urine:'.$crurine."<br />".'Bacteria, Urine:'.$burine."<br />".'Yeast Cell, Urine:'.$yurine."<br />".'Other, Urine:'.$ourine;
...
<!-- Form Title -->
      ...
      <input name="surine" type="text" size="70" style="text-transform:uppercase" value="To Follow"required>
	  <label for="age"><strong>pH, Urine:</strong></label>
      <input name="purine" type="text" size="70" style="text-transform:uppercase" value="To Follow"required>
	  <label for="age"><strong>Protein, Urine:</strong></label>
      <input name="prurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Glucose, Urine:</strong></label>
      <input name="gurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Ketone, Urine:</strong></label>
      <input name="kurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Bilirubin Screen, Urine:</strong></label>
      <input name="burine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Urobilinogen, Urine:</strong></label>
      <input name="uurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
      ...
      <input name="wurine" type="text" size="70" style="text-transform:uppercase" value="To Follow"required>
	  <label for="age"><strong>RBC, Urine:</strong></label>
      <input name="rurine" type="text" size="70" style="text-transform:uppercase" value="Nil/hpf"required>
	  <label for="age"><strong>Epithelial Cell, Urine:</strong></label>
      <input name="eurine" type="text" size="70" style="text-transform:uppercase" value="To Follow"required>
	  <label for="age"><strong>Cast, Urine:</strong></label>
      <input name="curine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Crystal, Urine:</strong></label>
      <input name="crurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Bacteria, Urine:</strong></label>
      <input name="baurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Yeast, Urine:</strong></label>
      <input name="yurine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
	  <label for="age"><strong>Others, Urine:</strong></label>
      <input name="ourine" type="text" size="70" style="text-transform:uppercase" value="Negative"required>
