...
$query = mysqli_query($db,"select * from death_summary where pmrn='$pmrn' and eid='$eid'");
    ...
    $output .='
       ...
       ';			}
                ...
                $output .='<table>
                            ...
                            <table>';
                $query1 = mysqli_query($con,"Select distinct(infusion), instruc from imedi3 where pmrn= '$pmrn' and eid='$eid' and status in ('Active','Served')");
                $count=1;
				...
				$output .='<table>
                            ...
                            <table>';
                            $query1 = mysqli_query($con,"Select distinct(infusion) from iinves where pmrn= '$pmrn' and eid='$eid' and rstatus in ('RECEIVED','Ordered')");
                            $count=1;
                            while ($data1 = mysqli_fetch_array($query1)) {
                                $output .='
                                        <tr>
