...
$ins_query="insert into irefferal (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`bed`,`ward`,`bed1`,`rnote`,`sid`,`ndate`,`cstatus`,`duser`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$docname','$adoc','$remarks','$rmode','$ward','$bed1','$rnote','$infu','$ndate','Active','$user')";
...
$ins_query="insert into irefferal (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`ward`,`bed1`,`rnote`,`sid`,`ndate`,`cstatus`,`duser`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$dd','$adoc','$ward','$bed1','Followup Visit','$sid','$ndate','Active','$user')";
mysqli_query($con,$ins_query) or die(mysql_error());
}
}}
?>
...
{
return confirm("Are you Sure to refer this patient to Covid Unit ?");
}
...
<h1 align="center"style="background-color:lightgreen;">Inpatient Reffreal Panel </h1>
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
		<tr><td colspan="20"align="right"><button type="submit" name="Submit1_a" class="button" onclick="return confirm_click();"><b>Transfer To Covid Unit</b></button></td></tr>
...
<tr><td colspan="8" align="center"bgcolor="lightgreen"><label><strong>Referral Doctor List</strong></label></td>
<td colspan="4" align="center"bgcolor="lightgreen"><label><strong>Referral Type</strong></label></td>

<td colspan="4" align="center"bgcolor="lightgreen"><label><strong>Referral Mode</strong></label></td>
<td colspan="4" align="center"bgcolor="lightgreen"><label><strong>Referral Note</strong></label></td>
 </tr>

<tr>

<td colspan="8" align="center"><input list="browsers1" name="infu"  class="form-control">
  <datalist id="browsers1">

						<option value=''>-Select Doctor's Name</option>
				<?php 
			$sql = "select * from `doctor` where status='Active'and dname!='Covid Unit'";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->sid."'>".$row->dname."- ".$row->Discipline."</option>";
				}
			}
			?>  </datalist></td>
			<td colspan="4" align="center"><input list="browsers3" name="remarks" class="form-control">
  <datalist id="browsers3">
						...
						<option value='Very Urgent Visit'>Very Urgent Visit</option>
						<option value='PAC'>PAC</option>
				 </datalist></td>
				 <td colspan="4" align="center"><input list="browsers4" name="rmode"  class="form-control">
  <datalist id="browsers4">
						...
						<option value='Regular Visit'>Regular Visit</option>
						<option value='Emergency Visit'>Emergency Visit</option>
						<option value='ICU Visit'>ICU Visit</option>
						<option value='Procedure Charge'>Procedure Charge</option>
						<option value='CCU Visit'>CCU Visit</option>
						<option value='Covid Unit Visit'>Covid Unit Visit</option>
						<option value='Tele Consultation'>Tele Consultation</option>
				 </datalist></td>
				 
				 <td colspan="4" align="center"><textarea rows="5"  name="rnote"  value=""></textarea></td>
...
<tr>
      ...
      <td colspan="4" align="center"><strong>Referred By</strong></td>
      ...
      <td colspan="3" align="center"><strong>Referral Note</strong></td>
	  <td colspan="3" align="center"><strong>Referral Status</strong></td>
...
<td align="center"colspan="2"><?php echo $row["bed"]; ?></td>	  
      ...
      <td align="center"colspan="3"><?php echo $row["rnote"]; ?></td>
	  <td align="center"colspan="3"><?php echo $row["cstatus"]; ?></td>
    ...
    <?php 
	  ...
	  $url4="can_refer_imo?id=$id&pmrn=$pmrn&eid=$eid";
	  ?>
	 
  <td align="center"><?php if($row['cstatus']=='Active'){echo"<a onclick='return confirm_click();' href='$url4'><strong>Cancel</strong></a>";}else if($fname==$adoc){echo"<a onclick='return confirm_click();' href='$url4'><strong>Cancel</strong></a>";} else {echo '';}?></td>
      </tr>
    <?php $count++; } ?>
</table>
</form>
