...
$query4 = mysqli_query($db,"select * from radio where id='$id'");
...
//$id1=$_REQUEST['ID'];
$url = "inves_request_a";
$query = "UPDATE radio set status='Rejected',rf6='$dtime',rejectby='$user',rejectcom='$recom' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());



$query1 = "UPDATE radio1 set status='Rejected',rf6='$dtime',rejectby='$user',rejectcom='$recom' where id='$id'"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());

$query2 = "UPDATE radio2 set status='Rejected',rf6='$dtime',rejectby='$user',rejectcom='$recom' where id='$id'"; 
