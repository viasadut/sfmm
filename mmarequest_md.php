...
$query139 = "SELECT * FROM user where fullname= '$dname'"; 
...
$sel90="SELECT * FROM privilege WHERE `pname`='$mname' and did='$user1';";
...
$ins_query1="insert into privilege (`pname`,`dname`,`did`,`status`,`comments`,`adate`,`adate1`,`charge`,`discipline`,`sformat`,`porder`,`aby`) values 
('$mname','$dname','$user1','Approved','$remarks','$adate','$adate1','$charge','$dis','$sformat','$porder','$user')";
...
<!-- Form Title -->
	  ...
	  <input list="browsers111" name="dname"  size="80"  style="text-transform:uppercase"required>
...
<input type="text" name="charge" id="email" class="input-text" placeholder="Charge" size="70"value="">     
