...
$objDB1 = mysqli_select_db($objConnect1,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$strSQL = "update staff1 set cfleave='$b_leave1',aleave='30',altaken=''";
...
<td ><input type="text" name="b_leave[]" id="b_leave<?php echo $i;?>" value="<?php if($cyear==$doj12){echo $al2;} else {echo $al;}?>"readonly></td>
