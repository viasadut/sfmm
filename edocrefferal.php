...
$ddate=date('Y-m-d');
$query41 = mysqli_query($db,"select * from erefferal where pmrn='$pmrn' and eid='$eid' and infusion='$infu'");
...
$ins_query="insert into erefferal (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`bed`,`ddate`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','$rmode','$ddate')";
...
<tr><td colspan="12" align="center"bgcolor="lightgreen"><label><strong>Referral Doctor List</strong></label></td>
...
<td colspan="12" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
  <datalist id="browsers1">
			...
			?>  </datalist></td>
			<td colspan="4" align="center"><input list="browsers3" name="remarks" size=60% class="form-control" required>
  <datalist id="browsers3">
				 ...
				 <td colspan="4" align="center"><input list="browsers4" name="rmode" size=60% class="form-control" required>
