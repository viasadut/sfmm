<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','lab','rd','imo','mofficer','nurse','rad','moopd','diet','staff','dialysis','histo','physio','outdoc')"; 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecg_test where status1 in ('Confirmed','Updated') and pmrn='$pmrn' order by id;";
