...
$rfid=$medi_take['rfid1_1'];
$rfid2=$medi_take['rfid1_2'];
$rfid3=$medi_take['rfid1_3'];

$sel991="SELECT * FROM medicine WHERE `code`='$mcode'";
$result991 = mysqli_query($con,$sel991);
$medi_take1=mysqli_fetch_assoc($result991);
$mcode12=$medi_take1['tqty']+1;


$sel96="SELECT * FROM medi_stock WHERE `rfid`='$rfid' and location='Pharmacy';";
...
$sel96a="SELECT * FROM medi_stock WHERE `rfid`='$rfid2' and location='Pharmacy';";
...
$sel96b="SELECT * FROM medi_stock WHERE `rfid`='$rfid3' and location='Pharmacy';";
...
$m_idb=$b_chk_b['id'];
			...
			$strSQL = "UPDATE iinfusion set status='Returned', ruser='$user', rdate='$pdate' ";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
			
			
			
			$strSQL3 = "UPDATE medicine set tqty='$mcode12'";
			$strSQL3 .="WHERE code = '$mcode' ";
			$objQuery3 = mysqli_query($objConnect,$strSQL3);
			
			$strSQL4 = "UPDATE medi_stock set add_qty='$m_qty1'";
			$strSQL4 .="WHERE id = '$m_id'";
			$objQuery4 = mysqli_query($objConnect,$strSQL4);
			
			if($rfid2!=''){
			$strSQL5 = "UPDATE medi_stock set add_qty='$m_qty1a'";
			$strSQL5 .="WHERE id = '$m_ida'";
			$objQuery5 = mysqli_query($objConnect,$strSQL5);
			}
			
			if($rfid3!='')
			{
			$strSQL6 = "UPDATE medi_stock set add_qty='$m_qty1b'";
			$strSQL6 .="WHERE id = '$m_idb'";
			$objQuery6 = mysqli_query($objConnect,$strSQL6);
			}
		}
	}
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>List Of Unsed Medication</strong></label></td> </tr>
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from iinfusion where pmrn= '$pmrn' and eid='$eid' and status in ('Cancel','Data Updated') and status1 in('Active','Cancel') and pstatus='Served' order by `infusion` asc;";
...
<tr>
      ...
      <td colspan="5" align="center"><strong>Infusion</strong></td>   
	  <td colspan="2" align="center"><strong>Additive</strong></td>
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="1"><?php echo $row["ortime"]; ?></td>
      ...
      <td align="center"colspan="1"><?php echo $row["otime"].' TO '.$row["otime1"]; ?></td>  
	  <td align="center"colspan="5"><?php echo $row["infusion"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["addi"].''.$row["add1"]; ?></td>
	  <td align="center"colspan="5"><?php echo $row["infu1"]; ?></td>
...
<?php
 $count++;}
?>
<tr><td colspan="15"><a target='_blank' href="returnmeditest1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
<td colspan="5" align="right"><button type="submit" name="btnDelete"><b>Confirm Return<b></button><input type="hidden" name="hdnCount" value="<?php echo $i;?>"></td>
</tr>
</table>
<?php
mysqli_close($objConnect);
...
<table align="center" class="table table-bordered" id="dynamic_field">  
 <tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Returned Infusion List</strong></label></td> </tr>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid'and status ='Returned' and status1 in('Cancel','Active') and pstatus='Served' order by `infusion` asc;";
...
<tr><td colspan="5"><a target='_blank' href="testpdfpharreturn1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr>	 
</table>
