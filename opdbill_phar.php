...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus='Updated' and type!='inpatient';";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["dname"]; ?>  
	       		   ...
	       		   <td align="left" ><a target='_blank' href="opdbill1_phar?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Details</a></td>
