...
$update33="update histo set `bstatus`='$cinfo',`bconby`='$user'where `id`='$id'";
...
<!-- Form Title -->
		...
		<a target='_blank' href="https://medex.com.bd"><b>Reference Drug Index of Bangladesh(medex.com.bd)<b></a></td></tr>
				...
				<tr><td colspan="20"><label><strong>User's Name :</strong></label></td></tr>
				<tr>	  
...
<tr>				 <td colspan="10"><input type="text" name="pname"  value="<?php echo $row39['pname'];?>" readonly/></td>
				...
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><label><strong>Bill Status:</strong></label></td>  </tr>
						 <tr><td colspan="20"><input type="text" name="cinfo" required value="Confirmed" readonly/></td>  </tr>
