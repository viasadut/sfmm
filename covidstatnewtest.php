...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','qc','mrd','covid','covid1','bill')"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Blood Group</strong>
...
<td align="center"><?php echo $row["tresult"]; ?>  </td>
...
<td><a target='_blank' href="covidbar?sid=<?php echo "$id2"; ?>&cname=<?php echo "$cname"; ?>"><b>Barcode REPORT<b></a></td>
      </tr>
