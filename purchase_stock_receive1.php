...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
			...
			$qq = mysqli_query($db,"select * from purchase_stock1 where id='".$updateid."'");
...
$sel96="SELECT * FROM purchase_stock WHERE `code`='$code_1' and location='Store' order by id asc limit 1;";
...
$m_id=$b_chk_m['id'];
			...
			$ins_query3="update purchase_stock set `add_qty`='$m_qty1' where id='$m_id'";
...
$strSQL1 = "update purchase_stock1 set status='Received' where id='".$updateid."'";
...
<tr>
	  ...
	  <td colspan="7" align="center"><strong>Instruction</strong></td>
	    ...
	    <?php 
                    $query = "select * from purchase_stock1 where rfid='$sno' and req_loc='$req_loc' and status='Returned'";
