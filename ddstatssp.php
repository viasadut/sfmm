...
$query43 = "SELECT COUNT(spcase) FROM preadm where spcase='special';"; 
...
$query498 = "SELECT bfigure, SUM(bfigure) FROM preadm where spcase='special';";
...
<h1 align="center">Doriddro Fund Reports (Special Cases)</h1>
...
echo "<font color=blue font size=5> Total Special Case found in the search  -";
echo   $row43['COUNT(spcase)'];
...
echo " BDT";
$count=1;
$sel_query="Select * from preadm where spcase='special' order by id;";
