...
$mpdf->AddPage();
		 ...
		 '<table width="100%">
                            <tr>
								...
								<td style="font-family: freesans; font-size: 11px; align:left" width="100%" ><b>Sheikh Fazilatunnessa Mujib Memorial KPJ Specialized Hospital</b></td>
						...
						<table width="100%">
							...
							<tr>
								...
								<td style="font-family: freesans; font-size: 15px; align:left" width="50%"><b>Date: '.date('d/m/Y').'</b></td>
								<td style="font-family: freesans; font-size: 15px; align:right" width="50%"><b>Bill NO: '.$data1['sno'].'</b></td>
						...
						<table width="100%">
							...
							<tr>
								...
								<td style="font-family: freesans; font-size: 15px; align:left" width="50%"><b>MRN: '.$data1['pmrn'].'</b></td>
								<td style="font-family: freesans; font-size: 15px; align:left" width="50%"><b>Qty: '.$data1['qty'].' Pc/s</b></td>
