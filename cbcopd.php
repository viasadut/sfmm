...
<!-- Form Title -->
	 ...
	 <label for="age"><strong>Patient's Name :</strong></label>
      ...
      <input name="psex" type="text" size="2"value="<?php echo $data['pgender']?>" required readonly>
														
						
      <input name="pmrn" type="text" size="5" value="<?php echo $data['pmrn']?>" required readonly>
      <input name="pphone" type="text" size="8" value="<?php echo $data['pphone']?>"  required readonly>	  
	  <input name="page" type="text" size="10"value="<?php echo $data['page']?>" required readonly>
