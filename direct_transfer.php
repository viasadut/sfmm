...
$sel96="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty!='0' and location='Pharmacy' order by id asc limit 1;";
	...
	else if($tqty<$tprice)
{
    ...
    echo '</script>';
			...
			$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`ins`,`brand`,`pname`,`pmrn`,`location`) values
			('$medi','$tprice','$uprice','$charge','$user','$adate','$sno','$ins','$brand','$p_name1','$p_mrn1','OTC')";
...
$sel97="SELECT * FROM medi_stock WHERE `code`='$code' and add_qty!='0' and location='Pharmacy' order by id asc limit 1;";
