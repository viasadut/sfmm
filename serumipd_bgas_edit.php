...
$query5 = mysqli_query($db,"select * from serumtbl_gas where sno='$sno'");
...
$rr='SODIUM:'.$sodium."<br />".'POTASSIUM:'.$potassium."<br />".'CHLORIDE:'.$chloride."<br />".'HCO3:'.$hco3."<br />".'TCO2:'.$tco2."<br />".'PH:'.$ph;



$rr1='SODIUM:'.$sodium.' '.'mmol/L'."<br />".'POTASSIUM:'.$potassium.' '.'mmol/L'."<br />".'CHLORIDE:'.$chloride.' '.'mmol/L'."<br />".'HCO3:'.$hco3.' '.'mmol/L'."<br />".'TCO2:'.$tco2.' '.'mmol/L'."<br />".'PH:'.$ph.' '.'mmol/L';


$ins_query1="update serumtbl_gas set `s1`='$sodium',`p1`='$potassium',`c11`='$chloride',`hco3`='$hco3',`tco2`='$tco2',`ph`='$ph',`eby`='$user1',`etime`='$time' where sno='$sno' ";
...
<!-- Form Title -->
      ...
      <input name="sodium" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['s1'];?>"required>
	  <label for="age"><strong>POTASSIUM:</strong></label>
      <input name="potassium" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['p1'];?>"required>
	  <label for="age"><strong>CHLORIDE:</strong></label>
      <input name="chloride" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['c11'];?>"required>
	  
	  <label for="age"><strong>HCO3:</strong></label>
      <input name="hco3" type="text" size="70" style="text-transform:uppercase" value="<?php echo  $data1['hco3'];?>"required>
