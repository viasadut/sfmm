...
$query22 = "SELECT * from frisk where pmrn='$pmrn' and eid='$eid'"; 
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Fallrisk Score:</strong></label></td>  </tr>

<tr><td colspan="20"><?php echo $row3['bodys'];?></td>  </tr>	
<tr><td colspan="20"><?php echo $row4['fscore'];?></td>  </tr>	
