...
<label for="age"  size="20%" ><strong color=pink>For Female :</strong></label><br><br>
 <b>Period: <input type="radio" name="pperiod" value="YES"required/> YES <input type="radio" name="pperiod" value="NO"checked="checked"required/> NO &nbsp;&nbsp;&nbsp;
