...
$update="update radreport set report='$cdetails',report1='$plaintext',edittime='$ortime',editby='$user' where `id`='$id'";
mysqli_query($con,$update);


$ins_query="insert into radreport_edit (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`report1`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`erdone`,`edate`,`type1`,`time`,`ac_no`,`status1`,`ineid`,`emerid`,`price`,`done_date`) 
values ('$odname', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$plaintext','$ptemp','$count1','Edited','$ordate','$or1date','$ofind','$user','$date2','$otype1','$otime','$oac_no','Edited','$oineid','$oemerid','$oprice','$odone_date')";
...
<div id='cssmenu'>
<ul>
   <li><a href='rad_report_outside21_l'><span>Home</span></a></li>
