...
<?php
$full = $row39['fullname'];
$sel453="SELECT * FROM chemopapp WHERE `pmrn`='$pmrn' and eid='$eid' ;";
...
$sel90="SELECT * FROM chemoconsent2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and `pro`='$pro';";
...
$ins_query="insert into chemoconsent2 (`pmrn`,`eid`,`pname`,`dname`,`padd`,`psex`,`tdate`,`pro`,`page`,`user`,`tdate1`,`ward`,`bed`) values 
...
<td><a target='_blank' href="chemoconsentprint2.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&pro=<?php echo "$pro"; ?>&dname=<?php echo "$dname"; ?>&anes=<?php echo "$anes"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
