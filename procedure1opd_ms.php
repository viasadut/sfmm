...
$query7 = "SELECT * from inpatient where pmrn='$pmrn' and discharge=''"; 
...
$sel90="select * from `privilege` where dname='$dname'and status in ('Approved','Waiting For CFO Approval') and pname='$proname';";
	...
	else if($res90=mysqli_num_rows($result90)<=0)
{
    ...
    else if($ieid=='')
    {
      ...
      $ins_query="insert into m_suite (`dname`,`pname`,`pmrn`,`pphone`,`page`,`psex`,`pdate`,`ptime`,`proname`,`type`,`date1`,`ll`,`stype`) values 
      ('$dname', '$pname','$pmrn','$pphone','$page','$psex','$pdate','$ptime','$proname','OPD','$date1','$ll','$stype')";
...
$ins_query="insert into m_suite (`dname`,`pname`,`pmrn`,`pphone`,`page`,`psex`,`pdate`,`ptime`,`proname`,`type`,`date1`,`ll`,`ieid`,`stype`) values 
('$dname', '$pname','$pmrn','$pphone','$page','$psex','$pdate','$ptime','$proname','Inpatient','$date1','$ll','$ieid','$stype')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
$(document).ready(function()
{
	...
	$(".country").change(function()
	{
		...
		$(".js-example-basic-single").find('option').remove();
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				<tr><td colspan="10"><label><strong>Doctor's Name :</strong></label></td>
        <td colspan="10"><label><strong>Type of Procedure:</strong></label></td>
        
        </tr>
				<tr>	  
				<td colspan="10">
            				
				<select name="dname" value="" class="country"required>
            ...
            <select class="js-example-basic-single" name="proname"  value=''required>
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly></td>
					 ...
					 <td colspan="3"><input type="text1" name="type" required value="<?php if($ieid==''){echo 'OPD';} else{echo "Inpatient";}?>" readonly></td>
		...
		<tr>
						...
						<td colspan="2"><label><strong>Procedure Room:</strong></label></td>
            <td colspan="2"><label><strong>Service Type:</strong></label></td>		
						</tr>
...
<td colspan="2"><select name="stype" required>
