...
$query21 = "SELECT COUNT(status) FROM conleavedetails where sname='$full' and  status not in ('Approved By ALL','Cancel','Rejected')and sdate between '2022-01-01' and '2022-12-31'"; 
...
if($fullname ==1367 || $fullname ==1480 || $fullname ==1862) { echo"
   <table width='100%' height ='100%' border='1' align='center' bgcolor='#FFFF99' style='border-collapse:collapse;'>

   <tr><td colspan='20'align='center' bgcolor='lightgreen'>
   
   <span style='font-size:45px;color:red'>NOT AUTHORIZED</td></tr></table>";
}
...
<tr><td colspan="20"align="center"bgcolor="lightgreen"><h3> Please Select Your Desire Module</h3></td></tr>
 ...
 <tr>
			...
			<td colspan="20" align="left"><a href="leave2con"><font size="4.5">Apply Leave</a></td></tr>
	<tr><td colspan="20"align="left"><a href="leaveviewindi"><font size="4.5">	View Pending Leave Application</a><font size="4.5" color="#FF0000"><b>('.$row21['COUNT(status)'].')<b></td>	
	<tr><td colspan="20"align="left"><a href="leaveviewcon"><font size="4.5">	Pending Leave For Recommendation</a> <font size="4.5" color="#FF0000"><b>('.$row22['COUNT(lseen)'].')<b></td>	
	<tr><td colspan="20"align="left"><a href="leavestats"><font size="4.5">	Total Leave Stats</a></td>	
	<tr><td colspan="20"align="left"><a href="leavereject"><font size="4.5">	Total Pending / Reject Leave Stats</a></td>	
	
	<tr><td colspan="20"align="left"><a href="cancelleavecon.php"><font size="4.5">	Cancel Unapproved Leave  </a></td>	
  
   <tr><td colspan="20"align="left"><a href="attnstatsdoc"><font size="4.5">Attendance Stats</a></td>
