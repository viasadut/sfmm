...
$ins_query="insert into ecnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`daten`,`type`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$user','Data Updated','$daten','MO')";
...
$count=1;
$sel_query="Select * from ecnote where pmrn= '$pmrn' and eid='$episode' and type='MO'order by `id` DESC;";
