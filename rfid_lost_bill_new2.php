	...
	<form action="" method="post">
        ...
        <table align="center" class="table table-bordered" id="dynamic_field">  
			...
			<tr>
				...
				<?php if($data['rfid_status']=='0'){
					
					echo'<span style="color:green;text-align:center;font-size:20px;font-weight:bold;">Patient Wrist Band: Recieved</span>';
				}
				else{echo'
				...
				<?php if($data['rfid_card2_status']=='0'){
					
					echo'<span style="color:green;text-align:center;font-size:20px;font-weight:bold;">Patient Visitor Card: Recieved</span>';
				}
				else{echo'
				...
				<?php if($data['rfid_acard_status']=='0'){
					
					echo'<span style="color:green;text-align:center;font-size:20px;font-weight:bold;">Patient Attendant Card :Recieved</span>';
				}
				else{echo'
