...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="bbhistory?pmrn=<?php echo "$pmrn"; ?>">ADD BIRTH HISTORY</a>&nbsp;&nbsp;<h2><a href="<?php echo $row2['link']?>?pmrn=<?php echo "$pmrn"; ?>">Issue Birth Certificate</a></td>	  </tr>
