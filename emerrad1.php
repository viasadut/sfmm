...
<td colspan="2" align="center"><a href="rpapp1pacsae?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&infu=<?php echo $row["infusion"]; ?>"><strong>RECEIVE</strong></a></td>
