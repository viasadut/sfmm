...
$sid7 = 'SFMMSH'.$_REQUEST['sid7'];
$sid8 = $_REQUEST['sid7'];
$mrn = $_REQUEST['mrn'];
$etime= date('d/m/Y H:i:s');
$ins_query1="insert into staff3 (sid,sid1,sname,gender,dob,doj,dept,subdept,desig,cno,padd,peradd,district,cat,aby,addtime,incharge,hos,bgroup,`status`,`mrn`) values

('$sid8','$sid7','$name','$psex','$dob','$doj','$dept','$subdept','$desig','$phone','$padd','$peradd','$district','$cat','$user','$etime','$incharge','$hos','$bgroup','Active','$mrn')";
mysqli_query($con,$ins_query1) or die(mysql_error());


$ins_query2="insert into user (uname,upass,utype,fullname,ugroup,status,dept,rfid_card) values

('$sid8','123456','staff','$name','staff','Active','$dept','$rfid')";
...
<input type="text" name="sid7" id="email" class="input-text" placeholder="SID" size="70"value="">     

<label for="age"><strong>Name:</strong></label>
<input type="text" name="name" id="email" class="input-text" placeholder="Name" size="70" value="">
...
<input type="text" name="dob" id="datepicker" placeholder="Select Date" size="15" value="">


<label for="age"><strong>DOJ (M/D/Y):</strong></label>
<input type="text" name="doj" id="datepicker1" placeholder="Select Date" size="15" value="">
...
<input type="text" name="phone" id="email" class="input-text" placeholder="Phone" size="70"value="">     

<label for="age"><strong>Present Address:</strong></label>
<input type="text" name="padd" id="email" class="input-text" placeholder="padd" size="70"value="">     

<label for="age"><strong>Permanent Address:</strong></label>
<input type="text" name="peradd" id="email" class="input-text" placeholder="padd" size="70"value="">     
...
<input type="text" name="mrn" id="mrn" class="input-text" placeholder="MRN" size="70"value=""required>     

<label for="age"><strong>RFID:</strong></label>
<input type="text" name="rfid" id="rfid" class="input-text" placeholder="RFID" size="70"value=""required>     
