...
$ins_query="insert into biom (`ename`,`dept`,`etype`,`remarks`,`vendor`,`model`,`sno`,`idate`,`ewarrenty`,`ano`,`manu`,`origin`,`warrenty`,`comments`,`addtime`,`addby`) 
values ('$ename', '$dept','$etype','$remarks','$vendor','$model','$sno','$idate','$ewarrenty','$ano','$manu','$origin','$warrenty','$comments','$edate','$user')";
...
<!-- Form Title -->
	  ...
	  <input  name="eid" type="text" size="70" value=""readonly />
	  
	  <label for="age"><strong>Material Name :</strong></label>
      
	  
	  <input  name="ename" type="text" size="70" value=""required  />
	  <br><br>
	 ...
	 <select name="remarks" value="" class="style1"required>
			...
			<input  name="sno" type="text" size="70" value=""  />
			<br><br>	
			
			<label for="age"><strong>Asset No :</strong></label><br><br>	
			<input  name="ano" type="text" size="70" value=""  />
			<br><br>	
			...
			<input type="text" name="ewarrenty" id="datepicker" placeholder="Select Date" size="15" value=''>
			<br><br>	
  </fieldset>

 <label for="age"><strong>Comments (If Any):</strong></label> 
<td colspan="15" align="center"> <textarea rows="5" name="comments" required></textarea></td>
	        <br><br>
  </fieldset>
