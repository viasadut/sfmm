...
$query445d = "SELECT COUNT(medi) FROM idismedi where pmrn= '$pmrn1' and eid='$eid1' and status NOT IN ('Served','Deleted');"; 
...
$query445d12 = "SELECT * FROM phar_sale where pmrn= '$pmrn1' and eid='$eid1' and location in ('ICU','NICU','5AB Medicine stock','5CD Medicine stock','6AB Medicine stock','6CD Medicine stock','HMD','Cathlab and SPD','5AB emergency trolley','5CD emergency trolley','6th Fl emergency trolley','Maternity Suite','CCU') and ins='';"; 
...
?>
	  ...
	  <td align="center" <?php if($count55>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><a href="pharinmedi_new_ipd?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Medi</a></td>
		  ...
		  <td align="center"<?php if($count574c>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><a href="careshope1_ipd?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Careshope</a></td>


<td align="center">
<?php if($count574d1=='' and $confirmdn!='' and $count574d<=0){echo"<span style='background-color:lightgreen'><a href='discharge_medicine_phar_ipd?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";}
else if($count574d1=='' and $confirmdn!='' and $count574d>0){echo"<span style='background-color:red'><a href='discharge_medicine_phar_ipd?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";}
else if ($count574d1!='' and $confirmdn!='' and $count574d>0){echo"<style='background-color:red'><a href='discharge_medicine_phar_ipd?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";} 
else if ($count574d1!='' and $confirmdn!='' and $count574d<=0){echo"<style='background-color:lightgreen'><a href='discharge_medicine_phar_ipd?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";} 
else {echo 'Discharge Note Not Confirmed';}?></td>
