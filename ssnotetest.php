...
$api_adminssion_no_char=$data5['OUT_ADMISSION_NO_PK'];
	...
	$queryd1 = mysqli_query($db,"select * from doctor_code where dcode='$dcode' and dname like '%SURGERY%'");
$datad1= mysqli_fetch_assoc($queryd1);

$code=$datad1['ccode'];
//$code4=(int)$datad1['ccode'];
//$dcode3=$datad1['dcode'];
$ip=$datad1['ip'];
$op=$datad1['op'];
...
$pname_new_details=$row_rr['pname'].' - '.$adoc_details;
...
//$sql = "insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`,`plevel`,`w_time`) values
//( '$pmrn','$id','$pname_new','$otdate','$full','$sreport','$ottype','$date1','$charge','$plevel','$w_time')";


$sql = "insert into otivisitendo (`pmrn`,`eid`,`infusion`,`room`,`cdate`,`user`,`vtype`,`odate`,`ieid`,`dcode`,`ccode`,`app_con`,`ip`,`op`,`ccentre`) values 
( '$pmrn','$id','$full','$charge','$date1','$user','$pname_new','$adate1','$ieid','$dcode','$code','$app_con','$ip','$op','$ccentre')";
...
if ($conn->query($sql) === TRUE) {
	...
	$date=date('Y-m-d');
		...
		values ('$last_id','CR','$tb_data','$date','$charge','OT_DOC_CHARGE')";
		...
		values ('$last_id','DR','615100','$date','$charge','OT_DOC_CHARGE')";
		mysqli_query($con,$ins_query7) or die(mysql_error());
...
$ins_query7="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`,`plevel`,`w_time`) values
( '$pmrn','$id','$pname_new','$otdate','$full','$sreport','$ottype','$date1','$charge','$plevel','$w_time')";
mysqli_query($con,$ins_query7) or die(mysql_error());
...
*/
	...
	//$sql = "insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`,`plevel`,`w_time`) 
	//values ( '$pmrn','$id','$proname','$otdate','$full','$sreport','$ottype','$date1','$charge1','$plevel','$w_time')";
	
	$sql = "insert into otivisitendo (`pmrn`,`eid`,`infusion`,`room`,`cdate`,`user`,`vtype`,`odate`,`ieid`,`dcode`,`ccode`,`app_con`,`ip`,`op`,`ccentre`) values 
	( '$pmrn','$id','$full','$charge1','$date1','$user','Assist','$adate1','$ieid','$dcode','$code','$app_con','$ip','$op','$ccentre')";
	...
	if ($conn->query($sql) === TRUE) {
		...
		*/
		...
		$date=date('Y-m-d');
		$ins_query6="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','CR','$tb_data','$date','$charge1','OT_DOC_CHARGE')";
		mysqli_query($con,$ins_query6) or die(mysql_error());

		$ins_query7="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','DR','615100','$date','$charge1','OT_DOC_CHARGE')";
		mysqli_query($con,$ins_query7) or die(mysql_error());

		$ins_query7="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`,`plevel`,`w_time`) 
		values ( '$pmrn','$id','$proname','$otdate','$full','$sreport','$ottype','$date1','$charge1','$plevel','$w_time')";
...
$count=1;
$sel_query="Select * from otivisitendo where pmrn= '$pmrn' and ieid='$ieid' and c_status='0' order by `id` DESC;";
...
//var variables = "pmrn=str&string=$pd";
				...
				// xhttp.open("GET", "filename", true);
				xmlhttp.open("GET", "ot_pull_new.php?pmrn=" + str + "&porder=<?php echo $full;?>"+ "&mrn=<?php echo $pmrn;?>", true);
