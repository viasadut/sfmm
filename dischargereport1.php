...
$query = mysqli_query($db,"select * from discharge where pmrn='$pmrn' and id='$id' and dname='$dname'");
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['xl'].",".$data['m1'].",".$data['m2'],1,1);

$pdf->ln(5);

$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Medication Advised:',1,1,'L');
$query1 = mysqli_query($db,"select * from ipmedi where pmrn='$pmrn' and date='$date' and dname='$dname'");
