...
<li class='active has-sub'><a href='#'><span>Package</span></a>
   ...
   <li class='active has-sub'><a href='#'><span>Investigation Bill Comfirm Panel</span></a>
	  ...
	  <li class='last'><a href='bill_lab_search_new'><span>Search Bill</span></a></li>
	  <li class='last'><a href='manual_bill'><span>Manual Bill Confirm</span></a></li>
      </ul>
...
$sel_query100="Select * from pappnew where status='NOT SEEN' and dname='$bt' and `bill`='' ORDER BY aslot asc;";
...
while($row100 = mysqli_fetch_assoc($result100)) { ?>
    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row100["status"];?> </td> 
			...
			<td  align ="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="bgg3333?pmrn='.$row100["pmrn"].'&ID='.$row100["ID"].'">UPDATE</a> </td>';}
			
			else if($row100['dreffer']!=''){echo'
			
			<td  align ="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="bgg3333_new?pmrn='.$row100["pmrn"].'&ID='.$row100["ID"].'">UPDATE</a> </td>';}
