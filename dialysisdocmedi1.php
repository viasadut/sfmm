...
$ins_query6="insert into dialysismedi (`pmrn`,`dname`,`eid`,`infusion`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from dialysismedi where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `infusion` and `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="5"><a href="chemomedicanceldocoo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&infu=<?php echo $row['infusion'];?>"><?php echo $row["infusion"]; ?></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="dialysismedicanceldoc?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
