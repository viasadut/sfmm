...
<option value='No'>Hits Bill Not Confirmed</option>
					 <option value='Yes'>Hits Bill Confirmed</option>
...
<td  colspan="4"align="center">
   ...
   <input list="24" name="pdos_1" type="text" class="style1" id="sdate12" hidden>
...
<td colspan="5" align="center"><select name="dtype" required id="sdate13" hidden>
...
<td colspan="5" align="center"><select name="damount" required id="sdate14" hidden>
...
if(rt === "Yes"){
	...
	sdate13.hidden = false;
	sdate13.disabled = false;

  sdate14.hidden = false;
	sdate14.disabled = false;
  ...
  sdate13.hidden = true;
	sdate13.disabled = true;

  sdate14.hidden = true;
	sdate14.disabled = true;
  }	  
