...
<tr><td colspan="20"align="Right"bgcolor="lightgreen"><a target='_blank' href="docadmdoc?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>View Consultant Plan Upon Admission<b></a>&nbsp;&nbsp;<a onclick="return confirm_click();" href="docvisit3?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD VISITING CHARGE</strong></a>&nbsp;&nbsp;<a onclick="return confirm_click1();" href="docvisit6?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD ICU VISIT CHARGE</strong></a>&nbsp;&nbsp;<a onclick="return confirm_click2();" href="docvisit7?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD EMERGENCY VISIT CHARGE</strong></a></td></tr>
<tr>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit98">Doctor Procedure Note</button></td>
...
<tr><td colspan="5" align="center"><button type="submit" name="Submit200">Nurse's Assessment</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row14['COUNT(pmrn)']; ?>)<b></td>
	...
	<td colspan="3" align="center"><button type="submit" name="Submit2">Stat Medication</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row15['COUNT(pmrn)']; ?>)<b></td>
...
<td colspan="5" align="center"><button type="submit" name="Submit501">Fluid Chart</td>
...
<td colspan="3" align="center"><button type="submit" name="Submit1001">Investigation Stat</button></td>
