...
<h1 align="center">Pending / Rejected Leave Stats</h1>
...
$count=1;
$sel_query="Select * from conleavedetails where sid='$bt' and status !='Approved By ALL' and status1 in('Rejected','') and sdate BETWEEN '$start' and '$end';"; 
