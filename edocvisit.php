...
$ins_query="insert into evisit (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`vtype`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$full','$user','$remarks','$infu')";
...
<td colspan="12" align="center"><select name="infu" class="country" placeholder="Select Visitor Card" >
				 ...
				 <?php 
			$sql = "select ctype from `concharge` ";
