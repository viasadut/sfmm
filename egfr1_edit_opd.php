...
<?php
    ...
    $query5 = mysqli_query($con,"select * from egfr where pmrn='$pmrn' and sno='$sno'");
...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        $adate1= date('m/d/Y');
        $rr='Creatinine:'.$chikun1."<br />".'Estimated Glomerular Filtration Rate:'.$chikun2;
        $rr1='Creatinine:'.$chikun1.' '.'mg/dL'."<br />".'Estimated Glomerular Filtration Rate:'.$chikun2.' '.'mL/min/1.7m2';

        // $ins_query1="insert into egfr (`pname`,`pmrn`,`psex`,`page`,`uv`,`uc`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
        // ('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$user','$adate','$eid','$iname','$id','$sno')";
        // mysqli_query($con,$ins_query1) or die(mysql_error());

        $ins_query1="UPDATE egfr SET 
            `pname`='$pname',
            `pmrn`='$pmrn',
            `psex`='$psex',
            `page`='$page',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <label for="age"><strong>Estimated Glomerular Filtration Rate(MDRD Equation) Report:</strong></label>

            <label for="tibc"><strong>Creatinine</strong></label>
            <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['uv']?>" required>
            <label for="tibc"><strong>Estimated Glomerular Filtration Rate</strong></label>
