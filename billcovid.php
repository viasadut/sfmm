...
$count=1;
if($dt==$adate)
{$sel_query="Select * from covidopd where ssent='$adate' order by sid asc;";}

else if($dt==$rd)
{$sel_query="Select * from covidopd where ssent='$rd'  order by sid asc;";}

else if($dt==$rd2)
{$sel_query="Select * from covidopd where ssent='$rd2' order by sid asc;";}

else if($dt==$rd3)
{$sel_query="Select * from covidopd where ssent='$rd3' order by sid asc;";}

else if($dt==$rd4)
{$sel_query="Select * from covidopd where ssent='$rd4' order by sid asc;";}


else if($dt==$rd5)
{$sel_query="Select * from covidopd where ssent='$rd5' order by sid asc;";}


else if($dt==$rd6)
{$sel_query="Select * from covidopd where ssent='$rd6' order by sid asc;";}
...
<td align="center"><?php if ($bill=='Paid'){echo $bill;} else {echo "<a onclick='return confirm_click();' href='$url'>Confirm Payment</a>";} ?>  </td>
