...
<th width="14%"><strong>Bed Charge</strong> 	  
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from bed where status in ('vacant','Vacant')";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["adate"];?>  
	  <td align="center"><?php echo $row["charge"]; ?>  
	  <td align="center"><a href="bededit_bill.php?id=<?php echo $row["id"]; ?>">Edit</a></td>
      </tr>
    <?php $count++; } ?>
   </tbody>
</form>
