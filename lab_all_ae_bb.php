...
$lab2a4 = "SELECT COUNT(id) from einves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate'and subtype in('BLOOD BANK') and rejectby!=''"; 
...
<body>
    ...
    <br>
    <h1 align="center" style="background-color:lightgreen;text-align:left"><a href='lab_all_opd_bb'>OPD (<?php echo $lab_ra;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ipd_bb'>IPD(<?php echo $lab_r1a;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ae_bb' style="color:red">AE(<?php echo $lab_r2a;?>)</a></h1>
...
$test=date('Y-m-d', strtotime('-30 days') );
$count=1;
$sel_query="Select * from einves where type in ('lab','LAB','Lab') and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between $test and '$apdate' and subtype in('BLOOD BANK') and rejectby=''  order by `resulttime` ASC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="labreportconfirmae_bb?id=<?php echo $row["id"]; ?>">Confirm</a></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_ae_bb?id=<?php echo $row["id"]; ?>">Reject</a></td>
      </tr>
...
<td align="center"colspan="1"><a target='_blank' href="<?php echo $row['report']?>?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&sno=<?php echo 'E'.$row['id']; ?>">Report</a></td>
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_ae_bio?id=<?php echo $row["id"]; ?>">Reject</a></td>
      </tr>
