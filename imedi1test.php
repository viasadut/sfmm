...
<tr><td colspan="20" align="right"bgcolor="pink"><a href="nursemedireturn?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><strong>Return Medi List</strong></a></td></tr>
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Medication Form</strong></label></td> </tr>

<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="2" align="center"><strong>Patient's Name</strong></td>
	  ...
	  <td colspan="11" align="center"><strong>UPDATE</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $data59["pname"]; ?></td>
...
<td colspan="1" align="center"><a onclick="return confirm_click();" href="imedi2test?pmrn=<?php echo "$row[pmrn]"; ?>&eid=<?php echo $data59["eid"]; ?>&id=<?php echo "$row[id]"; ?>&user=<?php echo "$user"; ?>"><strong>UPDATE</strong></a></td>	  
