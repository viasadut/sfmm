...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Rejected BY</strong>
	  <th width="14%"><strong>Rejection Comments</strong>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from preadm where ddrequest ='Reject'";
//$start=$row["aadate"];
...
$sel_query="Select * from endopapp where ddrequest ='Reject'";
//$start=$row["aadate"];
