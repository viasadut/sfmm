...
?>
	  ...
	  <td align="center"><?php if($mname =='L') {echo '<span style="color:black;text-align:center;"><b>L<b>';}else if($stime3>0 && $mname !='') {echo '<span style="color:blue;text-align:center;"><b>LT<b>';}else if($mname=='P') {echo "<span st9yle='color:green;text-align:center;'><b>$mname"; } else {echo '<span style="color:red;text-align:center;"><b>A<b>';}?></td>
