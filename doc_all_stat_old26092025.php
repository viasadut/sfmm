<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','adminmng','doctor')"; 
...
<h1 align="center">Datewise Consultant Activities Stats </h1>
...
$query43 = "SELECT COUNT(pmrn) FROM presnew where date1 between '$date77' and '$date77e' and dname='$full';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);


$query43p = "SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$full' and status='SEEN';"; 
	 
$result43p = mysqli_query($con, $query43p) or die(mysqli_error());
$row43p = mysqli_fetch_assoc($result43p);


$query44 = "SELECT COUNT(pmrn) FROM inpatient where anew between '$date77' and '$date77e' and adoc='$full' and emerid ='0';"; 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query44e = "SELECT COUNT(pmrn) FROM inpatient where anew between '$date77' and '$date77e' and adoc='$full' and emerid !='0';"; 
$result44e = mysqli_query($con, $query44e) or die(mysqli_error());
$row44e = mysqli_fetch_assoc($result44e);



$query45 = "SELECT COUNT(pmrn) FROM erefferal where ddate between '$date77' and '$date77e' and infusion='$full';"; 
	 
$result45 = mysqli_query($con, $query45) or die(mysqli_error());
$row45 = mysqli_fetch_assoc($result45);


$query46 = "SELECT COUNT(pmrn) FROM ot where date5 between '$date77' and '$date77e' and status='Received' and dname='$full';"; 
...
$query46a = "SELECT COUNT(pmrn) FROM ot where status='Received' and '$full' in (nanes,anes2,anes3) and date5 between '$date77' and '$date77e';"; 
...
$query47 = "SELECT COUNT(pmrn) FROM endopapp where adate between '$date77' and '$date77e' and dreffer='$full' and status in ('Received','SEEN');"; 
...
$query47a = "SELECT COUNT(pmrn) FROM endopapp where adate between '$date77' and '$date77e' and anes='$full' and status in ('Received','SEEN');"; 
...
$query48 = "SELECT COUNT(pmrn) FROM procedure1 where date1 between '$date77' and '$date77e' and dname='$full' and ustatus in ('Updated','Paid');"; 
...
$query48r = "SELECT COUNT(pmrn) FROM radreport where rdate between '$date77' and '$date77e' and dname='$full';"; 
...
$query48l = "SELECT COUNT(pmrn) FROM alltest where date1 between '$date77' and '$date77e' and cby='$fullname' and type='lab';"; 
...
$query48l1 = "SELECT COUNT(pmrn) FROM iinves where dis_date between '$date77' and '$date77e' and conby='$fullname' and type='lab';"; 
	 
$result48l1 = mysqli_query($con, $query48l1) or die(mysqli_error());
$row48l1 = mysqli_fetch_assoc($result48l1);


$query48l2 = "SELECT COUNT(pmrn) FROM einves where ndate between '$date77' and '$date77e' and conby='$fullname' and type='lab';"; 
...
$query48ecg = "SELECT COUNT(pmrn) FROM ecg where datenew between '$date77' and '$date77e' and dname1='$full' and status1='Confirmed';"; 
...
$query48echo = "SELECT COUNT(pmrn) FROM echo where datenew between '$date77' and '$date77e' and dname='$full' and status1='Confirmed';"; 
	 
$result48echo= mysqli_query($con, $query48echo) or die(mysqli_error());
$row48echo = mysqli_fetch_assoc($result48echo);


$query48ett = "SELECT COUNT(pmrn) FROM ett where date2 between '$date77' and '$date77e' and dname='$full' and status1='Confirmed';"; 
...
$histo = "SELECT COUNT(pmrn) FROM histo where date1 between '$date77' and '$date77e' and dname1='$full' and status='REPORT DONE';"; 
	 
$histo1= mysqli_query($con, $histo) or die(mysqli_error());
$histo2 = mysqli_fetch_assoc($histo1);


$histof = "SELECT COUNT(pmrn) FROM fnacreport where date5 between '$date77' and '$date77e' and dname='$full' and status='SEEN';"; 
...
$query43i = "SELECT SUM(charge) FROM icnote where dis_date between '$date77' and '$date77e' and user='$full' and ugroup='Doctor';"; 
	 
$result43i = mysqli_query($con, $query43i) or die(mysqli_error());
$row43i = mysqli_fetch_assoc($result43i);


$query43i_discount = "SELECT SUM(discount) FROM icnote where dis_date between '$date77' and '$date77e' and user='$full' and ugroup='Doctor';"; 
...
$query43o = "SELECT SUM(charge) FROM otreport where dis_date between '$date77' and '$date77e' and sname='$full';"; 
	 
$result43o = mysqli_query($con, $query43o) or die(mysqli_error());
$row43o = mysqli_fetch_assoc($result43o);


$query43o_discount = "SELECT SUM(discount) FROM doc_dis where edate between '$date77' and '$date77e' and dname='$full';"; 
...
$query43pp = "SELECT SUM(procharge) FROM procedure1 where date1 between '$date77' and '$date77e' and dname='$full';"; 
...
$query43e = "SELECT SUM(room) FROM ivisitendo where cdate between '$date77' and '$date77e' and infusion='$full';"; 
	 
$result43e = mysqli_query($con, $query43e) or die(mysqli_error());
$row43e = mysqli_fetch_assoc($result43e);


$query43ecg = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$fullname' and ron='ECG';"; 
	 
$result43ecg = mysqli_query($con, $query43ecg) or die(mysqli_error());
$row43ecg = mysqli_fetch_assoc($result43ecg);


$query43ecg1 = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$fullname' and ron='ECHO-COLOR DOPPLER';"; 
	 
$result43ecg1 = mysqli_query($con, $query43ecg1) or die(mysqli_error());
$row43ecg1 = mysqli_fetch_assoc($result43ecg1);


$query43ecg2 = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$fullname' and ron='ECHO-2D';"; 
	 
$result43ecg2 = mysqli_query($con, $query43ecg2) or die(mysqli_error());
$row43ecg2 = mysqli_fetch_assoc($result43ecg2);


$query43ecg3 = "SELECT COUNT(ron) FROM ecg_test where datenew between '$date77' and '$date77e' and con_by='$fullname' and ron='CORONARY ANGIOGRAM';"; 
	 
$result43ecg3 = mysqli_query($con, $query43ecg3) or die(mysqli_error());
$row43ecg3 = mysqli_fetch_assoc($result43ecg3);

 
 $query43_e = "SELECT SUM(visit) FROM ecnote where daten between '$date77' and '$date77e' and dname='$full' and type='Doctor';"; 
...
$query_cath = "SELECT COUNT(pmrn) FROM cath_charge where date1 between '$date77' and '$date77e' and c_status!='Cancelled' and sname='$full';"; 
...
$query_cath1 = "SELECT SUM(charge) FROM cath_charge where date1 between '$date77' and '$date77e' and c_status!='Cancelled' and sname='$full';"; 
...
echo "<font color=blue font size=2><b> CONSULTANT ACTIVITIES AT A GLANCE  - $date77 TO $date77e";
...
echo "<font color=blue font size=5.5><b> CONSULTANT ACTIVITIES AT A GLANCE  - $date77 TO $date77e";
...
echo "<font color=red font size=5.5><b> CONSULTANT ACTIVITIES AT A GLANCE in (BDT)  - $date77 TO $date77e";
...
echo "<br>";
echo "Total Discount-  ";	 
echo $row43i_discount['SUM(discount)']+$row43o_discount['SUM(discount)'];



echo "<br>";
echo "Net Income-  ";	 
echo $row43p['SUM(payment)'] + $row43i['SUM(charge)']+ $row43_e['SUM(visit)'] + $row43o['SUM(charge)'] + $row43pp['SUM(procharge)'] + $row43e['SUM(room)'] + $row43ecg['COUNT(ron)']*100 + $row43ecg1['COUNT(ron)']*1000+ $row43ecg2['COUNT(ron)']*1500+ $row43ecg3['COUNT(ron)']-$row43i_discount['SUM(discount)']-$row43o_discount['SUM(discount)']+$cath_sum['SUM(charge)'];
echo " BDT";	 
