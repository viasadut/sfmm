...
<input type="text"  onchange="two(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='code'  style="font-weight: bold;font-size:22px;color:green">
	...
	<option value=''>-Select-</option>
        ...
        ?>
            <option value="<?php echo $row['rfid']; ?>"><?php echo $row['rfid'].'('.$row['b_name'].')'; ?></option>
        <?php } ?>
...
<td colspan="2" ><input type="text" name="uprice" id="uprice" required value="" readonly style="font-weight: bold;font-size:22px;color:green"></td>
						...
						<td colspan="3" ><input type="text" name="tprice" id="qty" value="" style="font-weight: bold;font-size:22px;color:green"></td>
						
							
						
						
						<td colspan="3" ><input type="text" name="charge" id="tprice" readonly value="" style="font-weight: bold;font-size:22px;color:green"required>
            <br />
