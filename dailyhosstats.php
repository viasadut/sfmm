...
<h1 align="center">Datewise Hospital Stats </h1>
...
$query44 = "SELECT COUNT(pmrn) FROM inpatient where `anew`<='$date77' and `dnew`>'$date77';"; 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);

$query44b = "SELECT COUNT(pmrn) FROM inpatient where `anew`<='$date77' and `dnew`='0000-00-00';"; 
$result44b = mysqli_query($con, $query44b) or die(mysqli_error());
$row44b = mysqli_fetch_assoc($result44b);


$query44a = "SELECT COUNT(pmrn) FROM inpatient where `dnew`='$date77'";
...
echo "<font color=blue font size=5.5><b> $date77-  HOSPITAL ACTIVITIES AT A GLANCE  - ";
...
echo "IPD-  ";	 
echo $row44['COUNT(pmrn)'] + $row44a['COUNT(pmrn)'] + $row44b['COUNT(pmrn)'];
echo "( Admitted: ";
echo $row44['COUNT(pmrn)']+$row44b['COUNT(pmrn)'];	
echo " + Discharged: ";
