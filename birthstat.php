...
$query44 = "SELECT COUNT(pmrn) FROM birthb where idate BETWEEN '$start' and '$end';"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Baby Name</strong></th>
	  ...
	  <th width="14%"><strong>More</strong>
	  <th width="14%"><strong>Birth Certificate</strong>
...
echo "  To  ";
echo $end1;
	 $sel_query="Select * from birthb where idate BETWEEN '$start'and '$end' order by idate asc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["bname"]; ?>
	  <td align="center"><?php echo $row["sex"]; ?>
	  <td align="center"><?php echo $row["weight"]; ?>
	  <td align="center"><?php echo $row["dname"]; ?>
	  <td align="center"><?php echo $bdate1= date('d/m/Y', strtotime($row["bdate1"])); ?>
	  
	  
	  <td align="center"><a target='_blank' href="deathstatdetails?pmrn=<?php echo $row['pmrn']; ?>"><b>Details<b></a></td>	  
	  <td ><a target='_blank' href="birthprint?pmrn=<?php echo $row['pmrn']; ?>"><img src="print.png" title="Print Report" width="100" height="60" /></a></td>  
      </tr>
