...
<input name="pmrn" id="pmrn"onkeyup="GetDetail(this.value)" type="text" placeholder="MRN" value="" style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:300px">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="name" id="pname" type="text" value="" required style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:300px">
 	  <label for="age"><strong>ADDRESS :</strong></label>
      <input name="padd" id="padd" type="text" size="85" value="" required style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:330px">
...
<option value='Sylhet'>Sylhet</option> 
	  ...
	  <label for="age"><strong>Gender :</strong></label>
	  	...
	  	<select name="psex" id="psex"class="style1" placeholder="Gender"  required  style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:120px"> 
	 ...
	 <input name="pphone" type="text" id="pphone" placeholder="Phone No"value="" required  style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:200px">	  
...
<input name="dd" id="dd" type="text" maxlength="2" size="1" value=""   required placeholder="DD" style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:60px">	/

<input name="mm" id="mm" type="text" maxlength="2" size="1" value=""   required placeholder="MM" style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:60px"> /	

<input name="yy" id="yy" type="text" maxlength="4" size="1" value=""    required placeholder="YYYY" style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:90px">		  
...
<label for="age"><strong>Patient's Type :</strong></label>
	 ...
	 <input name="cr" type="text" id="cr" placeholder="CR"value="" style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:60px">	  
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "gfg1_endo111.php?pmrn=" + str, true);
...
if (q=="" || g=="") {
  ...
  xmlhttp.open("GET","endo_slot.php?q="+q+"&dname2="+g, true);
