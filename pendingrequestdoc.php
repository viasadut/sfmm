...
<p align="center" class="style1">Generic Name Request List for Pharmacy To Proceed </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicinerequest where rstatus='Pending' and rby='$user'ORDER BY id desc;";
...
//$id =$_GET['id'];
//$count=1;
$sel_query="Select * from medicinerequest where rstatus ='waiting for approval' and rby ='$user'  ORDER BY id desc;";
