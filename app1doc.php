...
<form action="app1doc" method="POST">
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      <th align="center"width="4%"><strong>S.No</strong></th>
      <th align="center"width="17%"align="center"><strong>Patient's Name</strong></th>
      <th align="center" width="10%"><strong>MRN</strong></th>
      <th align="center"width="15%"><strong>Appointment Date </strong></th>
	  <th align="center"width="15%"><strong>Slot </strong></th>
      <th align="center"width="14%"><strong>Patient Phone</strong>   </th>
      <th align="center"width="14%"><strong>Doctor's Name</strong></th>
      <th align="center"width="14%"><strong>Status</strong></th>
	  <th align="center"width="14%"><strong>BILL</strong></th>
...
$count=1;
$sel_query="Select * from pappnew where dname='$full' and adate ='$start' order by aslot asc;";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo date('d/m/Y',strtotime($row["adate1"])); ?></td>
	  ...
	  <td align="center"><?php echo $row["bill"]; ?>  
      </tr>
