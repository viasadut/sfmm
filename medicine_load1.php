...
$objDB1 = mysqli_select_db($objConnect1,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$qq = mysqli_query($db,"select * from medi_load where id='".$_POST["chkDel"][$i]."'");
			...
			$strSQL = "update medicine set `tqty`='$b_leave1'";
			$strSQL .="WHERE code = '".$code."' ";
			$objQuery = mysqli_query($objConnect1,$strSQL);
			
			$strSQL1 = "insert into medi_stock (`code`,`g_name`,`b_name`,`add_qty`)
			values ('$code','$g_name','$b_name','$b_leave1')";
//			$strSQL1 .="WHERE code = '".$code."' ";
			$objQuery1 = mysqli_query($objConnect1,$strSQL1);
...
<td align="center"><input type="text" name="b_leave[]" id="b_leave<?php echo $i;?>" value="<?php echo $row['qty'];?>"readonly></td>
