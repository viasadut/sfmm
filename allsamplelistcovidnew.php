...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','qc','mrd','covid1','bill','lab')"; 
...
<ul>
   ...
   <li class='active has-sub'><a href='covidstatdeptnew'><span>Categorywise Print Covid Reports</span></a>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Print Barcode</strong>
...
$sel_query="Select * from covidopd where ssent between '$rd4' and '$adate' and status=''order by id desc;";
