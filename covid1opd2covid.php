...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`apdate`,`aptime`,`pro`) values
 ...
 '$adate','$email','$user','$adate1','$sam','$tp','$ssent','09:00AM','$pro')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`apdate`,`aptime`,`pro`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$ssent','10:00AM','$pro')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`apdate`,`aptime`,`pro`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$ssent','11:00AM','$pro')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`apdate`,`aptime`,`pro`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$ssent','12:00PM','$pro')";
