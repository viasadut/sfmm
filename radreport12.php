...
$this->Cell(80,10,'Patient Name',1,0,'C');
$this->Cell(15,10,'MRN',1,0,'C');
$this->Cell(22,10,'Date',1,0,'C');
$this->Cell(20,10,'Slot',1,0,'C');
$this->Cell(80,10,'Investigation',1,0,'C');
$this->Cell(20,10,'Location',1,0,'C');
...
$stmt = $db->query("Select * from radpapp where dname='$bt' and adate BETWEEN '$start' and '$end'and status !='Cancel' order by location asc");
while($data = $stmt->Fetch(PDO::FETCH_OBJ)){
$this->Cell(10,10,$data->dname,1,0,'L');
$this->Cell(80,10,$data->pname,1,0,'L');
$this->Cell(15,10,$data->pmrn,1,0,'L');
$this->Cell(22,10,$data->adate,1,0,'L');
$this->Cell(20,10,$data->aslot,1,0,'L');
$this->Cell(80,10,$data->tname,1,0,'L');
$this->Cell(20,10,$data->location,1,0,'L');
