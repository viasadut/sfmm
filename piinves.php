...
function Header()
{
    ...
    $this->Cell(0,6,' Inpatient Investigation Request Form',0,1,'C');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iinves where pmrn='$pmrn' and eid='$eid' and ordate='$dd' and type='lab'and rstatus  not in ('RECEIVED','REJECTED','Cancelled')",$prop);
$pdf->Output();
?>