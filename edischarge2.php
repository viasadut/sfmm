...
$update="update emergency set disstatus='Discharge Bill Confirmed', bstatustime='$adate1', buser='$user' where `id`='$id'";
...
<td colspan="20" align="center"><input type="text" name="infu" required value="Confirm Discharge Bill" ></td>
</tr> 
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from emergency where id= '$id' and dstatus='Discharge Requested' order by `id` DESC;";
