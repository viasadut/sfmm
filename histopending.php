...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="15%"><strong>Referral Doctor </strong>
      <th width="14%"><strong>Procedure</strong> 
      <th width="14%"><strong>Guide</strong>
...
$sel_query="Select * from fnac where remarks='NOT SEEN' ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["rfor"]; ?>
	  <td align="center"><?php echo $row["guide"]; ?>
	  <td align="center"><?php echo $row["adate1"]; ?>
      
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["cfind"];?> </td> 

	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="histopre?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">UPDATE</a> </td>
...
$sel_query="Select * from alltest where status='' and medi in ('FNAC') ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["status"];?> </td> 
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="histoprenew?pmrn=<?php echo $row["pmrn"]; ?>&id4=<?php echo $row["id"];?>&dname5=<?php echo $row["dname"];?>&daten=<?php echo $row["date1"];?>">UPDATE</a> </td>
