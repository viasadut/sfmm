...
$query39 = "SELECT * FROM purchase_stock4 where rfid= '$sno'"; 
...
if($res95=mysqli_num_rows($result95)==0)
{
    ...
    echo '</script>';
			...
			*/
			...
			$ins_query1="insert into purchase_stock4 (`code`,`g_name`,`b_name`,`add_qty`,`req_qty`,`req_loc`,`status`,`location`,`rfid`,`sno`,`u_price`,`t_price`,`req_by`,`re_time`,`remarks`,`lpdate`,`plevel`,`balance`,`musage`,`p_id`,`hod`,`ptype`)
 values ('$code1','$medi','$medi','','$tprice','$p_mrn1','Pending','$p_mrn1','$sno','$runningTime','$uprice','$charge','$user','$re_time','$ins','$lpdate','$plevel','$balance','$musage','$p_id','$hod','$ptype')";
...
$ins_query1="insert into purchase_stock4 (`code`,`g_name`,`b_name`,`add_qty`,`req_qty`,`req_loc`,`status`,`location`,`rfid`,`sno`,`u_price`,`t_price`,`req_by`,`re_time`,`remarks`,`lpdate`,`plevel`,`balance`,`musage`,`p_id`,`hod`,`ptype`,`incharge`)
values ('$code1','$medi','$medi','','$tprice','$p_mrn1','Pending','$p_mrn1','$sno','$runningTime','$uprice','$charge','$user','$re_time','$ins','$lpdate','$plevel','$balance','$musage','$p_id','$hod','$ptype','$incharge')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$count=1;
//$count=1;
$sel_query="Select * from purchase_stock4 where rfid= '$sno' order by `id` DESC;";
