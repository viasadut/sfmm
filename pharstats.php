<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','pharmacy','mrd','staff')"; 
...
/*$query43 = "SELECT COUNT(DISTINCT(pmrn)) FROM pmedi where ndate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Prescription Stats</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select End Date:</strong></label></td>	
							...
							<td colspan="3"><label><strong> Select</strong></label></td> 
...
$sel_query="Select distinct pmrn,dname,date from pmedi where ndate between'$start' and '$end' ;";
