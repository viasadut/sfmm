...
$query40 = "SELECT * FROM staff3 where sid='$sid3';"; 
...
<input type="text" name="sid" id="email" class="input-text" placeholder="SID" size="70"value="<?php echo $data1['sid'];?>"readonly>     
...
<input type="text" name="phone" id="email" class="input-text" placeholder="Phone" size="70"value="<?php echo $data1['cno'];?>"readonly>     

<label for="age"><strong>Address:</strong></label>
<input type="text" name="padd" id="email" class="input-text" placeholder="padd" size="70"value="<?php echo $data1['padd'];?>"readonly>     
