...
$ins_query="insert into idinves (`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`) values ('$pmrn','$pname','$eid','$medi','$pins','$date','$type')";
...
$count=1;
$sel_query="Select * from idinves where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="imoidmoinvesdelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
