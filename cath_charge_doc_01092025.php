...
$ins_query="insert into cath_charge (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`,`plevel`,`ieid`,`inorder`) values
( '$pmrn','$id','$pname_new','$otdate','$full','$sreport','$ottype','$date1','$charge','$plevel','$ieid','$inorder')";
//mysqli_query($con,$ins_query) or die(mysql_error());
...
echo '<script language="javascript">';
	...
	$ins_query="insert into cath_charge (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`,`date1`,`charge`,`plevel`,`ieid`,`inorder`) values
	( '$pmrn','$id','$pname_new','$otdate','$full','$sreport','$ottype','$date1','$charge1','$plevel','$ieid','$inorder')";
