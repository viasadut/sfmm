...
$query = mysqli_query($con,"select * from mc_report_format where type='$type' and dname='$dname'");
...
<table width="100%">
					 ...
					 <tr>
                        <td width="25%" style="text-align: right;"><img src="2.png" style="width:40px;height:40px;"></td>
                        <td width="50%" align="center" style="text-align: center; font-weight: bold; font-size:10px;">
					...
					<tr>
                        ...
                        <td width="100%" align="center" style="font-size:12px;text-decoration: underline;"><b>'.$data['type'].'</b></td>
...
'<br><br>
                ...
                <table style="border: 1px solid black; cellspacing:0; cellpadding:=1">
                    <tr>
                       <td align="left" width="50%"><b>Surgeon Name: '.$data['dreffer'].'</b></td>
                       <td align="right" width="50%"><b>Consent Date & Time: '.$data['date2'].' '.$data['time'].'</b></td>
                    </tr>
                </table>';
...
<br><br>
                <table style"=cellspacing:1;cellpadding:1;">
                    <tr>
                        <td align="left" width="100%">'.$data['inves'].'</td>
