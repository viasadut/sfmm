...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','mng','ot','endo','imo','mofficer','nurse','emergency','diet')"; 
...
$query11 = "SELECT * FROM inpatient where pmrn= '$pmrn5' and eid='$eid5'"; 
...
$query = "SELECT * FROM mc_report_format where id= '$id5'"; 
...
$query1 = "SELECT * FROM ot where pmrn= '$pmrn5' and eid='$eid5' order by id desc"; 
...
$q = "SELECT COUNT(id),id FROM all_consent_print where pmrn= '$pmrn5' and eid='$eid5' and cname='$cname' and date='$date_d' order by id desc"; 
...
$url = "consent_format_view_ns?pmrn=$pmrn1&eid=$eid1&cname=$cname&id=$f_id";
header("Location: $url");
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr><td colspan="20" style="font-size:18px;color:green;"><label><strong> Surgeon's Name : <?php echo $row1['dname'];?></strong></label></td></tr>
				<tr>
				...
				<td colspan="20" style="font-size:18px;color:green;"><label><strong> Surgery's Name : <?php echo $row1['proce'];?></strong></label></td>
