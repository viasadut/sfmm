...
<?php
    ...
    $query5 = mysqli_query($con,"select * from prothrombin where pmrn='$pmrn' and sno='$sno'");
...
if(isset($_POST['Submit'])){
    ...
    $ins_query1="UPDATE prothrombin SET
        `ptime`='$ptime',
        `pcontrol`='$pcontrol',
        `pratio`='$pratio',
        `inr`='$inr',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="pratio" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['pratio']?>" required />
            <label for="age"><strong>% Activity PT:</strong></label>
            <input name="pt" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['pt']?>" required />
            <label for="age"><strong>International Sensitivity Index, ISI:</strong></label>
            <input name="isi" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['isi']?>" required />
