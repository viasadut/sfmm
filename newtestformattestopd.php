...
function disableME()
{
  var test1 = document.getElementById('psex'),
      test2 = document.getElementById('plmp'),
      test3 = document.getElementById('clist');

  if (test1.value != FEMALE) 
  {
    test2.disabled = true;
    test3.disabled = true;
  }
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="view3newtest?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>Record of Previous Visits<b></a>&nbsp&nbsp&nbsp&nbsp<a href="view3newtesttest?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>&eid=<?php echo "$count1"?>"><b>Edit On Previous Visits<b></a>&nbsp;&nbsp;
		&nbsp;&nbsp;<a target='_blank' href="opdradreport?pmrn=<?php echo "$pmrn"; ?>"><b>Radiology Report<b></a>&nbsp;&nbsp;<a target='_blank' href="cardiolink?pmrn=<?php echo "$pmrn"; ?>"><b>Cardiology Report<b></a>&nbsp&nbsp<a target='_blank' href="http://192.168.100.254?pmrn=<?php echo "$pmrn"; ?>"><b>LAB REPORT<b></a>&nbsp;&nbsp;<a target='_blank' href="https://medex.com.bd"><b>medex.com.bd<b></a></td></tr>
				...
				<tr><td colspan="20"><label><strong>Doctor's Name :</strong></label></td></tr>
				<tr>	  
...
<tr>				 
					...
					<td colspan="3"><input type="text" name="page" required value="<?php echo $row['page'];?>" /></td>  	
					 <td colspan="1"><input type="text" id="psex"name="psex" required value="<?php echo $row['psex'];?>" /></td>
...
<tr>
<td colspan="7"><input type="text" id ="pperiod"name="pperiod" required value="<?php echo $row['pperiod'];?>" /></td>
<td colspan="7"><input type="text" id ="plmp"name="plmp" required value="<?php echo $row['plmp'];?>" onchange="disableME()"></td>
<td colspan="6"><input type="text" id ="clist"name="clist" required value="<?php echo $row['clist'];?>" onchange="disableME()"></td>
</tr>
<tr>
...
<tr><td colspan="20" bgcolor="lightgreen"><h3><a target='_blank' href="vacine?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Vaccine History</a>&nbsp;&nbsp;<a target='_blank' href="bhistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Birth History</a>&nbsp;&nbsp;<a target='_blank' href="pasthistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Past History</a>&nbsp;&nbsp;<a target='_blank' href="comordoc?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Comorbidities</a>&nbsp;&nbsp;<a target='_blank' href="idocinvesstat?pmrn=<?php echo "$pmrn"; ?>">Record Investigation Results</a></td></tr>					
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="cdetails" rows="5" required></textarea></td>  </tr>
						 
						 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="diagnosis" rows="5"required ></textarea></td>  </tr>
