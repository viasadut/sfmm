	...
	<table width="100%">
            ...
            <table  width="100%" >
              <tr>
                        ...
                        <td style="font-family: freesans; text-align:center;font-size:16px;font-weight:bold" width="40%"><b><?php echo $dname;?></b>
...
<table width="100%">
              ...
              <tr>
                        ...
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="65%"><b>Medicine Name</b>
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="10%"><b>Quantity</b>
                        </td>
<td style="font-family: freesans; text-align:left;font-size:12px;" width="10%"><b>U.Price</b>
                        </td>
						
						<td style="font-family: freesans; text-align:left;font-size:12px;" width="10%"><b>T.Price</b>
                        </td>
...
?>
                    ...
                    <tr>
                        ...
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="65%"><?php echo $row['medi'];?>
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="10%"><?php echo $row['qty'];?>
                        </td>
<td style="font-family: freesans; text-align:left;font-size:12px;" width="10%"><?php echo $row['uprice'];?>
                        </td>
...
?>
					...
					<tr>
                        <td style="font-family: freesans;font-size:12px;text-align:center" width="5%">
                        </td>
                        
                        

                        <td style="font-family: freesans; text-align:left;font-size:12px;font-weight:bold" width="65%">Discount
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="10%">
                        </td>
<td style="font-family: freesans; text-align:left;font-size:12px;" width="10%">(-)
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;font-weight:bold" width="10%">'.$row433['dis_amount'].'
                        </td>
                    </tr>';}?>
