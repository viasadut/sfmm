...
$rf=$b_chk_m['rfid'];
			...
			if($eqty5 >= $eqty2 and $mqty=='' and $mm_qty<$eqty2)
	{
...
$third_qtyb=$b_chk_7b['add_qty']+$second_qty;
if($third_qtyb>$second_qty)
{
$ins_query4="update medi_stock set `add_qty`='$third_qtyb' where rfid='$rfid1b'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}

else if($third_qtyb<$second_qty)
{
...
$forth_qtyc=$b_chk_7c['add_qty']+$forth_qtyb;
if($forth_qtyb>$third_qtyb)
{
$ins_query4="update medi_stock set `add_qty`='$forth_qtyb' where rfid='$rfid1c'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($forth_qtyb<$third_qtyb)
{
...
$fifth_qtyd=$b_chk_7d['add_qty']+$fifth_qty;
if($fifth_qtyb>$forth_qtyb)
{
$ins_query4="update medi_stock set `add_qty`='$forth_qtyb' where rfid='$rfid1d'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($fifth_qtyb<$forth_qtyb)
{
	$ins_query4="update medi_stock set `add_qty`='forth_qtyb' where rfid='$rfid1d'";
mysqli_query($con,$ins_query4) or die(mysql_error());
