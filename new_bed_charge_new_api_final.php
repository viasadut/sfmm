...
$sql = "INSERT INTO newbed_new (dname,pname,pmrn,adate,type,bno,eid,adate1,adatenew,tby,b_charge,charge) VALUES 
  ('$bed_dname','$bed_pname','$bed_pmrn','$adate','$bed_type','$bed_no','$bed_eid','$adate1','$bed_ate','Cron','$bed_c','$half_bed_charge')";
...
values ('$last_id','CR','111212','$date','$half_bed_charge','IPD_BED_CHARGE')";
mysqli_query($con,$ins_query) or die(mysql_error());


$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','DR','111999','$date','$half_bed_charge','IPD_BED_CHARGE')";
...
$ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','CR','111212','$date','$bed_c','IPD_BED_CHARGE')";
mysqli_query($con,$ins_query) or die(mysql_error());


$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','DR','111999','$date','$bed_c','IPD_BED_CHARGE')";
mysqli_query($con,$ins_query2) or die(mysql_error());
