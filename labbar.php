...
$query = mysqli_query($db,"select * from bcross1 where dmrn='$pmrn' and bagno='$sno'");
...
$pdf->SetXY(10,12);
$pdf->Cell('31.4',15.2,date('d/m/Y', strtotime($data1['udate'])),1,1,'L');
...
$pdf->SetXY(72.1,12);
$pdf->Cell('35',15.2,date('d/m/Y',strtotime($data1['edate'])),1,1,'L');
