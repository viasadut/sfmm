...
$sel9=mysqli_query($db,"SELECT * FROM radio WHERE `iname`='$medi1'");
$result9 = mysqli_fetch_assoc($sel9);
//$brand2=$result9["brand1"];

$sel990="SELECT * FROM radio WHERE `iname`='$medi1';";
...
$ins_query1="insert into proinves (`dname`,`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`,`type`,`ieid`,`page`,`psex`) values ('$full','$pmrn','$pname','$medi1','$pdos','$eid','$date1','$type','$ieid','$page','$psex')";
...
<tr><td colspan="5" align="center"bgcolor="lightblue"><label><strong>Name Of the Investigation</strong></label></td>
<td colspan="15" align="center"bgcolor="lightblue"><label><strong>Instruction</strong></label></td>
 </tr>
<tr>

<td colspan="5" align="center"><input list="browsers1" name="medi1" class="form-control">
...
$count=1;
$sel_query="Select * from proinves where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="prodelete1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>">DELETE</a></td>
