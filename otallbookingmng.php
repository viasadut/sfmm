...
$query43 = "SELECT COUNT(pmrn) FROM ot where otdate BETWEEN '$start' and '$end' and status IN ('','Recevied','Done')" ;
...
$count=1;
$sel_query="Select * from ot where otdate BETWEEN '$start' and '$end' and status IN ('','Recevied','Done')";
