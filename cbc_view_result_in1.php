...
$query = mysqli_query($db,"select * from cbctbl where sno='$id'");
...
$pdf->Cell('40',5,'0-20',1,1,'C');
	...
	{
		$pdf->SetTextColor(000,0,0);
$pdf->Cell('80',5,'Pro-Myclocyte',1,0,'C');
...
$pdf->Cell('40',5,'',1,1,'C');
	...
	{
		$pdf->SetTextColor(000,0,0);
$pdf->Cell('80',5,'Metamyclocyte',1,0,'C');
...
$pdf->Cell('40',5,'',1,1,'C');
	...
	{
		$pdf->SetTextColor(000,0,0);
$pdf->Cell('80',5,'Lymphoblast',1,0,'C');
