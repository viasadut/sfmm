...
$ins_query="insert into idiet (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
<td colspan="4" align="center"><label><strong>Diet</strong></label></td> 
<td colspan="4" align="center"><label><strong>Done Date</strong></label></td>
<td colspan="4" align="center"><label><strong>Result</strong></label></td></tr>
...
<td colspan="4" align="center"><input list="rr" name="infu" size=60% class="form-control">
  <datalist id="rr">

						<option value=''>-Select Diet</option>
				<?php 
			$sql76 = "select * from `diet`";
			$res76 = mysqli_query($con, $sql76);
			if(mysqli_num_rows($res76) > 0) {
				while($row76 = mysqli_fetch_object($res76)) {
					echo "<option value='".$row76->dietn."'>".$row76->dietn."</option>";
				}
			}
			?>  </datalist></td>
