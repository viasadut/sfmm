...
{
return confirm("Are you Sure to Confirm This Code Call?");
}
...
<p align="center" class="style1">Active Code Call Panel</p> 
...
<tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr>
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Confirm Code Call</strong>   
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from code_call where call_c_status='1' order by id desc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
	...
	<td align="center" style="color:black; font-size:22px; font-weight:bold;">
  ...
  <?php echo $row['location'];;?>
    ...
    <form action="call_code/updateDBLED.php" method="post" id="LED_ON" name="LED_ON">
      ...
      <button class="buttonON" name= "call_update" type="submit" onclick="return confirm_click1();">Confirm Code Call</button>
