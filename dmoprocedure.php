...
$ins_query="insert into edprocedure (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Doctor's Procedure note</strong></label></td> </tr>
<tr>


<td colspan="4" align="center"><label><strong>Procedure Name</strong></label></td> 
<td colspan="16" align="center"><label><strong>Procedure Note</strong></label></td> 
</tr>
<tr>
...
<tr>
	  ...
	  <td colspan="2" align="center"><strong>Procedure Note</strong></td>
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="2"><?php echo $row["room"]; ?></td>
  	  ...
  	  <td align="center" colspan="2"><a href="dmoproceduredelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td> 
