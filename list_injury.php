...
$sel_query="Select * from injury where pmrn= '$pmrn' and user='$full' and status='Pending' order by id desc;";
 $count=1;	 
...
<a target='_blank' href="injurycertificate_new.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>">Issue Injury Certificate</a>
</td>
