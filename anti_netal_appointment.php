...
('$name', '$pmrn','$pphone','$padd','$doc1','$date_nn1','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$date_nn','Anti_netal_gyane','BILLED','$user','$aatime','$ptype')";
...
if(mysqli_query($con,$ins_query)==true){
	...
	$query44 = "SELECT * FROM pappnew where pmrn='$pmrn' and adate='$date_nn1' and page1='Anti_netal_gyane'"; 
...
<input name="yy" id="yy" type="text" maxlength="4" size="1" value="<?php echo $year;?>" required placeholder="YYYY" readonly>		  
	  ...
	  <br><br> 
		...
		<option value="">--Select--</option>
			<?php $sql6 = "select * from doctor where Discipline like('gy%') and status='active' and type='res' ";
