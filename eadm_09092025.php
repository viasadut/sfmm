...
$ins_query="insert into emergency (`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`eid`,`pphone`,`user`,`adate1`,`yage`,`adate2`,`type`) values ('$pname','$pmrn','$padd','$psex','$diff1','$adate','$eid','$pphone','$user','$adate1','$diff2','$adate2','$type')";
