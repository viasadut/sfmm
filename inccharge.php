...
<?php
	$stmt = $DB_con->prepare("SELECT distinct ctype FROM concharge");
	$stmt->execute();
...
?>
		...
		<label for="mail"><strong>Charge :</strong></label>
									<p>
...
$count=1;
$sel_query="Select * from ivisit where pmrn= '$pmrn' and eid='$eid'  order by `id` DESC;";
