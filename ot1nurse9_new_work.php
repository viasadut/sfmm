...
$id=$_REQUEST['id']; 
$query39 = "SELECT * FROM con_work where id= '$id'"; 
...
$query40 = "SELECT * FROM inpatient where pmrn= '".$row39['pmrn']."' and idisconfirm !='Confirmed'"; 
...
$update="update con_work set status='Booked',b_by='$user',b_time='$b_time' where `id`='$id'";
...
<!-- Google Font -->
		...
		<tr>
						...
						<td colspan="10" align='left' style="font-size: 20px;"><label><strong>Patient's MRN:<?php echo $row39['pmrn'];?></strong></label></td>
						<td colspan="10" align='left' style="font-size: 20px;"><label><strong>Patient's Gender:<?php echo $row39['psex'];?></strong></label></td>
						...
						<td colspan="10" align='left' style="font-size: 20px;"><label><strong>Patient's Name:<?php echo $row39['pname'];?></strong></label></td>
						<td colspan="10" align='left' style="font-size: 20px;"><label><strong>Patient's Phone:</strong> <?php echo $row39['pphone'];?></label></td>
						...
						<td colspan="10" align='left' style="font-size: 20px;"><label><strong>Patient's Age: <?php echo $row39['page'];?></strong></label></td>
						<td colspan="10" align='left' style="font-size: 20px;"><label><strong>Admission Date:<?php echo $addate;?></strong></label></td>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="20"><select name="dname1" value="" class="country"required>
			        
<option "<?php echo $row39['dname'];?>"><?php echo $row39['dname'];?></option>
</select>
					...
					<input name="ID" type="hidden" value="<?php echo $row39['id'];?>" />
						</select></td>
...
<option ="<?php echo $row39['pro_name'];?>"><?php echo $row39['pro_name'];?></option>
<?php
	$stmt = $DB_con->prepare("SELECT * FROM privilege where did='$dcode' and status='Approved'");
	$stmt->execute();
...
"jsnew/select2.min.css" />
		...
		<tr>
			    	 ...
			    	 <td colspan="4"><input type="date" name="otdate"  placeholder="Select Date" value="<?php echo $row39['date'];?>"size="15" required></td>  
