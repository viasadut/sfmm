...
<a target='$_blank' href="cggtttt?pmrn=<?php echo $pmrn; ?>"><strong>OPEN DOCTOR APPOINTMENT SLOT</strong></a>
...
<?php 
	  ...
	  <td align="center"><?php if($user!='929'){echo"<a ' href='$url4'><strong>Admission Request</strong></a>";} else {echo 'Allocation Amount Exceeded for the Month';}?></td>
