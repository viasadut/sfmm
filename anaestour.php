...
$ins_query="insert into anaestour (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`,`pad`,`atime`,`rtime`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','Data Updated','$odate1','$time','$date','Active','$remarks','$pad','$atime','$rtime')";
...
<td colspan="5" align="center"><label><strong>Site</strong></label></td>
<td colspan="2" align="center"><label><strong>Padding</strong></label></td>
<td colspan="3" align="center"><label><strong>Application Time</strong></label></td>
<td colspan="3" align="center"><label><strong>Release Time</strong></label></td>

</tr>
<tr>
<td colspan="2" align="left"><input type="text" class="style" name="date" id="datepicker" placeholder="Select Date" value="<?php echo date('m/d/Y');?>" required></td>
<td colspan="5" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
  <datalist id="browsers1">

						<option value=''>-Select Investigation</option>
				<?php 
			$sql = "select * from `radio1`";
...
<td colspan="2" align="center"><select name="pad" class="form-control"required>
...
<option value="NO">NO</option>
  ...
  <td colspan="3" align="center"><input type="text" name="atime" required value="" /></td>
  <td colspan="3" align="center"><input type="text" name="rtime" required value="" /></td>
...
$count=1;
$sel_query="Select * from anaestour where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
