...
<?php
		...
		<?php
           /* require('db1.php');
            $uname = '';
            $query9 = "select * from `careshope_new`";
            $result9 = mysqli_query($con, $query9);
            while($row9 = mysqli_fetch_array($result9)) {
        ?>
            <option value="<?php echo $row9['code']; ?>"><?php echo $row9['iname']; ?></option>
        <?php }*/ ?>
</datalist>
	  ...
	  <td colspan="3">
<input type="text" name="b_name" id="brand" required value=""  style="font-weight: bold;font-size:14px;color:green">
</td>
