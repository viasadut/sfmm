...
$query = mysqli_query($db,"select * from storenew_edit where ittime1='$ed'");
...
$count=1;
$query1 = mysqli_query($db,"select * from storenew_edit where ittime1='$ed'");
...
$pdf->SetFont('Arial' , '' , 6);
$pdf->Cell('20' , 5,$data1['eid'],1,0,'L');
$pdf->Cell('70' , 5,$data1['ename'],1,0,'L');
$pdf->Cell('10' , 5,'',1,0,'L');
$pdf->Cell('10' , 5,'',1,0,'L');
...
$pdf->Cell('50',5,$data['adate'],1,0,'L');
