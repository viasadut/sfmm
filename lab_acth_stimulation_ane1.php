...
require('db1.php');
    ...
    if(isset($_POST['Submit'])){
        ...
        $ins_query1="INSERT INTO lab_acth_stimulation (`pname`,`pmrn`,`pphone`,`psex`,`page`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`0min`,`60min`,`interpretation`) values 
                    ('$pname','$pmrn','$pphone','$psex','$page','$user','$adate','$eid','$iname','$id','$sno','$min0','$min60','$interpretation')";
