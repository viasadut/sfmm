...
$sel3="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '6D%' order by id desc limit 1";
...
$sel6="Select COUNT(id) from inpatient where room1 like '6D%' and discharge=''";
...
$sql="Select * from inpatient where room1 like '6D%' and discharge='' order by room1 asc";
