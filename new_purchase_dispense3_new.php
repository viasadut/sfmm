...
?>
 ...
 {  
	  ...
	  $rfid4 = mysqli_real_escape_string($connect, $_POST["code"]);  
...
$nqty=$tqty-$sqty;
	...
	$query5 = "SELECT * FROM purchase_stock where code= '$rfid4' and location='Store'"; 
...
if(mysqli_query($con,$query)==true){			
			...
			$ins_query3="update purchase_stock set `add_qty`='$nqty' where code='$code2' and location='Store'";
...
$strSQL3 = "insert into purchase_stock2 (`code`,`location`,`g_name`,`b_name`,`given_qty`,`req_qty`,`exdate`,`batch_no`,`sno`,`add_date`,`s_rfid`,`u_price`,`t_price`,`rfid`)
values('$code2','$rloc','$g_name','$b_name','$sqty','$reqty','$exdate','$batch_no','$lrfid','$date2','$rfid','$uprice','$tprice','$rfid')";
...
if(mysqli_query($con,$query)==true){			
			...
			$ins_query3="update purchase_stock set `add_qty`='$nqty' where code='$rfid4' and location='Store'";
//mysqli_query($con,$ins_query3) or die(mysql_error());
...
$strSQL3 = "insert into purchase_stock2 (`code`,`location`,`g_name`,`b_name`,`given_qty`,`req_qty`,`exdate`,`batch_no`,`sno`,`add_date`,`s_rfid`,`u_price`,`t_price`,`rfid`)
values('$code2','$rloc','$g_name','$b_name','$sqty','$reqty','$exdate','$batch_no','$lrfid','$date2','$rfid4','$uprice','$tprice','$rfid')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
//			$objQuery3 = mysqli_query($objConnect,$strSQL3);
}
