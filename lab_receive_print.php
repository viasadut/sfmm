...
if($data1['barcode2']!='' and $data1['barcode3']!=''){
			...
			<b>'.$data1['barcode1'].'-1st Sample</b><br>
			<barcode code="'.$data1['barcode2'].'" type="C128A" class="barcode" /><br>
			<b>'.$data1['barcode2'].'-2nd Sample</b><br>
			<barcode code="'.$data1['barcode3'].'" type="C128A" class="barcode" /><br>
			<b>'.$data1['barcode3'].'-3rd Sample</b><br>
			'.$data1['pname'].'<br>
			'.$data1['pmrn'].'<br>
			'.$data1['medi'].'<br>
			'.$data1['retime'].'
				...
				else if($data1['barcode2']!='' and $data1['barcode3']==''){
