...
<?php
$full = $row39['fullname'];
$sel453="SELECT * FROM ot WHERE `pmrn`='$pmrn' and id='$id' ;";
...
$sel90="SELECT * FROM otconsent2 WHERE `pmrn`='$pmrn' and `eid`='$id' and `pro`='$pro';";
...
$ins_query="insert into otconsent2 (`pmrn`,`eid`,`pname`,`dname`,`padd`,`psex`,`tdate`,`pro`,`page`,`user`,`tdate1`,`ward`,`bed`) values 
('$pmrn','$id','$ppname','$anes','$padd','$psex','$idate','$pro','$page','$user','$idate1','Endoscopy','Daycare')";
...
<label for="age"><strong>Patient's Name :</strong></label>
      ...
      <input name="dname" type="text" size="80" value="<?php echo $row53['nanes']; ?>" readonly>          
...
<td><a target='_blank' href="otconsentprint2.php?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"; ?>&pro=<?php echo "$pro"; ?>&dname=<?php echo "$dname"; ?>&anes=<?php echo "$anes"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
