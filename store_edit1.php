...
$query43 = "SELECT * FROM storenew_edit where id= '$id';"; 
...
$query22 = "SELECT COUNT(iid) FROM storenew_edit where iid='$id'"; 
$result22 = mysqli_query($con, $query22) or die(mysqli_error());
$row22 = mysqli_fetch_array($result22);
$eid1= $row22['COUNT(iid)']+1;  
...
$ins_query1="update storenew_edit set price='$uprice',cprice='$cprice',eby='$user',edate='$edate',uprice='$uprice1',mar='$mar',ename='$ename' where id='$id'";
...
<label for="age"><strong>Current Price:</strong></label><br><br>	
			<input  name="oprice" type="text" size="70" value="<?php echo $row1['oprice'];?>"readonly>			
				        <br><br>
			<label for="age"><strong>Proposed Price (OPD):</strong></label><br><br>	
			<input  name="uprice" id="uprice" type="text" size="70" value="<?php echo $row1['price'];?>"required>
			<br><br>
			<label for="age"><strong>Proposed Price (IPD):</strong></label><br><br>	
			<input  name="uprice1" type="text" size="70" value="<?php echo $row1['uprice'];?>">
