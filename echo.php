...
$ins_query="insert into echo (`dname`,`rname`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`proname`,`ao`,`lvid`,`ef`,`mva`,`la1`,`lvids`,`ivsd`,`avring`,`acs`,`fs`,`pa`,`epss`,`rvid`,`mvan`,`pwt`,`rvot`,`eaxis`,`poro`,`la`,`lv`,`rv`,`mv`,`av`,`pv`,`tv`,`ias`,`ivs`,`peri`,`intramass`,`v1`,`p1`,`m1`,`r1`,`va1`,`v2`,`p2`,`m2`,`r2`,`va2`,`v3`,`p3`,`m3`,`r3`,`va3`,`v4`,`p4`,`m4`,`r4`,`va4`,`pht`,`earation`,`pasp`,`padp`,`aduration`,`srdv`,`apv`,`mvalve`,`dvalve`,`avalve`,`pvalve`,`eorg`,`tee`,`wall`,`impression`,`advice`,`eid`) 
values('$dname','$rname','$pmrn','$pname','$page','$psex','$pphone','$proname','$ao','$lvid','$ef','$mva','$la1','$lvids','$ivsd','$avring','$acs','$fs','$pa','$epss','$rvid','$mvan','$pwt','$rvot','$eaxis','$poro','$lx','$lx2','$lx3','$lx4','$lx5','$lx6','$lx7','$lx8','$lx9','$lx10','$lx11','$v1','$p1','$m1','$r1','$va1','$v2','$p2','$m2','$r2','$va2','$v3','$p3','$m3','$r3','$va3','$v4','$p4','$m4','$r4','$va4','$pht','$earation','$pasp','$padp','$aduration','$svdv','$apv','$lx13','$lx12','$lx13','$lx14','$lx15','$tee','$wall','$impression','$advice','$count1')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="viewradrecord?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo $row['dreffer'];?>"><b>See Clinical Details<b></a></td></tr>
				...
				<tr>	  
				<td colspan="10"><input type="text" name="dname"  required value="<?php echo $full;?>" readonly/></td></td>
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
					 ...
					 <td colspan="5"><input type="text" name="pphone" required value="<?php echo $pp;?>" readonly/></td>  
					  ...
					  <td colspan="5"><select name="proname">
	...
	<tr><td colspan="20"bgcolor='lightgreen'align="center"><label><strong>MEASUREMENTS</label></strong></td></tr>				 
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="ao" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="lvid" required value=""></td>
					 <td colspan="5"><input type="text" name="ef" required value=""></td>  
...
<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="la1" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="lvids" required value=""></td>
					 <td colspan="5"><input type="text" name="ivsd" required value=""></td>  


					 <td colspan="5"><input type="text" name="avring" required value=""></td>  
					 </tr>					 
					 ...
					 <tr>
						...
						<td colspan="5"><label><strong>FS (mm) </strong></label></td>
						...
						<tr>				
						<td colspan="5"><input type="text" name="acs" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="fs" required value=""></td>
					 <td colspan="5"><input type="text" name="pa" required value=""></td>  
...
<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="rvid" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="mvan" required value=""></td>
					 <td colspan="5"><input type="text" name="pwt" required value=""></td>  
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="eaxis" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="poro" required value=""></td>
...
<td colspan="2"><input type="text" name="v1" required value=""></td>
<td colspan="2"><input type="text" name="p1" required value=""></td>
<td colspan="2"><input type="text" name="m1" required value=""></td>
<td colspan="2"><input type="text" name="r1" required value=""></td>
<td colspan="2"><input type="text" name="va1" required value=""></td>
...
<td colspan="2"><input type="text" name="v2" required value=""></td>
<td colspan="2"><input type="text" name="p2" required value=""></td>
<td colspan="2"><input type="text" name="m2" required value=""></td>
<td colspan="2"><input type="text" name="r2" required value=""></td>
<td colspan="2"><input type="text" name="va2" required value=""></td>
  </tr>
  
  <tr>
  
  <td colspan="5"><label><strong>PV (0.6-0.7)</strong></label></td>
<td colspan="2"><input type="text" name="v3" required value=""></td>
<td colspan="2"><input type="text" name="p3" required value=""></td>
<td colspan="2"><input type="text" name="m3" required value=""></td>
<td colspan="2"><input type="text" name="r3" required value=""></td>
<td colspan="2"><input type="text" name="va3" required value=""></td>
...
<td colspan="2"><input type="text" name="v4" required value=""></td>
<td colspan="2"><input type="text" name="p4" required value=""></td>
<td colspan="2"><input type="text" name="m4" required value=""></td>
<td colspan="2"><input type="text" name="r4" required value=""></td>
<td colspan="2"><input type="text" name="va4" required value=""></td>
 ...
 <tr>
<td colspan="5"><input type="text" name="pht" required value=""></td>
<td colspan="5"><input type="text" name="earation" required value=""></td>
<td colspan="5"><input type="text" name="pasp" required value=""></td>
<td colspan="5"><input type="text" name="padp" required value=""></td>
 ...
 <tr>
<td colspan="5"><input type="text" name="adura" required value=""></td>
<td colspan="5"><input type="text" name="svdv" required value=""></td>
<td colspan="5"><input type="text" name="arv" required value=""></td>
<td colspan="5"><input type="text" name="adur" required value=""></td>
...
<tr><td colspan="20"><label><strong>Wall Motion:</strong></label></td>  </tr>
						 ...
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="impression" rows="5" ></textarea></td>  </tr>
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="echoreport.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname=<?php echo "$dname3"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
