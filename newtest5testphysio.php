...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="10" align="center"bgcolor="lightgreen"><strong>Old Medicine </strong></td>
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="5"><input type="text" name="test" id="test" value="<?php echo $row["pdos"]; ?>";></td>
				  
				  
	  <td align="center" colspan="2"><a href="delete1testphysio?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid1=<?php echo "$eid1"; ?>&eid=<?php echo "$eid"; ?>&pname=<?php echo $row["pname"]; ?>&medi=<?php echo $row["medi"]; ?>&test=<?php echo $row["pdos"]; ?>">ADD</a></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="delete1ttphysio?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&eid1=<?php echo "$eid1"; ?>">DELETE</a></td>
