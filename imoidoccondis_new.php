...
$urgent = "consultant_confirmation_urgent?pmrn=$pmrn&eid=$eid";
      ...
      else if($dconfirm=='' and $d_type=='Confirm Death Declaration Request'){echo "<a href='$urgent'>Confirm Death Certificate On Behalf of Consultant</a>";}
