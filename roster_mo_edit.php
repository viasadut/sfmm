...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('imo','mofficer')"; 
...
$ins_query1="update staff3 set c_location='$opd',eby='$user',etime='$etime' where sid='$sid1'";
...
<select name="opd" required>
		...
		<option value='<?php echo $data['c_location'];?>'selected><?php echo $data['c_location'];?></option>
		...
		<option value='Gaynae Department'>Gaynae Department</option>
