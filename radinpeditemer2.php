...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eid' and status IN ('RECEIVED','REJECTED','Data Updated') and type='rad'  order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="4"><?php echo $row["infusion"]; ?></td>
		...
		<td colspan="1" align="center"><a href="radedit2emer1?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>EDIT</strong></a></td>	  
