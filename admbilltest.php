...
else if(empty($_REQUEST['bno']))

{
       echo '<script language="javascript">';
    echo 'alert("No Bed Selected!!"); ';
    echo '</script>';
...
$update212="update preadm set status='Admitted', fname='$fname', mname='$mname', peradd='$peradd', nid='$nid', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political', vcard='$vcard', vcard1='$vcard1', pmode='$pmode', premarks='$premarks' where `id`='$id'";
mysqli_query($con,$update212);


$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`)
values ('$dname', '$pname','$pmrn','$padd','$gender','$page','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1')";
...
$update111="update emergency set discharge='Admitted', disstatus='SEEN',fstatustime='$date1',ddate1='$ddate1', duser='$user' where pmrn='$pmrn'";
mysqli_query($con,$update111) or die(mysql_error());

$update112="update erefferal set status='Admitted'where pmrn='$pmrn'";
...
//$id=$_REQUEST['ID'];
//$adate=$_REQUEST['adate'];
$query49 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and discharge=''");
...
<td colspan="10">		<a target='_blank' href="admnew?pmrn=<?php echo "$pmrn"; ?>&adoc=<?php echo $data49["adoc"]; ?>&adate=<?php echo $data49["adate"]; ?>&eid=<?php echo $count1; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>
