...
-->
  ...
  <head>
    <title>Purchase & Store Stock</title>
...
$sel_query="Select DISTINCT code,g_name from purchase_stock3 where location='$start' ORDER BY code asc;";
...
$sum = "SELECT SUM(add_qty) FROM purchase_stock3 where code='$mcode' and location='$start' and status in('Served','')" ;
...
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $start; ?></td>
