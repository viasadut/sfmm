...
$update="update ecg set `ron`='$ron',`vent`='$vent',`qwave`='$qwave',`arate`='$arate',`st`='$st',`rhy`='$rhy',`twave`='$twave',`pwave`='$pwave',
`qt`='$qt',`pr`='$pr',`qtc`='$qtc',`qrs`='$qrs',`uwave`='$uwave',`qrsc`='$qrsc',`ebeats`='$ebeats',`qrsvol`='$qrsvol',
`others`='$others',`eaxis`='$eaxis',`poro`='$poro',`comments`='$comments',`status1`='Confirmed' where pmrn='$pmrn' and eid='$eid'";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="viewradrecord?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo $row['dreffer'];?>"><b>See Clinical Details<b></a></td></tr>
				...
				<td colspan="10"><input type="text" name="dname"  required value="<?php echo $rowecg["dname"];?>" readonly/></td></td>
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $rowecg["pmrn"];?>" readonly/></td>
	...
	<tr><td colspan="20"bgcolor='lightgreen'align="center"><label><strong>ELECTROCARDIOGRAPHY REPORT</label></strong></td></tr>				 
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="vent"  value="<?php echo $rowecg["vent"];?>" readonly></td>  
             		
					 <td colspan="5"><input type="text" name="qwave"  value="<?php echo $rowecg["qwave"];?>" readonly></td>
					 <td colspan="5"><input type="text" name="arate"  value="<?php echo $rowecg["arate"];?>" readonly></td>  


					 <td colspan="5"><input type="text" name="st" value="<?php echo $rowecg["st"];?>" readonly></td>  
					 </tr>
...
<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="rhy"  value="<?php echo $rowecg["rhy"];?>" readonly></td>  
             		
					 <td colspan="5"><input type="text" name="twave"  value="<?php echo $rowecg["twave"];?>" readonly></td>
					 <td colspan="5"><input type="text" name="pwave"  value="<?php echo $rowecg["pwave"];?>" readonly></td>  


					 <td colspan="5"><input type="text" name="qt"  value="<?php echo $rowecg["qt"];?>" readonly></td>  
					 </tr>					 
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="pr"  value="<?php echo $rowecg["pr"];?>" readonly></td>  
             		
					 <td colspan="5"><input type="text" name="qtc"  value="<?php echo $rowecg["qtc"];?>" readonly></td>
					 <td colspan="5"><input type="text" name="qrs"  value="<?php echo $rowecg["qrs"];?>" readonly></td>  


					 <td colspan="5"><input type="text" name="uwave" value="<?php echo $rowecg["uwave"];?>" readonly></td>  
					 </tr>	
...
<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="qrsc"  value="<?php echo $rowecg["qrsc"];?>" readonly></td>  
             		
					 <td colspan="5"><input type="text" name="ebeats"  value="<?php echo $rowecg["ebeats"];?>" readonly></td>
					 <td colspan="5"><input type="text" name="qrsvol"  value="<?php echo $rowecg["qrsvol"];?>" readonly></td>  


					 <td colspan="5"><input type="text" name="others" value="<?php echo $rowecg["others"];?>" readonly></td>  
					 </tr>
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="eaxis"  value="<?php echo $rowecg["eaxis"];?>" readonly></td>  
             		
					 <td colspan="5"><input type="text" name="poro"  value="<?php echo $rowecg["poro"];?>" readonly></td>
						...
						<tr><td colspan="20"><label><strong>Comments / Observation / Remarks:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="comments" rows="5" readonly><?php echo $rowecg["comments"];?></textarea></td>  </tr>
