...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('nurse','doctor','imo')"; 
...
<p align="center" class="style1">List Of Cardiology Report </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecg where status1='Confirmed' and pmrn='$pmrn';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from echo where status1='Confirmed' and pmrn='$pmrn';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ett where status1='Confirmed' and pmrn='$pmrn';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from cathreport where status1='Confirmed' and pmrn='$pmrn' ;";
