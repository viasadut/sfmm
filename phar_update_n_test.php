...
<td colspan="1" class='itotal' <?php if($row1['tqty']>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>></td>
	...
	<td colspan="10"align="right" style="font-weight: bold;font-size:22px;color:green">Grand Total</td>
	<td colspan="10"align="right" id='gtotal'style="font-weight: bold;font-size:22px;color:green"></td>
	<tr>
