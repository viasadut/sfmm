...
$query1 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and rdate='$rdate' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2='' and barcode3=''");
...
$pdf->Code128(8,1,$data1['barcode1'],23,8);
//$pdf->ln(10);
}


$query11 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and rdate='$rdate' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2 !='' and barcode3 !=''");
...
$pdf->SetXY(1,10.3);
//$pdf->SetXY(23,1);
$pdf->Cell('5',2,$data11['barcode1'],0,0,'L');
...
$pdf->SetXY(1,18.5);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data11['medi'],0,0,'L');
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data11['retime'].'(OPD)-1st',0,0,'L');


$pdf->Code128(8,1,$data11['barcode1'],23,8);
//$pdf->ln(10);
}


$query111 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and rdate='$rdate' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2 !='' and barcode3 =''");
...
$pdf->SetXY(1,10.3);
//$pdf->SetXY(23,1);
$pdf->Cell('5',2,$data111['barcode1'],0,0,'L');
...
$pdf->SetXY(1,18.5);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data111['medi'],0,0,'L');
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data111['retime'].'(OPD)-1st',0,0,'L');


$pdf->Code128(8,1,$data111['barcode1'],23,8);
//$pdf->ln(10);
}
...
$query2 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and rdate='$rdate' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2 !=''");
...
$query3 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and rdate='$rdate' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode3 !=''");
