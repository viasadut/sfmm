...
$dreffer=$row['dreffer'];
  ...
  $query43 = "SELECT * FROM lab_test where lid= '$sid';"; 
...
$ins_query="update lab_test set details='$cdetails' where lid='$sid'";
...
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$old_details','$count1','$date1','$date2','$stime','Updated','OPD','$date_d','$inves','$sid','$user','$add_time')";
