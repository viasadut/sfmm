...
<td align="center"><a onclick="return confirm_click();" href="sms_test1?id=<?php echo $row["id"]; ?>&uname=<?php echo $row["uname"]; ?>&type=<?php echo $row["type"]; ?>&bal=<?php echo $row["total"]; ?>"><strong>Confirm</strong></a></td>
