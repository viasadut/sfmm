...
<p align="center" class="style1" style="color:black; font-weight:bold; font-size:40px;">Pharmacy 2nd Floor</p> 
...
<br><span style="color:black;font-size:28px;text-align:center;font-weight:bold"><a target='_blank' href='phar_opd_02'>(<?php echo $row_opd['COUNT(distinct(pmrn))'];?>)</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a href="phar_out_02?sno=<?php echo $runningTime;?>">OPD Sale</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_scan_02">Scan Prescription</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_scan_return_02">Return Medicine(OPD)</a></span>
