...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and odate ='$dd' and reuse='';";
...
<tr><td colspan="10"><a target='_blank' href="testpdf1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&tdate=<?php echo "$dd";?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
