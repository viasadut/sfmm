...
//$id =$_GET['id'];
$count=1;
$sel_query="Select distinct sno,pmrn,adate,aby from phar_sale where s_type='Transfer' and status='Pending' order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="phar_update_out?pmrn=<?php echo $row["pmrn"]; ?>&sno=<?php echo $row["sno"]; ?>">UPDATE</a></td>
