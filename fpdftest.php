...
*                                                                              *
*******************************************************************************/
function FPDF1($orientation='P', $unit='mm', $format='A4')
{
	//Some checks
	$this->_dochecks();
...
function SetFont($family, $style='', $size=0)
{
	...
	if(!isset($this->fonts[$fontkey]))
	{
		...
		{
			if(!isset($FPDF1_charwidths[$fontkey]))
			{
				//Load metric file
				$file=$family;
...
{
	if(!defined('FPDF1_FONTPATH') && is_dir(dirname(__FILE__).'/font'))
		define('FPDF1_FONTPATH',dirname(__FILE__).'/font/');
	return defined('FPDF1_FONTPATH') ? FPDF1_FONTPATH : '';
}
...
function _putinfo()
{
	$this->_out('/Producer '.$this->_textstring('FPDF1 '.FPDF1_VERSION));
	if(!empty($this->title))
