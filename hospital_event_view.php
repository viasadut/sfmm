...
$count=1;
$sel_query="Select * from cme where status= 'Approved' and category='Hospital Event' order by `id` DESC;";
...
<td align="center"colspan="2"><a  target='_blank' href="tender/equipment/Contact_management_event?e_name=<?php echo $row["topic"]; ?>">Add Invitee</td>
