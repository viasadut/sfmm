...
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated','$ndate','Ordered','$alert','$reuse','$cc')";
...
<td colspan="2" align="center"><input list="rr10" name="root" class="form-control">
  <datalist id="rr10">
			  ...
			  <td colspan="1" align="center"><input list="infu2" name="infu2" class="form-control" value="<?php echo '1';?>">
  <datalist id="infu2">
