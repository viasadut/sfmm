...
$ins_query="insert into dialysisstret (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`) 
...
{
return confirm("Are you Sure to Stop The Special Order?");
}
...
$count=1;
$sel_query="Select * from dialysisstret where pmrn= '$pmrn' and eid='$eid' and odate='$odate'and status1 != 'Cancel' order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="dialysisdocsocancel?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Cancel</a></td>
