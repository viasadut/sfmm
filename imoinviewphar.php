...
<td align="center">
<?php if($count574d1=='' and $confirmdn!='' and $count574d<=0){echo"<span style='background-color:lightgreen'><a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";}
else if($count574d1=='' and $confirmdn!='' and $count574d>0){echo"<span style='background-color:red'><a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";}
else if ($count574d1!='' and $confirmdn!='' and $count574d>0){echo"<style='background-color:red'><a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";} 
else if ($count574d1!='' and $confirmdn!='' and $count574d<=0){echo"<style='background-color:lightgreen'><a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a></span>";} 
