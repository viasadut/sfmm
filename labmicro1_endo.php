...
$query4 = mysqli_query($db,"select * from endolab where id='$id'");
...
$ins_query1="insert into micro (`pname`,`pmrn`,`mm1`,`medi1`,`ins1`,`ins2`,`rdate`,`rby`,`inid`,`sno`,`mm2`,`medi2`,`mm3`,`mm4`,`stain`,`culture`,`mic1`,`mic2`,`atime`,`fstatus`,`ocom`) values 
('$pname','$pmrn','$mm1','$medi1','$ins1','$ins2','$rdate','$user','$id','$sno','$mm2','$spe1','$mm11','$mm22','$stain1','$culture','$mic1','$mic2','$atime','$fstatus','$ocom1')";
...
$update="update endolab set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='DONE' where id='$id'";
mysqli_query($con,$update) or die(mysql_error());
