...
$sel_query="Select * from m_suite where date1= '$date' and ustatus in('Updated') and dname='$full' and rstatus!='DONE' ;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["proname"]; ?>  
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="procedure2_ms?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">UPDATE</a> </td>
		   <td align="center"><a onclick="return confirm_click();" href="procancel_ms?id=<?php echo $row["id"]; ?>&cby=<?php echo $row["dname"]; ?>"> Cancel</a></td>
...
<tr><td colspan="20">Todays SEEN Patient</td></tr>
    <tr>
      <th width="4%"><strong>S.No</strong></th>
      <th width="17%"><strong>Patient's Name</strong></th>
      <th width="10%"><strong>MRN</strong></th>
...
$sel_query="Select * from m_suite where date1= '$date' and ustatus in('Updated','Paid') and dname='$full' and rstatus in('DONE','') and pnote!='';";
...
<?php if($row['pnote']!=''){echo '
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="procedure3_ms?pmrn='.$row["pmrn"].'&id='.$row["id"].'">Edit</a> </td>
';}?>
