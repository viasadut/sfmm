...
<option ="">--Select Employye Category</option>
			<option ="HOD">HOD</option>
<option ="Incharge">Incharge</option>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Carry Forward Balance</strong>
...
$sel_query="Select * from staff3 where cat='$dept' and status='Active' order by id asc";
