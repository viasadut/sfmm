...
<h1 align="center">Details Medicine History</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <td colspan="1" align="center"><strong>Implementation</strong></td>
...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and infusion ='$infu' and status='Active' order by infusion;";
