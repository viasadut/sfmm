...
$ins_query="insert into stat (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
{
return confirm("Are you Sure to UPDATE STAT Medicine Status ?");
}
...
$count=1;
$sel_query="Select * from istat where pmrn= '$pmrn' and eid='$eid'and status1='Active' and status='Data Updated' order by `otime` asc;";
...
<td colspan="2" align="center"><a onclick="return confirm_click();" href="inursestat?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>UPDATE</strong></a></td>	  
	  
      </tr>
    <?php $count++; } ?>
	
	
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><Strong><b>Implemented STAT Medicine List<b><strong></td></tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
...
$count=1;
$sel_query="Select * from istat where pmrn= '$pmrn' and eid='$eid' and status='implemented' and odate1='$odate'order by `id` desc;";
