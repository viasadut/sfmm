...
$count=1;
$sel_query="Select * from estat where pmrn= '$pmrn' and eid='$episode'and status='Data Updated' order by `otime` asc;";
...
<td colspan="2" align="center"><a target='_blank' href="estat11?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
