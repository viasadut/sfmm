...
$count=1;
$sel_query="Select * from pres where pmrn= '$pmrn' and dname='$user' order by ID desc;";
...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="p5.php?pmrn=<?php echo "$pmrn"; ?>&date=<?php echo "$date"?>">GO</a></td>
