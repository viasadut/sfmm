<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','ddf','oic','staff')"; 
...
<tr><td colspan="3" align="left"><a href="ipdmng"><font size="4.5">Datewise Admission Report</a></td></tr>
<tr>
	<td colspan="5"align="left"><a href="ipdmng1"><font size="4.5">Datewise Discharge Report</a></td></tr>
	
		<tr><td colspan="3" align="left"><a href="ipdmngtest1"><font size="4.5">Datewise Admission Report (DAYCARE/INPATIENT)</a></td></tr>
