...
$query5 = mysqli_query($db,"select * from ot where id='$id'");
...
//echo $type;
//echo $type;
$query10 = mysqli_query($db,"select * from ot where id ='$id'");
$data10 = mysqli_fetch_assoc($query10);
$dname=$data10["dname"];
$ins_query="insert into otlab (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`) values ('$dname', '$pmrn','$pname','$id','$medi','$pins','$date','$type')";
...
$count=1;
$sel_query="Select * from otlab where pmrn= '$pmrn' and eid='$id'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="otdelete?id1=<?php echo $id; ?>&pmrn=<?php echo "$pmrn"; ?>&id=<?php echo $row['id'];?>">DELETE</a></td>
    ...
    <?php $count++; } ?>
<tr>
<td align="right" colspan="20"><a target='_blank' href="csotlab?eid=<?php echo "$id"; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="self.close()">Close</button></td>
</tr>
</table>
