...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><?php echo $row["infusion"].'('.$row['room'].')'; ?></td>
...
if($row['return_by']=='' and $bstatus=='Issued' and $ss==''){
...
else if($ss=='' and $oo!='' and $bstatus=='Issued' and $row['pause_by']=='' and $row['pause_by1']=='' and $row['pause_by2']=='' and $row['start1by']=='' and $row['start2by']=='' and $row['nstart']=='' and $row['return_by']=='')
