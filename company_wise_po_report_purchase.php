...
<head>
    <meta charset="utf-8">
    <title>Purchase PO Monthly Report</title>
    <style>
        body {
...
<h2>Company Wise Approved PO Report (Purchase)</h2>
            ...
            <tr>
                ...
                <td style="vertical-align: bottom;">
                    ...
                    <a class="btn-pdf" target="_blank"
                       href="company_wise_po_report_pdf_purchase.php?stdate=<?php echo urlencode($st_in); ?>&endate=<?php echo urlencode($en_in); ?>">
                        Print / PDF
                    </a>
                </td>
            </tr>
