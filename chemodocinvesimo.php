...
//echo $type;
//echo $type;
$query10 = mysqli_query($db,"select * from chemopapp where pmrn='$pmrn' and eid='$eid'");
$data10 = mysqli_fetch_assoc($query10);
$dname=$data10["dreffer"];
$ins_query="insert into chemolab (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`status`) values ('$dname', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','Ordered')";
...
$count=1;
$sel_query="Select * from chemolab where pmrn= '$pmrn' and eid='$eid' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="chemolabdelete?eid=<?php echo $eid; ?>&pmrn=<?php echo $pmrn; ?>&id=<?php echo $row['id'];?>">DELETE</a></td>
    ...
    <?php $count++; } ?>
<tr>
<td align="right" colspan="20"><a target='_blank' href="chemoinves?eid=<?php echo "$eid"; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"; ?>"><img src="lab.png" title="Print Report" width="150" height="60" />
<a target='_blank' href="chemocsinvesrad?eid=<?php echo "$eid"; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"; ?>"><img src="rad.png" title="Print Report" width="150" height="60" />
<a target='_blank' href="chemocsinvesspd?eid=<?php echo "$eid"; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"; ?>"><img src="spd.png" title="Print Report" width="150" height="60" />
