...
$update33="update pappnew set `aslot`='$slot', `bill`='$bill', `pmrn`='$pmrn' where `ID`='$id'";
...
<!-- Form Title -->
		...
		<label for="mail"><strong>Appointment Date :</strong></label>
									<p>
									  <input type="text" name="date" id="datepicker" placeholder="Select Date" size="15" value="<?php echo $data["adate"]; ?>">
									  <input name="date1" type="text" size=40% value=" <?php if(isset($_POST['load'])==1)
{ $date1 = $_REQUEST['date'];
echo $date1;
}
?>" size ="57">
