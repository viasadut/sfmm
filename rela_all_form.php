...
<h1 align="center" class="style1">FORM LIST OF DR. RELA HOSPITAL</h1> 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;" id="myTable">
	...
	<th width="4%"><strong>S.No</strong></th>
      <th width="40%"><strong>Form Title</strong></th>
      <th width="40%"><strong>Rela Form</strong></th>
      <th width="40%"><strong>SFMM Form</strong></th>
...
$date1= date('Y-m-d');
$count=1;
$sel_query="Select * from rela_doc_upload order by id desc";
//$start=$row["aadate"];

$row1 = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($row1)) { ?>
      <td align="left"><span style='color:red;text-align:center;font-size:22px'><b><?php echo $count; ?></td>
      
	
      <td align="left"><span style='color:red;text-align:center;font-size:22px'>
    
      <b><?php echo $row["form_title"]; ?>
    </td>

    
    <td align="left"><span style='color:red;text-align:center;font-size:22px'>
    
    <b><a target='_BLANK' href="cam_test/rela_photo/<?php echo $row['rela_form']; ?>"><?php echo $row["rela_form"]; ?></a>
  </td>
      ...
      <?php if($row['sfmm_form']==''){ echo'
<form action="cam_test/sfmm_doc_upload.php" id="myform" enctype="multipart/form-data" method="POST">	   
...
<input type="hidden" name="mrn" value="'.$row["id"].'">
