...
<td align="center"colspan="2"><a target='_blank' href="bcrossreport1.php?pmrn=<?php echo $row['pmrn'];?>&bagno=<?php echo $row['bagno']; ?>&sno=<?php echo 'O'.$row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  	  
