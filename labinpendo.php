...
$dd=date('Y-m-d');
$count=1;
$sel_query="Select * from endolab where pmrn= '$pmrn' and eid='$eid'and status='Ordered' and odate='$dd' order by `id` DESC;";
...
<td colspan="2" align="center"><a href="labreceiveendo?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>RECEIVE</strong></a></td>	  
<td colspan="2" align="center"><a href="labreject1endo?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>REJECT</strong></a></td>	  
...
$count=1;
$sel_query="Select * from endolab where pmrn= '$pmrn' and eid='$eid' and type='lab' and status IN ('RECEIVED','REJECTED')order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="4"><?php echo $row["medi"]; ?></td>
			...
			<td align="center"colspan="3"<?php if($row['status']== "REJECTED"): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightblue;" <?php endif ; ?>>
        <?php echo $row['status'];?></td>
        	  	  <td align="center"colspan="2"><?php echo $row["rcomments"]; ?></td>
	  
	  	  <td align="center"colspan="2"><?php echo $row["luser"]; ?></td>
