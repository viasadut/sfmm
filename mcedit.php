...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from mcertificate where idate='11/18/2025' and ct='unfit' and user='$full'";
//$start=$row["aadate"];
...
<td align="center"><?php echo $row["pname"]; ?></a></td>
      ...
      <td align="center"><a href="medicalcertificate1edit?id=<?php echo $row['id']; ?>">Edit</a></td>	  
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from mcertificate where idate='$date'and ct='fit' and user='$full'";
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <td><a target='_blank' href="printmcedit1.php?id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
            <td align="center"><a href="medicalcertificate2edit?id=<?php echo $row['id']; ?>">Edit</a></td>	  
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from mtreatment where idate='$date' and user='$full'";
//$start=$row["aadate"];
...
<td align="center"><?php echo $row["pname"]; ?></a></td>
	  ...
	  <td><a target='_blank' href="printtreatment1.php?id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
      <td align="center"><a href="edittreatment?id=<?php echo $row['id']; ?>">Edit</a></td>	  
...
$date= date('d/m/Y');
$count=1;
$sel_query="Select * from injury where idate='$date' and user='$full'";
//$start=$row["aadate"];
...
<td align="center"><?php echo $row["pname"]; ?></a></td>
	  ...
	  <td><a target='_blank' href="injuryeditprint.php?id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
      <td align="center"><a href="injuryedit?id=<?php echo $row['id']; ?>">Edit</a></td>	  
