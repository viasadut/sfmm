...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="last_name">' . $row["code"] . '</div>';
...
{
 $query = "SELECT * FROM icd_code order by id asc limit 100";
