...
<!-- Form Title -->
		...
		&nbsp;&nbsp;<a target='_blank' href="opdradreport?pmrn=<?php echo "$pmrn"; ?>"><b>Record of checkboxlogy Report<b></a>&nbsp;&nbsp;<a target='_blank' href="https://medex.com.bd"><b>Reference Drug Index of Bangladesh(medex.com.bd)<b></a></td></tr>
...
<tr><td colspan="20" bgcolor="lightgreen"><label><strong>Systemic Inquiry :</strong></label></td></tr><br>
<tr><td colspan="20"bgcolor="lightgreen"><b>Cardiovascular: <input type="checkbox" name="pcar" value="Chest Pain"required/> Chest Pain <input type="checkbox" name="pcar" value="Palpitations"checked="checked"required/> Palpitations<input type="checkbox" name="pcar" value="Dyspnoea"checked="checked"required/> Dyspnoea<input type="checkbox" name="pcar" value="Syncope"checked="checked"required/> Syncope<input type="checkbox" name="pcar" value="Orthopnoea"checked="checked"required/> Orthopnoea<input type="checkbox" name="pcar" value="Peripheral Oedema"checked="checked"required/> Peripheral Oedema<input type="checkbox" name="pcar" value="N/A"checked="checked"required/> N/A </td></tr>
<tr><td colspan="20"bgcolor="lightgreen"><b>Respiratory: <input type="checkbox" name="pres" value="Dyspnoea"required/> Dyspnoea <input type="checkbox" name="pres" value="Cough "checked="checked"required/> Cough<input type="checkbox" name="pres" value="Sputum"checked="checked"required/> Sputum <input type="checkbox" name="pres" value="Wheeze"checked="checked"required/> Wheeze <input type="checkbox" name="pres" value="Haemoptysis"checked="checked"required/> Haemoptysis <input type="checkbox" name="pres" value="Chest pain"checked="checked"required/> Chest pain<input type="checkbox" name="pres" value="N/A"checked="checked"required/> N/A </td></tr>
<tr><td colspan="20"bgcolor="lightgreen"><b>GI: <input type="checkbox" name="pgi" value="Appetite"required/> Appetite <input type="checkbox" name="pgi" value="Nausea"checked="checked"required/> Nausea <input type="checkbox" name="pgi" value="Vomiting"checked="checked"required/> Vomiting  <input type="checkbox" name="pgi" value="Indigestion"checked="checked"required/> Indigestion <input type="checkbox" name="pgi" value="Dysphagia "checked="checked"required/> Dysphagia  <input type="checkbox" name="pgi" value="Weight Loss "checked="checked"required/> Weight Loss<input type="checkbox" name="pgi" value="Abdominal Pain"checked="checked"required/> Abdominal Pain<input type="checkbox" name="pgi" value="Bowel Habit "checked="checked"required/>Bowel Habit<input type="checkbox" name="pgi" value="Abdominal Pain"checked="checked"required/> Abdominal Pain<input type="checkbox" name="pgi" value="N/A "checked="checked"required/>N/A </td></tr>
<tr><td colspan="20"bgcolor="lightgreen"><b>Urinary : <input type="checkbox" name="puri" value="Volume of urine passed "required/> Volume of urine passed  <input type="checkbox" name="puri" value="Frequency"checked="checked"required/> Frequency <input type="checkbox" name="puri" value="Dysuria "checked="checked"required/> Dysuria    <input type="checkbox" name="puri" value="Urgency "checked="checked"required/> Urgency  <input type="checkbox" name="puri" value="Incontinence "checked="checked"required/> Incontinence<input type="checkbox" name="puri" value="N/A "checked="checked"required/> N/A  </td></tr>
<tr><td colspan="20"bgcolor="lightgreen"><b>CNS: <input type="checkbox" name="pcns" value="Vision"required/> Vision <input type="checkbox" name="pcns" value="Headache "checked="checked"required/> Headache  <input type="checkbox" name="pcns" value="Motor or sensory disturbance "checked="checked"required/> Motor or sensory disturbance    <input type="checkbox" name="pcns" value="Loss of consciousness  "checked="checked"required/> Loss of consciousness   <input type="checkbox" name="pcns" value="Confusion"checked="checked"required/> Confusion<input type="checkbox" name="pcns" value="N/A"checked="checked"required/> N/A  </td></tr>
<tr><td colspan="20"bgcolor="lightgreen"><b>Musculoskeletal: <input type="checkbox" name="pmus" value="Bone and joint pain "required/> Bone and joint pain  <input type="checkbox" name="pmus" value="Muscular pain  "checked="checked"required/> Muscular pain <input type="checkbox" name="pmus" value="N/A  "checked="checked"required/> N/A  </td></tr>
<tr><td colspan="20"bgcolor="lightgreen"><b>Dermatology: <input type="checkbox" name="pder" value="Rashes"required/> Rashes  <input type="checkbox" name="pder" value="Skin Breaks"checked="checked"required/> Skin Breaks<input type="checkbox" name="pder" value="Ulcers"checked="checked"required/> Ulcers<input type="checkbox" name="pder" value="Skin Lesions "checked="checked"required/> Skin Lesions<input type="checkbox" name="pder" value="N/A "checked="checked"required/> N/A  </td></tr>
...
<tr>
<td colspan="4"><input type="text" name="pperiod1" placeholder="Remarks" value="" /></td>
<td colspan="4"><input type="text" name="plmp1" placeholder="Remarks" value="" /></td>
<td colspan="4"><input type="text" name="pnochild1" placeholder="Remarks" value="" /></td>
<td colspan="4"><input type="text" name="plchild1" placeholder="Remarks" value="" /></td>
<td colspan="4"><input type="text" name="pmanopause1" placeholder="Remarks" value="" /></td>
</tr>
