...
$query = "UPDATE alltest set reby='$user',retime='$dtime', rstatus='RECEIVED', barcode1='$result5',status='RECEIVED',rdate='$datenew' where id='$id'"; 
...
<tr><td colspan="2" align="center"><input type="text"  name="odate" required value="<?php echo $data45["date"]; ?>" readonly/></td>
