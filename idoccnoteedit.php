...
$ins_query="update icnote set infusion='$infu',inves='$inves',pnote='$pnote',euser='$full',etime='$adate1',charge='$charge',vtype='$vtype' where id='$id';";
...
<td colspan="2" align="center"><label><strong>Visit Type</strong></label></td> 
...
<input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='vtype' required value="<?php echo $data5['vtype'];?>">
...
<td colspan="6" align="center"><textarea rows="2"  name="inves" required value=""><?php echo $data5['inves'];?></textarea></td>
<td colspan="2" ><input type="text" name="charge" id="charge" required value="<?php echo $data5['charge'];?>"readonly></td>
</tr>
