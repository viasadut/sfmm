...
$query = "SELECT * from endopapp where eid='$eid' and pmrn='$pmrn'"; 
...
<tr><td align="left" colspan="20"><a target='_blank' href="promedicine?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"?>&eid=<?php echo "$eid"?>&id=<?php echo "$id"?>&type=<?php echo "$type"?>&ieid=<?php echo "$ieid"?>"><img src="medicine1.jpg" title="test" width="130" height="90" /></a></td></tr>
