...
$query1 = mysqli_query($db,"select * from alltest where id='$id' and billstatus='Billed' and type='lab' and rstatus ='Received' and billdate='$dd'");
...
$pdf->SetXY(1,3.8);
$pdf->SetFont('Arial' , 'b' , 5);
$pdf->Cell('5',1,'Name-'.$data1['pname'].'('.$data1['pmrn'].')',0,1,'L');
$pdf->SetXY(1,6.3);
$pdf->SetFont('Arial' , 'b' , 5);
