...
<table width='100%' height ='100%' border='1' align='center' bgcolor='lightblue' style='border-collapse:collapse;' id='myTable'>


<tr>
	   
	    <td colspan='10' style='font-size:30px;color:green;text-align:center;background-color:white;'>
		...
		<img src='kpj_logo/1.png' style='width:40px;height:40px;'>
		
		
		</td>
		<td colspan='1' style='font-size:20px;color:white;font-weight:bold;text-align:center;background-color:#FA8C75;'>DT:".date('d/m/Y')."</td>
	   </tr>
<tr>
      <td width='2%' style='font-size:13px; background-color:lightblue;'><strong>S.No</strong></td>
      <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Patient's Name</strong></td>
      <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>MRN</strong></td>
	  <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Category</strong></td>
      <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Doctor's Name </strong></td>
      <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Admission Date</strong>   </td>
	  <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Working Diagnosis</strong></td>
      
      <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Bed No</strong></td>
	  <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Days Staying</strong></td>
      
	  <td width='6%' style='font-size:13px; background-color:lightblue;'><strong>OT Clearance</strong></td>
	  <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Nurse</strong></td>
...
if($count77>0){
  ...
  echo "<a target='_blank' href='diap?pmrn=".$row['pmrn']."&eid=".$row['eid']."'>".$dia."</a>";
echo "</td>";}
...
<tr>
		...
		<td colspan='1' style='font-size:20px;color:white;font-weight:bold;text-align:center;background-color:white;'></td>
	   </tr>
<tr>
      <td width='2%' style='font-size:13px; background-color:lightblue;'><strong>S.No</strong></td>
      <td width='7%' style='font-size:13px; background-color:lightblue;'><strong>Patient's Name</strong></td>
...
$rw = mysqli_fetch_assoc($resu);
  ...
  echo "<td style='background-color:#eed7a1;font-size:13px;font-weight:bold'>" . $count1 . "</td>";
