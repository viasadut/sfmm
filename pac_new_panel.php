...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from pac_request where status='Pending' order by r_s_t desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["r_s_d"]; ?></td>
	  <td align="center"><?php echo $row["dname"]; ?></td>
	  	  <td align="center"><?php echo 'PAC';?></td> 
...
<td align="center"colspan="7" align="right"><a href="pac_receive?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Receive</a></td>	  
