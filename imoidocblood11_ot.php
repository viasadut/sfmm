...
$query5 = mysqli_query($db,"select * from bcross1 where bagno='$bb'");
...
$query = "UPDATE iblood set finish='$finish',first='$first',second='$second',amount='$amount',ooby1='$user',ootime1='$odate' where id='$id'"; 
...
<tr>
						...
						<td colspan="3"><label><strong>Bag Number:</strong></label></td>
						<td colspan="3"><label><strong>Blood Group:</strong></label></td>
						<td colspan="3"><label><strong>Blood Type:</strong></label></td>
						<td colspan="3"><label><strong>1st 10 Mins Drop Rate:</strong></label></td>
						<td colspan="3"><label><strong>Then Increase to:</strong></label></td>
						<td colspan="3"><label><strong>Amount:</strong></label></td>
						<td colspan="3"><label><strong>Finish Bag(In Hour):</strong></label></td>
...
<tr>
						...
						<td colspan="3" align="center"><input list="browsers1" name="infu" class="form-control" value="<?php echo $data1['bagno']?>"readonly></input></td>
						<td colspan="3" align="center"><input list="browsers1" name="infu" class="form-control" value="<?php echo $data1['bgroup']?>"readonly></input></td>
						<td colspan="3" align="center"><input list="browsers1" name="infu" class="form-control" value="<?php echo $data1['btype']?>"readonly></input></td>
  
<td colspan="3" align="center"><input list="browsers1" name="first" class="form-control" value=""required></input></td>
<td colspan="3" align="center"><input list="browsers1" name="second" class="form-control" value=""required></input></td>
<td colspan="3" align="center"><input list="browsers1" name="amount" class="form-control" value="<?php echo $data1['bqty']?>"required></input></td>
<td colspan="3" align="center"><input list="browsers1" name="finish" class="form-control" value=""required></input></td>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>First 10 Mins Droplates/Mins</strong></td>   
      <td colspan="2" align="center"><strong>Then Increase to</strong></td>
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$episode' and location='OT'  order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="2"><?php echo $row["first"]; ?></td>
      
	  <td align="center"colspan="2"><?php echo $row["second"]; ?></td>
  	  <td align="center"colspan="2"><?php echo $row["amount"]; ?></td>
