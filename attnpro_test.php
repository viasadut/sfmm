...
/*$query40a = "SELECT * FROM roaster_2 where mor= '$ssid2' and date='$adate' order by id asc limit 1;"; 
	 
$result40a = mysqli_query($con, $query40a) or die(mysqli_error());

// Print out result
$row40a = mysqli_fetch_array($result40a);
