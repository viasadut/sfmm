...
<ul>
   <li><a href='inviewnew1'><span>Home</span></a></li>
    ...
    <li class='last'><a href='attn_confirm'><span>Attendance Confirm Window</span></a></li>
	<li class='last'><a href='tcmeview11'><span>Print</span></a></li>
...
$count=1;
$sel_query="Select * from cme where status= 'Approved' and date='$cdate' order by `id` DESC;";
...
<td align="center"colspan="2"><a  target='_blank' href="tcmeview2?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">Manual</td>
<td align="center"colspan="2"><a  target='_blank' href="tcmeview2_rfid?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>"></td>  		
<td align="center"colspan="2"><a  target='_blank' href="cme_rfid_new?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">RFID</td>  
