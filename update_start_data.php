...
$data = mysqli_fetch_assoc($query4);
      ...
      {  
           $query = "update iblood set start_remarks='$start_remarks',nsby='$user',nstart='$dtime',b_temp='$b_temp',b_pulse='$b_pulse',b_bp='$b_bp' WHERE id = '".$_POST["employee_id2"]."'";  
      ...
      {  
           $query = "update iblood set start1_remarks='$start_remarks',start1by='$user',start1time='$dtime',nstart='$dtime',b_temp='$b_temp',b_pulse='$b_pulse',b_bp='$b_bp' WHERE id = '".$_POST["employee_id2"]."'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
      ...
      {  
           $query = "update iblood set start2_remarks='$start_remarks',start2by='$user',start2time='$dtime',nstart='$dtime',b_temp='$b_temp',b_pulse='$b_pulse',b_bp='$b_bp' WHERE id = '".$_POST["employee_id2"]."'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
