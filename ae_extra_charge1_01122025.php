...
if($res990=mysqli_num_rows($result990)==0)
{
    ...
    echo '</script>';
		...
		$ins_query1="Update ae_extra_charge set pdos='$pdos2',price='$p12',add_user='$user',add_time='$time' where eid='$eid' and pmrn='$pmrn' and medi='$medi1'";
...
$ins_query1="insert into ae_extra_charge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`) values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$user','$time')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
...
$count=1;
$sel_query="Select * from ae_extra_charge where pmrn= '$pmrn' and eid='$eid' order by `date` DESC;";
