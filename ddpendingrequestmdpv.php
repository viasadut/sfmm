...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Update PV & Cheque No</strong>
...
$date= date('m/d/Y');
$count1=1;
$sel_query="Select * from preadm where apstatus='Approved' and ddrequest ='settled' and dd01='$fullname' and pvno='0' order by aldate desc";
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <td align="center"><?php echo $row["aldate"]; ?>  </td>
	  <td align="center"><?php echo $row["apstatus"]; ?></td>
	  
<td align="center"><a href="ddmngeditpv?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>View/Edit</strong></a></td>	   
...
$sel_query="Select * from endopapp where apstatus='Approved' and ddrequest ='settled' and dd01='$fullname' and pvno='0' order by aldate desc";
//$start=$row["aadate"];
...
<td align="center"><a href="ebilladmddbillendomngpv?id=<?php echo $row["ID"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>View/Edit</strong></a></td>	   
