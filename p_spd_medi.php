...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			$strSQL = "UPDATE cathmediused set pstatus='Served', puser='$user', pdate='$pdate' ";
...
<tr><td align="left" colspan="20"><font size="4.5" color="#FF000"><b><a onclick="return confirm_click();" href="spd_charge_confirm_p?pmrn=<?php echo $pmrn; ?>&id=<?php echo $id; ?>&eid=<?php echo $eid; ?>">Confirm Cathlab Charges: </a>(<?php echo $noti;?>)</td></tr> 
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from cathmediused where pmrn= '$pmrn' and eid='$eid' order by `id` desc;";
