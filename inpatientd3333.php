...
$query45 = mysqli_query($db,"select * from inves where pmrn='$pmrn' and id='$id'");
...
$update="update inves set ddate='$ddate', dtime='$dtime',status='updated' where `id`='$id'";
mysqli_query($con,$update) or die(mysql_error());

if($update)
{

header("Location: inviewnew1.php");
}
...
<tr><td colspan="20"><?php echo $data59["padd"]; ?></td></tr>
		...
		<tr>
						...
						<tr>				
						<td colspan="5"><?php echo $data45["pmrn"]; ?></td>  
...
<td colspan="4" align="center"><label><strong>Infusion</strong></label></td> 
...
<tr><td colspan="4" align="center"><input type="date"  name="odate" required value="<?php echo $data45["odate"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="otime" required value="<?php echo $data45["otime"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="infu" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="date" name="ddate" required value="" /></td>
<td colspan="4" align="center"><input type="text" name="dtime" required value="" /></td></tr> 
