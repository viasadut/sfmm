...
<div class="container">
    ...
    <form action="rela_doc_upload1.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <strong>Type Of Documents:</strong>
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from rela_doc_form where status='Active';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="rela_doc_pic/<?php echo $image['file'] ?>">
                        <img class="img-responsive" alt="" src="rela_doc_pic/<?php echo $image['file'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['file'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="rela_delete.php" method="POST">
