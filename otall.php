...
$query43 = "SELECT COUNT(pmrn) FROM ot where dname='$full' and otdate BETWEEN '$start' and '$end' and status in ('DONE', 'received');"; 
...
$count=1;
$sel_query="Select * from ot where dname='$full' and date5 BETWEEN '$start' and '$end' and status in ('DONE', 'received')";
...
$query4 = mysqli_query($db,"select sum(charge) from otreport where pmrn='$p' and eid='$e'");
