...
<p align="center" class="style1">DISCHARGE EMERGENCY PATIENTS</p> 
...
$sel_query="Select * from emergency where discharge in  ('discharged','Admitted') and ddate1='$date'  order by room asc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="emerrad1dis?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
	  <td align="center"><a href="radinpeditemer2?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">EDIT</a></td>
