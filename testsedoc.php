...
<td align="center"colspan="2"><a  onclick="return confirm_click1();" href="cmeapprovedoc?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">Approve</td>  		
