...
function Header()
{
    ...
    $this->Cell(0,6,' Daily Diet Order Sheet',0,1,'C');
...
$eid=$_REQUEST['eid'];
$dd=date('m/d/Y');
$query = mysqli_query($link,"SELECT * from iidiet where pmrn='$pmrn' and eid='$eid' " );
...
$pdf->AddCol('infusion',45,'Diet');
$pdf->AddCol('dmenu',160,'Instruction');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iidiet where pmrn='$pmrn' and eid='$eid' and status in ('Data Updated','Diet Ordered') order by `rtime` and `infusion` asc",$prop);
$pdf->Output();
?>