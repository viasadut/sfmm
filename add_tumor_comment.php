...
$query43 = "SELECT * FROM tumor_board_doc where id='$id';"; 
...
$url = "topicupload.php?eid=$count1";
	...
	$ins_query1="update tumor_board_doc set comments='$details',status='Done',aby='$user',atime='$atime' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());
 ...
 echo '<script language="javascript">';
    ...
    echo '</script>';
    header("location:tumor_test_doc");
 }
 else {
