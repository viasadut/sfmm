...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
	  ...
	  <td colspan="1"align="center"><strong>Admission Date</strong></td>
...
$sel_query="Select * from preadm where pphone= '$pmrn' and dname ='$fname'order by id desc;";}
 else{
	 $sel_query="Select * from preadm where pmrn= '$pmrn' and dname ='$fname' order by id desc;";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="idocnotedd?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">GO</a></td>
...
$sel_query="Select * from endopapp where pphone= '$pmrn' and dreffer ='$fname'order by id desc;";}
 else{
	 $sel_query="Select * from endopapp where pmrn= '$pmrn' and dreffer ='$fname' order by id desc;";
 } 
$count=1;	 
$result = mysqli_query($con,$sel_query);
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="ddmanualbill1endodoc?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["ID"]; ?>">GO</a></td>
