...
function Header()
{
    ...
    $this->Cell(0,6,' Emergency Medicine Order Sheet',0,1,'C');
...
$eid=$_REQUEST['eid'];
$dd=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from emedi2 where pmrn='$pmrn' and eid='$eid' " );
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from emedi2 where pmrn='$pmrn' and eid='$eid' and odate ='$dd' and status='Active'order by time",$prop);
$pdf->Output();
?>