...
$query43 = "SELECT COUNT(pmrn) FROM fnacreport where r1date BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from fnacreport where r1date BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["find"];?> 
      <td align="center"><?php echo $row["date2"]; ?>  
	  
	  <td colspan="10"><a target='_blank' href="p4new1histor.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>&dname=<?php echo $row['dname']; ?>"><img src="print.png" title="Print Report" width="100" height="60" /></a></td>	
      </tr>
