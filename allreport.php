...
$query43 = "SELECT COUNT(type1) FROM radreport where type1='$bt' and rdate BETWEEN '$start' and '$end';"; 
...
<form action="allreport" method="POST">
...
$count=1;
$sel_query="Select * from radreport where type1='$bt' and rdate BETWEEN '$start' and '$end';";
