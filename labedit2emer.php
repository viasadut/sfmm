...
//$id1=$_REQUEST['ID'];
$url = "emerlab1?pmrn=$pmrn&eid=$eid";
$query = "UPDATE einves set status='Data Updated', rcomments='' where id='$id'"; 
...
<ul>
   ...
   <li class='active has-sub'><a href='#'><span>Bed Management</span></a>
      <ul>
         ...
         </li>		          <li class='has-sub'><a href='tes77'><span>Detail History Episodewise</span></a>
...
<td colspan="8" align="center"><label><strong>Remarks</strong></label></td>
...
<td colspan="8" align="center"><input type="text" name="infu" required value="<?php echo $data45["room"]; ?>" readonly/></td>
