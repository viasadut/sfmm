...
echo "<font color=blue font size=5.5><b> ".$bt." ACTIVITIES AT A GLANCE  - $date77 TO $date77e";
   ...
   echo "<br>";
   echo "Total Income-  ";	 
   echo $row43p['SUM(payment)'] + $row43i['SUM(charge)'] + $row43_e['SUM(visit)']+ $row43o['SUM(charge)'] + $row43pp['SUM(procharge)'] + $row43e['SUM(room)'] + $row43ecg['COUNT(ron)']*100 + $row43ecg1['COUNT(ron)']*1500+ $row43ecg2['COUNT(ron)']*1000+ $row43ecg3['COUNT(ron)']+$cath_sum['SUM(charge)']+$row48_p['SUM(procharge)']+$row43e_e['SUM(room)'];
   echo " BDT";	 
   ...
   echo "<br>";
   echo "Net Income-  ";	 
   echo $row43p['SUM(payment)'] + $row43i['SUM(charge)'] + $row43_e['SUM(visit)']+ $row43o['SUM(charge)'] + $row43pp['SUM(procharge)'] + $row43e['SUM(room)'] + $row43ecg['COUNT(ron)']*100 + $row43ecg1['COUNT(ron)']*1500+ $row43ecg2['COUNT(ron)']*1000+ $row43ecg3['COUNT(ron)']-$row43o['SUM(discount)']- $row43o_discount['SUM(discount)']+$cath_sum['SUM(charge)']+$row48_p['SUM(procharge)']+$row43e_e['SUM(room)'];
   echo " BDT";	 
...
$sel_query2="Select * from cath_charge where date1 BETWEEN '$date77' and '$date77e' and sname='$bt'and c_status!='Cancelled'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
