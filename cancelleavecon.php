...
$date= date('Y-m-d');
$count=1;
$sel_query="Select * from conleavedetails where status Not IN('Approved By ALL','Approved By MD','Cancel','Rejected','%rejec%','Consultant requested to cancel') and sid='$fullname'";
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <td align="center"><a onclick="return confirm_click();" href="testleavecon?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>&tleave=<?php echo $row["tleave"]; ?>&tdays=<?php echo $row["tdays"]; ?>"><strong>Cancel</strong></a></td>
