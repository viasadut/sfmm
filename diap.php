<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','imo','diet')"; 
...
$ins_query="insert into diap (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`user`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$full','Data Updated')";
...
<h1 align="center"style="background-color:lightgreen;">INPATIENT DIAGNOSIS NOTE </h1>
<!-- Form Title -->
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Diagnosis</strong></label></td> </tr>


<td colspan="20" align="center"><label><strong>Diagnosis</strong></label></td> 
</tr>

<tr>


<td colspan="20" align="center"><textarea rows="5"  name="inves" required value=""></textarea></td>
</tr>
...
<tr>
      ...
      <td colspan="13" align="center"><strong>Diagnosis</strong></td>
...
$count=1;
$sel_query="Select * from diap where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="13"><?php echo $row["inves"]; ?></td>  
