...
$sel_query="Select * from pappnew where adate= '$date' and bill='Billed' and status='NOT SEEN'  ORDER BY dname asc;";
...
$sel_query="Select * from pappnew where adate= '$date' and `bill`='Billed' and status IN ('HISTORY UPDATED','SEEN') ORDER BY dname asc;";
