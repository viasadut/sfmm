...
if (!empty($_POST['rr3'])){
$ins_query6="insert into influid (`date`,`type`,`route`,`time`,`qty`,`pmrn`,`udone`,`eid`,`type1`,`qty1`,`route1`,`date1`,`time1`) values 
('$rr1','Intake','$rr3','$rr2','$rr4','$pmrn','$user','$eid','Output','','','$date1','$time1')";
...
$url = "influid1?pmrn=$pmrn&eid=$eid";
header("Location: $url"); 
...
<td colspan="20" align="center"><font size="10" color="red"><strong>ADD INTAKE<strong> </td><br>
...
<td colspan="4" align="center"><label><strong>Intake Qty</strong></label></td>


</tr>
<tr>
<td colspan="4" align="center"><input name="rr1" type="text" value="<?php echo $date; ?>"readonly>
  </td>
<td colspan="4" align="center"><select list="rr2" name="rr2"  class="form-control" required>
...
<option value=''>-Select-</option>
			  ...
			  <td colspan="6" align="center"><select list="rr3" name="rr3"  class="form-control" required>
...
<td colspan="4" align="center"><input name="rr4" type="text" value="" required></td>
