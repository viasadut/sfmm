...
$query198 = mysqli_query($db,"SELECT SUM(infusion) FROM anaesbloss where pmrn='$pmrn'and eid='$eid'"); 
...
$ins_query="insert into anaesbloss (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
$count=1;
$sel_query="Select * from anaesbloss where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
...
{ ?>    <tr>
    ...
    <?php $count++; } ?>
	<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Blood Loss:<?php echo $test1;?> (ml)</strong></td></tr>
