...
('$pbp1','$pbp1','$pbp1_1','$pbp1_2','$user','$loc','Nursing','$date3','$ddate1')";  
...
('Morning','$item','$user','$loc','Nursing','$date3','$ddate1')";  
		   mysqli_query($con,$query) or die(mysql_error());
		}
}
...
foreach ($treat1 as $item1) {
		...
		$querycz = "SELECT COUNT(mor) FROM roaster_2 where date ='$date3' and mor='$item' and emor='Late'"; 
$resultcz = mysqli_query($con, $querycz) or die(mysqli_error());
$rowcz = mysqli_fetch_array($resultcz);
$c1z=$rowcz['COUNT(mor)'];
      ...
      
{
		...
		$query = " insert into roaster_2 (`emor`,`mor`,`aby`,`location`,`dept`,`date`,`adate`) values 
('Late','$item1','$user','$loc','Nursing','$date3','$ddate1')";  
		   mysqli_query($con,$query) or die(mysql_error());
		}
...
foreach ($treat2 as $item2) {
		...
		$querycz = "SELECT COUNT(mor) FROM roaster_2 where date ='$date3' and mor='$item' and emor='Night'"; 
$resultcz = mysqli_query($con, $querycz) or die(mysqli_error());
$rowcz = mysqli_fetch_array($resultcz);
$c1z=$rowcz['COUNT(mor)'];
      ...
      
{
		...
		$query = " insert into roaster_2 (`emor`,`mor`,`aby`,`location`,`dept`,`date`,`adate`) values 
('Night','$item2','$user','$loc','Nursing','$date3','$ddate1')";  
		   mysqli_query($con,$query) or die(mysql_error());
		}
...
<select name="loc" >
						...
						<option value='<?php echo $loc;?>'selected><?php echo $loc;?></option>
