...
$ins_query1="insert into covid (`cp`,`name`,`ssent`,`tresult`,`cduration`,`distance`,`quntil`,`retest`,`adate`,`user`,`ldate`,`ldate1`,`ssent1`,`retest1`,`remarks`,`quntil1`,`pcase`,`sentto`,`padd`,`phone`,`advice`,`page`,`psex`,`district`,`specimen`,`rdate`,`rdate1`,`type`) values
 ('$cp','$name','$ssent','$tresult','$cduration','$distance','$quntil','$retest','$adate','$user','$ldate','$ldate1','$ssent1','$retest1','$remarks','$quntil1','$pcase','$sentto','$padd','$phone','$advice','$page','$psex','$district','$specimen','$rdate','$rdate1','Others')";
...
<input type="text" name="phone" id="email" class="input-text" placeholder="Designation" size="70"value=""required>     

<label for="age"><strong>Address:</strong></label>
<input type="text" name="padd" id="email" class="input-text" placeholder="padd" size="70"value=""required>     
