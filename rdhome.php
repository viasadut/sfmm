<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('rd','staff')"; 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="deathstatdetailsmnglab?pmrn=<?php echo "$pmrn"; ?>"><b>Details<b></a></td>
