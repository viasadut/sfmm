...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <th width="14%"><strong>Date Of Birth</strong>   
...
$sel_query="Select * from patient where pphone= '$pmrn';";}
 ...
 else if (($_POST['select'])=="MRN"){
	 $sel_query="Select * from patient where pmrn= '$pmrn';";
 } 
 
 
 else if(($_POST['select'])=="pname")
 
 {
	 $sel_query="Select * from patient where pname like'%$pmrn%';";
 } 
$count=1;	 
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["bdate"]; ?>
      <td align="center"><?php echo $row["pphone"]; ?>  
	  
	  <td align="center"><a target='_blank' href="tender/equipment/patient_all_image?pmrn=<?php echo $row['pmrn']; ?>"><b>Details<b></a></td>
