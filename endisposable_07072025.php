...
$query159 = mysqli_query($db,"select * from storenew where ename='$infu'");
...
$sel990="SELECT * FROM storenew WHERE `ename`='$infu';";
...
$ins_query="insert into edisposible (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`dcode`,`price`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated','$dcode','$p11')";
mysqli_query($con,$ins_query) or die(mysql_error());
}
}
?>
