...
<th width="14%"><strong>Last Sales Date</strong>  	  
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicine where '$edate'>= l_sale_date || l_sale_date is NULL and status='Active' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["l_sale_date"]; ?></td>
