...
$sel_query1="Select * from death1 where pmrn='$pmrn' ORDER BY id asc;";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
	  ...
	  <td><a target='_blank' href="deathprint222.php?pmrn=<?php echo $row1["pmrn"]; ?>&id=<?php echo $row1["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
