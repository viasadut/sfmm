...
<?php	  $date=$row["dname"] ;?>
	  ...
	  <td colspan="10"><a target='_blank' href="p4new1.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&dname=<?php echo $row['dname']; ?>"><img src="print.png" title="Print Report" width="60" height="20" /></a></td>

<td><form target="_blank" action="http:\\192.168.100.202/Launch_Viewer.asp?" method="post" id='tt' >
...
<button type="submit" name="Submit4" form="tt" >Confirm</button>
	  ...
	  <td colspan="10"><a target='_blank' href="Launch_Viewer.asp?pmrn=<?php echo $row['pmrn']; ?>&Username=<?php echo 'hisuser'; ?>&Password=<?php echo 'hisuser'; ?>">test Link</a></td>
