...
$params = $pdf->serializeTCPDFtagParameters(array($jj, 'C128', '155', '', 40, 12, 0.5, array('text'=>true, 'font'=>'helvetica', 'fontsize'=>8, 'stretchtext'=>0), 'N'));
...
<table width="100%">
                    <tr>
                        ...
                        <td width="100%" align="center" style="font-size:17px;text-decoration: underline;"><b>'.$data['medi'].' REPORT</b></td>
...
lab_render_approval_footer($pdf, $con, (isset($data['subtype'])?$data['subtype']:''), (isset($data['resultby'])?$data['resultby']:''), (isset($data['checked_by'])?$data['checked_by']:''), (isset($data['cby'])?$data['cby']:''));
