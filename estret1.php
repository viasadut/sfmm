...
$query45 = mysqli_query($db,"select * from estret where pmrn='$pmrn' and id='$id'");
...
$update="update estret set dtime='$dtime',ddate='$ddate', status='Rupdated', duser='$user' where `id`='$id'";
