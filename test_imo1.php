...
<input type='text' name="users" onchange="showUser(this.value)"list="categoryname" autocomplete="off" name='proname' placeholder='Select Procedure Name' style="color:green;font-size:22px; font-weight:bold">
