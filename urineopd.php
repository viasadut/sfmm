...
else
{
  ...
  /*$rr='Appearance:'.$aurine."<br />".'Colour:'.$color."<br />".'Specific Gravity:'.$surine."<br />".'pH:'.$purine."<br />".'Protien:'.$prurine."<br />".'Glucose:'.$gurine."<br />".
  ...
  $rr1='Appearance:'.$aurine."<br />".'Colour:'.$color."<br />".'Specific Gravity:'.$surine."<br />".'pH:'.$purine."<br />".'Protien:'.$prurine."<br />".'Glucose:'.$gurine."<br />".
  'Ketone:'.$kurine."<br />".'Bilirubin:'.$burine."<br />".'Urobilinogen:'.$uurine."<br />".'Blood:'.$blurine
  ...
  $rr2='Appearance:'.$aurine."<br />".'Colour:'.$color."<br />".'Specific Gravity:'.$surine."<br />".'pH:'.$purine."<br />".'Protien:'.$prurine."<br />".'Glucose:'.$gurine."<br />".
  'Ketone:'.$kurine."<br />".'Bilirubin:'.$burine."<br />".'Urobilinogen:'.$uurine."<br />".'Blood:'.$blurine
  ."<br />".'WBC:'.$wurine."<br />".'RBC:'.$rurine."<br />".'Epitheial Cell:'.$eurine."<br />".'Cast:'.$curine
  ...
  $rr3='Appearance:'.$aurine."<br />".'Colour:'.$color."<br />".'Specific Gravity:'.$surine."<br />".'pH:'.$purine."<br />".'Protien:'.$prurine."<br />".'Glucose:'.$gurine."<br />".
  'Ketone:'.$kurine."<br />".'Bilirubin:'.$burine."<br />".'Urobilinogen:'.$uurine."<br />".'Blood:'.$blurine
  ."<br />".'WBC:'.$wurine."<br />".'RBC:'.$rurine."<br />".'Epitheial Cell:'.$eurine."<br /><br />".'Cast:'.$curine
...
`burine`,`uurine`,`blurine`,`wurine`,`eurine`,`curine`,`crurine`,`baurine`,`yurine`,`ourine`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`rurine`,
`rbc`,`wbc`,`hyaline_c`,`granular_c`,`cal_ox`,`uric_acid`,`triple_phosphate`,`c_others`,`comment`,`color`,`sediment`,`sedi_v`) values 
...
'$rbc','$wbc','$hyaline_c','$granular_c','$cal_ox','$uric_acid','$triple_phosphate','$c_others','$comment','$color','$sediment','$sedi_v')";
...
mysqli_query($con,$update) or die(mysql_error());
  ...
  $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr_1' where id='$id'";
  mysqli_query($con,$update) or die(mysql_error());
  }

else if($curine=='Positive' and $crurine=='Negative' and $sediment=='Absent'){
  $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr1' where id='$id'";
  mysqli_query($con,$update) or die(mysql_error());
  }

  else if($curine=='Positive' and $crurine=='Negative' and $sediment=='Present'){
    $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr1_1' where id='$id'";
    mysqli_query($con,$update) or die(mysql_error());
    }

  else if($curine=='Positive' and $crurine=='Positive' and $sediment=='Absent'){
    $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr3' where id='$id'";
    mysqli_query($con,$update) or die(mysql_error());
    }

    else if($curine=='Positive' and $crurine=='Positive' and $sediment=='Present'){
      $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr3_3' where id='$id'";
      mysqli_query($con,$update) or die(mysql_error());
      }

    else if($curine=='Negative' and $crurine=='Positive' and $sediment=='Absent'){
      $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr2' where id='$id'";
      mysqli_query($con,$update) or die(mysql_error());
      }

      else if($curine=='Negative' and $crurine=='Positive' and $sediment=='Present'){
        $update="update alltest set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr2_2' where id='$id'";
        mysqli_query($con,$update) or die(mysql_error());
        }
...
<!-- Form Title -->
      ...
      <input name="aurine" type="text" size="70" style="text-transform:uppercase" value="Clear"required>

      <label for="age"><strong>Colour, Urine:</strong></label>
      <input name="color" type="text" size="70" style="text-transform:uppercase" value="Pale Yellow"required>
  ...
  <option value='Negative'>Negative</option>
      ...
      <label for="age" id="cast4" hidden><strong style="color:red; font:weight:bold;">Hyaline Cast:</strong></label>
      <input name="hyaline_c" type="text" size="70" value="" id="hyaline_c" hidden>

      <label for="age" id="cast3" hidden><strong style="color:red; font:weight:bold;">Granular Cast:</strong></label>
      <input name="granular_c" type="text" size="70" value="" id="granular_c" hidden>

      <label for="age" id="cast2" hidden><strong style="color:red; font:weight:bold;">WBC Cast:</strong></label>
      <input name="wbc_c" type="text" size="70" value="" id="wbc" hidden>

      <label for="age" id="cast1" hidden><strong style="color:red; font:weight:bold;">RBC Cast:</strong></label>
      <input name="rbc_c" type="text" size="70" value="" id="rbc" hidden>
      ...
      <label for="age" id="crystal1" hidden><strong style="color:red; font:weight:bold;">Calcium Oxalate:</strong></label>
      <input name="cal_ox" type="text" size="70"  value="" id="cal_ox" hidden>

      <label for="age" id="crystal2" hidden><strong style="color:red; font:weight:bold;">Uric Acid:</strong></label>
      <input name="uric_acid" type="text" size="70"  value="" id="uric_acid" hidden>

      <label for="age" id="crystal3" hidden><strong style="color:red; font:weight:bold;">Triple Phosphate:</strong></label>
      <input name="triple_phosphate" type="text" size="70"  value="" id="triple_phosphate" hidden>

      <label for="age" id="crystal4" hidden><strong style="color:red; font:weight:bold;">Others:</strong></label>
      <input name="c_others" type="text" size="70"  value="" id="c_others" hidden>
      ...
      <input name="comment" type="text" size="70" value="">
