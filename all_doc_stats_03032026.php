...
<tr>
<th style="font-weight:bold;font-size:20px; color:red;">
OPD
</th>
</tr>
...
$query_doc = "SELECT * FROM doctor where dname= '$bt';"; 
$result_doc = mysqli_query($con, $query_doc) or die(mysqli_error());
$row_doc = mysqli_fetch_assoc($result_doc);
$doc_charge=$row_doc['v1'];
...
$query43p = "SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN' and `payment`<=$doc_charge;"; 
	 
$result43p = mysqli_query($con, $query43p) or die(mysqli_error());
$row43p = mysqli_fetch_assoc($result43p);


$query43p_extra = "SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN' and `payment`>$doc_charge;"; 
	 
$result43p_extra = mysqli_query($con, $query43p_extra) or die(mysqli_error());
$row43p_extra = mysqli_fetch_assoc($result43p_extra);


$query43p_extra_c = "SELECT COUNT(ID) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN' and `payment`>$doc_charge;"; 
	 
$result43p_extra_c = mysqli_query($con, $query43p_extra_c) or die(mysqli_error());
$row43p_extra_c = mysqli_fetch_assoc($result43p_extra_c);
$count_discount=$row43p_extra_c['COUNT(ID)']*110;

$adjust_charge=$row43p_extra['SUM(payment)']-$count_discount;
...
$query48 = "SELECT COUNT(pmrn) FROM procedure1 where dis_date between '$date77' and '$date77e' and dname='$bt' and ustatus in ('Updated','Paid') and type='Inpatient';"; 
...
$query43o = "SELECT SUM(room) FROM otivisitendo where dis_date between '$date77' and '$date77e' and infusion='$bt';"; 
...
$query43pp = "SELECT SUM(procharge) FROM procedure1 where dis_date between '$date77' and '$date77e' and dname='$bt' and type='Inpatient';"; 
...
$query48_p = "SELECT SUM(procharge) FROM procedure1 where date1 between '$date77' and '$date77e' and dname='$bt' and ustatus in ('Updated','Paid') and type='OPD';"; 
	 
$result48_p = mysqli_query($con, $query48_p) or die(mysqli_error());
$row48_p = mysqli_fetch_assoc($result48_p);


$query43e = "SELECT SUM(room) FROM ivisitendo where dis_date between '$date77' and '$date77e' and infusion='$bt' and ieid>0;"; 
	 
$result43e = mysqli_query($con, $query43e) or die(mysqli_error());
$row43e = mysqli_fetch_assoc($result43e);

$query43e_e = "SELECT SUM(room) FROM ivisitendo where cdate between '$date77' and '$date77e' and infusion='$bt' and ieid='0';"; 
	 
$result43e_e = mysqli_query($con, $query43e_e) or die(mysqli_error());
$row43e_e = mysqli_fetch_assoc($result43e_e);
...
$query_cath = "SELECT COUNT(pmrn) FROM cath_charge where dis_date between '$date77' and '$date77e' and c_status!='Cancelled' and sname='$bt';"; 
...
$query_cath1 = "SELECT SUM(charge) FROM cath_charge where dis_date between '$date77' and '$date77e' and c_status!='Cancelled' and sname='$bt';"; 
	 
$result_cath1 = mysqli_query($con, $query_cath1) or die(mysqli_error());
$cath_sum = mysqli_fetch_assoc($result_cath1);


$query_charge_extra = "SELECT SUM(pdos) FROM ipd_extra_charge where date1 between '$date77' and '$date77e' and delete_status!='1' and medi in ('$bt-ANAESTHETIST','$bt-PROCEDURE', '$bt-WARD REVIEW','$bt-SURGERY','$bt - ANAESTHETIST','$bt - PROCEDURE', '$bt - WARD REVIEW','$bt - SURGERY', '$bt- ANAESTHETIST','$bt- PROCEDURE', '$bt- WARD REVIEW','$bt- SURGERY');"; 
//$query_charge_extra = "SELECT SUM(pdos) FROM ipd_extra_charge where date1 between '$date77' and '$date77e' and delete_status!='1' and medi1 in ('ANAESTHETIST','PROCEDURE', 'WARD REVIEW','SURGERY');"; 
	 
$result_charge_extra = mysqli_query($con, $query_charge_extra) or die(mysqli_error());
$data_charge_extra = mysqli_fetch_assoc($result_charge_extra);
echo $data_charge_extra['SUM(pdos)'];


$query_charge_discount = "SELECT SUM(pdos) FROM ipd_extra_charge where date1 between '$date77' and '$date77e' and delete_status!='1' and medi in ('$bt-DISCOUNT');"; 
//$query_charge_discount = "SELECT SUM(pdos) FROM ipd_extra_charge where date1 between '$date77' and '$date77e' and delete_status!='1' and medi1 in ('DISCOUNT');"; 
	 
$result_charge_discount = mysqli_query($con, $query_charge_discount) or die(mysqli_error());
$data_charge_discount = mysqli_fetch_assoc($result_charge_discount);
echo $data_charge_discount['SUM(pdos)'];



$query_spd = "SELECT SUM(room) FROM ivisitendo where cdate between '$date77' and '$date77e' and infusion='$bt' and ieid='0';"; 
	 
$result_spd = mysqli_query($con, $query_spd) or die(mysqli_error());
$row_spd = mysqli_fetch_assoc($result_spd);
...
echo "<font color=blue font size=5.5><b> ".$bt." ACTIVITIES AT A GLANCE  - $date77 TO $date77e";
   ...
   echo "<br>";
   echo "OPD-  ";	 
   echo $row43p['SUM(payment)']+$adjust_charge;
   echo "<br>";
   ...
   echo "OT-  ";	 
   echo $row43o['SUM(room)'];
   echo "<br>";
   
   echo "Procedure-  ";	 
   echo $row43pp['SUM(procharge)']+$row48_p['SUM(procharge)'];
   echo "<br>";

   echo "Manual Charge Entry-  ";	 
   echo $data_charge_extra['SUM(pdos)'];
   echo "<br>";
   
   echo "Endoscopy-  ";	 
   echo $row43e['SUM(room)']+$row43e_e['SUM(room)'];
   echo "<br>";
   ...
   echo "ECHO 2D-  ";	 
   echo $row43ecg2['COUNT(ron)']*1000;
   
   echo "<br>";
   echo "ECHO Color Doppler-  ";	 
   echo $row43ecg1['COUNT(ron)']*1500;
   ...
   echo "<br>";
   echo "Total Income-  ";	 
   echo $row43p['SUM(payment)'] + $row43i['SUM(charge)'] + $row43_e['SUM(visit)']+ $row43o['SUM(room)'] + $row43pp['SUM(procharge)'] + $row43e['SUM(room)'] + $row43ecg['COUNT(ron)']*100 + $row43ecg1['COUNT(ron)']*1500+ $row43ecg2['COUNT(ron)']*1000+$cath_sum['SUM(charge)']+$adjust_charge+$row48_p['SUM(procharge)']+$row43e_e['SUM(room)']+$data_charge_extra['SUM(pdos)'];
   echo " BDT";	 
   ...
   echo $row43o_discount['SUM(discount)']+$data_charge_discount['SUM(pdos)'];;
   
   
   echo "<br>";
   echo "Net Income-  ";	 
   //echo $row43p['SUM(payment)'] + $row43i['SUM(charge)'] + $row43_e['SUM(visit)']+ $row43o['SUM(charge)'] + $row43pp['SUM(procharge)'] + $row43e['SUM(room)'] + $row43ecg['COUNT(ron)']*100 + $row43ecg1['COUNT(ron)']*1500+ $row43ecg2['COUNT(ron)']*1000+ $row43ecg3['COUNT(ron)']-$row43o['SUM(discount)']- $row43o_discount['SUM(discount)']+$cath_sum['SUM(charge)'];
   echo $row43p['SUM(payment)'] + $row43i['SUM(charge)'] + $row43_e['SUM(visit)']+ $row43o['SUM(room)'] + $row43pp['SUM(procharge)'] + $row43e['SUM(room)'] + $row43ecg['COUNT(ron)']*100 + $row43ecg1['COUNT(ron)']*1500+ $row43ecg2['COUNT(ron)']*1000+ $row43ecg3['COUNT(ron)']- $row43o_discount['SUM(discount)']+$cath_sum['SUM(charge)']+$adjust_charge+$row48_p['SUM(procharge)']+$row43e_e['SUM(room)']+$data_charge_extra['SUM(pdos)']-$data_charge_discount['SUM(pdos)'];
   echo " BDT";	 
...
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
 ...
 { ?>    <tr>
     ...
     <td align="center"><?php echo $row1["adate1"]; ?>
       <td align="center"><?php 
       if($row1['payment']>$doc_charge){
       echo $row1["payment"]-110;}
...
$sel_query2="Select * from icnote where dis_date BETWEEN '$date77' and '$date77e' and user='$bt'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
 ...
 { ?>    <tr>
       ...
       <td align="center"><?php echo $row2["dis_date"]; ?></td>
       <td align="center"><?php echo $row2["charge"]; ?></td>
...
$sel_query2="Select * from ecnote where daten BETWEEN '$date77' and '$date77e' and dname='$bt'and type='Doctor'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
...
<td align="center"><?php echo $count; ?></td>
       <td align="center"><?php echo $row2['pmrn']; ?></td>
       <td align="center"><?php echo $row2['pname']; ?></td>
       <td align="center"><?php echo $row2['daten']; ?></td>
       <td align="center"><?php echo $row2['visit']; ?></td>
...
$sel_query2="Select * from otreport where dis_date BETWEEN '$date77' and '$date77e' and sname='$bt' and c_status=''";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
...
$sel_query2="Select * from procedure1 where dis_date BETWEEN '$date77' and '$date77e' and dname='$bt' and type='Inpatient'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
...
<td align="center"><?php echo $count; ?></td>
       <td align="center"><?php echo $row2['pmrn']; ?></td>
       <td align="center"><?php echo $row2['pname']; ?></td>
       <td align="center"><?php echo $row2['date1']; ?></td>
       <td align="center"><?php echo $row2['procharge']; ?></td>
...
if(isset($_POST['bsearch'])){
  ...
  $date78=date('m/d/Y');
     ...
     $sel_query2="Select * from procedure1 where date1 BETWEEN '$date77' and '$date77e' and dname='$bt' and type='OPD'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
...
$sel_query2="Select * from ivisitendo where cdate BETWEEN '$date77' and '$date77e' and infusion='$bt' and ieid='0'";
//$query43e = "SELECT SUM(room) FROM ivisitendo where dis_date between '$date77' and '$date77e' and infusion='$bt' and ieid>0;"; 
 $count=1;
...
<td align="center"><?php echo $count; ?></td>
       <td align="center"><?php echo $row2['pmrn']; ?></td>
       <td align="center"><?php echo $row2['pname']; ?></td>
       <td align="center"><?php echo $row2['cdate']; ?></td>
       <td align="center"><?php echo $row2['room']; ?></td>
     ...
     $sel_query2="Select * from ivisitendo where dis_date between '$date77' and '$date77e' and infusion='$bt' and ieid>0";
//$query43e = "SELECT SUM(room) FROM ivisitendo where dis_date between '$date77' and '$date77e' and infusion='$bt' and ieid>0;"; 
 $count=1;
...
$sel_query2="Select * from cath_charge where dis_date BETWEEN '$date77' and '$date77e' and sname='$bt'and c_status!='Cancelled'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
...
<td align="center"><?php echo $count; ?></td>
       <td align="center"><?php echo $row2['pmrn']; ?></td>
       <td align="center"><?php echo $row2['']; ?></td>
       <td align="center"><?php echo $row2['date1']; ?></td>
       <td align="center"><?php echo $row2['charge']; ?></td>
...
$sel_query2="Select * from ecg_test where datenew BETWEEN '$date77' and '$date77e' and con_by='$dd'";
//SELECT SUM(payment) FROM pappnew where adate1 between '$date77' and '$date77e' and dname='$bt' and status='SEEN';"; 
...
<td align="center"><?php echo $count; ?></td>
       <td align="center"><?php echo $row2['pmrn']; ?></td>
       <td align="center"><?php echo $row2['pname']; ?></td>
       <td align="center"><?php echo $row2['datenew']; ?></td>
       <td align="center"><?php echo $row2['ron']; ?></td>
       <td align="center"><?php if ($row2['ron']=='ECG') {echo "100";} else if ($row2['ron']=='ECHO-2D') {echo "1000";} else if ($row2['ron']=='ECHO-COLOR DOPPLER') {echo "1500";} ?></td>
