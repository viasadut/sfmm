         ...
         '.$data['details'].'
            ...
            ';
			 ...
			 /*$output .='<table style="border: 1px solid black" width="100%">
                    <tr>
                        <td style="width:100%;">'.$data['details'].'</td>
            ...
            $mpdf->SetHTMLHeader('
                ...
                <table width="100%">
                    <tr>
                        <td width="23%"></td>
                        <td width="50%"><b><h1 align="laft">ECG REPORT</h1> </b></td>
                ...
                <table>
                    <tr>
                        <td width="30%" ><h2 align="laft"><b>Report Done By:</b></h2></td>
                        <td width="70%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$data['dname1'].'</h2></b></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>'.$data3['degree'].'</td>
					...
					<tr>
                        <td width="30%" ><h2 align="laft"><b>Referral From:</b></h2></td>
