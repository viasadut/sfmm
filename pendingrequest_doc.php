...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','pharmacy')"; 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicinerequest where a2='Approved' and rstatus NOT IN ('DONE','Cancelled') ORDER BY id desc;";
...
//$id =$_GET['id'];
//$count=1;
$sel_query="Select * from medicinerequest where a2 !='Approved' and rstatus NOT IN('Waiting For Entry','Cancelled','DONE')  ORDER BY id desc;";
