...
$sel43="SELECT * FROM inpatient WHERE `pmrn`='$pmrn' and discharge='' ;";
...
$ins_query="insert into mcertificate (`pmrn`,`eid`,`pname`,`nid`,`nid1`,`ffor`,`fdate`,`fdate1`,`tdate`,`tdate1`,`rdate`,`rdate1`,`tdays`,`diagnosis`,`user`,`idate`,`ct`,`year`,`m1`,`m2`,`m3`,`staff`,`idate1`) values 
('$pmrn', '$eid','$pname','$passno','$passno1','$ufor','$fdate','$fdate1','$tdate','$tdate1','$rdate','$rdate1','$e','$diag','$full','$idate','unfit','$year','MR.','HE','HIS','$staff','$idate1')";
mysqli_query($con,$ins_query) or die(mysql_error());


  echo '<script language="javascript">';
    echo 'alert("Medical Certificate Issued Successfully !!"); ';
echo '</script>';}
	...
	$ins_query="insert into mcertificate (`pmrn`,`eid`,`pname`,`nid`,`nid1`,`ffor`,`fdate`,`fdate1`,`tdate`,`tdate1`,`rdate`,`rdate1`,`tdays`,`diagnosis`,`user`,`idate`,`ct`,`year`,`m1`,`m2`,`m3`,`staff`,`idate1`) values 
('$pmrn', '$eid','$pname','$passno','$passno1','$ufor','$fdate','$fdate1','$tdate','$tdate1','$rdate','$rdate1','$e','$diag','$full','$idate','unfit','$year','MS.','SHE','HER','$staff','$idate1')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
<label for="age"><strong>Patient's Details (MRN/Gender) :</strong></label>
	  ...
	  <input name="sex" type="text" size="15" value="<?php echo $row3["gender"]; ?>"readonly/>
...
<label for="name"><strong>Paients Identify:</strong></label>
      ...
      <textarea rows="5"  name="diag" required></textarea>
			...
			<select name="ufor" required>
			        <option value='Duties' selected>Duties</option>
		...
		<label for="mail"><strong>From :</strong></label>
									...
									<p>
									  <input type="text" name="rdate" id="datepicker2" placeholder="Select Date" size="15" value=""required>
...
<td><a target='_blank' href="printmc.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
