...
$sel_query="Select * from death1 where phone= '$pmrn';";}
 else{
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="death1edit21.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
...
$sel_query="Select * from death where phone= '$pmrn';";}
 else{
	 $sel_query="Select * from death where pmrn= '$pmrn';";
 } 
//$count=1;	 
$result = mysqli_query($con,$sel_query);
...
{ ?>    <tr>
      ...
      <td colspan="2"align="center"><?php echo $row["padd"]; ?></td>
      <td colspan="1"align="center"><?php echo $row["pphone"]; ?> </td>
	  <td align="center"><a target='_blank' href="death1edit.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo$row["pmrn"];?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
