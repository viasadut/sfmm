...
$query43 = "SELECT COUNT(id) FROM conleavedetails where '$start' between `sdate` and `edate` and status in ('Approved By ALL','Approval Pending','Approved By Replacement Consultant');"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
			    	 ...
			    	 <td colspan="2"><input type="date" name="stdate" placeholder="Select Date" size="15" required></td>  
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
   ...
   <tr>
      ...
      <th width="10%"><strong>Start</strong></th>
      <th width="10%"><strong>End</strong></th>
      <th width="14%"><strong>Leave Type</strong>   </th>
...
$count=1;
$sel_query="Select * from conleavedetails where '$start' between `sdate` and `edate` and status in ('Approved By ALL','Approval Pending','Approved By Replacement Consultant') order by id asc;"; 
