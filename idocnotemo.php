...
$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','$charge')";
...
<tr><td colspan="20" align="right"><a onclick="return confirm_click();" href="docvisit2?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD VISITING CHARGE</strong></a>&nbsp;&nbsp;<a onclick="return confirm_click1();" href="docvisit8?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD ICU VISIT CHARGE</strong></a>&nbsp;&nbsp;<a onclick="return confirm_click2();" href="docvisit9?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD EMERGENCY VISIT CHARGE</strong></a>&nbsp;&nbsp;<a onclick="return confirm_click3();" href="docvisit99?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&user=<?php echo "$full"; ?>&user1=<?php echo "$user"; ?>"><strong>ADD After Office Hour VISIT CHARGE</strong></a></td></tr>
<tr>
