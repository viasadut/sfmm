...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<?php 
			$sql = "Select DISTINCT trans_to  from storenew where etype='Asset';";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->trans_to."'>".$row->trans_to."</option>";
				}
			}
			?>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Warrenty</strong>
...
$sel_query="Select * from storenew where etype='Asset'";}


else{


$sel_query="Select * from storenew where trans_to='$bt';";
}
$count=1;
...
<td align="center"><a target='_blank' href="materialhistory1.php?eid=<?php echo $row['id']; ?>"><?php echo $row["id"]; ?></a> </td>
	  ...
	  <td align="center"><a target='_blank' href="asset_edit.php?id=<?php echo $row['id']; ?>">Details</a> </td>
