...
<form action="raddtsearch" method="POST">
...
$sel_query="Select * from alltest where pmrn='$pmrn' and status='' and type='rad';";
...
{ ?>    <tr>
      ...
      <td colspan="2"align="center"><?php echo $row["date"]; ?></td>
      <td colspan="1"align="center"><?php echo $row["medi"]; ?> </td>
	  <td colspan="1"align="center"><a href="rpapp2_00?pmrn=<?php echo $row["pmrn"]; ?>"></a></td>
