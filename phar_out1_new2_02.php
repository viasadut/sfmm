...
if ($pmrn !== "") {
	...
	$query = mysqli_query($con, "SELECT * FROM medicine WHERE code='$pmrn'");

	$row = mysqli_fetch_array($query);

	
	$query1 = mysqli_query($con, "SELECT SUM(add_qty) FROM medi_stock WHERE code='$pmrn' and location='2nd Fl Pharmacy' and add_qty>0");
