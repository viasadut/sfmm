...
//$id1=$_REQUEST['ID'];
$url = "po_prepare1_pharmacy.php?ono=$encryption";
$df=date('Y-m-d H:i:s');
...
if($user=='p01'||$user=='322'||$user=='345')
{
$query = "UPDATE po_table set status='Draft',f_time='$df',f_by='$user', total_amount='$va' where id='$id'"; 
