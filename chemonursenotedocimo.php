...
$query4 = mysqli_query($db,"select * from chemopapp where eid='$eid' and pmrn='$pmrn'");
...
$ins_query="insert into chemonnote (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`pnote`,`user`,`status`) values ( '$pmrn','$eid','$pname','$page','$adm','$psex','$pphone','$adate1','$inves','$pnote','$user','Data Updated')";
...
$count=1;
$sel_query="Select * from chemonnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
