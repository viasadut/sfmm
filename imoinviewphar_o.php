...
<td align="center"<?php if($count574d>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><?php if($count574d1==''){echo"<a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rru."'>Dis Medi</a>";}else {echo"<a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$rrusss."'>Dis Medi</a>";}?></td>
