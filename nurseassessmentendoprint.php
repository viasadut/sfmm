...
$query = mysqli_query($db,"SELECT * from nurseassessendo where pmrn='$pmrn' and eid='$eid'" );
$data = mysqli_fetch_array($query);
//$dname=$data['dname'];

$query2 = mysqli_query($db,"SELECT * from endopapp where pmrn='$pmrn' and eid='$eid'");
...
$query4 = mysqli_query($db,"SELECT * from friskendo where pmrn='$pmrn' and eid='$eid'");
