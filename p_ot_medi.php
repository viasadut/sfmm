...
$data59 = mysqli_fetch_assoc($query4);
  ...
  $noti=$data59['ot_charge_status_p'];
...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			$strSQL = "UPDATE othoscharge1 set pstatus='Served', puser='$user', pdate='$pdate' ";
...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i1=0;$i1<count($_POST["chkDel1"]);$i1++)
	{
		if($_POST["chkDel1"][$i1] != "")
		{
			$strSQL = "UPDATE otanaesmedi set pstatus='Served', puser='$user', pdate='$pdate' ";
...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i2=0;$i2<count($_POST["chkDel2"]);$i2++)
	{
		if($_POST["chkDel2"][$i2] != "")
		{
			$strSQL = "UPDATE otanaesinfusion set pstatus='Served', puser='$user', pdate='$pdate' ";
...
<h1 align="center"style="background-color:lightgreen;">Medication List Used in OT</h1>
<!-- Form Title -->
...
<tr><td align="left" colspan="20"><font size="4.5" color="#FF000"><b><a onclick="return confirm_click();" href="ot_charge_confirm_p?pmrn=<?php echo $pmrn; ?>&id=<?php echo $id; ?>">Confirm OT Charges: </a>(<?php echo $noti;?>)</td></tr> 
...
<tr>
	  ...
	  <td colspan="1" align="center"><strong>Patient MRN</strong></td>
	  <td colspan="1" align="center"><strong>Date</strong></td>
	  <td colspan="1" align="center"><strong>Medication</strong></td>
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="1"><?php if($row['pstatus']=='Served') {echo "<span style='color:green;text-align:center;'><b>".$row['pstatus']."";} else {echo "<span style='color:Red;text-align:center;'><b>".$row['pstatus']."";}?></td>
...
<?php
 $count++;}
?>
<tr><td colspan="20" align="right"><button type="submit" name="btnDelete1">Serverd</button><input type="hidden" name="hdnCount" value="<?php echo $i1;?>"></td>
</tr>
</table>
<?php
mysqli_close($objConnect);
...
<?php
 $count++;}
?>
<tr><td colspan="20" align="right"><button type="submit" name="btnDelete2">Serverd</button><input type="hidden" name="hdnCount" value="<?php echo $i2;?>"></td>
</tr>
</table>
<?php
mysqli_close($objConnect);
...
<?php
 $count++;}
?>
<tr><td colspan="20" align="right"><button type="submit" name="btnDelete3">Serverd</button><input type="hidden" name="hdnCount" value="<?php echo $i3;?>"></td>
</tr>
</table>
<?php
mysqli_close($objConnect);
