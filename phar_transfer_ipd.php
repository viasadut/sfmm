...
//echo $runningTime = date('Ymdsi')+$user;
...
<select name='dept' required style="font-weight: bold;font-size:22px;color:green;height:50px;" >
    
	<option value='<?php echo $p_mrn;?>' selected><?php echo $p_mrn;?></option>
