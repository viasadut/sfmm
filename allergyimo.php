...
$query43 = "SELECT * FROM allergy where pmrn= '$pmrn' and medi='$medi' and status!='Cancel';"; 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
//$row43 = mysqli_fetch_assoc($result43);
...
if($res=mysqli_num_rows($result43)>0)
{
    ...
    echo 'alert("Unsuccessful !!This Allergy is already added in Patient history"); ';
    echo '</script>';
    }
...
$ins_query="insert into allergy (`dname`,`pmrn`,`pname`,`medi`,`ins`,`date`,`type`) values ('$full', '$pmrn','$pname','$medi','$pins','$date','$type')";
...
<tr><td colspan="10" align="center"><label><strong>Mention Allergy</strong></label></td> 

<td colspan="10" align="center"><label><strong>Remarks</strong></label></td> 
</tr>
<tr>
<td colspan="10" align="center"><input list="browsers1" name="medi" size=60% class="form-control" required autocomplete="on">
...
$count=1;
$sel_query="Select * from allergy where pmrn= '$pmrn' and status!='Cancel' order by `id` DESC;";
