...
$rr='Prothrombin Time:'.$ptime."<br />".'PT Control(Normal):'.$pcontrol."<br />".'PT Ratio:'.$pt."<br />".'% Activity PT:'.$pt."<br />".'International Sensitivity Index, ISI:'.$isi."<br />".'INR:'.$inr."<br />";



$rr1='Prothrombin Time:'.$ptime.' '.'sec'."<br />".'PT Control(Normal):'.$pcontrol.' '.'sec'."<br />".'PT Ratio:'.$pratio.' '.''."<br />".'% Activity PT:'.$pt.' '.'sec'."<br />".'International Sensitivity Index, ISI:'.$isi.' '.''."<br />".'INR:'.$inr.' '.'';



$ins_query1="insert into prothrombin (`pname`,`pmrn`,`pphone`,`psex`,`page`,`ptime`,`pcontrol`,`pt`,`inr`,`isi`,`pratio`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$ptime','$pcontrol','$pt','$inr','$isi','$pratio','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
      ...
      <input name="ptime" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>PT Control(Normal):</strong></label>
      <input name="pcontrol" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  <label for="age"><strong>PT Ratio:</strong></label>
      <input name="pratio" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>% Activity PT:</strong></label>
      <input name="pt" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>International Sensitivity Index, ISI:</strong></label>
      <input name="isi" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>INR:</strong></label>
      <input name="inr" type="text" size="70" style="text-transform:uppercase" value=""required/>
