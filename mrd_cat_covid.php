...
if($bt=="ALL")
{
$query43 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and status='collected'"; 
...
$query44 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and tp='$bt' and status='collected'"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Passport No</strong>
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where rdate BETWEEN '$start' and '$end' and status='collected' order by sid asc;";}
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where rdate BETWEEN '$start' and '$end' and tp='$bt' and status='collected' order by sid asc;";}
...
<td align="center"><?php echo $row["pass_no"]; ?>  </td>
...
<td colspan ="7" align="right"><a target='_blank' href="covid_excel_mrd_cat?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>">Download In Excel</a></td>	     
