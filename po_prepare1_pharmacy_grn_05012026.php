...
$ins_query2="insert into medi_stock (`code`,`location`,`g_name`,`b_name`,`add_qty`,`exdate`,`batch_no`,`rfid`,`sno`,`u_price`,`t_price`,`add_by`,`add_time`,`re_date`,`req_qty`,`grn`,`invoice_no`,`p_id`,`check_by`)
values('$code','Pharmacy','$g_name','$b_name','$eqty2','$expiry','$batchno','$runningTime','$pono','$uprice','$tprice','$user','$add_time','$re_date','$eqty2','$grn','$invoice_no','$ono','$check_by')";
mysqli_query($con,$ins_query2) or die(mysql_error());

if($bonus>0){

 
  $ins_query22="insert into medi_stock (`code`,`location`,`g_name`,`b_name`,`add_qty`,`exdate`,`batch_no`,`rfid`,`sno`,`u_price`,`t_price`,`add_by`,`add_time`,`re_date`,`req_qty`,`grn`,`invoice_no`,`p_id`,`b_remarks`,`check_by`)
  values('$code','Pharmacy','$g_name','$b_name','$bonus','$expiry','$batchno','$runningTime1','$pono','$uprice','$bprice','$user','$add_time','$re_date','$eqty2','$grn','$invoice_no','$ono','Bonus Item','$check_by')";
...
$ins_query2="update medi_stock set `add_qty`='$new_qty', `req_qty`='$new_qty', check_by='$check_by' where id='$row_id' and location='Pharmacy'";
mysqli_query($con,$ins_query2) or die(mysql_error());
...
<td align="left" colspan="25"><input class="invoice" name="invoice" id="invoice" value="" type="text" placeholder="Invoice No" required size="30"></td>
</tr>
