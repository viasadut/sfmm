...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from nurseassessot where pmrn='$pmrn' and id='$id'"; 
...
$ins_query="insert into nurseassessot
...
('$pname','$pmrn','$psex','$cname','$crelation','$cphone','$page','$pphone','$aform','$adate','$astime','$ma','$acc','$shistory','$language','$nip','$edus','$comor','$valueableb','$bodys','$du','$remarks','$id','$cpatient','$csite','$cposition','$ctaken','$full')";
...
<tr><td colspan="20" bgcolor="lightgreen"><h3><a target='_blank' href="fallriskot?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"?>">Fall Risk Assessment(John Hopkins Tool)  </a></td></tr>					
