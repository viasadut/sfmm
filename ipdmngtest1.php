...
$query43 = "SELECT COUNT(room) FROM inpatient where room='DAYCARE'and anew BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(room) FROM inpatient where room !='DAYCARE' and anew BETWEEN '$start' and '$end';"; 
...
echo   $row43['COUNT(room)'];
echo " ,  From  ";
echo $start;
echo "  To  ";
echo $end;

$sel_query="Select * from inpatient where room='DAYCARE' and anew BETWEEN '$start' and '$end' order by anew";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row44['COUNT(room)'];
echo " ,  From  ";
echo $start;
echo "  To  ";
echo $end;
