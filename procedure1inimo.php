...
$query = "SELECT * from inpatient where id='$id' and pmrn='$pmrn'"; 
...
$ins_query="insert into procedure1 (`dname`,`pname`,`pmrn`,`pphone`,`page`,`psex`,`pdate`,`ptime`,`proname`,`type`,`ieid`) values 
('$dname', '$pname','$pmrn','$pphone','$page','$psex','$pdate','$ptime','$proname','Inpatient','$eid')";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
					 ...
					 <td colspan="3"><input type="text1" name="type" required value="Inpatient" readonly/></td>
		...
		<tr>
						...
						<td colspan="8"><label><strong>TIME:</strong></label></td>		
						</tr>
			    	 ...
			    	 <td colspan="3"><input type="text" name="pdate" id="datepicker1" placeholder="Select Date" size="15" required/></td>  
					 <td colspan="8"><select name="ptime"required/>
		...
		<tr>			 
						...
						<option value='Dressing Minor'>Dressing Minor</option>
						<option value='Dressing Major'>Dressing Major</option>
						<option value='Excision and Biopsy'>Excision and Biopsy</option>
						<option value='Major Procedure'>Major Procedure</option>
						<option value='Minor Procedure'>Minor Procedure</option>
						<option value='Plaster Cutting'>Plaster Cutting</option>
						<option value='POP'>POP</option>
						<option value='Burn Dressing Large'>Burn Dressing Large</option>
						<option value='Burn Dressing Small'>Burn Dressing Small</option>
						<option value='Injection Procedure'>Injection Procedure</option>
						<option value='Drain Remove'>Drain Remove</option>
						<option value='Injection Procedure'>Injection Procedure</option>
						<option value='IV Canula'>IV Canula</option>
