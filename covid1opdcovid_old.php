...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`,`pmrn`,`nid`,`pass_no`) values
 ...
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','09:00AM','$com','$bgroup','$bstatus','$user','$adate','$pmrn','$nid','$pass_no')";
...
$ins_query1="insert into covidopd (`sid`,`cp`,`name`,`psex`,`page`,`phone`,`padd`,`district`,`ward`,`symptom`,`phyper`,`pdm`,
`asthma`,`copd`,`mali`,`other`,`ssent`,`ssent1`,`sentto`,`specimen`,`ldate`,`ldate1`,`pcase`,
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','09:00AM','$com','$bgroup','$bstatus','$pmrn','$nid','$pass_no')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','10:00AM','$com','$bgroup','$bstatus','$user','$adate','$pmrn','$nid','$pass_no')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','10:00AM','$com','$bgroup','$bstatus','$pmrn','$nid','$pass_no')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','11:00AM','$com','$bgroup','$bstatus','$user','$adate','$pmrn','$nid','$pass_no')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','11:00AM','$com','$bgroup','$bstatus','$pmrn','$nid','$pass_no')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','12:00PM','$com','$bgroup','$bstatus','$user','$adate','$pmrn','$nid','$pass_no')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`pmrn`,`nid`,`pass_no`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','12:00PM','$com','$bgroup','$bstatus','$pmrn','$nid','$pass_no')";
