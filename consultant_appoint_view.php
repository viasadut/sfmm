...
<!-- Form Title -->
		<h1>Consultant Today's Slot Details</h1>
    ...
    <tr>
      ...
      <th width="17%"><strong>Slot</strong></th>
...
//$id =$_GET['id'];
$count=1;
$sel_query="select * from opd_appoint1 where dslot>='$ct' and dname='$full' and date1='$date22'  order by dslot asc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["dslot"]; ?></td>
	  ...
	  <td align="center">
	  <?php if($row['status']=='Booked'){echo"<span style='color:blue;text-align:center;'><b>".$row["status"]."";} 
	  else if ($row['status']=='AVAILABLE'){echo"<span style='color:green;text-align:center;'><b>".$row["status"]."";} 
	  else if ($row['status']=='NOT AVAILABLE'){echo"<span style='color:red;text-align:center;'><b>".$row["status"]."";} 
