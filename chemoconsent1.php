...
$sel90="SELECT * FROM chemoconsent1 WHERE `pmrn`='$pmrn' and `eid`='$eid' and `pro`='$pro';";
...
$ins_query="insert into chemoconsent1 (`pmrn`,`eid`,`pname`,`passno1`,`dname`,`padd`,`psex`,`spass`,`sdesig`,`tdate`,`pname1`,`pro`,`page`,`user`,`tdate1`,`wname`,`ward`,`bed`) values 
...
<td><a target='_blank' href="chemoconsentprint1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&pro=<?php echo "$pro"; ?>&dname=<?php echo "$dname"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
