...
$count=1;
$sel_query="Select * from eidiet where pmrn= '$pmrn' and eid='$episode' and status='Data Updated' order by `odate` asc;";
...
<td colspan="2" align="center"><a target='_blank' href="eidite1?pmrn=<?php echo "$row[pmrn]"; ?>&eid=<?php echo $data59["eid"]; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
