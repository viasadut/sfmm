...
$search_counter="select * from counter where status='Engage' and sno='2'";
...
$current_token = "select * from counter_history where counter_no='2' and cdate='$cdate' and status='1' order by id desc LIMIT 1"; 
$current_token_result= mysqli_query($con, $current_token);
$current_token_row=mysqli_fetch_assoc($current_token_result);
