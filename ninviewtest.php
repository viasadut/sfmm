...
<form action="" method="post">
		...
		<table>
			...
			<option value='ALL CRITICAL'>ALL CRITICAL</option>			
					...
					<td><a href="inview">    <strong>BACK</strong></a></td>
					 </tr>
</table>
...
$date= date('m/d/Y');
if (($_POST['bt'])=="ALL CRITICAL"){


$sel_query="Select * from inpatient where  room IN('ICU','CCU','HDU')and discharge= '' order by room asc";}
 else{
