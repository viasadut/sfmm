...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`eeid`,`snew`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','A&E','$date6','$staff','pending','$eid','$snew')";
mysqli_query($con,$ins_query);
	...
	else if ($staff== 'Staffs Children' ){$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`eeid`,`snew`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','A&E','$date6','$staff','pending','$eid','$snew')";
mysqli_query($con,$ins_query);
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`eeid`,`snew`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$doc','A&E','$date6','$staff','Approved','$eid','$snew')";
mysqli_query($con,$ins_query);
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<select name="doc" class="style1"required>
