...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from alltest where pmrn= '$pmrn' and billstatus='Billed' and type='lab' and rstatus in ('RECEIVED','')";
...
<tr>
	  ...
	  <td colspan="4" align="center"><strong>Barcode</strong></td>  
