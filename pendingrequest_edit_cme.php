...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicineedit where status='Waiting for Pharmacy Forwarding' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="editmedicinemngphar_cme?id=<?php echo $row["id"]; ?>">Proceed</a></td>
