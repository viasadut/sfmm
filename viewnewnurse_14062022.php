...
<ul>
   ...
   <li class='active has-sub'><a href='#'><span>Test</span></a>
      <ul>
	   <li class='has-sub'><a href='viewnewnurse_new2././'><span>New Receive Panel</span></a>
...
<td colspan="4" align="right"><input name="rfid_card" type="text" value=""required autofocus='autofocus'></td>  
...
<tr>
	...
	<td colspan="3"align="center"><a href="otallbookingdoc1mng"><font size="5.5" color="red" font-weight="bold">Today's OT List</a></td>
	<td colspan="3"align="center"><a href="dept_bar_print"><font size="5.5" color="red" font-weight="bold">View Stock</a></td>
	<td colspan="2"align="center"><a href="add_medi_stock_ipdlklk"><font size="5.5" color="red" font-weight="bold">Add Stock</a></td>
	<td colspan="2"align="left"><a href="phar_transfer_ipd?sno=<?php echo $runningTime;?>"><font size="4.5">Request For Stock</td>	
