...
$mo_confirm=$data1['confirmdn'];
$doc_confirm=$data1['dconfirm'];
...
$pname=$data1["pname"];
$otime = date('d/m/Y H:i:s');
$query159 = mysqli_query($db,"select * from doc_medi where iname='$medi1' and dname='$ddname'");
...
<td colspan="4" align="center"><label><strong>Frequency (Can Write Both in Bangla & English)</strong></label></td> 
<td colspan="2" align="center"><label><strong>Duration (Can Write Both in Bangla & English)</strong></label></td> 
<td colspan="4" align="center"><label><strong>Food Relation (Can Write Both in Bangla & English)</strong></label></td> 
</tr>
<tr>
...
/*else if($mo_confirm!='' and $pmrn=='321823'){
	
	echo '<td colspan="20"align="right"><button type="submit" name="Submit1">ADD</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="Submit1_a">ADD SET</button></td>';
}
*/
else {
	
	echo '<td colspan="20"align="right"><button type="submit" name="Submit1" disabled><font size="4.5" color="#FF000"><b>Discharge Note Already Confirmed</button></td>';
}
	  ?>
...
{ echo'
				 ...
				 <td align="center" colspan="2"><a href="imoidismomedidelete?id='.$row["id"].'&pmrn='.$pmrn.'&eid='.$eid.'">DELETE</a></td>';
				 
}
				 
				 else {
				echo '<td align="center" colspan="2">Discharge Note Already Confirmed</a></td>';	 
