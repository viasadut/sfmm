...
//$url = "einves_new_1?pmrn=$pmrn&eid=$eid&inves=$infu";
$url = "test_popup?pmrn=$pmrn&eid=$eid&inves=$infu";
if($res90=mysqli_num_rows($result90)==0)
{
	...
	else if($type=='RAD' || $type=='Rad' || $type=='rad'){
...
<td colspan="12" align="center"><input list="browsers1" name="infu" size=60% class="form-control" autocomplete="off" id="pmrn" onkeyup="GetDetail(this.value)">
...
<td colspan="8" align="center"><input type="text" name="remarks" id='uu1' value="" required >
...
<td colspan="6" align="center">
  <select id="pg" name="pg" style="background-color:lightgreen;" hidden required>
			...
			<td colspan="6" align="center">
  <select id="apg" name="apg" style="background-color:lightgreen;" hidden required>

						<option value=''>-Select Investigation</option>
				<?php 
			$sql3 = "select * from `radio2` where status='Active'";
			$res3 = mysqli_query($con, $sql3);
			if(mysqli_num_rows($res) > 0) {
				while($row3 = mysqli_fetch_object($res3)) {
					echo "<option value='".$row3->iname."'>".$row3->iname."</option>";
				}
			}
			?>  </select></td>


			<td colspan="8" align="center"><input type="text" name="remarks" id='uu' value="" required style="background-color:lightgreen;" placeholder="REMARKS" hidden>
</tr>		
						<script>
						var yy= document.getElementById
							("sformat").value=document.getElementById
							("sformat").value;
