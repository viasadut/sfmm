...
$query43 = "SELECT COUNT(pmrn) FROM endoreport where rdate BETWEEN '$start' and '$end' and dname='$full';"; 
...
$count=1;
$sel_query="Select * from endoreport where rdate BETWEEN '$start' and '$end' and dname='$full'";
...
{ ?>    <tr>
    ...
    <td colspan ="7" align="right"><a target='_blank' href="endo_excel_report?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>&full=<?php echo "$full"; ?>">Download In Excel</a></td>	
  </tbody>
</table>
