...
$query43="Select COUNT(subtype) from radio;";}
 else{


 $query43 = "SELECT COUNT(subtype) FROM radio where subtype= '$bt';"; }
...
$sel_query="Select * from radio where subtype='$bt' and type='lab';";
 }
$count=1;
