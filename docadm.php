...
//include("auth.php");
//echo $count1;
//$mdate=date('Y-m-d', strtotime('-1 days'));
...
$sql = "insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`sid`,`approx_amount`) values 
...
if ($conn->query($sql) === TRUE) {
  ...
  header("Location: admdoc.php?pmrn=$pmrn&adoc=$full&rdate=$date6&id=$last_id");
...
$conn->close();
        ...
        $sql = "insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`,`btype`,`sid`,`approx_amount`) values 
        ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','Approved','$snew','$btype','$sid','$approx_amount')";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<legend></legend>
            <!-- Name Input -->
<label for="age" align="right"><strong>

<a target='_blank' href="con_ot_bill"><font size="4.5">Search Previous Procedure Cost</a></strong>

&nbsp;<a target='_blank' href="admdoc?pmrn=<?php echo "$pmrn"; ?>&adoc=<?php echo $full; ?>&rdate=<?php echo $date6;?>"><img src="print.png" title="Print Report" width="50" height="40" /></a>
...
<label for="age"><strong>Staff ID:</strong></label>
      ...
      <label for="age"><strong>Diagnosis :</strong></label>
		...
		<input type="date" class="style1" name="date" placeholder="Select Date" size="15" required min="<?php echo date('Y-m-d');?>">
 ...
 <label for="age"><strong>Probable Date of Discharge  :</strong></label>
		<input type="date" class="style1" name="date1"  placeholder="Select Date" size="15" min="<?php echo date('Y-m-d');?>">
