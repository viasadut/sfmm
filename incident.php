...
$queryz = "SELECT * FROM staff3 where sid= '$user' and status='Active'"; 
$resultz = mysqli_query($con, $queryz) or die(mysqli_error());
$rowz = mysqli_fetch_array($resultz);
$hos5=$rowz['hos'];


$queryz1 = "SELECT * FROM staff3 where sid1='$hos5' and status='Active'"; 
$resultz1 = mysqli_query($con, $queryz1) or die(mysqli_error());
...
$idetails = str_replace("'", "''",$_REQUEST['idetails']);
//$page=$_REQUEST['page'];
//$psex=$_REQUEST['psex'];
...
$query9 = "SELECT * FROM staff3 where dept= '$idept' and cat='HOD'"; 
...
$ins_query1="insert into incident1 (`itype`,`idept`,`idetails`,`ceo`,`cfo`,`cno`,`md`,`hos`,`rby`,`fby`,`rdate`,`rdate1`,`cc`,`status`,`hos1`,`m10`) values 
('$itype','$idept','$idetails','md','1601','ruzita','md01','$hos5','$user','1678','$adate1','$adate','363','Forwarded','$hos6','1585')";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Type Of Incident :</strong></label>
            ...
            <select name="idept" required/>
						<option value=''>-Select Department's Name</option>
				<?php 
      ...
      <textarea rows="25"  name="idetails" required value=""></textarea>
