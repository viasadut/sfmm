...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><a target='_blank' href="docassessprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Doctor's Assessment</a>&nbsp;&nbsp;
...
{ ?>    <tr>
	...
	<tr>
      ...
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="3" align="center"><strong>Order Date </strong></td>
      <td colspan="2" align="center"><strong>Given Date</strong></td>
	  <td colspan="4" align="center"><strong>Done By</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="4"><?php echo $row["user"]; ?></td>
      <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  <td align="center"colspan="3"><?php echo $row["ordate"]; ?></td>  
      <td align="center"colspan="2"><?php echo $row["gtime"]; ?></td>
