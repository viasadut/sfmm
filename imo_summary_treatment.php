...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right" style="font-size:25px;color:red;font-weight:bold"><a href="imoidocmedi?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Order Medicine</a></td></tr>
