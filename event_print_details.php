<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','rad','mng','qc','ev','evv','bill')"; 
...
$count=1;
$sel_query="Select * from pinfo where edate='$cdate' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="left"><?php echo $row["pname"]; ?></a></td>
      <td align="left"><?php echo $row["gender"]; ?>
	  <td align="left"><?php echo $row["cno"]; ?>
	  
      
		  
<td align="left"><a  target='_blank' href="event_par1?eid=<?php echo $row["id"]; ?>">Edit</td>  				  
<td align="left"><a  target='_blank' href="event_print1?eid=<?php echo $row["id"]; ?>">Print</td>  		
