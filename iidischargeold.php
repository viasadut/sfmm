...
$ins_query="insert into idischarge1 (`dname`,`pname`,`pphone`,`pmrn`,`page`,`psex`,`discharge`,`ddia`,`surgery`,`ill`,`other`,`plan`, `ddate`,`eid`,`emo`,`dinves`)
...
$update="update inpatient set discharge='Discharged',fstatustime='$date1',ddate1='$ddate1', duser='$user' where `eid`='$eid' and pmrn='$pmrn'";
...
$update2="update bed set status='Vacant', pname='',pmrn='', adate='', dname=''where bno='$room1'";
