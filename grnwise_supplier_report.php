...
<table bgcolor="#FFFF99">
    ...
    <tr>
        ...
        <td align="left" style="padding-left:10px;">
            <a href="po_report_product_grn.php?product_code=<?php echo urlencode($product_code); ?>&product_name=<?php echo urlencode($product_name); ?>&stdate=<?php echo urlencode($st_in); ?>&endate=<?php echo urlencode($en_in); ?>">
...
$row5 = mysqli_fetch_assoc($rr);


$sel_query2 = "SELECT * FROM medi_stock WHERE sno='$ono' ORDER BY id DESC";
$rr2 = mysqli_query($con, $sel_query2);
$row52 = mysqli_fetch_assoc($rr2);

if($po_type=='Pharmacy'){

    $link='grn_print_pdf_phar';
    $simple_string11 = $row52['grn'];
 }

 else{

    $link='grn_print_pdf_4';
    $simple_string11 = $row5['grn'];
 }
...
?>
        ...
        <a target="_blank" href="<?php echo $link;?>?ono=<?php echo urlencode($encryption1); ?>&grn=<?php echo urlencode($encryption11); ?>&id=<?php echo urlencode($row['re_date']); ?>">Print</a>
      </td>
    </tr>
    <?php
        $count++;
