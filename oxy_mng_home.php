...
<?php
$query87 = "SELECT COUNT(id) FROM oxygen_1 where status='Ready To Use' and type in('Portable Oxygen Cylinder (Bull) ','Oxygen Concentrator')"; 
...
$query88 = "SELECT COUNT(id) FROM oxygen_1 where status='In-Use' and type in('Portable Oxygen Cylinder (Bull) ','Oxygen Concentrator')"; 
...
$query89 = "SELECT COUNT(id) FROM oxygen_1 where status='Empty' and type in('Portable Oxygen Cylinder (Bull) ','Oxygen Concentrator')"; 
	 
$result89 = mysqli_query($con, $query89) or die(mysqli_error());

// Print out result
$row89 = mysqli_fetch_array($result89);
$em=$row89['COUNT(id)'];

$query90 = "SELECT COUNT(id) FROM oxygen_1 where status='Partially Used' and type in('Portable Oxygen Cylinder (Bull) ','Oxygen Concentrator')"; 
...
$query91 = "SELECT COUNT(id) FROM oxygen_1 where status='Sent For Refill' and type in('Portable Oxygen Cylinder (Bull) ','Oxygen Concentrator')"; 
...
<p align="center" class="style1">Oxygen Cylinder Management</p> 
...
<span class="label success" style="float:right;"><a href="bed_mng_test5">Back To Bed Management</a></span>
...
echo "<font color=green font size=5> Ready To Use-";
echo   $row87['COUNT(id)'];
echo "<br>";

echo "<font color=#F778A1 font size=5> In-Use-";
echo   $row88['COUNT(id)'];
echo "<br>";

echo "<font color=#BAB86C font size=5> Partially Used-";
echo   $row90['COUNT(id)'];
echo "<br>";

echo "<font color=#FF0000 font size=5> Empty-";
echo   $row89['COUNT(id)'];
echo "<br>";

echo "<font color=#800517 font size=5> Sent For Refill-";
echo   $row91['COUNT(id)'];
echo "<br>";


$count=1;	
$sel_query="Select * from oxygen_1 where aname in('Portable Oxygen Cylinder (Bull) ','Oxygen Concentrator') order by location asc ";	
...
if ($rows!=0)
{
	...
	<p><h1 style="color:red;font-size:40px;text-align:left"><blink>Oxygen Cylinder Status</blink></h1></P>	  
<div class="grid-container">
...
if($row['status']=='In-Use' and $row['aname']=='Portable Oxygen Cylinder (Bull) ')
{
echo"
<div class='grid-item'>


<span class='font1'>".$row["sno"]."</span><br><br>
<span class='font3' style='color:white;text-align:left'>WARD: ".$row["ward"]."<br></span>
<span class='font2' style='color:white; align:left' >BED: ".$row["bed"]."</span><br>


<span class='font2' style='color:white; align:left' >MRN: ".$row["pmrn"]."</span><br><br>
<span class=''><img src='oxygen_new.png' title='Oxygen In Use'></span><br>

<span class='font2' style='color:white; align:left' >Status: ".$row["status"]."</span><br>
<span class='font2' style='color:white; align:left' >Location: ".$row["location"]."</span><br>
";
...
else if($row['status']=='Ready To Use' and $row['aname']=='Portable Oxygen Cylinder (Bull) ')
{
echo"
<div class='grid-item2'>


<span class='font1'><a href='$url'>".$row["sno"]."</a></span><br><br>

<span class=''><img src='oxy_use.png' title='Ready To Use'></span><br>
<span class='font2' style='color:white; align:left' >Status: ".$row["status"]."</span><br>
<span class='font2' style='color:white; align:left' >Location: ".$row["location"]."</span><br>
";
...
else if($row['status']=='Empty' and $row['aname']=='Portable Oxygen Cylinder (Bull) ')
{
echo"
<div class='grid-item8'>
...
<span class=''><img src='eoxygen.png' title='Empty Oxygen'></span><br>
<span class='font2' style='color:white; align:left' >Status: ".$row["status"]."</span><br>
<span class='font2' style='color:white; align:left' >Location: ".$row["location"]."</span><br>
";
...
else if($row['status']=='Sent For Refill' and $row['aname']=='Portable Oxygen Cylinder (Bull) ')
{
echo"
<div class='grid-item3'>
...
else if($row['status']=='Partially Used' and $row['aname']=='Portable Oxygen Cylinder (Bull) ')
{
echo"
...
<span class=''><img src='eoxygen.png' title='Partially Used Oxygen'></span><br>
<span class='font2' style='color:white; align:left' >Status: ".$row["status"]."</span><br>
<span class='font2' style='color:white; align:left' >Location: ".$row["location"]."</span><br>
";
...
else if($row['status']=='In-Use' and $row['aname']=='Oxygen Concentrator')
{
echo"
<div class='grid-item'>
...
<span class='font2' style='color:white; align:left' >MRN: ".$row["pmrn"]."</span><br><br>
<span class=''><img src='Oxygen_concentrator.png' title='Oxygen Concentrator'></span><br>
<span class='font2' style='color:white; align:left' >Status: ".$row["status"]."</span><br>
<span class='font2' style='color:white; align:left' >Location: ".$row["location"]."</span><br>
";
...
else if($row['status']=='Ready To Use' and $row['aname']=='Oxygen Concentrator')
{
echo"
<div class='grid-item2'>
...
else if($row['status']=='Empty' and $row['aname']=='Oxygen Concentrator')
{
echo"
<div class='grid-item8'>
...
else if($row['status']=='Sent For Refill' and $row['aname']=='Oxygen Concentrator')
{
echo"
<div class='grid-item3'>
...
else if($row['status']=='Partially Used' and $row['aname']=='Oxygen Concentrator')
{
echo"
<div class='grid-item5'>
