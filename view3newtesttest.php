...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a href="historynewtest?pmrn=<?php echo "$pmrn"; ?>&eido=<?php echo $row["eid"]?>&date=<?php echo $row["date"]?>&dname=<?php echo "$full"?>&eid=<?php echo "$eid"?>"><b>Details<b></a></td>
