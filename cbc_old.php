...
$update1="update alllab set resultstatus='Updated By Technologist',result='$rr',resulttime='$rtime',resultby='$user',r1='$haemo',r2='$red',r3='$pcv',
...
//{
	...
	$url = "cbcv?id=$id&pmrn=$pmrn&eid=$eid" ;
header("Location:$url");
...
<!-- Form Title -->
	 ...
	 <label for="age"><strong>Patient's Name :</strong></label>
	  ...
	  {echo
	  '<label for="age" style="font-weight: bold;font-size:22px;color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Last Result:('.$data_opd["udate"].')</label>'
	  ;}
	  else {};
	  ?>
      ...
      <span><input name="wbc" id="wbc" type="text" style="font-weight: bold;font-size:22px;" value=""required/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
document.getElementById('wbc').onchange= f_color6;
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="red" id="red" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('red').onchange= f_color14;
	   ...
	   <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input name="haemo" id="haemo" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('haemo').onchange= f_color15;
	  ...
	  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input name="pcv" id="pcv" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('pcv').onchange= f_color13;
      ...
      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mcv" id="mcv" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('mcv').onchange= f_color12;
      ...
      <input name="mch" id="mch" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('mch').onchange= f_color11;
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mchc" id="mchc" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="pla" id="pla" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('pla').onchange= f_color8;
	  ...
	  <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="rdw" id="rdw" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('rdw').onchange= f_color9;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mpv" id="mpv" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('mpv').onchange= f_color7;
	  ...
	  <input name="neu" id="neu" type="text"  style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('neu').onchange= f_color5;
	  ...
	  <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="lym" id="lym" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('lym').onchange= f_color4;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mono" type="text" id="mono" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('mono').onchange= f_color2;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="eos" id="eos" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
...
document.getElementById('eos').onchange= f_color3;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="bas" type="text" value="" id="bas" required style="font-weight: bold;font-size:22px;">
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="esr" type="text" value=""required id="esr" style="font-weight: bold;font-size:22px;" >
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-weight: bold;font-size:22px;color:red"> <?php echo $data_opd['esr'];?></strong>
</span>
<script>
function f_color(){
