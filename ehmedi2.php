...
$count=1;
$sel_query="Select * from ehmedi where pmrn= '$pmrn' and eid='$eid' and status='Data Updated'order by `odate` asc;";
...
<td colspan="2" align="center"><a target='_blank' href="ehmedi1?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
