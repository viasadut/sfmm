...
$strSQL = "Select * from advance_bill where pmrn='$pmrn' and eid='$eid' order by `id` desc;";
...
$row45=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(amount) FROM advance_bill WHERE location='IPD' and dname='IPD ADVANCE' and pmrn='$pmrn' and eid='$eid'"));

$row455=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(amount) FROM advance_bill WHERE location='IPD' and dname='Refund' and pmrn='$pmrn' and eid='$eid'"));
...
$strSQL16 = "Select * from pms_bill where location='IPD' and dname='IPD ADVANCE' and pmrn='$pmrn' and eid='$eid';";
$objQuery16 = mysqli_query($objConnect,$strSQL16) or die ("Error Query [".$strSQL1."]");
$row433=mysqli_fetch_array($objQuery16);


$strSQL15 = "Select * from inpatient where pmrn='$pmrn' and eid='$eid' and discharge='' order by `id` desc;";
