...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For IT Entry' and itby='$user' and type='lab'order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radio where status='Waiting For IT Entry' and itby='$user' and type='rad' order by id desc;";
