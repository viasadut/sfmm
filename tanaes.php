...
$ins_query="insert into otanaestype (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
$count=1;
$sel_query="Select * from otanaestype where pmrn= '$pmrn' and eid='$id' and status1='Active'order by `id` DESC;";
