...
$count=1;
$sel_query="Select * from discharge1 where pmrn= '$pmrn' order by id desc;";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["emo"]; ?>
...
<?php	  $date=$row["dname"] ;?>
	   <td colspan="10"><a target='_blank' href="disreport.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
