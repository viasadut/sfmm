...
$query43 = "SELECT COUNT(dname) FROM pappnew where dname IN ('Ms. Shanti Bormon','Md. Shahid Khan','Mr. K. Utshab Zaman') and adate BETWEEN '$start' and '$end';"; 
...
$query44 = "SELECT COUNT(dname) FROM pappnew where dname IN ('Ms. Shanti Bormon','Md. Shahid Khan','Mr. K. Utshab Zaman') and dreffer='$bt' and adate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Consultant wise Physio Referral Stats</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Referred To</strong>
      <th width="14%"><strong>Refferal From</strong>
...
$sel_query="Select * from pappnew where dname in ('Ms. Shanti Bormon','Md. Shahid Khan','Mr. K. Utshab Zaman') and adate BETWEEN '$start' and '$end' order by adate";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
$sel_query="Select * from pappnew where dname in ('Ms. Shanti Bormon','Md. Shahid Khan','Mr. K. Utshab Zaman') and dreffer='$bt' and adate BETWEEN '$start' and '$end'order by adate";
 } 
$count=1;
