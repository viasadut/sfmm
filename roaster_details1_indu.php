<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','staff','imo','mofficer','nurse','ot','cath')"; 
...
$end=date($id1 . date('t', strtotime($date)));
	   ...
	   while(strtotime($date) <= strtotime($end)) {
        ...
        echo "<th align='center'>$day_num <br/> $day_name</th>";
    }
    ?>
...
$sel_query="Select * from staff3 where status ='Active' and sid='$fullname'";
//$start=$row["aadate"];
$count=1;
...
while($row = mysqli_fetch_assoc($rown)) { ?>
	  ...
	  <td align="center"style="display:none;"><?php echo $row["subdept"]; ?></a>
 ...
 <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title"align='center'>View Roster Duty</h4>  
                </div>  
