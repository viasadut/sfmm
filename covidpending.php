...
$stmt1 = $db->query("SELECT COUNT(sname) as tt1 FROM staff3 where tt=''");
...
$stmt = $db->query("Select * from staff3 where tt='' and desig !='Medical Officer'");
while($data = $stmt->Fetch(PDO::FETCH_OBJ)){
$this->Cell(8,10,$count,1,0,'L');
$this->Cell(14,10,'SFMM'.$data->sid,1,0,'L');
$this->Cell(58,10,$data->sname,1,0,'L');

$this->Cell(20,10,$data->cno,1,0,'L');
$this->Cell(40,10,$data->dept,1,0,'L');
$this->Cell(40,10,$data->desig,1,0,'L');
$this->Cell(86,10,$data->padd,1,0,'L');
