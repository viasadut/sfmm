    ...
    <tr>
	  ...
	  <td align="center"><?php echo $row["price"]; ?></td>
	  	  <td align="center"><?php echo $row["code"];?></td> 
				  ...
				  <td align="center"><?php echo $row["status"].' '.$row["rejectby"].' '.$row["rejectcom"];?></td> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from edit_inves where status not in ('Active') and type='rad' order by id desc;";
