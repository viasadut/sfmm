...
$pmrn=$_REQUEST['pmrn'];
$eid=$_REQUEST['eid'];
$query43 = "SELECT COUNT(pmrn) FROM histo_gallery where pmrn= '$pmrn' and eid='$eid';"; 
...
<div class="container">
    ...
    <form action="histoupload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from histo_gallery where pmrn='$pmrn' and eid='$eid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="histopic/<?php echo $image['image'] ?>">
                        <img class="img-responsive" alt="" src="histopic/<?php echo $image['image'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['image'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="histo_delete.php" method="POST">
