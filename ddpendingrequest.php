...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
     <th width="4%"><strong>S.No</strong></th>
	  ...
	  <th width="14%"><strong>DD Amount</strong>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from preadm where apstatus='Waiting For Forwarder Approval' and qc='$fullname' and ddrequest!='Reject'";
//$start=$row["aadate"];
...
<td align="center"><a href="qcddedit?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>View/Edit</strong></a></td>	   
<td align="center"><a onclick="return confirm_click();" href="ddaproval1?id=<?php echo $row["id"]; ?>"><strong>Forward</strong></a></td>
...
$sel_query="Select * from endopapp where apstatus='Waiting For Forwarder Approval' and qc='$fullname' and apstatus!='settled'";
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <td align="center"><?php echo $row["arequest"]; ?>  
	  <td align="center"><?php echo $row["apstatus"]; ?>  
<td align="center"><a href="ebilladmddbillendoqc?id=<?php echo $row["ID"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>View/Edit</strong></a></td>	   
<td align="center"><a onclick="return confirm_click();" href="ddaproval1endo?id=<?php echo $row["ID"]; ?>"><strong>Forward</strong></a></td>

<td align="center"><a href="rejectmd99ed?id=<?php echo $row["ID"]; ?>"><strong>Reject</strong></a></td>
