...
$query41 = mysqli_query($db,"select * from emergency where pmrn='$pmrn' and discharge!='Discharged'");

$query42 = mysqli_query($db,"select * from patient where pmrn='$pmrn'");
...
//{
    ...
    echo 'alert("Already Admitted "); ';
    echo '</script>';
} 
else if ($data41=mysqli_num_rows($query41)==0 and $data42=mysqli_num_rows($query42)==0){

$ins_query1="insert into patient (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`,`bdate`,`type`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$date91','$type')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query="insert into emergency (`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`eid`,`pphone`,`user`,`adate1`,`yage`,`adate2`,`type`,`e_type`) values ('$pname','$pmrn','$padd','$psex','$diff1','$adate','$eid','$pphone','$user','$adate1','$diff2','$adate2','$type','$a_type')";
...
/*$update1="update patient set bdate='$date91', etime='$etime', eby='$user' where `pmrn`='$pmrn'";
mysqli_query($con,$update1) or die(mysql_error());
*/
$ins_query="insert into emergency (`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`eid`,`pphone`,`user`,`adate1`,`adate2`) values 
('$pname','$pmrn','$padd','$psex','$diff1','$adate','$eid','$pphone','$user','$adate1','$adate2')";
mysqli_query($con,$ins_query) or die(mysql_error());

/*$update_insert="insert into patient_edit_record (`pmrn`,`pname`,`padd`,`pphone`,`bdate`,`psex`,`eby`,`etime`) values
('$pmrn','$pname','$padd','$pphone','$date91','$psex','$user','$etime')";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Patient's Details :</strong></label>
            ...
            <input name="pmrn" type="text" size="15" value="" placeholder="MRN" required>
...
<input name="dd" type="text" maxlength="2" size="1" value="" required>	/

<input name="mm" type="text" maxlength="2" size="1" value=""required> /	
