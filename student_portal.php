...
<?php if($user=='951' || $user=='792' || $user=='174' || $user=='322' || $user=='md' || $user=='ceo' || $user=='cfo' || $user=='82' || $user=='570' || $user=='857')

{	echo'	
<tr>	<td colspan="20"align="left"><a href="add_student"><font size="4.5">Add New Student</a> <font size="4.5" color="#FF0000"><b><b></td></tr>
	
<tr>	<td colspan="20"align="left"><a href="all_student"><font size="4.5">View All Student</a></td></tr>	
