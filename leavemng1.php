...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Status / Comments</strong>
...
$date= date('Y-m-d');
$count=1;
$sel_query="Select * from conleavedetails where status !='Approved By ALL' and status1 not in ('Cancel') order by sdate desc";
//$start=$row["aadate"];
