...
$rr='Anti-Thyroid Peroxidase(Anti-TPO)- :'.$atpo."<br />".'Anti-Thyoglobulin(Anti-TG):'.$atg;

$rr1='Anti-Thyroid Peroxidase(Anti-TPO)- :'.$atpo.' '.'IU/mL'."<br />".'Anti-Thyoglobulin(Anti-TG):'.$atg.' '.'IU/mL';
...
$ins_query1="insert into thyroid (`pname`,`pmrn`,`pphone`,`psex`,`page`,`atpo`,`atg`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$atpo','$atg','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>THYROID ANTIBODIES SCREEN(GP47B):</strong></label>
	  <label for="age"><strong>Anti-Thyroid Peroxidase(Anti-TPO)</strong></label>
      <input name="atpo" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>Anti-Thyoglobulin(Anti-TG):</strong></label>
      <input name="atg" type="text" size="70" style="text-transform:uppercase" value=""required>
