...
$ins_query6="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`ndate`,`uprice`,`code`,`stest`,`pre`) 
values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu','$ndate','$uprice','$p_code','$stest','$pre')";
...
<td colspan="8" align="center"><input list="rr" name="infu" class="form-control" autocomplete="off" required>
  <datalist id="rr">
...
<td colspan="2" align="center"><input list="rr10" name="root" class="form-control" required>
  <datalist id="rr10">
...
<tr>
<td colspan="4" align="center"><select list="rr1" name="infu1"  class="form-control" required>
...
<td colspan="4" align="center"><input list="infu2" name="infu2" class="form-control" value="<?php echo '';?>" required type="number">
  <datalist id="infu2">
