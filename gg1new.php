...
<input name="dd" type="text" maxlength="2" size="1" value="<?php if(isset($_POST['load'])==1)
{ $dd1 = $_REQUEST['dd'];
echo $dd1;
}
?>" required placeholder="DD">	/

<input name="mm" type="text" maxlength="2" size="1" value="<?php if(isset($_POST['load'])==1)
{ $mm1 = $_REQUEST['mm'];
echo $mm1;
}
?>" required placeholder="MM"> /	

<input name="yy" type="text" maxlength="4" size="1" value="<?php if(isset($_POST['load'])==1)
{ $yy1 = $_REQUEST['yy'];
echo $yy1;
}
