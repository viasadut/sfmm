...
$query = mysqli_query($db,"select * from 24urinealbumin where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'24 Hours Urine Albumin',1,0,'C');
$pdf->Cell('30',5,$data['uc'],1,0,'C');
$pdf->Cell('31',5,'mg/24Hrs',1,0,'C');
$pdf->Cell('40',5,'<30.0',1,1,'C');
