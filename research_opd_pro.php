...
$query43 = "SELECT COUNT(pname) FROM procedure1 where proname LIKE '%$bt%';"; 
...
<h1 align="center">OPD Procedure Search Panel</h1>
...
<!-- Form Title -->
  ...
  <datalist id="browsers111">
				...
				<?php 
			$sql76 = "select distinct proname from `procedure1` order by id LIMIT 500";
...
$sel_query1="Select * from procedure1 where proname LIKE '%$bt%'  order by id desc";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row1["proname"]; ?>
