...
<?php
    ...
    $query5 = mysqli_query($con,"select * from plastin where pmrn='$pmrn' and sno='$sno'");
...
if(isset($_POST['Submit'])){
    ...
    $apartial=$_REQUEST['apartial'];
    $aptt=$_REQUEST['aptt'];

    $adate= date('d/m/Y H:i:s');
    $adate1= date('m/d/Y');
    $rr='aPartial Thromboplastin Time:'.$apartial."<br />".'aPTT Control:'.$aptt;
    $rr1='aPartial Thromboplastin Time:'.$apartial.' '.'sec'."<br />".'aPTT Control:'.$aptt.' '.'sec';

// $ins_query1="insert into plastin (`pname`,`pmrn`,`pphone`,`psex`,`page`,`apartial`,`aptt`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
// ('$pname','$pmrn','$pphone','$psex','$page','$apartial','$aptt','$user','$adate','$eid','$iname','$id','$sno')";
// mysqli_query($con,$ins_query1) or die(mysql_error());

    $ins_query1="UPDATE plastin SET 
        `pname`='$pname',
        `pmrn`='$pmrn',
        `psex`='$psex',
        `page`='$page',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="apartial" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['apartial']?>" required />

            <label for="age"><strong>aPTT Control:</strong></label>
            <input name="aptt" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['aptt']?>" required />
        </fieldset>
        <table>
            <tr>
