...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['abo']?>" required>
            <label for="tibc"><strong>Rhesus(D) Group</strong></label>
            <input name="chikun2" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['dgroup']?>" required>
