...
if ($pmrn !== "") {
	...
	$query1 = mysqli_query($con, "SELECT * FROM medi_stock WHERE rfid='$pmrn' and location='Pharmacy' and add_qty>0");
...
//$mcode = $row['code'];
	  $sum = "SELECT SUM(add_qty) FROM medi_stock where code='$code1' and location='Pharmacy' and add_qty>0" ;
