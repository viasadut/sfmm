...
$sel_query="Select * from pappnew where dname in ('Ms. Shanti Bormon','Md. Shahid Khan','Mr. K. Utshab Zaman') and adate ='$date' order by ID";
$count=1;
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="historynewphysio?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row["eid"]?>&date=<?php echo $row["adate"]?>&dname=<?php echo $row["dreffer"]?>"><b>Details<b></a></td>	  
      </tr>
