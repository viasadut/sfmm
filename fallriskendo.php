...
$query43 = "SELECT COUNT(pmrn) FROM endopapp where pmrn= '$pmrn' and discharge='';"; 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);
$count =$row43['COUNT(pmrn)'];
$count1 = $count+1;
$query = "SELECT * from endopapp where pmrn= '$pmrn' and eid='$eid' and discharge=''"; 
...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from friskendo where pmrn='$pmrn' and eid='$eid'"; 
...
if($res=mysqli_num_rows($result2)>0)
{
	...
	$ins_query6="insert into friskendo (`pmrn`,`eid`,`fscore`,`date`,`udone`,`astime`) values ('$pmrn','$eid','$all','$date','$user','$astime')";
