...
$query = mysqli_query($con,"select * from all_consent_print where pmrn='$pmrn' and eid='$eid' and cname='$cname'");
...
<table width="100%">
					 ...
					 <tr>
                        ...
                        <td width="25%" style="text-align: left;"><img src="" style="width:40px;height:40px;"></td>
                    </tr>
					
					<tr>
                        
                        <td width="100%" align="center" style="font-size:12px;text-decoration: underline;"><b>'.$data['cname'].' REPORT</b></td>
