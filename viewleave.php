...
$strSQL = "Select * from staff1 where astatus='Active' and ugroup='Doctor' and stype in('Permanent','Contractual')";
...
?>
    <tr>
	  ...
	  <th width="14%"><strong>A.Balance</strong>
	  <th width="14%"><strong>C.F.Leave </strong>
	  <th width="14%"><strong>S.Leave </strong>
...
<td ><?php if($cyear==$doj12){echo $al2;} else {echo $al;}?></td>
      <td align="center"><?php echo $row["cfleave"]; ?>  
