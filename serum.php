...
$ins_query1="insert into serumtbl (`pname`,`pmrn`,`pphone`,`psex`,`page`,`s1`,`p1`,`c11`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$sodium','$potassium','$chloride','$user','$adate','$eid','$iname','$id','$sno')";
...
$update1="update alllab set resultstatus='Updated By Technologist',result='$rr',resulttime='$rtime',resultby='$user',r1='$sodium',r2='$potassium',r3='$chloride',result1='$rr1'
where `sno`='$sno'";
