...
$query = mysqli_query($db,"SELECT * from dietass where pmrn='$pmrn' and eid='$eid'" );
...
$pdf->Cell('183',6,'Dietician Assessment',1,1,'C');
...
$pdf->Cell('25',5,$data['ward'],1,0,'L');
$pdf->Cell('15',5,'BED:',1,0,'L');
$pdf->Cell('33',5,$data['bed'],1,0,'L');
$pdf->Cell('20',5,'Adm. Date:',1,0,'L');
$pdf->Cell('35',5,$data['adate'],1,0,'L');
$pdf->Cell('20',5,'Ass. Time:',1,0,'L');
$pdf->Cell('20',5,$data['atime'],1,1,'L');


$pdf->ln(3);

$pdf->Cell('50',5,'Height:',1,0,'L');
$pdf->Cell('132',5,$data['ph'],1,1,'L');

$pdf->ln(1);
$pdf->Cell('50',5,'Weight:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['pw'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'BMI:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['pbmi'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Recent Weight Changes:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['rwc'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Grading Of Obesity:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['go'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Grading Of Undernutration:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['gu'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Nutrition Related Diagnosis:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['nrd'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Feeding Mode:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['fm'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Chewing Difficulties:	',1,0,'L');
$pdf->MultiCell('132' , 5,$data['cd'],1,1);


$pdf->ln(1);
$pdf->Cell('50',5,'Swallowing Difficulties:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['sd'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Activity Level:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['al'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Diet Recommended By Clinicial:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['drc'],1,1);

$pdf->ln(1);
$pdf->Cell('50',5,'Diet Plan By Dietician:',1,0,'L');
$pdf->MultiCell('132' , 5,$data['dpd'],1,1);
