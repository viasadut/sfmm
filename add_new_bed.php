...
$ins_query1="insert into bed (`bno`,`type`,`category`,`type1`,`rclass`,`bcurtain`,`tv`,`wroomclass`,`almira`,`ref`,`moven`,`sofa`,`ac`,`bed`,`des`,`size`,`wfilter`,`aby`,`adtime`,`charge`,`bed_status`,sins,room,block,level,status,view)
values('$bno','$cat','$cat','$type','$rclass','$bcurtain','$tv','$wroomclass','$almira','$ref','$moven','$sofa','$ac','$bed','$des','$size','$wfilter','$user','$adate1','$charge','$bed_status','$sins','$room','$block','$level','Vacant','$view')";
...
<input type="text" name="cat" id="email" class="input-text" placeholder="Bed Category" size="70" value=""required>


	  <label for="age"><strong>Type:</strong></label>
<input type="text" name="type" id="email" class="input-text" placeholder="Bed Type" size="70" value=""required>

<label for="age"><strong>Bed No:</strong></label>
	 
<input type="text" name="bno" id="email" class="input-text" placeholder="Bed No" size="70"value=""required>     
...
<input type="text" name="size" id="email" class="input-text" placeholder="" size="70"value=""required>     
...
<textarea rows="40" name="bed" ></textarea>
...
<input type="text" name="charge" id="email" class="input-text" placeholder="" size="70"value=""required>     
...
<textarea rows="40" name="sins" ></textarea>


<label for="age"><strong>Room :</strong></label>
	 
<input type="text" name="room" id="email" class="input-text" placeholder="" size="70"value=""required>     


<label for="age"><strong>Block:</strong></label>
	 
<input type="text" name="block" id="email" class="input-text" placeholder="" size="70"value=""required>     


<label for="age"><strong>Level:</strong></label>
	 
<input type="text" name="level" id="email" class="input-text" placeholder="" size="70"value=""required>     
