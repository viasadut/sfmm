...
$ot_q = "SELECT COUNT(pmrn) FROM ot where pmrn='$pmrn' and date5='$date1' and status !='Cancel' and tby !=''"; 
...
<!-- Google Font -->
	...
	<tr>
	  ...
	  <td ><strong>Status</strong></td>
		...
		<?php
		$count4=1;
		$sel_query4="Select * from ot where pmrn='$pmrn' order by id desc LIMIT 5;";
...
<td colspan="2"><input type="text" name="duration" size="15"value="" required></td>  		             		
					 <td colspan="8"><select name="xl3"  class="js-example-basic-singlems active" placeholder="Select Investigations">
