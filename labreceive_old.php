...
$query = "UPDATE iinves set rby='$user',rtime='$dtime', rstatus='RECEIVED', barcode='$result5',status='RECEIVED',otime='$dtime1' where id='$id'"; 
...
values ( '$pmrn','$eid','$pname','$page','$psex','$redate','$rinfusion','$ruser','$rodate','$user','$dtime','$result5','IPD','$sno','$link','$linkv','$reportv','$report')";
