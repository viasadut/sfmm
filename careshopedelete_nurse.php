...
$url = "careshope2.php?pmrn=$pmrn&eid=$eid";
$query = "UPDATE careshope1 set cby='$user', ctime='$ctime',rstatus='Cancelled' WHERE id=$id"; 
...
header("Location:careshope2.php?pmrn=$pmrn&eid=$eid");
