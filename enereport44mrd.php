...
$query43 = "SELECT COUNT(discharge) FROM emergency where discharge IN('discharged','Admitted') and ddate1 BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query443 = "SELECT COUNT(discharge) FROM emergency where discharge = 'discharged' and ddate1 BETWEEN '$start' and '$end';"; 
	 
$result443 = mysqli_query($con, $query443) or die(mysqli_error());
$row443 = mysqli_fetch_assoc($result443);

$query543 = "SELECT COUNT(discharge) FROM emergency where discharge ='Admitted' and ddate1 BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from emergency where discharge IN ('discharged','Admitted') and ddate1 BETWEEN '$start' and '$end' order by fstatustime asc";
