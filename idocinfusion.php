...
values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$fname','Data Updated','$alert','Active','$adate','$time',' $add','$otime1','$infu1',' $add1','$qty1','$qty2','Ordered','$ortime')";
