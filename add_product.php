...
$p_name = str_replace("'", "''",$_REQUEST['p_name']);

$sel90="SELECT * FROM store_master WHERE `code`='$p_code';";
...
echo '<script language="javascript">';
	...
	$ins_query1="insert into store_master (`name`,`code`) values 
('$p_name','$p_code')";
...
<!-- Form Title -->
	  ...
	  <input  name="p_code" type="text" size="70" value=""required  />
	  
	  
	   <label for="age"><strong>Asset Name :</strong></label>
      
     <input  name="p_name" type="text" size="70" value=""required  />
	  
<table><tr><td colspan="15">		<button type="submit" name="Submit">Add Product</button></td>
</table>
