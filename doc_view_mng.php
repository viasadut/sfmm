...
$date1= date('Y-m-d');
$count=1;
$sel_query="Select distinct dname,sid from doctor where status in ('Active','active') order by dname asc";
//$start=$row["aadate"];
...
$ss=$row40['sid'];
   ...
   ?>
	 ...
	 <img  src="prescription/prescription/doctor/<?php echo $row40['pic']; ?>" width="60"  height="60" align="center">
	  
	  <b><?php echo $row["dname"].'('. $row40["Discipline"].')'; ?>
