...
{
$ins_query3="insert into opd_appoint1 (`dname`,`ddate`,`dslot`,`status`,`user`,`date1`,`remarks`,`otime`) 
values ('$name', '$date','$select','AVAILABLE','$user','$dd','AVAILABLE','$otime')";
...
function showUser(str) {
  ...
  xmlhttp.open("GET","app_data.php?q="+str + "&dname2=<?php echo $dname2;?>", true);
  xmlhttp.send();
}
</script>
