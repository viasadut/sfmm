...
$ins_query="insert into familyhistory (`dname`,`pmrn`,`pname`,`ins`,`date`) values ('$full', '$pmrn','$pname','$pins','$date')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Family History</strong></label></td> </tr>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
      	  ...
      	  <td colspan="16" align="center"><strong>Family History</strong></td>
...
$count=1;
$sel_query="Select * from familyhistory where pmrn= '$pmrn' order by `id` DESC;";
