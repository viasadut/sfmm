...
$pname=$data1["pname"];
$date1 = date('m/d/Y');
$ins_query1="insert into tphysio (`dname`,`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`) values ('$full1','$pmrn','$pname','$medi1','$pdos','$eid','$date1')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>physiotherapeutic Treatment </strong></label></td> </tr>
<tr><td colspan="10" align="center"><label><strong>Treatment</strong></label></td> 
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="10" align="center"><strong>Treatment</strong></td>
...
$count=1;
$sel_query="Select * from tphysio where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="delete1physio?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>">DELETE</a></td>
