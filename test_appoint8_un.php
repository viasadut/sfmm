...
$update="update opd_appoint1 set status='AVAILABLE',remarks='$reason',otime='$otime' where dslot='$select' and date1='$dd' and dname='$name' and status!='Booked'";
...
function showUser(str) {
  ...
  xmlhttp.open("GET","app_data_unblock.php?q="+str + "&dname2=<?php echo $dname2;?>", true);
  xmlhttp.send();
}
</script>
