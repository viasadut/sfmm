...
$query43 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='NEW'and tresult!='' and dconfirm='confirmed'"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='FollowUp' and tresult!='' and dconfirm='confirmed'"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);

$query45 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='Death' and tresult!='' and dconfirm='confirmed'"; 
	 
$result45 = mysqli_query($con, $query45) or die(mysqli_error());
$row45 = mysqli_fetch_assoc($result45);

$query46 = "SELECT COUNT(sid) FROM covidopd where rdate BETWEEN '$start' and '$end' and tresult!='' and dconfirm='confirmed'"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="7%"><strong>Name</strong></th>
	  <th width="4%"><strong>Age</strong></th>
	  <th width="4%"><strong>Gender</strong></th>
	  <th width="4%"><strong>MRN</strong></th>
	  <th width="4%"><strong>Blood Group</strong></th>
      <th width="7%"><strong>Collection Date</strong></th>
	  <th width="7%"><strong>Result Date</strong></th>
      <th width="7%"><strong>Phone</strong>
       
      <th width="7%"><strong>Address</strong>
	  <th width="7%"><strong>Ward</strong>
	  <th width="7%"><strong>District</strong>
      <th width="7%"><strong>Sample Type</strong>
	  <th width="7%"><strong>Patient Type</strong>
	  <th width="7%"><strong>Result</strong>
	  <th width="7%"><strong>Status</strong>
	  
	  
	  <th width="7%"><strong>Print Report</strong>
...
$start2=date('d/m/Y',strtotime($_REQUEST["stdate"]));
$end2=date('d/m/Y',strtotime($_REQUEST["endate"]));
...
echo "<font color=blue font size=5> Samples Has Been Tested";
...
echo "  To  ";
echo $end2;
	 $sel_query="Select * from covidopd where rdate BETWEEN '$start' and '$end' and tresult!='' and dconfirm='confirmed' order by sid asc"; 
...
{ ?>    <tr>
     ...
     <td align="center"><?php echo $count; ?></td>
	  ...
	  <td align="center"><?php echo date('d/m/Y',strtotime($row["rdate"])); ?>
...
$inform=$row['uploaded'];
$dstatus=$row['dconfirm'];
$url8 = "covid_stats_mrd?id=$id8&sdate=$start&edate=$end"; 
?>
<td align="center"><?php if($inform=='Uploaded' and $dstatus=='confirmed'){echo "<span style='color:green;text-align:center;'><b>Already Updated in DGHS";}else {echo '';}?></td>
