...
//$id =$_GET['id'];
$count=1;
$sel_query="Select distinct pname,dname,date,dname,eid,pmrn from pmedi where date='$date' order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="tes2?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>">UPDATE</a></td>
	  <td align="center"><a href="phsttest2?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>">NEW</a></td>
