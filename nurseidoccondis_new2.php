...
header("Location: nurseidoccondis_new2?pmrn=$pmrn&eid=$eid");
    }
			...
			<div class="col-md-6">
                    <div class="card card-info">
                        <div class="card-header p-2">
                            Patient Discharge <?php if($data['disstatus']!='Discharge Bill Confirmed'){echo "<span style='color:yellow;weight:bold;font-size:25px;'>(Bill Not Confirmed Yet)</span>";}?>
                        </div>
                        <div class="card-body">
							<table>
								<tr>
								...
								<tr>
									...
									<?php if($data['disstatus']=='Discharge Bill Confirmed' and $data['confirmdn']!='' and $data['rfid_status']=='0' and $data['rfid_card2_status']=='0' and $data['rfid_acard_status']=='0' )
									{echo
