...
$dcode=$result1["code"];
$tprice=$result1["ipd_charge"]*$pdos;
$sub_type=$result1["sub_type"];

$price=$result1["ipd_charge"];
...
$ins_query1="insert into endohoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`ieid`,`type`,`remarks`)
 values ('$pmrn','$pname','$ii','$eid','$date1','$pdos','$code','$t_price','$ieid','$sub_type','Package')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
  ...
  $ins_query1="Update endohoscharge set pdos='$pdos2',price='$p12' where eid='$eid' and pmrn='$pmrn' and ieid='$ieid' and medi='$medi1'";
mysqli_query($con,$ins_query1) or die(mysql_error());
  ...
  //else {
    $ins_query1="insert into endohoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`ieid`,`type`)
    values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$tprice','$ieid','$sub_type')";
   mysqli_query($con,$ins_query1) or die(mysql_error());}
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="endohosdelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&id1=<?php echo "$id"; ?>">DELETE</a></td>
