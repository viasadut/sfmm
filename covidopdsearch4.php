<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','qc','mrd','covid','covid1','call')"; 
...
$count=1;
$sel_query="Select * from covidopd where sid= '$pmrn' and lstatus='Received' and dconfirm='confirmed'order by ID desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo "<a target='_blank' href='$url2'>Edit</a>"; ?></td>
