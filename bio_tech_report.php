<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('bio','mng','endo')"; 
...
<tr>
		...
		<tr><td colspan="5" align="left"><a href="project_bio/projectbio/sample_comments"><font size="4.5">View Sample List</a></td></tr>
