...
$query40 = "SELECT * FROM staff1 where mname='$name' and astatus='Active';"; 
...
page='$page',psex='$psex',district='$district',specimen='$specimen',rdate='$rdate',rdate1='$rdate1' where name='$name'";
...
<input type="text" name="rdate" id="datepicker6" placeholder="Select Date" size="15" value="<?php if($data["rdate"]=='0000-00-00'){echo '';}else {echo date('m/d/Y',strtotime($data['rdate']));}?>">



<label for="age"><strong>Last date of contact with positive case:</strong></label>
<input type="text" name="ldate" id="datepicker1" placeholder="Select Date" size="15" value="<?php echo date('m/d/Y',strtotime($data['ldate']));?>" >
...
<input type="text" name="quntil" id="datepicker3" placeholder="Select Date" size="15" value="<?php echo date('m/d/Y',strtotime($data['quntil']));?>">

	<label for="age"><strong>Retest:</strong></label>
<input type="text" name="retest" id="datepicker2" placeholder="Select Date" size="15" value="<?php echo date('m/d/Y',strtotime($data['retest']));?>">
