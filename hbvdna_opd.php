...
$rr1='HBV-DNA- :'.$chikun1."<br />".'Unit:'.$chikun3."<br />".'Copies:'.$chikun2;

$rr='HBV-DNA- :'.$chikun1."<br />".'Unit:'.$chikun3.'IU/mL'."<br />".'Copies:'.$chikun2.'Copies/mL';



$ins_query1="insert into hbvdna (`pname`,`pmrn`,`psex`,`page`,`result`,`opinion`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`crate`) values 
