...
$url = "idismomedi.php?pmrn=$pmrn&eid=$eid"; 
?>
...
if($code4!='' and $brand2!='')
{
$ins_query1="insert into idismedi (`dname`,`pmrn`,`pname`,`medi`,`eid`,`brand`,`pdos`,`date`,`ndate`,`duration`,`frelation`,`oby`,`otime`,`status`) values 
('$ddname1','$pmrn','$pname','$ii','$eid','$brand2','$ii2','$date1','$date2','$ii3','$ii4','$user','$otime','Active')";
...
$ins_query1="insert into idismedi (`dname`,`pmrn`,`pname`,`medi`,`eid`,`brand`,`pdos`,`date`,`ndate`,`duration`,`frelation`,`oby`,`otime`,`status`) values 
('$ddname1','$pmrn','$pname','$medi1','$eid','$brand2','$pdos','$date1','$date2','$duration','$pdos1','$user','$otime','Active')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
{ echo'
				 ...
				 <td align="center" colspan="2"><a href="imoidismomedidelete1?id='.$row["id"].'&pmrn='.$pmrn.'&eid='.$eid.'">DELETE</a></td>';
