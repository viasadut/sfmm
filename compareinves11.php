...
<h1 align="center">Compare Investigation Result</h1>
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and infusion ='$infu' and rstatus IN ('RECEIVED','REJECTED') order by infusion;";
