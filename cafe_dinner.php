...
$dd1=date('d/m/Y');
            ...
            $output = "";
                ...
                $output .='<table style="border:0px;border-collapse:collapse;border-spacing:0px;" width="100%">
								...
								<td style="border: 1px solid black" width="10%" align="center"><b>Instructsion</td>
                            </tr>
                                
                            
                            ';
                $query1 = mysqli_query($con,"select * from iidiet where odate ='$dd' and status='Diet Ordered' and diettime in ('Dinner','Extra Food') and status1!='Cancel'order by room");
                $count=1;
                while ($data1 = mysqli_fetch_array($query1)) {
                    $output .='
                            <tr>
								...
								<td style="border: 1px solid black" width="10%" align="center"> '.$data1['room'].'</td>
								<td style="border: 1px solid black" width="10%" align="center"> '.$data1['bed'].'</td>
								...
								<td style="border: 1px solid black" width="10%" align="center"> '.$data1['pins'].'</td>
                            </tr>
            ...
            $mpdf->SetHTMLHeader('
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="80%" align="center"><b><h1 align="center"> Dinner Diet Order Sheet</h1> </b></td>
