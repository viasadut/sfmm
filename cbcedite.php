...
<?php
    ...
    $iname=$data['infusion'];
    // $pmrn=$data['pmrn'];
    $query5 = mysqli_query($con,"select * from cbctbl where sno='$inid'");
...
`promyclocyte`='$promyclocyte',`metamyclocyte`='$metamyclocyte',`myoblast`='$myoblast',`lymphoblast`='$lymphoblast',`nrbc`='$nrbc', `remarks`='$remarks',a_cell='$acell' where sno='$inid'";
...
document.getElementById('bas').onchange= f_color1;
	  ...
	  else if($data1['esr']>0 and $data1['esr']<20)
	  {
	  
	  echo '
	   <label for="age"><strong>ESR:</strong></label>
	  <input name="esr" type="text" value="'.$data1["esr"].'" id="esr" required style="font-weight: bold;font-size:22px;color:green">';
	  }
	  else 
	  {
	  ...
	  echo '
	   <label for="age"><strong>ESR:</strong></label>
	  <input name="esr" type="text" value="'.$data1["esr"].'" id="esr" required style="font-weight: bold;font-size:22px;color:red">';
	  }
	  ?>
...
<span>
<input name="promyclocyte" type="text" value="<?php echo $data1['promyclocyte'];?>" style="font-weight: bold;font-size:22px;" >

</span>
	  
<label for="age"><strong>Metamyclocyte:</strong></label>
<span>
<input name="metamyclocyte" type="text" value="<?php echo $data1['metamyclocyte'];?>" style="font-weight: bold;font-size:22px;" >
 </span>


<label for="age"><strong>Lymphoblast:</strong></label>
<span>
<input name="lymphoblast" type="text" value="<?php echo $data1['lymphoblast'];?>" style="font-weight: bold;font-size:22px;" >
 
</span>

<label for="age"><strong>Myoblast:</strong></label>
<span>
<input name="myoblast" type="text" value="<?php echo $data1['myoblast'];?>" style="font-weight: bold;font-size:22px;" >
...
<input name="nrbc" type="text" value="<?php echo $data1['nrbc'];?>"required style="font-weight: bold;font-size:22px;" >
...
<?php echo $data1['remarks'];?>
        ...
        <table>
            <tr>
                <td colspan="15"> <button type="submit" name="Submit">Confirm Edit</button></td>
                <td colspan="10"> <a target='_blank'
                        href="cbc_view_result_ae1?inid=<?php echo "$inid"; ?>&id=<?php echo $id; ?>"><img
                            src="print.png" title="Print Report" width="150" height="60" /></a></td>
							
							         <td colspan="10"> <a href="testlabreceive">Back to Pending Panel</a></td>
            </tr>
        </table>
    </form>
</body>
