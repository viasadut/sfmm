...
values ( '$pmrn','$id','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$user','Data Updated','$alert','Active','$adate','$time',' $add','$otime1','$infu1',' $add1','$qty1','$qty2','Ordered','$ortime')";
...
//$episode=$data["eid"];
$count=1;
$sel_query="Select * from otendoinfusion where pmrn= '$pmrn'and eid='$id'and odate='$ad' and status1='Active' and status='Data Updated' order by `ddate` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="otinfusionusenurse?id3=<?php echo $row["id"]; ?>&id=<?php echo $id; ?>&pmrn=<?php echo $row["pmrn"]; ?>&infusion=<?php echo $row["infusion"]; ?>&odate=<?php echo $row["odate"]; ?>&addi=<?php echo $row["addi"]; ?>&add1=<?php echo $row["add1"]; ?>&qty1=<?php echo $row["qty1"]; ?>&qty2=<?php echo $row["qty2"]; ?>">Update</a></td>
