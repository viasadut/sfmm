...
$ins_query="insert into idisposible (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Equipment Charges</strong></label></td> </tr>
<tr>


<td colspan="16" align="center"><label><strong>Equipment Item Name</strong></label></td> 
