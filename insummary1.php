...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="4"><?php echo $row104["duser"]; ?></td>
		...
		<td align="center"colspan="4"><?php echo $row104["uprice"]; ?></td>
...
$result198as = mysql_query($query198as) or die(mysql_error());

// Print out result
$row198as = mysql_fetch_array($result198as);
...
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid' and udone !='' order by `time` asc;";
...
$result198ad = mysql_query($query198ad) or die(mysql_error());

// Print out result
$row198ad = mysql_fetch_array($result198ad);
...
$result198af = mysql_query($query198af) or die(mysql_error());

// Print out result
$row198af = mysql_fetch_array($result198af);
...
$result198ag = mysql_query($query198ag) or die(mysql_error());

// Print out result
$row198ag = mysql_fetch_array($result198ag);
...
$result198ah = mysql_query($query198ah) or die(mysql_error());

// Print out result
$row198ah = mysql_fetch_array($result198ah);
...
<td align="center"colspan="2"><?php echo $row["date"]; ?></td>
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
			...
			<?php
				        ...
				        <td align="center"colspan="2"><?php echo $row["pdos"].' ('.$uom.')'; ?></td>
...
$result198j = mysql_query($query198j) or die(mysql_error());

// Print out result
$row198j = mysql_fetch_array($result198j);
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="otuse?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">Details OT Charge</a> </td>
...
<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Grand Total is:<?php echo $test1c+$test1+$test1as+$test1a1+$test1al+$test1ai+$test1am;?> (BDT)</strong></td></tr>	
</table>
</form>
</body>
