...
$stmta = $db->query("Select * from covidopd where ssent BETWEEN '$start' and '$end' and status='collected'");
...
{
$this->Cell(300,10,'Total '.$yya.' Samples Has Been Sent  '.'(New Sample- '. $yy1a.' & FollowUp Sample- '.  $yy2a.' & Death Sample- '.  $yy3a.')'. ' From '.$start1.' TO '.$end1,0,1,'C');
...
$stmt = $db->query("Select * from covidopd where ssent BETWEEN '$start' and '$end' and tresult='P' order by ssent desc");
...
$this->Cell(25,($line * $cellHeight),$data->lid,1,0);
...
$this->Cell(18,($line * $cellHeight),$data->sentto,1,0);
...
$this->Cell(15,($line * $cellHeight),$data->ward,1,0);
