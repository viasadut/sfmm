...
$count=1;
$sel_query="Select * from cme where status= 'Approved' order by `date` DESC;";
...
<td align="center"colspan="2"><a  target='_blank' href="cmerecord?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">Details</td>  
<td align="center"colspan="2"><a  target='_blank' href="cme_print?id=<?php echo $row["id"]; ?>&topic=<?php echo $row['topic'];?>">Print</td>  		
 ...
 <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title">CME ATTENDANCE</h4>  
                </div>  
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          <label>NAME OF THE TOPIC</label>  
                          <input type="text" name="name" id="topic" class="form-control" readonly/>  
                          <br />  
