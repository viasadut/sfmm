...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="echom_yy?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">ECHO</a></td>
	  <td colspan="1"align="center"><a href="ecgmanualm_yy?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">ECG</a></td>
	  <td colspan="1"align="center"><a href="ettm_yy?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">ETT</a></td>
	  	  <td colspan="1"align="center"><a href="cathreportm_yy?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">CATHLAB</a></td>
