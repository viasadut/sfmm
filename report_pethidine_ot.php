...
$query = mysqli_query($db,"select * from othoscharge1 where id='$id'");
...
$nurse_name=$data['nuser'];
$charge_date=$data['ndate'];

$query_pa = mysqli_query($db,"select * from ot where pmrn='$patient_pmrn' and date5='$charge_date' order by id desc");
...
$pdf->Cell('38',5,date('d/m/Y H:i:s',strtotime($data['time'])),1,0,'L');
$pdf->Cell('13',5,'Area:',1,0,'L');
$pdf->Cell('49',5,'OT',1,1,'L');
