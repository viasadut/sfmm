...
$query41 = mysqli_query($db,"select * from patient where pmrn='$pmrn'");



if ($data41=mysqli_num_rows($query41)>0 and $user!='')
	{
//if ($con->query($ins_query) == TRUE) 
//{

    echo '<script language="javascript">';
    echo 'alert("Patinet is Already registerd in the system "); ';
    echo '</script>';
} 
else if ($data41=mysqli_num_rows($query41)==0){

$ins_query1="insert into patient (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`,`bdate`,`fname`,`mname`,`aby`,`dtime`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$date91','$fname','$mname','$user','$dtime')";
...
<!-- Form Title -->
      ...
      <input name="padd" type="text" size="70" value=""required>
	  ...
	  <label for="age"><strong>Patient's Details :</strong></label>
            ...
            <input name="pmrn" type="number" size="15" value="" placeholder="MRN" required>
      <input name="pphone" type="tel" maxlength="11" size="13" value="" placeholder="Phone No" required pattern="[0-9]{11}">	  
	  
      <br><br>
<label><strong>Date Of Birth(DD/MM/YYYY) :</strong></label>
<input name="dd" type="number" max="31" size="1" value="" required>	/

<input name="mm" type="number" max="12" size="1" value=""required> /	

<input name="yy" type="number" maxlength="2999" size="1" value=""required>		  
	  <br><br>
