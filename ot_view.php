...
$test = isset($_SESSION['user_session_id']) ? $_SESSION['user_session_id'] : '';
?>

<?php
$conn = new mysqli("localhost", "root", "", "sfmmkpjnew");
...
<head>
	...
	<script>
		function showUser() {
			...
			xmlhttp.open("GET", "ot_view_data.php", true);
			xmlhttp.send();
		}
