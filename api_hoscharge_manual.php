...
$query39 = "SELECT * FROM inhoscharge where id= '$id'"; 
...
$acode=(int)$row['code'];
$aprice=(int)$row['price'];
$price=(int)$aprice/$pdos;
$medi=$row['medi'];
...
//echo json_encode($data);
  ...
  $invoice_no=$decoded_response['invoice_id'];
   ...
   if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
    ...
    $api_query = "update inhoscharge set api_status='1', invoice_no='$invoice_no' where id='".$id."'"; 
