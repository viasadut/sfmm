...
$pdf->Cell('80',5,$data3->medi,0,0,'L');
...
lab_render_approval_footer($pdf, $db1, 'IMMUNOLOGY/SEROLOGY', '', (isset($data3->checked_by)?$data3->checked_by:''), (isset($data3->cby)?$data3->cby:''));
$pdf->Ln(10);
