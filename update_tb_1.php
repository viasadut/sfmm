...
$query44 = "SELECT COUNT(ID) FROM pappnew where adate1 BETWEEN '$start' and '$end' and bill='BILLED';"; 
...
$date=$err_p['adate1'];
      ...
      ('$updateid','CR','$cr_code','$dcode','$cost_centre','$date','1','$amount','OPD')";
     ...
     /* $strSQL1 = "insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`status`,`amount`) values 
      ...
      ('$updateid','DR','$dr_code','$dcode','$cost_centre','$date','1','$amount','OPD')";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
<h1 align="center">UNPROCESSED OPD DATA</h1>
...
echo $end;
	 ...
	 $sel_query="Select * from pappnew where adate1 BETWEEN '$start' and '$end' and bill='BILLED'";
