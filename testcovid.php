...
$pdf->Cell('183',6,$qty.' Records Found'.' From  '.$start1. '  TO  ' .$end1,0,1,'C');
...
$query1 = mysqli_query($db,"Select * from covid where ssent BETWEEN '$start' and '$end' ;");
...
if($data1["tresult"]=='N'){
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->WriteHTML('Result                      : '.$data1['tresult']);}
