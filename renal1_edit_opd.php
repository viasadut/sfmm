...
<?php 
    ...
    $query5 = mysqli_query($con,"select * from renal where pmrn='$pmrn' and sno='$sno'");
...
$urine_albumin_creatinine_ratio=$_REQUEST['urine_albumin_creatinine_ratio'];
    ...
    $ins_query1="UPDATE renal SET 
        ...
        `micro_albu_urine`='$micro_albu_urine',
...
<!-- Form Title -->
	 ...
	 <label for="age"><strong>Patient's Name :</strong></label>
	  ...
	  <input name="page" type="text" size="2"value="<?php echo $data['page']?>" required readonly>
      
	  <label for="age"><strong>RENAL FUNCTION TEST (GP40A):</strong></label>


      <label for="age"><strong>Uric Acid:</strong></label>
      <input name="uacid" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['uacid']?>"required>
	  <label for="age"><strong>Creatinine:</strong></label>
      <input name="creatinine" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['creatinine']?>"required>
	  <label for="age"><strong>Urea:</strong></label>
      <label for="age"><strong>Bicarbonate:</strong></label>
      <input name="urea" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['urea']?>"required>
	  <label for="age"><strong>Sodium:</strong></label>
      <input name="sodium" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['sodium']?>"required>
	  <label for="age"><strong>Potassium:</strong></label>
      <input name="potassium" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['potassium']?>"required>
	  <label for="age"><strong>Chloride:</strong></label>
      <input name="chloride" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['chloride']?>"required>

      <label for="age"><strong>Bicarbonate:</strong></label>
      <input name="bicarbonate" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['bicarbonate']?>"required>
	  <label for="age"><strong>Total Protein:</strong></label>
      <input name="tprotein" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['tprotein']?>"required>
	  <label for="age"><strong>MicroAlbumin, Urine:</strong></label>
      <input name="micro_albu_urine" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['micro_albu_urine']?>"required>
	  
      <label for="age"><strong>Creatinine, Urine:</strong></label>
      <input name="creatinine_urine" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['creatinine_urine']?>"required>
	  	  <label for="age"><strong>Urine Albumin / Creatinine Ratio:</strong></label>
      <input name="urine_albumin_creatinine_ratio" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['urine_albumin_creatinine_ratio']?>"required>
	  
	  	  <label for="age"><strong>Serum Calcium:</strong></label>
      <input name="scal" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['scal']?>"required>
	  
	  	  <label for="age"><strong>Serum Inorganic Phosphate:</strong></label>
      <input name="po4" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['po4']?>"required>
	  
	  	  <label for="age"><strong>eGFR:</strong></label>
      <input name="egfr" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['egfr']?>"required>
