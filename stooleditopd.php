...
$query5 = mysqli_query($db,"select * from stool where inid='$id'");
...
$update="update alltest set resulttime='$adate',resultby='$user',result='$rr',result1='$rr1' where id='$id'";
...
<!-- Form Title -->
      ...
      <input name="pname" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data2['pname']?>"required/>
 	  

	  <label for="age"><strong>Patient's Details :</strong></label>
	  	
      <input name="psex" type="text" size="5"value="<?php echo $data2['psex']?>" required/>
														
						
            <input name="pmrn" type="text" size="15" value="<?php echo $data2['pmrn']?>" required/>
      <input name="pphone" type="text" size="13" value="<?php echo $data2['pphone']?>"  required/>	  
	  <input name="page" type="text" size="2"value="<?php echo $data2['page']?>" required/>
