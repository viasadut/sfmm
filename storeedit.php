...
<h1 align="center">HOSPITAL CHARGE EDIT PANEL</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="2%"><strong>Name</strong></th>
      
	  <th width="2%"><strong>Type</strong>
	  <th width="5%"><strong>Price</strong>
	  <th width="5%"><strong>Status</strong>
	  <th width="5%"><strong>Edit </strong>
	  <th width="5%"><strong>Edit Price</strong>
...
echo   $row44['COUNT(eid)'];

$sel_query="Select * from storenew ";}
...
$sel_query="Select * from storenew where etype='$bt';";
}

$count=1;
//$sel_query="Select * from storenew order by etype asc;";
...
{ ?>    <tr>
      ...
      <td align="center" ><a href="hoschargeedit1store?id=<?php echo $row["id"]; ?>">Edit</a></td>
	  <td align="center" >
    <?php if($user!='1603'){echo'
    <a href="store_edit?id='.$row["id"].'">Edit Price</a>';}
    ?></td>
	  <td align="center" ><a onclick="return confirm_click();" href="mmadactivatestore?id=<?php echo $row["id"]; ?>">Deactivate</a></td>
      </tr>
