...
$query43 = "SELECT COUNT(sid) FROM attendance where sid= '$bt' and adate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Attendance Stats</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
   ...
   <tr>
      ...
      <th width="14%"><strong>Attendance Location</strong>   
...
$count=1;
$sel_query="Select * from attendance where sid= '$bt' and adate BETWEEN '$start' and '$end' order by id desc;"; 
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["etime"]; ?>
      <td align="center"><?php echo $row["location"]; ?>
	  <td align="center"><?php echo $row["status"].'<br>'.$row["com"]; ?>
