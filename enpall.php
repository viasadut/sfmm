...
$query59 = mysqli_query($db,"select * from emergency where pmrn='$pmrn' and eid='$eid'and discharge=''");
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><a href="engcs?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Patient Triage<b></a></td></tr>
...
$count=1;
$sel_query="Select * from ecnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from enprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from edprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from einfusion where pmrn= '$pmrn'and eid='$episode' order by `ddate` DESC;";
...
$count=1;
$sel_query="Select * from estret where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
$count=1;
$sel_query="Select * from eidiet where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
$count=1;
$sel_query="Select * from eblood where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="1" align="center"><strong>HITS CODE</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center" colspan="1"><?php echo $count; ?></td>
      <td align="center"colspan="1"><?php echo $row["dcode"]; ?></td>
...
$count=1;
$sel_query="Select * from erefferal where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
$count=1;
$sel_query="Select * from evisit where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
{ ?>    <tr>
    ...
    <?php $count++; } ?>
	<tr><td colspan="10"><a target='_blank' href="esummaryprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr>	
</table>
</form>
</body>
