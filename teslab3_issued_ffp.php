...
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_ffp'style="color:red">FFP</a>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from bcross1 where status='Issued' and udate between '$test1' and '$test' and btype='FFP' order by udate desc;";
