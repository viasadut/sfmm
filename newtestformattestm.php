...
$update33="update pappnew set `height`='$pheight',`weight`='$pweight',`temp`='$ptemp',`pbp`='$pbp',`pbmi`='$pbmi',`ppluse`='$ppluse',`mstatus`='$pmstatus',`occupation`='$poccupation',`eid`='$count1', `status`='SEEN',`stime`='$stime',`spo2`='$spo2',`rr`='$rr' where `ID`='$id'";
...
$url = "historynewviewm?pmrn=$pm&eid=$count1&date=$pdate&dname=$pd" ;
header("Location:$url");
}
}
?>
