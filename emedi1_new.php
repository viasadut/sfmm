...
$count=1;
$sel_query="Select * from estat where pmrn= '$pmrn' and eid='$eid'  order by `otime` asc;";
...
<td colspan="2" align="center"><a target='_blank' href="emedi2?pmrn=<?php echo "$row[pmrn]"; ?>&eid=<?php echo $data59["eid"]; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
...
$count=1;
$sel_query="Select * from emedi2 where pmrn= '$pmrn' and eid='$eid' and status1='implemented'order by `donet` desc;";
