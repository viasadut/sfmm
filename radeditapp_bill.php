...
<h1 align="center">Cancel Patient Appointment </h1>
...
$count=1;
$sel_query="Select * from radpapp where dname='$bt' and adate BETWEEN '$start' and '$end' and status not in ('Cancel','SEEN');";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="appedit_bill?ID=<?php echo $row['ID'];?>">CANCEL</a>  
