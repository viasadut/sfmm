...
$ins_query="insert into endoinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from endoinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status1='Active' and status='Data Updated' order by `ddate` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="iinfuupdate1nurse?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Given</a></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from endoinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status='Given' order by `ddate` DESC;";
