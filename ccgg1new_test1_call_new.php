...
$sel="SELECT * FROM pappnew WHERE `pphone`='$pphone' and `pmrn`='$pmrn' and `dname`='$dname2' and adate='$date23' and status!='Cancel';";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="dis" id="dis" class="district" placeholder="District" required style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:200px"> 
...
$(document).ready(function() {
    $('.district').select2();
	 ...
	 <input name="pphone" type="text" id="pphone" placeholder="Phone No"value="" required style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:200px" min="11" max="11">	  
...
<label for="mail"><strong>Appointment Date :</strong></label>
			...
			<select id="txtHint" style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:120px" name = 'slot' required class="country">
...
function showUser(str) {
  ...
  xmlhttp.open("GET","opd_slot.php?q="+str + "&dname2=<?php echo $dname2;?>", true);
  xmlhttp.send();
}
</script>
</body>
