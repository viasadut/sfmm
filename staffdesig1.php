...
$query43 = "SELECT COUNT(sid) FROM staff3 where desig='$desig'"; 
...
<h1 align="center">Staff Stats Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="8%"><strong>Gender</strong>
      <th width="8%"><strong>Department</strong></th>
      <th width="8%"><strong>Designation</strong>
	  <th width="8%"><strong>Phone</strong>
	  <th width="8%"><strong>Address</strong>
	  <th width="8%"><strong>DOJ</strong>
      <th width="8%"><strong>District</strong>   
...
echo   $row43['COUNT(sid)'];
	 ...
	 $sel_query="Select * from staff3 where desig='$desig' order by id asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php if($row["doj"]=='1970-01-01' ||$row["doj"]=='0000-00-00'){echo '';}else {echo date('d/m/Y',strtotime($row["doj"]));}?>
	  
	  <td align="center"><?php echo $row["district"]; ?>
