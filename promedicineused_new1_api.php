...

{
  ...
  $sql = "insert into promediused (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`code`,`adate`,`price`) 
  ...
  $last_id = $conn->insert_id;
      ...
      $invoice_no=$decoded_response['invoice_id'];
       ...
       if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
        ...
        $ins_query="UPDATE promediused SET api_status='1', invoice_no='$invoice_no' WHERE id='$last_id'";
...
$sql = "insert into promediused (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`reuse`,`adate`,`code`,`price`) values 
