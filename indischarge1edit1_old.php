...
$update="update idischarge1 set dname='$dname', emo='$full', ddate='$date1', discharge='$discharge',ddia='$ddia', surgery='$surgery', ill='$ill', other='$other', plan='$plan', dinves='$dinves' where `eid`='$eid' and pmrn='$pmrn'";
...
<h1 align="center">EDIT DISCHARGE NOTE </h1>
...
<tr><td colspan="20"><select name="discharge" placeholder="Select Discharge Type" required>
...
<tr><td colspan="20"><label><strong>Case Note:</strong></label></td></tr>
...
<tr><td colspan="20"><textarea id="exampleTextarea2" name="dinves" rows="5" placeholder="Advise on Discharge"><?pnhp echo $row40['dinves'];?></textarea></td>  </tr>	
