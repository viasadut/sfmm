...
$query47 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tresult='P'"; 
	 
$result47 = mysqli_query($con, $query47) or die(mysqli_error());
$row47 = mysqli_fetch_assoc($result47);

$query48 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tresult='N'"; 
...
<?php $count++; } }?>
      ...
      <td colspan ="2" align="right"><a target='_blank' href="test_pdf12?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
