...
$ins_query="insert into istat (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`odate1`,`root`,`alert`,`time`,`date`,`status1`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$fname','$remarks','Data Updated','$odate1','$root','$alert','$time','$date','Active')";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idocstatstop?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo "$user"; ?>">Stop</a></td>
