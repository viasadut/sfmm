<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','ddf','doctor','moopd','staff','nurse')"; 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>"><b>Details<b></a></td>
