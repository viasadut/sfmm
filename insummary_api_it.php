...
echo $diff->format("%R%a days");?>  </td>
	  <td align="center"><a href="api_admission_manual1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission</a></td>
     <td align="center"><a href="api_admission_manual1_1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission with MRN</a></td>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from emergency where discharge= '' and api_status=0 order by id desc";
...
$diff=date_diff($date1,$date2);
echo $diff->format("%R%a days");?>  </td>
	  <td align="center"><a href="api_admission_manual1_ae?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission (A&E)</a></td>
     <td align="center"><a href="api_admission_manual1_ae1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission (A&E) with MRN</a></td>
