...
$pdf->Cell('100',5,'Test',0,0,'L');
$pdf->Cell('30',5,'Result',0,0,'L');
$pdf->Cell('30',5,'Unit(IU/mL)',0,0,'L');
$pdf->Cell('25',5,'Copies / mL',0,1,'L');
...
$pdf->Cell(100,5,$data->infusion,0,0);
$pdf->Cell(30,5,$data->result,0,0);
$pdf->Cell(30,5,$unit,0,0);
$pdf->Cell(25,5,$data->ins,0,1);


$pdf->SetFont('Times', 'B', 12);
$pdf->Ln(10);
$pdf->Cell(25,5,'Sample: '. $data->sample,0,1);
$pdf->Ln(5);
$pdf->Cell(25,5,'Method: '. $data->method,0,1);
