...
$query43 = "SELECT COUNT(lstatus) FROM presnew where lstatus= '$bt' and date BETWEEN '$start' and '$end';"; 
...
<h1 align="center">LAB REQUEST SERVED REPORT </h1>
...
<form action="tes5lab" method="POST">
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<option value='served'>Partially Served</option>
...
$count=1;
$sel_query="Select * from presnew where lstatus='$bt' and date BETWEEN '$start' and '$end';";
