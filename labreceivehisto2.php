...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('lab','histo')"; 
...
$query45 = mysqli_query($db,"select * from proinves where id='$id'");
...
$query = "UPDATE proinves set rby='$user',rtime='$dtime', rstatus='RECEIVED', barcode='$result5',status='RECEIVED' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());

$url = "sample_receive_print2?pmrn=$pmrn&eid=$eid&id=$id";
header("Location: $url"); 
...
<td colspan="4" align="center"><input type="text" name="infu" required value="<?php echo $data45["pdos"]; ?>" readonly/></td>
