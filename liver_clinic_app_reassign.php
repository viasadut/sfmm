...
$sel_query="Select * from pappnew where adate1 between '$test' and '$test1' and status NOT IN ('Cancel','SEEN') and dname IN('Dr. Dinesh Jothimani','Dr. Naresh P Shanmugam','Dr. Kumar Palaniappan') and bill='BILLED' ORDER BY adate1 asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
	...
	<td><input type="button" name="edit" value="Re-Assign" id="'.$row['ID'].'" class="btn btn-info btn-xs edit_data"></td>
...
<div id="dataModal" class="modal fade">  
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     ...
                     <form method="post" id="insert_form" name="frmMain2">  
                          ...
                          <input type="text" name="app_date" id="app_date" class="form-control"readonly>
 ...
 <label>Location</label>                          
						  ...
						  <label>Already Assigned Doctor Name</label>  
                          <input type="text" name="dname" id="dname" class="form-control"  size="15" readonly>  
...
<script>  
 $(document).ready(function(){  
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"update_liver_consultant_reassign.php",  
                     method:"POST",  
...
if (q=="" || g=="") {
  ...
  xmlhttp.open("GET","opd_slot.php?q="+q+"&dname2="+g, true);
