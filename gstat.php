<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('billin','bill','staff')"; 
...
$query43 = "SELECT COUNT(id) FROM gdetails where anew BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Datewise Guest House Stats Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="7%"><strong>NID No</strong>
      <th width="7%"><strong>Type</strong>
	  <th width="7%"><strong>A. Date</strong>
	  <th width="7%"><strong>D. Date</strong>
...
$count=1;
$sel_query="Select * from gdetails where anew BETWEEN '$start' and '$end' order by anew asc";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["rname"]; ?>
      <td align="center"><?php echo $row["pphone"]; ?>  
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["peradd"];?> 
