...
{
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`rfid`,`code`,`ndate`,`route`,`remarks`,`location`,`aqty`,`ins`,`time`,`mtime`) values 
('$pmrn','$pname','$medi1','$bb_name','$pdos','$id','$date1','$rfid','$code','$adate','$route','$remarks','$location','$m_qty1','$t_price','$time','$mtime')";
...
{
$ins_query1="update othoscharge1 set pdos='$pdos2',aqty='$m_qty1',ins='$t_price2', mtime='$mtime' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query21="update phar_sale set qty='$pdos2',tprice='$t_price2' where pmrn='$pmrn' and eid='$eid' and rfid='$rfid' and adate='$adate'";
...
{
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`rfid`,`code`,`ndate`,`route`,`remarks`,`location`,`reuse`,`aqty`,`ins`,`mtime`) values
 ('$pmrn','$pname','$charge_name','$bb_name','$pdos','$id','$date1','$rfid','$c_code','$adate','$route','$remarks','$location','Yes','$mm_qty','$new_charge_price','$mtime')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
{
$ins_query1="update othoscharge1 set pdos='$pdos2',aqty='$mm_qty',ins='$new_charge_price1',mtime='$mtime' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<td colspan="5" align="center"><input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="browsers2" autocomplete="off" name='medi1' required style="font-weight: bold;font-size:22px;color:green">
  <datalist id="browsers2">
            ...
            require('db1.php');
            $uname = '';
            $query = "select * from `medi_stock` where add_qty>0 and location='OT Medicine Store' and status in('Served','Partially Served')";
...
<td colspan="4">
  ...
  <select id="rr10" name="location" required>
...
<td colspan="2"><input type="text" name="mtime" id="" required value=""  style="font-weight: bold;font-size:22px;color:green"></td>
<td colspan="3"><input type="text" name="remarks" id="" required value=""  style="font-weight: bold;font-size:22px;color:green"></td>
...
{ echo'
				 ...
				 <td align="center" colspan="2"><a href="othosdelete1_new?id='.$row["id"].'&pmrn='.$pmrn.'&eid='.$id.'&rfid='.$row["rfid"].'&reuse='.$row["reuse"].'&pdos='.$row["pdos"].'">DELETE</a></td>';
