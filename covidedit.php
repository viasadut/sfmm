...
$query39 = "SELECT * FROM covid where sid= '$sid3'"; 
...
$query40 = "SELECT * FROM staff1 where sid='$sid3' and astatus='Active';"; 
	 
$result40 = mysqli_query($con, $query40) or die(mysqli_error());

// Print out result
$data1 = mysqli_fetch_array($result40);
$depart1=$data1['designation'];
...
page='$page',psex='$psex',district='$district',specimen='$specimen',rdate='$rdate',rdate1='$rdate1',sam2='$sam2',sam21='$sam21',rrdate1='$rrdate1',rrdate2='$rrdate2' where sid='$sid3'";
...
<input type="text" name="sid" id="email" class="input-text" placeholder="Phone" size="70"value="<?php echo $data1['sid'];?>"readonly>     
...
<input type="text" name="phone" id="email" class="input-text" placeholder="Phone" size="70"value="<?php echo $data1['phone'];?>"readonly>     

<label for="age"><strong>Address:</strong></label>
<input type="text" name="padd" id="email" class="input-text" placeholder="padd" size="70"value="<?php echo $data1['preadd'];?>"readonly>     
...
<input type="text" name="rdate" id="datepicker6" placeholder="Select Date" size="15" value="<?php if($data['rdate']=='1970-01-01' || '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($data['rdate']));}?>">



<label for="age"><strong>Last date of contact with positive case:</strong></label>
<input type="text" name="ldate" id="datepicker1" placeholder="Select Date" size="15" value="<?php if($data['ldate']=='1970-01-01' || '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($data['ldate']));}?>">
...
<input type="text" name="quntil" id="datepicker3" placeholder="Select Date" size="15" value="<?php if($data['quntil']=='1970-01-01' || '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($data['quntil']));}?>">

	<label for="age"><strong>Retest:</strong></label>
<input type="text" name="retest" id="datepicker2" placeholder="Select Date" size="15" value="<?php if($data['retest']=='1970-01-01' || '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($data['retest']));}?>">
...
<input type="text" name="sam2" id="datepicker5" placeholder="Select Date" size="15" value="<?php if($data['sam2']=='1970-01-01' || '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($data['sam2']));}?>">

<label for="age"><strong>2nd Result Date:</strong></label>
<input type="text" name="rrdate1" id="datepicker7" placeholder="Select Date" size="15" value="<?php if($data['rrdate1']=='1970-01-01' || '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($data['rrdate1']));}?>">
