...
$query34 = "SELECT * FROM doctor1 where did= '$attn_id'"; 
	 
$result34 = mysqli_query($con, $query34) or die(mysqli_error());
...
<tr><td colspan="20"align="center"bgcolor="lightblue"class="style1" border="0" style="color:red;font-size:60px;font-weight:bold">'.$row34["Discipline"].'</td>
