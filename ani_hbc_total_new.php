...
$rr1='Result- :'.$chikun1."<br />".'Result Interpretation:'.$chikun3."<br />".'Type:'.$type;

$rr='Result- :'.$chikun1."<br />".'Result Interpretation:'.$chikun3."<br />".'Type:'.$type;
...
$ins_query1="insert into antihbc (`pname`,`pmrn`,`psex`,`page`,`result`,`crate`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`type`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$chikun3','$user','$adate','$eid','$iname','$id','$sno','$type')";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Anti-Hbc- Total:</strong></label>
	  ...
	  <label for="tibc"><strong>Result Interpretation</strong></label>
      <input name="chikun3" type="text" size="70"  value=""required>
	  
	  
	  	  <label for="tibc"><strong>Result Interpretation</strong></label>
      <textarea name="chikun2" type="text" size="70"  value=""required readonly>
	  Reference Range:
	  Negative: >0.80
	  Borderline: 0.80 - 0.10
	  Positive: <0.10
	  </textarea>
