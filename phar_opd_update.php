...
$eqty5 = $_POST['eqty2_'.$updateid];
			...
			$strSQL = "update medi_stock set rfid='".$eqty5."' where id='".$updateid."'";
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Brand Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from medi_stock where add_qty>0 and status IN ('') and location='Pharmacy' and rfid=''";
...
<td align="center"colspan="1"><input name="eqty2_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row['rfid_old'];?>" readonly ></td>
