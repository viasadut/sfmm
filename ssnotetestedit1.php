...
$ins_query="insert into otreport (`pmrn`,`eid`,`pname`,`otdate`,`sname`,`sreport`,`ottype`) values ( '$pmrn','$id','$lx','$otdate','$full','$sreport','$ottype')";
...
$count=1;
$sel_query="Select * from otreport where pmrn= '$pmrn' and eid='$id' and sname='$full' and c_status!='Cancelled' order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="10"><?php echo $row["sreport"]; ?></td>
	  	  ...
	  	  <td align="center"colspan="10"><a target='_blank' href="ssnotetestedit?id=<?php echo "$id"; ?>&pmrn=<?php echo $row["pmrn"]; ?>&id1=<?php echo $row["id"]; ?>">EDIT</a></td>
