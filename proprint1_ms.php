...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Proname Name</strong>  
      <th width="14%"><strong>Print Note</strong>
...
$sel_query="Select * from m_suite where pdate= '$date' and ustatus='paid' and stype='Regular' ;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
  ...
  $sel_query="Select * from m_suite where pdate= '$date' and stype='Package' ;";
