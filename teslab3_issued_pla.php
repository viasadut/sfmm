...
<?php 
$test=date('Y-m-d');
$test1=date('Y-m-d', strtotime('-120 days') );
  //echo $test;
...
<p align="center" class="style1">Blood Bank Issued Portal</p> 
<h1 align="center" style="background-color:lightgreen;text-align:left">
<a href='teslab3_issued' >Whole Blood</a>
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_prbc' >PRBC</a>
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_pla'style="color:red">PLATELET CONCENTRATE</a>
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_ffp'>FFP</a>
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_plaa'>PLATELET APHERESIS</a>
</h1>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from bcross1 where status='Issued' and udate between '$test1' and '$test' and btype='PLATELET CONCENTRATE' order by udate desc;";
