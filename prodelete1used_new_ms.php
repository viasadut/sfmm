...
$url = "promedicineused_new1_ms.php?pmrn=$pmrn&eid=$eid&dname=$dname&id=$id";	 

$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$sel_p=mysqli_query($db,"SELECT COUNT(id) FROM promediused_ms WHERE `id`='$id';");
...
$query = "DELETE FROM promediused_ms WHERE id='$id'"; 
...
header("Location:promedicineused_new1_ms.php?pmrn=$pmrn&eid=$eid&dname=$dname&id=$id");
