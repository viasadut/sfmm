...
//$query4 = mysqli_query($db,"select * from icd1 where pmrn='$pmrn' and eid='$eid' and pdate='$date' and dname='$dname'");
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'ICD10 Diagnosis:',0,1,'L');
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from icd1 where pmrn='$pmrn' and eid='$eid' and pdate='$date' and dname='$dname'");
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data1['Diseasesub'],0,1);
...
$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Diagnosis Remarks:',0,1,'L');
$pdf->SetFont('Arial' , '' , 10);
