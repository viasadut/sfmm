...
$update33="update histo set `cinfo`='$cinfo',`spe`='$spe',`gdes`='$gdes',`mdes`='$mdes',`dia`='$dia',`status`='REPORT DONE',`dname1`='$full',`rtime`='$time',`rdate`='$date1',`date1`='$dd',`hno`='$hno' where `id`='$id'";
