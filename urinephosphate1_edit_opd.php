...
$query5 = mysqli_query($con,"select * from 24urinephosphate where pmrn='$pmrn' and sno='$sno'");
...
if(isset($_POST['Submit'])){
    ...
    $adate1= date('m/d/Y');
    $rr='24 Hours Urine Volume:'.$chikun1."<br />".'24 Hours Urine Protine:'.$chikun2;
    $rr1='24 Hours Urine Volume:'.$chikun1.' '.'mL'."<br />".'24 Hours Urine Protine:'.$chikun2.' '.'g/24hrs';

    $ins_query1="UPDATE 24urinephosphate SET 
        `uv`='$chikun1',
        `uc`='$chikun2',
        `uby`='$user',
        `udate`='$adate',
...
<body>
    ...
    <form action="" method="post">
        <!-- Form Title -->
        <h1>Urinary Phosphate (24hrs urine) </h1>
        <fieldset>
            <legend></legend>
            <!-- Name Input -->
            ...
            <label for="age"><strong>24 HOUR URINE PROTINE Report:</strong></label>
            ...
            <label for="tibc"><strong>24 Hours Urine Protine</strong></label>
