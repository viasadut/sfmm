...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('rad','doctor','mng','staff')"; 
...
/*try {
  ...
  $sh = $db2->prepare("insert into radio (iname,type,subtype,price,code,adtime,adby,instruction,tcentre,interpretation,fby,status,ceo,cfo,itby,md,price1,cprice,ittime1,com_remarks,com_price) VALUES 
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  ...
  $sh = $db2->prepare("insert into radio1 (iname,type,subtype,price,code,adtime,adby,instruction,tcentre,interpretation,fby,status,ceo,cfo,itby,md,price1,cprice,ittime1,com_remarks,com_price) VALUES 
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $sh->execute([$mname,$bname,$cname,$form,$cat,$adate,$user,$instruction,$tcentre,$interpretation,$bill,$bf,$ceo,$cfo,$it,$md,$form1,$cprice,$ittime1,$com_remark,$com_price]);

  $sh = $db2->prepare("insert into radio2 (iname,type,subtype,price,code,adtime,adby,instruction,tcentre,interpretation,fby,status,ceo,cfo,itby,md,price1,cprice,ittime1,com_remarks,com_price) VALUES 
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $sh->execute([$mname,$bname,$cname,$form,$cat,$adate,$user,$instruction,$tcentre,$interpretation,$bill,$bf,$ceo,$cfo,$it,$md,$form1,$cprice,$ittime1,$com_remark,$com_price]);
...
<!-- Form Title -->
      ...
      <input name="bname" type="text" size="70"  value="RAD"readonly>
      ...
      <select name="cname" required>
						...
						<?php 
			$sql = "Select DISTINCT subtype  from radio where type='rad';";
