...
$sel_query="Select * from medi_stock where location='$start' and status!='Pending' ORDER BY g_name asc;";
...
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["batch_no"]; ?></td>
	  ...
	  <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["u_price"]; ?></td>
	  <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["add_qty"] * $row["u_price"]; ?></td>
	  
	  
	  <td align="left" ><a target='_blank' href="department_bar.php?id=<?php echo $row['id']; ?>">bar_print</a></td>
	  <td align="left" ><a target='_blank' href="edit_medi_stock_oop.php?id=<?php echo $row['id']; ?>"></a></td>
	  
      </tr>
	  
    <?php $count++; } 
	
$sum = "SELECT sum(pmrn) FROM ot where otdate='$start'" ;
