...
$pmrn=$_REQUEST['pmrn'];
//$eid=$_REQUEST['eid'];
$query43 = "SELECT COUNT(pmrn) FROM inves_gallery where pmrn= '$pmrn';"; 
...
<div class="container">
    ...
    <form action="invesupload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from inves_gallery where pmrn='$pmrn';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="invespic/<?php echo $image['image'] ?>">
                        <img class="img-responsive" alt="" src="invespic/<?php echo $image['image'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['image'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="inves_delete.php" method="POST">
