...
$query45 = mysqli_query($db,"select * from emedi where pmrn='$pmrn' and id='$id'");
...
$update="update emedi set dtime='$dtime',ddate='$ddate', status='Rupdated', duser='$user' where `id`='$id'";
...
$count=1;
$sel_query="Select * from emedi where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
