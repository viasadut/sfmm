...
<a href='teslab3_issued' style="color:red">Whole Blood</a>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from bcross1 where status='Issued' and udate between '$test1' and '$test' and btype='Whole Blood' order by udate desc;";
