...
$sel_query="Select * from medicinerequest where rstatus NOT IN ('DONE','Cancelled') and rstatus='Forward to CFO Approval' and '$fullname'='cfo'  ORDER BY id asc;";
...
$date= date('m/d/Y');
$count1=1;
$sel_query="Select * from medicineedit where status='WAITING FOR CFO APPROVAL' and cfo='$user'";
//$start=$row["aadate"];
...
$date= date('m/d/Y');
$count1=1;
$sel_query="Select * from medicineedit where status='WAITING FOR IT ENTRY' and it='$user'";
//$start=$row["aadate"];
...
<td align="center"><a href="edit_phar1_p?id=<?php echo $row["id"]; ?>"><strong>View/Edit</strong></a></td>	   
<td align="center"><a onclick="return confirm_click();" href="phar_edit_confirm_test?id=<?php echo $row["id"]; ?>"><strong>Confirm</strong></a></td>
...
$date= date('m/d/Y');
$count1=1;
$sel_query="Select * from medicineedit where status in ('WAITING FOR IT ENTRY','WAITING FOR MD APPROVAL','WAITING FOR CFO APPROVAL','Waiting For Finance Fowrading') and ceo='$user'";
//$start=$row["aadate"];
