...
$query6 = "SELECT * FROM ccom where id= '$id'"; 
...
$ins_query1="update ccom set cname='$cname', res='$res' where id='$id'";
...
<!-- Form Title -->
	  ...
	  <input list="browsers111" name="cname"  size="80"  style="text-transform:uppercase"required autocomplete='off' value="<?php echo $cname;?>">
  <datalist id="browsers111">
	  ...
	  <label for="age"><strong>Responsibilities:</strong></label>
			 ...
			 <div>
									...
									<div>
                                           <textarea name="res" class="form-control" placeholder="Details"rows="25"cols="25" style="font-size:22px;"><?php echo $res5;?></textarea>
