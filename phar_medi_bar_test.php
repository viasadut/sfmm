...
$sel96="SELECT * FROM imedi3 WHERE `pmrn`='$pmrn' and eid='$eid' and pstatus='Served' and status !='Cancel' and ndate='$nn' order by id desc limit 1;";
...
$pno=$b_chk_m['pno'];
		 ...
		 $mpdf = new \Mpdf\Mpdf([
                ...
                $query1 = mysqli_query($con,"select * from imedi3 where pmrn='$pmrn' and eid='$eid' and pstatus ='Served' and status !='Cancel' and pno='$pno' order by infusion asc");
                //$count=1;
...
$sel95="SELECT * FROM medi_stock WHERE `rfid`='$rfid1';";
