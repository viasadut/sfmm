...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="echom?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">ECHO</a></td>
	  <td colspan="1"align="center"><a href="ecgmanualm?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">ECG</a></td>
	  <td colspan="1"align="center"><a href="ettm?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">ETT</a></td>
	  	  <td colspan="1"align="center"><a href="cathreportm?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>">CATHLAB</a></td>
