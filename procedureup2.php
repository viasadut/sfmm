...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus in('Updated') and dname='$full' and rstatus!='DONE' ;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["proname"]; ?>  
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="procedure2?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">UPDATE</a> </td>
		   <td align="center"><a onclick="return confirm_click();" href="procancel?id=<?php echo $row["id"]; ?>&cby=<?php echo $row["dname"]; ?>"> Cancel</a></td>
...
$sel_query="Select * from procedure1 where pdate= '$date' and ustatus in('Updated','Paid') and dname='$full' and rstatus in('DONE','');";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["proname"]; ?>  
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="procedure3?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">Edit</a> </td>
