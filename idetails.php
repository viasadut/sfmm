<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','nurse','mng','imo','oic')"; 
...
<tr>
			<td colspan="5"align="center"><button type="submit" name="Submit213">Nurse's Assessment</button></td>
			<td colspan="5" align="center"><button type="submit" name="Submit214">Fallrisk Assessment</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row14['COUNT(pmrn)']; ?>)<b></td>
	<td colspan="3"align="center"><button type="submit" name="Submit13">Nurse's Note</button></td>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit10">Vitals</button><font size="4.5" color="#FF0000"><br><b>(<?php echo  $row22['COUNT(pmrn)']; ?>)<b></td>
		<td colspan="2"align="center"><button type="submit" name="Submit4r">Return Medi List</button><font size="4.5" color="#FF0000"><br><b><b></td>	
...
<td colspan="5" align="center"><button type="submit" name="Submit1">Infusion</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row14['COUNT(pmrn)']; ?>)<b></td>
 ...
 <tr>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit9">Confirm Final Discharge</button></td>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit503">Doctor's Assessment</button></td>
		<td colspan="2" align="center"><button type="submit" name="Submit100">Surgery Note</button></td>

</tr>
<tr>
<td colspan="5" align="center"><button type="submit" name="Submit501">Fluid Chart</button></td>
...
<td colspan="2" align="center"><button type="submit" name="sum_charge">Summary Charges</button></td>
</tr>
...
<td colspan="3" align="center"><button type="submit" name="nurse_form">Print Nursing Form</button></td>
<td colspan="3" align="center"><button type="submit" name="icu_notes">ICU Notes</button></td>
<td colspan="2" align="center"><button type="submit" name="all_consent_form">ALL Consent Form</button></td>
<td colspan="2" align="center"><button type="submit" name="Submit99"><span style="color:red;font-weight:bold;">Nurses Procedure</span></button></td>
</tr>
