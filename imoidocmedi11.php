...
$objDB1 = mysql_select_db("sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$sel90 = "SELECT * from imedi2 where pmrn='$pmrn' and time='$time' and odate='$odate' and infusion='$infu'"; 
$result90 = mysqli_query($con,$sel90);
...
echo '<script language="javascript">';
    ...
    echo '</script>';
			...
			$strSQL = "insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime')";
...
<td colspan="8" align="center"><input list="rr" name="infu" class="form-control">
  <datalist id="rr">
...
<tr>
<td colspan="4" align="center"><input list="rr1" name="infu1"  class="form-control">
  <datalist id="rr1">
...
<td colspan="4" align="center"><input list="rr2" name="infu2"  class="form-control">
  <datalist id="rr2">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><input list="rr3" name="infu3"  class="form-control">
  <datalist id="rr3">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><input list="rr4" name="infu4"  class="form-control">
  <datalist id="rr4">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><input list="rr5" name="infu5" class="form-control">
  <datalist id="rr5">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
...
<table align="center" class="table table-bordered" id="dynamic_field">  
<tr>
		<td colspan="21"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="addpharmediimo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Medicine</a></strong>&nbsp;&nbsp;<a href="datewisemediimo?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
