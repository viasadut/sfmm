...
<label for="name"><strong>Admitted Through:</strong></label>
			...
			<label for="mail"><strong>Visit / Admission Date :</strong></label>
									<p>
									  <input type="text" name="adate" id="datepicker" placeholder="Select Date" size="8" value="" required>
      ...
      <textarea rows="5"  name="diag" required></textarea>
		...
		<label for="mail"><strong>Discharge Date:</strong></label>
									<p>
									  <input type="text" name="ddate" id="datepicker1" placeholder="Select Date" size="8" value="" required>
...
<td><a target='_blank' href="injurycerprint1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
