...
<div class="column">
        <img class="circular--square" src="prescription/prescription/doctor/<?php echo $gg ?>" width="120"  height="120" align='center'>
      </div>
	  </div>
...
<tr><td colspan="20"align="center"bgcolor="lightgreen"><h3> Please Select Your Desire Module  ( Date: '.date('d/m/Y').')</h3> </td></tr>
<tr>
...
<a href="deathstatmngdoc"><font size="4.5">	MMRC </a>

	</td>
	<td colspan="2"align="center">
<a href="ticket/index"><font size="4.5">	IT Ticketing System </a>
...
<td colspan="3"align="center">
<a href="deathstatmngdocz"><font size="4.5">	MMRC </a>
