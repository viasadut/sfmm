...
$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`room`,`room1`,`eid`,`pphone`) values ('$dname', '$pname','$pmrn','$padd','$gender','$page','$adate','$btype','$bno','$count1','$pphone')";
...
$update98="update vcard set status='BOOKED'where `c_no`='$vcard'";
mysqli_query($con,$update98);

$update99="update vcard set status='BOOKED'where `c_no`='$vcard1'";
