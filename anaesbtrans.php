...
$query198 = mysqli_query($db,"SELECT SUM(infusion) FROM anaesbtrans where pmrn='$pmrn'and eid='$eid'"); 
...
$ins_query="insert into anaesbtrans (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$remarks','$user','Data Updated','$odate1','$time','$date','Active','$infu')";
...
<td colspan="7" align="center"><select name="infu" class="form-control"required>
...
$count=1;
$sel_query="Select * from anaesbtrans where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
