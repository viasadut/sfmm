...
<div id='cssmenu'>
<ul>
   <li><a href='hinfo111'><span>Home</span></a></li>
   
   <li class='last'><a href='logout'><span>LOGOUT</span></a></li>
</ul>
</div>

<p align="center" class="style1">Code List</p> 
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select distinct code_name,code_color from code order by code_name asc";

$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      <td align="center" style="background-color:<?php echo $row['code_color'];?>;color:white;font-weight:bold;font-size:20px;"><?php echo $count.')'; ?></td>
      <td align="center" style="background-color:<?php echo $row['code_color'];?>">
	  <input name="code_name" style="background-color:<?php echo $row['code_color'];?>;color:white;font-weight:bold;font-size:20px;" type="text" value="<?php echo $row['code_name'];?>" readonly>
	  </td>
	...
	<input style="background-color:<?php echo $row['code_color'];?>;font-size:25px;font-weight:bold" type="button" name="edit_co" value="Call Code" id="<?php echo $row['code_name']; ?>" class="btn btn-info btn-xs edit_data_co" />
 ...
 <div id="add_data_Modal7" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title">Code Call Panel</h4>  
                </div>  
      ...
      $(document).on('click', '.edit_data_co', function(){  
           ...
           $.ajax({  
                ...
                success:function(data){  
                     ...
                     $('#employee_id2').val(data.code_name);  
                     $('#insert450').val("Confirm");  
