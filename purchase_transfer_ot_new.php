...
if($res95=mysqli_num_rows($result95)==0)
{
    ...
    echo '</script>';
			...
			*/
			...
			$ins_query1="insert into purchase_stock_new (`code`,`g_name`,`b_name`,`add_qty`,`req_loc`,`status`,`location`,`rfid`,`sno`,`u_price`,`t_price`,`re_by`)
 values ('$code','$medi','$medi','$tprice','$p_mrn1','Pending','$p_mrn1','$rfid5','$sno','$uprice','$charge','$user')";
mysqli_query($con,$ins_query1) or die(mysql_error());
			
			
$url = "purchase_transfer_ot_new?sno=$sno";
header("Location: $url"); 
...
<td colspan="6" align="center"><textarea name="medi" id="code" class="form-control action" cols="30" rows="5"style="font-weight: bold;font-size:22px;color:green"readonly required>
						...
						<td colspan="3"><input type="text" name="tqty" id="tqty" required value="" readonly style="font-weight: bold;font-size:22px;color:green">
...
$count=1;
//$count=1;
$sel_query="Select * from purchase_stock_new where sno= '$sno' order by `id` DESC;";
