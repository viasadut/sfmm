...
<p align="center" class="style1">List of Package Patients</p>
<form action="" method="GET">
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from package_screening where status='Active' order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["psex"]; ?>  </td>
		   ...
		   <td align="center"><a  href="imo_pack_details?pmrn=<?php echo $row['pmrn'];?>&eid=<?php echo $row['eid'];?>&id=<?php echo $row['id'];?>">Details</a> </td>
