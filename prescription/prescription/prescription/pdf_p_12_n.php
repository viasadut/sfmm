            ...
            $b = date( 'j-F-Y', strtotime( $d) );
			 ...
			 if($count_eye==0){
                ...
                $output .='<table style="border: 1px solid black" width="100%">
                                <tr>
                                    <th align="left"><b>Eye Examination:</b></th>
                                </tr>
                            </table>
                            <table style="border: 1px solid black" width="100%">
							
							<tr border="1">
                                <td align="center"><b>Eye</b></td>
                                <td align="center"><b>DV (SPH)</b></td>
								<td align="center"><b>DV (CYL)</b></td>
								<td align="center"><b>DV (AXIS)</b></td>
								<td align="center"><b>NV (SPH)</b></td>
								<td align="center"><b>NV (CYL)</b></td>
								<td align="center"><b>NV (AXIS)</b></td>
								
                            </tr>
							';
                $query1 = mysqli_query($con,"select * from eye_medi where pmrn='$pmrn' and eid='$eid' order by type desc");
                $count=1;
                while ($data1 = mysqli_fetch_array($query1)) {
                    $output .='
							...
							<tr border="1">
                                <td align="center"><b>'.$data1['type'].'</b></td>
                                <td align="center"><b> '.$data1['dv_sph'].'<b></td>
								<td align="center"><b> '.$data1['dv_cyl'].'<b></td>
								<td align="center"><b> '.$data1['dv_axis'].'<b></td>
								<td align="center"><b> '.$data1['nv_sph'].'<b></td>
								<td align="center"><b> '.$data1['nv_cyl'].'<b></td>
								<td align="center"><b> '.$data1['nv_axis'].'<b></td>
                            </tr>
