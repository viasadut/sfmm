...
$bell = "select * from doctor where dname='$full' and status='Active'";
...
$url2 = "doc_call_off?dn=$full";   
  ...
  <img src='../../audio/off_button.jpg' title='Active...' width='100'  height='50'></a></td>
  ";
		}  
  ...
  <img src='../../audio/on_button.jpg' title='Calling...' width='100'  height='40'></a></td>
  ";
		}  
...
else if($status=='HISTORY UPDATED' and $bstatus=='BILLED' and $next!=''){echo "<span style='color:darkgreen;text-align:center;font-size:18px;'><strong>".$pmrn."</strong></a>";}
