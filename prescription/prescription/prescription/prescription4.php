                ...
                <div class="col-md-7">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <b>Name:</b><strong class="text-danger h5 font-weight-bold"><?php echo $row['pname'];?></a></strong> <br>
                                    <b>PMRN:</b><strong class="text-danger h5 font-weight-bold"> <?php echo $row['pmrn'];?></a></strong><br>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <b>BMI:</b> <?php if ($row['pbmi']=='<br /'){echo '';} else {echo $row['pbmi'];}?>
                                </div>
                                <div class="col-md-2">
                                   <img alt="" src="pic/<?php echo $rowp['pic'] ?>" class="img-flex-rounded" width="100"  height="100" align="center"/>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			?>	
                ...
                <div class="col-md-3">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fa fa-pills float-left fa-2x"></i> <a target='_blank' href="newtest2?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$count1"?>"style="color:white">Medication</a></button>
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-vials float-left fa-2x"></i> <a target='_blank' href="newtest5?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$count1"?>"style="color:white">Investigation</a></button>
      ...
      $(document).on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                ...
                success:function(data){  
                     $('#name').val(data.pmrn);  
                     $('#address').val(data.pmrn);  
                     $('#result').val(data.pmrn); 
					 $('#dname').val(data.pmrn); 
					 $('#pname').val(data.pmrn); 
					 $('#brand').val(data.pmrn); 
