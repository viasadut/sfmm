...
if($count12==0){
           ...
           if($data['did']==''){
            ...
            $mpdf->SetHTMLFooter('
                <table width="100%">
                <tr>
                        <td width="25%" align="center" style="font-family: freesans;font-size:10px;font-weight:bold">** Blood Sample Counter: GF(Room-132), Radiology Counter: GF(Room-145), ECG/ECHO- 3rd FL(Room-1234), Pharmacy Counter; GF(Room-111) **</td>
                    </tr>    
                <tr>
