...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Eye Examination Form</strong></label></td> </tr>
<tr><td colspan="5" align="center"><label><strong>EYE</strong></label></td> 
<td colspan="3" align="center"><label><strong>Type</strong></label></td> 

<td colspan="3" align="center"><label><strong>SPH </strong></label></td> 
<td colspan="3" align="center"><label><strong>CYL</strong></label></td> 
<td colspan="3" align="center"><label><strong>AXIS</strong></label></td>
<td colspan="3" align="center"><label><strong>VA</strong></label></td> 
</tr>
<tr>
<td colspan="5" align="center">
  <select id="browsers2" name="eye" required>
  ...
  <select id="browsers2" name="type_dv" required>
...
<td  colspan="3"align="center"><input list="21" name="dv_sph"  class="form-control" value="">
   
</td>

<td  colspan="3"align="center"><input list="23" name="dv_cyl"  class="form-control" value="">
   
</td>


<td  colspan="3"align="center"><input list="22" name="dv_axis"   class="form-control"value="">
   
</td>

<td  colspan="3"align="center"><input list="22" name="dv_va"   class="form-control"value="">
...
<td colspan="5" align="center">
				  ...
				  <td colspan="3" align="center">
  <select id="browsers2" name="type_nv" required>
...
<td  colspan="3"align="center"><input list="21" name="nv_sph"  class="form-control" value="">
   
</td>

<td  colspan="3"align="center"><input list="23" name="nv_cyl"  class="form-control" value="">
   
</td>


<td  colspan="3"align="center"><input list="22" name="nv_axis"   class="form-control"value="">
   
</td>
<td  colspan="3"align="center"><input list="22" name="nv_va"   class="form-control"value="">
...
<td colspan="5" align="center">
  <select id="browsers2" name="eye1" required>
				...
				<option value='L'>L</option>
				  ...
				  <td colspan="3" align="center">
  <select id="browsers2" name="type_dv1" required>
...
<td  colspan="3"align="center"><input list="21" name="dv_sph1"  class="form-control" value="">
   
</td>

<td  colspan="3"align="center"><input list="23" name="dv_cyl1"  class="form-control" value="">
   
</td>


<td  colspan="3"align="center"><input list="22" name="dv_axis1"   class="form-control"value="">
   
</td>

<td  colspan="3"align="center"><input list="22" name="dv_va1"   class="form-control"value="">
...
<td colspan="5" align="center">
				  ...
				  <td colspan="3" align="center">
  <select id="browsers2" name="type_nv1" required>
...
<td  colspan="3"align="center"><input list="21" name="nv_sph1"  class="form-control" value="">
   
</td>

<td  colspan="3"align="center"><input list="23" name="nv_cyl1"  class="form-control" value="">
   
</td>


<td  colspan="3"align="center"><input list="22" name="nv_axis1"   class="form-control"value="">
   
</td>

<td  colspan="3"align="center"><input list="22" name="nv_va1"   class="form-control"value="">
...
<td colspan="20"align="left"><strong>Comments</strong></textarea></td>
...
<td colspan="20"align="left"><textarea name='comments'></textarea></td>
...
<td colspan="20"align="left"><strong>IPD</strong></textarea></td>
...
<td colspan="20"align="left"><textarea name='ipd'></textarea></td>
...
$count=1;
						...
						$sel_query="SELECT * FROM eye_medi where pmrn='$pmrn' ORDER BY ndate desc";
...
while($row = mysqli_fetch_assoc($result)) 
	...
	<?php if ($user_e==$row["user"])
	{echo"

	<td align='left'><a href='delete1_eye?id=".$row["id"]."&pmrn=".$pmrn."&dname=".$dname."&eid=".$eid."&ID=".$id."'>DELETE</a></td>";}?>
				  </tr>
