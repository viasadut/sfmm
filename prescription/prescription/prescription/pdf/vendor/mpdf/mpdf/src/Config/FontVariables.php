...
class FontVariables
{
	...
	public function __construct()
	{
		$this->defaults = [
			...
			'sans_fonts' => ['bangla','dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
			...
			'serif_fonts' => ['bangla','dejavuserifcondensed', 'serif', 'dejavuserif', 'freeserif', 'liberationserif',
			...
			'mono_fonts' => ['bangla','dejavusansmono', 'mono', 'monospace', 'freemono', 'liberationmono', 'courier', 'ocrb', 'ocr-b', 'lucidaconsole',
