    ...
    <div class="row">
        ...
        <?php
            ...
            $output .='
                ...
                <h1 align="center" style="color:red;">OUTPATIENT RECORD</h1>
                <table>
                    <tr>
            ...
            $output .='
                <table style="border: 1px solid black" width="100%">
                    <tr>
                        ...
                        <td style="color:red;"><b>MRN :</b>'.$data['pmrn'].'</td>
                ...
                while ($data1 = mysqli_fetch_array($query1)) {
                    $output .='
                        <table>
                            ...
                            <tr>
                                <td></td>
                                <td>'.$data1['pdos'].', <mark style="font-family: bangla;  font-size: 18px; background:none; "> '.$data1['pdos'].' </mark></td>
                            </tr>
                        </table><br>
                    ';
                    $count++;
