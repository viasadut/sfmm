            ...
            if($count11==0){
                ...
                while ($data1 = mysqli_fetch_array($query1)) {
                    $output .='
                            ...
                            <tr>
                                <td></td>
                                <td style="font-family:freesans;font-size: 15px;">'.$data1['pdos'].',   '.$data1['duration'].',  '.$data1['frelation'].'</td>
                            </tr>
                    ';
                    $count++;
                }
            ...
            if($data['other']=='' && $data['other_b']==''){
                ...
                $output .='
                    <table>
                        ...
                        <tr>
                            <td><div style="font-family: freesans; font-size: 15px;"> '.$data['other_b'].' </div></td>
                        </tr>
                    </table>
                '; 
            }
...
if($count12==0){
                ...
                while ($data1 = mysqli_fetch_array($query1)) {
                    $output .='
                            <tr>
                                <td style="font-family: freesans; font-size: 14px;"><b>'.$count.'. </b></td>
                                <td style="font-family: freesans; font-size: 14px;"> '.$data1['ref_name'].'  '.$data1['reason'].'</td>
                            </tr>
           ...
           if($data['did']==''){
			...
			MRN-'.$data['pmrn'].'
                ...
                <table style="border: 1px solid black" width="100%" >
                    <tr>
                        <td style="font-family: freesans;"> <b>Patient Name :</b></td>
