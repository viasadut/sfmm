...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','moopd','diet','physio')"; 
...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="pdf_p_12?pmrn=<?php echo "$pmrn"; ?>&date=<?php echo "$date"?>&dname=<?php echo "$full"?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="50" height="20" /></a></td>
