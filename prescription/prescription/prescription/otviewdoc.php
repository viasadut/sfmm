...
$sel_query="Select * from ot where status='received' and dname3='$full' and dname2status !='Written'";
...
$sel_query="Select * from ot where status='received' and dname4='$full' and dname2status !='Written'";
...
$sel_query="Select * from ot where status='received' and nanes='$full' and date5 between '$test' and '$test1';";
...
$sel_query="Select * from ot where status='received' and anes2='$full' and date5 between '$test' and '$test1';";
...
$sel_query="Select * from ot where status='received' and anes3='$full' and date5 between '$test' and '$test1';";
...
$sel_query="Select * from ot where status='done' and anes2='$full' and otdate='$date';";
...
$sel_query="Select * from ot where status='done' and anes3='$full' and otdate='$date';";
