...
else if (preg_match('/^[a-z0-9 .}, !@#$%^&*()_+|\';?><-]+$/i', $other)) 
{
  // commands


$ins_query="insert into presnew (`dname`,`pname`,`pmrn`,`pphone`,`cdetails`,`diagnosis`,`other`,`date`,`page`,`pdiet`,`psex`,`eid`,`dstatus`,`date1`,`fdate`) values 
('$dd', '$pn','$pm','$pp','$cdetails','$diagnosis','$other','$pdate','$pg','$pdiet','$ps','$count1','SEEN','$date4','$fdate')";
...
$ins_query="insert into presnew (`dname`,`pname`,`pmrn`,`pphone`,`cdetails`,`diagnosis`,`other_b`,`date`,`page`,`pdiet`,`psex`,`eid`,`dstatus`,`date1`,`fdate`) values 
('$dd', '$pn','$pm','$pp','$cdetails','$diagnosis','$other','$pdate','$pg','$pdiet','$ps','$count1','SEEN','$date4','$fdate')";
mysqli_query($con,$ins_query) or die("Please avoid Apostrophe in your prescription");
...
<button type="submit" style="color:white" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-notes-medical float-left fa-2x"></i>PACS VIEW</button>
