...
$url = "newtest2.php?pmrn=$pmrn&dname=$full&ID=$id&eid=$eid";   
?>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="7" align="center"><strong>TEST NAME</strong></td>
...
<tr id="<?php echo $row['id'] ?>">
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="7"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center"colspan="3"><input type="button" name="edit_coo" value="Details" id="<?php echo $row['code']; ?>" class="btn btn-info btn-xs edit_data_coo" /></td>
		...
		$url = "delete?pmrn=$pmrn&id=$id1&ID=$id&dname=$dname&eid=$eid"; 
		$url1 = "../../cam_test/cam_test_darma?pmrn=$pmrn&eid=$eid&id=$id1"; 
		   
		   
		
	//if($type=='Lab' and $rstatus!='')
     if($rstatus=='')
	{ 
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	}
	//else if($rstatus!='' and $type=='LAB')
     else if($rstatus=='' and $type=='LAB')
	{ 
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	}
	//else if($rstatus!='RECEIVED' and $type=='lab')
     else if($rstatus=='' and $type=='lab')
	{ 
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	}
	//else if($status!='' and $type=='RAD')
     else if($rstatus=='' and $type=='RAD')
	{ 
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	}
	
	//else if($status!='DONE' and $type=='Rad')
     else if($rstatus=='' )
	{ 
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	}
...
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	...
	{ 
echo "<td align='center'  colspan='2'style='background-color:lightgreen;'><b>Bill Done</b></td>";
	}
	else if($rstatus!='' and $type=='Lab')
	{ 
          echo "<td align='center'  colspan='2'style='background-color:lightgreen;'><b>Bill Done</b></td>";
...
echo "<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url'><b>DELETE</b></a></td>";
	...
	?>
  	  ...
  	  <?php
	  if($row["medi"]=='Darmascopy Examination')
		  
		  {
			  
			  echo"<td align='center' colspan='2' style='background-color:lightblue;'><a href='$url1'><b>Prepare Report</b></a></td>";
		  }
	  ?>
...
<script>  
                ...
                <div class="modal-body">  
                     <form method="post" name="insert_form8" id="insert_form8">  
                         <label>Investigation Name</label>  
                          <input type="text" name="pmrn1" id="pmrn11" class="form-control" size="15" readonly>  
                          
                          <label>Subtype</label>  
                          <input type="text" name="phyper" id="phyper1" class="form-control"  size="15" readonly>  
                          
                          <label>Specimen</label>  
                          <input type="text" name="pheart" id="pheart1" class="form-control" />  
						  <label>Sample Amount</label>  
                          <input type="text" name="amount" id="amount" class="form-control" />  
						  
						  <label for="age"><strong>Turn Around Time Regular(TAT-Regular) :</strong></label>
      <input id="tat_r" type="text" size="70" style="text-transform:uppercase" readonly>
	  
	  <label for="age"><strong>Turn Around Time Urgent(TAT-Urgent) :</strong></label>
      <input id="tat_u" type="text" size="70" style="text-transform:uppercase" readonly>
	  
	   <label for="age"><strong>Test Center:</strong></label>
      <input id="tcentre" type="text" size="70" style="text-transform:uppercase" readonly>
 ...
 $(document).ready(function(){  
      ...
      $(document).on('click', '.edit_data_coo', function(){  
           var employee_id22 = $(this).attr("id");  
           $.ajax({  
                url:"inves_details.php",  
                method:"POST",  
                data:{employee_id22:employee_id22},  
				
                dataType:"json",  
                success:function(data){  
                     $('#pmrn11').val(data.iname);  
                     $('#phyper1').val(data.subtype);  
                     $('#pheart1').val(data.specimen); 
					 $('#amount').val(data.amount); 
					 $('#tat_r').val(data.tat_r); 
					 $('#tat_u').val(data.tat_u); 
					 $('#tcentre').val(data.tcentre); 
					 $('#employee_id22').val(data.id);  
                     $('#insert4501').val("Update");  
