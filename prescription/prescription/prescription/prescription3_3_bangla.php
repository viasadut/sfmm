...
$ins_query="insert into presnew (`dname`,`pname`,`pmrn`,`pphone`,`cdetails`,`diagnosis`,`other`,`date`,`page`,`pdiet`,`psex`,`eid`,`dstatus`,`date1`,`fdate`,`did`) values 
('$dd', '$pn','$pm','$pp','$cdetails','$diagnosis','$other','$pdate','$pg','$pdiet','$ps','$count1','SEEN','$date4','$fdate','$user')";
