...
$ins_query_r="insert into pappnew (`dname`,`pname`,`pmrn`,`pphone`,`page`,`bdate`,`yage`,`psex`,`padd`,`dis`,`adate`,`adate1`,`user`,`aatime`,`status`,`dreffer`) values 
('$medi1', '$pname','$pmrn','$pphone','$page','$bdate','$yage','$psex','$padd','$dis','$adate','$adate1','$user','$aatime','NOT SEEN','$full')";
mysqli_query($con,$ins_query_r) or die(mysql_error());
