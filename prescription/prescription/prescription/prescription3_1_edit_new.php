                    ...
                    <div class="card card-success">
						...
						<form  class="form-horizontal" action="" method="post" onsubmit='return confirm("Do You Want To Proceed??");'id="prescrip" name="prescrip" />
						    ...
						    <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Clinical Details:</label>
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="cdetails" id="ha" rows="2" placeholder="Patient's Clinical Details"><?php echo $row431['cdetails'];?></textarea>
	...
	skin:"blue"
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Diagnosis:</label> 
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="diagnosis" id="ha1" rows="3" placeholder="Patient's Diagnosis"><?php echo $row431['diagnosis'];?></textarea>
                                    </div>
                                </div>
			...
			?>	
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Other Instructions (In English):</label>
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="other" id="ha2" rows="3" placeholder="Other Instructions (In English)"><?php echo $row431['other'];?></textarea>
                                    </div>
	...
	skin:"blue"
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
										...
										<input type="text1" class="form-control" name="fdate" id="datepicker" placeholder="Next Follow Up Date" value="<?php echo date('m/d/Y', strtotime($row431['fdate']));?>">
                                    </div>
								</div>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-pills float-left fa-2x"></i> <a target='_blank' href="newtest5_1?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Medication</a></button>
...
?>
                            ...
                            <button type="button" class="btn btn-block btn-warning font-weight-bold"><i class="fa fa-pills float-left fa-2x"></i><a target='_blank' href="newtest2test2?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"?>&eid=<?php echo "$count1"?>&eido=<?php echo "$oeid"?>"style="color:white"><b>Load Last Medicine<b></a></button>
