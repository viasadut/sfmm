...
<tr id="<?php echo $row['id'] ?>">
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="7"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center"colspan="3"><?php echo $row["ins"]; ?><input type="button" name="edit_coo" value="Details" id="<?php echo $row['code']; ?>" class="btn btn-info btn-xs edit_data_coo" /></td>
	...
	if($type=='Lab' and $rstatus!='RECEIVED')
	{ 
...
echo "<td align='center'  colspan='2'style='background-color:lightgreen;'><b>Already Received in LAB</b></td>";
	...
	{ 
echo "<td align='center'  colspan='2'style='background-color:lightgreen;'><b>Already Received in Radiology</b></td>";
	}
