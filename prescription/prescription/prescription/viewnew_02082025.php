...
$query40 = "SELECT * FROM doctor where sid= '$fullname'"; 
...
<div2 class="blink-bg"><h1 align="center" ><?php echo $opd;?> OPD
<br>Todays  <?php echo $dname; ?>'s Out Patients List </h1>
</div2>
<p align="right" class="style1">
<?php echo "Date:" ?> <?php echo date('d/m/Y')?> </p>
...
<form style="background-color:#E8F1D4">

<div id="txtHint" style="background-color:#E8F1D4">
...
function showUser() {
  ...
  xmlhttp.open("GET","doc_opd.php",true);
  xmlhttp.send();
}
