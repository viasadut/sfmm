...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><a href="prescription3_3?ID=<?php echo $row["ID"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>"><?php echo $row["pname"]; ?></a></td>
...
<td align="center"><?php echo $count2; ?>  
	  ...
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["status"];?> </td> 
	   ...
	   <td align="center"><a href="prescription3_3?ID=<?php echo $row["ID"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">NEW</a></td> 
	   
	   <td>
		<a target="_blank" href="<?php echo $row["z_link"]; ?>">Link</a>
