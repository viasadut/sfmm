						...
						<form  class="form-horizontal" action="" method="post" onsubmit='return confirm("Do You Want To Proceed??");'id="prescrip" name="prescrip" />
						    ...
						    <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Clinical Details:</label>
								 ...
								 <script>
												...
												<script>
function updateSetEmailAddress1(){
    var ddl = document.getElementById("somemembers1");
    var selectedOption = ddl.options[ddl.selectedIndex];
    var liveMemberData = selectedOption.getAttribute("value");
   ...
   /* if(liveMemberData=="1"){
	...
	document.getElementById
							("diagnosis").value = liveMemberData;
		
		    CKEDITOR.instances["diagnosis"].setData(liveMemberData);
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Diagnosis:</label> 
                                    <div class="col-sm-12">
                                   <textarea id="diagnosis" name="diagnosis" class="form-control" placeholder="Enter Product's Comparison"></textarea>
				...
				<select id="somemembers1" onChange="return updateSetEmailAddress1()">
...
function updateSetEmailAddress(){
   ...
   /* if(liveMemberData=="1"){
	...
	document.getElementById
							("other").value = liveMemberData;
		
		    CKEDITOR.instances["other"].setData(liveMemberData);
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Other Instructions (In English):</label>
                                    <div class="col-sm-12">
                                       <textarea id="other" name="other"><?php echo "sdfsd";?></textarea>
