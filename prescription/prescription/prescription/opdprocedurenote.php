...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','gpopd')"; 
...
<p align="center" class="style1">List Of OPD Procedure Report </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from procedure1 where pmrn= '$pmrn' and ustatus='paid';";
