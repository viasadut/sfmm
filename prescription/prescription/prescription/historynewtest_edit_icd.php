                    ...
                    <div class="card card-success">
						...
						<form  class="form-horizontal" action="" method="post" onsubmit='return confirm("Do You Want To Proceed??");'id="prescrip" name="prescrip" />
						    ...
						    <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Clinical Details:</label>
                                    ...
                                    <div class="col-sm-12">
                                         <textarea id="editor1" name="cdetails" class="form-control" placeholder="Enter Product's Comparison"><?php echo $row43['cdetails'];?></textarea>
	...
	removePlugins: 'scayt',
      disableNativeSpellChecker: false
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="other_b" id="ha" rows="3" placeholder="Other Instructions (In Bangla)"><?php echo $row43['other_b'];?></textarea>
                                    </div>
