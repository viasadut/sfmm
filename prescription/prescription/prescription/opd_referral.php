...
$ins_query="insert into opd_referral (`ref_name`,`dis`,`reason`,`ref_by`,`pname`,`pmrn`,`eid`,`rdate`,`bdate`) values 
('$medi1', '$dis','$pins','$full','$pname','$pmrn','$eid','$date77','$bdate')";
mysqli_query($con,$ins_query) or die(mysql_error());

/*$ins_query_r="insert into pappnew (`dname`,`pname`,`pmrn`,`pphone`,`page`,`pmrn`,`eid`,`rdate`,`bdate`) values 
('$medi1', 'uyu','$pins','$full','$pname','$pmrn','$eid','$date77','$bdate')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
*/
$ins_query26="insert into pappnew (`pname`,`pmrn`,`pphone`,`dname`,`adate`,`status`,`page`,`psex`,`dreffer`,`padd`,`yage`,`dis`,`adate1`,`bdate`) values 
('$pname', '$pmrn','$pphone','$medi1','$date67','NOT SEEN','$page','$psex','$full','$padd','$yage','$dis','$date77','$bdate')";
