...
<tr>
<td colspan="20" align="right" style="font-size:22px; color:red; align:right; font-weight:bold">
<a target='_BLANK'href='../../deathstatdetailsmng?pmrn=<?php echo $pmrn1;?>'><span>All Records</span></a>
</td>
</tr>
    <tr>
...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="historynew?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo $row["eid"]?>&date=<?php echo $row["date"]?>&dname=<?php echo "$dname"?>"><b>Details<b></a></td>
