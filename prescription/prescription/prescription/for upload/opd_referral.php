...
$ins_query="insert into opd_referral (`ref_name`,`dis`,`reason`,`ref_by`,`pname`,`pmrn`,`eid`) values 
('$medi1', 'uyu','$pins','$full','$pname','$pmrn','$eid')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
<td colspan="10" align="center"><input list="browsers1" name="medi" size=60% class="form-control" autocomplete="off" required>
  <datalist id="browsers1">
				...
				<?php 
			$sql = "select dname from `doctor1` where status='Active'";
