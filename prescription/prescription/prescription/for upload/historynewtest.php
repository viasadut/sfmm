...
$ins_query="insert into presnew (`dname`,`pname`,`pmrn`,`pphone`,`cdetails`,`diagnosis`,`other`,`date`,`page`,`pdiet`,`pdiet2`,`pdiet3`,`pdiet4`,`pdiet5`,`pdiet6`,`pdiet7`,`reffer`,`reffer2`,`reffer3`,`reffer4`,`reffer5`,`reffer6`,`psex`,`eid`,`dstatus`,`date1`,`fdate`) values ('$dname', '$pname','$pmrn','$pphone','$cdetails','$diagnosis','$other','$date1','$page','$pdiet','$ref1','$ref2','$ref3','$ref4','$ref5','$ref6','$reffer','$reffer2','$reffer3','$reffer4','$reffer5','$reffer6','$psex','$eid','SEEN','$date4','$fdate')";
...
$update33="update pappnew set `height`='$pheight',`weight`='$pweight',`temp`='$ptemp',`pbp`='$pbp',`pbmi`='$pbmi',`phyper`='$phyper',`ppluse`='$ppluse',`pheart`='$pheart',`pdm`='$pdm',`pkid`='$pkid',`ptb`='$ptb',`pasthma`='$pasthma',`pthyroid`='$pthyroid',`pneuro`='$pneuro',`psurgery`='$psurgery',`pperiod`='$pperiod',`plmp`='$plmp',`pnochild`='$pnochild',`plchild`='$plchild',`palcohol`='$palcohol',`psmoking`='$psmoking',`pfamily`='$pfamily',`pdrug`='$pdrug',`mstatus`='$pmstatus',`occupation`='$poccupation',`eid`='$eid', `status`='SEEN',`stime`='$stime',`spo2`='$spo2',`rr`='$rr',`pperiod1`='$pperiod1',`plmp1`='$plmp1',`pnochild1`='$pnochild1',`plchild1`='$plchild1',`psurgery1`='$psurgery1',`palcohol1`='$palcohol1',`psmoking1`='$psmoking1',`pfamily1`='$pfamily1',`pdrug1`='$pdrug1',`phyper1`='$phyper1',`pheart1`='$pheart1',`pdm1`='$pdm1',`pkid1`='$pkid1',`ptb1`='$ptb1',`pasthma1`='$pasthma1',`pthyroid1`='$pthyroid1',`pneuro1`='$pneuro1',`liver`='$liver',`liver1`='$liver1',`para`='$para',`para1`='$para1',`gravida`='$gravida',`gravida1`='$gravida1',`clist`='$clist',`clist1`='$clist1',`adate1`='$date4' where `pmrn`='$pmrn' and `adate`='$date1' and dname='$dname'";
...
<tr><td align="right" colspan="20"><a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>"style="color:#FF0000;"><b>ALL REPORTS<b></a></td></tr>		
...
<tr>				 
					<td colspan="10"><input type="text" name="pname"  value="<?php echo $row43['pname'];?>" readonly></td>
					<td colspan="2"><input type="text" name="pmrn"   value="<?php echo $pm;?>" readonly></td>
...
<td colspan="2"><input type="text" name="phyper" style="background-color:skyblue;" required value="<?php echo $row1['phyper'];?>" /></td>
<td colspan="2"><input type="text" name="pheart" style="background-color:skyblue;" required value="<?php echo $row1['pheart'];?>" /></td>
<td colspan="2"><input type="text" name="pdm" style="background-color:skyblue;" required value="<?php echo $row1['pdm'];?>" /></td>
<td colspan="2"><input type="text" name="pkid" style="background-color:skyblue;" required value="<?php echo $row1['pkid'];?>" /></td>
<td colspan="2"><input type="text" name="ptb" required value="<?php echo $row1['ptb'];?>" /></td>
<td colspan="2"><input type="text" name="pasthma" required value="<?php echo $row1['pasthma'];?>" /></td>
<td colspan="3"><input type="text" name="pthyroid" required value="<?php echo $row1['pthyroid'];?>" /></td>
<td colspan="3"><input type="text" name="pneuro" required value="<?php echo $row1['pneuro'];?>" /></td>
<td colspan="2"><input type="text" name="liver" required value="<?php echo $row1['liver'];?>" /></td>
...
<td colspan="2"><input type="text" name="phyper1" style="background-color:skyblue;" placeholder="Remarks" value="<?php echo $row1['phyper1'];?>"/></td>
<td colspan="2"><input type="text" name="pheart1" style="background-color:skyblue;" placeholder="Remarks" value="<?php echo $row1['pheart1'];?>" /></td>
<td colspan="2"><input type="text" name="pdm1" style="background-color:skyblue;" placeholder="Remarks" value="<?php echo $row1['pdm1'];?>" /></td>
<td colspan="2"><input type="text" name="pkid1" style="background-color:skyblue;" placeholder="Remarks" value="<?php echo $row1['pkid1'];?>" /></td>
<td colspan="2"><input type="text" name="ptb1" placeholder="Remarks" value="<?php echo $row1['ptb1'];?>"/></td>
<td colspan="2"><input type="text" name="pasthma1" placeholder="Remarks" value="<?php echo $row1['pasthma1'];?>" /></td>
<td colspan="3"><input type="text" name="pthyroid1" placeholder="Remarks" value="<?php echo $row1['pthyroid1'];?>" /></td>
<td colspan="3"><input type="text" name="pneuro1" placeholder="Remarks" value="<?php echo $row1['pneuro1'];?>" /></td>
<td colspan="2"><input type="text" name="liver1" placeholder="Remarks" value="<?php echo $row1['liver1'];?>" /></td>
...
<tr>
<td colspan="4"><input type="text" name="psurgery" required value="<?php echo $row1['psurgery'];?>" /></td>
<td colspan="4"><input type="text" name="palcohol" required value="<?php echo $row1['palcohol'];?>" /></td>
<td colspan="4"><input type="text" name="psmoking" required value="<?php echo $row1['psmoking'];?>" /></td>
<td colspan="4"><input type="text" name="pfamily" required value="<?php echo $row1['pfamily'];?>" /></td>
<td colspan="4"><input type="text" name="pdrug" required value="<?php echo $row1['pdrug'];?>" /></td>
</tr>
<tr>
...
<tr>
<td colspan="7"><input type="text" name="pperiod" required value="<?php echo $row1['pperiod'];?>" /></td>
<td colspan="7"><input type="text" name="plmp" required value="<?php echo $row1['plmp'];?>" /></td>
<td colspan="6"><input type="text" name="clist" required value="<?php echo $row1['clist'];?>" /></td>
</tr>
<tr>
...
<td colspan="5"><input type="text" name="para" required value="<?php echo $row1['para'];?>" /></td>
<td colspan="5"><input type="text" name="gravida" required value="<?php echo $row1['gravida'];?>" /></td>
<td colspan="5"><input type="text" name="plchild" required value="<?php echo $row1['plchild'];?>" /></td>
<td colspan="5"><input type="text" name="pnochild" required value="<?php echo $row1['pnochild'];?>" /></td>
</tr>
<tr>
...
<tr><td colspan="3"><select name="reffer" placeholder="Select Dosage" >
				 ...
				 <?php 
			$sql = "select * from `doctor` where status='Active' order by dname asc";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
...
<tr><td colspan="4" align="left"><input type="text1" class="style" name="fdate" id="datepicker" placeholder="Select Date" value=""></td>
