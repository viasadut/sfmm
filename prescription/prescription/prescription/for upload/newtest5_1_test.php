...
$data59 = mysqli_fetch_assoc($query59);
  ...
  $url = "newtest5.php?pmrn=$pmrn&dname=$full&ID=$id&eid=$eid"; 
?>
...
else if (preg_match('/^[a-z0-9 .}, !@#$%^&*()_+|\';?><-]+$/i', $pdos1)) 

{
	$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`frelation`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos','$eid','$date1','$date2','$pdos1')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`frelation_b`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos','$eid','$date1','$date2','$pdos1')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<td colspan="5" align="center"><label><strong>Frequency & Duration</strong></label></td> 
<td colspan="5" align="center"><label><strong>Food Relation</strong></label></td> 
</tr>
<tr>
<td colspan="10" align="center"><input list="browsers2" name="medi1" size=60%  class="country" class="form-control"autocomplete="off" required/>
  <datalist id="browsers2">
				...
				<?php 
			$sql = "select distinct iname from `doc_medi` where uname='$user'";
...
<td  colspan="5"align="center"><input list="21" name="pdos"  class="form-control" value="">
   <datalist id="21" name="pdos"  class="state">
						  </datalist>
</td>


<td  colspan="5"align="center"><input list="22" name="pdos1"   class="form-control"value="">
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["brand"].' ('.$row["medi"].')'; ?></td>
			      <td align="center"colspan="5"><?php echo $row["pdos"]; ?> <input type="button" name="edit_co" value="E" id="<?php echo $row['id']; ?>" class="btn btn-info btn-xs edit_data_co" /></td>
				  
				  <td align="center" colspan="1"><a href="delete1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>">DELETE</a></td>
