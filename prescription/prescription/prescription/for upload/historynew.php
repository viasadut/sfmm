...
$query = "SELECT * from pappnew where pmrn='$pmrn'and eid='$eid'and adate='$dt' and status='SEEN';" ;
...
<?php $query14 = "select * from pmedi where pmrn='$pmrn' and eid='$eid'";
$result4 = mysqli_query($con,$query14);
while($data14 = mysqli_fetch_array($result4))

{ ?>    <tr>

      <td colspan="12"><?php echo $data14["medi"]; ?></td>
	        <td colspan="8"><?php echo $data14["pdos"]; ?></td>
	  </tr>
    <?php } ?>
