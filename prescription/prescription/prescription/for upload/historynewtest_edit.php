...
('$dd', '$pn','$pm','$pp','$cdetails','$diagnosis','$other','$other_b','$date1','$pg','$pdiet','$ps','$eid','SEEN','$date4','$fdate')";
mysqli_query($con,$ins_query) or die("Please avoid Apostrophe in your prescription");

//$gg= $_REQUEST['pname'];
$update33="update pappnew set `eid`='$eid', `status`='SEEN',`stime`='$stime',`adate1`='$date4',pbmi='$pbmi' where `ID`='$id'";
                    ...
                    <div class="card card-success">
						...
						<form  class="form-horizontal" action="" method="post" onsubmit='return confirm("Do You Want To Proceed??");'id="prescrip" name="prescrip" />
						    ...
						    <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Clinical Details:</label>
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="cdetails" id="ha" rows="2" placeholder="Patient's Clinical Details"><?php echo $row43['cdetails'];?></textarea>
	...
	skin:"blue"
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Diagnosis:</label> 
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="diagnosis" id="ha1" rows="3" placeholder="Patient's Diagnosis"><?php echo $row43['diagnosis'];?></textarea>
                                    </div>
                                </div>
			...
			?>	
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Other Instructions (In English):</label>
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="other" id="ha2" rows="3" placeholder="Other Instructions (In English)"><?php echo $row43['other'];?></textarea>
                                    </div>
	...
	skin:"blue"
                ...
                <div class="col-md-3">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-pills float-left fa-2x"></i> <a target='_blank' href="newtest2test2?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"?>&eid=<?php echo "$eid"?>&eido=<?php echo "$eid1"?>"style="color:white">Medication</a></button>
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-vials float-left fa-2x"></i> <a target='_blank' href="newtest2_edit?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"?>&eid=<?php echo "$eid"?>&eido=<?php echo "$eid1"?>"style="color:white">Investigation</a></button>
