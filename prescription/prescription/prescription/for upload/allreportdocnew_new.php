<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','lab','rd','imo','mofficer','nurse','rad','moopd','diet','staff')"; 
...
$count=1;
$sel_query="Select * from alltest where pmrn= '$pmrn' order by ID desc;";
...
$sel_query="Select * from histo where pmrn= '$pmrn' ORDER BY id asc;";
...
$sel_query="Select * from fnacreport where pmrn= '$pmrn' ORDER BY id asc;";
...
$count=1;
$sel_query="Select * from endoreport where pmrn= '$pmrn' order by id desc;";
