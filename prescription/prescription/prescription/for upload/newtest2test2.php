...
$objDB1 = mysqli_select_db($objConnect1,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$qq = mysqli_query($d,"select * from pmedi where id='".$_POST["chkDel"][$i]."'");
			...
			$strSQL = "insert into pmedi (`dname`,`pname`,`pmrn`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`duration`,`frelation`) values ('$dname','$pname','$pmrn','$medi','$brand','$edit','$eid','$date1','$date2','$edit1','$edit2')";
...
<tr>
	  ...
	  <td align="center"colspan="4"><input type="text" name="dedit1" value="<?php echo $row["duration"]; ?>";></td>
	  
	  <td align="center"colspan="4"><input type="text" name="dedit2" value="<?php echo $row["frelation"]; ?>";></td>
