                ...
                while ($data1 = mysqli_fetch_array($query1)) {
                    $output .='
                            ...
                            <tr>
                                ...
                                <td>'.$data1['pdos'].',  '.$data1['frelation'].'<div style="font-family: bangla; font-size: 14px;"> '.$data1['frelation_b'].' </div></td>
            ...
            $mpdf->SetHTMLHeader('
                ...
                <table>
                    <tr>
                        ...
                        <td width="70%" style="font-weight: bold !important;"><b>'.$data['dname'].'</b></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>'.$data3['degree'].'</td>
