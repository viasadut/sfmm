                ...
                <div class="col-md-3">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
							...
							<button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-vials float-left fa-2x"></i> <a target='_blank' href="comorimo?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$count1"?>"style="color:white">Comorbidities</a></button>
