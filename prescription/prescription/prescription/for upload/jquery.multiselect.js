...
(function($){
    var defaults = {
        ...
        maxPlaceholderOpts : 12,    // maximum number of placeholder options to show until "# selected" shown instead
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            if( instance.options.maxHeight ) {
                ...
                var maxHeight = ($(window).height() - optionsWrap.offset().top + $(window).scrollTop() - 15);
            }
