...
$count1 = $count+1;
      ...
      {  
           $query = "  
           INSERT INTO pmedi(pmrn,medi,brand,pdos,eid,date,dname,pname,ndate,duration,frelation)  
           VALUES('$name','$address','$brand','$result','$count1','$date1','$dname','$pname','$date2','$pheart28','$pheart38');  
           ";  
