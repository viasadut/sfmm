...
?>
 ...
 {  
	  ...
	  $pbp = mysqli_real_escape_string($connect, $_POST["pbp"]);
	  	  $pbp1 = mysqli_real_escape_string($connect, $_POST["pbp1"]);
	 $temp = mysqli_real_escape_string($connect, $_POST["temp"]);	  
	 $rr = mysqli_real_escape_string($connect, $_POST["rr"]);	  
	 
	 $spo2 = mysqli_real_escape_string($connect, $_POST["spo2"]);	  
	 
	 	  $hwc = mysqli_real_escape_string($connect, $_POST["hwc"]);
		  	  $hhc = mysqli_real_escape_string($connect, $_POST["hhc"]);
	 //$id8 = mysqli_real_escape_string($connect, $_POST["employee_id"]);	  
      ...
      {  
           $query = "update pappnew set ppluse='$ppluse',pbp='$pbp',temp='$temp',spo2='$spo2',rr='$rr',pbp1='$pbp1',hwc='$hwc',hhc='$hhc' WHERE ID = '".$_POST["employee_id"]."'";  
