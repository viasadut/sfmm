...
$query43 = "SELECT * FROM presnew where id='$id1';" ;
...
$update34="update presnew set `cdetails`='$cdetails',`diagnosis`='$diagnosis',`other`='$other',`pdiet`='$pdiet',`pdiet2`='$ref1',`pdiet3`='$ref2',`pdiet4`='$ref3',`pdiet5`='$ref4',`pdiet6`='$ref5',`pdiet7`='$ref6',`reffer`='$reffer',`reffer2`='$reffer2',`reffer3`='$reffer3',`reffer4`='$reffer4',`reffer5`='$reffer5',`reffer6`='$reffer6',`fdate`='$fdate' where id='$id1'";
