        ...
        <div class="container-fluid">
						...
						<form  class="form-horizontal" action="" method="post" onsubmit='return confirm("Do You Want To Proceed??");'id="prescrip" name="prescrip" />
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="cdetails" id="" rows="3" placeholder="Patient's Clinical Details"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="diagnosis" id="" rows="3" placeholder="Patient's Diagnosis"></textarea>
                                    </div>
                                </div>
			...
			?>	
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="other" id="" rows="3" placeholder="Other Instructions (In English)"></textarea>
                                    </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="other_b" id="" rows="3" placeholder="Other Instructions (In Bangla)"></textarea>
                                    </div>
