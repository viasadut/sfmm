...
$objDB1 = mysqli_select_db($objConnect1,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$strSQL = "insert into pmedi (`dname`,`pmrn`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`) values ('$dname','$pmrn','$medi','$brand','$edit','$eid','$date1','$date2')";
...
<tr>
	  ...
	  <td align="center"colspan="5"><input type="text" name="dedit[]" id="dedit<?php echo $i;?>" value="<?php echo $row["pdos"]; ?>";></td>
