...
$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`,`acard`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`)
values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1','$acard','$staff','$anew','$diff2','$eeid','$ad','$ad1')";
...
?>"required>		  
	  ...
	  <input list=poss name="poss" placeholder="Select Possession" size="70" value="<?php echo $data4444['poss'];?>">
		...
		<br><br>
			...
			<input list="browsers1" name="btype1" class="country" autocomplete="off">
  <datalist id="browsers1">

						<?php
	$stmt = $DB_con->prepare("SELECT mname FROM medicine where status='Active'");
	$stmt->execute();
...
?>
		...
		<label for="mail"><strong>Avaiable Bed :</strong></label>
									...
									<input list="21" name="bno" class="state" value="">
  <datalist id="21" name="bno" class="state">
				
</datalist>									



									<input list="22" name="bno6" class="city" value="">
  <datalist id="22" name="bno6" class="city">
...
<label for="age"><strong>Visitor Card  :</strong></label> <br>
	   ...
	   <select name="acard" placeholder="Select Attendant Card" >
