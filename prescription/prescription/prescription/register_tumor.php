...
$query = "SELECT * from patient where pmrn='$pmrn3'"; 
...
$query41 = mysqli_query($db,"select * from patient_tumor where pmrn='$pmrn'");
...
$ins_query1="insert into patient_tumor (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`,`bdate`,`type`,`add_by`,`add_time`,`b_type`,`b_remarks`) 
values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$date91','$type','$user','$add_time','$b_type','$b_remarks')";
...
<!-- Form Title -->
		<h1>PATIENT'S TUMOR REGISTRATION </h1>
      ...
      <input name="pname" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row['pname'];?>" readonly required>
 	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row['padd'];?>"required readonly>

	  <label for="age"><strong>Patient's Details :</strong></label>
	  	
            <select name="psex" required>
						<option value='<?php echo $row['psex'];?>'><?php echo $row['psex'];?></option>
									
														
						</select>
            <input name="pmrn" type="text" size="15" value="<?php echo $row['pmrn'];?>" placeholder="MRN" required readonly>
      <input name="pphone" type="text" size="13" value="<?php echo $row['pphone'];?>" placeholder="Phone No" required readonly>	  
	  
      <br><br>
<label><strong>Date Of Birth(DD/MM/YYYY) :</strong></label>
<input name="dd" type="text" maxlength="2" size="1" value="<?php echo $dd;?>" required readonly>	/

<input name="mm" type="text" maxlength="2" size="1" value="<?php echo $mm;?>"required readonly> /	

<input name="yy" type="text" maxlength="4" size="1" value="<?php echo $yy;?>"required readonly>		  
	  <br><br>
      ...
      <label for="age"><strong>Patient's NID / BID :</strong></label>
      <input name="nid" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row['nid'];?>"required>

      <label for="age"><strong>ICD Code :</strong></label>
      <input name="icd" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row['icd'];?>"required>
