...
<div style="position: relative;left: 640px; top:00px;">
...
$sel_query="Select * from pappnew where dname= 'MO(General OPD)' and adate1= '$date' and status not in('SEEN','Cancel') and aslot!='' ORDER BY aslot asc;";
//$start=$row["aadate"];
...
$sel_query1="Select * from presnew where did= '$fullname' and date1= '$date' ORDER BY id asc;";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
	  ...
	  $re = "SELECT * FROM pappnew where pmrn= '$pp' and eid='$ee'"; 
	 
$re1 = mysqli_query($con, $re) or die(mysqli_error());

// Print out result
$rs = mysqli_fetch_array($re1);
	  $ptype=$rs['ptype'];
	  $id3=$rs['ID'];
	  $psex=$rs['psex'];
	  $page=$rs['page'];
      ...
      <td align="center"><a href="prescription3_1_edit?pmrn=<?php echo $row1["pmrn"]; ?>&eid=<?php echo $row1["eid"]; ?>&ID=<?php echo $id3; ?>"><?php echo $row1["pname"]; ?></a></td>
      <td align="center"><?php echo $row1["pmrn"]; ?>
	  
	  <?php
	  $tr=$ptype;
	  if($ptype=='Staff' || $ptype=='Staff Spouse' || $ptype=='Staff Children' || $ptype=='Consultant')
	{ 
echo "<td align='center' style='background-color:lightblue;'>".$tr."</td>";
	}
...
echo "<td align='center'>".$tr."</td>";
	  ...
	  ?>
  	  <td align="center"><?php echo $psex; ?>  
	  <td align="center"><?php echo $page; ?>  
      <td align="center"><?php echo $aslot; ?>
      <td align="center"><?php echo $stime; ?>  
...
<td align="center"><?php echo $dreffer; ?>  
	  <td align="center"><a href="prescription3_1_edit?pmrn=<?php echo $row1["pmrn"]; ?>&eid=<?php echo $row1["eid"]; ?>&ID=<?php echo $id3; ?>">Edit</a></td>
...
<a target="_blank" href="admdoc?pmrn='.$row1["pmrn"].'&adoc='.$row1["dname"].'&rdate='.$rdate.'"><img src="print.png" title="Print Report" width="50" height="30" /></a>';
