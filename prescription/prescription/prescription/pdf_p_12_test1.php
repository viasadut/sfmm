...
if($count12==0){
	...
	//'mirrorMargins' => true
			...
			//$mpdf->SetLeftMargin('50cm');
			//$mpdf->margin-left=10cm;
            ...
            $mpdf->SetHTMLHeader('
                <table width="100%">
                    <tr>
                        ...
                        <br>C/12, Tetuibari, Kashimpur, Gazipur, Bangladesh. </td>
                ...
                <table>
                    <tr>
                        <td width="35%" ><h2 align="laft"><b>Consultant Name:</b></h2></td>
                        <td width="65%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$data['dname'].'</h2></b></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>'.$data3['degree'].'</td>
