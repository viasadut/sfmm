...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`frelation`,`duration`,`code`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos','$eid','$date1','$date2','$pdos1','$duration','$code2')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$sel94=mysqli_query($db,"SELECT * FROM medicine WHERE `mname`='$medi'");
