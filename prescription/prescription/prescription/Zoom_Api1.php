...
class Zoom_Api
{
	private $zoom_api_key = 'MAyZw3e5RJO6lsDLf_8bkg';
	private $zoom_api_secret = '87ckLGFlfZk2TUsrDIGYTOlkdKpclsmkMrLy';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/kpjitdhaka02@gmail.com/meetings";
