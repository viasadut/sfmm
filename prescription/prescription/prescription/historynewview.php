...
$query = "SELECT * from pappnew where pmrn='$pmrn'and adate='$dt' and status='SEEN' and dname='$dname';" ;
...
{
$url = "prescription3_1_edit?pmrn=$pm&eid=$eid&dname=$dname&date=$dt1&id=$id1&ID=$id";
header("Location: $url");
}
?>
<!DOCTYPE html>
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="pdf_p_12.php?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"; ?>&date=<?php echo "$dt1"; ?>&eid=<?php echo "$eid1"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr>
...
{ ?>    <tr>
      ...
      <td colspan="12"><?php echo $data1["medi"].' ('.$data1["brand"].')'; ?></td>
...
<tr><td colspan="20"><label><strong>Follow Up Date :</strong></label></td></tr>
<tr><td colspan="20"><?php echo $row43['fdate'];?>
</td></tr>
<tr><td colspan="10"><button type="submit" name="Submit">EDIT</button></td>
<td colspan="5"><a target='_blank' href="pdf_p_12.php?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"; ?>&date=<?php echo "$dt1"; ?>&eid=<?php echo "$eid1"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
