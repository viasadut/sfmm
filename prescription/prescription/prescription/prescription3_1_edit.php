...
$query431 = "SELECT * FROM presnew where pmrn='$pmrn' and eid='$eid';" ;
$result431 = mysqli_query($con, $query431) or die(mysqli_error());
$row431 = mysqli_fetch_assoc($result431);
...
$ins_query="update presnew set cdetails='$cdetails',diagnosis='$diagnosis',pdiet='$pdiet',other='$other',other_b='$other_b',fdate='$fdate',did='$user',fav='$fav',surgery='$surgery' where pmrn='$pmrn' and eid='$eid'";
...
$url = "historynewview?pmrn=$pm&eid=$eid&date=$pdate&dname=$pd" ;
header("Location:$url");
...
<option value=''>-Select-</option>
    ...
    ?>
                                           ...
                                           <textarea id="editor90" name="cdetails" class="form-control" placeholder="Enter Product's Comparison"><?php echo $row431['cdetails'];?></textarea>
      ...
      disableNativeSpellChecker: false
                                ...
                                <div class="form-group row">
                                   <label for="inputEmail3" class="col-sm-12 col-form-label">Patient's Diagnosis:</label> 
                                    <div class="col-sm-12">
                                   <textarea id="editor1" name="diagnosis" class="form-control" placeholder="Enter Product's Comparison"><?php echo $row431['diagnosis'];?></textarea>
  ...
  extraPlugins : 'filebrowser',
	...
	removePlugins: 'scayt',
      disableNativeSpellChecker: false
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                         <input list=diet1 name="pdiet" placeholder="Select Diet" class="form-control" value="<?php echo $row431['pdiet'];?>" >
					<datalist id="diet1">	
	...
	<option value=''>-Select-</option>
			...
			?>
                                        ...
                                        <textarea id="editor91" name="other" class="form-control" placeholder="Enter Product's Comparison"><?php echo $row431['other'];?></textarea>
  ...
  extraPlugins : 'filebrowser',
	...
	<option value=''>-Select-</option>
			...
			?>
                                        ...
                                        <textarea class="form-control" name="other_b" id="other_b" rows="3" placeholder="Other Instructions (In Bangla)"><?php echo $row431['other_b'];?></textarea>
                                    </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
										...
										<input type="date" class="form-control" name="fdate" id="" placeholder="Next Follow Up Date" value="<?php echo date('m/d/Y', strtotime($row431['fdate']));?>">
                                    </div>
								</div>
							...
							<div class="form-group row">
                                    ...
                                    <span style="color:green;font-size:20px;font-weight:bold">Add To Favourite:</span> <input type="checkbox" id="critical" name="fav" value="1" style="height:20px; width:20px; color:red;" <?php if($row431['fav']==1){echo "checked";}?>>
                                    <span style="color:green;font-size:20px;font-weight:bold">&nbsp;&nbsp;&nbsp;Plan For Surgery:</span> <input type="checkbox" id="surgery" name="surgery" value="1" style="height:20px; width:20px; color:red;" <?php if($row431['surgery']==1){echo "checked";}?>>
                                    </div>
								</div>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-info font-weight-bold"style="background-color:#ED6572"><i class="fas fa-pills float-left fa-2x"></i> <a target='_blank' href="newtest5_1?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Medication</a></button>
                            <button type="button" class="btn btn-block btn-info font-weight-bold"style="background-color:#ED6572"><i class="fas fa-vials float-left fa-2x"></i> <a target='_blank' href="newtest2?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Investigation</a></button>
							<button type="button" class="btn btn-block btn-info font-weight-bold"style="background-color:#ED6572"><i class="fas fa-id-card-alt float-left fa-2x"></i> <a target='_blank' href="opd_referral?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Referral</a></button>
							<button type="button" class="btn btn-block btn-success font-weight-bold"><i class="fas fa-head-side-cough float-left fa-2x"></i> <a target='_blank' href="../../comorimo?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Comorbidities</a></button>
							<button type="button" class="btn btn-block btn-success font-weight-bold"><i class="fas fa-allergies float-left fa-2x"></i> <a target='_blank' href="../../allergyimo?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Allergies</a></button>
							<button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-store float-left fa-2x"></i> <a target='_blank' href="care_shop?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Care Shop Item</a></button>
							<button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-eye float-left fa-2x"></i> <a target='_blank' href="eye_01?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Spectacles Power</a></button>
...
<button type="button" class="btn btn-block btn-info font-weight-bold"style="background-color:#ED6572"><i class="fas fa-id-card-alt float-left fa-2x"></i> <a target='_blank' href="docadm?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"; ?>&eid=<?php echo "$eid"; ?>"style="color:white">Admission Advise</a></button>
...
<button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-thin fa-child float-left fa-2x"></i> <a target='_blank' href="set_pic_attach?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Upload Body Image</a></button>
