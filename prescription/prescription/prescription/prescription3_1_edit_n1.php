...
$ins_query="update presnew set cdetails='$cdetails',diagnosis='$diagnosis',pdiet='$pdiet',other='$other',other_b='$other_b',fdate='$fdate' where pmrn='$pmrn' and eid='$eid'";
			...
			?>	
                ...
                <div class="col-md-3">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-pills float-left fa-2x"></i> <a target='_blank' href="newtest5_1_n1?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Medication</a></button>
                            <button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-vials float-left fa-2x"></i> <a target='_blank' href="newtest2?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Investigation</a></button>
							<button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-id-card-alt float-left fa-2x"></i> <a target='_blank' href="opd_referral?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>&ID=<?php echo "$id"?>&eid=<?php echo "$eid"?>"style="color:white">Referral</a></button>
...
<button type="button" class="btn btn-block btn-info font-weight-bold"><i class="fas fa-id-card-alt float-left fa-2x"></i> <a target='_blank' href="docadm?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"; ?>&eid=<?php echo "$eid"; ?>"style="color:white">Admission Advise</a></button>
