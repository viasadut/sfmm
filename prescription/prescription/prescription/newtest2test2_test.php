...
$url = "newtest2test2.php?pmrn=$pmrn&dname=$full&eido=$eid1&eid=$eid"; 
...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`eid`,`brand`,`pdos`,`date`,`ndate`,`duration`,`frelation`) values ('$full','$pmrn','$pname','$ii','$eid','$brand2','$ii2','$date1','$date2','$ii3','$ii4')";
...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`frelation`,`duration`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos','$eid','$date1','$date2','$pdos1','$duration')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$objDB1 = mysqli_select_db($objConnect1,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$qqz = mysqli_query($db,"select * from pmedi where id='".$_POST["chkDel"][$i]."'");
			$ddz = mysqli_fetch_assoc($qqz);
			
			$edit = $_REQUEST["dedit"][$i];
			$edit1 = $_REQUEST["dedit1"][$i];
			$edit2 = $_REQUEST["dedit2"][$i];
			//$edit= $dd["pdos"];
			//$edit1= $dd["duration"];
			//$edit2= $dd["frelation"];
			$dname=$dd['dname'];
			...
			$strSQLz = "insert into pmedi (`dname`,`pname`,`pmrn`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`duration`,`frelation`) values 
			('$dname','$pname','$pmrn','$medi','$brand','$edit','$eid','$date1','$date2','$edit1','$edit2')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQueryz = mysqli_query($objConnect1,$strSQLz);
		}
	}
...
<tr>
	  ...
	  <td align="center"colspan="4"><input type="text" name="dedit[]" id="dedit<?php echo $i;?>"value="<?php echo $row["pdos"]; ?>"></td>
	  <td align="center"colspan="4"><input type="text" name="dedit1[]" id="dedit1<?php echo $i;?>" value="<?php echo $row["duration"]; ?>"></td>
	  
	  <td align="center"colspan="4"><input type="text" name="dedit2[]" id="dedit2<?php echo $i;?>" value="<?php echo $row["frelation"]; ?>"></td>
