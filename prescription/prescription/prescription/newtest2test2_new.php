...
$url = "newtest2test2_new.php?pmrn=$pmrn&dname=$full&eido=$eid1&eid=$eid"; 
...
$objDB1 = mysqli_select_db($objConnect1,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$strSQL = "insert into pmedi (`dname`,`pname`,`pmrn`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`duration`,`frelation`) values 
