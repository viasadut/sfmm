...
if($code!='' and $brand2!='')
{
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`eid`,`brand`,`pdos`,`date`,`ndate`,`duration`,`frelation`,`code`) values ('$full','$pmrn','$pname','$ii','$eid','$brand2','$ii2','$date1','$date2','$ii3','$ii4','$code')";
...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`ndate`,`frelation`,`duration`,`code`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos2','$eid','$date1','$date2','$pdos1','$duration','$code2')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
while($row = mysqli_fetch_assoc($result)) 
	        ...
	        <td align="left" ><?php echo $row["brand"].' ('.$row["medi"].')'; ?></td>
				  ...
				  <td align="left"><a href="delete1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $pmrn; ?>&dname=<?php echo $dname; ?>&eid=<?php echo $eid; ?>&ID=<?php echo $id; ?>">DELETE</a></td>
...
<td align="left"><input type="button" name="edit" value="Details" id="<?php echo $row["medi"]; ?>" class="btn btn-info btn-xs edit_data" /></td>  		
    ...
    <td align="right" colspan="20"><button onclick="self.close()">Close</button></td>
