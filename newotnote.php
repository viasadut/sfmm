...
$query1 = mysqli_query($db,"select * from otreport where pmrn='$pmrn' and eid='$eid' and c_status=''");
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->MultiCell('182' , 5,'Surgeon Name: '.$data1['sname'],0,1);
$pdf->MultiCell('182' , 5, 'Procedure Name: '.$data1['pname'].$data1['others'],0,1);

$pdf->MultiCell('182' , 5,'Details Note:',0,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data1['sreport'],0,1);
