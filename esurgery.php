...
$query4 = mysqli_query($db,"select * from emergency where pmrn='$pmrn'");
$data = mysqli_fetch_assoc($query4);


$query39 = mysqli_query($db,"select * from user where uname='$user'");
$data39 = mysqli_fetch_assoc($query39);

?>
<?php
$full = $data39['fullname'];
$date=date('m/d/Y');
?>
...
diagnosis='$diagnosis',adate='$adate',otdate='$otdate',bookingdt='$bkdate',duration='$bt',sprequire='$sprequire',
ptype='$tp',tanes='$lx3',nanes='$na',proce='$lx',duration1='$duration',otherins='$otherins',sprequire='$sprequire',remarks='$remarks',nurse='$lx2' where `id`='$id'";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
						...
						<td colspan="2"><label><strong>Name Of Operation:</strong></label></td>
						<td colspan="3"><label><strong>Admission Date:</strong></label></td>
						<td colspan="2"><label><strong>Type Of Surgery:</strong></label></td>
						<td colspan="2"><label><strong>Position:</strong></label></td>
             		...
             		<td colspan="3"><input type="text" name="adate" id="datepicker" placeholder="Select Date" size="15" value="<?php echo $res['adate'];?>"></td>					 	
			    	 ...
			    	 <td colspan="2"><input type="text" name="otdate" id="datepicker1" placeholder="Select Date" size="15" value="<?php echo $res['otdate'];?>"></td>  
		...
		<tr>
					 ...
					 <td colspan="6"><select name="xl3[]" multiple="multiple" class="3col active" placeholder="Select Investigations"required/>
       
						
						<option value='<?php echo $res['tanes'];?>' selected><?php echo $res['tanes'];?></option>
 ...
 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="diagnosis" rows="5"><?php echo $res['diagnosis'];?> </textarea></td>  </tr>
...
<tr><td colspan="20"><input list="proname11" name="proname11" class="form-control" value="" autocomplete="off">
	...
	<datalist id="proname11">
       ...
       <?php 
		...
		<tr><td colspan="20"><input name="proname" type="text" value="<?php if(isset($_POST['load'])==1)
{ $date10 = $_REQUEST['proname11'];
echo $date10;
...
<tr><td colspan="20"><input type="text" name="cs" value=""</td>  </tr>
...
<tr><td colspan="20"><input type="text" name="position" value=""></td>  </tr>
...
<tr><td colspan="20"><input type="text" name="biopsy" value=""></td>  </tr>
...
<tr><td colspan="20"><input type="text" name="hplan" value=""></td>  </tr>
		...
		<tr><td colspan="20"><select name="xl2[]" multiple="multiple" class="3col active" placeholder="Select Investigations"required/>
<option value="<?php echo "$nurse";?>" selected><?php echo "$nurse";?></option>
