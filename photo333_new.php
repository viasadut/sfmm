...
$pmrn=$_REQUEST['pmrn'];
$eid=$_REQUEST['eid'];
$query43 = "SELECT COUNT(pmrn) FROM darma_gallery where pmrn= '$pmrn' and eid='$eid';"; 
...
<div class="container">
    ...
    <form action="imageupload_darma.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from darma_gallery where pmrn='$pmrn' and eid='$eid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="darma/<?php echo $image['image'] ?>">
                        <img class="img-responsive" alt="" src="darma/<?php echo $image['image'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['image'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="darma_delete.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $image['id'] ?>">
					  <input type="hidden" name="name" value="<?php echo $image['image'] ?>">
					  <input type="hidden" name="pmrn" value="<?php echo $image['pmrn'] ?>">
					  <input type="hidden" name="eid" value="<?php echo $image['eid'] ?>">
