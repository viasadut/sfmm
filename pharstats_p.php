...
$query44 = "SELECT COUNT(infusion) FROM imedi3 where infusion= '$bt'and ndate BETWEEN '$start' and '$end' and status1='SEEN';"; 
...
{ ?>    <tr>
	...
	$sel_query2="Select * from imedi3 where infusion='$bt' and ndate BETWEEN '$start' and '$end' and status1='SEEN' order by id desc";
...
$dname4=$row_p4['fullname'];
      ...
      <td align="center"><?php echo $dname4; ?></td>
