<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','mrd','bill','billin','staff')"; 
...
$sel_query="Select * from ot where proce='$proce' and status='Received' and dname='$full' ORDER BY id DESC LIMIT 10;";
