...
$query43 = "SELECT  COUNT(DISTINCT(pmrn)) FROM pappnew where aslot in ('Consultation Package-1','Consultation Package-2') and adate1 BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);


$query44 = "SELECT  COUNT(DISTINCT(pmrn)) FROM alltest where ins in ('Inves Pack-1','Inves Pack-2') and date1 BETWEEN '$start' and '$end' and status='RECEIVED';"; 
...
<h1 align="center">Diabetics Day Promotional Stats</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<option value='C'>Consultation Package</option>
						<option value='I'>Investigation Package</option>
...
$sel_query="Select * from pappnew where  adate1 BETWEEN '$start' and '$end' and aslot in ('Consultation Package-1','Consultation Package-2') group by pmrn order by aslot asc";
...
echo "  To  ";
echo $end;
$sel_query="Select * from alltest where ins in ('Inves Pack-1','Inves Pack-2') and date1 BETWEEN '$start' and '$end' and status ='RECEIVED'group by pmrn order by ins asc;"; 
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["pphone"]; ?>  
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["ins"];?> 
      <td align="center"><?php echo $row["status"]; ?>  
