...
$query43 = "SELECT sum(qty) FROM phar_sale where medi= '$bt'and adate BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT sum(qty) FROM phar_sale where medi BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Pharmacy Report</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
           ...
           <input list="browsers1115" name="bt"  size="80"  style="text-transform:uppercase"required autocomplete='off'>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Generic Name</strong>   
      <th width="14%"><strong>Brand Name</strong>
      <th width="14%"><strong>Qty</strong>
	  <th width="14%"><strong>Total Price</strong>
...
$sel_query="Select * from phar_sale where adate BETWEEN '$start' and '$end' order by adate";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['sum(qty)'];
echo " ,  From  ";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from phar_sale where medi='$bt' and adate BETWEEN '$start' and '$end' order by adate";
 } 
$count=1;
...
{ ?>    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["brand"];?> 
      <td align="center"><?php echo $row["qty"]; ?>  
	  <td align="center"><?php echo $row["tprice"]; ?>  
