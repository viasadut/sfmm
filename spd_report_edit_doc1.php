...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecg_test where datenew between '$test' and '$date' and status1='updated' and dname1='$full' order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="spd_report_edit_doc?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Edit</a></td>
	  <td align="center"><a href="spdupload_new?eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Upload</a></td>
