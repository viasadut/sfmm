...
$ins_query="update mcertificate set `nid`='$passno',`nid1`='$passno1',`ffor`='$ffor',`fdate`='$fdate',`fdate1`='$fdate1',`diagnosis`='$diag',`staff`='$staff' where id='$id'"; 
...
<!-- Form Title -->
		<h1>Medical Certificate (Issue FIT Certificate)  </h1>
...
<label for="name"><strong>Paients Identify:</strong></label>
      ...
      <textarea rows="5"  name="diag" required value=""><?php echo $row3["diagnosis"]; ?></textarea>
			...
			<label for="name"><strong>Fit For:</strong></label>
			<select name="ffor" value="<?php echo $row3["ffor"]; ?>" required>
			        <option value='<?php echo $row3["ffor"]; ?>'selected ><?php echo $row3["ffor"]; ?></option>
					<option value='Regular Duty' selected>Regular Duty</option>
...
<td><a target='_blank' href="printmcedit1.php?id=<?php echo "$id"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
