...
function Header()
{
    ...
    $this->Cell(0,6,' Mid Morning Diet Order Sheet',0,1,'C');
...
$pdf->AddCol('room',25,'Ward','L');
$pdf->AddCol('bed',40,'Bed','L');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iidiet where odate ='$dd' and status='Diet Ordered' and diettime in('Mid Morning','Extra Food') and status1!='Cancel'order by room",$prop);
$pdf->Output();
?>