...
echo '<script language="javascript">';
	...
	$ins_query1="update storecafe set `eqty`='$nqty1',`remarks`='$remarks',`adate`='$adate',`adate1`='$adate1',`aby`='$user' where ename='$ename'";
...
<!-- Form Title -->
	  ...
	  <input list=diet1 name="ename" placeholder="Select Item" class="form-control" autocomplete="off">
					<datalist id="diet1">	
						
						<option value=''>-Select Diet-</option>
				 <?php 
			$sql = "select * from `storecafe`";
