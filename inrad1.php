...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eeid' and status in('Rupdated','Data Updated') and type='rad' order by `id` DESC;";
...
<td colspan="2" align="center"><a href="rpapp1pacsae?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&user=<?php echo "$user"; ?>&infu=<?php echo $row["infusion"]; ?>"><strong>RECEIVE</strong></a></td>
<td colspan="2" align="center"><a href="radreject1emer?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>REJECT</strong></a></td>	  
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and status='Data Updated' and type in ('rad','RAD') and rstatus!='Cancelled' order by `id` DESC;";
...
<td colspan="2" align="center"><a href="rpapp1pacsin?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>RECEIVE</strong></a></td>
<td colspan="2" align="center"><a href="radreject1?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>REJECT</strong></a></td>	  

      </tr>
    <?php $count++; } ?>
	
	<tr><td colspan="10"><a target='_blank' href="piinvesrad.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>	
...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eid' and type='rad' and rstatus IN ('RECEIVED','REJECTED') and status IN ('RECEIVED','REJECTED','DONE')   order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="1"><?php echo $row["odate"]; ?></td>  
	  <td align="center"colspan="4" style="color:red"><b><?php echo $row["infusion"]; ?><b></td>
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and type='rad'and rstatus IN ('RECEIVED','REJECTED')and status IN ('RECEIVED','REJECTED','SEEN','DONE') and type='rad'  order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="4"><?php echo $row["infusion"]; ?></td>
  	  ...
  	  <td colspan="2"><a target='_blank' href="out_print.php?id=<?php echo $row['id']; ?>">For Outside</a></td>  
