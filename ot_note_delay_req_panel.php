...
<?php
		   ...
		   if($row['e_status']=='1'){echo'
		   
		   <td colspan="6"align="center">
		  
		  <input type="button" name="edit" value="Approve Request" id="'.$row['id'].'" class="btn btn-info btn-xs edit_data">
...
$sel_query="Select * from otreport where md_approve='Pending'";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      <td align="center"><?php echo $count; ?></td>
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["sname"];?> </td> 
      <td align="center"><?php echo $row["pname"]; ?></td>
      <td align="center"><?php echo $row["pmrn"]; ?>
      <td align="center"><?php echo $row["otdate"]; ?>
      <td align="center"><?php echo $row["ottype"]; ?>  
	  <td align="Left"><?php echo $row["plevel"]; ?>  
	  	  <td align="Left"><?php echo $row["sreport"]; ?> 
		  
		   <td colspan="6"align="center">
		  
		  <input type="button" name="edit" value="Approve" id="<?php echo $row['id'];?>" class="btn btn-info btn-xs edit_data1">
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title"align='center'>Old Surgery Note Edit Request</h4>  
                </div>  
                <div class="modal-body">  
...
<label>Patient Name</label>  
                          <input type="text" name="pname1" id="pname1" class="form-control"  size="15" readonly>  

						  
						   <label>Name Of The Surgery</label>  
                          <input type="text" name="sname1" id="sname1" class="form-control" size="15" readonly>  
                          
                          
						  
						  <label>Surgeon Name</label>                          
                          <input type="text" name="surname1" id="surname1" class="form-control"readonly>
                          
                         
						  
						  <label>Remarks</label>  
						  <textarea name="remarks1" id="remarks1" class="form-control" readonly></textarea>
                          ...
                          <input type="hidden" name="employee_id1" id="employee_id1" />  
						   ...
						   <div class="modal-footer">  
                     <input type="submit" name="insert1" id="insert451" value="Insert" class="btn btn-success"></label>  
      ...
      $(document).on('click', '.edit_data1', function(){  
           ...
           $.ajax({  
                ...
                success:function(data){  
					 ...
					 $('#sname1').val(data.pname); 
					 $('#surname1').val(data.sname); 
                     $('#remarks1').val(data.req_remarks); 
