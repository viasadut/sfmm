...
$ins_query="update dialysispapp  set dia1='$dia1' where ID='$ID'";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Doctor's Diagnosis</strong></label></td> </tr>
...
<td colspan="20" align="center"><textarea rows="2"  name="dia1" required value=""></textarea></td>
...
$count=1;
$sel_query="Select * from dialysispapp where ID= '$ID' order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="2"><?php echo $row["dia1"]; ?></td>
