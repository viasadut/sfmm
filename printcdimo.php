...
$sel_query="Select * from otlab where pphone= '$pmrn'and dname='$full' order by date desc;";}
 else{
	 $sel_query="Select * from otlab where pmrn= '$pmrn' and dname='$full'order by date desc;";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  <td colspan="10"><a target='_blank' href="csotlabreprint?id=<?php echo $row['id']; ?>&eid=<?php echo $row['eid']; ?>&pmrn=<?php echo $row['pmrn']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
      </tr>
