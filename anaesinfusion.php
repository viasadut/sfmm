...
$ins_query="insert into anaesinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$user','Data Updated','$alert','Active','$adate','$time',' $add','$otime1','$infu1',' $add1','$qty1','$qty2','Ordered','$adate1')";
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><button onClick="goBack()">Back</button></td></tr>
				...
				<tr>	  
				<td colspan="20"><?php echo $data["anes"]; ?></td></tr>
...
<tr><td colspan="20"><?php echo $data["padd"]; ?></td></tr>
		...
		<tr>
			    	 ...
			    	 <td colspan="2"><?php echo $data["tname"]; ?></td>  
...
<tr>
	  ...
	  <td colspan="20"align="right"><strong><a href="addpharmedidoctorinfu?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Medicine</a></strong>&nbsp;&nbsp;<a href="idocinfusiondate?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;<button type="submit" name="Submit">Confirm</button></td>
</tr>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from anaesinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status1='Active' order by `ddate` DESC;";
