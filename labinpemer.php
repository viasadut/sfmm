...
$count=1;
$sel_query="Select * from einves where pmrn= '$pmrn' and eid='$eeid' and type='lab' and status ='RECEIVED' and resultstatus=''   order by `id` DESC;";
...
{ ?>    <tr>
	 ...
	 <td align="center"colspan="1"><?php echo $row["odate"]; ?></td>  
	 <td align="center"colspan="4"><span style="color:red;text-align:center;"><b><?php echo $row["infusion"]; ?><b></span></td>
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and type='lab' and rstatus IN ('RECEIVED','REJECTED') and status IN ('RECEIVED','REJECTED') and resultstatus in('UPDATED','Updated By Technologist')   order by `id` DESC;";
