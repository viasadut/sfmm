...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from package_screening where eid='$eid' and pmrn='$pmrn' ORDER BY id asc;";
...
$url = "imoidisreport_pack?pmrn=$pmrn&eid=$eid";
$url1 = "indischarge1edit1_pack?pmrn=$pmrn&eid=$eid";
...
$sel_query1="Select * from package_screening where eid='$eid' and pmrn='$pmrn'  ORDER BY id asc;";
...
$url2 = "deathprint1?pmrn=$pmrn&eid=$eid";
      ...
      else if($res90>0 and $d_type!='Confirm Death Declaration Request'){echo "<a target='_blank'href='idisreport_pack?pmrn=".$pmrn."&eid=".$eid."'><img src='dis_pic.png' title='Print Report' width='100' height='60'></a>";} 
      //else if($res914==0 and $d_type=='Confirm Death Declaration Request'){echo "Death Summary Not Written";}
      else if($res91==0 and $d_type=='Confirm Death Declaration Request'){echo "Death Certificate Not Prepared";}
      else if($res91>0 and $d_type=='Confirm Death Declaration Request'){echo "<a href='$url2'><img src='death_pic.png' title='Print Report' width='100' height='60'></a>";} ?></td>
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idisupdate1_pack?eid=<?php echo $row1["eid"]; ?>&pmrn=<?php echo $row1["pmrn"]; ?>&room1=<?php echo "$room1"; ?>&id=<?php echo $row1['id']; ?>&vc=<?php echo "$vc"; ?>&vc1=<?php echo "$vc1"; ?>&ac=<?php echo "$ac"; ?>&user=<?php echo "$fullname"; ?>">Discharge</a></td>
