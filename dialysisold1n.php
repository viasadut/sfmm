...
$sel43="SELECT * FROM dialysisapp WHERE `dname`='$dname' and `ddate`='$date1' and dslot='$slot' and status='Booked';";
...
$ins_query="insert into dialysispapp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`dreffer`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$page','$psex','$tname23')";
mysqli_query($con,$ins_query);
$update="update chemoapp set status='Booked' where `ddate`='$date1' and `dslot`='$slot'";
