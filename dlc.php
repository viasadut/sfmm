...
$ins_query1="insert into dlc (`pname`,`pmrn`,`pphone`,`psex`,`page`,`neu`,`lym`,`eos`,`mono`,`bas`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$neu','$lym','$eos','$mono','$bas','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
      ...
      <input name="bas" type="text" size="70" style="text-transform:uppercase" value=""required/>
