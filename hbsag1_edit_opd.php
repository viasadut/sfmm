...
<?php
    ...
    $query5 = mysqli_query($con,"select * from hbsag where pmrn='$pmrn' and sno='$sno'");
...
if(isset($_POST['Submit'])){
    ...
    $adate1= date('m/d/Y');
    $rr1='Patient Value- :'.$chikun1."<br />".'Cut Off Value:'.$chikun2."<br />".'Interpretation:'.$chikun3;
    $rr='Patient Value- :'.$chikun1."<br />".'Cut Off Value:'.$chikun2."<br />".'Interpretation:'.$chikun3;

    // $ins_query1="insert into hbsag (`pname`,`pmrn`,`psex`,`page`,`pvalue`,`cvalue`,`inter`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
    // ('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$chikun3','$user','$adate','$eid','$iname','$id','$sno')";
    // mysqli_query($con,$ins_query1) or die(mysql_error());

    $ins_query1="UPDATE hbsag SET 
        `pname`='$pname',
        `pmrn`='$pmrn',
        `psex`='$psex',
        `page`='$page',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <label for="age"><strong>HBsAg-ELISA Report:</strong></label>
            <label for="iron"><strong>Patient Value</strong></label>
            <input name="chikun1" type="text" size="70" style="text-transform:uppercase"
                value="<?php echo $data1['pvalue']?>" required>
            <label for="tibc"><strong>Cut Off Value</strong></label>
            <input name="chikun2" type="text" size="70" style="text-transform:uppercase"
                value="<?php echo $data1['cvalue']?>" required>
            <label for="tibc"><strong>Interpretation</strong></label>
            <input name="chikun3" type="text" size="70" style="text-transform:uppercase"
                value="<?php echo $data1['inter']?>" required>
        </fieldset>
        <table>
            <tr>
