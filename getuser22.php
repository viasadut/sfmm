...
<tr>
            <th width=4%' style='font-size:13px; background-color:#eed7a1;'><strong>S.No</strong></th>
      <th width=17% style='font-size:13px; background-color:#eed7a1;'><strong>Patient's Name</strong></th>
      <th width=10% style='font-size:13px; background-color:#eed7a1;'><strong>MRN</strong></th>
	  <th width=10% style='font-size:13px; background-color:#eed7a1;'><strong>Category</strong></th>
      <th width=15% style='font-size:13px; background-color:#eed7a1;'><strong>Doctor's Name </strong>
      <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>Admission Date</strong>   
	  <th width=24% style='font-size:13px; background-color:#eed7a1;'><strong>Working Diagnosis</strong>
      <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>Room No</strong>
      <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>Bed No</strong>
	  <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>Days Staying</strong>
      <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>Summary Treatment</strong>
      <th width=5% style='font-size:13px; background-color:#eed7a1;'><strong>Transfer Bed</strong>
	  <th width=5% style='font-size:13px; background-color:#eed7a1;'><strong>H.Notes</strong>
	  <th width=10% style='font-size:13px; background-color:#eed7a1;'><strong>Covid Result</strong>
	  <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>OT Clearance</strong>
	  <th width=14% style='font-size:13px; background-color:#eed7a1;'><strong>Plan</strong>
...
echo "</td>";}
  ...
  echo "<td style='background-color:#eed7a1;font-size:13px;font-weight:bold'>"; 
  echo "<a target='_blank' href='mo_pwl?pmrn=".$row['pmrn']."&eid=".$row['eid']."'>H.Notes</a>";
  echo "</td>";
  
   echo "<td style='background-color:#eed7a1;font-size:13px;font-weight:bold'></td>"; 
...
echo "<td align='center' style='background-color:#eed7a1;font-size:12px;'></td>";
 ...
 echo"<td align='center' style='background-color:#eed7a1;font-size:12px;'><button type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modal-view".$row["id"]."'>
										...
										<div class='modal fade bd-example-modal-lg' id='modal-view".$row["id"]."' tabindex='-1' role='dialog' aria-labelledby='myLargeModalLabel' aria-hidden='true'>
											  ...
											  $inqt = "SELECT * FROM t_plan where pmrn= ".$row['pmrn']." and eid=".$row['eid']." order by id desc"; 
...
<span style='color:lightblue;font-size:18px;font-weight:bold'>".$in_rowt['plan']."</span></p>";}													   		
