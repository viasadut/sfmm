...
$ins_query="insert into infusion (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
$episode=$data59["eid"];
$count=1;
$sel_query="Select * from infusion where pmrn= '$pmrn'and eid='$episode' and status='Not Updated'order by `id` DESC;";
...
<td colspan="2" align="center"><a target='_blank' href="inpatient3333.php?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
