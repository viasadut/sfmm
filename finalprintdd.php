...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from preadm where ddrequest='settled' and qca !='' and mda !='' and cfoa !='' and ceo !='' and apstatus='Approved'";
//$start=$row["aadate"];
...
<td colspan="10">		<a target='_blank' href="finalprintdd1?id=<?php echo $row['id']; ?>&eid=<?php echo $row['eid']; ?>&pmrn=<?php echo $row['pmrn']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>
