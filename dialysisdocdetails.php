...
$query4 = mysqli_query($db,"select * from dialysispapp where ID='$ID' ");
...
{
$url = "dialysisdocmedi1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocddfund?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocinfu1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocsorder1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisvitalsdoc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisinassessmentdoc1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisinassessment1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocnote1?pmrn=$pmrn&ID=$ID";
header("Location: $url");
}
?>
...
$url = "dialysisnursenotedoc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
{
$url = "dialysisdoccharge?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>

<?php
if(isset($_POST['Submitdia']))
{
$url = "dialysis_dia?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocinves?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocadm?pmrn=$pmrn&eid=$eid&dname=$full";
header("Location: $url");
}
?>
...
<td colspan="2" align="center"><button type="submit" name="Submit101">Doctor Charges</button></td>
<td colspan="2" align="center"><button type="submit" name="Submitdia">Diagnosis</button></td>
