...
$ins_query1="insert into antihbc (`pname`,`pmrn`,`psex`,`page`,`result`,`opinion`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`crate`,`type`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$user','$adate','$eid','$iname','$id','$sno','$chikun3','$type')";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Anti-Hbc- Total Report:</strong></label>
