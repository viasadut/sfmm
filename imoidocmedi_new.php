...
$sel_re="SELECT * FROM medicine WHERE `mname`='$infu' and status='Active' and pre IN('Tablet','Vaginal Suppository','VT','Suppository','Soft Capsule','Sachet','Capsule','Injection','Infusion')";
$result_re = mysqli_query($con,$sel_re);

$sel_dis="SELECT COUNT(id) FROM imedi3 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and reuse='Reuse' and discard !='discarded';";
...
$ins_query6="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`ndate`,`uprice`,`code`,`reuse`,`discard`) values 
('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$datem1','Active','$root','Rupdated','Ordered','$ortime','$datem','$uprice','$p_code','Reuse','New')";
...
$ins_query6="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`ndate`,`uprice`,`code`) values 
('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$datem1','Active','$root','Rupdated','Ordered','$ortime','$datem','$uprice','$p_code')";
mysqli_query($con,$ins_query6);
...
$sel_re="SELECT * FROM medicine WHERE `mname`='$ii' and status='Active' and pre IN('Tablet','Vaginal Suppository','VT','Suppository','Soft Capsule','Sachet','Capsule','Injection','Infusion');";
$result_re = mysqli_query($con,$sel_re);
...
$ins_query6="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`ndate`,`uprice`,`code`,`reuse`,`discard`) values 
('$pmrn','$dname','$eid','$ii','$infu1','$ddate','$alert','$user','$datem1','Active','$root','Rupdated','Ordered','$ortime','$datem','$uprice2','$p_code','Reuse','New')";
mysqli_query($con,$ins_query6);
...
$ins_query6="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`ndate`,`uprice`,`code`) values 
('$pmrn','$dname','$eid','$ii','$infu1','$ddate','$alert','$user','$datem1','Active','$root','Rupdated','Ordered','$ortime','$datem','$uprice2','$p_code')";
mysqli_query($con,$ins_query6);
...
mysqli_select_db($objConnect, "sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$sel95 = "SELECT * from medicine where mname='$infu' and pre in('Tablet','Vaginal Suppository','VT','Suppository','Soft Capsule','Sachet','Capsule','Injection','Infusion') and status='Active'"; 
...
echo '<script language="javascript">';
    ...
    echo '</script>';
			...
			{
			$strSQL = "insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`uprice`,`code`,`ndate`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime','$uprice1','$p_code','$ndate3')";
			...
			{
			$strSQL = "insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`reuse`,`uprice`,`code`,`ndate`,`status_select`,`rfid`,`rfid1`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Served','$ortime','Reuse','$uprice1','$p_code','$ndate3','selected','$rf','$rf1')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
			...
			{
			$strSQL = "insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`reuse`,`uprice`,`code`,`ndate`,`discard`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime','Reuse','$uprice1','$p_code','$ndate3','New')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
...
<td colspan="3" align="center"><label><strong>Type</strong></label></td>
</tr>
<tr>
