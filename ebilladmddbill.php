...
$update212="update preadm set pname='$pname',fname='$fname', mname='$mname', peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',nidcard='$nidcard',bcard='$bcard',vgcard='$vgcard',ocard='$ocard',wcard='$wcard',hcard='$hcard',fcard='$fcard',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Pending',pphone='$pphone2',user='$user',scase='$scase',vpoor='$vpoor',aldate='$aldate',pvno='$pvno',pvdate='$pvdate',spcase='$spcase', qc='805',md='md',cfo='cfo',ceo='ceo',dd01='dd01',apstatus='Waiting For Finance Approval',dsign='$aid.jpg' where `id`='$id'";
...
<input name="vpoor" type="text" size="70" value="<?php echo $data444['vpoor'];?>"required  />		<b>	  
<label for="age"><strong>Allocation Date:</strong></label>
<input type="text" name="aldate" id="datepicker" placeholder="MM/DD/YYYY" size="15" required>
...
<input type="text" name="pvdate" id="datepicker1" placeholder="MM/DD/YYYY" size="15" required>
