...
$ins_query="insert into innote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`inves`,`user`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$inves','$user','Rupdated')";
...
echo '<script language="javascript">';
    echo 'alert("Record NOT Added, contact your administrator"); ';
    echo '</script>';
...
<td colspan="16" align="center"><label><strong>Nurses Note</strong></label></td>
</tr>

<td colspan="4" align="center"><input type="text" name="infu" required value="" /></td>
<td colspan="16" align="center"><textarea rows="2" cols="50" name="inves" required value=""></textarea></td>
</tr>
...
$count=1;
$sel_query="Select * from innote where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
