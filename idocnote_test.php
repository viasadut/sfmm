...
<td colspan="6"><textarea name="remarks" id="remarks" class="form-control action" cols="30" rows="10"></textarea></td>
<td colspan="6"><textarea name="remarks" id="remarks1" class="form-control action" cols="30" rows="10"></textarea></td>
