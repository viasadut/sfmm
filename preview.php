...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="preview1?pmrn=<?php echo "$pmrn"; ?>&date=<?php echo "$date";?>&dname=<?php echo $row["dname"];?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="50" height="20" /></a></td>
