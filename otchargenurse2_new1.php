...
$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$sel1=mysqli_query($db,"SELECT * FROM medicine WHERE `mname`='$medi1';");
...
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`ins`) values ('$pmrn','$pname','$medi1','$id','$date1','$pdos','$dcode','$pp1')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
}
?>
<?php
...
{ echo'
				 ...
				 <td align="center" colspan="2"><a href="othosdelete1?id3='.$row["id"].'&pmrn='.$pmrn.'&id='.$id.'">DELETE</a></td>';
