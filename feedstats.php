<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('adminmng','mng','qc','staff')"; 
...
$query43 = "SELECT COUNT(ctype) FROM feed where ctype= '$bt' and adate BETWEEN '$start' and '$end';"; 
...
$query44 = "SELECT COUNT(ctype) FROM feed where adate BETWEEN '$start' and '$end' ;"; 
...
<h1 align="center">Feedback Stats Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>I. Action</strong>   
      <th width="14%"><strong>Final Feedback</strong>
      <th width="14%"><strong>F. Time</strong>
...
echo   $row44['COUNT(ctype)'];
echo " ,  From  ";
echo $start;
echo "  To  ";
echo $end;

$sel_query="Select * from feed where  adate BETWEEN '$start' and '$end' ";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['COUNT(ctype)'];
echo " ,  From  ";
echo $start;
echo "  To  ";
echo $end;
	 $sel_query="Select * from feed where ctype='$bt' and adate BETWEEN '$start' and '$end' ";
 } 
$count=1;
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["iaction"]; ?>
      <td align="center"><?php echo $row["feed"]; ?>  
      
      <td align="center"><?php echo $row["ftime"]; ?>  
