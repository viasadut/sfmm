...
$rr1='Dengue NS1 Antigen- :'.$chikun1;

$rr='Dengue NS1 Antigen- :'.$chikun1;
...
$ins_query1="insert into dengue (`pname`,`pmrn`,`psex`,`page`,`dengue1`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Dengue NS1 Test:</strong></label>
	  <label for="iron"><strong>Dengue NS1 Antigen </strong></label>
