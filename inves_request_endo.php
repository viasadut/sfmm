...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('endo','doctor','mng','staff')"; 
...
$ins_query="insert into radio (`iname`,`type`,`subtype`,`price`,`code`,`adtime`,`adby`,`instruction`,`tcentre`,`interpretation`,`fby`,`status`,`ceo`,`cfo`,`itby`,`md`,`price1`,`cprice`,`ittime1`) values 
( '$mname','$bname','$cname','$form','$cat','$adate','$user','$instruction','$tcentre','$interpretation','338','Waiting For Finance Fowrading','ceo','cfo','322','md','$form1','$cprice','$ittime1')";
mysqli_query($con,$ins_query) or die(mysql_error());
	

$ins_query1="insert into radio1 (`iname`,`type`,`subtype`,`price`,`code`,`adtime`,`adby`,`instruction`,`tcentre`,`interpretation`,`fby`,`status`,`ceo`,`cfo`,`itby`,`md`,`price1`,`cprice`,`ittime1`) values 
( '$mname','$bname','$cname','$form','$cat','$adate','$user','$instruction','$tcentre','$interpretation','338','Waiting For Finance Fowrading','ceo','cfo','322','md','$form1','$cprice','$ittime1')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query2="insert into radio2 (`iname`,`type`,`subtype`,`price`,`code`,`adtime`,`adby`,`instruction`,`tcentre`,`interpretation`,`fby`,`status`,`ceo`,`cfo`,`itby`,`md`,`price1`,`cprice`,`ittime1`) values 
( '$mname','$bname','$cname','$form','$cat','$adate','$user','$instruction','$tcentre','$interpretation','338','Waiting For Finance Fowrading','ceo','cfo','322','md','$form1','$cprice','$ittime1')";
...
<!-- Form Title -->
      ...
      <input name="bname" type="text" size="70"  value="ENDOSCOPY SUITE"readonly>
