...
$query = "SELECT * from pac where pmrn='$pmrn' and eid='$eid'"; 
...
$insert="update pac set `induction`='$induction',`intubation`='$intubation',`ecare`='$ecare',`acare`='$acare',`monitoring`='$monitoring',`pposition`='$pposition',`psite`='$psite',`psize`='$psize',`csite`='$csite',`asite`='$asite',`circuit`='$circuit',`ventilation`='$ventilation',`rapid`='$rapid',`rtechnique`='$rtechnique1',
...
`spontaneous`='$spontaneous',`gasflow`='$gasflow',`co2a`='$co2a',`hme`='$hme',`peroxy`='$peroxy' where pmrn='$pmrn' and eid ='$eid'";
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
					 ...
					 <td colspan="6"><select name="induction" >
						...
						<option value='<?php echo $row['induction'];?>'><?php echo $row['induction'];?></option>
...
<td colspan="3"><select name="intubation">
						...
						<option value='<?php echo $row['intubation'];?>'><?php echo $row['intubation'];?></option>
						<option value='9:00AM'>9:00AM</option>
						<option value='10:00AM'>10:00AM</option>
						<option value='11:00AM'>11:00AM</option>
						<option value='12:00PM'>12:00PM</option>
		...
		<tr>
					 ...
					 <td colspan="5"><input type="text" name="ecare" value="<?php echo $row['ecare'];?>" ></td> 
					 <td colspan="5"><input type="text" name="acare" value="<?php echo $row['acare'];?>" ></td> 

						<td colspan="5"><input type="text" name="monitoring" value="<?php echo $row['monitoring'];?>" ></td> 
						
						<td colspan="5"><select name="pposition">
        
						<option value='<?php echo $row['pposition'];?>'><?php echo $row['pposition'];?></option>
...
<td colspan="10"><label><strong>Size</strong></label></td> </tr>
						...
						<option value='<?php echo $row['psite'];?>'><?php echo $row['psite'];?></option>
...
<td colspan="10"><select name="psize">
						...
						<option value='<?php echo $row['psize'];?>'><?php echo $row['psize'];?></option>
...
<tr><td colspan="20"><label><strong>Central</strong></label></td>  </tr>
 <tr><td colspan="20"><label><strong>Site</strong></label></td>
						...
						<option value='<?php echo $row['csite'];?>'><?php echo $row['csite'];?></option>
...
<tr><td colspan="20"><label><strong>Arterial Line</strong></label></td>  </tr>
 <tr><td colspan="20"><label><strong>Site</strong></label></td>
						...
						<option value='<?php echo $row['asite'];?>'><?php echo $row['asite'];?></option>
...
<tr><td colspan="10"><select id='dropdown' name='dropdown' value="">
  <option value="<?php echo $row['ga'];?>"><?php echo $row['ga'];?></option>
  <option value="YES">YES</option>
  <option value="NO">NO</option>
  
</select></td>
<td colspan="10"><input type="text" id="gasize"  name="gasize" value="<?php echo $row['gasize'];?>" placeholder="Guedal Airway Size" /></td>
...
<tr><td colspan="10"><select id='dropdown1' name='dropdown1'>
  <option value="<?php echo $row['lm'];?>"><?php echo $row['lm'];?></option>
  <option value="YES">YES</option>
  <option value="NO">NO</option>
  
</select></td>
<td colspan="10"><input type="text" id="lmsize" name="lmsize" value="<?php echo $row['lmsize'];?>" placeholder="LM Size" /></td>
...
<tr><td colspan="10"><select id='dropdown2' name='dropdown2'>
  <option value="<?php echo $row['ett'];?>"><?php echo $row['ett'];?></option>
  <option value="YES">YES</option>
  <option value="NO">NO</option>
  
</select></td>
<td colspan="5"><input type="text" id="ett" name="ett" value="<?php echo $row['ett1'];?>" placeholder="ETT Type" /></td>
<td colspan="5"><input type="text" id="ett1"  name="ett1" value="<?php echo $row['ett2'];?>" placeholder="ETT Size" /></td>
...
<td colspan="10"><input type="text" id="trache" name="trache" value="<?php echo $row['trache1'];?>" placeholder="Tracheostomy Type" /></td>
...
<tr><td colspan="10"><select id='dropdown4' name='dropdown4'>
  <option value="<?php echo $row['ng'];?>"><?php echo $row['ng'];?></option>
  <option value="YES">YES</option>
  <option value="NO">NO</option>
  
</select></td>
<td colspan="5"><input type="text" id="ng" name="ng" value="<?php echo $row['ng1'];?>"placeholder="NG Type" /></td>
<td colspan="5"><input type="text" id="ng1" name="ng1" value="<?php echo $row['ng2'];?>" placeholder="NG Size" /></td></tr>
...
<td colspan="5"><input type="text" id="circuit" name="circuit"placeholder="circuit" value="<?php echo $row['circuit'];?>" ></td>


		<td colspan="5"><select name="co2a">
        
						<option value="<?php echo $row['co2a'];?>"><?php echo $row['co2a'];?></option>
						...
						<option value="<?php echo $row['hme'];?>"><?php echo $row['hme'];?></option>
						...
						<option value="<?php echo $row['peroxy'];?>"><?php echo $row['peroxy'];?></option>
...
<tr><td colspan="20"><label><strong>Ventilation</strong></label></td>
						  ...
						  <tr><td colspan="20"><select name="ventilation">
        
						<option value='<?php echo $row['ventilation'];?>'><?php echo $row['ventilation'];?></option>
						<option value='Gas Flow'>Gas Flow</option>
						<option value='Spontaneous Respiration'>Spontaneous Respiration</option>
						<option value='PPV'>PPV</option>
						<option value='VT'>VT</option>
						<option value='V'>V</option>
						<option value='F'>F</option>
						<option value='Inmax'>Inmax</option>
...
<tr><td colspan="20"><input type="text" name="gasflow" value="<?php echo $row['gasflow'];?>" ></td>

<tr><td colspan="20"><label><strong>Spontaneous Respiration<</strong></label></td>
<tr><td colspan="20"><input type="text" name="spontaneous" value="<?php echo $row['spontaneous'];?>" ></td>

<tr><td colspan="20"><label><strong>PPV</strong></label></td>
<tr><td colspan="20"><input type="text" name="ppv" value="<?php echo $row['ppv'];?>" ></td>

<tr><td colspan="20"><label><strong>VT</strong></label></td>
<tr><td colspan="20"><input type="text" name="vt" value="<?php echo $row['vt'];?>" ></td>

<tr><td colspan="20"><label><strong>V</strong></label></td>
<tr><td colspan="20"><input type="text" name="v" value="<?php echo $row['v'];?>" ></td>

<tr><td colspan="20"><label><strong>F</strong></label></td>
<tr><td colspan="20"><input type="text" name="f" value="<?php echo $row['f'];?>" ></td>

<tr><td colspan="20"><label><strong>Inmax</strong></label></td>
<tr><td colspan="20"><input type="text" name="inmax" value="<?php echo $row['inmax'];?>" ></td>
...
<tr><td colspan="20"><label><strong>Laryngoscopy Graden</strong></label></td>
						  ...
						  <tr><td colspan="20"><input type="text" name="lgrading" value="<?php echo $row['lgrading'];?>" ></td>
...
<tr><td colspan="20"><label><strong>Regional Technique</strong></label></td>
					...
					<select name="rtechnique[]" multiple="multiple" class="3col active" placeholder="Select Regional Technique"required>
						...
						<option value='<?php echo $row['rtechnique'];?>'selected><?php echo $row['rtechnique'];?></option>
...
<tr><td colspan="20"><input type="text" name="rlevel" value="<?php echo $row['rlevel'];?>" ></td>

<tr><td colspan="20"><label><strong>Drugs</strong></label></td>
<tr><td colspan="20"><input type="text" name="rdrugs" value="<?php echo $row['rdrugs'];?>" ></td>

<tr><td colspan="20"><label><strong>Others</strong></label></td>
<tr><td colspan="20"><input type="text" name="rothers" value="<?php echo $row['rothers'];?>" ></td>


<tr><td colspan="20"><label><strong>Difficulities / Critical Events</strong></label></td></tr>


						  <tr><td colspan="20"><input type="text" name="cevents" value="<?php echo $row['cevents'];?>" ></td>
...
<tr><td colspan="20"><label><strong><a target='_blank'href="anaesmedi?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Medication</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesinfusion?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Infusion</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesn2o?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">N20/Air</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesagent?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Volatile Agent</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesvitals?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Vitals</strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank'href="anaesbsugar?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Blood Sugar</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesbloss?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Blood Loss</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank'href="anaesurine?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Urine Output</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesinves?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Peroperative Investigation</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesbtrans?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Blood Transfsion Order</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank' href="anaesother?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Other Fluid Loss</a></strong>&nbsp;&nbsp;&nbsp;<strong><a target='_blank'href="anaestour?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Tourniquite</a></strong></label></td></tr>
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="anaesprint?id=<?php echo "$id"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
