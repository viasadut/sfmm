...
$ins_query="insert into estat (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated')";
...
<tr>
<td colspan="15" align="center"><label><strong>Stat Medication</strong></label></td> 
<td colspan="5" align="center"><label><strong>Remarks</strong></label></td>
</tr>
<tr>

<td colspan="15" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
