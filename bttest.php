...
$update33="update pappnew set `aslot`='$slot', `bill`='$bill' where `ID`='$id'";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<input name="dname" type="text" value="<?php echo $data["dname"]; ?>">
		
		
		<label for="mail"><strong>Appointment Date :</strong></label>
									<p>
									  
									  <input name="date1" type="text" size=65% value="<?php echo $data["adate"]; ?>" size ="57">
			...
			<select name="slot"> <option><?php echo $data["aslot"]; ?></option>
	   <?php 
	   $dname= $_REQUEST['dname'];
	   $date1=$_REQUEST['date1'];
			$sql = "select * from `test` where `dname`='$dname' and `status`='AVAILABLE'and `ddate`='$date1' order by id asc";
      ...
      <input name="name" type="text" size="65" value="<?php echo $data["pname"]; ?>">
 	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" type="text" size="65" value="<?php echo $data["padd"]; ?>">

	  <label for="age"><strong>Patient's Details :</strong></label>
	  	
            <input name="psex" type="text" size="15" value="<?php echo $data["psex"]; ?>">
            <input name="pmrn" type="text" size="10" value="<?php echo $data["pmrn"]; ?>">
      <input name="pphone" type="text" size="10" value="<?php echo $data["pphone"]; ?>">	  
	  <input name="page" type="text" size="5"value="<?php echo $data["page"]; ?>">
      
<label for="age"  size="20%"><strong>Patient's Physical Examination :</strong></label>

	        <input name="pheight" type="text" size="20" placeholder="Height" value="">
	        <input name="pweight" type="text" size="14" placeholder="Weight" value="">
	        <input name="ptemp" type="text" size="14" placeholder="Temperature" value="">
