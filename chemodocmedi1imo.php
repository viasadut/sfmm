...
$ins_query6="insert into chemomedi (`pmrn`,`dname`,`eid`,`infusion`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from chemomedi where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `infusion` and `time` asc;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="chemomedicanceldoc?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
