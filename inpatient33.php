...
$ins_query="insert into infusion (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`infusion`,`status`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$infu','Not Updated')";
...
<td colspan="12" align="center"><input type="text" name="infu" required value="" /></td>
