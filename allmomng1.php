...
$count=1;
$sel_query="Select * from staff1 where astatus='Active' and ugroup in ('imo','mofficer')order by sdepartment asc;";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo 'SFMM'.$row["sid"]; ?>
...
<td align="center"><?php echo $row["sdepartment"]; ?> 
	  
<?php 
$bname=$row["mname"];
$bid=$row["id"];
$bid1=$row["sid"];
$query43 = "SELECT COUNT(sid) FROM covid where sid ='$bid1';"; 
...
$rr=$row43['COUNT(sid)'];
$url = "covid1?id=$bid"; 
$url1 = "covidedit?name=$bname&sid=$bid1"; 

?>
	  <td><?php if($rr==1){ 
echo "<a target='_blank' href='$url1'>Edit</a>";
	}
else 
	{ 
echo "<a target='_blank' href='$url'>Add</a>";
	}
?></td>
