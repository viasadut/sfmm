...
<tr>
	  ...
	  <td colspan="1" align="center"><strong>Status</strong></td>
		  ...
		  <td colspan="2" align="center"><strong>Update1</strong></td>
...
<td align="center"colspan="2"><a href="labtestin3?pmrn=<?php echo $row['pmrn']; ?>&id=<?php echo $row['id']; ?>&eid=<?php echo $row['eid']; ?>">UPDATE</a></td>  	  
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Investigation</strong></td>
	   ...
	   <td colspan="2" align="center"><strong>Print</strong></td>
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="2"><?php echo $row["infusion"]; ?></td>
		...
		<td colspan="3"><a target='_blank' href="<?php echo $row['report']?>?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
		<td colspan="2"><a target='_blank' href="printlabreport.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
