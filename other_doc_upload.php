...
<div class="container">
    ...
    <form action="other_doc_upload1.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <select name="type" required>
				 ...
				 <option value='Nursing Document'>Nursing Document</option>
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from other_doc_form where pmrn='$pmrn' and eid='$eid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    ...
                    <form action="other_delete.php" method="POST">
