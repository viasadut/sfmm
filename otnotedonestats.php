...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>Procedure Name</strong></th>
...
$count=1;
$sel_query="Select * from otreport where date1 BETWEEN '$start' and '$end';";
...
{ ?>    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["sname"];?> 
      <td align="center"><?php echo $row["ottype"]; ?>  
	  <td colspan="10"><?php echo $row["sreport"]; ?> </td>	
      </tr>
