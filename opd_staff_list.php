...
$count=1;
$sel_query="Select * from staff3 where status='Active' and dept='Out Patient Services' order by sid desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="opd_edit?sid=<?php echo $row["sid"]; ?>">Edit</a> </td>
