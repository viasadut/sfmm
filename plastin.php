...
<!-- Form Title -->
      ...
      <input name="apartial" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  
	  <label for="age"><strong>aPTT Control:</strong></label>
      <input name="aptt" type="text" size="70" style="text-transform:uppercase" value=""required/>
