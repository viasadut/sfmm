...
<img src="21.jpg" height="400" width="290">
...
<form method="post" action="auth1.php">
	...
	<img src="final_covid_bg.jpg" height="400" width="290">
    </div>
	...
	<div id="slider1_container" style="visibility: hidden; position: absolute; left: 440px; top: 455px; width: 400px; height: 230px; overflow: hidden; align:center;">
			...
			<?php
					...
					$result = $db->query("SELECT id, created FROM images order by created ASC  limit 6");
				
					While($imgData = $result->fetch_assoc()){        
						echo "<div><a target='_blank' href='test_pdf12?date='".$start."'&date1='".$end."'> <img data-u='image' src='slider/display.php?id=". $imgData['id'] . "' ></a></div>"; 
					}
			?>
			</div>
	...
	<div id="slider1_container1" style="visibility: hidden; position: absolute; left: 30px; top: 455px; width: 400px; height: 230px; overflow: hidden; align:center;">
			...
			<?php
					...
					//Get image data from database
					$result = $db->query("SELECT id, created FROM images_other order by created ASC  limit 5");
	...
	<div id="slider1_container2" style="visibility: hidden; position: absolute; left: 850px; top: 455px; width: 400px; height: 230px; overflow: hidden; align:center;">
			...
			<?php
					...
					//Get image data from database
					$result = $db->query("SELECT id, created FROM images_cme order by created ASC  limit 5");
