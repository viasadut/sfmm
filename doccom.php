...
$sel90="SELECT * FROM ccomm WHERE `cname`='$cname' and mname='$mname'and status='Active';";
...
$ins_query1="insert into ccomm (`cname`,`mname`,`mrole`,`adate`,`adate1`,`aby`,`status`) values ('$cname','$mname','$mrole','$adate','$adate1','$user','Active')";
...
<!-- Form Title -->
		<h1>Hospital Committee List Where You Are Included</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>View Minutes</strong>
...
$date= date('m/d/Y');
$count1=1;
$sel_query="Select * from ccomm where uid='$user' and status='Active' order by mrole asc";
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <?php
	  $rrm=$row['cname'];
	  $query = "SELECT * FROM ccom where cname= '$rrm'"; 
...
//$fname=$row['fullname'];
	  ...
	  <td align="center"><?php echo $row["aby"]; ?></a></td>
	  	  <td align="center"colspan="2"><a  target='_blank' href="indimeet?id=<?php echo $row11["id"]; ?>&cname=<?php echo $row11['cname'];?>">View Minutes</td>  	
