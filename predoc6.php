...
<tr><td colspan="20" align="center"bgcolor="lightblue"><h2><label><strong>Approved Surgery List </strong></label><h2></td> </tr>
<tr bgcolor="#F08080">
...
$count=1;
$sel_query="Select * from predoc where rby='$mname' and status='approved' order by `rdate1` asc;";
