...
<tr><td align="left" colspan="20"><a target='_blank' href="promedicine?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"?>&eid=<?php echo "$eid"?>&id=<?php echo "$id"?>"><img src="medicine1.jpg" title="test" width="130" height="90" /></a></td></tr>
