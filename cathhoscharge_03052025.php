...
//else {
$ins_query1="insert into cathhoscharge (`dname`,`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`type`,`ieid`,`code`,`qty`,`ins`) values 
('$full','$pmrn','$pname','$medi1','$eid','$date1','$pdos','$type','$ieid','$code','$price','$btype')";
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="7" align="center"><strong>ITEM</strong></td>
...
$count=1;
$sel_query="Select * from cathhoscharge where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="7"><?php echo $row["medi"]; ?></td>
                ...
                <td align="center"colspan="2"><?php echo $row["qty"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="cathhosdelete1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>&ieid=<?php echo "$ieid"; ?>&type=<?php echo "$type"; ?>">DELETE</a></td>
