...
`promyclocyte`='$promyclocyte',`metamyclocyte`='$metamyclocyte',`myoblast`='$myoblast',`lymphoblast`='$lymphoblast',`nrbc`='$nrbc' where sno='$sno'";
	...
	$url = "cbc_view_result1?inid=$inid&id=$id" ;
header("Location:$url");
        ...
        <table>
            <tr>
                ...
                <td colspan="10"> <a target='_blank'
                        href="cbc_view_result?inid=<?php echo "$inid"; ?>&id=<?php echo $id; ?>"><img
