...
$sh = $db->prepare("insert into preanaes (`dname`,`pmrn`,`pname`,`height`,`surgeon`,`weight`,`allergy`,`teeth`,`airway`,`mscore`,`otherins`,`preanae`,`mediprob`,`premedi`,`pulse`,`temp`,`bp`,`jaundice`,`cyanosis`,`edema`,`cvs`,`resp`,`git`,`cns`,`hb`,`wbc`,`pla`,`pt`,`inr`,`bt`,`ct`,`aptt`,`urea`,`creatinine`,`na`,`k`,`cl`,`hco3`,`glucose`,`hbs`,`hcv`,`hiv`,`abg`,`pft`,`tft`,`echo`,`xray`,`ecg`,`bgroup`,`crossm`,`tanaesthesia`,`prelief`,`rfactor`,`tsurgery`,`nil`,`premedication`,`remarks`,`charge`,`date`,`time`,`page`,`psex`,`eid`,`otname`,`urinere`,`others1`,`tsh`,`inp`) VALUES 
	(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $sh->execute([$dname,$pmrn,$pname,$height,$sname,$weight,$allergy,$teeth,$airway,$mscore,$otherins,$preanae,$mediprob,$premedi,$pulse,$temp,$bp,$jaundice,$cyanosis,$edema,$cvs,$resp,$git,$cns,$hb,$wbc,$pla,$pt,$inr,$bt,$ct,$aptt,$urea,$creatinine,$na,$k,$cl,$hco3,$glucose,$hbs,$hcv,$hiv,$abg,$pft,$tft,$echo,$xray,$ecg,$bgroup,$crossm,$tanaesthesia,$prelief,$rfactor,$tsurgery,$nil,$premedication,$remarks,$charge,$aadate,$adate,$pa,$ps,$eidp,$otname,$urinere,$others1,$tsh,$eid]);
	
	
	
$sh = $db->prepare("insert into icnote(`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`) VALUES
	(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $sh->execute([$pmrn,$eid,$pname,$padd,$pa,$padm,$ps,$pp,$adate,$advice,$advice,$advice,$dname,$up,$doc,$charge,$advice,$daten,$entry_time]);
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="20"><select name="dname" value="" class="style1">
 ...
 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
    ...
    $(function () {
        $('select[multiple].active.3col').multiselect({
            columns: 6,
            placeholder: 'Select Anaesthesia',
            search: true,
            searchOptions: {
                'default': '-Select Anaesthesia-'
            },
            selectAll: true
        });
...
<tr><td colspan="20"><label><strong>Pain Relief Discussed:</strong></label></td></tr>	
					 ...
					 <tr>
					  ...
					  <td colspan="20"><select name="xl4[]" multiple="multiple" class="3col active" placeholder="Select Anaesthesia">
