...
$ins_query1="update medicine set code='$mcode', etime='$adate',eby='$user' where id='$id'";
...
<!-- Form Title -->
      ...
      <input name="mcode" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["code"];?>"required readonly>
      ...
      <input name="bname" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["brand1"];?>"required readonly>
	  <label for="age"><strong>Company Name :</strong></label>
      <input name="cname" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["brand2"];?>"required readonly>
	  <label for="age"><strong>Form :</strong></label>
      <input name="form" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["pre"];?>"required readonly>
	  <label for="age"><strong>Category :</strong></label>
      <input name="cat" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["pcat"];?>"required readonly>
