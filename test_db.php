...
$query4 = mysqli_query($db,"select * from ta where id='1'");
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
			$objDB1 = mysqli_select_db($objConnect,"test");

			
			
			$ins_query1="insert into ta (`name`) values ('$name')";
mysqli_query($objConnect,$ins_query1) or die(mysql_error());
...
<!-- Form Title -->
		...
		<input type="text"name="name" type="text" size="70" value="<?php echo $nname;?>"required  />
		<label for="age"><strong>New Password :</strong></label>
		<input type="text" name="gender" type="text" size="70" value=""required  />

		<label for="age"><strong>Re-Type New Password :</strong></label>
		<input type="text"name="age" type="text" size="70" value=""required  />
