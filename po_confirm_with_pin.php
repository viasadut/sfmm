...
//$pbp1= implode(",",$pbp2);
 ...
 if($user=='1601')       
      {  
           ...
           $query = "update po_table set status='FORWARD FOR CEO APPROVAL',cfo_a_time='$ortime' WHERE id = '".$_POST["employee_id"]."'";  
      ...
      {  
           ...
           $query = "update po_table set status='Approved',ceo_a_time='$ortime',ceo='$user' WHERE id = '".$_POST["employee_id"]."'";  
		   mysqli_query($connect,$query) or die(mysql_error());
           $message = 'Data Updated';  
           $_SESSION['success'] = 'Successfully Approved.';
      }  
