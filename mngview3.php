...
<p align="center" class="style1">LIST OF IPD'S DENGUE PATIENT</p> 
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from ecnote where pnote LIKE '%dengu%' order by id asc";
...
<td align="center"><?php echo $row["ddia"]; ?>	  

      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["ward"];?>  
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["bed"];?>  
