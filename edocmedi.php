...
$ins_query6="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date','Active','$root','Rupdated')";
mysqli_query($con,$ins_query6) or die(mysql_error());}

if (!empty ($_POST['infu2'])){
$ins_query61="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date','Active','$root','Rupdated')";
mysqli_query($con,$ins_query61) or die(mysql_error());}

if (!empty ($_POST['infu3'])){
$ins_query62="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date','Active','$root','Rupdated')";
mysqli_query($con,$ins_query62) or die(mysql_error());}

if (!empty ($_POST['infu4'])){
$ins_query63="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date','Active','$root','Rupdated')";
mysqli_query($con,$ins_query63) or die(mysql_error());}

if (!empty ($_POST['infu5'])){
$ins_query64="insert into emedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date','Active','$root','Rupdated')";
...
<td colspan="4" align="center"><label><strong>Caution</strong></label></td>
</tr>
...
<td colspan="4" align="left"><input type="radio" name="alert" value="" checked="checked"> Regular <br> <input type="radio" name="alert" value="H. Medi"> <b>High Alert Medication<b></td>
...
<tr>
	  ...
	  <td colspan="2" align="center"><strong>Caution</strong></td>
...
$count=1;
$sel_query="Select * from emedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel'order by `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="2"<?php if($row['alert']== "H. Medi"): ?> style="background-color:RED;" <?php endif ; ?>>
        <?php echo $row['alert'];?></td>
  	  
<td align="center" colspan="1"><a onclick="return confirm_click();" href="emediupdate1?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
	  <td align="center" colspan="1"><a href="emediupdate?id=<?php echo $row["id"]; ?>">Stop ALL</a></td>
