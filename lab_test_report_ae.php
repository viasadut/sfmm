...
$query = "SELECT * from einves where id='$id'"; 
...
$update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$plaintext' where id='$id'";
