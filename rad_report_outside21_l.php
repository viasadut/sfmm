...
<div id='cssmenu'>
<ul>
   <li><a href='radview1_con'><span>Pending Reports</span></a></li>
...
$sel_query="Select * from radreport where status!= 'confirmed' and rdate='$rr1' and dname='$full' ORDER BY id desc;";
...
?>
		  	  ...
		  	  <td align="center"><a target='_blank' href="radpreedit_out_l.php?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&type1=<?php echo $row['type1']; ?>">EDIT</a></td>
