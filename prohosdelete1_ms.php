...
//$id1=$_REQUEST['ID'];
$url = "prohoscharge_ms.php?pmrn=$pmrn&eid=$eid&dname=$dname&id=$id&ieid=$ieid&type=$type";
$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$sel_p=mysqli_query($db,"SELECT COUNT(id) FROM prohoscharge_ms WHERE `id`='$id';");
$result_p = mysqli_fetch_assoc($sel_p);
$del_id=$result_p['COUNT(id)'];
if($del_id>0){

$query = "DELETE FROM prohoscharge_ms WHERE id=$id"; 
...
header("Location:prohoscharge_ms.php?pmrn=$pmrn&eid=$eid&dname=$dname&id=$id&ieid=$ieid&type=$type");
}
?>