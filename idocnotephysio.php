...
$ins_query="insert into physionote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$user','Data Updated')";
...
$count=1;
$sel_query="Select * from physionote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
