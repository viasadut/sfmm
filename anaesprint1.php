...
$query = mysqli_query($db,"select * from pac where id='$id'");
...
$pdf->Cell('50',5,$data['ventilation'],0,0,'L');
...
$query1 = mysqli_query($db,"select * from anaesmedi where pmrn='$pmrn' and eid='$eid'");
...
$query1 = mysqli_query($db,"select * from anaesinfusion where pmrn='$pmrn' and eid='$eid'");
