...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Receive GRN Documents</strong>
...
$sel_query="Select * from acct_ap where status='' order by id desc";
...
<a href="prepare_ap_cheque_new_1?cname=<?php echo $row["id"]; ?>">Receive GRN Documents</a> 
</td>
