...
$sel_query="Select * from m_suite where pdate= '$date' and ustatus='Updated' and type!='inpatient' and stype in('Regular','Package');";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["dname"]; ?>  
	       		   ...
	       		   <td align="left" ><a target='_blank' href="opdbill1_ms?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Details</a></td>
