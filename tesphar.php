...
{
return confirm("Do You Want to Update The Status ?");
}
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Doctor's Name</strong>   
	        <th width="14%"><strong>SERVED</strong>   
      
      <th width="14%"><strong>PARTIALLY SERVED</strong>
	  <th width="14%"><strong>NOT SERVED</strong>
	  <th width="14%"><strong>NOT PURCHASE</strong>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select DISTINCT(pmrn),date, dname,eid from pmedi where date='$date' and status=''ORDER BY date desc;";
...
<td  align="center"><a onclick="return confirm_click();" href="updatephar?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>SERVED</strong></a></td>
<td align="center"><a onclick="return confirm_click1();" href="updatephar1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>PARTIALLY SERVED</strong></a></td>
<td  align="center"><a onclick="return confirm_click2();" href="updatephar2?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>NOT SERVED</strong></a></td>
<td align="center"><a onclick="return confirm_click3();" href="updatephar3?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><strong>NOT PURCHASE</strong></a></td>
