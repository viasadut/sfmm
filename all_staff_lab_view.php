...
<p align="right"><div2><input style="background-color: lightgreen;" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search By Blood Group.." title="Type in a Discipline">
