...
<div id='cssmenu'>
<ul>
   <li><a href='cviewsp1et'><span>Home</span></a></li>
...
<li class='last'><a href='appet'><span>Set patient Appointment</span></a></li>
<li class='last'><a href='previouset'><span>Search Previous Patient</span></a></li>
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="previouset1?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">GO</a></td>
