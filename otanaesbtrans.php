...
$query198 = mysqli_query($db,"SELECT SUM(infusion) FROM otanaesbtrans where pmrn='$pmrn'and id='$id'"); 
...
$ins_query="insert into otanaesbtrans (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
('$pmrn','$id','$pname','$page','$adm','$psex','$pphone','$odate','$remarks','$user','Data Updated','$odate1','$time','$date','Active','$infu')";
...
$count=1;
$sel_query="Select * from otanaesbtrans where pmrn= '$pmrn' and eid='$id' and status1='Active'order by `id` DESC;";
