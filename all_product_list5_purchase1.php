...
$queryd = "SELECT * from store_master where code='".$id."'"; 
...
$eid=$rowd['eid'];
	  ...
	  $queryr = "SELECT SUM(req_qty) from purchase_stock3 where code='".$eid."' and status='Pending'"; 
...
$gg=$rowd['eid'];
$count=1;
$sel_query="Select * from purchase_stock3 where code='$id' and status='Pending' ORDER BY id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from store_master where code='$id' ORDER BY id desc;";
...
$ccode=$row['code'];
	  ...
	  $queryrv = "SELECT SUM(add_qty) from purchase_stock3 where code='".$ccode."' and location='store' and add_qty>0"; 
