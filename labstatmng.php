...
$query43 = "SELECT COUNT(medi) FROM alltest where medi= '$bt'and date1 BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(infusion) FROM iinves where infusion= '$bt'and ndate BETWEEN '$start' and '$end';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(infusion) FROM einves where infusion= '$bt'and odate BETWEEN '$start' and '$end';"; 
...
$sel_query1="Select * from alltest where medi='$bt' and date1 BETWEEN '$start' and '$end' order by id";
...
{ ?>    <tr>
	...
	$sel_query2="Select * from iinves where infusion='$bt' and ndate BETWEEN '$start' and '$end' order by id";
...
{ ?>    <tr>
	...
	<?php
	$sel_query3="Select * from einves where infusion='$bt' and odate BETWEEN '$start' and '$end' order by id";
