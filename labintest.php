...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and status='Data Updated' and type='lab' order by `id` DESC;";
...
<td colspan="2" align="center"><a onclick="return confirm_click();" href="labresult1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&user=<?php echo "$user"; ?>"><strong>RECEIVE</strong></a></td>
...
<tr>
      ...
      <td colspan="4" align="center"><strong>Investigation</strong></td>
	   ...
	   <td colspan="7" align="center"><strong>Result</strong></td>
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and type='lab' and rstatus IN ('RECEIVED','REJECTED') and status IN ('RECEIVED','REJECTED') and resultstatus='UPDATED'   order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
	  ...
	  <td align="center"colspan="4"><?php echo $row["infusion"]; ?></td>
		  ...
		  <td align="center"colspan="7"><?php echo $row["result"]; ?></td>
		  
		  <td align="center"colspan="7"><a target='_blank' href="<?php echo $row['link']?>?pmrn=<?php echo $row['pmrn']; ?>id=<?php echo $row['id']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>">REPORT</a></td>
		  		  <td colspan="10"><a target='_blank' href="printlabreport.php?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
				  		  		  <td colspan="10"><a target='_blank' href="<?php echo $row['report']?>?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
