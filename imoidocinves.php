...
$query159 = mysqli_query($db,"select * from radio1 where id='$infu' and status='Active'");
$data159 = mysqli_fetch_assoc($query159);
$code5=$data159["code"];


$query1590 = mysqli_query($db,"select * from radio where code='$code5' and status='Active'");
$data1590 = mysqli_fetch_assoc($query1590);


$iname3=$data159["iname"];
$type=$data159["type"];
$code=$data1590["code"];
...
$sel90="SELECT * FROM radio1 WHERE `id`='$infu' and status='Active';";
...
$ins_query="insert into iinves (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`ordate`,`type`,`code`,`price`,`subtype`,`rstatus`,`link`,`report`,`ndate`,`linkv`,`reportv`,`unit`,`dname`,`ip`,`op`,`acct_code`,`ccentre`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$iname3','$user','$remarks','Data Updated','$ordate','$type','$code','$price','$subtype','Ordered','$link','$report','$ndate','$linkv','$reportv','$unit','$d_name','$ip','$op','$acode','$ccentre')";
...
$query9 = mysqli_query($db,"select * from radio1 where iname='$ii' and status='Active'");
...
$ins_query="insert into iinves (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`ordate`,`type`,`code`,`price`,`subtype`,`rstatus`,`link`,`report`,`ndate`,`linkv`,`reportv`,`unit`,`dname`,`ip`,`op`,`acct_code`,`ccentre`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$ii','$user','$remarks','Data Updated','$ordate','$type','$code','$price','$subtype','Ordered','$link','$report','$ndate','$linkv','$reportv','$unit','$d_name','$ip','$op','$acode','$ccentre')";
mysqli_query($con,$ins_query) or die(mysql_error());
...
{ ?>    <tr>
 ...
 <td colspan="2">
		  <?php 
			if($row['infusion']=='ECG' || $row['infusion']=='ecg' || $row['infusion']=='Ecg' and $row['upload']!=''){echo" 
