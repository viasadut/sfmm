...
$sel96="SELECT * FROM medi_stock WHERE `sno`='$code';";
...
$url = "phar_out_new_bill1_test_opd?sno=$sno";
header("Location: $url"); 
...
if($result18['COUNT(id)']>0 and $user!=''){
...
header("Location: phar_out_new_bill1_test_opd?sno=$sno");
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "phar_out1_new_new_opd.php?pmrn=" + str, true);
