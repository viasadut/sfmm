...
$url = "otchargenurse2_new11.php?pmrn=$pmrn&id=$eid";	 

$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$sel_p=mysqli_query($db,"SELECT COUNT(id) FROM othoscharge1 WHERE `id`='$id';");
...
$query = "DELETE FROM othoscharge1 WHERE id='$id'"; 
...
values ('$last_id','DR','$tb_data','$date','$price','OT_MEDI_DEL')";
mysqli_query($con,$ins_query) or die(mysql_error());


$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','CR','615100','$date','$price','OT_MEDI_DEL')";
...
header("Location: otchargenurse2_new11.php?pmrn=$pmrn&id=$eid"); 
