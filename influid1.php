...
<tr><td colspan="20"align="center"><font size="6" color="#FF0000"><strong><a href="influid2?pmrn=<?php echo "$pmrn";?>&eid=<?php echo "$eid"; ?>"> Add Intake</a>&nbsp;&nbsp;<a href="influid3?pmrn=<?php echo "$pmrn";?>&eid=<?php echo "$eid"; ?>">Add Outtake</a></td></tr>
<tr><td colspan="20"align="right"><font size="4.5" color="Lightgreen"><strong><a target='_blank' href="influiddoctestnurse.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Summary &nbsp;&nbsp;<a target='_blank' href="fluidstat?pmrn=<?php echo "$pmrn";?>&eid=<?php echo "$eid"; ?>">Datewise Stats</a></td></tr>
<tr>
