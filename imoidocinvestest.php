...
<tr><td colspan="15" align="center"bgcolor="lightgreen"><label><strong>Investigation Request Form</strong></label></td> </tr>
...
<td colspan="12" align="center"><input list="browsers1" name="infu" size=60% class="form-control" autocomplete="off">
  <datalist id="browsers1">
				...
				<?php 
			$sql = "select * from `radio1` where status='Active'";
			...
			?>  </datalist></td>
			<td colspan="4" align="center"><input type="text" name="remarks" value="" /></td>
<td colspan="4" align="center"><textarea name="utype" id="utype" class="form-control action" cols="30" rows="10"></textarea></td>
</tr> 
...
echo "";
	...
	?>	  
		...
		$record=$row["result"];
		$ac_no='E'.$row["id"];
		$url = "$link?pmrn=$pmrn&eid=$eid4&id=$id"; 
	if($type=='lab' && $record !='')
	{ 
echo "<a target='_blank' href='$url'>REPORT</a>";
	}
