...
$query43="Select COUNT(pcat) from medicine where status='Active';";}
 else{

 $query43 = "SELECT COUNT(pcat) FROM medicine where pcat= '$bt' and status='Active';"; }
...
<h1 align="center">Category wise Medicine List</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt" required>
						...
						<?php 
			$sql = "Select DISTINCT pcat  from medicine;";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->pcat."'>".$row->pcat."</option>";
				}
			}
			?>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="15%"><strong>Available Brand </strong>
...
$count=1;
 $sel_query="Select * from medicine where pcat='$bt' and status='Active';";}
...
?>
      ...
      <td align="center" ><a href="editmedicinemng?id=<?php echo $row["id"]; ?>">Edit</a></td>
      </tr>
