...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','call','bill','mng','staff','ot','endo')"; 
...
$queryd = "SELECT * FROM staff1 where mname= '$dname1'"; 
...
$ins_query="insert into service_booking (`dname`,`dcode`,`pro_name`,`pname`,`pmrn`,`pphone`,`psex`,`page`,`date`,`s_date`,`s_by`,`remarks`,`status`,`loc`) values 
('$dname1', '$dcode','$pro_name','$pname','$pmrn','$pphone','$psex','$diff1','$date1','$s_date','$user','$remarks','Pending','$loc')";
...
<input name="pmrn" id="pmrn"onkeyup="GetDetail(this.value)" type="text" size="85" placeholder="MRN" value="">
    ...
    <select name="dname1" value="" class="country"required>
...
<select class="js-example-basic-single" name="xl"  value=''required>
