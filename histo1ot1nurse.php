...
$query399 = "SELECT * FROM ot where id= '$id'"; 
$result399 = mysqli_query($con, $query399) or die(mysqli_error());
$row399 = mysqli_fetch_array($result399);
$surname=$row399['dname'];
...
$date_n =$_REQUEST['date_n'];

$ins_query="insert into histo (`dname`,`date`,`time`,`pmrn`,`pname`,`pphone`,`page`,`psex`,`shistory`,`noperation`,`indication`,`find`,`bio1`,`bio2`,`eid`,`status`,`bstatus`,`bsize`,`eeid`,`date_n`) 
values ('$surname','$date1', '$time','$pmrn','$pname','$pphone','$page','$psex','$shistory','$noperation','$indication','$find','$bio1','$bio2','$count1','NOT SEEN','Not Confirm','$bsize','$eeid','$date_n')";
...
<!-- Form Title -->
		...
		<a target='_blank' href="https://medex.com.bd"><b>Reference Drug Index of Bangladesh(medex.com.bd)<b></a></td></tr>
				...
				<tr>	  
				<td colspan="20"><input type="text" name="dname" value="<?php echo $surname;?>" readonly/>
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="historeq.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname1=<?php echo "$full"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
