...
<th width="14%"><strong>Category</strong>	  
	  ...
	  <th width="10%"><strong>H.Notes</strong>
	  <th width="10%"><strong>Plan</strong>
...
<td>
<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-view1<?php echo $row["id"]; ?>">
                                                H.Notes <i class="fa fa-clipboard" aria-hidden="true"></i>
                                            </button> <br><br>

                                            <div class="modal fade bd-example-modal-lg" id="modal-view1<?php echo $row["id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
														   ...
														   $inq = "SELECT * FROM inpatient where id= '$u'"; 
	 
$inr = mysqli_query($con, $inq) or die(mysqli_error());

// Print out result
$in_row = mysqli_fetch_array($inr);
$ppr=$in_row['pmrn'];
$peid=$in_row['eid'];
$inqt = "SELECT * FROM pwl where pmrn= '$ppr' and eid='$peid' order by id desc"; 
...
echo "
<span style='color:green;font-size:22px;font-weight:bold'>Handover Notes: ".$send_row['fullname']." ( ".$in_rowt['send_time'].")</span>
<br><span style='color:green;font-size:22px;font-weight:bold'>Handover Given To: ".$send_row1['fullname']."</span>

<span style='color:gregoriantojd;font-size:18px;font-weight:bold'>".$in_rowt['work']."</span>";}													   
														   ?>
...
<td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-view<?php echo $row["id"]; ?>">
                                                Plan <i class="fa fa-clipboard" aria-hidden="true"></i>
                                            </button> <br><br>

                                            <div class="modal fade bd-example-modal-lg" id="modal-view<?php echo $row["id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title">Patient Treatment Plan</h1>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
...
$ppr=$in_row['pmrn'];
$peid=$in_row['eid'];
														   $inqt = "SELECT * FROM t_plan where pmrn= '$ppr' and eid='$peid' order by id desc"; 
...
echo "
<span style='color:green;font-size:22px;font-weight:bold'>Treatment Plan By: ".$in_rowt['add_by']." ( ".$in_rowt['add_time'].")</span>

<span style='color:gregoriantojd;font-size:18px;font-weight:bold'>".$in_rowt['plan']."</span>";}													   
														   ?>
...
<td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-view1<?php echo $row["id"]; ?>">
                                                Plan <i class="fa fa-clipboard" aria-hidden="true"></i>
                                            </button> <br><br>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
														   ...
														   $inq = "SELECT * FROM irefferal where id= '$u'"; 
...
<span style='color:lightblue;font-size:18px;font-weight:bold'>".$in_rowt['plan']."</span>";}													   
														   ?>
