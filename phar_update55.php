...
if($b_chk_7g['add_qty']>=$seven_qtyd1)
{
$ins_query4="update medi_stock set `add_qty`='$eight_qtyd' where id='$midg' and location='Pharmacy'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7g['add_qty']<$seven_qtyd1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where id='$midg' and location='Pharmacy'";
mysqli_query($con,$ins_query4) or die(mysql_error());
...
<tr>
	  ...
	  <td colspan="3" align="center"><strong>Instruction</strong></td>
		  ...
		  <td colspan="1" align="center"><strong>Ex. Date</strong></td>
...
$sum5 = "SELECT * FROM medi_stock where code='$mcode' and location='Pharmacy' and add_qty>0 order by exdate asc limit 1" ;
...
$new_batch1=$sum25['batch_no'];
     ...
     <td align="center" colspan="1" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>><?php echo $count; ?></td>
      ...
      <td align="center"colspan="7" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>><?php echo $row["medi"].' ('.$row1["brand1"].')'; ?></td>
	  
<td align="center"colspan="1" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>><?php echo $row1["code"]; ?></td>


	  <td align="center"colspan="2" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>><?php echo $row["pdos"].'<br>'.$row["frelation"].'<br>'.$row["duration"]; ?></td>
	        
						

		
<td align="center"colspan="3"
<?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>><?php echo $new_qty;?>


<input name="eqty2_<?= $id ?>" id="eqty2" type="hidden" value="<?php echo $new_qty;?>" readonly <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>>
...
<?php if($new_qty5>$rr_qty1){echo $new_qty5;} else {echo $new_qty6;};?>
<input name="batchqty_<?= $id ?>" type="hidden" value="<?php if($new_qty5>$rr_qty1){echo $new_qty5;} else {echo $new_qty6;};?>" id="eqty2" readonly <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?> >
...
<td align="center"colspan="1" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>>
<?php if($new_qty5>$rr_qty1){echo $new_batch1;} else {echo $new_batch;};?>

<input name="batchno_<?= $id ?>" style="font-weight: bold;font-size:12px;color:green" type="hidden" value="<?php if($new_qty5>$rr_qty1){echo $new_batch1;} else {echo $new_batch;};?>"readonly>

</td> 
		
<td align="center"colspan="1" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>>
<?php if($new_qty5>$rr_qty1){echo $new_qty55;} else {echo $new_qty66;};?>
<input name="exdate_<?= $id ?>" style="font-weight: bold;font-size:12px;color:green" type="hidden" value="<?php if($new_qty5>$rr_qty1){echo $new_qty55;} else {echo $new_qty66;};?>" readonly>
...
<td align="center"colspan="1"
<?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>><?php echo $row1['uprice'];?>

<input class="iprice" name="eqty3_<?= $id ?>" id="eqty2" type="hidden" value="<?php echo $row1['uprice'];?>" readonly <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>>
</td>			
...
<input class="iquantity" name="eqty1_<?= $id ?>" onchange='subTotal()' id="eqty1" type="text" value="0" required <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>>




<td colspan="1" class='itotal' <?php if($new_qty>0){echo'style="font-weight: bold;font-size:12px;color:green"';} else{echo'style="font-weight: bold;font-size:12px;color:red"';}?>></td>
