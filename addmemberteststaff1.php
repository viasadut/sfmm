...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('qc','admin1','staff')"; 
...
if($res=mysqli_num_rows($result)>0)
{
    ...
    echo '</script>';
		...
		$sql = "INSERT INTO staff1 (image,sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave,bgroup) VALUES 
		('".$image_name."','".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday1."','".$bgroup."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
	
	
	$sqlz = "INSERT INTO doctor (dname,degree,Discipline,status,sid,desig) VALUES 
		('".$mname."','".$degree."','".$new."','".$aa."','".$sid."','".$designation."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sqlz) or die(mysql_error());
	
	
	
	$sqlz1 = "INSERT INTO doctor1 (dname,degree,Discipline,status) VALUES 
		('".$mname."','".$degree."','".$new."','".$aa."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sqlz1) or die(mysql_error());
	...
	$sql3 = "INSERT INTO user (uname,upass,utype,fullname,status) VALUES 
		...
		mysqli_query($con,$sql3) or die(mysql_error());}
			...
			$sql = "INSERT INTO staff1 (image,sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave,bgroup) VALUES 
		('".$image_name."','".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday2."','".$bgroup."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
...
if($tt==$doj70){
		$sql = "INSERT INTO staff1 (sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave,bgroup) VALUES 
		('".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday1."','".$bgroup."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
...
$sqlz = "INSERT INTO doctor (dname,degree,Discipline,status,sid) VALUES 
		('".$mname."','".$degree."','".$new."','".$aa."','".$sid."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sqlz) or die(mysql_error());
...
$sql = "INSERT INTO staff1 (sid,mname,dob,gender,fname,maname,sname,mstatus,peradd,preadd,econtact,phone,email,econtactp,doj,department,sdepartment,designation,hod,astatus,stype,perdis,user,category,religion,ugroup,aleave,bgroup) VALUES 
		('".$sid."','".$mname."','".$dob."','".$gender."','".$fname."','".$maname."','".$sname."','".$mstatus."','".$peradd."','".$preadd."','".$econtact."','".$phone."','".$email."','".$econtactp."','".$doj."','".$department."','".$sdepartment."','".$designation."','".$hod."','".$astatus."','".$stype."','".$perdis."','".$user."','".$category."','".$religion."','".$ugroup."','".$fday2."','".$bgroup."')";
		//$mysqli->query($sql);
	mysqli_query($con,$sql) or die(mysql_error());
...
<h1 align="center">Consultant Registration Panel</h1>
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Degree:</strong></label></td></tr>
		...
		<tr>				 
					<td colspan="20">					<input type="text" name="degree" id="Degree" class="input-text" placeholder="Degree" required></td>
...
<td colspan="3"><select name="category" class="city" value=''required>
					...
					<td colspan="3"><select name="designation" class="style1" value='' required> <option>--Designation--</option>
						...
						<option value="Sessional Consultant">Sessional Consultant</option>;
						<option value="Specialist">Specialist</option>;
						<option value="Sessional Specialist">Sessional Specialist</option>;
						...
						<option value="Asst. Executive">Senior Consultant</option>;
