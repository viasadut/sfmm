<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('pharmacy','staff')"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
           ...
           <option value='pharmacy_opd'>Pharmacy OPD</option>
           <option value='pharmacy_ipd'>Pharmacy IPD</option>
  ...
  <option value='Surgical ICU'>Surgical ICU</option>
		...
		<option value='Endoscopy Emergency Trolley'>Endoscopy Emergency Trolley</option>
		<option value='6CD emergency trolley'>6CD emergency trolley</option>
		<option value='RAD'>Radiology</option>
		<option value='2nd Fl Pharmacy'>2nd Fl Pharmacy</option>
    <option value='CCU'>CCU</option>
		<option value='6th Fl C Block'>6th Fl C Block</option>
    <option value='6th Fl D Block'>6th Fl D Block</option>
    <option value='Out Patient Services'>Out Patient Services</option>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"style="font-size:20px;font-weight:bold;color:red;"><strong>SNO Name</strong></th>
      ...
      <th width="14%"style="font-size:20px;font-weight:bold;color:red;"><strong>Unit Price</strong> 
      <th width="14%"style="font-size:20px;font-weight:bold;color:red;"><strong>Total Price</strong> 
...
$sel_query="Select * from medi_stock where location='$start' and status NOT IN ('Pending','Rejected') and add_qty>'0' ORDER BY g_name asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["sno"]; ?></td>
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["add_qty"]; ?></td>
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["batch_no"]; ?></td>
      <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["exdate"]; ?></td>
	  <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $row["location"]; ?></td>
...
$query0 = "SELECT * FROM medicine where code= '$cc_code'"; 
...
?>
    ...
    <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $c_price; ?></td>
    <td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $c_price*$row["add_qty"]; ?></td>
	  
	  
	  
    <?php 
    if($row['location']=='Pharmacy'){echo"
  <td align='left' ><a target='_blank' href='department_bar_phar.php?id=".$row['id']."'>bar_print</a></td>";}

  else {echo"
    <td align='left' ><a target='_blank' href='department_bar.php?id=".$row['id']."'>bar_print</a></td>";
  }
  ?>
  ...
  <a target='_blank' href='edit_medi_stock.php?id=".$row['id']."'>Edit</a>
  ...
  ";
    ...
    td colspan ="7" align="right"><a target='_blank' href="stock_excel_report_dept?location=<?php echo "$start"; ?>">Download In Excel</a></td>	
