...
$query4 = mysqli_query($db,"select * from alltest where pmrn='$pmrn' and billstatus='Billed' and rstatus!='RECEIVED' ");
...
$strSQL1 = "select DISTINCT MAX(s_no) from alltest where rdate='$cdate'";
			...
			echo $mno=$obj['MAX(s_no)']+1;
			echo '<br>'.$mno1=$obj['MAX(s_no)'];
...
if($mno>$mno1){
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		...
		if($number_of_digits==1){
				...
				$strSQL = "UPDATE alltest set rstatus='RECEIVED', status='RECEIVED', reby='$user', retime='$pdate' ,rdate='$pdate', barcode1='$new_bar1',s_no='$mno'";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."'";
			$objQuery = mysqli_query($objConnect,$strSQL);
				
				
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar1";
header("Location: $url"); 
			}
				...
				$strSQL = "UPDATE alltest set rstatus='RECEIVED', status='RECEIVED', reby='$user', retime='$pdate' ,rdate='$pdate', barcode1='$new_bar2',s_no='$mno'";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."'";
			$objQuery = mysqli_query($objConnect,$strSQL);
			
			
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar2";
header("Location: $url"); 
			}
			...
			$strSQL = "UPDATE alltest set rstatus='RECEIVED', status='RECEIVED', reby='$user', retime='$pdate' ,rdate='$pdate', barcode1='$new_bar3',s_no='$mno'";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."'";
			$objQuery = mysqli_query($objConnect,$strSQL);
			
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar3";
header("Location: $url"); 
			...
			$strSQL = "UPDATE alltest set rstatus='RECEIVED', status='RECEIVED', reby='$user', retime='$pdate' ,rdate='$pdate', barcode1='$new_bar4',s_no='$mno'";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."'";
			$objQuery = mysqli_query($objConnect,$strSQL);
				
				
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar4";
header("Location: $url"); 
			}
