...
$query43 = "SELECT COUNT(bfigure) FROM preadm where dname='$bt' and bfigure !='0' and ddrequest='settled' and  snew BETWEEN '$start' and '$end';"; 
...
$query498 = "SELECT bfigure, SUM(bfigure) FROM preadm where dname='$bt' and  bfigure !='0' and ddrequest='settled' and snew BETWEEN '$start' and '$end';";
...
<h1 align="center">Consultant wise Doriddro Fund Reports</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					...
					<tr>
						...
						<td colspan="3"><label><strong> Name Of The Consultant</strong></label></td> 
...
echo " BDT";
$count=1;
$sel_query="Select * from preadm where dname='$bt' and bfigure !='0' and ddrequest='settled'and snew BETWEEN '$start' and '$end';";
