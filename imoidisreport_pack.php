...
$plan = strip_tags($_REQUEST['plan']);
$dinves = strip_tags($_REQUEST['dinves']);
...
$ins_query="insert into idischarge1_pack (`dname`,`pname`,`pphone`,`pmrn`,`page`,`psex`,`discharge`,`ddia`,`surgery`,`ill`,`other`,`plan`, `ddate`,`eid`,`emo`,`dinves`,`refer`)
...
<tr><td colspan="20"><textarea id="exampleTextarea22" name="other" rows="5" placeholder="Advise on Discharge"></textarea></td>  </tr>	
<script>
...
<tr><td colspan="20"><label for="age"><strong>Follow Up Plan:(Can Write Both in Bangla & English)</strong></label>
