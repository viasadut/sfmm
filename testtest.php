...
$sel90="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu1' and `status`='Active';";
$result90 = mysqli_query($con,$sel90);

$sel91="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu2' and `status`='Active';";
$result91 = mysqli_query($con,$sel91);


$sel92="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu3' and `status`='Active';";
$result92 = mysqli_query($con,$sel92);


$sel93="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu4' and `status`='Active';";
$result93 = mysqli_query($con,$sel93);


$sel94="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu5' and `status`='Active';";
...
else if(!empty ($_POST['infu1'])){
$ins_query6="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
else if(!empty ($_POST['infu2'])){
$ins_query7="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
mysqli_query($con,$ins_query7);


}

if($res92=mysqli_num_rows($result92)>0)
{
echo '<script language="javascript">';
    echo 'alert("This Medicine is Already Added in Todays Order  !!"); ';
...
else if(!empty ($_POST['infu3'])){
$ins_query8="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
if($res93=mysqli_num_rows($result93)>0)
{
echo '<script language="javascript">';
    echo 'alert("This Medicine is Already Added in Todays Order  !!"); ';
...
else if(!empty ($_POST['infu4'])){
$ins_query9="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
else if(!empty ($_POST['infu5'])){
$ins_query10="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
...
<td colspan="6" align="center"><label><strong>Medication</strong></label></td> 
...
<td colspan="2" align="center"><label><strong>Caution</strong></label></td>
</tr>

<td colspan="6" align="center"><input list="rr" name="infu" size=60% class="form-control">
  <datalist id="rr">

						<option value=''>-Select Medicine</option>
				<?php 
			$sql76 = "select * from `medicine`";
...
<td colspan="5" align="center"><input list="rr10" name="root" size=60% class="form-control">
  <datalist id="rr10">
...
<td colspan="2" align="left"><input type="text" class="style" name="date" id="datepicker" placeholder="Select Date"  ></td>
			  <td colspan="2" align="left"><input type="radio" name="alert" value="" checked="checked"> Regular <br> <input type="radio" name="alert" value="H. Medi"> <b>High Alert Medication<b></td>

</tr>
<tr>
<td colspan="4" align="center"><label><strong>Time1</strong></label></td> 
<td colspan="4" align="center"><label><strong>Time2</strong></label></td>
<td colspan="4" align="center"><label><strong>Time3</strong></label></td>
<td colspan="4" align="center"><label><strong>Time4</strong></label></td>
<td colspan="4" align="center"><label><strong>Time5</strong></label></td></tr>
<tr>
<td colspan="4" align="center"><input list="rr1" name="infu1" size=60% class="form-control">
  <datalist id="rr1">
...
<td colspan="4" align="center"><input list="rr2" name="infu2" size=60% class="form-control">
  <datalist id="rr2">
<option value=''>-Select-</option>
						<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><input list="rr3" name="infu3" size=60% class="form-control">
  <datalist id="rr3">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><input list="rr4" name="infu4" size=60% class="form-control">
  <datalist id="rr4">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><input list="rr5" name="infu5" size=60% class="form-control">
  <datalist id="rr5">
<option value=''>-Select-</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
...
<tr><td colspan="20"align="right"><button type="submit" name="Submit">Confirm</button></td></tr>
	<tr>	<td colspan="20"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="addpharmedidoctor?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Medicine</a></strong>&nbsp;&nbsp;<a href="datewisemedi?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;</td>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `infusion` and `time` asc;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="imediupdate1?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
	  <td align="center" colspan="1"><a href="imediupdate?id=<?php echo $row["id"]; ?>">Stop ALL</a></td>
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="docinmeditomorrow?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&time=<?php echo $row["time"]; ?>&instruc=<?php echo $row["instruc"]; ?>&orderby=<?php echo $user; ?>&root=<?php echo $row["root"]; ?>&alert=<?php echo $row["alert"]; ?>">ADD For Tomorrow</a></td>

      </tr>
    <?php $count++; } ?>
	 <tr><td colspan="10"><a target='_blank' href="testpdf.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
