...
values ('$full', '$pm','$pn','$pa','$ps','$pp','$dreffer','$cdetails','$plaintext','$pd','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no','Updated By Technologist','$ineid','$emerid','$price','$date_d','$price_code','$critical')";
...
$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`report1`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`ac_no`,`status1`,`ineid`,`emerid`,`price`,`done_date`,`code`,`critical`) 
values ('$full', '$pm','$pn','$pa','$ps','$pp','$dreffer','$cdetails','$plaintext','$pd','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no','Confirmed By Consultant','$ineid','$emerid','$price','$date_d','$price_code','$critical')";
mysqli_query($con,$ins_query);
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="rad_report_new2.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname=<?php echo "$full"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
