...
$rr='24 Hours Urine Volume:'.$chikun1."<br />".'24 Hours Urine Chloride:'.$chikun2;

$rr1='24 Hours Urine Volume:'.$chikun1.' '.'mL'."<br />".'24 Hours Urine Chloride:'.$chikun2.' '.'mmol/24hrs';



$ins_query1="insert into 24urinechloride (`pname`,`pmrn`,`psex`,`page`,`uv`,`uc`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>24 Hours Urine Chloride Test Report:</strong></label>
	  ...
	  <label for="tibc"><strong>24 Hours Urine Chloride</strong></label>
