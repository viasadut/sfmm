...
$url = "endo_extra_charge.php?pmrn=$pmrn&eid=$eid";


$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$sel_p=mysqli_query($db,"SELECT COUNT(id) FROM endo_extra_charge WHERE `id`='$id3' and delete_status='1';");
$result_p = mysqli_fetch_assoc($sel_p);
$del_id=$result_p['COUNT(id)'];
if($del_id>0){


$query = "update endo_extra_charge set delete_status='1', delete_by='$user' WHERE id=$id3"; 
...
header("Location:endo_extra_charge.php?pmrn=$pmrn&eid=$eid");
