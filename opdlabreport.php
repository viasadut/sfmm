...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where  type in('lab','LAB','Lab') and status in ('Received','RECEIVED') and rdate between '$test' and '$apdate' and cby ='' and resultstatus ='Updated By Technologist' order by id desc;";
...
<td align="left"><?php echo $row["result"];?></td>		  
	  ...
	  <td align="center" colspan="1"><a target="_blank"
	  	  	  ...
	  	  	  <td colspan="1"><a target='_blank' href="<?php echo $row['report']?>?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>&sno=<?php echo 'O'.$row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
...
//$count=1;
$sel_query="Select * from endolab where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and odate between '$test3' and '$apdate' and resultstatus !='Confirmed By Consultant' order by `id` DESC;";
...
<td align="center"colspan="1"><a target='_blank' href="<?php echo $row['linkv']?>?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&e=<?php echo 'Y'; ?>">EDIT</a></td>
  	  
<td colspan="1"><a target='_blank' href="<?php echo $row['report']?>?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>&sno=<?php echo 'EN'.$row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
      </tr>
