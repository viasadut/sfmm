...
$rr='SODIUM:'.$sodium."<br />".'POTASSIUM:'.$potassium."<br />".'CHLORIDE:'.$chloride;

$rr1='SODIUM:'.$sodium.' '.'umol/L'."<br />".'POTASSIUM:'.$potassium.' '.'umol/L'."<br />".'CHLORIDE:'.$chloride.' '.'umol/L';

$ins_query1="update serumtbl set `s1`='$sodium',`p1`='$potassium',`c11`='$chloride',`eby`='$user',`etime`='$time' where sno='$sno'";
