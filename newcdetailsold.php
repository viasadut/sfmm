...
<head>
  <meta charset="UTF-8">
  <title>Patients History Update</title>
...
<label for="age"  size="20%"><strong>Patient's Vitals :</strong></label>
	        ...
	        <input name="pheight" type="text" size="3" placeholder="Height" value="" required/>
	        <input name="pweight" type="text" size="3" placeholder="Weight" value=""required/>
	        <input name="ptemp" type="text" size="3" placeholder="Temp" value=""required/>
	        <input name="ppluse" type="text" size="3" placeholder="Pluse" value=""required/>
	        <input name="pbp" type="text" size="3" placeholder="BP" value=""required/>
			<input name="spo2" type="text" size="3" placeholder="SPO2" value=""required/>
			<input name="rr" type="text" size="3" placeholder="RR" value=""required/>
	        
<label for="age"  size="20%"><strong>Patient's Past History :</strong></label><br>
<p>
 <b>Hypertension: &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="phyper" value="YES"required/> YES &nbsp;&nbsp;<input type="radio" name="phyper" value="NO"checked="checked"required/> NO &nbsp;&nbsp;
 <b>Heart Disease: <input type="radio" name="pheart" value="YES"required/> YES &nbsp;&nbsp;<input type="radio" name="pheart" value="NO"checked="checked"required/> NO &nbsp;&nbsp;
 <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DM: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="pdm" value="YES"required/> YES <input type="radio" name="pdm" value="NO"checked="checked"required/> NO <br><br>
 <b>Kidney Disease: &nbsp;<input type="radio" name="pkid" value="YES"required/> YES&nbsp;&nbsp;&nbsp;<input type="radio" name="pkid" value="NO"checked="checked"required/>&nbsp;&nbsp;NO &nbsp;
 <b>TB: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="ptb" value="YES"required/> YES &nbsp;&nbsp;&nbsp;<input type="radio" name="ptb" value="NO"checked="checked"required/> NO &nbsp;
 <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Asthma: &nbsp;&nbsp;<input type="radio" name="pasthma" value="YES"required/> YES <input type="radio" name="pasthma" value="NO"checked="checked"required/> NO <br><br>
 <b>Thyroid Disease: <input type="radio" name="pthyroid" value="YES"required/> YES &nbsp;&nbsp;<input type="radio" name="pthyroid" value="NO"checked="checked"required/> NO &nbsp;
 <b>Neuro Disorder: <input type="radio" name="pneuro" value="YES"required/> YES <input type="radio" name="pneuro" value="NO"checked="checked"required/> NO 
 <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Past Surgery: <input type="radio" name="psurgery" value="YES"required/> YES <input type="radio" name="psurgery" value="NO"checked="checked"required/> NO
<br><br><b>Liver Disease: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="liver" value="YES"required/> YES <input type="radio" name="liver" value="NO"checked="checked"required/> NO 
 </p>
<br><br>

<label for="age"  size="20%" ><strong color=pink>For Female :</strong></label><br><br>
 <b>Period: <input type="radio" name="pperiod" value="YES"required/> YES <input type="radio" name="pperiod" value="NO"checked="checked"required/> N/A &nbsp;&nbsp;&nbsp;
  <b>LMP- Date: <input type="text" name="plmp" value="N/A" required/>
  <br>
<br>
<input name="pnochild" type="text" size="10" value="N/A"/ placeholder="No Of Child"required/>
<input name="plchild" type="text" size="14" value="N/A"/ placeholder="Age Of Last Child"required/>
<input name="pmenopause" type="text" size="14" value="N/A" / placeholder="Menopause"required/> 
