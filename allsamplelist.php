...
$count=1;
$sel_query="Select * from covidopd where ssent='$adate' and status='collected'order by id asc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covidopdprint?id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="50" height="25" /></a> </td>
