...
$q9 = "SELECT * from conleavedetails where status Not in('Cancel','Rejected') and sid='$user' and '$sdate' between sdate and edate"; 
$re9 = mysqli_query($con, $q9) or die ( mysqli_error());
$r9 = mysqli_fetch_assoc($re9);

$q99 = "SELECT * from conleavedetails where status Not in('Cancel','Rejected') and sid='$user' and '$edate' between sdate and edate"; 
...
else if($tleave!='Annual Leave' && $rdoc!='No Replacement'){
