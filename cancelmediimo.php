...
session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('imo','nurse','doctor')"; 
...
{
return confirm("Are you Sure to Retrive The Medication ?");
}
...
<h1 align="center">Today's Cancelled Medication List</h1>
...
<td colspan="1" align="center"><strong>Caution</strong></td>
	  <td colspan="1" align="center"><strong>Cancel By</strong></td>
	  <td colspan="1" align="center"><strong>Cancel Time</strong></td>
	  <td colspan="1" align="center"><strong>Retrieve Medication</strong></td>
...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and odate ='$dd' and status='Cancel' order by infusion;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="imediupdate1_doc2?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo $user; ?>">Retrieve Medication</a></td>

      </tr>
    <?php $count++; } ?>
<tr><td colspan="20"><a target='_blank' href="testpdf1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&tdate=<?php echo "$dd";?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
