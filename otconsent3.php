...
$sel90="SELECT * FROM otconsent3 WHERE `pmrn`='$pmrn' and `eid`='$id' and `pro`='$pro';";
...
$ins_query="insert into otconsent3 (`pmrn`,`eid`,`pname`,`passno1`,`dname`,`padd`,`psex`,`spass`,`sdesig`,`tdate`,`pname1`,`pro`,`page`,`user`,`tdate1`,`wname`,`ward`,`bed`) values 
...
<!-- Form Title -->
		<h1>Consent For High Risk Cases</h1>
...
<td><a target='_blank' href="consentprint3.php?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"; ?>&pro=<?php echo "$pro"; ?>&dname=<?php echo "$dname"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
