...
<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','staff','mng','ot','endo','imo','mofficer','nurse','emergency','moopd','call','bill','billin','diet','physio','mrd','adminmng','outdoc','gpopd','vc')"; 
...
$query4 = mysqli_query($db,"select * from user where uname='$fullname'");
$data59 = mysqli_fetch_assoc($query4);
$pass=$data59['upass'];
...
$update212="update user set upass='$mname' where `uname`='$fullname'";
...
<!-- Form Title -->
		...
		<label for="age"><strong>Old Password :</strong></label>
		<input type="password"name="fname" type="text" size="70" value=""required  />
		<label for="age"><strong>New Password :</strong></label>
		<input type="password" name="mname" type="text" size="70" value=""required  />

		<label for="age"><strong>Re-Type New Password :</strong></label>
		<input type="password"name="peradd" type="text" size="70" value=""required  />
