...
$ins_query="update m_suite set proname1='$proname1', pnote='$pnote', diagnosis='$diagnosis', procharge='$procharge', ustatus='Updated',rstatus='DONE' where id='$id'";
...
<tr><td colspan="20"><input type="text" name="procharge" required value="<?php echo $row['procharge'];?>" /></td>  </tr>
<tr>
