...
$update212="update endopapp set pvno='$pvno',pvdate='$pvdate',chno='$chno' where `ID`='$id'";
...
<input type="text" name="pvdate" id="datepicker1" placeholder="MM/DD/YYYY" size="15" value="<?php echo $data444['pvdate'];?>" >
