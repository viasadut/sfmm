...
<div class="container">
    ...
    <form action="spd1upload1.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from echo where pmrn='$pmrn' and eid='$eid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="spd1pic/<?php echo $image['upload'] ?>">
                        <img class="img-responsive" alt="" src="spd1pic/<?php echo $image['upload'] ?>" />
