...
<tr>
      ...
      <td align="center"><strong>Doctor Code</strong></td>
      ...
      <td align="center"><strong>Date</strong></td>
	    ...
	    <?php 
                    $query = "Select * from pms_tb where acct_code='$acct_code' and date between '$start' and '$end' order by acct_code asc";
     ...
     <td align="center" ><?php echo $count; ?></td>
      ...
      <td align="center" ><?php echo $row["acct_code"]; ?></td>
      <td align="center" ><?php echo $row["trans_id"]; ?></td>
      <td align="center" ><?php echo $row["dcode"]; ?></td>
	  
		  <td align="center"><?php if($row["trans_type"]=='CR') {echo $row["amount"];} ?></td>
          <td align="center"><?php if($row["trans_type"]=='DR') {echo $row["amount"];} ?></td>
