...
$rr1='Anti TB IgM- :'.$chikun1."<br />".'Anti TB IgG:'.$chikun2;

$rr='Anti TB IgM- :'.$chikun1."<br />".'Anti TB IgG:'.$chikun2;
...
$ins_query1="insert into dengue (`pname`,`pmrn`,`psex`,`page`,`dengue1`,`dengue2`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Anti TB Test:</strong></label>
	  <label for="iron"><strong>Anti TB IgM</strong></label>
      <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="tibc"><strong>Anti TB IgG</strong></label>
