...
if($res990=mysqli_num_rows($result990)==0)
{
    ...
    echo '</script>';
		...
		$ins_query1="Update othoscharge1 set pdos='$pdos2',ins='$pp2',ndate='$ndate' where eid='$id' and pmrn='$pmrn' and medi='$medi1'";
...
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`ins`,`ndate`) values ('$pmrn','$pname','$medi1','$id','$date1','$pdos','$dcode','$pp1','$ndate')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
}
?>
<?php
