...
{
$url = "idocmediendo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "ddmanualbill1endodoc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "idocinfusionendo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "idocstretendo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "inassessmentnurseview1doc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "endodocnote?pmrn=$pmrn&ID=$ID";
header("Location: $url");
}
?>
...
$url = "endonursenotedoc?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
{
$url = "idocvisitendo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>

<?php
if(isset($_POST['Submit_dis']))
{
$url = "endo_discharge?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
<?php
if(isset($_POST['col_report']))
{
$url = "pic_upload?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
...
<?php
if(isset($_POST['col_report_pdf']))
{
$url = "pic_report_pdf?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
<?php
...
{
$url = "otcsendo?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>

<?php
if(isset($_POST['Submit1018']))
{
$url = "otcsendo1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "docadm?pmrn=$pmrn&eid=$eid&dname=$full";
header("Location: $url");
}
?>
...
<tr>
		...
		<td colspan="4" align="center"><button type="submit" name="Submit100">Procedure Note</button></td>
...
<td colspan="3" align="center"><button type="submit" name="Submit112">PAC</button></td>
<td colspan="3" align="center"><button type="submit" name="Submit">Intra Procedual Document</button></td>
<td colspan="3" align="center"><button type="submit" name="Submit999">Admission Request</button></td>

<td colspan="3" align="center"><button type="submit" name="Submit1011">Investigation Request</button></td>

<td colspan="3" align="center"><button type="submit" name="Submit101">Doctor Charges</button></td>
<td colspan="3" align="center"><button type="submit" name="Submit_dis">Discharge Report</button></td>
...
<td colspan="3" align="center"><button type="submit" name="col_report">Colposcopy Reporting</button></td>

<td colspan="3" align="center"><button type="submit" name="col_report_pdf">Colposcopy Report Print</button></td>
