...
$sel90="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu1' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result90 = mysqli_query($con,$sel90);

$sel91="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu2' and `status`='Active' and status1 in ('SEEN','Rupdated') ;";
$result91 = mysqli_query($con,$sel91);


$sel92="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu3' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result92 = mysqli_query($con,$sel92);


$sel93="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu4' and `status`='Active' and status1 in ('SEEN','Rupdated');";
$result93 = mysqli_query($con,$sel93);


$sel94="SELECT * FROM imedi2 WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate1' and `time`='$infu5' and `status`='Active' and status1 in ('SEEN','Rupdated');";
...
$ins_query6="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`) values ('$pmrn','$dname','$eid','$infu','$infu1','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu')";
mysqli_query($con,$ins_query6);}

if(!empty ($_POST['infu2'])){
$ins_query7="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu')";
mysqli_query($con,$ins_query7);}

if(!empty ($_POST['infu3'])){
$ins_query8="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu')";
mysqli_query($con,$ins_query8);}

if(!empty ($_POST['infu4'])){
$ins_query9="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu')";
mysqli_query($con,$ins_query9);}

if(!empty ($_POST['infu5'])){
$ins_query10="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$dilu')";
...
echo '<script language="javascript">';
    ...
    echo '</script>';
			...
			{
			$strSQL = "insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$ortime','$dilu')";
			...
			{
			$strSQL = "insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`reuse`) values 
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="4" align="center"><select list="rr3" name="infu3"  class="form-control">
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="4" align="center"><select list="rr4" name="infu4"  class="form-control">
...
<option value='SOS'>SOS</option>
			  ...
			  <td colspan="4" align="center"><select list="rr5" name="infu5" class="form-control">
...
$count=1;
$sel_query="Select * from estat where pmrn= '$pmrn' and eid='$eeid'  order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="5"><span style="color:red;text-align:center;"><b><?php echo $row["infusion"]; ?><b></span></td>
	        <td align="center"colspan="5"><?php echo $row["room"]; ?></td>
			<td align="center"colspan="5"><?php echo $row["dtime"]; ?></td>  
...
<tr><td colspan="10"><a target='_blank' href="testpdf.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
	 <td colspan="10"><a target='_blank' href="testpdfserved.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="sprint.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
<?php
mysql_close($objConnect);
?>
