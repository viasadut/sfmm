...
//$id =$_GET['id'];
$count=1;
$sel_query="SELECT * from phar_sale  where code='".$cc."' and adate between '$sd' and '$ed' and location in ('IPD','DISCHARGE') and status!='Cancel'";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"style="font-size:18px;font-weight:bold;color:green;"><?php echo $row["qty"]; ?></td>
	  <td align="center"style="font-size:18px;font-weight:bold;color:green;"><?php echo $row["adate"]; ?></td>
