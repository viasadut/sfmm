<?php 
    ...
    if(!isset($_SESSION['sess_username']) || $role!="covid"){
...
{
//echo $sqlfrom ." <br>";
$query = "INSERT INTO covidserial (sno, date,status) VALUES ('$d-$i', '$date','Vacant')"; 

$result39 = mysqli_query($con, $query) or die(mysqli_error());
//$sno++;
