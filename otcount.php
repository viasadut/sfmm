...
$query3 = "SELECT * FROM otcount where pmrn= '$pmrn' and eid='$id' and date='$date1' and medi='$medi1'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM otcount where pmrn= '$pmrn' and eid='$id' and date='$date1'and medi='$medi1'"; 
...
if($res990=mysqli_num_rows($result990)==0)
{
    ...
    echo '</script>';
		...
		$ins_query1="Update otcount set pdos='$pdos2' where eid='$id' and pmrn='$pmrn' and medi='$medi1'";
...
$ins_query1="insert into otcount (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`c1by`,`c1time`) values ('$pmrn','$pname','$medi1','$id','$date1','$pdos','$dcode','$user','$time')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
}
?>
<?php
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>OT COUNT LOG</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from otcount where pmrn= '$pmrn' and eid='$id'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="otcountdelete?id1=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&pdos=<?php echo $row['pdos']; ?>&id=<?php echo $id; ?>"><b>Delete<b></a></td>
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Count Back</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
     
      <td colspan="3" align="center"><strong>MRN</strong></td>
     	  <td colspan="8" align="center"><strong>ITEM</strong></td>
      	  <td colspan="2" align="center"><strong>1st Count</strong></td>
		  <td colspan="2" align="center"><strong>ADD Qty Same as 1st count</strong></td>
		<td colspan="2" align="center"><strong>Edit qty to add in 2nd count</strong></td>
		  <td colspan="2" align="center"><strong>2nd Count</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="3"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="8"><?php echo $row["medi"]; ?></td>
				        <td align="center"colspan="2"bgcolor='red'><b><?php echo $row["pdos"]; ?><b></td>
				
<td align="center" colspan="2"><a href="otcountadd?id1=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&pdos=<?php echo $row['pdos']; ?>&id=<?php echo $id; ?>"><b>ADD<b></a></td>
...
<td align="center"colspan="2"><input type="button" name="edit" value="Edit" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs edit_data" /></td>  		  	  
				<td align="center"colspan="2" bgcolor='red'><b><?php echo $row["qty"]; ?><b></td>
