...
$pmrn=$_REQUEST['pmrn'];
$eid=$_REQUEST['eid'];
$query43 = "SELECT COUNT(pmrn) FROM e_gallery where pmrn= '$pmrn' and eid='$eid';"; 
...
<html>
<head>
    <title>A&E Picture Upload</title>
...
<div class="container">
    ...
    <form action="aeupload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from e_gallery where pmrn='$pmrn' and eid='$eid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="aepic/<?php echo $image['image'] ?>">
                        <img class="img-responsive" alt="" src="aepic/<?php echo $image['image'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['image'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="ae_delete.php" method="POST">
