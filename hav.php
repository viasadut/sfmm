...
$ins_query1="insert into hav (`pname`,`pmrn`,`psex`,`page`,`result`,`opinion`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`inter`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$user','$adate','$eid','$iname','$id','$sno','$chikun3')";
...
<!-- Form Title -->
	  ...
	  <label for="iron"><strong>Result</strong></label>
