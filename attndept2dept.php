...
<?php
	$stmt = $DB_con->prepare("SELECT * FROM staff3 where hos='$sid11' or incharge='$sid11' and status='Active'");
	$stmt->execute();
...
if (($_POST['staff'])=="All"){
$sel_query="Select * from tm3 where hos='$sid11' and date1 between '$start' and '$end' order by uid asc";}
