...
$count=1;
$sel_query="Select * from inpatient where pmrn= '$pmrn' and idisconfirm!='Confirmed';";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="ot1nursetest?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
