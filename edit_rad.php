...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('rad','doctor','staff')"; 
...
$query44 = "SELECT COUNT(iname) FROM radio where type= 'rad';"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="15%"><strong>Price</strong>
...
$sel_query="Select * from radio where type='rad' and status !='Deactive'";}
...
$sel_query="Select * from radio where subtype='$bt' and status !='Deactive';";
}
$count=1;
...
{ ?>    <tr>
	  ...
	  <td align="center" ><a target='_blank' href="edit_inves_price_rad?id=<?php echo $row["id"]; ?>">Edit</a></td>
      </tr>
