...
<form action="ccviewsp11" method="Post">
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $bt;?> </td> 
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="ccviewsp112?dname=<?php echo $row["dname"]; ?>&ddate=<?php echo '$date';?>">Details</a> </td>
