...
$query43 = "SELECT COUNT(pmrn) FROM dialysispapp where pmrn= '$pmrn';"; 
...
$query22 = "SELECT * from friskdialysis where pmrn='$pmrn' and eid='$eid'"; 
$result22 = mysqli_query($con, $query22) or die ( mysqli_error());
$row4 = mysqli_fetch_assoc($result22);
...
$update="update nurseassessdialysis set cname='$cname',crelation='$crelation',cphone='$cphone', astime='$astime', ma='$ma', acc='$acc', shistory='$shistory', language='$language', nip='$nip', edus='$edus', comor='$comor', valueableb='$valueableb', bodys='$bodys', du='$du', remarks='$remarks' where eid='$eid' and pmrn='$pmrn'";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessmentnursedia?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="nursesassessedit_dia?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
...
<td colspan="5"><input type="text" name="cpatient" value="<?php echo $row3['cpatient'];?>"></td>
<td colspan="5"><input type="text" name="csite" value="<?php echo $row3['csite'];?>"></td>
<td colspan="5"><input type="text" name="cposition" value="<?php echo $row3['cposition'];?>"></td>
<td colspan="5"><input type="text" name="ctaken" value="<?php echo $row3['ctaken'];?>"></td>
...
<td colspan="5" bgcolor="#00CCCC"><label><strong>Fall Riskk Assessment Score:</strong></label><?php echo $row4['fscore'];?></td>

<td colspan="10"><a target='_blank' href="nurseassessmentdialysisprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>		</tr>
