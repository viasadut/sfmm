...
$ins_query1="insert into antihev (`pname`,`pmrn`,`psex`,`page`,`pvalue`,`cvalue`,`inter`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>ANTI HEV Report:</strong></label>
