...
function Header()
{
    ...
    $this->Cell(0,6,' Emergency Investigation Request Form',0,1,'C');
...
$dd=date('m/d/Y');
$dd1=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from einves where pmrn='$pmrn' and eid='$eid' " );
...
$pdf->Cell('75',5,$data3['fullname'],0,0,'L');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from einves where pmrn='$pmrn' and eid='$eid' and type='lab' and odate1='$dd'",$prop);
$pdf->Output();
?>