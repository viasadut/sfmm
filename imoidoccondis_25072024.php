...
$url3 = "death2_edit?pmrn=$pmrn&eid=$eid";
      ...
      <td align="center"><b><?php if($res90==0 and $d_type!='Confirm Death Declaration Request'){echo "<a href='$url'>Prepare Discharge Note</a>";} else if($res90>0 and $d_type!='Confirm Death Declaration Request'){echo "<a href='$url1'>Edit Discharge Note</a>";} else if($res91==0 and $d_type=='Confirm Death Declaration Request'){echo "<a href='$url2'> Prepare Death Certificate</a>";}else if($res91>0 and $d_type=='Confirm Death Declaration Request'){echo "<a href='$url3'> Edit Death Certificate</a>";} ?></td>


<td align="center"><b><?php echo $row["dconfirm"]; ?></td>	  
	  <td align="center" colspan="1"><a onclick="return confirm_click1();" href="dconfirmimo?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Confirm BY </a>(<b><?php echo $row["confirmdn"]; ?></b>)  </td>	  
...
$url2 = "deathprint1?pmrn=$pmrn&eid=$eid";
	  ...
	  <td align="center"><b><?php if($res90==0 and $d_type!='Confirm Death Declaration Request'){echo "Discharge Note Not Prepared";} else if($res90>0 and $d_type!='Confirm Death Declaration Request'){echo "<a target='_blank'href='idisreport?pmrn=".$pmrn."&eid=".$eid."'><img src='dis_pic.png' title='Print Report' width='100' height='60'></a>";} else if($res91==0 and $d_type=='Confirm Death Declaration Request'){echo "Death Certificate Not Prepared";}else if($res91>0 and $d_type=='Confirm Death Declaration Request'){echo "<a href='$url2'><img src='death_pic.png' title='Print Report' width='100' height='60'></a>";} ?></td>
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idisupdate1?eid=<?php echo $row1["eid"]; ?>&pmrn=<?php echo $row1["pmrn"]; ?>&room1=<?php echo "$room1"; ?>&room=<?php echo "$room"; ?>&vc=<?php echo "$vc"; ?>&vc1=<?php echo "$vc1"; ?>&ac=<?php echo "$ac"; ?>&user=<?php echo "$fullname"; ?>">ds</a></td>
