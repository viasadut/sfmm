...
$query198 = "SELECT sid, SUM(tdays) FROM conleavedetails where sid='$user' and tleave='Annual Leave' and status IN ('Approval Pending','Approved By Replacement Consultant','Approved By MD') GROUP BY sid"; 
...
echo $diff->format("%d");*/
$al=$cl+$fday+$tttdays-$altaken;
$al2=$cl+$fday8+$tttdays-$altaken;
...
if($tleave=='Annual Leave' && $rdoc!='No Replacement' && $diff1<=$al ){
	
	
	$ins_query1="insert into conleavedetails (`sid`,`tleave`,`tdays`,`sdate`,`edate`,`reason`,`md`,`ceo`,`status`,`rdoc`,`sname`,`lseen`,`eid`) values ('$user','$tleave','$diff1','$sdate','$edate','$reason','Dr. Razeeb Hassan','Mohd Taufik Bin Ismail','Approval Pending','$rdoc','$full','NOT SEEN','$eid')";
...
else if($tleave=='Annual Leave' && $rdoc=='No Replacement' && $diff1<=$al){
	
	
	$ins_query1="insert into conleavedetails (`sid`,`tleave`,`tdays`,`sdate`,`edate`,`reason`,`md`,`ceo`,`status`,`rdoc`,`sname`,`lseen`,`eid`) values ('$user','$tleave','$diff1','$sdate','$edate','$reason','Dr. Razeeb Hassan','Mohd Taufik Bin Ismail','Approved By Replacement Consultant','$rdoc','$full','RSEEN','$eid')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
else if($tleave=='Other Leave' && $rdoc!='No Replacement'){
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>
						...
						<td colspan="3"><label><strong>Annual Leave Taken-  <?php echo 30-$al;?> DAY(S)</strong></label></td>
						<td colspan="3"><label><strong>Pending Leave Request-  <?php echo $tttdays;?> DAY(S)</strong></label></td>
