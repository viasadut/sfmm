...
//$id =$_GET['id'];
$count=1;
$sel_query="Select distinct rfid,req_loc from medi_stock1 where status='Returned' order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="phar_stock_receive1?rfid=<?php echo $row["rfid"]; ?>&req_loc=<?php echo $row["req_loc"]; ?>">UPDATE</a></td>
