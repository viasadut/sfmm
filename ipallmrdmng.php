<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','ddf','corona','doctor','moopd','ddf1','staff','imo','nurse','mofficer','physio','techbio','endo','rad','outdoc')"; 
...
$query5 = mysqli_query($db,"select * from ipres where pmrn='$pmrn' and eid='$eid'");
...
<!-- Form Title -->
		...
		<a target="_blank" href="imoedocvitals.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>">BP</a> <a target="_blank" href="g_chart_bp.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>"><span style="font-size:14px;color:red;background:lightgreen;"><b>(BP Graph)</b></span></a>
		<a target="_blank" href="imoedocvitals.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>">Pulse</a> <a target="_blank" href="g_chart_pulse.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>"><span style="font-size:14px;color:red;background:lightgreen;"><b>(Pulse Graph)</b></span></a>
		<a target="_blank" href="indmdoc.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>">Saturation:</a><a target="_blank" href="saturation_chart.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>"><span style="font-size:14px;color:red;background:lightgreen;"><b>(Saturation Graph)</b></span></a>
		<a target="_blank" href="influiddoc.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>">RR Chart:</a><a target="_blank" href="rr_chart.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>"><span style="font-size:14px;color:red;background:lightgreen;"><b>(RR Graph)</b></span></a>
		<a target="_blank" href="influiddoc.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>">Fluid Chart:</a><a target="_blank" href="g_chart_fluid.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>"><span style="font-size:14px;color:red;background:lightgreen;"><b>(Fluid Graph)</b></span></a>
		<br>

		<a target='_blank' href="docassessprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Doctor's Assessment</a>&nbsp;&nbsp;
<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>"><b>ALL Reports<b></a></td></tr>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row100["user"]; ?></td>	  
...
$count=1;
$sel_query101="Select * from icnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query102="Select * from inprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query103="Select * from idprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and pstatus='Served' order by `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><a href="addpharmediimodetails?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&infu=<?php echo $row['infusion'];?>"><?php echo $row["infusion"]; ?></a></td>
...
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from idisposible where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from iequipment where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from ivisit where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
...
{ ?>    <tr>
	...
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Consultant's Procedure Charge Form</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Done By</strong></td>
...
$count=1;
$sel_query="Select * from iprocedure where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
