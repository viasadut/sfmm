...
$ins_query="insert into einfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu')";
...
<td colspan="20" align="center"><label><strong>Infusion</strong></label></td> 
</tr>
<tr>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from einfusion where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
