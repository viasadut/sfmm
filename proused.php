...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from prohoscharge where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
...
$pdf->MultiCell('182' , 5,$data1['medi'].' - '.$data1['pdos'].' Pcs'.' - '.$data1['price'],0,1);
...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from promediused where pmrn='$pmrn' and dname='$dname'  and eid='$eid'");
...
$pdf->MultiCell('182' , 5,'Price: '.$data1['price'],0,1);
$pdf->ln(1);
}
//$pdf->Cell('92' , 5,'Dosages',1,1,'C');
