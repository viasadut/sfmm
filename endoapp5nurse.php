...
?>" size ="57" readonly>
	  ...
	  <select name="psex" class="style1" required> 
      ...
      <input name="pmrn" type="text" size="15"Placeholder="MRN" class="style1" value=""required>
      <input name="pphone" type="text" size="13" Placeholder="Phone NO" class="style1"value=""required>	  
	  <input name="page" type="text" size="5"Placeholder="AGE" class="style1" value="" required>
