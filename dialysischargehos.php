...
$sel9=mysqli_query($db,"SELECT * FROM dialysispapp WHERE `ID`='$id'");
...
$ins_query1="insert into dialysishoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`) values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode')";
...
$count=1;
$sel_query="Select * from dialysishoscharge where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="dialysishosdelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&id1=<?php echo "$id"; ?>">DELETE</a></td>
