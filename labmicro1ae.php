...
$update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='DONE',critical='$critical' where id='$id'";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
      ...
      <td align="center"><a onclick="return confirm_click1();" href="micro_delete_ae?id=<?php echo $row1['id']; ?>&eid=<?php echo $eid; ?>&pmrn=<?php echo $pmrn; ?>&id1=<?php echo $id; ?>"><strong>Delete</strong></a></td>
...
<td align="center"><a onclick="return confirm_click();" href="labmicroconfirm2?id=<?php echo $id; ?>"><strong>Complete Report</strong></a></td>
  </tbody>
</table>
</form>
