...
$strSQL = "Select * from staff1 where astatus='Active' and ugroup='Doctor' order by mname asc";
...
?>
  ...
  <tbody>
      ...
      <td align="center"><a  target='_blank' href="leaveviewindimng?sid=<?php echo $row["sid"]; ?>"><?php echo $row["sid"];?></a></td>
      <td align="center"><a  target='_blank' href="leaveviewindimng?sid=<?php echo $row["sid"]; ?>"><?php echo $row["mname"]; ?>
