...
<body>
	...
	<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;" >
		<tr>
			...
			<a target="_blank" href="event_cal/calender_view"><img src="event_cal/cal_view.png" title="Update Calendar" width="100" height="70" /></a></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" align="center"><a style="color:red;font-weight:bold;font-size:18px;" href="otallbookingdoc1mng"><font size="4.5">Today's OT List</a></td>
			<td colspan="2" align="center"><a style="color:red;font-weight:bold;font-size:18px;" href="otallbookingdoc1mng_to"><font size="4.5">Tomorrow's OT List</a></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3"align="center"><a href="rfid/nurse/inpatient/medication_new_receive"><font size="4.5">Receive Medication</a></td>
				...
				<td colspan="2"align="center"><a href="rfid/nurse/inpatient/discard_medi"><font size="4.5">Discard Medicine(Patient)</a></td>
				<td colspan="2"align="center"><a href="dispose_medicine_nurse"><font style="size:4.5; color:red;font-weight:bold;">Discard Medicine(Department)</font></a></td>
	...
	<td colspan="3"align="center"><a href="phar_transfer_ipd?sno=<?php echo $runningTime;?>"><font size="4.5">Request For Stock</td>	
	<td colspan="3"align="center"><a href='rfid/transaction/transfer'><span>RFID Transfer</span></a>        </td>
	<td colspan="3"align="center"><a href='ipd_medi_stat'><span>Used Stock Medicine Stats</span></a>        </td>
	<td colspan="3"align="center"><a href='ipd_return_phar?sno=<?php echo date('mdsYi');?>'><span>Return Stock Medicine</span></a>        </td>
	
	<tr><td colspan="5"align="center"><a href="attnstatsindu"><font size="4.5">Datewise Attendance</td>
	<td colspan="5"align="center"><a href="roaster_home_indu"><font size="4.5">Staff's Roster</a></td>
	<td colspan="3"align="center"><a href="oes1/index"><span><font size="5.5" color="green" font-weight="bold">Online Exam Module</span></a></td>
	
	<td colspan="3" align="center"><a href="tender/equipment/asset_management"><font size="4.5">New(RFID)</a></td>
	<td colspan="3" align="center"><a href="asset_search_new"><font size="4.5">Search By(RFID)</a></td>
<td colspan="3"align="center"><a href="consent_patient"><span><font size="5.5" color="green" font-weight="bold">Upload Consent Forms</span></a></td>
		...
		<tr>
		<td colspan="5"align="center"><a href="rfid/nurse/inpatient/medication_new_return_nurse_1"><font size="5" color="green">View Return Medication List</a></td>
		...
		<?php 
				if($cat!='HOD' or $cat!='Incharge'){
					echo'
					<td colspan="5"align="left"><a href="purchase_transfer_ot?sno='.$runningTime1.'"><font size="5" color="green">Request For Material(Store)</td>
	<td colspan="3"align="left"><a href="view_material_request_indu"><font size="5" color="green">View Material Request</td>
		...
		<?php 
				if($cat=='HOD' or $cat=='Incharge'){
					echo'<tr>
						<td colspan="5" align="center"><a href="mrequest"><font size="4.5">Material Request</a></td>
						<td colspan="5" align="center"><a href="bio_list_nurse"><font size="4.5">Asset List</a></td>		
						<td colspan="3" align="center"><a href="dmaterialstore"><font size="4.5">Add Hospital Asset</a></td>		
						<td colspan="3" align="center"><a href="bededit_nurse"><font size="4.5">Bed Management</a></td>	
						
							<td colspan="2"align="center"><a href="recruit/manpower_requisition"><font size="4.5">Recruitment</a></td>	
							<td colspan="2"align="center"><a href="roaster_home"><font size="4.5">Set Departmental Roster</a></td>
						</tr>
						<tr>
						<td colspan="5" align="center"><a href="tender/equipment/asset_management"><font size="4.5">New(RFID)</a></td>
	<td colspan="5" align="left"><a href="asset_search_new"><font size="4.5">Search By(RFID)</a></td>
	<td colspan="3"align="left"><a href="purchase_transfer_ot?sno='.$runningTime1.'"><font size="5" color="green">Request For Stock(Store)</td>
	<td colspan="3"align="left"><a href="view_material_request_indu"><font size="5" color="green">View Material Request</td>
</tr>
					';
				}
