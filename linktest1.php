...
<form action="linktest1" method="POST">
...
$count=1;
$sel_query="Select * from presnew where pmrn= '$pmrn' and dname='$full' order by ID desc;";
...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="p5new?pmrn=<?php echo "$pmrn"; ?>&date=<?php echo "$date"?>&dname=<?php echo "$full"?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="50" height="20" /></a></td>
<td align="center"><a target='_blank' href="http://192.168.100.254?pmrn=<?php echo "$pmrn"; ?>"><b>LINK<b></a></td>
