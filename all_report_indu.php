...
<body>
	...
	<p>
		<div1><input style="background-color: lightgreen;" type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by Investigation Name" title="Type in a Discipline">
		</div1>
	...
	<table width="100%" height="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;" id="myTable">
		<a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo $row["pmrn"]; ?>">
			...
			<tr>
				<td colspan="20" bgcolor="lightbrown" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold;color:red;"><b>PATIENTS OPD RECORD<b> </td>
			</tr>
			...
			<tbody>
				...
				while ($row = mysqli_fetch_assoc($result)) { ?> <tr>
						...
						<td>
							...
							<?php if ($type == 'rad' or $type == 'RAD' or $type == 'Rad' and $tt == '192.168.100.252:8081') {
...
<input type="submit" name="Submit90" value="PACS VIEW" align="right"></input>
							...
							} else if ($type == 'rad' or $type == 'RAD' or $type == 'Rad' and $tt != '192.168.100.252:8081') {
...
<input type="submit" name="Submit90" value="PACS VIEW" align="right"></input>
			...
			<tr>
				<td colspan="20" bgcolor="skyblue" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold;color:red;"><b>PATIENTS IPD RECORD<b> </td>
			</tr>
			...
			<tr>
				...
				<th width="14%"><strong>Zone ok</strong>
...
<input type="submit" name="Submit90" value="PACS VIEW" align="right"></input>
			...
			<tr>
				<td colspan="20" bgcolor="lightgreen" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold;color:red;"><b>PATIENTS EMERGENCY RECORD<b> </td>
			</tr>
