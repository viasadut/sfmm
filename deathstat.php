...
<h1 align="center">Number of Death Case Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Certificate</strong></th>
...
<td align="center"><a target='_blank' href="deathstatdetails?pmrn=<?php echo $row['pmrn']; ?>"><b>Details<b></a></td>	  

<td align="center"><a target='_blank' href="deathprint.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row['pmrn']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
