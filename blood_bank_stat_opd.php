...
$count=1;
$sel_query="Select * from alltest where medi='$inves' and date1 between '$start' and '$end' and rstatus='RECEIVED' order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td><?php
		...
		$dname5=$row["dname"];
		$ac_no=$row["id"];
		$url = "$report5?pmrn=$pmrn5&eid=$eid5&id=$id5&sno=$sno"; 
