...
$query43 = "SELECT COUNT(dname) FROM presnew where dname= '$bt' and date1 BETWEEN '$start' and '$end' and dstatus='SEEN';"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th ><strong>Patient Phone</strong>   
      <th ><strong>Doctor's Name</strong>
      
	  
	  <th ><strong>Diagnosis</strong>
...
$sel_query="Select * from presnew where  date1 BETWEEN '$start' and '$end' and dstatus='SEEN'";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from presnew where dname='$bt' and date1 BETWEEN '$start' and '$end' and dstatus='SEEN' ";
 } 
$count=1;
