...
$sel_query="Select * from con_work where status='Pending' and loc='OPD Procedure' ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	 ...
	 <td align="center" style="background-color:lightbllue;font-size:22px;font-weight:bold"><a href="procedure1opd_work?pmrn=<?php echo $row['pmrn']; ?>&id=<?php echo $row["id"]; ?>">RECEIVE PATIENT</a> </td>
