...
$query44 = "SELECT COUNT(dname) FROM presnew where date1 BETWEEN '$start' and '$end' ;"; 
...
$sel_query="Select * from presnew where  date1 BETWEEN '$start' and '$end' ";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
$pmrn=$row['pmrn'];
$eid=$row['eid'];
$queryz = "SELECT * from pappnew where pmrn='$pmrn' and eid='$eid'"; 
...
?>	  
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row1["vtime"];?> </td>
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row1["stime"];?> </td>
	  <td align="center"><?php echo $row["dstatus"]; ?>  
