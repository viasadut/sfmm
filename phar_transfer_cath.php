...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','cath')"; 
...
$url = "phar_transfer_cath?sno=$sno";
header("Location: $url"); 
...
<input type="text" id="dept" class="form-control action" list="ddd" autocomplete="off" name='dept' required style="font-weight: bold;font-size:22px;color:green" value="<?php echo 'Cathlab';?>" readonly>
