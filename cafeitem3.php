...
$query3 = "SELECT * FROM cafesale where sid= '$sid' and ename='$ename'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM cafesale where sid= '$sid' and ename='$ename'"; 
...
if($eeqty<$pdos2)
{
    ...
    echo '</script>';
		...
		$ins_query1="Update cafesale set eqty='$pdos2',tprice='$tprice1',ptype='CASH',stime='$stime' where sid='$sid' and ename='$ename'";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query2="Update storecafe set eqty='$ueqty1' where ename='$ename'";
...
$test4=	$result498['SUM(tprice)'];?>
	...
	<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Cost For The Selected Investigation Will Be:<?php echo $test4;?> (BDT)</strong></td></tr>
	<tr><td align="right" colspan="20"><button onclick="self.close()">Close</button></td></tr>
	<tr><td colspan="10"><a target='_blank' href="p5new0.php?sid=<?php echo "$sid"; ?>&sdate=<?php echo "$sdate"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>	
</table>
</form>
