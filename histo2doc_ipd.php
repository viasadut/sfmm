...
$update33="insert into  histo (`cinfo`,`spe`,`gdes`,`mdes`,`dia`,`status`,`dname1`,`rtime`,`rdate`,`hno`,`dname`,`date`,`time`,`pmrn`,`pname`,`page`,`psex`,`cstatus`,`ruby`,`rutime`,`date1`,`eid`,`sno`,`eeid`) values 
('$cinfo','$spe','$gdes','$mdes','$dia','REPORT DONE','$full','$time','$date1','$hno','$dname5','$daten','$time','$pmrn','$pname','$page','$psex','Waiting For Consultant Confirmation','$full','$udate','$date_n','$count1','$sno','$eeid')";
