...
$update2="update massess set shistory='$shistory', ccom='$ccom',pill='$pill',gexam='$gexam',abdomen='$abdomen',res='$resp',car='$car',nsys='$nsys',ent='$ent',breast='$breast',gen='$gen',mus='$mus',ex='$ex',uro='$uro',func='$func',diag='$diag',mplan='$mplan',dplan='$dplan' where `pmrn`='$pmrn' and eid='$eid'";
