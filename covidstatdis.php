...
$query44 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and district='$bt' and status='collected'"; 
...
<option value='ALL'>ALL</option>
					<?php 
			$sql = "Select DISTINCT district  from covidopd;";
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and status='collected' order by ssent desc;";}
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and district='$bt' and status='collected' order by ssent desc;";}
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covid1opd1?id=<?php echo $row["id"]; ?>">Edit</a> </td>
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covid1opd2?id=<?php echo $row["id"]; ?>">Add New Record</a> </td>
      </tr>
