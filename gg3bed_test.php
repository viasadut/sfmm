...
$p_a = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and eid='$eid'");
$p_a1 = mysqli_fetch_assoc($p_a);
...
$query_bed1 = mysqli_query($db,"select * from newbed where type='$psex' and bno='$ptemp' and pmrn='$pmrn' and eid='$eid'");
...
if($ptemp!=$bno and $btype=='ICU(4TH FL)' or $btype=='ICU(C)' or $btype=='ICU(3RD FL)' or $btype=='HDU(3RD FL)' or $btype=='HDU(4TH FL)'){
$ins_query1="insert into newbed (`dname`,`pname`,`pmrn`,`adate`,`type`,`bno`,`eid`,`adate1`,`adatenew`,`tby`) values ('$dname', '$pname','$pmrn','$adate','$btype','$bno','$eid','$adate1','$adatenew','$user')";
...
$ins_query2="insert into bed_mang (`bno`,`c_request_by`,`c_request_time`,`problem`,`status`) values('$bno','$user','$adate','Under Housekeeping','Under Housekeeping')";
mysqli_query($con,$ins_query2) or die(mysql_error());

$update2_n="update newbed set adatenew1='$adatenew',tby1='$user',charge='$fday',tdays='$fday_t',b_charge='$b_charge1' where type='$psex' and bno='$ptemp' and pmrn='$pmrn' and eid='$eid'";
...
('$pmrn','$eid','$pname','$padd','$page','$adm','$pgender','$pphone','$odate','$dd','$adoc','$btype','$bno','Followup Visit','$sid','$ndate','Active','$user','Regular Visit','Continuous')";
