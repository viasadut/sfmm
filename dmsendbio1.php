...
$ins_query1="Update asset_new set solvetime='$adate1',btime='$stime',sendto='$sendto',bioby='$user',bremarks='$fremarks',estatus='$estatus',status='$estatus' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());


$ins_query2="insert into store1 (`ename`,`eid`,`elocation`,`etype`,`eqty`,`estatus`,`bremarks`,`solvetime`,`btime`,`sendto`,`bioby`) values 
('$ename','$eid','$elocation','$etype','','$estatus','$fremarks','$adate1','$stime','$sendto','$user')";
...
<!-- Form Title -->
	 ...
	 <input name="elocation" type="text" size="80"  style="text-transform:uppercase"value="<?php echo $data['dept'];?>" required  readonly>
