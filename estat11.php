...
$query45 = mysqli_query($db,"select * from estat where pmrn='$pmrn' and id='$id'");
...
$update="update estat set dtime='$dtime',status='Rupdated', udone='$user' where `id`='$id'";
...
<td colspan="12" align="center"><label><strong>Infusion</strong></label></td> 
...
<td colspan="12" align="center"><input type="text" name="infu" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
