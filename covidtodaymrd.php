...
$count=1;
$sel_query="Select * from covidopd where ssent='$adate' and status='collected' and tp='Foreign_Passenger' order by id asc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covidfmrd?id=<?php echo $row["id"]; ?>">Details</a> </td>
