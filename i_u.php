...
<tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr>
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Infusion</strong>
	  
	  <th width="14%"><strong>Special</strong>
	  <th width="14%"><strong>Careshope</strong>
	  <th width="14%"><strong>Return Medi</strong>
	  <th width="14%"><strong>Return Infu</strong>
...
$pmrn1=$row['pmrn'];
$eid1=$row['eid'];
//$sel90="Select * from imedi2 where pmrn= $pmrn1 and odate='$dd';";
//$result90 = mysqli_query($con,$sel90);
//$row3 = mysqli_fetch_assoc($result90);

$query43 = "SELECT COUNT(pstatus) FROM imedi2 where pmrn= '$pmrn1' and odate='$dd' and pstatus='Ordered' and status !='Cancel';"; 
...
$query445d = "SELECT COUNT(medi) FROM idismedi where pmrn= '$pmrn1' and eid='$eid1';"; 
...
?>
	  ...
	  <td align="center" <?php if($count56>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><a href="infusionphar_new?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Infu</a></td>
...
<td align="center"<?php if($count57>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><a href="pharinmedireturn_new?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Return Medi</a></td>
<td align="center"<?php if($count57>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><a href="pharinmedireturntest_new?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Return Infu</a></td>
<td align="center"<?php if($count574d>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><?php if($count574d1==''){echo"<a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$runningTime."'>Dis Medi</a>";}else {echo"<a href='discharge_medicine_phar?pmrn=".$row['pmrn']."&eid=".$row['eid']."&sno=".$count574d1."'>Dis Medi</a>";}?></td>
