...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('spd')"; 
...
<input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='code' required style="font-weight: bold;font-size:22px;color:green">
	...
	<option value=''>-Select-</option>
            ...
            require('db1.php');
            $uname = '';
            $query = "select * from `medi_stock` where add_qty>0 and location='SPD'";
...
$count=1;
//$count=1;
$sel_query="Select * from medi_stock1 where rfid= '$sno' and req_loc='SPD' order by `id` DESC;";
