...
$query19 = "SELECT COUNT(pmrn) FROM imedi2 where pmrn='$pmrn' and eid='$eid' and status1='Rupdated' and status='Active' "; 
...
{
$url = "iinpatient?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
//$update="update imedi2 set status1='SEEN' where `pmrn`='$pmrn' and `eid`='$eid' and `status1`='Rupdated';";
//mysqli_query($con,$update) or die(mysql_error());
$url = "imedi1?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
<?php
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="einviewimo?pmrn=<?php echo "$pmrn"; ?>"><b>Patient's A&E Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>"><b>ALL REPORT<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>"><b>ALL RECORDS<b></a></td></tr>
