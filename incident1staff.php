...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','staff','mng','ot','endo','imo','mofficer','nurse','emergency','moopd','call','bill','billin','diet','physio','mrd','adminmng','lab','cath')"; 
...
else if($_SESSION['sess_username']=='363'){
...
mysqli_query($con,$ins_query1) or die(mysql_error());
 ...
 echo '<script language="javascript">';
	...
	$ins_query1="update incident1 set com6='$com',com6time='$adate' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());
