...
$sel_query="Select * from store where estatus= 'Not Functioning' ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["bremarks"]; ?>  
	        ...
	        <td colspan="10"><a target='_blank' href="dmsend.php?id=<?php echo $row['id']; ?>">Give Feedback</a></td>	
