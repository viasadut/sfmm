...
$this->Cell('183',6,'Appointment Report ',0,1,'C');
$this->Ln();
}
...
$this->Cell(193,10,$data->dname.'   has  '.$data1->tt.' appointment  '. 'From '.$_REQUEST['date'].' TO '.$_REQUEST['date1'],0,0,'C');
...
$this->Cell(70,10,'Patient Name',1,0,'C');
$this->Cell(15,10,'MRN',1,0,'C');
$this->Cell(25,10,'Date',1,0,'C');
$this->Cell(20,10,'Time',1,0,'C');
...
$stmt = $db->query("Select * from radpapp where dname='$bt' and adate BETWEEN '$start' and '$end' and status!='Cancel'");
while($data = $stmt->Fetch(PDO::FETCH_OBJ)){

$this->Cell(30,10,$data->dname,1,0,'L');
$this->Cell(70,10,$data->pname,1,0,'L');
$this->Cell(15,10,$data->pmrn,1,0,'L');
$this->Cell(25,10,$data->adate,1,0,'L');
$this->Cell(20,10,$data->aslot,1,0,'L');
$this->Cell(28,10,$data->psex,1,0,'L');
