...
$sel95 = "SELECT * from medicine where code='$code' and c_code!='' and order by id desc"; 
$result95 = mysqli_query($con,$sel95);
//$charge_code = mysqli_fetch_assoc($con,$result95);
$charge_code4 = mysqli_fetch_assoc($result95);


$sel956 = "SELECT * from medicine where code='$code' and c_code=''"; 
$result956 = mysqli_query($con,$sel956);
$charge_code = mysqli_fetch_assoc($result956);




$sel9564 = "select * from medicine where code='$code'"; 
$result9564 = mysqli_query($con,$sel9564);
$charge_code6 = mysqli_fetch_assoc($result9564);
echo $tprice=(int)$charge_code6['uprice']*$pdos;

$tprice2=(int)$charge_code6['uprice']*$pdos2;
...
else if($row95=mysqli_num_rows($result956)>0  and $tqty>=$pdos)
...
$sql = "insert into endohoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`rfid`,`adate`,`brand`,`price`,`ieid`,`ip`,`op`,`acct_code`,`ccentre`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$code','$rfid','$adate','$bb_name','$tprice','$ieid','$ip','$op','$acct_code','$ccentre')";
...
else if($row95=mysqli_num_rows($result956)<=0)
...
$sql = "insert into endohoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`rfid`,`adate`,`brand`,`reuse`,`price`,`ieid`,`ip`,`op`,`acct_code`,`ccentre`) values 
('$pmrn','$pname','$charge_name','$eid','$date1','$pdos','$c_code','$rfid','$adate','$bb_name','Yes','$new_charge_price','$ieid','$ip','$op','$acct_code','$ccentre')";
...
$ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','CR','$tb_data','$date','$new_charge_price','ENDOSCOPY')";
mysqli_query($con,$ins_query) or die(mysql_error());


$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','DR','615100','$date','$new_charge_price','ENDOSCOPY')";
mysqli_query($con,$ins_query2) or die(mysql_error());
