...
if($mm_qty>=$eqty2)
	{
			...
			$ins_query3="update medi_stock set `add_qty`='$m_qty1_t' where rfid='$rf'";
...
//#2
			...
			$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1'";
			mysqli_query($con,$ins_query4) or die(mysql_error());
				

$sel97b="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$third_qtyb' where rfid='$rfid1b'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
...
else if($b_chk_7b['add_qty']<$second_qty1)
{
	...
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1b'";
mysqli_query($con,$ins_query4) or die(mysql_error());
		

$sel97c="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$forth_qtyc' where rfid='$rfid1c'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7c['add_qty']<$third_qtyb1)
{
	
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1c'";
mysqli_query($con,$ins_query4) or die(mysql_error());
		

$sel97d="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$fifth_qtyd' where rfid='$rfid1d'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7d['add_qty']<$forth_qtyc1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1d'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97e="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$sixth_qtyd' where rfid='$rfid1e'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7e['add_qty']<$fifth_qtyd1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1e'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97f="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$seven_qtyd' where rfid='$rfid1f'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7f['add_qty']<$sixth_qtyd1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1f'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97g="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$eight_qtyd' where rfid='$rfid1g'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7g['add_qty']<$seven_qtyd1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1g'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97h="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$nine_qtyd' where rfid='$rfid1h'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7h['add_qty']<$eight_qtyd1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1h'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97i="SELECT * FROM medi_stock WHERE `code`='$code_1' and add_qty>0 and location='Pharmacy' order by id asc limit 1;";
...
{
$ins_query4="update medi_stock set `add_qty`='$ten_qtyd' where rfid='$rfid1i'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7i['add_qty']<$nine_qtyd1)
{
	$ins_query4="update medi_stock set `add_qty`='0' where rfid='$rfid1i'";
mysqli_query($con,$ins_query4) or die(mysql_error());
...
$new_qty=$sumr['SUM(add_qty)'];
     ...
     <td align="center" colspan="1" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>><?php echo $count; ?></td>
      ...
      <td align="center"colspan="9" <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>><?php echo $row["medi"]; ?></td>
...
<td align="center"colspan="1"><input name="eqty2_<?= $id ?>" id="eqty2" type="text" value="<?php echo $new_qty;?>" readonly <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>></td>
		
<td align="center"colspan="1"><input class="iprice" name="eqty3_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row1['uprice'];?>" readonly <?php if($new_qty>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?>></td>			
