...
<?php 
    ...
    $eid=$data['eid'];
    $iname=$data['medi'];
    $query5 = mysqli_query($con,"select * from 24urinepotassium where pmrn='$pmrn' and sno='$sno'");
...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        $ins_query1="UPDATE 24urinepotassium SET 
            `pname`='$pname',
            `pmrn`='$pmrn',
            `psex`='$psex',
            `page`='$page',
...
<body>
    ...
    <form action="" method="post">
        <!-- Form Title -->
        <h1>Urinary Potassium (24 Hours urine)</h1>
        <fieldset>
            <legend></legend>
            <!-- Name Input -->
            ...
            <label for="age"><strong>24 Hours Urine Albumin Test Report:</strong></label>
            ...
            <label for="tibc"><strong>24 Hours Urine Albumin</strong></label>
