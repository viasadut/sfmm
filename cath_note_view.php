...
<p align="center" class="style1">View Patient Cathlab Post Order</p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from cath_charge where pmrn='$pmrn' and c_status!='Cancelled' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["sname"]; ?></td>
	  	  <td align="center"><?php echo $row["inorder"];?></td> 
           ...
           if($row['inorder']!=''){
			  	...
			  	echo
            '<td align="center"><a target="_blank" href="cath_post_order?pmrn='.$row["pmrn"].'&eid='.$row["eid"].'&id='.$row["id"].'"><img src="print.png" title="Post Order" width="50" height="60" /></a></td>';
           }
else {
