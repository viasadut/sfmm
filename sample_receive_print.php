...
$pdf->Cell('182',6,$data->infusion.' (Received)',0,1,'C');
$pdf->Ln(2);
...
$pdf->Cell('110',5,'Sample Date: '.$data->odate,0,0,'L');	
$pdf->Cell('50',5,'Receive Time: '.$data->rtime,0,1,'L');

$pdf->Cell('110',5,'',0,0,'L');
$pdf->Cell('50',5,'Received By: '. $data->rby,0,1,'L');
...
$pdf->Cell('190',5,'Details',0,1,'L');
//$pdf->Cell('190',5,'.$data->room,0,0,'L');
$pdf->MultiCell('180',5,$data->room,0);


$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'No Signature Required',0,1,'R');
