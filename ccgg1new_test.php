...
$sel="SELECT * FROM pappnew WHERE `pphone`='$pphone' and `pmrn`='$pmrn' and `dname`='$dname' and adate='$date10';";
...
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`,`adate1`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date10','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$adate1')";
...
<input name="pmrn" id="pmrn"onkeyup="GetDetail(this.value)" type="text" size="80" placeholder="MRN" value="<?php if(isset($_POST['load'])==1)
{ $pmrn = $_REQUEST['pmrn'];
echo $pmrn;
}
?>">
      ...
      <input name="name" id="pname" type="text" size="80" value="<?php if(isset($_POST['load'])==1)
{ $name = $_REQUEST['name'];
echo $name;
}
?>" required >
 	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" id="padd" type="text" size="40" value="<?php if(isset($_POST['load'])==1)
{ $padd = $_REQUEST['padd'];
echo $padd;
}
?>" required>
...
?></option>
	 ...
	 <input name="pphone" type="text" id="pphone"size="13" placeholder="Phone No"value="<?php if(isset($_POST['load'])==1)
{ $pphone = $_REQUEST['pphone'];
echo $pphone;
}
?>" required>	  
