...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from topic where discipline='$dis' order by id desc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
	...
	<td align="center"><a href="topicview1md?id=<?php echo $row["id"]; ?>">DETAILS</a></td> 
	<td align="center">
	<?php
	...
	$id=$row["id"];
		...
		$url = "topicview1md_edit?id=$id"; 
	
	
if($fullname=='ceo' or $fullname=='cfo' or $fullname=='ruzita' or $fullname=='1292'){
echo"
