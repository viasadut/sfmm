...
$query45 = mysqli_query($db,"select * from eblood where id='$id'");
...
$update="update eblood set ddate='$ddate',status='Rupdated',duser='$user', otime='$result' where `id`='$id'";
...
<td colspan="4" align="center"><label><strong>Investigation</strong></label></td> 
<td colspan="4" align="center"><label><strong>Remarks</strong></label></td>
<td colspan="4" align="center"><label><strong>Result</strong></label></td>

<tr><td colspan="4" align="center"><input type="text"  name="odate" required value="<?php echo $data45["odate"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="otime" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="infu" required value="<?php echo $data45["room"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="result" required value="" /></td>
</tr> 
