...
$ss=$row40['sid'];
   ...
   ?>
	  ...
	  <td align="center"><div style="margin: 0 auto; width: 200px"><span style='color:red;text-align:center;font-size:14px'>
	  
	  <a href="new_opd_1?sid=<?php echo $ss; ?>" target="_blank"><img  src="prescription/prescription/doctor/<?php echo $ss.'.jpg' ?>" width="60"  height="60"></a>
