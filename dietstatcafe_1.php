...
echo $end1;
*/
$sel_query="Select COUNT(DISTINCT(pmrn)),odate FROM iidiet where  odate BETWEEN '$start' and '$end' and status in('Diet Ordered','Given') group by odate"; 
 /*else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row['COUNT(DISTINCT(pmrn))']; ?></td>
