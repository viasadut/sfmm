...
$pmrn=$_REQUEST['pmrn'];
$infu=$_REQUEST['infu'];
$infu1=$_REQUEST['infu'].' '.$unit;
$dtime= date('d/m/Y H:i:s');
//$id1=$_REQUEST['ID'];
$url = "testapprove";
$query = "UPDATE iinves set eby='$user',etime='$dtime',result='$infu',result1='$infu1' where id='$id'"; 
...
<td colspan="3" align="center"><label><strong>Investigation</strong></label></td> 
<td colspan="15" align="center"><label><strong>Result</strong></label></td>


<tr><td colspan="2" align="center"><input type="text"  name="odate" required value="<?php echo $data45["odate"]; ?>" readonly></td>
<td colspan="3" align="center"><input type="text" name="otime" required value="<?php echo $data45["infusion"]; ?>" readonly></td>
<td colspan="15" align="center"><textarea type="text" name="infu" required rows="10"><?php echo $data45["result"]; ?></textarea></td>
