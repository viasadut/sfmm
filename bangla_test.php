...
//if (!preg_match('/[^A-Za-z0-9]/', $details)) // '/[^a-z\d]/i' should also work.

	$ins_query1="insert into o_topic (`topic1`,`topic`) values ('$details','$bdetails')";
//mysqli_query($con,$ins_query1) or die(mysql_error());

if(mysqli_query($con,$ins_query1)==true){

$query434 = "SELECT * from o_topic order by id desc limit 1"; 
...
header("location:bangla_print?id=$id2");	
...
<!-- Form Title -->
		...
		<label for="age"><strong>Details(Bangla):</strong></label>

									
                                    <div>
                                           <textarea name="bdetails" class="form-control" placeholder="Details"rows="25"cols="25"></textarea>
                                               
										 
                                    </div>
                                
 <script>
 CKEDITOR.replace( 'bdetails', {
  height: 400,
  ...
  extraPlugins : 'filebrowser',
    ...
    filebrowserUploadUrl: "upload_topic.php"
	  ...
	  <label for="age"><strong>Details(English):</strong></label>
