...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from presnew where date1='$date6'order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  $pp=$row['pmrn'];
	  $sel="Select * from patient where pmrn='$pp';";
...
$row1 = mysqli_fetch_assoc($re);
 ...
 ?>
	  	  	  ...
	  	  	  <td align="center"><a target='_blank' href="prescription/prescription/pdf_p_12?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"];?>&date=<?php echo $row["date"];?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="60" height="20" /></a></td>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from pappnew where pic!='' and adate1='$date55' order by id desc;";
...
$row1 = mysqli_fetch_assoc($re);
	  ...
	  <a target='_BLANK' href="cam_test/upload/<?php echo $row['pic']; ?>"><img alt="" src="cam_test/upload/<?php echo $row['pic']; ?>" class="img-flex-rounded" width="30"  height="40" align="center"/></a>
	  </td>
