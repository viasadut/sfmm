...
<?php 
    ...
    $eid=$data['eid'];
    $iname=$data['medi'];
    $query5 = mysqli_query($con,"select * from 24urinechloride where pmrn='$pmrn' and sno='$sno'");
...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        $ins_query1="UPDATE 24urinechloride SET 
            `pname`='$pname',
            `pmrn`='$pmrn',
            `psex`='$psex',
            `page`='$page',
...
<body>
    ...
    <form action="" method="post">
        <!-- Form Title -->
        <h1>Urinary Chloride (24 hrs urine)</h1>
        <fieldset>
            <legend></legend>
            <!-- Name Input -->
