...
Please be informed that Your Annual Leave from  '.$rowl['sdate'].' to '.$rowl['edate'].' is Approved.
...
We much appreciateyour thoughtfulness in advance.
...
Powered By KPJ_IT_DHAKA'
            ...
            $result = curl_exec($ch);
            echo $result;
			header("Location:leaveviewtm_test");
			curl_close($ch); 
