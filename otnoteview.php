...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="20"><?php echo $row1['dname']; ?>
				...
				<tr><td colspan="20"><?php echo $row1['asdoc']; ?></td></tr>
...
<tr>				<td colspan="2"><?php echo $row1['pmrn']; ?></td>
					 <td colspan="18"><?php echo $row1['pname']; ?></td>
 ...
 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><?php echo $res['diagnosis'];?></td>  </tr>
						


		<tr><td colspan="20"><label><strong>Procedure Name:</strong></label></td>  </tr>
		<tr><td colspan="20"><?php echo $res['proce'];?></td></tr>
<td colspan="20"><?php echo $res['Otherins'];?></td>	    	 
					 </tr>
...
<tr>
						...
						<tr>				
						<td colspan="20"><?php echo $res['remarks'];?></td>  
