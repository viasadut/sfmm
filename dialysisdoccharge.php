...
$query4 = mysqli_query($db,"select * from dialysispapp where pmrn='$pmrn' and eid='$eid'and discharge=''");
...
$ins_query="insert into ivisitdialysis (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`vtype`,`cdate`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$full','$user','$remarks','$infu','$date')";
...
<td colspan="12" align="center"><label><strong>Consultant Note</strong></label></td> 
<td colspan="3" align="center"><label><strong>Charge</strong></label></td>
...
<td colspan="12" align="center">
  <textarea rows="2"  name="infu" required value=""></textarea>
</td>
...
$count=1;
$sel_query="Select * from ivisitdialysis where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
