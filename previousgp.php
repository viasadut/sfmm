...
<li class='has-sub'><a href='appgp'><span>Set Patient's Appointment</span></a>
            
         </li>
		 <li class='has-sub'><a href='previousgp'><span>Search Previous Patient</span></a>
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="previousgp1?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">GO</a></td>
