...
lab_render_approval_footer($pdf, $db, (isset($data->subtype)?$data->subtype:''), (isset($data->resultby)?$data->resultby:''), (isset($data->checked_by)?$data->checked_by:''), (isset($data->cby)?$data->cby:''));
$pdf->Ln(10);
