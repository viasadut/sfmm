...
$sel="SELECT * FROM pappnew WHERE pphone='$pphone' and `pmrn`='$pmrn' and `dname`='$dname' and adate='$date_nn1'and status!='Cancel';";
...
('$name', '$pmrn','$pphone','$padd','$dname','$date_nn1','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$date_nn','ccgg1new_test2_call')";
...
<input type="text" name="date_nn" placeholder="Select Date" size="85" value="'.$date_new1.'" readonly>
';}
...
<input type="text" name="date_nn" id="datepicker1" placeholder="Select Date" size="85" value="">
								';} 
