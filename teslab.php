...
$test_new=$_SESSION['user_session_id'];
  //echo $test;
...
<ul>
  ...
  <li><a href='categoryinvesmng_lis'><span>Update</span></a></li>
  <li><a href='lab_report_approval_flow.php'><span>Lab Report Approval Flow</span></a></li>
  ...
  <li class='active has-sub'><a href='#'><span>Covid</span></a>
      ...
      <ul>
         <li class='has-sub'><a href='#manualesearchlab#'><span>OPD Manual Request</span></a>
		  ...
		  <li class='has-sub'><a href='registerlab_0000'><span>Manual Patient Registration</span></a>
      ...
      <ul>
		...
		<li class='has-sub'><a href='#manualesearchlab_bbank#'><span>Donor Investigation Request</span></a>
		 ...
		 <li class='has-sub'><a href='Print_previous_Report'><span>Print Previous Reports(Donor)</span></a>
		 </li>

       <li class='has-sub'><a href='Print_previous_Report_patient'><span>Print Previous Reports(Patient)</span></a>
		 </li>
		 <li class='has-sub'><a href='all_staff_lab_view'><span>View All Staff Blood Group</span></a>
		 </li>
		 
       <li class='has-sub'><a href='teslab3_issued'><span>Issued Blood List</span></a></li>
       <li class='has-sub'><a href='lab_blood_return'><span>Return Blood</span></a></li>
       <li class='has-sub'><a href='lab_blood_report'><span>Transfusion Reaction Report</span></a></li>
       <li class='has-sub'><a href='discard_blood_bank'><span>Expired Blood Bank Bag List</span></a></li>
...
<li class='has-sub'><a href='lab_sample_receive_new'><span>Receive OPD Sample</span></a>
		 ...
		 <li class='has-sub'><a href='print_lab_home'><span>Print Receive Sample</span></a>
            
         </li>
   
   <li><a href='labsearchbar_report'><span>Search All Done Reports By Barcode</span></a></li>
   
	  <li class='last'><a href='lab_update'><span>Sample Collection</span></a></li>
	  <li><a href='labstatlab_new'><span>Dengue Stats</span></a></li>
   ...
   <li class="active has-sub"><a href="#"><span>FOR HOS / InCharge Only</span></a>
      <ul>
		...
		<li class="has-sub"><a href="mrequest"><span>Material Request</span></a>
		 ...
		 <li class="has-sub"><a href="attndept2dept">Departmental Attendance Report</a>
            
         </li>
		 
		 <li class="has-sub"><a href="dispose_medicine_lab">Discard Stock Medicine</a>
            
         </li>
		 
         <li class="has-sub"><a href="hos_info_home">ADD EDOC TOPIC</a>
            
         </li>

         

         <li class="has-sub"><a href="purchase_transfer_ot?sno='.$runningTime1.'">Request For Stock (Store)</a>
         </li>
...
?>	  
	  ...
	  <li class='last'><a href="reporting-portal/index.php">Reporting Portal</a></li>
...
//$id =$_GET['id'];
$count=1;
//$sel_query="Select * from alltest where date1 between '$test' and '$date' and type in ('lab','LAB','Lab') and status!='Received' order by date1 desc;";
    ...
    <tr>
	  ...
	  <td align="center"><?php echo $row["dname"]; ?></td>
	  	  <td align="center"><?php echo $row["medi"];?></td> 
	  	  	  ...
	  	  	  <td align="center" colspan="1"><a href="labreceiveopd?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>"></a></td>
...
{
    var session_id = "<?php echo $test_new; ?>";
