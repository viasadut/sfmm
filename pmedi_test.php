...
$runningTime = date('dsiY')+$_POST["chkDel"][$i];
			$bar_code = date('iYds');			
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from imedi3 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pstatus='Ordered' and status1 not in ('SEEN','implemented') order by `time` and `infusion` asc;";
