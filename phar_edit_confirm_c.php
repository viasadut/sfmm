<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','store','staff')"; 
...
{
$query = "UPDATE medicineedit set status='WAITING FOR CFO APPROVAL',chair_time='$dtime' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());
...
else if($user=='322' and $code!=$code_master)
{
