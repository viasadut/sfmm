...
/*$rr1='ABO Group- :'.$chikun1."<br />".'Rehesus(D) Group:'.$chikun2;

$rr='ABO Group- :'.$chikun1."<br />".'Rehesus(D) Group:'.$chikun2;
*/
...
$ins_query1="insert into bgroup (`pname`,`pmrn`,`psex`,`page`,`abo`,`dgroup`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`remarks`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$user','$adate','$eid','$iname','$id','$sno','$remarks')";
