<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','mrd','corona','doctor','moopd','ddf1','staff','imo','nurse','mofficer','physio','techbio','endo','rad','ot','opdpro')"; 
...
<p align="center" class="style1">SEARCH YOUR PATIENTS BY MRN</p> 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="consent_upload?pmrn=<?php echo "$pmrn"; ?>">GO</a></td>
