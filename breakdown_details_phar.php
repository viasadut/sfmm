...
//$id=$_REQUEST["id"];
	 ...
	 $sel_query="Select * from pms_bill where date between '$billdate' and '$billdate1' and location='$location'";
...
$user_name_d = mysqli_fetch_assoc($user_name_r);
      ...
      <td align="center"><?php echo $row['billno']; ?>
   </td>
      <td>
      <?php
      ...
      {echo '<a href="new_bill/opd_consultation_bill_pdf_a5_1?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Print</a>';}
      

      else if($row['location']=='IPD-Payment' and $row['dname']!='IPD ADVANCE' )
      {echo '<a href="new_bill/ipd_bill_pdf?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Bill Print</a>
        <a href="ipd_details_charge?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Details Print</a>
        ';}
      ...
      {echo '<a href="new_bill/ipd_bill_paper_advance?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Print</a>';}
      
      else if($row['location']=='OPD_Medi' || $row['location']=='OPD_DIS' || $row['location']=='OTC' || $row['location']=='OTC_Sale')
      {echo '<a href="new_bill/opd_bill_pdf22_new_medi_pos?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Print</a>';}
      ...
      {echo '<a href="new_bill/opd_consultation_refund_pdf_extra?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Print</a>';}


      else if($row['location']=='AE')
      {echo '<a href="new_bill/ae_bill_pdf?billno='.$row['billno'].'&pmrn='.$row['pmrn'].'&eid='.$row['eid'].'">Print</a>';}
