...
$sel_query1="Select * from alltest where date1 BETWEEN '$start' and '$end' and subtype='BLOOD BANK' order by id";
...
{ ?>    <tr>
	...
	$sel_query2="Select * from iinves where ndate BETWEEN '$start' and '$end' and subtype='BLOOD BANK' order by id";
...
{ ?>    <tr>
	...
	<?php
	$sel_query3="Select * from einves where ndate BETWEEN '$start' and '$end' and subtype='BLOOD BANK' order by id";
