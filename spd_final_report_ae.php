...
$query = "SELECT * from ieinves where id='$id'"; 
...
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$cdetails','$count2','$date1','$date2','$stime','Updated','AE','$date_d','$inves','$lid','$user','$add_time')";
mysqli_query($con,$ins_query);

$update="update einves set status='Updated', report='$plaintext' where `id`='$id'";
