...
$res90=mysqli_num_rows($result90);


		
		$url = "radpre?pmrn=$pmrn&ID=$ID&dreffer=$dreffer&dname1=$dname1"; 
...
echo $pmrn;
		...
		{ 
echo "<a target='_blank' href='$url'>$pmrn</a>";
	}
	...
	?>
	  ...
	  <td align="center"><?php echo $row["dreffer"]; ?>  
	  	  <td align="center"><a href="mmarequestrad?tname=<?php echo $row['tname'];?>"><font size="4.5"><?php echo $row["tname"]; ?> </a>
...
$res90=mysqli_num_rows($result90);
	...
	if($res90=mysqli_num_rows($result90)==0)
	{ 
echo "Please kindly apply for the previlege to do this report";
	}
