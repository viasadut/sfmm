...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
              ...
              $g_discount=$_REQUEST['g_discount']+$discount_given;
...
//$sel95w="SELECT COUNT(id) FROM medi_stock WHERE `code`='$code' and location='Pharmacy' and batch_no='$batchno' and add_qty>0 and sno='$pono';";
$sel95w="SELECT COUNT(id) FROM medi_stock WHERE `code`='$code' and location='Pharmacy' and batch_no='$batchno' and add_qty>0 and sno='DSSVSGDGDG';";
$result95w = mysqli_query($con,$sel95w);
...
$ins_query2="insert into medi_stock (`code`,`location`,`g_name`,`b_name`,`add_qty`,`s_qty`,`exdate`,`batch_no`,`rfid`,`sno`,`u_price`,`t_price`,`add_by`,`add_time`,`re_date`,`req_qty`,`grn`,`invoice_no`,`p_id`,`check_by`,`s_date`,`po_id`)
values('$code','Pharmacy','$g_name','$b_name','$eqty2','$eqty2','$expiry','$batchno','$runningTime','$pono','$uprice','$tprice','$user','$add_time','$re_date','$eqty2','$grn','$invoice_no','$ono','$check_by','$re_date','$po_id')";
mysqli_query($con,$ins_query2) or die(mysql_error());

if($bonus>0){

 
  $ins_query22="insert into medi_stock (`code`,`location`,`g_name`,`b_name`,`add_qty`,`s_qty`,`exdate`,`batch_no`,`rfid`,`sno`,`u_price`,`t_price`,`add_by`,`add_time`,`re_date`,`req_qty`,`grn`,`invoice_no`,`p_id`,`b_remarks`,`check_by`,`s_date`,`po_id`)
  values('$code','Pharmacy','$g_name','$b_name','$bonus','$bonus','$expiry','$batchno','$runningTime1','$pono','$uprice','$bprice','$user','$add_time','$re_date','$eqty2','$grn','$invoice_no','$ono','Bonus Item','$check_by','$re_date','$po_id')";
...
$total += $tprice;
        ...
        $sel95r="SELECT SUM(t_price) FROM medi_stock WHERE `grn`='$grn' and b_remarks='';";
