...
$query1 = mysqli_query($db,"select * from endopapp where ID='$id'");
$data1 = mysqli_fetch_array($query1);
$adm1=$data1['adate'];
$adm= date('d/m/Y', strtotime($adm1));
...
$pdf->Cell('28',5,$data1['psex'],1,1,'L');
$pdf->ln(2);
$pdf->SetFont('Arial' , 'b' , 10);
...
$pdf->Cell('38',5,$adm,1,0,'L');
$pdf->Cell('5');
$pdf->Cell('25',5,'Ward:',1,0,'L');
$pdf->Cell('33',5,'ENDO-DAYCARE',1,1,'L');
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->ln(2);
$pdf->Cell('30',5,'Visitor Card:',1,0,'L');
$pdf->Cell('2');
$pdf->Cell('27',5,'VISITOR-01',1,0,'L');
$pdf->Cell('2');
$pdf->Cell('27',5,'VISITOR-02',1,0,'L');
$pdf->Cell('2');
$pdf->Cell('33',5,'ATTENDENT-01',1,0,'L');
$pdf->Cell('2');
$pdf->Cell('18',5,'Bed:',1,0,'L');
$pdf->Cell('40',5,'ENDO-01',1,1,'L');
$pdf->ln(2);
$pdf->Cell('30',5,'Payment Type:',1,0,'L');
$pdf->Cell(2);
$pdf->Cell('60',5,'CASH',1,0,'L');
$pdf->Cell(2);
$pdf->Cell('30',5,'Payment By:',1,0,'L');
$pdf->Cell(2);
$pdf->Cell('57',5,'SELF',1,1,'L');
...
$pdf->MultiCell('123',5,'NPO FOR 6 HRS',1,1);
$pdf->ln(2);
$pdf->Cell('60',5,'Suggested Date Of Admission:',1,0,'L');
$pdf->MultiCell('123',5,$adm,1,1);

$pdf->ln(2);
$pdf->Cell('60',5,'Plan:',1,0,'L');
$pdf->MultiCell('123',5,$data1['tname'],1,1);
...
$pdf->Cell('30',5,'Gender:',1,0,'L');
$pdf->Cell('28',5,$data1['psex'],1,0,'L');
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('2');
$pdf->Cell('30',5,'Patient Age:',1,0,'L');
...
$pdf->Cell('30',5,'Admission Date:',1,0,'L');
$pdf->Cell('38',5,$data1['adate'],1,1,'L');
$pdf->ln(2);
$pdf->Cell('60',5,'Primary Consultant:',1,0,'L');
$pdf->Cell('120',5,$data1['dreffer'],1,1,'L');
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->ln(2);
...
$pdf->MultiCell('183',10,$data1['scase'],1,1);
$pdf->ln(2);
