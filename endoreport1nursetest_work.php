...
$sel_query="Select * from con_work where status='Pending' and loc='Endoscopy' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	 ...
	 <td align="center"style="background-color:lightbllue;font-size:22px;font-weight:bold" ><a href="endoapp4nurse_work_new?id=<?php echo $row["id"]; ?>">Set Appointment</a> </td>
