...
<h1 align="center"style="background-color:lightgreen;">Todays Covid Sample Receive Pending List</h1>
<!-- Form Title -->
...
$count=1;
$sel_query="Select * from covidopd where status= 'collected' and sentto in ('SFMMKPJSH','Dr.Farida Huq Memorial -Ibrahim General Hospital') and ssent between '$test' and '$sdate' and lstatus=''order by `id` asc;";
...
<td colspan="2" align="center"><a href="covidreceive?id=<?php echo $row['id']; ?>"><strong>RECEIVE</strong></a></td>	  	
	...
	<br><br><br><br>
<h1 align="center"style="background-color:lightgreen;">Todays Covid Sample Received List</h1>
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
...
$count=1;
$sel_query="Select * from covidopd where status= 'collected' and sentto in ('SFMMKPJSH','Dr.Farida Huq Memorial -Ibrahim General Hospital') and ssent ='$sdate' and lstatus='Received'order by `lid` asc;";
...
$tr=$row['tresult'];
$id2=$row['id'];
$url="covidreceive?id=$id2";

?>
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php if($tr==''){echo"<a target='_blank' href='$url'>Edit</a>";} else{echo'';} ?></td>

      </tr>
    <?php $count++; } ?>
	
	
	<tr><td colspan ="2" align="right"><a target='_blank' href="test_pdf12dtrecv?date=<?php echo "$sdate3"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
</form>
