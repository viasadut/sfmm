...
if (!empty ($_POST['ibp'])){
$ins_querypibp="insert into otanaesibp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','IBP','$cvp','$countpscore1','$user','$odate','$time')";
