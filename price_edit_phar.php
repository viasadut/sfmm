...
$ins_query1="update medicine set etime='$adate',eby='$user',uprice='$uprice', uprice1='$uprice1', cprice='$cprice' where id='$id'";
...
$ins_query2="update medi_stock set u_price='$uprice1' where code='$code'";
...
<!-- Form Title -->
	 ...
	 <label for="age"><strong>Unit Price (OPD):</strong></label>
      ...
      <input name="remarks" type="text" size="70" style="text-transform:uppercase" value="UPLOAD" readonly>
