...
$query43t = "SELECT COUNT(pmrn) FROM endopapp where pmrn= '$pmrn' and status !='Cancel';"; 
...
$ins_query="update endopapp set dreffer='$dname', tname='$tname',anes='$anes',eid='$count1t',status='Received' where ID='$ID'";
