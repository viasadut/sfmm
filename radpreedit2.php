...
$date= date('Y/m/d');
$date1=date('m/d/Y');
//$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`type1`) values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$type1')";
//mysqli_query($con,$ins_query);
$update="update radreport set status='Confirmed',rconfirm='$user',report='$cdetails',find='$find' where `id`='$id'";
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="p4new111.php?id=<?php echo $row['id']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
