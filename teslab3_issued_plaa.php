...
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_pla'>PLATELET CONCENTRATE</a>
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_ffp'>FFP</a>
&nbsp;&nbsp;&nbsp;<a href='teslab3_issued_plaa' style="color:red">PLATELET APHERESIS</a>
</h1>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from bcross1 where status='Issued' and udate between '$test1' and '$test' and btype='PLATELET APHERESIS' order by udate desc;";
