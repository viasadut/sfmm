...
$query = mysqli_query($db,"select * from endopapp where pmrn='$pmrn' and ieid='$eid'");
...
//$dname=$data['dname'];
$query3 = mysqli_query($db,"select * from endohoscharge1 where pmrn='$pmrn' and ieid='$eid'");
$data3 = mysqli_fetch_array($query3);


$query4 = mysqli_query($db,"select * from endohoscharge where pmrn='$pmrn' and ieid='$eid'");
$data4 = mysqli_fetch_array($query4);



$query5 = mysqli_query($db,"Select * from endomedi where pmrn= '$pmrn' and ieid='$eid' and status='Active' and pstatus='Given'order by `id` DESC;");
$data5 = mysqli_fetch_array($query5);




$query6 = mysqli_query($db,"Select * from endoinfusion where pmrn= '$pmrn' and ieid='$eid' and status='Given' and status1='Active'order by `id` DESC;");
$data6 = mysqli_fetch_array($query6);




$query7 = mysqli_query($db,"Select * from endostret where pmrn= '$pmrn' and ieid='$eid' and status1='' and status='Given'order by `id` DESC;");
...
$query333 = mysqli_query($db,"select * from alltest where pmrn='$pmrn' and ieid='$yy'");
...
$pdf->ln(2);
$query1 = mysqli_query($db,"Select * from ivisitendo where pmrn= '$pmrn' and ieid='$eid'  order by `id` DESC;");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from endohoscharge1 where pmrn= '$pmrn' and ieid='$eid'order by `id` DESC;");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from endohoscharge where pmrn= '$pmrn' and ieid='$eid'order by `id` DESC;");
