...
?>
 ...
 $connect = mysqli_connect("localhost", "root", "Godiloveu16", "sfmmkpjnew");  
      ...
      $output = '';  
      $message = '';  
      $sbp = mysqli_real_escape_string($connect, $_POST["sbp"]);  
      $dbp = mysqli_real_escape_string($connect, $_POST["dbp"]);  
...
$query1="update vitalsbp set score1='$sbp',score2='$dbp',remarks='$remarks',edit_by='$user',edit_time='$dtime' where id='$id'";
