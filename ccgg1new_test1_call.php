...
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`,`adate1`,`ptype`,`page1`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date23','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$adate1','$ptype','ccgg1new_test1_call')";
...
<input name="pmrn" id="pmrn"onkeyup="GetDetail(this.value)" type="text" size="85" placeholder="MRN" value="">
      ...
      <input name="name" id="pname" type="text" size="85" value="" required >
 	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" id="padd" type="text" size="85" value="" required >
...
<option value='Sylhet'>Sylhet</option> 
	 ...
	 <input name="pphone" type="text" id="pphone"size="85" placeholder="Phone No"value="" required >	  
...
<input name="dd" id="dd" type="text" maxlength="2" size="1" value=""  required placeholder="DD">	/

<input name="mm" id="mm" type="text" maxlength="2" size="1" value=""  required placeholder="MM"> /	

<input name="yy" id="yy" type="text" maxlength="4" size="1" value=""   required placeholder="YYYY">		  
