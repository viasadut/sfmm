...
$update33="update pappnew set `aslot`='$slot', `bill`='$bill', `pmrn`='$pmrn', `pname`='$name', `padd`='$padd' where `ID`='$id'";
...
<!-- Form Title -->
      ...
      <input name="name" type="text" size="65" value="<?php echo $data["pname"]; ?>"required/>
