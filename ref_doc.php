...
$sel9=mysqli_query($db,"SELECT * FROM doctor1 WHERE `dname`='$medi1'");
$result9 = mysqli_fetch_assoc($sel9);
$dis=$result9["Discipline"];

$sel990="SELECT * FROM doctor1 where `dname`='$medi1';";
...
$ins_query1="insert into ref_doc (`dname`,`pmrn`,`pname`,`medi`,`brand`,`eid`,`date`,`ndate`,`pdos`) 
values ('$full','$pmrn','$pname','$medi1','$dis','$eid','$date1','$date2','$pdos')";
...
$count=1;
$sel_query="Select * from ref_doc where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["dname"].' ('.$row["brand"].')'; ?></td>
