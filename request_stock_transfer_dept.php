...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','pharmacy','ot')"; 
...
$query39 = "SELECT * FROM phar_transfer where sno= '$sno'"; 
...
$code_m=$b_chk_m['code'];
$location='';
$g_name_m=$b_chk_m['g_name'];
$b_name_m=$b_chk_m['b_name'];
$add_q_m=$b_chk_m['add_q'];
$add_qty_m=$b_chk_m['add_qty'];
$exdate_m=$b_chk_m['exdate'];
$u_price_m=$b_chk_m['u_price'];
$t_price_m=$b_chk_m['t_price'];
$batch_no_m=$b_chk_m['batch_no'];
$rfid_m=$b_chk_m['rfid'];




$chk="SELECT * FROM phar_transfer WHERE `sno`='$sno' and medi='$medi';";
...
else if($res95=mysqli_num_rows($result95)>0 and $mm_qty<$tprice){


			/*$strSQL2 = "insert into phar_transfer(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`ins`,`brand`,`pname`,`pmrn`) values
...
$ins_query1m="insert into medi_stock1 (`code`,`g_name`,`b_name`,`add_qty`,`exdate`,`u_price`,`t_price`,`batch_no`,`rfid`,`location`,`location1`)
 values ('$code_m','$g_name_m','$b_name_m','$mm_qty','$exdate_m','$u_price_m','$t_price_m','$batch_no_m','$code','Pharmacy','OT')";
mysqli_query($con,$ins_query1m) or die(mysql_error());
...
$sel97="SELECT * FROM medi_stock WHERE `code`='$pcode' and add_qty!='0' limit 1;";
$result97 = mysqli_query($con,$sel97);
$b_chk_8=mysqli_fetch_assoc($result97);
$rfid1=$b_chk_8['rfid'];
$second_qty=$b_chk_8['add_qty']+$m_qty1;

$code_m1=$b_chk_8['code'];
$location1='';
$g_name_m1=$b_chk_8['g_name'];
$b_name_m1=$b_chk_8['b_name'];
$add_q_m1=$b_chk_8['add_q'];
$add_qty_m1=$b_chk_8['add_qty'];
$exdate_m1=$b_chk_8['exdate'];
$u_price_m1=$b_chk_8['u_price'];
$t_price_m1=$b_chk_8['t_price'];
$batch_no_m1=$b_chk_8['batch_no'];
$rfid_m1=$b_chk_8['rfid'];

$sec_qty=$tprice-$mm_qty;
...
$ins_query1m1="insert into medi_stock1 (`code`,`g_name`,`b_name`,`add_qty`,`exdate`,`u_price`,`t_price`,`batch_no`,`rfid`,`location`,`location1`)
 values ('$code_m1','$g_name_m1','$b_name_m1','$sec_qty','$exdate_m1','$u_price_m1','$t_price_m1','$batch_no_m1','$rfid1','Pharmacy','OT')";
mysqli_query($con,$ins_query1m1) or die(mysql_error());
...
$ins_query1m="insert into medi_stock1 (`code`,`g_name`,`b_name`,`add_qty`,`exdate`,`u_price`,`t_price`,`batch_no`,`rfid`,`location`,`location1`)
 values ('$code_m','$g_name_m','$b_name_m','$tprice','$exdate_m','$u_price_m','$t_price_m','$batch_no_m','$code','Pharmacy','OT')";
mysqli_query($con,$ins_query1m) or die(mysql_error());
...
<tr>
<td colspan="10" align="center"><label><strong>Code</strong></label></td> 

<td colspan="10" align="center"><label><strong>Medicine Name</strong></label></td> <tr>
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "phar_out1_new.php?pmrn=" + str, true);
