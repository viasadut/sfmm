...
$query44 = "SELECT SUM(price) FROM iinves where dis_date BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and dname='$bt' and type in('lab','LAB','Lab','RAD','Rad','rad');"; 
...
$query44r = "SELECT COUNT(infusion) FROM iinves where dis_date BETWEEN '$start' and '$end' and type in('lab','LAB','Lab','RAD','Rad','rad') and rstatus='RECEIVED';"; 
...
{ ?>    <tr>
  ...
  <tr> <td colspan="20"></td> </tr>
	...
	$sel_query2="Select * from iinves where dis_date BETWEEN '$start' and '$end' and status in ('RECEIVED','DONE') and dname='$bt' and type in('lab','LAB','Lab','RAD','Rad','rad') order by type asc";
