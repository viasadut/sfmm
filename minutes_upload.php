...
<div class="container">
    ...
    <form action="minuteupload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
			...
			<input type="hidden" name="poid" value="<?php echo $encryption1; ?>">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from cme where id='$id';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="meetingminutes/<?php echo $image['minutes_p'] ?>">
                        <img class="img-responsive" alt="" src="meetingminutes/<?php echo $image['minutes_p'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['minutes_p'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="minutes_delete.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $image['id'] ?>">
					<input type="hidden" name="poid" value="<?php echo $eid ?>">
					<input type="hidden" name="ono" value="<?php echo $pmrn ?>">
					  <input type="hidden" name="name" value="<?php echo $image['minutes_p'] ?>">
