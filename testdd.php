...
$update212="update preadm set `nid`='$nid1' where `id`='$id'";
$result=mysqli_query($con,$update212);
...
echo '</script>';}
	...
	echo '<script language="javascript">';
    echo 'alert("skdsjfjlkjsdlly Updated"); ';
echo '</script>';
...
<input name="ecost1" type="text" size="70" value=""required  />		<b>	  

<label for="age"><strong>Recommended Donation Amount(Figure in BDT) :</strong></label>
<input name="bfigure" type="text" size="70" value=""required  />		<b>	  

<label for="age"><strong>Recommended Donation Amount(In Words) :</strong></label>
<input name="bword" type="text" size="70" value=""required  />		<b>	  
...
<td colspan="10">		<a target='_blank' href="admnewdd?pmrn=<?php echo "$pmrn"; ?>&adoc=<?php echo $data49["adoc"]; ?>&adate=<?php echo $data49["adate"]; ?>&eid=<?php echo $count1; ?>&id=<?php echo $id; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>

</form>
  

<?php echo $data444['nid'];?>
</body>
