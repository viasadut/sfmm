...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`) values
 ...
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','09:00AM','$com','$bgroup','$bstatus','$user','$adate')";
...
$ins_query1="insert into covidopd (`sid`,`cp`,`name`,`psex`,`page`,`phone`,`padd`,`district`,`ward`,`symptom`,`phyper`,`pdm`,
`asthma`,`copd`,`mali`,`other`,`ssent`,`ssent1`,`sentto`,`specimen`,`ldate`,`ldate1`,`pcase`,
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','09:00AM','$com','$bgroup','$bstatus')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,'udone','btime') values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','10:00AM','$com','$bgroup','$bstatus','$user','$adate')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','10:00AM','$com','$bgroup','$bstatus')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','11:00AM','$com','$bgroup','$bstatus','$user','$adate')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','11:00AM','$com','$bgroup','$bstatus')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`,`udone`,`btime`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','12:00PM','$com','$bgroup','$bstatus','$user','$adate')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`pro`,`apdate`,`aptime`,`com`,`bgroup`,`bstatus`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$pro','$ssent','12:00PM','$com','$bgroup','$bstatus')";
