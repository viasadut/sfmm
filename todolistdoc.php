...
$ins_query="insert into todolist (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated')";
...
<div id='cssmenu'>
<ul>
   <li><a href='iview?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>'><span>Home</span></a></li>
...
<td colspan="16" align="center"><label><strong>Add Pending Work </strong></label></td> 
...
<td colspan="16" align="center"><input type="text" name="infu1" value="" ></td>
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Pending List During Hand Over </strong></label></td> </tr>
<tr>
	  ...
	  <td colspan="2" align="center"><strong>Done </strong></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from todolist where pmrn= '$pmrn'and eid='$episode' and status='Data Updated'order by `id` DESC;";
...
{ ?>    <tr>
	...
	<td colspan="2" align="center"><a onclick="return confirm_click();" href="todoupdatedoc?id=<?php echo "$row[id]"; ?>&pmrn=<?php echo "$row[pmrn]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>DONE</strong></a></td>	        
	...
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>DONE TASK LIST</strong></label></td> </tr>
<tr>
   <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="2" align="center"><strong>Entry By</strong></td>
	  <td colspan="2" align="center"><strong>Entry Time </strong></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from todolist where pmrn= '$pmrn'and eid='$episode' and status='DONE' order by `id` DESC;";
