...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="17%"><strong>Check In Date</strong></th>
	  <th width="17%"><strong>Check Out Date</strong></th>
	  ...
	  <th width="14%"><strong>NID No</strong>
...
$count=1;
$sel_query="Select * from gdetails where anew BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["gname"]; ?></td>
	        <td align="center"><?php echo $row["anew"]; ?>
			<td align="center"><?php echo $row["dnew"]; ?>
