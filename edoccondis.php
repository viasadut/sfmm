...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from emergency where disstatus= 'Discharge Bill Confirmed' and eid='$eid' and pmrn='$pmrn' ORDER BY id asc;";
...
<td align="center"><a href="eedischarge?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">Prepare Discharge Note</a></td>
...
$sel_query1="Select * from pappnew where dname= '$full' and adate= str_to_date(  $date, '%d/%m/%Y') and status='SEEN' and `bill`='Billed' ORDER BY aslot asc;";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="newtest6?pmrn=<?php echo $row1["pmrn"]; ?>&eid=<?php echo $row1["eid"]; ?>&ID=<?php echo $row1["ID"]; ?>">Edit</a></td>
