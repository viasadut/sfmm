...
$db = new PDO('mysql:host=localhost;dbname=sfmmkpjnew','root','Godiloveu16');
$stmt = $db->query("Select * from covidopd where rdate BETWEEN '$start' and '$end' and tresult='P'and dconfirm='confirmed' and tp='$type'");
$data = $stmt->Fetch(PDO::FETCH_OBJ);
$stmt1 = $db->query("SELECT COUNT(name) as tt FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='NEW'and tresult='P'and dconfirm='confirmed'and tp='$type'");
$data1 = $stmt1->Fetch(PDO::FETCH_OBJ);
$stmt2 = $db->query("SELECT COUNT(name) as tt FROM covidopd where rdate BETWEEN '$start' and '$end'and sam='FollowUp'and tresult='P'and dconfirm='confirmed'and tp='$type'");
$data2 = $stmt2->Fetch(PDO::FETCH_OBJ);
$stmt3 = $db->query("SELECT COUNT(name) as tt FROM covidopd where rdate BETWEEN '$start' and '$end'and sam='Death'and tresult='P'and dconfirm='confirmed'and tp='$type'");
$data3 = $stmt3->Fetch(PDO::FETCH_OBJ);



$stmta = $db->query("Select * from covidopd where rdate BETWEEN '$start' and '$end' and status='collected'and tresult!='' and dconfirm='confirmed'and tp='$type'");
$dataa = $stmta->Fetch(PDO::FETCH_OBJ);
$stmt1a = $db->query("SELECT COUNT(name) as tt FROM covidopd where rdate BETWEEN '$start' and '$end' and sam='NEW'and status='collected'and tresult!='' and dconfirm='confirmed'and tp='$type'");
$data1a = $stmt1a->Fetch(PDO::FETCH_OBJ);
$stmt2a = $db->query("SELECT COUNT(name) as tt FROM covidopd where rdate BETWEEN '$start' and '$end'and sam='FollowUp'and status='collected'and tresult!='' and dconfirm='confirmed'and tp='$type'");
$data2a = $stmt2a->Fetch(PDO::FETCH_OBJ);
$stmt3a = $db->query("SELECT COUNT(name) as tt FROM covidopd where rdate BETWEEN '$start' and '$end'and sam='Death'and status='collected'and tresult!='' and dconfirm='confirmed'and tp='$type'");
...
$this->Cell(300,10,$type.' Report',0,1,'C');
...
$stmt = $db->query("Select * from covidopd where rdate BETWEEN '$start' and '$end' and tresult!='' and dconfirm='confirmed'and tp='$type' order by sid asc");
...
$this->Cell(14,($line * $cellHeight),$data->ssent1,1,0);
