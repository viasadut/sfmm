...
<?php
    ...
    $ins_query1="update cbctbl set `haemo`='$haemo',`red`='$red',`pcv`='$pcv',`mcv`='$mcv',`mch`='$mch',`mchc`='$mchc',`rdw`='$rdw',`pla`='$pla',`mpv`='$mpv',`wbc`='$wbc',`neu`='$neu',`lym`='$lym',`eos`='$eos',`mono`='$mono',`bas`='$bas',`crea`='$crea',`eby`='$user',`etime`='$time',`esr`='$esr' where sno='$inid'";
