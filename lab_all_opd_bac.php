...
$lab2a4 = "SELECT COUNT(id) from alltest where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate'and subtype in('BACTERIOLOGY','IMMUNOLOGY/SEROLOGY','VIROLOGY') and rejectby!=''"; 
...
<body>
    ...
    <br>
    <h1 align="center" style="background-color:lightgreen;text-align:left"><a href='lab_all_opd_bac' style="color:red">OPD (<?php echo $lab_ra;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ipd_bac'>IPD(<?php echo $lab_r1a;?>)</a>&nbsp;&nbsp;&nbsp;<a href='lab_all_ae_bac'>AE(<?php echo $lab_r2a;?>)</a></h1>
...
$ae_bill_date1=date('d/m/Y',strtotime($data_ae['rdate']));
			...
			?>
                    ...
                    <td align="center" colspan="1"><a onclick="return confirm_click();"
                        href="labreportconfirmopd_bac?id=<?php echo $row["id"]; ?>">Confirm</a></td>
                    ...
                    <td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_opd_bio_bac?id=<?php echo $row["id"]; ?>">Reject</a></td>
                </tr>
                <?php $count++;  }}
                    else {
