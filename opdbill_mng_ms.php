<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('bill','mng','doctor','imo','nurse','mofficer')"; 
...
$ins_query1="update m_suite set ustatus='Paid' where id='$id'";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="10"><?php echo $row["price"]; ?></td>
