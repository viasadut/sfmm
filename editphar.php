...
$ins_query1="insert into medicineedit (`mname`,`brand1`,`brand2`,`pre`,`pcat`,`eby`,`etime`,`frequency`,`frelation`,`pcategory`,`duration`,`contrain`,`meffect`,`uprice`,`status`,`mid`)
 values ('$mname','$bname','$cname','$form','$cat','$user','$adate','$frequency','$frelation','$pcategory','$duration','$contrain','$meffect','$uprice','waiting','$id')";
