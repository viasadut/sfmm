...
$sel90="SELECT * FROM istret WHERE `pmrn`='$pmrn' and `eid`='$eid' and`infusion`='$infu' and odate='$odate' and `rtime`='$rtime';";
...
$ins_query="insert into istret (`pmrn`,`eid`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`) 
