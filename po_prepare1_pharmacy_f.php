...
<a onclick="return confirm_click();" href="po_forward_p?id='.$po_id.'&ono='.$_REQUEST['ono'].'&va='.$po_value.'"><strong><img src="forward.png" title="Forward PO" width="50" height="50" /></strong></a>
...
<table width="95%" height ="100%" border="0" align="center" bgcolor="lightblue" style="border-collapse:collapse;">	
  ...
  <tr>
		...
		<td colspan="5" style="font-weight: bold;font-size:14px;color:red"> </td>
		<td colspan="5" style="font-weight: bold;font-size:14px;color:red"> Record Status: <br> <span style="font-weight: bold;font-size:18px;color:green"><?php if($data['status']==''){echo "Open";} else {echo $data['status'];}?></span></td>
...
<input type="hidden" name="p_id" id="p_id" value="" style="font-weight: bold;font-size:22px;color:green"required>
		...
		if($status=='' || $status=='Draft') {
			...
			<a target="_Blank" href="po_print_new?ono='.$ono4.'"></a>
			</span></td>
