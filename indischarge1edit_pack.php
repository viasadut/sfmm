...
$url = "indischarge1edit1_pack?pmrn=$pmrn&eid=$eid" ;
header("Location:$url");
...
<tr>
		<td colspan="10"><button type="submit" name="Submit34">EDIT</button></td>
	
<td colspan="5"><a href="imoidoccondis?pmrn=<?php echo $pmrn;?>&eid=<?php echo $eid;?>"><b>BACK</a></td>
