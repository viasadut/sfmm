...
$date2=date('d/m/Y');
$stime=date("h:i:sa");
$ins_query="insert into fnacreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`date1`,`guide`,`hno`,`specimen`,`anote`) 
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$date1','$guide','$hno','$specimen','$anote')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="viewradrecord?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo $row['dreffer'];?>"><b>See Clinical Details<b></a></td></tr>
				...
				<td colspan="5" ><input type="text" name="dname" required value="<?php echo $dname1;?>" readonly/ style="background-color:skyblue;></td>
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
					 ...
					 <td colspan="2"><input type="text" name="ptemp" value="<?php echo $rfor;?>" readonly/></td>  
...
<tr><td colspan="20"><label><strong>Cytopathological  No:</strong></label></td>  </tr>
						 ...
						 <tr><td colspan="20"><input type="text" name="specimen" style="text-transform:uppercase" required value="<?php $spe;?>" /></td>  </tr>
						<tr><td colspan="20"><label><strong>Aspiration Note:</strong></label></td>  </tr>
						<tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="anote" rows="5" ></textarea></td>  </tr>						
						<tr><td colspan="20"><label><strong>Microscopic Description:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="cdetails" rows="20" ></textarea></td>  </tr>
