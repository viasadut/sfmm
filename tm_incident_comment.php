...
$tm_comment=$_REQUEST['tm_comment'];
$tm_status=$_REQUEST['tm_status'];
//$medi = $_REQUEST['medi'];
//$pins = $_REQUEST['pins'];

//$dtime = $_REQUEST['dtime'];

$url = "incidentviewstaff12";

$ins_query="update incident1 set tm_comments='$tm_comment',tm_status='$tm_status',tm_by='$user',tm_status_time='$adate' where id='$id'";
...
<tr><td colspan="20" align="left"><label><strong>TM Comments</strong></label></td> 
...
<td colspan="20" align="center"><textarea name="tm_comment" rows='10' class="form-control" autocomplete="off" required>

</textarea>
</td>
</tr>
<tr><td colspan="20" align="left"><label><strong>TM Final Status</strong></label></td> 
...
<td colspan="20" align="center">
  <select id="browsers1" name="tm_status" required>
