...
$data1 = mysqli_fetch_assoc($query5);
 ...
 $query6 = mysqli_query($db,"select COUNT(sno) from b_gas_a where sno='$sno'");
...
$ins_query1="insert into b_gas_a (`pname`,`pmrn`,`pphone`,`psex`,`page`,`ph`,`pco2`,`po2`,`beecf`,`hco3`,`tco2`,`so2`,`lac`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$ph','$pco2','$po2','$beecf','$hco3','$tco2','$so2','$lac','$user','$adate','$eid','$iname','$id','$sno')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$update="update iinves set resultstatus='Updated By Duty Nurse',resulttime='$adate',resultby='$user',result='$rr',result1='$rr1',rstatus='RECEIVED',status='RECEIVED' where id='$id'";
...
<!-- Form Title -->
		<h1>ABG (ARTERIAL BLOOD GASES) </h1>
...
document.getElementById('rdw').onchange= f_color9;
      ...
      <input name="lac" id="pla" type="text" style="font-weight: bold;font-size:22px;" value=""required/>
