...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <?php 
	  if($row['itype']=='Clinical' and $row['com3']!='' and $row['com4']!='' and $row['com5']!='' and $row['chaircom']!='' )
	  {echo
  
	  '<a href="incident1?ceo='.$row['ceo'].'&cfo='.$row['cfo'].'&cno='.$row['cno'].'>&md='.$row['md'].'&hos='.$row['hos'].'&id='.$row['id'].'">Write Comments</a>';}
	  
	  
	  else if($row['itype']=='Non-Clinical' and $row['com5']!='' and $row['chaircom']!='' )
	  {echo
	  ...
	  <td align="center"align="right"><a href="incident_print?id=<?php echo $row['id']; ?>">Details</a></td>	  
...
while($row = mysqli_fetch_assoc($row1)) { ?>
      ...
      <td align="center"align="right"><a href="incident1?ceo=<?php echo $row['ceo']; ?>&cfo=<?php echo $row['cfo']; ?>&cno=<?php echo $row['cno']; ?>&md=<?php echo $row['md']; ?>&hos=<?php echo $row['hos']; ?>&id=<?php echo $row['id']; ?>">Edit Comments</a></td>	  
	  <td align="center"align="right"><a href="incident_print?id=<?php echo $row['id']; ?>">Details</a></td>	  
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from incident1 where status='forwarded' and md='$fullname' and com4=''order by id desc";
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
      ...
      <td align="center"align="right"><a href="incident1?ceo=<?php echo $row['ceo']; ?>&cfo=<?php echo $row['cfo']; ?>&cno=<?php echo $row['cno']; ?>&md=<?php echo $row['md']; ?>&hos=<?php echo $row['hos']; ?>&id=<?php echo $row['id']; ?>">Write Comments</a></td>	  
	  <td align="center"align="right"><a href="incident_print?id=<?php echo $row['id']; ?>">Details</a></td>	  
