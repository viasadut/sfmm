...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Done time</strong>
...
$count=1;
$sel_query="Select * from istat where pmrn= '$pmrn' and eid='$eid' and date BETWEEN '$start' and '$end';";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["user"]; ?>  
	   <td align="center"><?php echo $row["status1"]; ?>  
