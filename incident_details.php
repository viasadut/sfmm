<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','staff','mng','ot')"; 
...
while($row = mysqli_fetch_assoc($row1)) { ?>
    <tr><td align="right" style="font-size: 30px;"><a href="incident_photo_view?pmrn=<?php echo $id;?>">Photo View</a>&nbsp;<a href="incident_print?id=<?php echo $id;?>">P</a></td>
	</tr>  
  ...
  ";
	  ...
	  <tr><td align="left"><textarea rows="15"readonly><?php echo 'Chairman Comments'.'- '.$row["chair"].'- '.'&#013;&#010;&#013;&#010;'.$row["chaircom"]; ?> </textarea> </tr>
