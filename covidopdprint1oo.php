...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers: Ambulance: +880244077029, +8801791987466,Appointments: +880244077030,+8801703788561 (SFMMKPJSH/COVID-19/MR-2)',0,0,'C');
...
{
$pdf->SetFont('Arial' , 'b' , 14);
$pdf->Cell('67',5,'*** Test Charge 200 Taka',0,1,'L');
...
{
$pdf->SetFont('Arial' , 'b' , 11);
$pdf->Cell('67',5,'*** Test Charge 4000 Taka(Sample Collection-500 Taka, Test- 3500 Taka)',0,1,'L');
$pdf->Cell('67',5,'*** Non-Refundable',0,1,'L');
$pdf->Cell('67',5,'*** Applicable Only For Specified Appointment Date',0,0,'L');
}
