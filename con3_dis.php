...
$query43 = "SELECT COUNT(adoc) FROM inpatient where adoc= '$full' and dnew BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Number of Discharge Report</h1>
...
$count=1;
$sel_query="Select * from inpatient where adoc='$full' and dnew BETWEEN '$start' and '$end' order by dnew desc;";
