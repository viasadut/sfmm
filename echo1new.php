...
<tr>				<td colspan="10"><input type="text" name="pmrn"   value="<?php echo $row2['pmrn'];?>" readonly/></td>
		...
		<tr>
					 ...
					 <td colspan="5"><input type="text" name="psex"  value="<?php echo $row2['psex'];?>" readonly/></td>
					 ...
					 <tr>
						...
						<td colspan="10"><label><strong>Echo Window:</strong></label></td>
						
						<td colspan="10"><select name="ewin" value="">
						...
						<td colspan="20"><label><strong>ECHO FINDINGS: </strong></label></td>
...
<tr>
						...
						<td colspan="5"><label><strong>TAPSE (mm)</strong></label></td>
...
<option value="Normal In Cavity Dimension ANd Wall Thickness">Normal In Cavity Dimension And Wall Thickness</option>
<option value="No Segmental Or Global Wall Motion Abnormality Present">No Segmental Or Global Wall Motion Abnormality Present</option>
</tr>				 
...
<tr><td colspan="20"bgcolor='lightgreen'align="left"><label><strong>IVC</label></strong></td></tr>				 



				 <tr><td colspan="20"><select name="xl115[]" multiple="multiple" class="3col active" placeholder="Select Investigations">
