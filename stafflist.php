...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>Staff Name</strong></th>
...
while($row = mysqli_fetch_assoc($result)) { ?>
      ...
      <td align="center"><?php echo $row["sdesignaton"]; ?>
      <td align="center"><?php echo $row["sdept"]; ?>  
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["sphone"];?>  
