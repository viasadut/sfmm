...
<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>"style="color:#FF0000;"><b>ALL REPORTS<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>"><b>ALL RECORDS<b></a></td>
</tr>		
...
$n1=$data_baby1['beid'];
 ...
 echo'
		  <a target="_blank" href="imoidetails?pmrn='.$n.'&eid='.$n1.'"><strong><img src="baby1.png" title="Baby History" width="50" height="50" /></strong></a>
	  ...
	  ';}	
		  ...
		  echo '<a target="_blank" href="imoidetails?pmrn='.$m_pmrn.'&eid='.$m_eid.'"><strong><img src="mother1.png" title="Mother History" width="50" height="50" /></strong></a>
