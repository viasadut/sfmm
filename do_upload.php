...
$date = date('Y-m-d');
	...
	if(move_uploaded_file($tmp, 'doupload/'.$image_name)){


	$sql = "INSERT INTO do_upload (image,sid,date,user,remarks,topic) VALUES 
...
<h1 align="center">Homepage Side Banner Upload Panel</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr><td colspan="20"><label><strong>Select Side:</strong></label></td>
		...
		<tr>		<td colspan="10"><label><strong>Upload Image:</strong></label></td></tr>
		<tr>				 
