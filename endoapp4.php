...
$query339 = "SELECT * FROM user where uname= '$user'"; 
...
$ins_query="insert into endopapp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`dreffer`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$page','$psex','$tname23')";
...
<!-- Form Title -->
	...
	<input list="tname45" name="tname45" size=75% class="form-control" value="<?php echo $full;?>"readonly>
