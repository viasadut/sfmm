...
$query4 = mysqli_query($db,"select * from biom where id='$id'");
...
$ins_query1="Update store set sendtime='$adate1',stime='$stime',sendto='$sendto',sendby='$user',fremarks='$fremarks',estatus='$estatus' where id='$id'";
...
<!-- Form Title -->
	 ...
	 <input name="elocation" type="text" size="80"  style="text-transform:uppercase"value="<?php echo $data['elocation'];?>" required  readonly>
		...
		<br><br>	
			...
			<input  name="eqty" type="text" size="70" value="<?php echo $data['eqty'];?>"required  />
