...
$count=1;
$sel_query="Select * from ot where date5 BETWEEN '$start' and '$end' and status IN ('RECEIVED','DONE') order by otdate asc;";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo date('d/m/Y', strtotime($row["otdate"])); ?>
