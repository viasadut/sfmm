...
$ins_query="insert into histo (`dname`,`date`,`time`,`pmrn`,`pname`,`pphone`,`page`,`psex`,`shistory`,`eid`,`status`,`bstatus`,`eeid`,`location`) 
values ('$dname','$date1', '$time','$pmrn','$pname','$pphone','$page','$psex','$instruction','$count1','NOT SEEN','Not Confirm','$eeid','Procedure Room')";
...
<!-- Form Title -->
		...
		<a target='_blank' href="https://medex.com.bd"><b>Reference Drug Index of Bangladesh(medex.com.bd)<b></a></td></tr>
				...
				<tr>	  
				<td colspan="20"><input type="text" name="dname" value="<?php echo $dname4;?>" readonly/>
...
<tr>				 <td colspan="10"><input type="text" name="pname"  value="<?php echo $row39['pname'];?>" readonly/></td>
					...
					<td colspan="2"><input type="text" name="page" required value="<?php echo $pa;?>" /></td>  	
				...
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><label><strong>Instruction:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="instruction" rows="20" >
Name of Surgery – 
Indication – 
Specimen – 
Any marking -
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="historeq.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname1=<?php echo "$dname4"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
