...
<td colspan="10" align="right"><a target='_blank' href="emodatewise.php"><b>See Datewise Report<b></a></td>	  
      ...
      <th width="14%"><strong>Age</strong>
	       ...
	       <th width="14%"><strong>Summary</strong>
		         <th width="14%"><strong>Discharge Report</strong>
				  <th width="14%"><strong>Triage Summary</strong>
...
<td align="center"><a target='_blank' href="emopall1.php?pmrn=<?php echo $row1['pmrn']; ?>&eid=<?php echo $row1['eid']; ?>">Summary</a></td>	  
...
<td ><a target='_blank' href="printtri.php?pmrn=<?php echo $row1["pmrn"]; ?>&eid=<?php echo $row1["eid"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
