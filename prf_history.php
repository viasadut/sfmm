...
$queryd = "SELECT * from storenew where eid='".$id."'"; 
$resultd = mysqli_query($con, $queryd) or die ( mysqli_error());
$rowd = mysqli_fetch_assoc($resultd);
$id1=$rowd['id'];
$ccode=$rowd['code'];

$queryr = "SELECT SUM(add_qty) from purchase_stock where code='".$id."' and status in ('Served','Partially Served') and req_loc='$req'"; 
$resultr = mysqli_query($con, $queryr) or die ( mysqli_error());
$rowr = mysqli_fetch_assoc($resultr);


$sum3=$rowr['SUM(add_qty)'];


$queryrv = "SELECT SUM(req_qty) from purchase_stock where code='".$id."' and status in ('Pending') and req_loc='$req'"; 
$resultrv = mysqli_query($con, $queryrv) or die ( mysqli_error());
$rowrv = mysqli_fetch_assoc($resultrv);


$sum3v=$rowrv['SUM(req_qty)'];
...
<p align="center" class="style1">PRF HISTORY</p> 
...
<table width="100%" height ="100px" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
	...
	Pending Stock Request- <?php echo $sum3v;?>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<?php echo "Current Stock In Hand- ". $sum3; ?>
	</p>
  ...
  <tr>
	  ...
	  <th align="center"><strong>Request Location</strong></th>
      <th align="center"><strong>Code</strong></th>
	  <th ><strong>Brand</strong></th>
    
      <th ><strong>Request Qty</strong>
	  <th ><strong>Given Qty</strong>
...
$gg=$rowd['eid'];
$count=1;
$sel_query="Select * from purchase_stock where code='$id' and status in('Pending','Served','Partially Served') and req_loc='$req' ORDER BY add_time desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["add_qty"]; ?></td>
	  
	  <td align="center"><?php if ($row['status']=='Served' || $row['status']=='Partially Served'){echo'<span style="color:green; font-size:22px;font-weight:bold">'.$row["status"].'</span>';}else{echo'<span style="color:red; font-size:22px;font-weight:bold">'.$row["status"].'</span>';}?> </td>
...
$gg=$rowd['ename'];
$count=1;
$sel_query="Select * from po_table1 where name='$gg' ORDER BY id desc limit 5;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from storenew where eid='$id' and estatus='Active' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  $queryr = "SELECT * from add_com_product where mid='".$cid."'"; 
$resultr = mysqli_query($con, $queryr) or die ( mysqli_error());
//$rowr = mysqli_fetch_assoc($resultr);
$cc=1;
	  ...
	  $queryrv = "SELECT SUM(add_qty) from purchase_stock where code='".$id."' and location='Store' and add_qty>0"; 
$resultrv = mysqli_query($con, $queryrv) or die ( mysqli_error());
$rowrv = mysqli_fetch_assoc($resultrv);
$sum=$rowrv['SUM(add_qty)'];
	  ...
	  <a  target='_blank' href='vendor_price_product.php?id=".$id1."'><span style='color:green;font-weight:bold'>".$cc.".".$rowr['company']."</span></a><br>";}
	  
	  else {echo "
	  
	  <a  target='_blank' href='vendor_price_product.php?id=".$id1."'><span style='color:red;font-weight:bold'>".$cc.".".$rowr['company']."</span></a><br>";}?>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from add_com_product where mid='$id1' ORDER BY status asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $count; ?></td>
      <td align="center"><a  target='_blank' href='vendor_price_product.php?id=<?php echo $id1;?>'><?php echo $row["company"]; ?></a></td>
