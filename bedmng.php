...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from bed order by status asc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="bededit?id=<?php echo $row["id"]; ?>">Edit</a> </td>
