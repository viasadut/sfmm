...
<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','billin','bill')"; 
...
$ins_query="insert into emergency (`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`eid`,`pphone`,`user`,`adate1`,`yage`,`adate2`,`type`,`page`) values 
('$pname','$pmrn','$padd','$psex','$diff1','$adate','$eid','$pphone','$user','$adate1','$diff2','$adate2','$type','eadm')";
...
*/
$ins_query="insert into emergency (`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`eid`,`pphone`,`user`,`adate1`,`adate2`,`page`) values 
('$pname','$pmrn','$padd','$psex','$diff1','$adate','$eid','$pphone','$user','$adate1','$adate2','eadm')";
mysqli_query($con,$ins_query) or die(mysql_error());
