...
<html lang="en">
  <head>
    ...
    <title>Rh Antibody Identification & Titration Analysis Report IPD</title>
    <!-- Bootstrap core CSS -->
  ...
  <body  style="background-color: rgb(144, 238, 144);">
    ...
    <header>
        <nav class="navbar navbar-light bg-light">
          ...
          <h3><b>Rh Antibody Identification & Titration Analysis Report IPD</b></h3>
        </nav>
    </header>
    <main role="main" class="container-fluid">
               ...
               <form action="rhantibody-report-ipd.php" method="POST" enctype="multipart/form-data">
                <?php
                if($Existing_data_check==null){
                ?>
