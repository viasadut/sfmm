...
$ins_query="insert into ivisit (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`vtype`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$full','$user','$remarks','$infu')";
...
<tr>
<td colspan="12" align="center"><label><strong>Type Of Visit</strong></label></td> 
<td colspan="8" align="center"><label><strong>Charge</strong></label></td>
...
<td colspan="12" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
  <datalist id="browsers1">
						...
						<option value='Regular Ward Visit'>Regular Ward Visit</option>
						<option value='After Hour Ward Visit'>After Hour Ward Visit</option>
