...
$query = "UPDATE einves set rby='$user',rtime='$btime', rstatus='RECEIVED', status='DONE',rdate='$rdate' where id='$id'"; 
...
values ('$id','CR','$tb_data','$date','$price','AE_INVES_CHARGE_RAD')";
...
values ('$id','DR','111999','$date','$price','AE_INVES_CHARGE_RAD')";
...
$invoice_no=$decoded_response['invoice_id'];
 if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
	...
	$api_query = "update einves set api_status='1', invoice_no='$invoice_no' where id='".$id."'"; 
