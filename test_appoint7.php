...
$update="update opd_appoint1 set status='AVAILABLE',remarks='$reason' where dslot='$select' and date1='$date2' and dname='$dname2'";
...
<!-- Form Title -->
		<h2 align="center">UNBLOCK DOCTOR'S TODAYS BLOCKED SLOT</h2>
