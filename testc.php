...
$count=1;
$sel_query="Select staff3.sname from staff3 join covid where staff3.sname=covid.name;";
...
$bname=$row["sname"];
$bid=$row["id"];
$query43 = "SELECT COUNT(name) FROM covid where name ='$bname';"; 
