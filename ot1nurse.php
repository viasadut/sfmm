...
$ins_query="insert into ot (`dname`,`pname`,`pmrn`,`pphone`,`diagnosis`,`psex`,`page`,`adate`,`otdate`,`bookingdt`,`duration`,`spereq`,`ptype`,`tanes`,`nanes`,`proce`,`duration1`,`Otherins`,`sprequire`,`remarks`,`typeo`) values 
('$dname', '$pname','$pmrn','$pphone','$diagnosis','$psex','$page','$adate','$otdate','$bkdate','$bt','$sn','$tp','$lx3','$na','$lx','$duration','$otherins','$sprequire','$remarks','$typeo')";
