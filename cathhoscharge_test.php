...
$sql = "insert into cathhoscharge (`dname`,`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`type`,`ieid`,`code`,`qty`,`ins`,`remarks`,`ctype`) values 
('$full','$pmrn','$pname','$medi1','$eid','$date1','$pdos','$type','$ieid','$code','$price','$btype','$remarks','Others')";
...
$sql = "insert into cathhoscharge (`dname`,`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`type`,`ieid`,`code`,`qty`,`ins`,`ctype`) values 
('$full','$pmrn','$pname','$ii','$eid','$date1','$pdos','$type','$ieid','$code','$price','$btype','Package')";
...
{ echo'
				 ...
				 <td align="center" colspan="2"><a href="cathhosdelete1_test?id='.$id.'&pmrn='.$row['pmrn'].'&dname='.$dname.'&eid='.$eid.'&ieid='.$ieid.'&type='.$type.'&ID='.$id.'&rid='.$row['id'].'&pdos='.$row["pdos"].'&admission_no='.$admission_id.'&invoice_no='.$row['invoice_no'].'&code='.$row['code'].'">DELETE</a></td>';
