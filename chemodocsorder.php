...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="chemosogiven?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Given</a></td>
...
$count=1;
$sel_query="Select * from chemostret where pmrn= '$pmrn' and eid='$eid' and odate='$odate'and status = 'Given' order by `id` DESC;";
