...
<h1 align="center"style="background-color:lightgreen;">INPATIENT BLOOD ORDER </h1>
<!-- Form Title -->
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Blood Order Form</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="2" align="center"><strong>Issued By</strong></td>
      <td colspan="1" align="center"><strong>Issue Date </strong></td>
      <td colspan="2" align="center"><strong>Expiry Date</strong></td>
      <td colspan="2" align="center"><strong>Blood Type</strong></td>  
		<td colspan="2" align="center"><strong>Cross Match Result</strong></td>  
		<td colspan="2" align="center"><strong>Screening Result</strong></td>  	  
      <td colspan="4" align="center"><strong>Bag No</strong></td>
	  
       	  <td colspan="2" align="center"><strong>Issue Order</strong></td>
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$eid' and bbstatus='Rupdated' order by `id` DESC;";
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
       <td align="center"colspan="2"><?php echo $row["bbuser"]; ?></td>
	  <td align="center"colspan="1"><?php echo $row["idate"]; ?></td>  
	  <td align="center"colspan="2"><?php echo $row["edate"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["room"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["cmr"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["sr"]; ?></td>
	        
      <td align="center"colspan="4"><?php echo $row["bi"]; ?></td>
  	  
<td colspan="2" align="center"><a target='_blank' href="bbupdate4?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>Issue Order</strong></a></td>	  
	  
      </tr>
    <?php $count++; } ?>
	
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Blood Order Placed</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="2" align="center"><strong>Issued By</strong></td>
...
$count=1;
$sel_query="Select * from iblood where pmrn= '$pmrn' and eid='$eid' and bbstatus='Order Placed' order by `id` DESC;";
...
<td colspan="2" align="center"><?php echo $row["oodate"]; ?></td>	  
