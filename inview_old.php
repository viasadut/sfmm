...
echo $diff->format("%R%a days");?>  </td>
	  <td align="center"><a href="idetails?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
	  	  <td align="center"><a href="gg3bed?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>">transfer bed</a></td>
<td align="center"><a href="tdoc1?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>">Transfer Doctor</a></td>	  
