...
<form action="raddtsearch2" method="POST">
...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <td colspan="1"align="center"><strong>Investigation Name</strong></td>
      <td colspan="2"align="center"><strong>A. Date</strong></td>   
      <td colspan="1"align="center"><strong>A. Time</strong></td>
...
$sel_query="Select * from radpapp where pmrn='$pmrn' and status='NOT SEEN';";
...
{ ?>    <tr>
      ...
      <td colspan="1"align="center"><?php echo $row["tname"]; ?> </td> 
      <td colspan="2"align="center"><?php echo $row["adate"]; ?></td>
      <td colspan="1"align="center"><?php echo $row["aslot"]; ?> </td>
	   <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="radpre_new_typist?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"];?>&dreffer=<?php echo $row["dreffer"];?>">GO</a> </td>
