...
$url = "phar_transfer_phar?sno=$sno";
header("Location: $url"); 
...
<input type="text" id="dept" class="form-control action" list="ddd" autocomplete="off" name='dept' required readonly style="font-weight: bold;font-size:22px;color:green" value="<?php echo 'Pharmacy_ipd';?>">
