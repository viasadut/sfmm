...
<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>"style="color:#FF0000;"><b>ALL REPORTS<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>"><b>ALL RECORDS<b></a></td></tr>		
 ...
 <tr>
	  ...
	  <tr><td align="Left"style="font-size:22px;color:red;"><b>Patient's MRN :<?php echo $data["pmrn"]; ?></b></td>  </tr>
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and type in('LAB','Lab','lab') order by `id` DESC limit 4;";
...
<?php if($diff1>7){echo'<button type="submit" name="pac_req"><font size="4.5" color="green"><b>Send PAC Request</button>';}

else if($diff1<=7){echo'<button type="submit" name="pac_req" disabled><font size="4.5" color="#FF000"><b>Already One PAC Request Sent</button>';}
?>
