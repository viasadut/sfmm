...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
			...
			$strSQL1 = "update phar_sale set ins='Served', b_by='$user',b_date='$b_date' where id='".$updateid."'";
...
<tr>
	  ...
	  <td colspan="8" align="center"><strong>Medication Name</strong></td>
	  <td colspan="5" align="center"><strong>Brand</strong></td>
	  <td colspan="2" align="center"><strong>MRN</strong></td>
	  <td colspan="2" align="center"><strong>Used By</strong></td>
        
      <td colspan="1" align="center"><strong>Used date</strong></td>   
	    ...
	    <?php 
                    $query = "Select * from phar_sale where pmrn= '$pmrn' and eid='$eid' and location in ('ICU','NICU','5AB Medicine stock','5CD Medicine stock','6AB Medicine stock','6CD Medicine stock','HMD','Cathlab and SPD','5AB emergency trolley','5CD emergency trolley','6th Fl emergency trolley','Maternity Suite','6CD emergency trolley','CCU','Medical ICU') and ins=''";
	...
	<td align="center"colspan="5"><?php echo $row["brand"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
      <td align="center"colspan="2"><?php echo $row["aby"]; ?></td>  
	  <td align="center"colspan="1"><?php echo $row["adate"]; ?></td>
	...
	<?php 
                    $query = "Select * from phar_sale where pmrn= '$pmrn' and eid='$eid' and location in ('ICU','NICU','5AB Medicine stock','5CD Medicine stock','6AB Medicine stock','6CD Medicine stock','HMD','Cathlab and SPD','5AB emergency trolley','5CD emergency trolley','6th Fl emergency trolley','Maternity Suite','6CD emergency trolley','CCU') and ins!='';"; 
                    $result = mysqli_query($con,$query);
					$count=1;
                    while($row = mysqli_fetch_array($result) ){
                       $id = $row['id'];
	...
	<td align="center"colspan="5"><?php echo $row["brand"]; ?></td>
      ...
      <td align="center"colspan="2"><?php echo $row["aby"]; ?></td>  
	  <td align="center"colspan="1"><?php echo $row["adate"]; ?></td>
	  <td align="center"colspan="1" style="color:red;font-size:20px; font-weight:bold;"><?php echo 'Bill Confirmed'; ?></td>
