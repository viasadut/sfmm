...
require('db1.php');
$query43 = "SELECT COUNT(pmrn) FROM cath_receive where pmrn= '$pmrn' and eid!='0';"; 
...
$update33="update cath_receive set `temp`='$temp',`pulse`='$pulse',`temp`='$temp',`bp`='$bp',`remarks`='$remarks',`pscore`='$pscore',`ustatus`='Updated',`eid`='$count1' where `id`='$id'";
