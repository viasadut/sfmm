...
$query1 = mysqli_query($db,"select * from einves where barcode='$barcode' and type in('lab','LAB','Lab') and barcode2='' and barcode3=''");
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data1['rtime'].'(AE)',0,0,'L');
...
$query11 = mysqli_query($db,"select * from einves where barcode='$barcode' and type in('lab','LAB','Lab') and barcode2 !='' and barcode3 !=''");
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data11['rtime'].'(AE)-1st',0,0,'L');
...
$query111 = mysqli_query($db,"select * from einves where barcode='$barcode' and type in('lab','LAB','Lab') and barcode2 !='' and barcode3 =''");
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data111['rtime'].'(AE)-1st',0,0,'L');
...
$query2 = mysqli_query($db,"select * from einves where barcode='$barcode' and type in('lab','LAB','Lab') and barcode2 !=''");
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data2['rtime'].'(AE)-2nd',0,0,'L');
...
$query3 = mysqli_query($db,"select * from einves where barcode='$barcode' and type in('lab','LAB','Lab') and barcode3 !=''");
...
$pdf->SetXY(1,20.8);
$pdf->SetFont('Courier' , 'b' , 7);
$pdf->Cell('30',4,$data3['rtime'].'(AE)-3rd',0,0,'L');
