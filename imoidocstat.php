...
$ins_query="insert into istat (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`odate1`,`root`,`alert`,`time`,`date`,`status1`,`pstatus`,`ortime`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated','$odate1','$root','$alert','$time','$date','Active','Ordered','$ortime')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Stat Medication Form</strong></label></td> </tr>
<tr>
<td colspan="3" align="center"><label><strong>Date</strong></label></td> 
<td colspan="7" align="center"><label><strong>Medicine</strong></label></td> 
...
<td colspan="7" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
  <datalist id="browsers1">

						<option value=''>-Select Stat Medication</option>
				<?php 
			...
			?>  </datalist></td>
			<td colspan="3" align="center"><input list="rr10" name="root" class="form-control">
  <datalist id="rr10">
						...
						<option value='Per Vaginally'>Per Vaginally</option>
						<option value='Nose'>Nose</option>
			  </datalist></td>
<td colspan="5" align="center"><input type="text" name="remarks" required value="" /></td>
...
<tr>
	  ...
	  <tr>	<td colspan="20"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="idatewisestat1?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;</td>
</tr>
<tr>
...
$count=1;
$sel_query="Select * from istat where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
...
{ ?>    <tr>
	...
	<td align="center"colspan="1"><?php echo $row["time"]; ?></td>	  
	  ...
	  <td align="center"colspan="2"<?php if($row['alert']== "H. Medi"): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightblue;" <?php endif ; ?>>
        <?php echo $row['alert'];?></td>
  	  <td align="center"colspan="2"><?php echo $row["ddate"]; ?></td>  
	  <td align="center"colspan="2"><?php echo $row["dtime"]; ?></td>
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idocstatstop1?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo "$user"; ?>">Stop</a></td>
