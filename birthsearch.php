...
$sel_query="Select * from inpatient where pphone= '$pmrn' and discharge='';";}
 else{
...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="birthcer?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"]; ?>&phone=<?php echo $row["pphone"]; ?>">GO</a></td>
