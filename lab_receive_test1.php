...
values ('$dname', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','$price','$code','$link','$date77','$linkv','$report','$reportv','OPD','$diff1','$psex','$subtype')";
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from alltest where pmrn= '$pmrn' and status='' group by eid order by eid desc;";
...
<td align="center"colspan="1"><?php echo $row["date"]; ?></td>
	...
	<td colspan="2"><a target='_blank' href="lab_receive_test3.php?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&dname=<?php echo $row["dname"]; ?>">Details</a></td>
