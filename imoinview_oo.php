...
<!DOCTYPE html>
<html>
<title>View Inpatient List</title>
<head>
<script>
function showUser() {
  ...
  xmlhttp.open("GET","getuser22.php",true);
  xmlhttp.send();
}
...
<p align="center" class="style1">!! WELCOME !! <?php echo $user; ?>'s Dash Board </p> 

<p align="center" class="style1" style="background-color:lightgreen;font-size:22px;font-weight:bold;">In-Patient list</p>
