...
$sel_query="Select * from po_table where po_type='Pharmacy' and status='' ORDER BY id desc;";
...
<?php 
$ono=$row['id'];
if($row['status']=='' and $fullname=='45'){
echo "<a href=po_prepare_new_phar_edit?id=$ono>View</a>";
//po_prepare1_pharmacy
}
else {
