...
$ins_query1="update storenew set eid='$eid',eid1='$eid1', ename='$ename',ename1='$ename1', elocation='$elocation', etype='$etype', eqty='$eqty', estatus='$estatus', remarks='$remarks', edate='$edate'
,eby='$user', installdate='$installdate', supplier='$vendor', model='$model', serialno='$serialno', manu='$manu', origin='$origin', warrenty='$warrenty',price='$price1',uprice='$uprice1',cprice='$cprice',mar='$mar' where id='$id'";
...
<!-- Form Title -->
	  ...
	  <input  name="eid1" type="text" size="70" value="<?php echo $row1['eid1'];?>"  />
  ...
  <label for="age"><strong>Material Name :</strong></label>
	  ...
	  <input list="browsers3" name="ename1" size="80"  class="form-control" value="<?php echo $row1['ename1'];?>" autocomplete="off"  required>
  <datalist id="browsers3">
	...
	<label for="age"><strong>Chargeable Name :</strong></label>
	  ...
	  <input list="browsers2" name="ename" size="80"  class="form-control" autocomplete="off"value="<?php echo $row1['ename'];?>" required>
...
<br><br>	
	 ...
	 <select name="estatus" value="" class="style1"required>
			...
			<input  name="cprice" id="cprice" type="text" size="70" value="<?php echo $row1['cprice'];?>"required  />
			<br><br>	
			...
			<input  name="uprice1" id="uprice1" type="text" size="80" value="<?php echo $row1['uprice'];?>"required  />
