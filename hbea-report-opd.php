...
echo '<script>
    ...
    window.location.href = "testlabreceive";
</script>';
exit;
...
<html lang="en">
  <head>
    ...
    <title>Hb Electrophoresis Analysis Report OPD - Sheikh Fazilatunnesa Mujib Memorial KPJ Specialized Hospital & Nursing College</title>
    <!-- Bootstrap core CSS -->
  ...
  <body  style="background-color: rgb(144, 238, 144);">
    ...
    <header>
        <nav class="navbar navbar-light bg-light">
          ...
          <h3><b>Hb Electrophoresis Analysis Report OPD</b></h3>
        </nav>
    </header>
    <main role="main" class="container-fluid">
               ...
               <form action="hbea-report-opd.php" method="POST" enctype="multipart/form-data">
                <?php
                if($Existing_data_check==null){
                ?>
