...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','mng','bill','billin')"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>Outstanding Bill</strong></th>
...
$query43_p1 = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode in ('Cash','Card','bkash');"; 
...
$query43_p1_card = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode='Card';"; 
	 
$result43_p1_card = mysqli_query($con, $query43_p1_card) or die(mysqli_error());
$row43_p1_card = mysqli_fetch_assoc($result43_p1_card);


$query43_p1_bkash = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode='bkash';"; 
...
$query43_p1_dis = "SELECT SUM(dis_amount) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user';"; 
...
$query43_o3 = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund NOT IN ('1','2') and user='$user';"; 
	 
$result43_o3 = mysqli_query($con, $query43_o3) or die(mysqli_error());
$temp_opd_collection_all3 = mysqli_fetch_assoc($result43_o3);


$query43_dis4 = "SELECT SUM(dis_amount) FROM pms_payment where date between '$start' and '$end' and user='$user';"; 
	 
$result43_dis4 = mysqli_query($con, $query43_dis4) or die(mysqli_error());
$opd_collection_dis4 = mysqli_fetch_assoc($result43_dis4);

$query43_refund5 = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund IN ('1','2') and user='$user';"; 
...
$income=$temp_opd_collection_all3['SUM(amount)']+$row43_p32['SUM(amount)']+$row43_p1['SUM(amount_receive)']-$opd_collection_dis4['SUM(dis_amount)']-$opd_collection_refund5['SUM(amount)']-$row43_p1_dis['SUM(dis_amount)'];
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pms_bill where date BETWEEN '$start' and '$end'  and user='$user' group by user";
 } 
$count=1;
...
$query43_bkash = "SELECT SUM(amount_receive) FROM pms_bill where user= '$bill_user'and date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and p_mode in ('bkash','Bkash');"; 
...
$query43_o = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date between '$start' and '$end' and refund NOT IN ('1','2') and user='$user';"; 
	 
$result43_o = mysqli_query($con, $query43_o) or die(mysqli_error());
$temp_opd_collection_all = mysqli_fetch_assoc($result43_o);

$query43_dis = "SELECT SUM(dis_amount) FROM pms_payment where user= '$bill_user'and date between '$start' and '$end' and user='$user';"; 
	 
$result43_dis = mysqli_query($con, $query43_dis) or die(mysqli_error());
$opd_collection_dis = mysqli_fetch_assoc($result43_dis);

$query43_refund = "SELECT SUM(amount) FROM pms_payment where user= '$bill_user'and date between '$start' and '$end' and refund IN ('1','2') and user='$user';"; 
...
$query43_dis_t_card = "SELECT SUM(dis_amount) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and p_mode='Card' and user='$bill_user';"; 
...
$query43_dis_t_bkash = "SELECT SUM(dis_amount) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and p_mode in ('Bkash','bKash') and user='$bill_user';"; 
...
$card_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode='Card' and user='$user';"; 
$card_result = mysqli_query($con, $card_query) or die(mysqli_error());
$card_data = mysqli_fetch_assoc($card_result);
$card=$card_data['SUM(amount)']+$phar_collection_card['SUM(amount_receive)']-$phar_collection_dis_t_card['SUM(dis_amount)'];


$cheque_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode='Cheque' and user='$user';"; 
...
$bkash_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user' and date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode in ('bKash','Bkash') and user='$user';"; 
$bkash_result = mysqli_query($con, $bkash_query) or die(mysqli_error());
$bkash_data = mysqli_fetch_assoc($bkash_result);
$bkash=$bkash_data['SUM(amount)']+$phar_collection_bkash['SUM(amount_receive)']-$phar_collection_dis_t_bkash['SUM(dis_amount)'];
...
$opd_collection=$phar_collection['SUM(amount_receive)']+$phar_collection_card['SUM(amount_receive)']+$phar_collection_bkash['SUM(amount_receive)']+$temp_opd_collection_all['SUM(amount)']-$opd_collection_dis['SUM(dis_amount)']-$phar_collection_dis['SUM(dis_amount)']-$phar_collection_dis_card['SUM(dis_amount)']-$phar_collection_dis_bkash['SUM(dis_amount)'];
...
<td align="center">
      ...
      <?php echo $outstanding_data['SUM(amount)'];
...
$query43_t = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode='Cash';"; 
$result43_t = mysqli_query($con, $query43_t) or die(mysqli_error());
$phar_collection_t = mysqli_fetch_assoc($result43_t);


$query43_t_card = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode='Card';"; 
...
$query43_t_bkash = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode='bkash';"; 
...
$query43_dis_t = "SELECT SUM(dis_amount) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi') and user='$user' and p_mode='Cash';"; 
...
$cash_query_t = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode='Cash' and user='$user';"; 
...
$card_query_t = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode='Card' and user='$user';"; 
...
$cheque_query_t = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode='Cheque' and user='$user';"; 
...
$bkash_query_t = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund NOT IN ('1','2') and p_mode in ('bKash','Bkash') and user='$user';"; 
...
$query43_refund_t = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and refund IN ('1','2') and user='$user';"; 
...
$total_refund=$opd_collection_refund_t['SUM(amount)'];

$query43_dis_t = "SELECT SUM(dis_amount) FROM pms_payment where date between '$start' and '$end' and user='$user';"; 
	 
$result43_dis_t = mysqli_query($con, $query43_dis_t) or die(mysqli_error());
$total_di = mysqli_fetch_assoc($result43_dis_t);
$total_discount=$total_di['SUM(dis_amount)'];

$query43_dis_t_cash = "SELECT SUM(dis_amount) FROM pms_payment where date between '$start' and '$end' and p_mode='Cash' and user='$user';"; 
...
$query43_refund_t_cash = "SELECT SUM(amount) FROM pms_payment where date between '$start' and '$end' and p_mode='Cash' and user='$user' and refund IN ('1','2');"; 
...
$total_refund_cash=$total_re_cash['SUM(amount)'];

$outstanding_query_t = "SELECT SUM(amount) FROM pms_bill where amount_receive='0' and date between '$start' and '$end' AND amount!='0' AND dname!='IPD ADVANCE' AND amount>dis_amount and user='$user'"; 
...
//$query43_refund_phar_indu1 = "SELECT SUM(r_amount) FROM refund_bill where date between '$start' and '$end' and dname='OPD_Medi' and refund_by='$user';"; 

$query43_refund_phar_indu1 = "SELECT SUM(r_amount) FROM refund_bill where date between '$start' and '$end' and refund_by='$user' and location!='IPD';"; 
	 
$result43_refund_phar_indu1 = mysqli_query($con, $query43_refund_phar_indu1) or die(mysqli_error());
$opd_collection_refund_phar_indu1 = mysqli_fetch_assoc($result43_refund_phar_indu1);


$final_cash_collection=$cash_t-$total_discount_cash-$total_refund_cash-$opd_collection_refund_phar_indu1['SUM(r_amount)'];

$total_opd_collection=$cash_t+$bkash_t+$cheque_t+$card_t;
$total_net=$total_opd_collection-$total_refund-$total_discount-$opd_collection_refund_phar_indu1['SUM(r_amount)'];
