...
$query = mysqli_query($db,"SELECT * from nurseassessechemo where pmrn='$pmrn' and eid='$eid'" );
...
$query4 = mysqli_query($db,"SELECT * from friskchemo where pmrn='$pmrn' and eid='$eid'");
