...
//$id=$_REQUEST["id"];
	 ...
	 $sel_query="Select * from pms_payment where date between '$billdate' and '$billdate1' and user='$billuser' and refund IN ('1','2')";
...
$user_name_d = mysqli_fetch_assoc($user_name_r);
   ...
   //$id=$_REQUEST["id"];
       ...
       $sel_query="Select * from refund_bill where date='$billdate' and refund_by='$billuser' and location!='IPD'";
   ...
   $user_name_d = mysqli_fetch_assoc($user_name_r);
         ...
         ?>
         <td align="center"><?php echo $count; ?></td>
         <td align="center"><?php echo $row["refund_by"]; ?></td>
         <td align="center"><?php echo $user_name_d['fullname']; ?></td>
         <td align="center"><?php echo $row['pmrn']; ?></td>
         
         <td align="center"><?php echo $row['p_mode']; ?></td>
         <td align="center"><?php echo $row['r_amount']; ?></td>
