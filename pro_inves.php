...
values 
('$dname', '$pmrn','$ppname','$eid1','$medi','$pins','$date','$type','$price','$code','$link','$ndate','$linkv','$report','$reportv','OPD','$page','$pgender','$type1')";
...
$count=1;
$sel_query="Select * from alltest where pmrn= '$pmrn' and date1='$ndate'order by `id` DESC;";
