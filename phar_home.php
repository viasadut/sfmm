...
<br><span style="color:black;font-size:28px;text-align:center;font-weight:bold"><a target='_blank' href=''>(<?php echo $row_opd['COUNT(distinct(pmrn))'];?>)</a></span>
...
<br><span style="color:black;font-size:28px;text-align:center;font-weight:bold"><a target='_blank' href=''>(<?php echo $row_ot['COUNT(pmrn)'];?>)</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a href="?sno=<?php echo $runningTime;?>">OPD Sale</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="add_company_pp">Add Supplier</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="">Add Stock</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="">Scan Prescription</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_scan_return_po">Return Medicine(OPD)</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="served_list_phar">View Served Request</a></span>
...
<br><span style="color:black;font-size:28px;text-align:center;font-weight:bold"><a target='_blank' href="emergency_phar_pp">(<?php echo $row_ipd['COUNT(pmrn)'];?>)</a></span>
...
<span><img src='phar_pic/return.png' title='Add_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="rfid/nurse/inpatient/.php">Return Medicine(IPD)</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href=".php">Old Discharge Medicine</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="">Add Stock(2nd Fl Pharmacy)</a></span>
...
<span><img src='phar_pic/endo_icon.png' title='Add_Stock_2nd_Fl' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="endo_phar">Endoscopy Suite</a></span>
...
<span><img src='phar_pic/dressing_icon.png' title='Add_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="opdbill_phar.php">OPD Procedure Room</a></span>
...
<span><img src='phar_pic/ms_icon.png' title='Add_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="opdbill_ms_phar.php">Maternity Suite</a></span>
...
<span><img src='phar_pic/cathlab.png' title='Add_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="cath_phar.php">Cathlab Suite</a></span>
...
<span><img src='phar_pic/stock_request.png' title='Stock_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a href="purchase_transfer_ot?sno=<?php echo $runningTime1;?>">Request For Stock(Store)</a></span>
...
<span><img src='phar_pic/stock.png' title='Add_Stock_2nd_Fl' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="">Dispense Medicine</a></span>
