...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mrd','opdpro','mng')"; 
...
$query43 = "SELECT COUNT(dname) FROM procedure1 where dname= '$bt' and date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated');"; 
...
$query44 = "SELECT COUNT(dname) FROM procedure1 where date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated') ;"; 
...
$sel_query="Select * from procedure1 where  date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated')";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from procedure1 where dname='$bt' and date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated') ";
 } 
$count=1;
