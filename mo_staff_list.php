...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mofficer','imo')"; 
...
$count=1;
$sel_query="Select * from staff3 where status='Active' and desig='Medical Officer' and c_location='$cc_loc' order by sid desc;";
