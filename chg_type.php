...
<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('billin','mng')"; 
...
$p_type_new=$_REQUEST['p_type_new'];
...
$update22="update inpatient set type='$p_type_new' where pmrn='$pmrn' and id='$id'";
...
<!-- Form Title -->
		<h1>Patient'S Category Change Panel</h1>
        ...
        <fieldset>
			...
			<legend></legend>
            <!-- Name Input -->
			<label for="name"><strong>Select Patient Category :</strong></label>
			<p>
			<select name="p_type_new" class="country" required>
