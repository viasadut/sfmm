...
$pmrn=$_REQUEST['pmrn'];
$pmrn=$_REQUEST['pmrn'];
$sdate=date( 'm/d/Y', strtotime( $_REQUEST['sdate']) );
$edate=date( 'm/d/Y', strtotime( $_REQUEST['edate']) );
//$date=$_REQUEST['date'];
//$id=$_REQUEST['id'];

$db = mysqli_connect('localhost','root','Godiloveu16');
mysqli_select_db($db,'sfmmkpjnew');
$query = mysqli_query($db,"select * from mcertificate where pmrn='$pmrn' and fdate='$sdate' and tdate='$edate'");
