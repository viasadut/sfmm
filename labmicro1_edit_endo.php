...
$query5 = mysqli_query($db,"select * from alltest where pmrn='$pmrn' and eid='$eid'");
$data1 = mysqli_fetch_assoc($query5);
$rdate=date('Y-m-d');  
$pname=$data['pname'];


$query6 = mysqli_query($db,"select * from micro where pmrn='$pmrn' and sno='$sno' and dstatus!='Deleted'");
...
//$url = "mmaedit.php";
$query = "UPDATE micro set dstatus='Deleted',duser='$user',dtime='$dtime' WHERE id=$id6"; 
...
$ins_query1="insert into micro (`pname`,`pmrn`,`mm1`,`medi1`,`ins1`,`ins2`,`rdate`,`rby`,`inid`,`sno`,`mm2`,`medi2`,`mm3`,`mm4`,`stain`,`culture`,`mic1`,`mic2`,`atime`,`fstatus`) values 
('$pname','$pmrn','$mm1','$medi1','$ins1','$ins2','$rdate','$user','$id','$sno','$mm2','$spe1','$mm11','$mm22','$stain1','$culture','$mic1','$mic2','$atime','$fstatus')";
...
<tr>
<td colspan="20" align="center"><input list="aa" name="culture" size=60% class="form-control" autocomplete="off"  value="">
  <datalist id="aa">
...
<tr>
<td colspan="20" align="center"><input list="dd" name="atime" size=60% class="form-control" autocomplete="off"  value="">
  <datalist id="dd">
				</datalist></td>
</tr>
...
<tr>
<td colspan="20" align="center"><input list="cc" name="fstatus" size=60% class="form-control" autocomplete="off"  value="">
  <datalist id="cc">
...
$sel_query1="Select * from micro where sno= '$sno'  and dstatus !='Deleted' ORDER BY id desc;";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row1["mic1"]; ?></td>
      <td align="center"><?php echo $row1["ins1"]; ?>
  	  <td align="center"><?php echo $row1["mic2"]; ?></td>
      <td align="center"><?php echo $row1["ins2"]; ?>
	  
	   <input type="hidden" id="id6" name="id6" value="<?php echo $row1['id'];?>">
...
<td align="center"><a onclick="return confirm_click();" href="labmicroconfirm_endo?id=<?php echo $id; ?>"><strong>Complete Report</strong></a></td>
  </tbody>
</table>
</form>
