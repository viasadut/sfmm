...
//  echo "</td>";
 ...
 $date5=date('Y-m-d'); 
  ...
  $query43_o = "SELECT * FROM ot where pmrn= '$tt1' and date5='$date5' and status!='Cancel' order by id desc;"; 
...
echo "<td align='center' style='background-color:#eed7a1;font-size:12px;'></td>";
  ...
  echo '<td align="center" style="background-color:#eed7a1;font-size:16px;"><a target="_blank" href="pcovidresult?pmrn='.$tt1.'">';
  
  if($tt=="P" and $dcon=="confirmed" and $diff47<=4)
