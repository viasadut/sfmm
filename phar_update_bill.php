...
$query23 = "select * FROM phar_sale WHERE sno='$sno'"; 
...
if(isset($_POST['but_update'])){
			...
			$strSQL1 = "update phar_sale set b_status='Billed',b_by='$user',b_date='$bdate' where id='".$updateid."'";
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Instruction</strong></td>
		  ...
		  <td colspan="1" align="center"><strong>Unit Price</strong></td>
      	  <td colspan="1" align="center"><strong>Sale_Qty</strong></td>
	    ...
	    <?php 
                    $query = "select * from phar_sale where sno='$sno' order by id asc";
     ...
     <td align="center" colspan="1" style="font-weight: bold;font-size:22px;color:green"><?php echo $count; ?></td>
      ...
      <td align="center"colspan="8" style="font-weight: bold;font-size:22px;color:green"><?php echo $row["medi"].' ('.$row["brand"].')'; ?></td>
	  
<td align="center"colspan="1" style="font-weight: bold;font-size:22px;color:green"><?php echo $row["code"]; ?></td>


	  <td align="center"colspan="5" style="font-weight: bold;font-size:22px;color:green"><?php echo $row["ins"]; ?></td>
...
<td align="center"colspan="1"><input class="iprice" name="eqty3_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row['uprice'];?>" readonly style="font-weight: bold;font-size:22px;color:green"></td>			

<td align="center"colspan="1">



<input class="iquantity" name="eqty1_<?= $id ?>" onchange='subTotal()' id="eqty1" type="text" value="<?php echo $row['qty'];?>" readonly style="font-weight: bold;font-size:22px;color:green">




<td colspan="1" class='itotal' style="font-weight: bold;font-size:22px;color:green"></td>
