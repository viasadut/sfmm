...
$ins_query="insert into otdnote (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`pnote`,`user`,`status`) values ( '$pmrn','$id','$pname','$page','$adm','$psex','$pphone','$adate1','$inves','$pnote','$user','Data Updated')";
...
$count=1;
$sel_query="Select * from otdnote where pmrn= '$pmrn' and eid='$id'order by `id` DESC;";
