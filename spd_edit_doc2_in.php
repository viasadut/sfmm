...
$query = "SELECT * from ecg_test where lid='$lid'"; 
...
$update="update iinves set status='SEEN', report='$plaintext' where `id`='$id'";
mysqli_query($con,$update);

$update="update ecg_test set details='$cdetails', con_by='$fullname',con_time='$add_time' where `lid`='$lid'";
mysqli_query($con,$update);
