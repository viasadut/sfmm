...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`) values
 ...
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid')";
...
<input type="text" name="sid" id="email" class="input-text" placeholder="ID" size="70" value="">
...
<input type="text" name="ssent" id="datepicker" placeholder="Select Date" size="15" value="<?php echo $ss;?>">
