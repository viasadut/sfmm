...
$dname=$data['dname'];
$query2 = mysqli_query($db,"select * from doctor where dname='$dname'");
...
$pdf->Cell('183',6,$data['type'].' REPORT',1,1,'C');
...
$pdf->ln(4);
$pdf->SetFont('Arial' , 'b' , 12);
$pdf->Cell('63.5',5,$data2['degree'],0,0,'R');
$pdf->ln(4);
$pdf->SetFont('Arial' , 'b' , 12);
$pdf->Cell('113',5,$data2['Discipline'],0,0,'R');
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('40',5,'Refferal Consultant:',1,0,'L');
$pdf->Cell('141', 5,$data['dreffer'],1,1,'L');

$pdf->ln(5);

$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Detail Report:',1,1,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['report'],1,1);
...
$pdf->WriteHTML('<p align="center"><b>MY NAME</b></p><p align="center"><b style="background-color: rgb(0, 255, 255);">djfjkhdgkhjf</b></p>');
