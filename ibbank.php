...
$query5 = mysqli_query($db,"select * from iblood where pmrn='$pmrn' and eid='$eid'");
$r2 = mysqli_fetch_assoc($query5);
...
$ins_query="insert into iblood (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`bed`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','$infu1','Data Updated')";
...
<tr>
						...
						<td colspan="3"><label><strong>Cross match result:</strong></label></td>
						<td colspan="3"><label><strong>Screening result:</strong></label></td>
						<td colspan="3"><label><strong>Bag issued:</strong></label></td>
						<td colspan="3"><label><strong>Expiry date:</strong></label></td>
						<td colspan="2"><label><strong>Update</strong></label></td>
...
<td colspan="3" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["infusion"] ; ?>"readonly/></td>
			<td colspan="3" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["room"] ; ?>"readonly/></td>
			<td colspan="3" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["room"] ; ?>"></td>
			<td colspan="3" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["room"] ; ?>"></td>
			<td colspan="3" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["room"] ; ?>"></td>
			<td colspan="3" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["room"] ; ?>"></td>
			<td colspan="2" align="center"><input name="rr1" type="text" size="15" value="<?php echo $r2["room"] ; ?>"></td>
