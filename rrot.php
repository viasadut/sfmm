...
$(document).ready(function() {
	 ...
	 */
	$.ajax({
		url : "http://192.168.100.252:8081/sfmm/rr1ot.php?pmrn=<?php echo $pmrn?>&eid=<?php echo $eid?>&odate1=<?php echo $odate1?>",
//		var pmrn =data.pmrn;
		type : "GET",
		success : function(data){
			...
			for (var i = 0; i < len; i++) {
				if (data[i].vitails1 == "RR") {
					score1.RR.push(data[i].score1);
				}
