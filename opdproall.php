...
$sel_query="Select * from procedure1 where pphone= '$pmrn' and ustatus='paid' and dname='$full'";}
 else{
	 $sel_query="Select * from procedure1 where pmrn= '$pmrn' and ustatus='paid' and dname='$full';";
 } 
$count=1;	 
