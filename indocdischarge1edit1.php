...
$url = "indocdischarge1edit?pmrn=$pmrn&eid=$eid" ;
...
$update="update idischarge1 set dname='$dname', ddate='$date1', discharge='$discharge',ddia='$ddia', surgery='$surgery', ill='$ill', other='$other', plan='$plan', dinves='$dinves',refer='$refer' where `eid`='$eid' and pmrn='$pmrn'";
