...
if($eeqty<$pdos2)
{
    ...
    echo '</script>';
		...
		$ins_query1="Update cafesale set eqty='$pdos2',tprice='$tprice1',ptype='DUE' where sid='$sid' and ename='$ename'";
...
$ins_query1="insert into cafesale (`sid`,`ename`,`eqty`,`sdate`,`tprice`,`eby`,`ptype`) values ('$sid','$ename','$eqty','$sdate','$tprice','$user','DUE')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
