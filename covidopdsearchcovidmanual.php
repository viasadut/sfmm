...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covid1opd2covidpmanual?id=<?php echo $row["id"]; ?>&rd=<?php echo $rd; ?>">Add New Record</a> </td>
