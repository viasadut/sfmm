...
$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`ac_no`) 
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no')";
...
$url = "p4new1?pmrn=$pmrn&eid=$count1&dname=$dname3" ;
header("Location:$url");
...
<!-- Form Title -->
	  ...
	  <option value='Dr. Roeyna Afroz'>Dr. Roeyna Afroz</option>
