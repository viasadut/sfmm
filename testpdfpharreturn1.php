...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"Select * from iinfusion where pmrn= '$pmrn' and eid='$eid'and status ='Returned' and status1 in('Active','Cancel') and pstatus='Served' order by `infusion` asc;",$prop);
$pdf->Output();
?>