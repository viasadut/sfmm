...
$query43 = "SELECT COUNT(ID) FROM pappnew where adate1 BETWEEN '$start' and '$end' and status='SEEN';"; 
...
$query44 = "SELECT COUNT(ID) FROM pappnew where adate1 BETWEEN '$start' and '$end' and status IN ('Cancel');"; 
...
$query45 = "SELECT COUNT(ID) FROM pappnew where adate1 BETWEEN '$start' and '$end' and status NOT IN ('Cancel','SEEN','HISTORY UPDATED');"; 
...
$query46 = "SELECT COUNT(ID) FROM pappnew where adate1 BETWEEN '$start' and '$end';"; 
	 
$result46 = mysqli_query($con, $query46) or die(mysqli_error());
$row46=mysqli_fetch_assoc($result46);

$query47 = "SELECT COUNT(ID) FROM pappnew where adate1 BETWEEN '$start' and '$end' and status in ('HISTORY UPDATED');"; 
...
<h1 align="center">Appointment VS SEEN PATIENT STATS</h1>
...
echo "<font color=blue font size=5> Total Appointment -";
echo   $row46['COUNT(ID)'];
echo"<br>";

echo "<font color=green font size=5> Total Seen Patient -";
echo   $row43['COUNT(ID)'];
echo"<br>";

echo "<font color=red font size=5> Appointment Cancelled -";
echo   $row44['COUNT(ID)'];
echo"<br>";

echo "<font color=red font size=5> History Updated -";
echo   $row47['COUNT(ID)'];
echo"<br>";

echo "<font color=orange font size=5> NOT SEEN -";
echo   $row45['COUNT(ID)'];
echo"<br>";

echo "<font color=black font size=5> date -";
echo $start;
echo "  To  ";
echo $end;

$sel_query="Select * from pappnew where  adate1 BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
      ...
      echo '<span style="color:green">'.$row["status"].'</span>'; }
        ...
        else if($row['status']!='Cancel' and $row['status']!='Cancel'){
