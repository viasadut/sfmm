...
$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card1`,`card2`,`acard`,`type`,`anew`)
values ('$dname', '$pname','$pmrn','$padd','$gender','$page','$adate','$btype','$bno','$count1','$pphone','$aadate','$vcard','$vcard1','$acard','$staff','$anew')";
