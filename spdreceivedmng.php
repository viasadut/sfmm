...
$query43 = "SELECT COUNT(medi) FROM alltest where medi= '$bt' and date1 BETWEEN '$start' and '$end' and type='SPD1';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query433 = "SELECT COUNT(medi) FROM alltest where medi= '$bt' and date1 BETWEEN '$start' and '$end' and type='SPD1' and status in ('RECEIVED','SEEN');"; 
...
$query44 = "SELECT COUNT(medi) FROM alltest where date1 BETWEEN '$start' and '$end'  and type='SPD1';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44=mysqli_fetch_assoc($result44);

$query444 = "SELECT COUNT(medi) FROM alltest where date1 BETWEEN '$start' and '$end'  and type='SPD1' and status in ('RECEIVED','SEEN');"; 
	 
$result444 = mysqli_query($con, $query444) or die(mysqli_error());
$row444=mysqli_fetch_assoc($result444);
...
<h1 align="center">Number of SPD Request Report</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<?php 
			$sql = "select * from `radio` where type='SPD1'";
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>SPD NAME</strong>
	  <th width="14%"><strong>Received By</strong>
<th width="14%"><strong>Received Time</strong> 
	   </tr>
  </thead>
  <tbody>
...
echo   $row44['COUNT(medi)'];
echo "<font color=blue font size=5> , Received  -";
echo   $row444['COUNT(medi)'];
echo " ,  From  ";
echo date('d/m/Y', strtotime($start));
echo "  To  ";
echo date('d/m/Y', strtotime($end));

$sel_query="Select * from alltest where  date1 BETWEEN '$start' and '$end'  and type='SPD1' order by date desc";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['COUNT(medi)'];

echo "<font color=blue font size=5> , Received  -";
echo   $row433['COUNT(medi)'];
echo " ,  From  ";
echo date('d/m/Y', strtotime($start));
echo "  To  ";
echo date('d/m/Y', strtotime($end));
	 $sel_query="Select * from alltest where medi='$bt' and date1 BETWEEN '$start' and '$end' and type='SPD1' order by date desc";
 } 
$count=1;
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["rby"]; ?>  
