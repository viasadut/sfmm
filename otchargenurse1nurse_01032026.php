...
*/
$sql = "insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`,`remarks`,`ip`,`op`,`acct_code`,`ccentre`,`user`) values 
('$pmrn','$pname','$ii','$eid','$date1','$pdos','$code','$t_price','$date2','$sub_type','Package','$ip','$op','$acode','$ccentre','$user')";
...
$sql = "insert into inhoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`type`,`ip`,`op`,`acct_code`,`ccentre`,`user`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode','$p11','$date2','$sub_type','$ip','$op','$acode','$ccentre','$user')";
