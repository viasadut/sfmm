...
$count=1;
$sel_query="Select * from test where dname='$bt' and ddate ='$start' order by id;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="delete.php?id=<?=$row["id"];?>" onclick="return confirm(‘Are you sure?’);">Delete</a></td>
...
$query11 = "DELETE FROM test WHERE id=$id1"; 
