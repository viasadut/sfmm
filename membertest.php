...
doj='".$doj."',department='".$department."',sdepartment='".$sdepartment."',designation='".$designation."',hod='".$hod."',astatus='".$astatus."',stype='".$stype."',perdis='".$perdis."',uby='".$user."',category='".$category."',religion='".$religion."',ugroup='".$ugroup."' where sid='$sid'";
		//$mysqli->query($sql);
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<td colspan="4">	<input type="text" name="dob" id="datepicker" class="input-text" placeholder="Date Of Birth" value="<?php echo $row['doj'] ?>" required></td>
...
<tr><td align="left" colspan="20"><a target='_blank' href="seducation?sid=<?php echo "$sid"; ?>"><b>Education Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="straining?sid=<?php echo "$sid"; ?>"><b>Training Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="spromotion?sid=<?php echo "$sid"; ?>"><b>Promotion Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="stransfer?sid=<?php echo "$sid"; ?>"><b>Transfer Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="snid?sid=<?php echo "$sid"; ?>"><b>Upload NID / Passport<b></a></td></tr>
<tr>
