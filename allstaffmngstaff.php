...
$count=1;
$sel_query="Select * from staff1 where astatus ='Active' and ugroup in('doctor','imo','emo','mofficer')order by ID desc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="memberview1mngstaff3?sid=<?php echo $row["sid"]; ?>"><b>Details<b></a></td>
