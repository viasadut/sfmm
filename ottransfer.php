...
$ins_query1="insert into newbed (`dname`,`pname`,`pmrn`,`adate`,`type`,`bno`,`eid`,`adate1`) values ('$dname', '$pname','$pmrn','$adate','$btype','$bno','$eid','$adate1')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$update2="update bed set status='Vacant', pname='',pmrn='', adate='', dname=''where bno='$oldbed'";
...
$update23="update ot set room2='$btype', room3='$bno',tby='$user', ttime='$time' where pmrn='$pmrn' and id='$id'";
...
<input name="psex" type="text" size="15" value="<?php echo $data["room"]; ?>"readonly>
      ...
      <input name="dname" type="text" size="65" value="<?php echo $data["dname"]; ?>"readonly>									
