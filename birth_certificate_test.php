...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        //$this->Ln(50);
        $this->Image('logo1.jpg', 25, 30, 20, 20, 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
    ...
    public function Footer() {
		...
		$this->Cell(0, 10, 'Contact Numbers: Ambulance: +880244077029, +8801896317401, Appointments: +880244077030, +8801703788561 (KPJDHAKA/NSG/MR-30)', 0, false, 'C', 0, '', 0, false, 'T', 'M');
//        $this->Cell(0, 10, 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
...
<tr>
    <td align="left" width="100%"><b>Name and Signature of certifying Doctor<br>'.$data['dname'].'
