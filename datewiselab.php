...
$query43 = "SELECT COUNT(medi) FROM alltest where date1 BETWEEN '$start' and '$end' and type='lab';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(infusion) FROM iinves where ndate BETWEEN '$start' and '$end' and type='lab';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(infusion) FROM einves where ndate BETWEEN '$start' and '$end' and type='lab';"; 
...
$query43r = "SELECT COUNT(medi) FROM alltest where date1 BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED' and dname !='Outside Referral';"; 
...
$query43rr = "SELECT COUNT(medi) FROM alltest where date1 BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED' and dname ='Outside Referral';"; 
	 
$result43rr = mysqli_query($con, $query43rr) or die(mysqli_error());
$row43rr = mysqli_fetch_assoc($result43rr);


$query44r = "SELECT COUNT(infusion) FROM iinves where ndate BETWEEN '$start' and '$end' and type='lab'and rstatus='RECEIVED';"; 
	 
$result44r = mysqli_query($con, $query44r) or die(mysqli_error());
$row44r = mysqli_fetch_assoc($result44r);


$query45r = "SELECT COUNT(infusion) FROM einves where ndate BETWEEN '$start' and '$end' and type='lab' and rstatus='RECEIVED';"; 
...
$sel_query1="Select * from alltest where date1 BETWEEN '$start' and '$end' and type='lab' order by id";
...
{ ?>    <tr>
	...
	$sel_query2="Select * from iinves where ndate BETWEEN '$start' and '$end' and type='lab' order by id";
...
{ ?>    <tr>
	...
	<?php
	$sel_query3="Select * from einves where odate BETWEEN '$start' and '$end' and type='lab' order by id";
