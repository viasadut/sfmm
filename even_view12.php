...
{ ?>    <tr>
	  ...
	  <td colspan="1"align="center"><a href="package_inves?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">Diabetes</a></td>
  	  <td colspan="1"align="center"><a href="#package_inves_cancer?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">Cancer Day</a></td>
