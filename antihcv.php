...
$ins_query1="insert into antihcv (`pname`,`pmrn`,`psex`,`page`,`result`,`opinion`,`inter`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`type`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Anti-HCV- Report:</strong></label>
