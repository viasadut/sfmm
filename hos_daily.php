...
{ ?>    <tr>
	...
	<td colspan="2" align="center"><a onclick="return confirm_click();" href="todoupdate?id=<?php echo "$row[id]"; ?>&pmrn=<?php echo "$row[pmrn]"; ?>&eid=<?php echo "$row[eid]"; ?>"><strong>DONE</strong></a></td>	        
