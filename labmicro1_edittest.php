...
<td align="center"><a onclick="return confirm_click();" href="micro_edit_del?id2=<?php echo $row1["id"]; ?>&id=<?php echo $id; ?>&pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><strong>Delete</strong></a></td>
