...
$query43 = "SELECT COUNT(dname) FROM presnew where dname= '$bt' and date BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from pappnew where dname='$bt' and date BETWEEN '$start' and '$end'";
