...
<!-- Form Title -->
		...
		<fieldset>
			...
			<select name="dname" id="groupSelect" value="" required readonly onchange="showUser()">
...
<!-- E-mail Input -->
			<label for="mail"><strong>Appointment Date :</strong></label>
									...
									<input type="date" name="date" id="userSelect" placeholder="Select Date" value="<?php echo date('m/d/Y', strtotime($date2));?>" required onchange="showUser()">
<!-- Password Input --><!-- Age Dropdown -->
			...
			<select id="txtHint" name = 'select[]' multiple size=60>   
...
function showUser() {
    ...
    var q = document.getElementById('userSelect').value;
    var q1 = document.getElementById('groupSelect').value;
    ...
    xmlhttp.open("GET","getuser_unblock.php?q="+q+"&q1="+q1,true);
    xmlhttp.send();
}
</script>
