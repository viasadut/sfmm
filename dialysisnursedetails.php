...
$url = "dialysishoscharge?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
...
$url = "histo1endo1?pmrn=$pmrn&dname=$dname&eeid=$eid";
header("Location: $url");
}
...
$url = "dialysisconsent?pmrn=$pmrn&pro=$pro&eeid=$eid&dname=$dname";
header("Location: $url");
}
...
{
$url = "dialysischargehos?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
<?php
...
{
$url = "dialysisnurseassess?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdnotenurse?pmrn=$pmrn&eid=$eid&ID=$ID";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocmedi?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocinfusion?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "dialysisdocsorder?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
{
$url = "chemovitals?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
?>
...
$url = "dialysisnotenurse?pmrn=$pmrn&ID=$ID";
header("Location: $url");
}
?>
<?php
...
<td colspan="4" align="center"><button type="submit" name="Submit690">Medication Ordered</button></td>
<td colspan="4" align="center"><button type="submit" name="Submit66">Infusion Ordered</button></td>
