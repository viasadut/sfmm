...
$sel_query="Select * from dialysispapp where adate= '$date'  and status='NOT SEEN' ORDER BY aslot asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["status"];?> </td> 
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="dialysisreceive?ID=<?php echo $row["ID"]; ?>">RECEIVE PATIENT</a> </td>
