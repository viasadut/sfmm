...
$query = "UPDATE iinves set rby='$user',rtime='$dtime', rstatus='RECEIVED', barcode='$result5', barcode1='$result5',status='RECEIVED',otime='$dtime1' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());



$url = "lab_indu_bar_ipd?id=$id";
header("Location: $url"); 
...
<td colspan="4" align="center"><input type="text" name="result" required value="<?php echo $data45['id'].''.date('dY');?>"readonly></td></td>	  
