...
$ins_query1="insert into covid_t (`pname`,`pmrn`,`psex`,`page`,`pvalue`,`cvalue`,`inter`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`type`) values 
...
<!-- Form Title -->
		<h1>Covid-19 Total Antibody Test Form </h1>
	  ...
	  <label for="age"><strong>Covid-19 Total Antibody Test Report:</strong></label>
	  <br><br>
      ...
      <input name="chikun1" type="text" size="70"  value=""required>
	  <label for="tibc"><strong>Cut Off Value</strong></label>
      <input name="chikun2" type="text" size="70"  value="0.160"required>
	  <label for="tibc"><strong>Interpretation</strong></label>
      <input name="chikun3" type="text" size="70"  value=""required>
