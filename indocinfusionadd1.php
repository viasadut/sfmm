...
$sel90="SELECT * FROM iinfusion WHERE `id`='$id';";
...
$url = "imoidocinfusion.php?pmrn=$pmrn&eid=$eid";
...
$ins_query="insert into iinfusion (`pmrn`,`eid`,`pname`,`odate`,`infusion`,`user`,`room`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`code`,`a_d_c_1`,`a_d_c_2`) 
values ( '$pmrn','$eid','$pname','$odate','$infu','$orderby','$infuqty','Data Updated','$alert','Active','$odate','$stime','$add1','$etime','$infu1','$add2','$qty1','$qty2','Ordered','$i_code','$a_c_1','$a_c_2')";
