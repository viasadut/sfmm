...
$query43 = "SELECT COUNT(sid) FROM covidopd where tresult='P'"; 
...
echo   $row43['COUNT(sid)'];
	 ...
	 $sel_query="Select * from covidopd where tresult='P' order by ssent desc;";
...
<?php $count++;  }?>
      ...
      <td colspan ="2" align="right"><a target='_blank' href="test_pdf"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
