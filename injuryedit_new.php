...
$sel44="SELECT * FROM patient WHERE `pmrn`='$pmrn' ;";
...
$ins_query="update injury set `fdate`='$adate',`remark`='$remark',`ddate`='$ddate',`dtime`='$dtime',`diagnosis`='$diag',`ffor`='$ifind',`fdate1`='$atime',eid='$eid',pname='$pname', where id='$id'";
...
<label for="age"><strong>Patient's Name :</strong></label>
      <input name="pname" type="text" size="80" value="<?php echo $row4["pname"]; ?>" readonly/>          
...
<label for="age"><strong>Patient's Details (MRN/Gender) :</strong></label>
	  ...
	  <input name="sex" type="text" size="15" value="<?php echo $row4["psex"]; ?>"readonly/>
...
<label for="name"><strong>Admitted Through:</strong></label>
			...
			<label for="mail"><strong>Visit / Admission Date :</strong></label>
									<p>
									  <input type="text" name="adate" id="datepicker" placeholder="Select Date" size="8" value="<?php echo $row3['fdate'];?>" required>
      ...
      <textarea rows="5"  name="diag" required><?php echo $row3['diagnosis'];?></textarea>
		...
		<label for="mail"><strong>Discharge Date:</strong></label>
									<p>
									  <input type="text" name="ddate" id="datepicker1" placeholder="Select Date" size="8" value="<?php echo $row3['ddate'];?>" required>
