...
if($rr=='')
    ...
    echo 'alert("RFID Not Matched OR already in use"); ';
...
$select1="insert into storenew (`msno`,`ename`,`ename1`,`etype`,`c_loc`,`rfid`,`supplier`,`p_by`,`category`)
values('$msno','$ename','$ename','Asset','$location','$rfid','$vendor','$from','$cat')";
$sel1=mysqli_query($con,$select1) or die(mysql_error());

$ins_query1r="update rfid set status='1' where rfid='$rfid' and use_for='Asset Tag'";
...
if($rr=='')
	...
	$ins_query1="update storenew set rfid='$rfid',category='$cat' where id ='$employee_id'";
...
<p align="right"><div2><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style='background-color:green;font-size:20px;'>Add New</button></div2></p>
...
<td align="center"colspan="1"><input type="button" name="edit" value="Edit" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs edit_data" style='background-color:lightgreen;font-size:20px; align:center;'></td>  		  	  	  
...
<div id="dataModal" class="modal fade">  
 ...
 <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog"style="width:800px;">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal"style="width:80px;">&times;</button>  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form" name="frmMain2">  
						  ...
						  <select name="cat" id="cat" class="form-control" required style="font-size:18px;color:red;" value=''>
...
<script>  
 ...
 <div class="modal-body" >  
                     <form method="post" id="insert_form" name="frmMain2">  
                          <label>Equipment ID </label>  
                          <input type="text1" name="eid" id="name" class="form-control" size="15" readonly>  
                          
						  <label>MSNO</label>  
                          <input type="text1" name="msno" id="code" class="form-control"  size="15">  
						  
						  
                          <label>Equipment Name</label>  
                          <input type="text1" name="ename" id="address" class="form-control"  size="15"required style="font-size:22px;color:red;">  
                          
						  <label>Category</label>  
                         
						  
						  <select name="cat" id="cat" class="form-control" required style="font-size:18px;color:red;" >
        <option value=''>-Select-</option>
		<option value='Medical Equipment'>Medical Equipment</option>
		<option value='Furniture'>Furniture</option>
		<option value='Office Tool'>Office Tool</option>
						  ...
						  <select name="location" id="result" class="form-control" required style="font-size:18px;color:red;" >
        <option value=''>-Select-</option>
		<?php 
			...
			?>
						  ...
						  <label>Vendor</label>  
                          <input type="text1" name="vendor" id="ins1" class="form-control" required />  
						  
						  
						  <label>From</label>  
                          <input type="text1" name="from" id="ins" class="form-control" required style="font-size:22px;color:red;">  
                          ...
                          <br>
                          <input type="submit" name="insert7" id="insert45" value="ADD" class="btn btn-success">  
                     </form>  
                </div>  
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal" style="width:80px;">Close</button>
