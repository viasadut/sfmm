...
<!-- Form Title -->
	  ...
	  <label for="age"><strong><SPAN STYLE="font-size:18.0pt">Patient Category:</span><?php if($data['type']=='VIP'){echo "<span style='color:red;text-align:center;font-size:18pt;'><b>VIP"; }else if($data['type']=='Staff'){echo "<span style='color:green;text-align:center;font-size:18pt;'><b>Staff"; }else {echo "<span style='color:green;text-align:center;font-size:18pt;'><b>General";} ?></a></strong></label>
