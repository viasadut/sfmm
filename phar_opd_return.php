...
$pid=$_REQUEST['sno'];
$query23 = "select * FROM phar_sale WHERE sno='$pid'"; 
...
$eqty2 = $_POST['eqty1_'.$updateid];
	...
	$chk=mysqli_query($db,"SELECT * FROM phar_sale where id='".$updateid."'");
...
$qq1 = mysqli_query($db,"select * from medi_stock where rfid='$m_rfid' and location='Pharmacy' order by id asc limit 1");
...
$rdate = date('Y-m-d H:i:s');			
			...
			if($rqty=='0' and $eqty2<=$mqty)
	{
			
			
			
			$strSQL = "update medi_stock set add_qty='$u_qty' where id='$mid' and location='Pharmacy'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
			
			
			
			$strSQL2 = "update phar_sale set r_qty='$eqty2',r_by='$user',r_date='$rdate' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
...
//header("Location:$url");
	...
	else if($rqty>0 and $new_rqty<=$mqty)
	{
			...
			//$strSQL1 = "update pmedi set status='Returned',r_qty='$eqty2' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			//$objQuery1 = mysqli_query($objConnect,$strSQL1);

			
			$strSQL2 = "update phar_sale set r_qty='$new_rqty',r_by='$user',r_date='$rdate' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery2 = mysqli_query($objConnect,$strSQL2);
...
<tr>
      ...
      <td colspan="8" align="center"><strong>Medicine Name</strong></td>
     	  ...
     	  <td colspan="7" align="center"><strong>Sold Qty</strong></td>
		  
      	  <td colspan="1" align="center"><strong>return_Qty</strong></td>
	    ...
	    <?php 
                    $query = "select * from phar_sale where sno='$sno'";
...
$query1 = "select * from medicine where mname='$medi' and status='Active'";
     ...
     <td align="center" colspan="1" style="font-weight: bold;font-size:22px;color:green"><?php echo $count; ?></td>
      ...
      <td align="center"colspan="8" style="font-weight: bold;font-size:22px;color:green"><?php echo $row["medi"]; ?></td>
	  
	  <td align="center"colspan="7" style="font-weight: bold;font-size:22px;color:green"><?php echo $row["qty"]; ?></td>
...
<input name="eqty1_<?= $id ?>" type="text" value="<?php echo $va;?>" id="eqty1" required <?php if($row1['tqty']>0){echo'style="font-weight: bold;font-size:22px;color:green"';} else{echo'style="font-weight: bold;font-size:22px;color:red"';}?><?php echo $readOnly;  ?> ></td>                            
	...
	<tr>
	<td colspan="10"align="right"><a target='_blank' href="phar_receipt_return?sno=<?php echo $sno;?>"><img src="phar_pic/print.png" title="Print Receipt" width="100" height="80" /></a>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="medi_ins_return?sno=<?php echo $sno;?>"><img src="phar_pic/barcode.png" title="Print Instruction" width="100" height="80" /></a>
