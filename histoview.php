...
$query39 = "SELECT * FROM histo where pmrn= '$pmrn' and eid='$eid'"; 
...
$update33="update histo set `cinfo`='$cinfo',`spe`='$spe',`gdes`='$gdes',`mdes`='$mdes',`twork`='$twork',`dia`='$dia',`status`='REPORT DONE'where `pmrn`='$pmrn' and `eid`='$eid'";
...
<tr>				 <td colspan="10"><input type="text" name="pname"  value="<?php echo $row39['pname'];?>" readonly/></td>
				...
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><input type="text" name="hno" style="text-transform:uppercase" required value="<?php echo $row39['hno'];?>" /></td>  </tr>
						 
						 <tr><td colspan="20"><label><strong>Specimen:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="spe" rows="5"><?php echo $row39['bio2'];?></textarea></td>  </tr>
						<tr><td colspan="20"><label><strong>Gross Description:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="gdes" rows="5"><?php echo $row39['gdes'];?></textarea></td>  </tr>
				<tr><td colspan="20"><label><strong>Microscopic Description</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="mdes" rows="5"><?php echo $row39['mdes'];?></textarea></td>  </tr>
														<tr><td colspan="20"><label><strong>Tumor Workup:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="twork" rows="5"><?php echo $row39['twork'];?></textarea></td>  </tr>

<tr><td colspan="20"><label><strong>Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="dia" rows="5"><?php echo $row39['dia'];?></textarea></td>  </tr>
...
<tr>
	 ...
	 <td colspan="10"><a target='_blank' href="historeport.php?pmrn=<?php echo $row39['pmrn']; ?>&dname1=<?php echo "$full"; ?>&eid=<?php echo $row39['eid']; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a>
	 <a target='_blank' href="histo_photo.php?pmrn=<?php echo $row39['pmrn']; ?>&eid=<?php echo $row39['eid']; ?>">Upload Image</a></td>	
