...
$query43 = "SELECT COUNT(pmrn) FROM dietass where assdate BETWEEN '$start' and '$end' and dname='$full';"; 
...
$sel_query="Select * from dietass where assdate BETWEEN '$start' and '$end' and dname='$full'order by adate";
