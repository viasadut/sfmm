...
$query3 = "SELECT * FROM hos_discount where pmrn= '$pmrn' and eid='$eid' and date='$date1' and medi='$medi1' and location='AE'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM hos_discount where pmrn= '$pmrn' and eid='$eid' and date='$date1'and medi='$medi1' and location='AE'"; 
...
$ins_query1="insert into hos_discount (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`,`dname`,`location`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$price','$dcode','$price','$date2','$user','$time','$adoc','AE')";
mysqli_query($con,$ins_query1) or die(mysql_error());


$ins_query2="update emergency set hos1_dis='$in_price' where pmrn='$pmrn' and eid='$eid'";
mysqli_query($con,$ins_query2) or die(mysql_error());

//$ins_query="update preadm set dia1='$inves',`cinfo`='Improving',ddin='$adate2',ddrequest='Request',arequest='$price',aid='$sid',drsend='$drsend' where pmrn='$pmrn' and eid='$eid'";
//mysqli_query($con,$ins_query) or die(mysql_error());
}



else if($user!='' and $medi!='DD Fund'){
  $ins_query1="insert into hos_discount (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`,`dname`,`location`) values 
  ('$pmrn','$pname','$medi1','$eid','$date1','$price','$dcode','$price','$date2','$user','$time','$adoc','AE')";
  mysqli_query($con,$ins_query1) or die(mysql_error());
...
<td colspan="10" align="center"><select name="item" class="con_charge" id="pmrn" onchange="GetDetail(this.value)">
			...
			*/?>
      			<option value='Hospital Discount'>Hospital Discount</option>
...
<td colspan="10" align="center"><input type="number" name="price" value="" id="remarks" required max="<?php echo $bill;?>">
...
$count=1;
$sel_query="Select * from hos_discount where pmrn= '$pmrn' and eid='$eid' order by `date` DESC;";
