<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mng','doctor','qc','mrd','covid','covid1','call','bill')"; 
...
$count=1;
$sel_query="Select * from covidopd where sid= '$pmrn' order by ID desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php if($row['tresult']!='' and $row['dconfirm']=='confirmed'){echo"<a target='_blank' href='$url'><img src='print.png' title='Print Report' width='50' height='25' /></a>";}else{echo'Report Pending';} ?></td>
      </tr>
    <?php $count++; } }?>
  </tbody>
</table>
