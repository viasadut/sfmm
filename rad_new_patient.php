...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where type='rad' and status='' and pmrn='$pmrn' order by pmrn desc ;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from radpapp where status='NOT SEEN' and pmrn='$pmrn' order by pmrn desc ;";
