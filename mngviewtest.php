...
<td align="center"<?php if($count77>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:WHITE;" <?php endif ; ?>><a href="ipallmng?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">DETAILS</a></td> 
	<td  align="center"<?php if($count55>0): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightgreen;" <?php endif ; ?>><a class="blink" href="feedback?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><div3>Feedback</div3></a></td>  
