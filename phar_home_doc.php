...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','pharmacy','staff')"; 
...
$edate=date("Y-m-d", strtotime("$end_date -30 days"));
...
<div class='grid-item'>
<span class=''><img src='phar_pic/medicine_png.png' title='Available Generic' height='60' width='75'align='center'></span><br>
<span style="color:black;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href='pendingrequest_doc'>Pending Add Request</a></span>
<br>
...
<div class='grid-item'>
<span class=''><img src='phar_pic/medicine_png.png' title='Available Generic' height='60' width='75'align='center'></span><br>
<span style="color:black;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href='editrequestpending_doc'>Pending Edit Request</a></span>
<br>
