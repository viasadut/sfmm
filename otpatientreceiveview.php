...
<td colspan="15" align="center"> <textarea rows="5" name="belongings"><?php echo $row39['belongings'];?></textarea></td>
<br>

<br>
<label for="age"><strong>Is This The Correct Patient: <?php echo $row39['rpatient'];?></strong></label><br>


<label for="age"><strong>Name Tag In Position and Correct: <?php echo $row39['ntag'];?></strong></label><br>



<label for="age"><strong>Operation Consent Form Signed Doctor / Patient: <?php echo $row39['oconsent'];?></strong></label><br>




<label for="age"><strong>Operation Site Prepared: <?php echo $row39['osite'];?></strong></label><br>




<label for="age"><strong>Dentures Removed: <?php echo $row39['dremove'];?></strong></label><br>




<label for="age"><strong>Hair Clips/Make-up Etc Removed: <?php echo $row39['hremove'];?></strong></label><br>





<label for="age"><strong>Jewellary Removed and Recorded: <?php echo $row39['jremove'];?></strong></label><br>




<label for="age"><strong>Artificial Eye-Contact Lenses Removed: <?php echo $row39['aremove'];?></strong></label><br>




<label for="age"><strong>Hearing Aides to accompany patient and handed over to theater nurse: <?php echo $row39['ha'];?> </strong></label><br>



<label for="age"><strong>LSCS: Paediatrician Informed: <?php echo $row39['lscs'];?></strong></label><br>



<label for="age"><strong>Blood Reservered: <?php echo $row39['breservered'];?></strong></label><br>




<label for="age"><strong>Last Meal Or Drink Taken: <?php echo $row39['lmeal'];?></strong></label><br>

<label for="age"><strong>Lab Report Taken: <?php echo $row39['lreport'];?></strong></label><br>

<label for="age"><strong>Radiology Report Taken: <?php echo $row39['rreport'];?></strong></label><br>

<label for="age"><strong>Site Marking Taken: <?php echo $row39['smarking'];?></strong></label><br>
