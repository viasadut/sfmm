...
$querym = "SELECT COUNT(sid) FROM covidopd where ssent='$rd'"; 
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`udone`,`btime`,`nid`) values
 ...
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','09:00AM','Health Care Employee','$bgroup','$bstatus','$user','$adate','$nid')";
...
$ins_query1="insert into covidopd (`sid`,`cp`,`name`,`psex`,`page`,`phone`,`padd`,`district`,`ward`,`symptom`,`phyper`,`pdm`,
`asthma`,`copd`,`mali`,`other`,`ssent`,`ssent1`,`sentto`,`specimen`,`ldate`,`ldate1`,`pcase`,
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','09:00AM','Health Care Employee','$bgroup','$bstatus','$nid')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`udone`,`btime`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','10:00AM','Health Care Employee','$bgroup','$bstatus','$user','$btime','$nid')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','10:00AM','Health Care Employee','$bgroup','$bstatus','$nid')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`udone`,`btime`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','11:00AM','Health Care Employee','$bgroup','$bstatus','$user','$btime','$nid')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','11:00AM','Health Care Employee','$bgroup','$bstatus','$nid')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`udone`,`btime`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','12:00PM','Health Care Employee','$bgroup','$bstatus','$user','$btime','$nid')";
...
`advice`,`atime`,`email`,`aby`,`adate`,`sam`,`tp`,`desig`,`dept`,`ssid`,`apdate`,`aptime`,`pro`,`bgroup`,`bstatus`,`nid`) values
 ('$max1','$cp','$name','$psex','$page','$phone','$padd','$district','$ward','$lx','$phyper','$pdm','$asthma','$copd','$mali',
 '$other','$ssent','$ssent1','$sentto','$specimen','$ldate','$ldate1','$pcase','$advice',
 '$adate','$email','$user','$adate1','$sam','$tp','$desig','$dept','$ssid','$ssent','12:00PM','Health Care Employee','$bgroup','$bstatus','$nid')";
