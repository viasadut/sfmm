...
$query = mysqli_query($db,"select * from death where id='$id'");
...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers:  Ambulance:  +880244077029, +8801791987466, Appointments: +880244077030, +8801703788561 (SFMMKPJSH/A&E/MR-04)',0,0,'C');
...
$pdf->Cell('67',5,$data['name'],1,0,'L');
$pdf->Cell('11',5,'MRN:',1,0,'L');
$pdf->Cell('17',5,$data['pmrn'],1,0,'L');
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('82',5,'Name and Signature of certifying Doctor:',0,1,'L');
$pdf->Cell('70',5,$data['rdoc'],0,1,'L');
$pdf->ln(2);

/*$image3 = $data['rdoc'].'.jpg';
if($image3==$data['rdoc'].'.jpg')
{
$pdf->Cell( 100, 13, $pdf->Image($image3, $pdf->GetX(), $pdf->GetY(), 30.78), 0, 0, 'L', false );
}
*/

$pdf->Cell('182',5,'**Corrected Copy**',0,1,'R');
