...
$count=1;
$y=date('Y');
$sel_query="Select * from dleave where hstatus NOT IN ('Approved By HOS','Rejected By User','Rejected By HOS','Confirmed By TM','Cancelled By TM','Rejected By TM') and cyear='$y' and uname !=''";
//$start=$row["aadate"];
...
{echo'
<a onclick="return confirm_click();" href="leaveapprove1_test2?id='.$row["id"].'&uname='.$row["uname"].'&type='.$row["type"].'&bal='.$row["total"].'"><strong>Confirm</strong></a>';
}
