...
$query159 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and discharge=''");
$data159 = mysqli_fetch_assoc($query159);
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="delete2?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
