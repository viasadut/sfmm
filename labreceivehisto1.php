...
$query = "UPDATE iinves set rby='$user',rtime='$dtime', rstatus='RECEIVED', barcode='$result5',status='RECEIVED' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());

//$url = "sample_receive_print?pmrn=$pmrn&eid=$eid&id=$id";
$url = "bar_print_histo_in?id=$id";
header("Location: $url"); 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="20"><?php echo $dname;?></td></tr>
...
<tr><td colspan="20"><?php echo $data["padd"]; ?></td></tr>
		...
		<tr>
						...
						<tr>				
						<td colspan="5"><?php echo $data6["age"]; ?></td>  
             		<td colspan="3"><?php echo $data45["padmission"]; ?></td>					 	
