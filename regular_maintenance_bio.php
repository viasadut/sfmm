...
$ins_query1="Update biom set solvetime='$adate1',btime='$stime',bioby='$user',bremarks='$fremarks',remarks='$estatus',rm='Regular Maintenance' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());


$ins_query2="insert into store1 (`ename`,`eid`,`elocation`,`etype`,`eqty`,`estatus`,`bremarks`,`solvetime`,`btime`,`bioby`,`rm`) values 
('$ename','$eid','$elocation','$etype','','$estatus','$fremarks','$adate1','$stime','$user','Regular Maintenance')";
...
<!-- Form Title -->
		<h1>Regular Maintenance Note</h1>
