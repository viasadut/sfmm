...
$date= date('m/d/Y');
$count=1;
$sel_query="Select distinct dname from doctor where status='Active' and opd='$opd' and type='out' order by dname asc";
//$start=$row["aadate"];
...
$sel_query5="Select * from pappnew where adate1='$date5' and dname='$dn' and status IN ('SEEN') and pic='' ORDER BY aslot asc;";
...
$eid=$row5['eid'];
$pmrn=$row5['pmrn'];
$url = "cam_test/test_cam_pres?eid=$eid&pmrn=$pmrn"; 
