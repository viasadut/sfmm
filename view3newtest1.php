...
$count=1;
$sel_query="Select * from presnew where pmrn= '$pmrn' and dstatus='seen'  order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="ttttptest?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo $row["eid"]?>&ID=<?php echo "$id"?>&dname=<?php echo "$full"?>"><b>Details<b></a></td>
