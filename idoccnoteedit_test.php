...
$ins_query="update icnote set infusion='$infu',inves='$inves',pnote='$pnote',euser='$full',etime='$adate1',charge='$charge' where id='$id';";
...
<td colspan="2" ><input type="text" name="charge" required value="<?php echo $data5['charge'];?>"readonly></td>
</tr>
