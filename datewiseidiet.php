...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('imo','doctor','mng')"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					...
					<tr><td colspan="20"><label><strong><a href="datewisemedi21imo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Show Previous Day's Medicine</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;<a href="datewisemedi22imo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Show Day Before Yesterday's Medicine</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;<a href="datewisemedi23imo?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Show 2 Day Before's Medicine</a></strong></label></td></tr>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="20%"><strong>Diet</strong></th>
      <th width="8%"><strong>Instruction</strong>
	  <th width="10%"><strong>Given Date </strong>
      <th width="5%"><strong>Given Time</strong>   
      <th width="8%"><strong>Order Time</strong>
...
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$eid' and odate BETWEEN '$start' and '$end';";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["infusion"]; ?>
	        <td align="center"><?php echo $row["dtime"]; ?>
	  ...
	  <td align="center" colspan="1"><a onclick="return confirm_click1();" href="idiettomorrow?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["dtime"]; ?>&rtime=<?php echo $row["rtime"]; ?>&orderby=<?php echo $user; ?>">ADD</a></td>  	  
      </tr>
