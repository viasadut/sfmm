...
$pname=$result9["pname"];
 ...
 $url = "promedicine_new.php?pmrn=$pmrn&dname=$full&ID=$id&eid=$eid"; 
?>
...
$count=1;
						...
						$sel_query="SELECT * FROM promedi where pmrn='$pmrn' and eid='$eid' ORDER BY page_order";
...
while($row = mysqli_fetch_assoc($result)) 
	        ...
	        <td align="left" ><?php echo $row["brand"].' ('.$row["medi"].')'; ?></td>
				  ...
				  <td align="left"><a href="prodelete1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>">DELETE</a></td>
