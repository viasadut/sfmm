...
$ins_query="insert into alltest (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`price`,`code`,`link`,`date1`,`linkv`,`report`,`reportv`,`location`,`page`,`pgender`,`subtype`,`billstatus`,`billby`,`billdate`,`pphone`,`barcode`,`barcode1`,`billtime`) 
values ('$dname', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','$price','$code','$link','$date77','$linkv','$report','$reportv','OPD','$bdate','$psex','$subtype','Billed','$user','$pdate','$pphone','$bar','$bar','$pdate1')";
...
$ncharge =$_REQUEST["ncharge"];
$etime=date('Y-m-d H:i:s');


$ins_query3="update alltest set discount='$ncharge', edit_by='$user', edit_time='$etime' where pmrn='$sdfhh' and eid='$eid'";
$tt=mysqli_query($con,$ins_query3) or die(mysqli_error());
...
<tr>
<td colspan="10" align="center"><input list="browsers1" name="medi" size=60% class="form-control" autocomplete="off">
...
<td colspan="10" align="center"><input type="text" name="pins" value="" >
...
<tr><td colspan="20" align="right"bgcolor="lightgreen" id="tprice"><font size="6" color="#FF0000"><strong>Total Cost For The Selected Investigation Will Be:<?php echo $test1;?> (BDT)</strong></td></tr>
</form>

<tr>
	
	<td colspan="5"align="right" style="font-weight: bold;font-size:35px;color:red">Discount</td>
	<td colspan="5"align="right"><input type="number"name="ncharge" id='hh1' min="0" max="20" style="font-size:35px; color:red;font-weight:bold;" onchange="subTotal1()" required value="<?php echo '0' ?>"></td>
	<td colspan="5"align="right" style="font-weight: bold;font-size:35px;color:red">Grand Total After Discount</td>
		<td colspan="5" type="number"name="ncharge222" id='hh' style="font-size:35px; color:red;font-weight:bold;"></td>
		
		<td colspan="2"align="right"><button type="submit" name="dis">Confirm Discount</button></td>
	</tr>
...
function subTotal1()
{
 ...
 var hh2=<?php echo $test1;?>;
 
 var hh3=hh2-hh2*hh1/100;
  document.getElementById("hh").innerHTML = Math.round(hh3);
}
