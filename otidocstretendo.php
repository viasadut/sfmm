...
$ins_query="insert into otendostret (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`) 
values( '$pmrn','$id','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate')";
...
$count=1;
$sel_query="Select * from otendostret where pmrn= '$pmrn' and eid='$id' and odate='$odate'and status1 != 'Cancel' order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="otimediupdate1inspecialendo?id3=<?php echo $row["id"]; ?>&id=<?php echo $id; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Cancel</a></td>
