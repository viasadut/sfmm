...
$queryr = "SELECT COUNT(pmrn) FROM ref_doc where pmrn= '$pmrn' and eid='$eid' and dname='$dname';"; 
$resultr = mysqli_query($con, $queryr) or die(mysqli_error());
$rowr = mysqli_fetch_assoc($resultr);
$countr=$rowr['COUNT(pmrn)'];
...
$pdf->ln(3);	
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Referral:',0,1,'L');
$count=1;
$query1 = mysqli_query($db,"select * from ref_doc where pmrn='$pmrn' and dname='$dname' and eid='$eid'");
