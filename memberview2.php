...
doj='".$doj."',department='".$department."',sdepartment='".$sdepartment."',designation='".$designation."',hod='".$hod."',astatus='".$astatus."',stype='".$stype."' where sid='$sid'";
		//$mysqli->query($sql);
...
doj='".$doj."',department='".$department."',sdepartment='".$sdepartment."',designation='".$designation."',hod='".$hod."',astatus='".$astatus."',stype='".$stype."' where sid='$sid'";
	...
	mysqli_query($con,$sql) or die(mysql_error());
		...
		$_SESSION['success'] = 'Uploaded successfully.';
		header("Location: memberview1?sid=$sid");	
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr><td colspan="5"><label><strong>Staff ID:</strong></label></td>
				<td colspan="5"><label><strong>Staff's Name :</strong></label></td>
								<td colspan="5"><label><strong>Date Of Birth:</strong></label></td>
							<td colspan="5"><label><strong>Gender:</strong></label></td>
				
				</tr>
				<tr>	  
				<td colspan="5">	<input type="text" name="sid" id="sid" class="input-text" placeholder="Staff ID" value="<?php echo $row['sid'] ?>"required></td>
				<td colspan="5">	<input type="text" name="mname" id="mname" class="input-text" placeholder="Staff Name" value="<?php echo $row['mname'] ?>"required></td>
				<td colspan="5">	<input type="text" name="dob" id="datepicker" class="input-text" placeholder="Date Of Birth" value="<?php echo $row['doj'] ?>" required></td>
...
<tr>				 
		...
		<tr>				 
					<td colspan="20">					<input type="text" name="peradd" id="village" class="input-text" placeholder="Village" value="<?php echo $row['peradd'] ?>"required></td>
...
<tr>				 
					<td colspan="5">					<input type="text" name="phone" id="phone" class="input-text" placeholder="Phone" value="<?php echo $row['phone'] ?>"required></td>
						...
						<td colspan="5"><label><strong>HOD:</strong></label></td>						
