...
if(isset($_POST['receive'])){
  ...
  $uinsert =  "update ot set recovery='1' where id='$id' and recovery='0'";

  $update = mysqli_query($db, $uinsert) or die(mysqli_error($db));


	
  if(mysqli_affected_rows($db) >0 ){
$url = "recovery_receive_panel";
$_SESSION['success'] = 'Patient Received In Observation Room';
header("Location: $url");
}
else {
  $url = "recovery_receive_panel";
  $_SESSION['error'] = 'Patient Not Received In Observation Room';
  header("Location: $url");
