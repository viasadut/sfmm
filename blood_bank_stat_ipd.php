...
<a  target='_blank' href="deathstatdetailsmng?pmrn=<?php echo $row["pmrn"]; ?>">
  ...
  <tr> <td colspan="20" bgcolor="lightbrown"style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold;color:red;"><b>PATIENTS IPD RECORD<b> </td> 
...
$count=1;
$sel_query="Select * from iinves where ndate between '$start' and '$end' and infusion='$inves' and rstatus='RECEIVED' order by id desc;";
