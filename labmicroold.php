...
?>
  ...
  <tr>
	  ...
	  <input list="browsers1" name="infu" size=60% class="form-control" autocomplete="off" onkeydown="return false">
  <datalist id="browsers1">

						<option value=''>-Select Investigation</option>
				<?php 
			$sql = "select * from `radio2`";
	  ...
	  <input type="checkbox" name="chkDel[]" id="chkDel<?php echo $i;?>" value="<?php echo $row["id"];?>">
