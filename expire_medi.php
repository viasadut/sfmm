...
$edate=date('Y-m-d', strtotime('-15 days') );
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Batch NO</strong>  
<th width="14%"><strong>Expire Date</strong>  	  
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medi_stock where '$edate'>= exdate and add_qty!='0' ORDER BY exdate asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["exdate"]; ?></td>
