...
$ins_query1="update bed set `rclass`='$rclass',`bcurtain`='$bcurtain',`tv`='$tv',`wroomclass`='$wroomclass',`almira`='$almira',`ref`='$ref',`moven`='$moven',`sofa`='$sofa',`ac`='$ac',`bed`='$bed',`des`='$des',
`size`='$size',`wfilter`='$wfilter',`eby`='$user',`etime`='$adate1',`charge`='$charge',`bed_status`='$bed_status',sins='$sins' where id='$id'";
