...
$query = mysqli_query($db,"SELECT * from nurseassessedialysis where pmrn='$pmrn' and eid='$eid'" );
$data = mysqli_fetch_array($query);
//$dname=$data['dname'];

$query2 = mysqli_query($db,"SELECT * from dialysispapp where pmrn='$pmrn' and eid='$eid'");
...
$query4 = mysqli_query($db,"SELECT * from friskdialysis where pmrn='$pmrn' and eid='$eid'");
...
$pdf->Cell('38',5,'Dialysis Daycare',1,0,'L');
$pdf->Cell('15',5,'BED:',1,0,'L');
$pdf->Cell('20',5,'Dialysis-01',1,0,'L');
...
$pdf->ln(1);
$pdf->Cell('50',5,'Correct Patient:',1,0,'L');
$pdf->Cell('132',5,$data['cpatient'],1,1,'L');
$pdf->ln(1);

$pdf->Cell('50',5,'Correct Position:',1,0,'L');
$pdf->Cell('132',5,$data['cposition'],1,1,'L');
$pdf->ln(1);

$pdf->Cell('50',5,'Concent Taken:',1,0,'L');
$pdf->Cell('132',5,$data['ctaken'],1,1,'L');
$pdf->ln(1);
