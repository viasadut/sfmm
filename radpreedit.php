...
$update="update radreport set report='$cdetails',find='$find',edittime='$ortime',editby='$user' where `id`='$id'";
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="p4new11111.php?id=<?php echo "$id"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
