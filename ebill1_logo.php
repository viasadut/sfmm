...
$pdf->Cell('183',6,'DOCTORS CHARGES SUMMARY',1,1,'C');
...
$pdf->Cell('182',5,'VISITED CONSULTANT CHARGES:',0,1,'L');
$pdf->ln(5);
...
$pdf->Cell('60' , 5,$data1['dname'].' -',0,0,'L');
$pdf->Cell('60' , 5,'('.($data1['vtype']).') - ',0,0,'L');
