...
$ins_query="insert into otnnote (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`pnote`,`user`,`status`) values ( '$pmrn','$eid','$pname','$page','$adm','$psex','$pphone','$adate1','$inves','$pnote','$user','Data Updated')";
