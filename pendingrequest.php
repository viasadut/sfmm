...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicinerequest where rstatus='Pending' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["phar_remarks"]; ?></td>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
     <tr>
      <th width="4%"><strong>S.No</strong></th>
      <th width="17%"><strong>Generic Name</strong></th>
	  <th width="17%"><strong>Brand</strong></th>
	  <th width="17%"><strong>Company</strong></th>
      <th width="10%"><strong>Requested By</strong></th>
      <th width="15%"><strong>Request Date </strong>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from medicinerequest where a2='Approved' and a1='Approved' and a3='Approved' and a4='Approved' and rstatus NOT IN ('DONE','Cancelled') ORDER BY id desc;";
...
//$id =$_GET['id'];
//$count=1;
$sel_query="Select * from medicinerequest where a2 !='Approved' || a1 !='Approved' || a3 !='Approved' || a4 !='Approved' and rstatus NOT IN('Waiting For Entry','Cancelled','DONE')  ORDER BY id desc;";
