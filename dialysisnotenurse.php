...
$ins_query="insert into dialysisnnote (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`pnote`,`user`,`status`) values ( '$pmrn','$eid','$pname','$page','$adm','$psex','$pphone','$adate1','$inves','$pnote','$user','Data Updated')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Nurse's NOTE</strong></label></td> </tr>


<td colspan="15" align="center"><label><strong>Nurse's Note</strong></label></td> 
...
<td colspan="15" align="center"><textarea rows="2"  name="pnote" required value=""></textarea></td>
<td colspan="5" align="center"><textarea rows="2"  name="inves" required value=""></textarea></td>
</tr>
...
$count=1;
$sel_query="Select * from dialysisnnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
