...
$pdf->Cell(60,5,$data->medi,0,0);
$pdf->Cell(30,5,$data->result,0,0);

$pdf->Cell(30,5,$data->ins,0,0);
...
lab_render_approval_footer($pdf, $db, 'IMMUNOLOGY/SEROLOGY', (isset($data->resultby)?$data->resultby:''), (isset($data->checked_by)?$data->checked_by:''), (isset($data->cby)?$data->cby:''));
$pdf->Ln(10);
