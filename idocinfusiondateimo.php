...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="1"><a href="addinfusion_oiiii?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo "$eid"; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["room"]; ?>&dname=<?php echo $user; ?>&alert=<?php echo $row["alert"]; ?>">ADD</a></td>
      </tr>
