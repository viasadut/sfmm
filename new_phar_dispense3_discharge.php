...
$nqty=$tqty-$sqty;
	...
	$queryp = mysqli_query($con, "SELECT * FROM idismedi WHERE id='$id'");
...
$query="update idismedi set status='Served',`qty`='$t_g_qty' where id='$id'";
...
('$g_name','$sqty','$uuprice','$tprice','$user','$date','$sno','$b_name','$ins','$pname','$pmrn','$eid','$rfid','OPD','$code2')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
