...
$ins_query="insert into allvacine (`dname`,`pmrn`,`pname`,`medi`,`ins`,`date`,`type`,`date2`,`date1`,`remarks`) values ('$full', '$pmrn','$pname','$medi','$pins','$date','$type','$date2','$date1','$remarks')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Vaccine History</strong></label></td> </tr>
<tr><td colspan="10" align="center"><label><strong>Name of Vaccine</strong></label></td> 
...
<tr>
<td colspan="10" align="center"><input list="browsers1" name="medi" size=60% class="form-control" required/>
  <datalist id="browsers1">

						<option value=''>-Select Vacine-</option>
				<?php 
			$sql = "select * from `vacine`";
...
<input type="text" name="pins" id="datepicker1" placeholder="MM/DD/YYYY" size="15" ></td>

<td colspan="5" align="center"><textarea rows="5"  name="remarks" required value=""></textarea></td>
</tr>			        
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="6" align="center"><strong>Vaccine NAME</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="6"><?php echo $row["medi"]; ?></td>
			      <td align="center"colspan="4"><?php echo $row["ins"]; ?></td>
				  <td align="center"colspan="5"><?php echo $row["remarks"]; ?></td>
