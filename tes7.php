...
$query43 = "SELECT COUNT(pmrn) FROM newbed where pmrn= '$bt' and adate1 BETWEEN '$start' and '$end';"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="2"><label><strong>Select End Date:</strong></label></td>	
							...
							<td colspan="3"><label><strong> MRN</strong></label></td> 
					 ...
					 <td colspan="3"><input type="text" name="bt"></td>  
...
$count=1;
$sel_query="Select * from newbed where pmrn='$bt' and adate1 BETWEEN '$start' and '$end';";
...
{ ?>     <tr>
    ...
    <?php $count++; } }?>
      ...
      <td colspan="10" align="right"><a target='_blank' href="ppbed?pmrn=<?php echo "$bt";?>&date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
  </tbody>
</table>
