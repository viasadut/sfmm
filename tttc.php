...
$objDB = mysql_select_db("sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		...
		{
			$strSQL = "UPDATE staff1 set tt='done' ";
			$strSQL .="WHERE mname = '".$_REQUEST["eqty1"][$i]."' ";
...
$objConnect = mysql_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysql_select_db("sfmmkpjnew");
$strSQL = "Select mname from staff1 join covid where staff1.mname= covid.name;";
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td colspan="2"><input type="text" name="eqty1[]" id="eqty1<?php echo $i;?>" value="<?php echo $row["mname"]; ?>" /></td>
