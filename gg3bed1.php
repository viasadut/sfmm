...
$query4 = mysqli_query($db,"select * from ipres where pmrn='$pmrn' and id='$id'");
...
$update22="update ipres set room='$btype', room1='$bno' where pmrn='$pmrn' and id='$id'";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<select name="btype" placeholder="Select Bed Type" >
			        ...
			        <input name="btype1" type="text" size=43% value="<?php	  if(isset($_POST['load'])==1)
...
<input name="psex" type="text" size="15" value="<?php echo $data["room"]; ?>">
      <input name="ptemp" type="text" size="13" value="<?php echo $data["room1"]; ?>">	 
      ...
      <input name="dname" type="text" size="65" value="<?php echo $data["dname"]; ?>">									
