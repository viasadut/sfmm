...
$query = "UPDATE einves set rby='$user',rtime='$dtime', rstatus='RECEIVED', barcode='$result',barcode1='$result',status='RECEIVED' where id='$id'"; 
...
<td colspan="4" align="center"><input type="text" name="result" required value="<?php echo $data45['id'].''.date('dm');?>"></td></td>	  
