...
$query6 = "SELECT * FROM sur_count where id= '$id'"; 
...
$ins_query1="update sur_count set cname='$cname', res='$res' where id='$id'";
...
$url = "ccomm3_ins?cname=$cname&id=$id";
header("Location: $url"); 
...
<!-- Form Title -->
		<h1>Edit Instrument Set Name</h1>
