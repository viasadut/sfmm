...
$query43 = "SELECT COUNT(medi) FROM alltest where date1= '$start';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(infusion) FROM iinves where ndate = '$start';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(infusion) FROM einves where odate = '$start';"; 
...
<h1 align="center">Todays Investigation Request</h1>
...
//$id=$_REQUEST["id"];
echo "<font color=blue font size=5>Today ($start) Total Record found in the search  -";
...
$sel_query1="Select * from alltest where date1 = '$start' order by id";
...
{ ?>    <tr>
	...
	$sel_query2="Select * from iinves where ndate = '$start' order by id";
...
{ ?>    <tr>
	...
	<?php
	$sel_query3="Select * from einves where odate = '$start' order by id";
