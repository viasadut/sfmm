...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Charge</strong>
...
//$sel_query="Select * from privilege where status in ('pending','Approved','Reject','Waiting For CFO Approval') and dname='$full'  ORDER BY status asc;";
$sel_query="Select * from privilege where status in ('Approved','Waiting For CFO Approval') and dname='$full'  ORDER BY status asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["charge"]; ?>  </td>
	  	  

<td align="center"colspan="2"><a  target='_blank' href="priedit?id=<?php echo $row["id"]; ?>">Edit</td>  			  
