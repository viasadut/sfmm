...
$query43 = "SELECT COUNT(pmrn) FROM histo where rdate BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from histo where rdate BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["dia"]; ?> 
