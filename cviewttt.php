...
$count=1;
$sel_query="Select * from test where dname='$bt' and ddate BETWEEN '$start' and '$end' order by id;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="delete.php?id=<?php echo $row["id"]; ?>&dname=<?php echo $bt; ?>&date=<?php echo $start; ?>&date2=<?php echo $end; ?>">DELETE</a></td>
    ...
    <?php $count++; } }?>
 	  ...
 	  <td align="center"><a href="cviewttt.php?dname=<?php echo $bt; ?>&date=<?php echo $start; ?>&date2=<?php echo $end; ?>">Edit</a></td>
