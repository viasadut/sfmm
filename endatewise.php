...
$query43 = "SELECT COUNT(discharge) FROM emergency where discharge='discharged' and ddate1 BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from emergency where discharge='discharged' and ddate1 BETWEEN '$start' and '$end'";
