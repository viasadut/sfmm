...
<form action="billapp" method="POST">
...
$count=1;
$sel_query="Select * from pappnew where dname='$bt' and adate BETWEEN '$start' and '$end' order by aslot asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php if ($row['bill']!='BILLED'){echo 'UNPAID';} else if ($row['bill']=='BILLED'){echo $row['status'];} ?>  
