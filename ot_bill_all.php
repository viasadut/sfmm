...
{
return confirm("Are you Sure to Confirm OT Charges ??");
}
...
<tr><td colspan="20"><?php echo $data59["padd"]; ?></td></tr>
		...
		<tr>
					...
					<?php if($noti=='')
{echo	'<td align="left" colspan="20"><font size="4.5" color="#FF000"><b><a onclick="return confirm_click();" href="ot_charge_confirm?pmrn='.$pmrn.'&id='.$id.'">Confirm OT Charges</a></td>
';}
else {
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
	...
	<td align="center"colspan="5"><?php echo $row["vtype"]; ?></td>
	  ...
	  <td align="center"colspan="1">Charge Confirmed</td>
