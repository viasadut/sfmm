...
$update212="update endopapp set fname='$fname', mname='$mname', peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Settled',pphone='$pphone',user='$user',scase='$scase',vpoor='$vpoor',spcase='$spcase', qc='qc',md='md',cfo='cfo',ceo='ceo',apstatus='Waiting For Forwarder Approval',dsign='$aid.jpg' where `ID`='$id'";
