...
$query = mysqli_query($con,"select * from vitals_report_format where id='$id'");
            ...
            $query39 = "SELECT * FROM transplant_patient where pmrn= '$pmrn'"; 
        ...
        $output .='
                <table>
                    ...
                    <tr>
                        <td style="font-family: freesans;">'.$data['report'].'</td>
                    </tr>
           ...
           /* $mpdf->SetWatermarkImage(
			...
			$mpdf->SetHTMLHeader('
                ...
                <table style="border: 1px solid black" width="100%" >
                    <tr>
                        <td style="font-family: freesans;"> <b>Patient Name : '.$row39['pname'].'</b></td>
                        <td style="font-family: freesans;"><b>MRN :'.$row39['pmrn'].'</b></td>
                        <td style="font-family: freesans;"><b>GENDER :</b>'.$row39['psex'].'</td>
                        <td style="font-family: freesans;"><b>AGE :</b>'.$row39['page'].'</td>
                    </tr>
                </table>
