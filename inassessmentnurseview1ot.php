...
$query22 = "SELECT * from friskot where pmrn='$pmrn' and eid='$id'"; 
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="inassessmentnurseot?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"?>">ADD ASSESSMENT</a>&nbsp;&nbsp;<a href="inassessmentnurseviewot?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"?>">EDIT ASSESSMENT</a></td></tr>
				<tr>
