...
$query = mysqli_query($db,"select * from 24ccrate where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'S. Creatinine',1,0,'C');
$pdf->Cell('30',5,$data['sc'],1,0,'C');
$pdf->Cell('31',5,'umol/L',1,0,'C');
$pdf->Cell('40',5,'60-128',1,1,'C');
...
$pdf->Cell('80',5,'24 Hours Urine Creatinine',1,0,'C');
$pdf->Cell('30',5,$data['uc'],1,0,'C');
$pdf->Cell('31',5,'mmol/24hr',1,0,'C');
$pdf->Cell('40',5,'Adult: 9.2-20.7',1,1,'C');

$pdf->Cell('80',5,'24 Hours Creatinine Clearance',1,0,'C');
$pdf->Cell('30',5,$data['cc'],1,0,'C');
$pdf->Cell('31',5,'mL/min',1,0,'C');
$pdf->Cell('40',5,'62-120',1,1,'C');
