...
$eqty5 = $_POST['eqty2_'.$updateid];
			...
			$strSQL = "update medi_stock set add_qty='".$eqty5."' where id='".$updateid."' and location='Pharmacy'";
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Brand Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from medi_stock where add_qty='-1' and location='Pharmacy' and id between '40001' and '50000'";
     ...
     <td align="center" colspan="1" ><?php echo $count; ?></td>
      ...
      <td align="center"colspan="9" ><?php echo $row["g_name"]; ?></td>
	  	  ...
	  	  <td align="center"colspan="2" ><?php echo $row["add_qty"]; ?></td>
		  <td align="center"colspan="2" ><?php echo $row["code"]; ?></td>
	  



	  <td align="center"colspan="5" ><?php echo $row["b_name"]; ?></td>
	        
						

<td align="center"colspan="1"><?php echo $row['add_qty'];?></td>					

<td align="center"colspan="1"><input name="eqty2_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row['given_qty'];?>" readonly></td>
