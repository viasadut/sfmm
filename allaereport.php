...
$query7 = mysqli_query($db,"Select * from emergency where pmrn='$pmrn' and eid='$eid';");
...
$pdf->Cell(170,5,'KPJ SPECIALIZED HOSPITAL',0,0,'C');
$pdf->Ln(3);
$pdf->SetFont('Arial','B',12);
...
$pdf->Cell('183',6,'LAB INVESTIGATION RECORD ((A & E))',0,1,'C');
//$this->SetFont('Arial','B',);
$pdf->ln(2);
...
$query11 = mysqli_query($db,"Select * from einves where pmrn='$pmrn' and eid='$eid' and type='lab' and status='Received' order by odate1 desc;");
...
$pdf->SetFont('Arial' , 'bu' , 15);
$pdf->Cell('183',6,'RADIOLOGY INVESTIGATION RECORD (A & E)',0,1,'C');
$pdf->ln(10);



$query1 = mysqli_query($db,"Select * from radreport where pmrn='$pmrn' and emerid='$eid' order by id desc;");
