...
$query43 = "SELECT COUNT(type1) FROM radreport where type1= '$bt'and dname='$full' and r1date BETWEEN '$start' and '$end';"; 
...
<form action="allreportdoc" method="POST">
...
$count=1;
$sel_query="Select * from radreport where type1='$bt' and dname='$full' and r1date BETWEEN '$start' and '$end' ;";
