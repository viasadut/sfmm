...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>Contact Pattern</strong></th>
      <th width="15%"><strong>Department</strong>
	  <th width="15%"><strong>designation</strong>
	  <th width="15%"><strong>Phone</strong>
	  <th width="15%"><strong>Sent To</strong>
      <th width="14%"><strong>Sample Sent</strong>   
      <th width="14%"><strong>Test Result</strong>
      <th width="14%"><strong>Last date of contact with positive case</strong>
	  <th width="17%"><strong>contact duration</strong></th>
	  <th width="17%"><strong>within 1 m distance</strong></th>
	  <th width="17%"><strong>Quarantine until</strong></th>
	  <th width="17%"><strong>Retest</strong></th>
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo date('d/m/Y',strtotime($row["ldate"])); ?>
	  <td align="center"><?php echo $row["distance"]; ?>
	  <td align="center"><?php echo $row["cduration"]; ?>
	  <td align="center"><?php echo date('d/m/Y',strtotime($row["quntil"])); ?>
	  
      <td align="center"><?php echo date('d/m/Y',strtotime($row["retest"])); ?>
      <td align="center"><?php echo $row["remarks"]; ?>
	  <td colspan ="2" align="right"><a target='_blank' href="covideditreport?id=<?php echo $row["id"]; ?>">Report</a></td>	
      </tr>
