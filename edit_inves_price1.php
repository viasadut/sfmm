...
$query = "UPDATE edit_inves set iname='$mname',price='$price',cprice='$cprice',eby='$user',etime='$adate',com_remarks='$com_remarks',com_price='$com_price' where id='$id'"; 
...
<label for="age"><strong>Present Price :</strong></label>
      <input name="price44" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["oprice"];?>"readonly>
	  
	  <label for="age"><strong>Proposed Price :</strong></label>
      <input name="price" id="price" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["price"];?>"required>
...
<label for="age"><strong>Competitor Price :</strong></label>
      <input name="com_price" id="com_price" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["com_price"];?>"required>

<label for="age"><strong>Remarks:</strong></label>
      <textarea name="com_remarks" required rows='20'><?php echo $row1["com_remarks"];?></textarea>	  
