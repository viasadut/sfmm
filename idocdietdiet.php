...
$ins_query="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`dtime`,`status`) values ('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Diet Order</strong></label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a target='_blank' href="diet_chart_print.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="50" height="60" /></a>
...
<tr>
	  ...
	  <td colspan="1" align="center"><strong>Calorie</strong></td>
      
      <td colspan="2" align="center"><strong>User Done</strong></td>
	  <td colspan="6" align="center"><strong>Done time</strong></td>
	  <td colspan="2" align="center"><strong>Protine</strong></td>
	  <td colspan="2" align="center"><strong>PStatus</strong></td>
...
$dd=date('Y-m-d');
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$eid'and status1 !='Cancel' and status in ('Data Updated','Diet Ordered')and odate='$dd'order by `rtime` and `infusion` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="2"><?php echo $row["otime"]; ?></td>
	  	  <td align="center"colspan="6"><?php echo $row["dmenu"]; ?></td>
		  	  <td align="center"colspan="2"><?php echo $row["diettime"]; ?></td>

<td colspan="2" align="center"><a href="editdiet?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>&eid=<?php echo "$row[eid]"; ?>&user=<?php echo "$user"; ?>"><strong>EDIT</strong></a></td>	  

      </tr>
    <?php $count++; } ?>
	
	
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Diet Servred</strong></label></td> </tr>
...
$dd=date('Y-m-d');
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$eid'and status1 !='Cancel' and status in ('Served','Given')and odate='$dd'order by `rtime` and `infusion` asc;";
