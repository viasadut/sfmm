...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <td colspan="1"align="center"><strong>Suggested Date </strong></td>
...
$query39 = "SELECT * FROM inpatient where pmrn= '$pmrn' and eid='$count2'"; 
...
$sel_query="Select * from preadm where pphone= '$pmrn' and status='Admitted' order by id desc;";}
 else{
	 $sel_query="Select * from preadm where pmrn= '$pmrn'and status='Admitted' order by id desc;";
 } 
$count=1;	 
...
{ ?>    <tr>
      ...
      <td colspan="1"align="center"><?php echo $row["sda"]; ?> </td> 
      <td colspan="2"align="center"><?php echo $row["padd"]; ?></td>
      <td colspan="1"align="center"><?php echo $row["pphone"]; ?> </td>
	  <td colspan="10">		<a target='_blank' href="admnew?pmrn=<?php echo $row["pmrn"]; ?>&adoc=<?php echo $row["dname"]; ?>&adate=<?php echo $row39["adate"]; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
