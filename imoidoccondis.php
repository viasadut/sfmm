...
$url3 = "death2_edit?pmrn=$pmrn&eid=$eid";
      ...
      else if($res90>0 and $d_type!='Confirm Death Declaration Request' and $row['confirmdn']==''){echo "<a href='$url1'>Edit Discharge Note</a>";} 
      else if($res90>0 and $d_type!='Confirm Death Declaration Request' and $row['confirmdn']!=''){echo "Discharge Note Already Confirmed";} 
...
<td align="center"><b><?php echo $row["dconfirm"]; ?></td>	  
	  <td align="center" colspan="1"><a onclick="return confirm_click1();" href="dconfirmimo?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo $fullname; ?>">Confirm BY </a>(<b><?php echo $row["confirmdn"]; ?></b>)  </td>	  
