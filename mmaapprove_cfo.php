...
$sel_query="Select * from privilege where status in ('Waiting For CFO Approval')and $fullname in ('cfo')  ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="mmarequestedit_cfo?id=<?php echo $row["id"]; ?>"><strong>Approve</a> </td>
