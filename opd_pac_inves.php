...
values 
('$dname', '$pmrn','$ppname','$eid1','$medi','$pins','$date','$type','$price','$code','$link','$ndate','$linkv','$report','$reportv','PAC_OPD','$page','$pgender','$type1','$pphone')";
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<td colspan="6"><?php echo $ppname; ?></td>
