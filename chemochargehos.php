...
$sel9=mysqli_query($db,"SELECT * FROM chemopapp WHERE `ID`='$id'");
...
$ins_query1="insert into chemohoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`) values ('$pmrn','$pname','$medi1','$eid','$date1','$pdos','$dcode')";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="chemohosdelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>&id1=<?php echo "$id"; ?>">DELETE</a></td>
