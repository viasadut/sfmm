...
$sel="SELECT * FROM alltest where pmrn= '$pmrn' and type='spd1' and medi='ECG' and status='';"; 
...
values('$dname','$select','$pmrn','$pname','$page','$psex','$pphone','$ron','$vent','$qwave','$arate','$st','$rhy','$twave','$pwave','$qt','$pr','$qtc','$qrs','$uwave','$qrsc','$ebeats','$qrsvol','$others','$eaxis','$poro','$comments','$count1','$date1','$date2','$stime','Updated','Manual')";
