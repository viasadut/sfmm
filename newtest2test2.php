...
$query5 = mysqli_query($db,"select * from pappnew where pmrn='$pmrn' and eid='$eid1'");
...
$ins_query="insert into alltest (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`price`,`code`,`link`,`date1`,`location`,`linkv`,`report`,`reportv`,`page`,`pgender`,`pphone`,`subtype`) values ('$full', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','$price','$code','$link','$date77','OPD','$linkv','$report','$reportv','$page','$psex','$pphone','$subtype')";
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
     	  <td colspan="10" align="center"bgcolor="lightgreen"><strong>Old Investigation </strong></td>
...
$count=1;
$sel_query="Select * from alltest where pmrn= '$pmrn' and eid='$eid1'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
			      <td align="center"colspan="5"><input type="text" name="test" id="test" value="<?php echo $row["pdos"]; ?>"onChange="document.getElementById('selectedValue').innerHTML = this.value";></td>
				  
 
				  
				  <td align="center" colspan="2"><a href="delete1testinves?pmrn=<?php echo "$pmrn"; ?>&date1=<?php echo "$date1"; ?>&dname=<?php echo "$dname"; ?>&eid1=<?php echo "$eid1"; ?>&eid=<?php echo "$eid"; ?>&pname=<?php echo $row["pname"]; ?>&medi=<?php echo $row["medi"]; ?>&type=<?php echo $row["type"]; ?>&page=<?php echo $page; ?>&psex=<?php echo $psex; ?>">ADD</a></td>
    ...
    <?php $count++; } ?>
<tr><td colspan='20'align="center" font-size='16'bgcolor="lightblue"><b>New Investigation<b></td></tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="deleteinves?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&eid1=<?php echo "$eid1"; ?>">DELETE</a></td>
