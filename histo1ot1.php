...
$query11 = "SELECT * FROM histo where pmrn= '$pmrn' and eeid='$id'  and dname='$full'"; 
...
values ('$full','$date1', '$time','$pmrn','$pname','$pphone','$page','$psex','$shistory','$noperation','$indication','$find','$bio1','$bio2','$count1','NOT SEEN','Not Confirm','$bsize','$id')";
...
$count=1;
$sel_query="Select * from histo where pmrn= '$pmrn' and eeid='$id'  and dname='$full';";
...
{ ?>    <tr>
	  ...
	  ?>
  	  ...
  	  <td align="center"colspan="1"><a target='_blank' href="histo_bar?pname=<?php echo "$pp1"; ?>&pmrn=<?php echo "$pp2"; ?>&infusion=<?php echo "$pp3"; ?>&infusion1=<?php echo "$pp4"; ?>">test</a></td>



      </tr>
    <?php $count++; } ?>
<tr><td colspan="10"><a target='_blank' href="historeq.php?pmrn=<?php echo "$pmrn"; ?>&eeid=<?php echo "$id"; ?>&dname1=<?php echo "$full"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>		</tr>
</body>
