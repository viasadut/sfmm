...
values ('$full', '$fullname','$cdetails','$fullname','$add_time','Active','$type','$pd')";
mysqli_query($con,$ins_query_format);



$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`ac_no`,`status1`,`ineid`,`emerid`,`price`) 
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no','Updated By Technologist','$ineid','$emerid','$price')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="deathstatdetailsmng?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>All Records<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="allreportdocnew?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>All Reports<b></a></td></tr>
				...
				<td colspan="5"><label><strong>Referral Doctors's Name :</strong></label></td>
				<td colspan="5"><label><strong>Use Previous Template :</strong></label></td>
				</tr>
				<tr>	  
