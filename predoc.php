...
$sel90="SELECT * FROM predoc WHERE `proname`='$mname' and rby='$fname';";
$result90 = mysqli_query($con,$sel90);
if($res90=mysqli_num_rows($result90)>0)
{
echo '<script language="javascript">';
    echo 'alert("You Have Already Applied For This Procedure !!"); ';
...
$ins_query1="insert into predoc (`rby`,`rdate`,`rdate1`,`status`,`proname`,`remarks`) values ('$fname','$adate','$adate1','Pending','$mname','$remarks')";
...
<!-- Form Title -->
		<h1>Apply for procedure Privilege</h1>
	  ...
	  <input list="browsers111" name="mname"  size="80"  style="text-transform:uppercase"required autocomplete="off">
  <datalist id="browsers111">

						<option value=''>-Select Medicine</option>
				<?php 
			$sql = "select * from `predoc` where rby='$fname'";
 ...
 <label for="age"><strong>Please Define The Necessity Of This  Privilege:</strong></label> 
