...
$url = "phar_transfer_physio?sno=$sno";
header("Location: $url"); 
...
<tr>
<td colspan="10" align="center"><input type="text" name="p_name" id="" required value="<?php echo 'PHYSIOTHERAPY';?>" style="font-weight: bold;font-size:22px;color:green"></td> 
<td colspan="10" align="center">


<input type="text" id="dept" class="form-control action" list="ddd" autocomplete="off" name='dept' required style="font-weight: bold;font-size:22px;color:green" value="<?php echo 'PHYSIOTHERAPY';?>"readonly>
