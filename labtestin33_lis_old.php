...
$query39 = "SELECT * FROM einves where id= '$id'"; 
...
$update12="update einves set resultstatus='Updated By Technologist',result='$result',result1='$result',resulttime='$rtime',resultby='$user' where `id`='$id'";
mysqli_query($con,$update12);
...
<label><strong>Result</strong></label>  
                          <textarea rows="25" cols="50" name="result"  style="text-transform:uppercase" required><?php echo $row39['result'];?></textarea>
