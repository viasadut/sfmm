...
<span class="label success" style="float:right;"><a target='_blank' href="asset_upload.php?id=<?php echo $row['id']; ?>">Occupied</a></span>
<span class="label info"style="float:right;">Vacant</span>
<span class="label warning"style="float:right;">Under Housekeeping</span>
<span class="label danger"style="float:right;">Under Maintenance</span>
<span class="label other"style="float:right;">To be Discharged</span>
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='5A' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='5B' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='5C' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='5D' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='6A' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='6B' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='6C' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='6D' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='7A' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='7B' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='7C' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='7D' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='ICU' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='CCU' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='HDU' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='NICU' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='Covid ICU' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Vacant') and block='Any Block' order by status asc";	
