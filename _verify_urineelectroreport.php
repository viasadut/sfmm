...
$query = mysqli_query($db,"select * from 24urineelectro where pmrn='$pmrn' and eid='$eid' and sno='$id' order by id desc");
...
lab_render_approval_footer($pdf, $db1, 'BIOCHEMISTRY', (isset($data3['resultby'])?$data3['resultby']:''), (isset($data3['cby'])?$data3['cby']:''), (isset($data3['conby'])?$data3['conby']:''));
$pdf->Ln(10);
