...
lab_render_approval_footer($pdf, $db, 'BLOOD BANK', (isset($Tdata['resultby'])?$Tdata['resultby']:''), (isset($Tdata['checked_by'])?$Tdata['checked_by']:''), (isset($Tdata['conby'])?$Tdata['conby']:''));
$pdf->Ln(10);
