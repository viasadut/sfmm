...
*/
$ins_query="update injury set `fdate`='$adate',`fdate_new`='$adate1',`remark`='$remark',`ddate`='$ddate',`ddate_new`='$ddate1',`dtime`='$dtime',`diagnosis`='$diag',`ffor`='$ifind',`fdate1`='$atime',estatus='Waiting For Acknowledgement',confirmby='$full', con_time='$time' where id='$id'";
...
<label for="age"><strong>Patient's Details (MRN/Gender) :</strong></label>
	  ...
	  <input name="sex" type="text" size="15" value="<?php if($row3["m1"]=='MR.') {echo "M";} else{echo "F";} ?>"readonly/>
