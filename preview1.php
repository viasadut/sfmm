...
$pdf->Cell('18',5,$data['pmrn'],1,0,'R');
$pdf->Cell('20',5,'GENDER:',1,0,'L');
$pdf->Cell('20',5,$data['psex'],1,0,'R');
$pdf->Cell('10',5,'AGE:',1,0,'L');
$pdf->Cell('13',5,$data['page'],1,1,'R');
...
$pdf->Cell('30',5,$data['pheight'],1,0,'R');
$pdf->Cell('30',5,'Weight:',1,0,'L');
$pdf->Cell('30',5,$data['pweight'],1,0,'R');
$pdf->Cell('30',5,'Tempareture:',1,0,'L');
$pdf->Cell('32',5,$data['ptemp'],1,0,'R');
...
$query1 = mysqli_query($db,"select * from pmedi where pmrn='$pmrn' and dname='$dname'and date='$date' and eid='$eid'");
...
$pdf->MultiCell('182' , 5,$data['pdiet'].",".$data['pdiet2'].",".$data['pdiet3'].",".$data['pdiet4'].",".$data['pdiet5'].",".$data['pdiet6'],1,1);
...
$pdf->MultiCell('182' , 5,$data['reffer'].",".$data['reffer2'].",".$data['reffer3'].",".$data['reffer4'].",".$data['reffer5'].",".$data['reffer6'],1,1);
