...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from conleavedetails where sid='$fullname' and  status not in ('Approved By all','Cancel','Rejected')";
//$start=$row["aadate"];
...
$user=$_SESSION["sess_username"];
$date= date('m/d/Y');
$date2= date('2021-01-01');
$date3= date('2021-12-31');

$count=1;
$sel_query1="Select * from conleavedetails where sid='$fullname' and status='Approved By all' and sdate between '2021-01-01' and '2021-12-31'";
//$start=$row["aadate"];
