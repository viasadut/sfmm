...
<div class="container">
    <div class="row">
        ...
        <?php
			...
			$query_eye = "SELECT SUM(tprice) FROM phar_sale where sno= '$sno' and r_qty>0;"; 
            ...
            $total_price=$row_eye['SUM(tprice)'];
                ...
                $query1 = mysqli_query($con,"select * from phar_sale where sno='$sno' and r_qty>0 order by id asc");
                $count=1;
                    ...
                    $output .='
                        ...
                        <table width="100%">
                            <tr>
								...
								<td width="20%" align="center">'.$data1['r_qty'].'</td>
               ...
               <br>
                <table>
					...
					<tr>
                        ...
                        <td width="70%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$pmrn.'</h2></b></td>
                    </tr>
