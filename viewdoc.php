...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from pappnew where dname= '$full' and adate= '$date' and status='Not Seen' and `bill`='Billed' ORDER BY aslot asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="ttttptest?ID=<?php echo $row["ID"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">GO</a></td>
