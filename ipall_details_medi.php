...
<tr><td colspan="20"><?php echo $data["padd"]; ?></td></tr>
	...
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Medication Charges</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid' and infusion='$medi' and udone!='' order by `odate` DESC;";
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198 = "SELECT SUM(uprice) FROM imedi3 where pmrn= '$pmrn' and eid='$eid' and infusion='$medi' and udone!=''"; 
...
$test1=	$row198['SUM(uprice)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Medication Charge is:<?php echo $test1;?> (BDT)</strong></td></tr>
