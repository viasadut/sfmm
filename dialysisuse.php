...
$query = mysqli_query($db,"select * from dialysispapp where pmrn='$pmrn' and eid='$eid'");
...
//$dname=$data['dname'];
$query3 = mysqli_query($db,"select * from dialysishoscharge1 where pmrn='$pmrn' and eid='$eid'");
$data3 = mysqli_fetch_array($query3);


$query4 = mysqli_query($db,"select * from dialysishoscharge where pmrn='$pmrn' and eid='$eid'");
$data4 = mysqli_fetch_array($query4);



$query5 = mysqli_query($db,"Select * from dialysismedi where pmrn= '$pmrn' and eid='$eid' and status='Active' and pstatus='Given'order by `id` DESC;");
$data5 = mysqli_fetch_array($query5);




$query6 = mysqli_query($db,"Select * from dialysisinfusion where pmrn= '$pmrn' and eid='$eid' and status='Given' and status1='Active'order by `id` DESC;");
$data6 = mysqli_fetch_array($query6);




$query7 = mysqli_query($db,"Select * from dialysisstret where pmrn= '$pmrn' and eid='$eid' and status1='' and status='Given'order by `id` DESC;");
...
$pdf->ln(2);
$query1 = mysqli_query($db,"Select * from ivisitdialysis where pmrn= '$pmrn' and eid='$eid'  order by `id` DESC;");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from dialysishoscharge1 where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data1['medi'].' - '.$data1['pdos'].' Pcs',0,1);
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from dialysishoscharge where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from dialysismedi where pmrn= '$pmrn' and eid='$eid' and status='Active' and pstatus='Given'order by `id` DESC;");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from dialysisinfusion where pmrn= '$pmrn' and eid='$eid' and status='Given' and status1='Active'order by `id` DESC;");
...
$pdf->ln(3);
$query1 = mysqli_query($db,"Select * from dialysisstret where pmrn= '$pmrn' and eid='$eid' order by `id` DESC;");
