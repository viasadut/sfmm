...
if($bt=="ALL")
{
$query43 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and status='collected' and tresult='P' and dconfirm='confirmed'"; 
...
$query44 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tp='$bt' and status='collected' and tresult='P' and dconfirm='confirmed'"; 
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and status='collected' and tresult='P' and dconfirm='confirmed' order by sid asc;";}
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and tp='$bt' and status='collected'and tresult='P' and dconfirm='confirmed' order by sid asc;";}
...
$querym = "SELECT * FROM staff3 where sid='$bg'"; 
...
?>
     ...
     <td align="center"><?php echo $count; ?></td>
      ...
      <td align="center"><?php echo $bg1; ?></td>
