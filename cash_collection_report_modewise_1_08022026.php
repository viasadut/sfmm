...
$bill_user=$row['user'];
$bill_date=$row['date'];
$query43 = "SELECT SUM(amount_receive) FROM pms_bill where user= '$bill_user'and date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi');"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$phar_collection = mysqli_fetch_assoc($result43);

$query43_dis = "SELECT SUM(dis_amount) FROM pms_bill where user= '$bill_user'and date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi');"; 
