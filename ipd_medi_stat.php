...
$query44 = "SELECT COUNT(id) FROM phar_sale where medi= '$bt'and adate BETWEEN '$start' and '$end' and location='IPD STOCK';"; 
...
<h1 align="center">Used Medicine stats(From Stock)</h1>
...
<!-- Form Title -->
  ...
  <datalist id="browsers111">
						...
						<?php 
			$sql = "select DISTINCT(medi) from `phar_sale` where location='IPD STOCK'";
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>Medicine</strong></th>
      <th width="10%"><strong>MRN</strong></th>
      <th width="15%"><strong>Patient Name</strong>
      <th width="14%"><strong>Date</strong> 
<th width="14%"><strong>Implement By</strong> 	
<th width="14%"><strong>Order ID</strong> 	
...
$count=1;
	...
	$sel_query2="Select * from phar_sale where medi='$bt' and adate BETWEEN '$start' and '$end' and location='IPD STOCK' order by id desc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row2["medi"]; ?></td>
...
$pname=$row39['pname'];
      ...
      <td align="center"><?php echo $row2["adate"]; ?></td>
	  <td align="center"><?php echo $row2["aby"]; ?></td>
	  <td align="center"><?php echo $row2["iidd"]; ?></td>
