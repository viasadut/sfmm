...
$rowz = mysql_fetch_assoc($r30);
			...
			$strSQL1 = "Insert into tm3 (`name`,`dept`,`uid`,`date`,`date1`,`status`,`otime`,`time`,`ttime`,`hos`) values('$sname','$dept','$staff','$date1','$rd1','$status3','$otime','$stime','$ttime','$hos')";
			...
			$strSQL = "UPDATE tm3 set status='$status3', otime='$otime', time='$stime',date='$date1',ttime='$ttime',hos='$hos'";
...
<th width="4%"><strong>S.No</strong></th>
	  ...
	  <th width="17%"><strong>HOS</strong></th>
	  <th width="17%"><strong>Start Time</strong></th>
	  <th width="17%"><strong>End Time</strong></th>
	  <th width="17%"><strong>Late</strong></th>
	  <th width="17%"><strong>Ttime</strong></th>
...
?>
	   ...
	   <td align="center"><input type="text" name="date1[]" id="date1<?php echo $i;?>" value="<?php echo $row40["date"]; ?>" /></td>
	   <td align="center"><input type="text" name="otime[]" id="otime<?php echo $i;?>" value="<?php echo $row40n["date"]; ?>" /></td>
...
<td><input type="text" name="status1[]" id="status1<?php echo $i;?>" value="<?php if($stime3>0 && $mname !='') {echo 'LT';}else if($stime3<0 && $mname =='P') {echo "P"; } else if($r9=mysqli_num_rows($re9)>0){echo "L";} else if($rh=mysqli_num_rows($reh)>0){echo "H";} else {echo 'A';}?>" readonly></td>
