...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="17%"><strong>PMRN</strong></th>
...
$dcon=$row["dconfirm"];
?>
<td align="center"><?php if($tt=='P' and $dcon=='confirmed'){echo "<span style='color:red;text-align:center;'><b>$tt"; }else if($tt=='N' and $dcon=='confirmed'){echo "<span style='color:green;text-align:center;'><b>$tt"; }else {echo "<span style='color:blue;text-align:center;'><b>Result Pending";} ?>  </td>
