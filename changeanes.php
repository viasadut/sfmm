...
$update24="update endopapp set anes='$nanaes', tby='$user', ttime='$ttime' where ID='$ID'";
...
<!-- Form Title -->
		<h1>ANAESTHETIST CHANGE PANEL</h1>
        ...
        <fieldset>
			...
			<legend></legend>
            <!-- Name Input -->
			<label for="name"><strong>Select New Anaesthetist's Name :</strong></label>
			<p>
			<select name="nanaes" class="country">
				...
				<?php 
			$sql76 = "select * from `doctor` where Discipline ='anes' and status in ('Active','active')";
      ...
      <input name="oanaes" type="text" size="65" value="<?php echo $data["anes"]; ?>"readonly/>									
