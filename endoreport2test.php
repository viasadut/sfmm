...
$date1=date('m/d/Y');
$time=date("h:i:sa");
$ins_query="insert into endoreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rtime`) values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$time')";
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="endopdf1.php?pmrn=<?php echo "$pm"; ?>&eid=<?php echo "$count1"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
	  	  <td colspan="10"><a target='_blank' href="photo3.php?pmrn=<?php echo "$pm"; ?>&eid=<?php echo "$count1"; ?>">UPLOAD PICTURE</a></td>	
