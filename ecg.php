...
$query = "SELECT * from ecgapp where id='$id'"; 
...
$ins_query="insert into ecg (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`ron`,`vent`,`qwave`,`arate`,`st`,`rhy`,`twave`,`pwave`,`qt`,`pr`,`qtc`,`qrs`,`uwave`,`qrsc`,`ebeats`,`qrsvol`,`others`,`eaxis`,`poro`,`comments`,`eid`,`date1`,`date2`,`stime`) 
values('$dname','$dname1','$pmrn','$pname','$page','$psex','$pphone','$ron','$vent','$qwave','$arate','$st','$rhy','$twave','$pwave','$qt','$pr','$qtc','$qrs','$uwave','$qrsc','$ebeats','$qrsvol','$others','$eaxis','$poro','$comments','$count1','$date1','$date2','$stime')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="viewradrecord?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo $row['dreffer'];?>"><b>See Clinical Details<b></a></td></tr>
				...
				<tr>	  
				<td colspan="15"><input type="text" name="select"  required value="<?php echo $row['dname'];?>" readonly/></td></td>
				<td colspan="5" ><input type="text" name="dname" required value="<?php echo $row['rname'];?>" readonly/ style="background-color:skyblue;></td>
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<tr>
					 ...
					 <td colspan="5"><input type="text" name="ron" value="<?php echo $row['proname'];?>" readonly/></td>  
					 </tr>
	...
	<tr><td colspan="20"bgcolor='lightgreen'align="center"><label><strong>ELECTROCARDIOGRAPHY REPORT</label></strong></td></tr>				 
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="vent" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="qwave" required value=""></td>
					 <td colspan="5"><input type="text" name="arate" required value=""></td>  
...
<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="rhy" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="twave" required value=""></td>
					 <td colspan="5"><input type="text" name="pwave" required value=""></td>  


					 <td colspan="5"><input type="text" name="qt" required value=""></td>  
					 </tr>					 
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="pr" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="qtc" required value=""></td>
					 <td colspan="5"><input type="text" name="qrs" required value=""></td>  
...
<tr>
						...
						<tr>				
						<td colspan="5"><input type="text" name="qrsc" required value=""></td>  
             		
					 <td colspan="5"><input type="text" name="ebeats" required value=""></td>
					 <td colspan="5"><input type="text" name="qrsvol" required value=""></td>  
					 ...
					 <td colspan="5"><input type="text" name="poro" required value=""></td>
						...
						<tr><td colspan="20"><label><strong>Comments / Observation / Remarks:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="comments" rows="5" ></textarea></td>  </tr>
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="ecgreport.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname=<?php echo "$dname3"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
