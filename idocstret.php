...
$ins_query="insert into istret (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`) 
values( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$date','$infu','$dtime','$user','Data Updated','$rtime','$odate')";
...
<h1 align="center"style="background-color:lightgreen;">INPATIENT SPECIAL TREATMENT </h1>
<!-- Form Title -->
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Special Treatment Form</strong></label></td> </tr>
<tr>
<td colspan="2" align="center"><label><strong>Date</strong></label></td>
<td colspan="2" align="center"><label><strong>Time</strong></label></td>
<td colspan="10" align="center"><label><strong>Special Treatment</strong></label></td> 
...
<tr>
<td colspan="2" align="left"><input type="text" class="style" name="date" id="datepicker" placeholder="Select Date" value="<?php echo $odate;?>" required ></td>
<td colspan="2" align="center"><input list="rr5" name="rtime" required>
  <datalist id="rr5">
<option value=''>-Select Time-</option>
			...
			?>  </datalist></td>
<td colspan="10" align="center"><input type="text" name="infu" required value="" /></td>

<td colspan="6" align="center"><input type="text" name="dtime" required value="" /></td>
<tr>

<tr><td colspan="20" align="right"><button type="submit" name="Submit">Confirm</button></td></tr>

<tr>
<td colspan="20"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="addpharmediimospecial?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Medicine</a></strong>&nbsp;&nbsp;<a href="datewisemediimospecial?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
$count=1;
$sel_query="Select * from istret where pmrn= '$pmrn' and eid='$eid' and odate='$odate'and status1 != 'Cancel' order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="imoinmeditomorrowspecial?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["dtime"]; ?>&rtime=<?php echo $row["rtime"]; ?>&orderby=<?php echo $user; ?>">ADD For Tomorrow</a></td>  	  
<td align="center" colspan="1"><a onclick="return confirm_click();" href="imediupdate1inspecial?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo $user; ?>">Cancel</a></td>
	  
      </tr>
    <?php $count++; } ?>
	<tr><td colspan="10"><a target='_blank' href="testpdfstret.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
</form>
</body>
<?php echo $data59["eid"]; ?>
