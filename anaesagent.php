...
$ins_query="insert into anaesagent (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','Data Updated','$odate1','$time','$date','Active','$remarks')";
...
<td colspan="10" align="center"><label><strong>Flow</strong></label></td>
...
$count=1;
$sel_query="Select * from anaesagent where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
