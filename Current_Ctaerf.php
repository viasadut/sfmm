...
$pdf->Cell('20',5,$_REQUEST['psex'],1,0,'L');
$pdf->Cell('10',5,'AGE:',1,0,'L');
$pdf->Cell('25',5,$_REQUEST['page'],1,1,'L');

//$pdf->ln(20);

$pdf->Image('nursing_form_pic/CC1.jpg',0,35, 210, 220);
$pdf->Image('nursing_form_pic/CC2.jpg',0,300, 210, 220);
$pdf->Image('nursing_form_pic/CC3.jpg',0,35, 210, 220);
$pdf->Image('nursing_form_pic/CC4.jpg',0,35, 210, 220);
$pdf->Image('nursing_form_pic/CC5.jpg',0,35, 210, 220);
$pdf->Image('nursing_form_pic/CC6.jpg',0,35, 210, 220);
