...
<tr>
<td colspan="4" align="center"><select name="infu1" class="style1" value=''> 
...
<td colspan="4" align="center"><select name="infu2" class="style1" value=''> 
<option value=''>-Select-</option>
<option value='STAT'>STAT</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><select name="infu3" class="style1" value=''> 
<option value=''>-Select-</option>
<option value='STAT'>STAT</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><select name="infu4" class="style1" value=''> 
<option value=''>-Select-</option>
<option value='STAT'>STAT</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
			  ...
			  <td colspan="4" align="center"><select name="infu5" class="style1" value=''> 
<option value=''>-Select-</option>
<option value='STAT'>STAT</option>
<option value='SOS'>SOS</option>
						<option value='00:00'>00:00</option>
