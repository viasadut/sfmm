    ...
    $(document).ready(function () {
        $('input[id$=aa]').datepicker({});
					 ...
					 <td colspan="3"><select name="bt" >
						...
						<?php 
			$sql = "select distinct(dname) from `pappnew` where liver_opd='SFMM LIVER CLINIC' and dname !='SFMM LIVER CLINIC'";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pappnew where dname='$bt' and adate1 BETWEEN '$start' and '$end' and status='SEEN' order by dname asc";
