...
//$id1=$_REQUEST['ID'];
$url = "labinpeditendo?pmrn=$pmrn&eid=$eid";
$query = "UPDATE endolab set status='Ordered', rcomments='' where id='$id'"; 
...
<td colspan="8" align="center"><input type="text" name="infu" required value="<?php echo $data45["ins"]; ?>" readonly/></td>
