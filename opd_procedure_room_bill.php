...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(id) FROM procedure1 WHERE billno='$billno'"));
...
$strSQL = "Select * from procedure1 where billno='$billno' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");

$strSQL1 = "Select * from procedure1 where billno= '$billno' order by `id` desc;";
...
$strSQL165 = "Select * from pms_bill where billno= '$billno';";
$objQuery165 = mysqli_query($objConnect,$strSQL165) or die ("Error Query [".$strSQL1."]");
$row435=mysqli_fetch_array($objQuery165);
$grand_total=$row435['amount_receive']-$row435['r_amount'];


$strSQL15 = "Select * from procedure1 where billno= '$billno' order by `id` desc;";
...
<br>
		...
		<tr><td style="text-align:center;font-size:16px;">
					<b>OPD Procedure Suite Bill</b></td></tr>
...
<?php if($row['dis_amount']>0)                    {
  ...
  <tr>
                        ...
                        <td style="font-family: freesans; text-align:center;font-size:12px;" width="10%">'.$row['dis_amount'].'
                        </td>
...
<br><br><br>
                ...
                <table width="100%">
                <tr>
                <td style="font-family: freesans;text-align:center;font-size:14px;" width="10%"><b>Billed By:</b>'.$row435['user'].'
                </td>
                
                <td style="font-family: freesans; text-align:center;font-size:14px;" width="30%"><b>Billed Time:</b>'.$row435['time'].'
                </td>
                <td style="font-family: freesans; text-align:left;font-size:14px;" width="30%"><b>Paymant Mode:</b>'.$row435['p_mode'].'
                </td>
                <td style="font-family: freesans; text-align:right;font-size:16px;" width="30%"><b>Grand Total:'.$grand_total.'</b>
                </td>';
                }
