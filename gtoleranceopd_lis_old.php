...
<!-- Form Title -->
      ...
      <input name="gfast" type="text" size="70" style="text-transform:uppercase" value=""required/>
	  <label for="age"><strong>Glucose, Blood (1.0 Hour):</strong></label>
      <input name="gone" type="text" size="70" style="text-transform:uppercase" value=""/>
	  <label for="age"><strong>Glucose, Blood (2.0 Hour)::</strong></label>
      <input name="gtwo" type="text" size="70" style="text-transform:uppercase" value=""required/>
