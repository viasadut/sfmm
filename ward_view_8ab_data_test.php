...
$sel3="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '8A%' order by id desc limit 1";
...
$sel4="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '8B%' order by id desc limit 1";
...
$sel6="Select COUNT(id) from inpatient where room1 like '8A%' and discharge=''";

$resu6 = mysqli_query($con,$sel6);
$rw6 = mysqli_fetch_assoc($resu6);


$sel66="Select COUNT(id) from inpatient where room1 like '8B%' and discharge=''";
...
$sql="Select * from inpatient where room1 like '8A%' and discharge='' order by room1 asc";
$result = mysqli_query($con,$sql);
$count=1;



$sql1="Select * from inpatient where room1 like '8B%' and discharge='' order by room1 asc";
...
<tr>
		...
		<strong>8th Floor AB Block</strong>&nbsp;&nbsp;
...
<tr>
		...
		<strong>7th Floor B Block</strong>&nbsp;&nbsp;
...
$txt='One Patient is Admitted in Block - 8A, Patient Name is-'.$tt4.' And Patient- '.'MRN'.$tt3;
...
if($rw4==true){
							$txt='One Patient is Admitted in Block - 8B, Patient Name is-'.$tt66.' And Patient- '.'MRN'.$tt55;
  $txt1=htmlspecialchars($txt);
  $txt2=rawurlencode($txt1);
  $html=file_get_contents('https://translate.google.com/translate_tts?ie=UTF-8&client=gtx&q='.$txt2.'&tl=en-US');
