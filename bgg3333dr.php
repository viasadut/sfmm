...
$sel3="SELECT * FROM pappnew WHERE `dname`='$dname' and adate='$date1' and aslot='$slot';";
...
$update87="update test set status='Booked' where `dname`='$dname' and `ddate`='$date1' and `dslot`='$slot'";
...
<!-- Form Title -->
		...
		<label for="mail"><strong>Appointment Date :</strong></label>
			...
			<select name="slot"readonly required> <option></option>
	   <?php 
	   $dname= $data['dname'];
	   $date1=$data['adate'];
      ...
      <input name="padd" type="text" size="65" style="text-transform:uppercase" value="<?php echo $data["padd"]; ?>"required>
