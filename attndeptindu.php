...
<?php
	$stmt = $DB_con->prepare("SELECT * FROM staff3 where sid='$full1'");
	$stmt->execute();
...
$adate=date('Y-m-d');
$ssid=$row["sid1"];
$query40 = "SELECT * FROM tm where uid= '$ssid' and date1 between '$start' and '$end' order by id asc limit 1;"; 
...
$query40n = "SELECT * FROM tm where uid= '$ssid' and date1 between '$start' and '$end' order by id desc limit 1;"; 
