...
$ins_query3="insert into opd_appoint1 (`dname`,`ddate`,`dslot`,`status`,`user`,`date1`) 
values ('$name', '$date','$select','AVAILABLE','$user','$dd')";
...
<form action="test_appoint4" method="post">
