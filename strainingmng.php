...
$ins_query="insert into straining (`sid`,`cname`,`cyear`,`institute`,`result`,`remarks`,`date`,`user`,`status`) values ('$sid', '$cname','$cyear','$institute','$result','$remarks','$date','$user','active')";
...
$count=1;
$sel_query="Select * from straining where sid= '$sid' and status='active' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["sid"]; ?></td>
				  ...
				  <td align="center" colspan="1"><a href="deletetrain?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>">DELETE</a></td>
