...
<p align="center" class="style1">Appointment Desk</p> 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Make Today's Appointment</strong></th>
	  <th width="10%"><strong>Make Advance Appointment</strong></th>
...
$ss=$row40['sid'];
   ...
   ?>
	  ...
	  <b><a href="con_details?sid=<?php echo $ss; ?>" target="_blank"><?php echo $row["dname"]; ?></a></td>
...
echo "<a target='_blank' href='$url'>Make Appointment</a>";}
...
echo "<a target='_blank' href='$url'>Make Advance Appointment</a>";}
