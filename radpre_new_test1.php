<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','rad')"; 
...
$ins_query="insert into radreport (`dname`,`pmrn`,`pname`,`age`,`gender`,`pphone`,`dreffer`,`report`,`type`,`eid`,`status`,`rdate`,`r1date`,`find`,`rdone`,`date2`,`type1`,`time`,`ac_no`,`status1`,`ineid`,`emerid`) 
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$a_no','Updated By Technologist','$ineid','$emerid')";
...
<tr><td align="right" colspan="20"><a target='_blank' href="history11dochis?pmrn=<?php echo "$pmrn"; ?>"><b>Patient's Record<b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href="opdradreport?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Radiology Report<b></a>&nbsp;&nbsp;<a target='_blank' href="endoreportin?pmrn=<?php echo "$pmrn"; ?>"><b>Record of Endoscopy Report<b></a>&nbsp;&nbsp<a target='_blank' href="http://192.168.100.254?pmrn=<?php echo "$pmrn"; ?>"><b>LAB REPORT<b></a>&nbsp;&nbsp;<a target='_blank' href="noteviewdoc?pmrn=<?php echo "$pmrn"; ?>"><b>SURGERY NOTE<b></a>&nbsp;&nbsp;<a target='_blank' href="cardiolink?pmrn=<?php echo "$pmrn"; ?>"><b>CARDIOLOGY REPORT<b></a>&nbsp;&nbsp;<a target='_blank' href="opdprocedurenote?pmrn=<?php echo "$pmrn"; ?>"><b>OPD PROCEDURE NOTE<b></a>&nbsp;&nbsp;<a target='_blank' href="historeportdoc?pmrn=<?php echo "$pmrn"; ?>"><b>HISTOPATHOLOGY REPORT<b></a></td></tr>		
	...
	<option value=''>-Select-</option>
            ...
            require('db1.php');
            $uname = '';
            $query_1 = "select * from `rad_report_format` where status='Active' and iname='$pd' and dcode='$fullname'";
        ...
        <?php } ?>
				...
				<td colspan="5" ><input type="text" id="uu" name="dname" required value="jhjhh" readonly/ style="background-color:skyblue;"></td>
...
//						var res="<?php echo $dreffer;?>";
						...
						<td colspan="5" ><?php echo $abc ="<script> 
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
    ...
    function EnableDisableTextBox(chkPassport) {
	 ...
	 <input type="text" id="txtPassportNumber" name='type' disabled="disabled" required>
		...
		<tr>
					 ...
					 <td colspan="5"><input type="text" name="ptemp" id="ptemp" value="<?php echo $pd;?>" readonly></td>  
					 </tr>

						 <tr><td colspan="20"><label><strong>Patient's Details Report:</strong></label></td>  </tr>
						 <tr><td colspan="20"><textarea class="form-control" id="charge" name="cdetails" rows="40" ><?php echo '1';?></textarea></td>  </tr>
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="p4new1.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$count1"; ?>&dname=<?php echo "$dname3"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
