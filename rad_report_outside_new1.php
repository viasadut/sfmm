...
<p align="center" class="style1">Pending List For Outside Reporting</p>
  ...
  <table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
	  ...
	  <th width="14%"><strong>Reporting Consultant</strong>
      
      

	  
	        <th width="14%"><strong>PACS View</strong>
			<th width="14%"><strong>Cancel Outside Reporting</strong>
...
$sel_query="Select * from radpapp where adate1 between '$test' and '$test1' and status in ('NOT SEEN','Draft') and out_report='1' ORDER BY report_dname asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["dreffer"]; ?>  </td>
        ...
        <td align="center"><?php echo $row["report_dname"]; ?>  </td>
...
<td>
<?php if ($row['status']!="Draft"){echo '
<input type="button" name="edit" value="Cancel" id="'.$row["ID"].'" class="btn btn-info btn-xs edit_data">
';}

else if ($row['status']=="Draft"){

     echo "<span style='color:green;font-weight:bold;font-size:20px;'>Save As Draft</span>";
}
?>     
</td>
...
<div id="dataModal" class="modal fade">  
 ...
 <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title"align='center'>Cacel Image For Outside Reporting</h4>  
                </div>  
 ...
 <label>Location</label>                          
						  ...
						  <select name="pbp" id="pbp" class="form-control">
<option value="">--Select--</option>
	  	  <option value="PROF. DR. SHIBENDU MAJUMDAR">PROF. DR. SHIBENDU MAJUMDAR</option>
...
<script>  
 $(document).ready(function(){  
           ...
           $.ajax({  
                ...
                success:function(data){  
					...
					$('#peid').val(data.tname); 
                     ...
                     $('#insert45').val("Cancel Outside Reporting");  
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"update_rad_consultant1.php",  
                     method:"POST",  
