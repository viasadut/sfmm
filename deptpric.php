...
$query43 = "SELECT COUNT(dname) FROM privilege where dname= '$bt' and status in ('Approved','Waiting For CFO Approval');"; 
...
$query44 = "SELECT COUNT(dname) FROM privilege where status in ('Approved','Waiting For CFO Approval');"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT * FROM privilege where dname='$bt' and status in ('Approved','Waiting For CFO Approval') ;"; 
...
<h1 align="center">Consultant wise Privilege List</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt"class="con_charge">
        
						<option value=''>-Select-</option>
						<option value='all'>All</option>
						<?php 
			$sql = "Select DISTINCT dname from doctor where status='Active';";
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Approved By</strong>
			<th width="14%"><strong>Time</strong>
      <th width="14%"><strong>Previous Charge</strong>
      <th width="14%"><strong>Currect Charge</strong>
...
$sel_query="Select * from privilege where status='Approved'";}
...
$sel_query="Select * from privilege where dname='$bt' and status in('Approved','Waiting For CFO Approval');";
}
$count=1;
...
{ ?>    <tr>
    ...
    <td align="Left"><?php echo $row["l_price"]; ?>  
    <td align="Left"><?php echo $row["charge"]; ?>  
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="mmarequestedit?id=<?php echo $row["id"]; ?>"><strong>Edit</a> </td>
