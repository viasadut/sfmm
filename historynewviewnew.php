...
<td colspan="5"><a target='_blank' href="p4new.php?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"; ?>&date=<?php echo "$pdate"; ?>&eid=<?php echo "$eid1"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
