...
$query43 = "SELECT COUNT(dname) FROM presnew where xl !='' and dname= '$bt' and date BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Number of Prescription Report</h1>
...
<form action="tes6lab" method="POST">
...
$count=1;
$sel_query="Select * from presnew where dname='$bt' and date BETWEEN '$start' and '$end'and xl !='';";
