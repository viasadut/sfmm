...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(id) FROM advance_bill WHERE pmrn='$pmrn' and eid='$eid'"));
$row44['COUNT(id)'];
...
$strSQL = "Select * from advance_bill where pmrn='$pmrn' and eid='$eid' and location='AE' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");

$strSQL1 = "Select * from inpatient where pmrn='$pmrn' and eid='$eid' and discharge=''  order by `id` desc;";
...
$row45=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(amount) FROM advance_bill WHERE location='AE' and dname='AE ADVANCE' and pmrn='$pmrn' and eid='$eid'"));

$row455=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(amount) FROM advance_bill WHERE location='AE' and dname='Refund' and pmrn='$pmrn' and eid='$eid'"));
//echo $row45['SUM(price)'];

$bill_paper=$row45['SUM(amount)']-$row455['SUM(amount)'];

//echo $row46['desig'];


$strSQL16 = "Select * from pms_bill where location='AE' and dname='AE ADVANCE' and pmrn='$pmrn' and eid='$eid';";
$objQuery16 = mysqli_query($objConnect,$strSQL16) or die ("Error Query [".$strSQL1."]");
$row433=mysqli_fetch_array($objQuery16);


$strSQL15 = "Select * from emergency where pmrn='$pmrn' and eid='$eid' and discharge='' order by `id` desc;";
...
<br>
		...
		<table width="100%">
					...
					<tr>
                    <td style="font-family: freesans; text-align:center; font-weight:bold; font-size:14px;">ADVANCE / REFUND BILL STATEMENT</td>
                    </tr>
					</table>
                    
          <?php if($row44['COUNT(id)']>0){echo 
...
<td style="font-family: freesans; text-align:left;font-size:12px;" width="5%"><b>SNO</b>
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="50%"><b>Particulars</b>
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="35%"><b>Date&Time</b>
                        </td>
...
?>
                    ...
                    <tr>
                        ...
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="50%"><?php echo $row['remarks'];?>
                        </td>

                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="35%"><?php echo $row['time'];?>
                        </td>
                        <td style="font-family: freesans; text-align:center;font-size:12px;" width="10%"><?php echo $row['amount'];?>
                        </td>
...
?>
                ...
                <table width="100%">
                  ...
                  <td style="font-family: freesans; text-align:left;font-size:12px;" width="20%"><b>Paymant Method:</b>'.$row433['p_mode'].'
                  </td>
                  <td style="font-family: freesans; text-align:right;font-size:16px;" width="30%"><b>Grand Total:'.$bill_paper.'</b>
                </td>';
                }
...
/*    function printPage(divName){
  ...
  font:5,          
        ...
        $(document).ready(function() {
          let barcodeValue = <?= $eid; ?>;
          let displayText = "EID: " + barcodeValue;
