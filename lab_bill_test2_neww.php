...
$query4 = mysqli_query($db,"select * from alltest where pmrn='$pmrn' and date1='$dd1'");
...
$eqty2 = $_POST['eqty1_'.$updateid];
			...
			if($eqty2 >0)
	{
						...
						$strSQL1 = "update alltest set billstatus='Billed', billby='$user', billdate='$pdate' where id='".$updateid."'";
...
$strSQL = "Select * from alltest where pmrn='$pmrn' and date1='$dd1' and billstatus!='Billed'";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");



                    $query = "select * from alltest where pmrn='$pmrn' and date1='$dd1' and billstatus!='Billed'";
     ...
     <td align="center"colspan="4" style="font-size:22px; color:red; font-weight:bold;"><?php echo $row["medi"]; ?></td>
				  ...
				  <input class="iprice" name="eqty3_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row["price"];?>" readonly style="font-size:22px; color:red; font-weight:bold;">
