...
$ins_query="insert into einfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user')";
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from einfusion where pmrn= '$pmrn'and eid='$episode' and status='Data Updated'order by `id` DESC;";
...
<td colspan="2" align="center"><a target='_blank' href="einpatient3333.php?pmrn=<?php echo "$row[pmrn]"; ?>&id=<?php echo "$row[id]"; ?>"><strong>UPDATE</strong></a></td>	  
