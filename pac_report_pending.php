...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from pac_request where status='RECEIVED' order by id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"align="center"><a href="new_pac?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&id=<?php echo $row['id']; ?>">REPORT</a></td>
