...
$rr1='Patient Value- :'.$chikun1."<br />".'Cut Off Value:'.$chikun2."<br />".'Interpretation:'.$chikun3."<br />".'Type:'.$type;

$rr='Patient Value- :'.$chikun1."<br />".'Cut Off Value:'.$chikun2."<br />".'Interpretation:'.$chikun3."<br />".'Type:'.$type;



$ins_query1="insert into hbsag (`pname`,`pmrn`,`psex`,`page`,`pvalue`,`cvalue`,`inter`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`type`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$chikun3','$user','$adate','$eid','$iname','$id','$sno','$type')";
...
<!-- Form Title -->
      ...
      <input name="chikun2" type="text" size="70" style="text-transform:uppercase" value="0.160"required>
