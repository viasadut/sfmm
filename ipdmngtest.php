...
$query43 = "SELECT COUNT(adoc) FROM inpatient where adoc= '$bt'and aadate BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(adoc) FROM inpatient where aadate BETWEEN '$start' and '$end';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(adoc) FROM inpatient where ddate1 BETWEEN '$start' and '$end';"; 
...
echo   $row44['COUNT(adoc)'] +$row45['COUNT(adoc)'];
echo " ,  From  ";
echo $start;
echo "  To  ";
echo $end;

$sel_query="Select * from inpatient where aadate BETWEEN '$start' and '$end'";
//$sel_query2="Select * from inpatient where ddate1 BETWEEN '$start' and '$end'";
}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo $end;
 ...
 //$sel_query2="Select * from inpatient where adoc='$bt' and ddate1 BETWEEN '$start' and '$end'";
 } 
$count=1;
//$sel_query="Select * from inpatient where adoc='$bt' and aadate BETWEEN '$start' and '$end'";
