...
<h1 align="center">View Datewise Diet Order</h1>
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="1"><a onclick="return confirm_click1();" href="idiettomorrowdoc?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["dtime"]; ?>&rtime=<?php echo $row["rtime"]; ?>&orderby=<?php echo $user; ?>">ADD</a></td>  	  
      </tr>
