...
<td colspan="20" align="center"font size="7"><strong>Fluid CHART (<?php echo $date;?>)<br><?php
// Make a MySQL Connection
$username = "root";
...
$query11 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Vomitus'GROUP BY route1"; 
...
$query22 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='NG' GROUP BY route1"; 
...
$query33 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Urine'GROUP BY route1"; 
...
$query44 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-1'GROUP BY route1"; 
...
$query55 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-2'GROUP BY route1"; 
...
$query66 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-3'GROUP BY route1"; 
...
$query77 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-4'GROUP BY route1"; 
...
$query88 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-5'GROUP BY route1"; 
...
$query99 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-6'GROUP BY route1"; 
...
$query00 = "SELECT route1, SUM(qty1) FROM influid where date='$date' and pmrn='$pmrn' and eid='$eid'and route1='Drain-7'GROUP BY route1"; 
