...
$test8=date('Y-m-d', strtotime('-90 days') );
?>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecg where datenew between '$test' and '$date' and status1='Confirmed' order by id desc;";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from echo where datenew between '$test' and '$date' and status1='Confirmed';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ett where status1='Confirmed';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from cathreport where status1='Confirmed' ;";
