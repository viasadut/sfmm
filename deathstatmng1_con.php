...
$dname_n=$data['fullname'];





$query44 = "SELECT COUNT(pmrn) FROM deathn where rdoc='$dname_n' and rdate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Death Stats</h1>
...
echo $end1;
	 ...
	 $sel_query="Select * from deathn where rdoc='$dname_n' and rdate BETWEEN '$start'and '$end' order by rdate asc";
	 echo "<font color=blue font size=5> Total Record found in the search  -";
