...
$query = "UPDATE iblood set bagno='$bagno',issueby='$user',issuetime='$odate',bbstatus='Issued' where id='$id'"; 
$result = mysqli_query($con,$query) or die ( mysqli_error());


$query1 = "UPDATE bcross1 set status='Issued' where bagno='$bagno'"; 
$result1 = mysqli_query($con,$query1) or die ( mysqli_error());

$url = "labblood?pmrn=$pmrn&eid=$eid"; 
header("Location: $url"); 
}
?>
...
$count=1;
$sel_query="Select * from iblood where id='$id'  order by `id` DESC;";
