...
$ins_query="insert into irefferal (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`ward`,`bed1`,`rnote`,`sid`,`ndate`,`cstatus`) values 
('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$dd','$adoc','$ward','$bed1','Followup Visit','$sid','$ndate','Active')";
...
<tr>
	  ...
	  <td colspan="4" align="center"><strong>Referral Status</strong></td>
...
<td colspan="20"align="right"><button type="submit" name="Submit1_a">Give Covid Referral</button></td>
</form>
</body>
