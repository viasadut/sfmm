...
$query43 = "SELECT COUNT(pmrn) FROM ecg where datenew between '$start' and '$end' and status1='Confirmed' and dname='$full'"; 
...
<h1 align="center">Datewise ECG Stats Report</h1>
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from ecg where datenew between '$start' and '$end' and status1='Confirmed' and dname='$full'"; 
