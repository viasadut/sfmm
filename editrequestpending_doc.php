...
$sel_query="Select * from medicineedit where status in ('Waiting For Finance Fowrading','waiting','WAITING FOR IT ENTRY','Waiting For MD Approval','Waiting For cfo Approval','Waiting For ceo Approval') ORDER BY id asc;";
