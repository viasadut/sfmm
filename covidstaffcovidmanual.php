...
$count=1;
$sel_query="Select * from staff3 where sid !=''order by sid desc;";
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a target='_blank' href="covidstaff2covidmanual?id=<?php echo $row["id"]?>&rd=<?php echo $rd;?>">Add</a> </td>
