...
$query3 = "SELECT COUNT(hrd) FROM anaesetco2 where pmrn='$pmrn' and date1='$odate1'"; 
...
$querybp = "SELECT COUNT(hrd) FROM anaessbp where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypulse = "SELECT COUNT(hrd) FROM anaespulse where pmrn='$pmrn' and date1='$odate1'"; 
...
$queryspo2 = "SELECT COUNT(hrd) FROM anaesspo2 where pmrn='$pmrn' and date1='$odate1'"; 
...
$querytemp = "SELECT COUNT(hrd) FROM anaestemp where pmrn='$pmrn' and date1='$odate1'"; 
...
$queryrr = "SELECT COUNT(hrd) FROM anaesrr where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypscore = "SELECT COUNT(hrd) FROM anaescvp where pmrn='$pmrn' and date1='$odate1'"; 
...
$ins_query21="insert into anaesetco2 (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','SPO2','$spo2','$count1','$user','$odate','$time')";
mysqli_query($con,$ins_query21) or die("Problem in entry");}

if (!empty ($_POST['sbp'])){
$ins_querybp="insert into anaessbp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`vitails2`,`score2`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','sbp','$sbp','dbp','$dbp','$countbp1','$user','$odate','$time')";
mysqli_query($con,$ins_querybp) or die("Problem in entry");}

if (!empty ($_POST['pulse'])){
$ins_querypulse="insert into anaespulse (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','Pulse','$pulse','$countpulse1','$user','$odate','$time')";
mysqli_query($con,$ins_querypulse) or die("Problem in entry");}

if (!empty ($_POST['spo2'])){
$ins_queryspo2="insert into anaesspo2 (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','SPO2','$spo2','$countspo21','$user','$odate','$time')";
mysqli_query($con,$ins_queryspo2) or die("Problem in entry");}

if (!empty ($_POST['temp'])){
$ins_querytemp="insert into anaestemp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','Temperature','$temp','$counttemp1','$user','$odate','$time')";
mysqli_query($con,$ins_querytemp) or die("Problem in entry");}

if (!empty ($_POST['rr'])){
$ins_queryrr="insert into anaesrr (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','RR','$rr','$countrr1','$user','$odate','$time')";
mysqli_query($con,$ins_queryrr) or die("Problem in entry");}

if (!empty ($_POST['cvp'])){
$ins_querypscore="insert into anaescvp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$eid','$odate1','SPO2','$spo2','$countpscore1','$user','$odate','$time')";
...
&nbsp;&nbsp;<a href="dgraph2.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>">Datewise Graph</a>&nbsp;&nbsp;<a href="height.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Height Graph</a>&nbsp;&nbsp;<a href="weight.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Weight Graph</a>&nbsp;&nbsp;<a href="bp.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">BP Graph</a>&nbsp;&nbsp;<a href="pulse.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Pulse Graph</a>&nbsp;&nbsp;<a href="temp.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Temperature Graph</a>&nbsp;&nbsp;<a href="spo2.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">SPO2 Graph</a>&nbsp;&nbsp;<a href="rr.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">RR Graph</a>&nbsp;&nbsp;<a href="pain.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Pain Score Graph</a></h4>
		...
		<tr><td colspan="20" align="right"><button onClick="goBack()">Back</button></td></tr>
				...
				<tr>	  
				<td colspan="20"><?php echo $data59["anes"]; ?></td></tr>
...
$count=1;
$sel_query="Select * from anaessbp where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from anaespulse where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from anaesspo2 where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from anaestemp where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from anaesrr where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from anaesetco2 where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from anaescvp where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
