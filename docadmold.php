...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','pending','$snew')";
...
$ins_query="insert into preadm (`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`diagnosis`,`sda`,`plan`,`formo`,`pdischarge`,`remarks`,`dname`,`location`,`rdate`,`staff`,`tstatus`,`snew`) values ('$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$date2','$plan','$instruction','$date3','$remarks','$full','OPD','$date6','$staff','Approved','$snew')";
mysqli_query($con,$ins_query);
