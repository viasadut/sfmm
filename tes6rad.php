...
$query43 = "SELECT COUNT(dname) FROM presnew where xl2 !='' and dname= '$bt' and date BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Number of Radiology Test request By Consultant</h1>
...
<form action="tes6rad" method="POST">
...
$count=1;
$sel_query="Select * from presnew where dname='$bt' and date BETWEEN '$start' and '$end'and xl2 !='';";
