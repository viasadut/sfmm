            ...
            <tbody>
                <?php
                    if($ugroup=='lab' && $status='active'){	
                        ...
                        $count=1;
                        $sel_query="Select * from alltest where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test' and '$apdate'  and subtype in('HISTOLOGY','CYTOLOGY') and rejectby='' and rejecttime='' order by `id` DESC;";
                ...
                <tr>
                    ...
                    <td align="center" colspan="1"><?php echo date('d/m/Y H:i:s',strtotime($row["retime"])); ?></td>
                    ...
                    <td align="center" colspan="1"><a onclick="return confirm_click();"
                        href="labreportconfirmopd1_h?id=<?php echo $row["id"]; ?>">Confirm</a></td>
                    <td align="center" colspan="1">
					<?php if($row['subtype']=='HISTOLOGY'){echo"
					
					<a target='_blank'
					href='".$row['linkv']."?id=".$row['id']."'>EDIT</a>";}
					
					else if($row['subtype']=='CYTOLOGY' and $row['medi']=='FNAC' || $row['medi']=='PAP SMEAR'){echo"
					
					<a target='_blank'
					href='".$row['linkv']."?id=".$row['id']."'>EDIT</a>";}
					
					else if($row['subtype']=='CYTOLOGY' and $row['medi']!='FNAC'){
						
						echo "
						<a target='_blank'
					href='".$row['linkv']."?id=";?><?php
				...
				<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_opd_histo?id=<?php echo $row["id"]; ?>">Reject</a></td>	
                </tr>
                <?php $count++;  }}
                    else {
...
$count=1;
$sel_query="Select * from einves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between $test and '$apdate' and subtype in('HISTOLOGY','CYTOLOGY') and rejectby='' and rejecttime=''  order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="labreportconfirmae1_h?id=<?php echo $row["id"]; ?>">Confirm</a></td>
...
<td align="center"colspan="1"><a target='_blank' href="<?php echo $row['report']?>?id=<?php echo 'E'.$row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>&sno=<?php echo 'E'.$row['id']; ?>">REPORT</a></td>
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_ae_histo?id=<?php echo $row["id"]; ?>">Reject</a></td>
      </tr>
...
$count=1;
$sel_query="Select * from iinves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and rdate between '$test3' and '$apdate' and subtype in('HISTOLOGY','CYTOLOGY') and rejectby='' and rejecttime='' order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="labreportconfirm1_h?id=<?php echo $row["id"]; ?>">Confirm</a></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="reject_ipd_histo?id=<?php echo $row["id"]; ?>">Reject</a></td>
      </tr>
...
$test3=date('Y-m-d', strtotime('-30 days') );
$count=1;
$sel_query="Select * from endolab where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and odate between '$test3' and '$apdate' order by `id` DESC;";
