...
<tr>
		<td colspan="20"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="datewisemediimodietdoc?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Diet Order)<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from dietfollow where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `time` and `infusion` asc;";
