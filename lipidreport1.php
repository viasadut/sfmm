...
$query = mysqli_query($db,"select * from lipid where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'Total Cholesterol',1,0,'C');
$pdf->Cell('30',5,$data['tc'],1,0,'C');
$pdf->Cell('31',5,'mg/dL',1,0,'C');
$pdf->Cell('40',5,'<200',1,1,'C');

$pdf->Cell('80',5,'Triglycerides',1,0,'C');
$pdf->Cell('30',5,$data['tri'],1,0,'C');
$pdf->Cell('31',5,'mg/dL',1,0,'C');
$pdf->Cell('40',5,'<150',1,1,'C');

$pdf->Cell('80',5,'HDL Cholesterol',1,0,'C');
$pdf->Cell('30',5,$data['hdl'],1,0,'C');
$pdf->Cell('31',5,'mg/dL',1,0,'C');
$pdf->Cell('40',5,'>65',1,1,'C');

$pdf->Cell('80',5,'LDL Cholesterol',1,0,'C');
$pdf->Cell('30',5,$data['ldl'],1,0,'C');
$pdf->Cell('31',5,'mg/dL',1,0,'C');
$pdf->Cell('40',5,'<100',1,1,'C');


$pdf->Cell('80',5,'Chol/HDL Chol',1,0,'C');
$pdf->Cell('30',5,$data['cho'],1,0,'C');
$pdf->Cell('31',5,'mg/dL',1,0,'C');
$pdf->Cell('40',5,'Up to 4.0',1,1,'C');
...
lab_render_approval_footer($pdf, $db1, (isset($data3['subtype'])?$data3['subtype']:''), (isset($data3['resultby'])?$data3['resultby']:''), (isset($data3['checked_by'])?$data3['checked_by']:''), (isset($data3['cby'])?$data3['cby']:''));
$pdf->Ln(10);
