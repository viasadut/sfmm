...
<p align="center" class="style1">Todays  <?php echo $full; ?>'s Pending Cheque Approval List </p> 
...
<a target='_Blank' href="print_allocate_cheque?cname=<?php echo $row['creditor_name']; ?>&chequeno=<?php echo $row['chequeno']; ?>&id=<?php echo $row['id']; ?>">View</a>
    ...
    <?php
     ...
     $sel_query3="Select * from fund_transfer_master where approve_status='2' and '$user'='md' order by id desc;";
