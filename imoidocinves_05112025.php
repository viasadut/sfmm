...
$query159 = mysqli_query($db,"select * from radio1 where iname='$infu' and status='Active'");
$data159 = mysqli_fetch_assoc($query159);

$query1590 = mysqli_query($db,"select * from radio where iname='$infu' and status='Active'");
...
$sel90="SELECT * FROM radio1 WHERE `iname`='$infu' and status='Active';";
...
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated','$ordate','$type','$code','$price','$subtype','Ordered','$link','$report','$ndate','$linkv','$reportv','$unit','$d_name','$ip','$op','$acode','$ccentre')";
