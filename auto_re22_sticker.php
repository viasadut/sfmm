...
$ss1=$row40['sid'];
   ...
   $url1 = "doc_call_off_ca?dn=$dn&sid=$ss";   
	...
	<td style='vertical-align:top;color:red;text-align:center;font-size:14px'>
	<a href='$url'><img  src='prescription/prescription/doctor/".$ss1.".jpg' width='60'  height='60' align='center'></a>
	
	<span><a target='_blank' href='$url'><strong>".$dn."</strong></a><br>";
	}
	?>
...
if($row5['s_no']=='' and $row5['bill']=='BILLED' and $row5['status']!='HISTORY UPDATED' and $row5['status']!='SEEN')
{
echo "<p align='left' style='font-weight:bold;color:blue;font-size:12px;'>
<a  onclick='return confirm_click();' href='$url'>".$count4.' ) ' .$row5["pname"].'<br> MRN-'.$row5["pmrn"]."</a>
<a  onclick='return confirm_click();' href='$url1'><img src='print.png' title='Print Sticker' width='20' height='20' /></a>
";
...
else if($row5['s_no']!='' and $row5['bill']=='BILLED' and $row5['status']!='HISTORY UPDATED' and $row5['status']!='SEEN')
{
  echo "<p align='left' style='font-weight:bold;color:blue;font-size:12px;'>
  <a  onclick='return confirm_click();' href='$url'>".$count4.' ) ' .$row5["pname"].'<br> MRN-'.$row5["pmrn"]."</a>
  <a  onclick='return confirm_click();' href='$url1'><img src='print.png' title='Print Sticker' width='20' height='20' /></a>
...
else if($row5['s_no']=='' and $row5['bill']!='BILLED' and $row5['status']=='NOT SEEN' and $row5['dreffer']=='')
{
...
else if($row5['bill']!='BILLED' and $row5['status']=='NOT SEEN' and $row5['dreffer']!='')
{
echo "<p align='left' style='font-weight:bold;color:red;font-size:12px;'>".$count4.' ) ' .$row5["pname"].' '.'-'.$row5["s_no"].'<br> MRN-'.$row5["pmrn"].'<br> Referred By-'.$row5["dreffer"];}
