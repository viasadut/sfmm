...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Dependent Name</strong></th>
	  <th width="14%"><strong>Relation</strong>
...
$sel_query="Select * from pappnew where  adate1 BETWEEN '$start' and '$end' and status='SEEN' and ptype in ('Staff','Staff Children','Staff Spouse')";
$count=1;
...
{ ?>    <tr>
	  ...
	  <?php
	  $pp=$row['pmrn'];
		$query2 = "SELECT * FROM staff3 where mrn= '$pp' and status='Active'"; 
	 	$result2 = mysqli_query($con, $query2) or die(mysqli_error());
		$row2 = mysqli_fetch_assoc($result2);
		
		$query3 = "SELECT * FROM dependency where d_mrn= '$pp' and status='Active'"; 
	 	$result3 = mysqli_query($con, $query3) or die(mysqli_error());
		$row3 = mysqli_fetch_assoc($result3);

	  ?>
	  
	  <td align="center"><?php echo $row3["s_name"]; ?></td>
	  <td align="center"><?php echo $row["ptype"]; ?>  </td>
	        <td align="center"><?php echo $row2["dept"]; ?></td>
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from inpatient where anew BETWEEN '$start' and '$end' and type in ('Staff','Staff Children','Staff Spouse') order by anew";
