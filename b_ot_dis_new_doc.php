...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from otivisitendo where pmrn= '$pmrn' and ieid='$id' order by `id` desc;";
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198j_doc = "SELECT SUM(room) FROM otivisitendo where pmrn= '$pmrn' and ieid='$id' "; 
...
<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Hospital Discount:</a><?php echo $data45['ot_hos_dis'];?> (BDT)</strong></td></tr>	
<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Consultant Discount:</a><?php echo $data45['ot_doc_dis'];?> (BDT)</strong></td></tr>	
