...
$query43 = "SELECT COUNT(pmrn) FROM ot where otdate BETWEEN '$start' and '$end' and status IN ('RECEIVED','DONE');"; 
...
$count=1;
$sel_query="Select * from ot where otdate BETWEEN '$start' and '$end' and status IN ('RECEIVED','DONE');";
...
{ ?>    <tr>
	  ...
	  <td colspan="10"><?php echo $row["status"]; ?> </td>	
      </tr>
