...
if ($po_type !== '') {
    $sql = "
        SELECT id, creditor_code, total_amount, status, ceo_a_time, ono, po_type
        FROM po_table
        WHERE status='Approved'
          AND po_type='$po_type_esc'
                ...
                <td>
                    ...
                    <select name="po_type" id="po_type" required>
                        ...
                        <?php foreach ($po_types as $type) { ?>
                            <option value="<?php echo htmlspecialchars($type); ?>" <?php echo ($po_type === $type) ? 'selected' : ''; ?>>
...
<?php if ($po_type !== '') { ?>
<p>
    PO Type: <strong><?php echo htmlspecialchars($po_type); ?></strong><br>
