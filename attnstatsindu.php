...
<h1 align="center">Datewise Attendance Report</h1>
...
$sel_query="Select * from tm3 where uid='$uid' and date1 between '$start' and '$end' order by date1 asc";
...
$query198j = "SELECT SUM(ts) FROM tm3 where uid= '$uid' and date1 between '$start' and '$end'"; 
	 
$result198j = mysqli_query($dbhandle,$query198j) or die(mysqli_error());
