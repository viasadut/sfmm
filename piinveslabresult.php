...
function Header()
{
    ...
    $this->Cell(0,6,' Inpatient Investigation Result',0,1,'C');
...
$pdf->AddCol('user',25,'Update BY','L');
$pdf->AddCol('odate',40,'Update Date','L');
$pdf->AddCol('infusion',60,'Investigation');
$pdf->AddCol('result',130,'Result');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iinves where pmrn='$pmrn' and eid='$eid' and type='lab' and rstatus='RECEIVED' and resultstatus ='UPDATED'",$prop);
$pdf->Output();
?>