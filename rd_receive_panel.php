<?php 
    ...
    if(!isset($_SESSION['sess_username']) || $role!="rd"){
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecg_test where datenew between '$test' and '$date' and status1='updated' and spd_send_time!='' order by id desc;";
    ...
    <tr>
	  ...
	  <td align="center"><?php echo $row["ron"]; ?></td>
	  	  <td align="center"><?php echo $row["location"]; ?></td>
	  	   <td align="center"><a href="ecg_pdf1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Report</a></td>
...
<td align="center"><a onclick="return confirm_click();" href="rd_report_receive?id=<?php echo $row["id"]; ?>"><strong>Receive</strong></a></td>
      </tr>
    <?php $count++; } ?>
