...
$sel96="SELECT * FROM medi_stock WHERE `code`='$code_1' and batch_no='$batch_no' and location='Pharmacy' order by id asc limit 1;";
$result96 = mysqli_query($con,$sel96);
$b_chk_m=mysqli_fetch_assoc($result96);
$p_qty=$b_chk_m['add_qty']+$eqty2;
...
$p_rf=$b_chk_m['rfid'];
				...
				else 
	{
			...
			$strSQL = "update medi_stock1 set status='Returned Done' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);

			$ins_query3="update medi_stock set `add_qty`='$p_qty' where rfid='$p_rf' and batch_no='$batch_no' and location='Pharmacy'";
...
<tr>
      ...
      <td colspan="8" align="center"><strong>Medicine Name</strong></td>
     	  ...
     	  <td colspan="1" align="center"><strong>Returned Qty</strong></td>
		  
      	  <td colspan="1" align="center"><strong>Received_Qty</strong></td>
...
$new_qty=$sumr['SUM(add_qty)'];					 
     ...
     <td align="center" colspan="1" style="font-weight: bold;font-size:22px;color:green"><?php echo $count; ?></td>
      ...
      <td align="center"colspan="8" style="font-weight: bold;font-size:22px;color:green"><?php echo $row["g_name"]; ?></td>
...
<td align="center"colspan="1"><input name="eqty2_<?= $id ?>" type="text" value="<?php echo $row['add_qty'];?>" id="eqty2" readonly style="font-weight: bold;font-size:22px;color:green"></td>
