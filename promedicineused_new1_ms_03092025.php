...
$sel9=mysqli_query($db,"SELECT * FROM promediused_ms where pmrn= '$pmrn' and eid='$eid' and code='$code' and rfid='$rfid' and adate='$adate'");
$result9 = mysqli_fetch_assoc($sel9);
$pdos1=$result9['pdos'];
$pdos2=$result9['pdos']+$pdos;
$iid=$result9['id'];
$tprice2=$pdos2*$u_price;
...
{
$ins_query1="insert into promediused_ms (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`code`,`adate`,`price`) 
values ('$full','$pmrn','$pname','$medi1','$bb_name','$pdos','$eid','$date1','$type','$ieid','$rfid','$code','$adate','$tprice')";
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`brand`,`pmrn`,`eid`,`rfid`,`status`,`location`,`code`) values
			('$g_name','$pdos','$u_price','$tprice','$user','$adate','$bb_name','$pmrn','$eid','$rfid','Sale','Maternity Suite','$code')";
...
{
$ins_query1="update promediused_ms set pdos='$pdos2',price='$tprice2' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$ins_query21="update phar_sale set qty='$pdos2',tprice='$tprice2' where pmrn='$pmrn' and eid='$eid' and rfid='$rfid' and adate='$adate'";
...
{
$ins_query1="insert into promediused_ms (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`rfid`,`reuse`,`adate`,`code`,`price`) values 
('$full','$pmrn','$pname','$charge_name','$bb_name','$pdos','$eid','$date1','$type','$ieid','$rfid','Yes','$adate','$c_code','$new_charge_price')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`brand`,`pmrn`,`eid`,`rfid`,`status`,`location`,`code`,`reuse`) values
			('$charge_name','$pdos','$charge_price','$new_charge_price','$user','$adate','$bb_name','$pmrn','$eid','$rfid','Sale','Maternity Suite','$c_code','Yes')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery2 = mysqli_query($con,$strSQL2);
...
{
$ins_query1="update promediused_ms set pdos='$pdos2',price='$new_charge_price1' where id='$iid'";
mysqli_query($con,$ins_query1) or die(mysql_error());


$ins_query21="update phar_sale set qty='$pdos2',tprice='$new_charge_price1' where pmrn='$pmrn' and eid='$eid' and rfid='$rfid' and adate='$adate'";
mysqli_query($con,$ins_query21) or die(mysql_error());
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"].' ('.$row["brand"].')'; ?></td>
				  ...
				  <td align="center" colspan="2"><a href="prodelete1used_new?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>&rfid=<?php echo $row['rfid']; ?>&pdos=<?php echo $row['pdos']; ?>&reuse=<?php echo $row['reuse']; ?>">DELETE</a></td>
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "procedure_stock_test2_ms.php?pmrn=" + str, true);
