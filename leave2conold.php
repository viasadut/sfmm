...
//mysqli_query($con,$ins_query2) or die(mysql_error());
	...
	$ins_query1="insert into conleavedetails (`sid`,`tleave`,`tdays`,`sdate`,`edate`,`reason`,`md`,`ceo`,`status`,`rdoc`,`sname`,`lseen`) values ('$user','$tleave','$diff1','$sdate','$edate','$reason','Dr. Razeeb Hassan','Mohd Taufik Bin Ismail','Approved By Replacement Consultant','$rdoc','$full','RSEEN')";
mysqli_query($con,$ins_query1) or die(mysql_error());
