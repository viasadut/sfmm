...
$update="update patient set pname='$name',padd='$padd',pphone='$pphone',bdate='$page1',psex='$psex',eby='$fullname',etime='$etime',type='$type' where `ID`='$id'";
...
<!-- Form Title -->
      ...
      <input name="name" type="text" size="80" style="text-transform:uppercase" value="<?php echo $data["pname"]; ?>" readonly>
	  ...
	  <label for="age"><strong>Patient's Details :</strong></label>
           ...
           <label> <select id="browsers1" name="psex" readonly>
      ...
      <input name="pphone" type="text" size="13" style="text-transform:uppercase" value="<?php echo $data["pphone"]; ?>"readonly>	  
	  <input name="page1" type="text" size="11" style="text-transform:uppercase" value="<?php echo $data["bdate"]; ?>" readonly>
