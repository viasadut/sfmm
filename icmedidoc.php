...
$ins_query="insert into incmedi (`dname`,`pmrn`,`pname`,`ins`,`date`,`ins1`) values ('$full', '$pmrn','$pname','$pins','$date','$ins1')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Current Medication List</strong></label></td> </tr>



<tr><td colspan="10" align="center"bgcolor="lightblue"><label><strong>Current Medication List & Dosages</strong></label></td>
<td colspan="10" align="center"bgcolor="lightblue"><label><strong>Reconciled The Medicine</strong></label></td>
</tr>
<tr>


<td colspan="10" align="center"><textarea class="form-control" id="exampleTextarea" name="pins" rows="10" ></textarea></td>
<td colspan="10" align="center"><textarea class="form-control" id="exampleTextarea" name="pins1" rows="10" ></textarea></td>
</tr>			        
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
      	  ...
      	  <td colspan="16" align="center"><strong>Past History</strong></td>
...
$count=1;
$sel_query="Select * from incmedi where pmrn= '$pmrn' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
			      ...
			      <td align="center"colspan="8"><textarea class="form-control" id="exampleTextarea" name="pins" rows="10" readonly/><?php echo $row["ins"]; ?></textarea></td>
				  <td align="center"colspan="8"><textarea class="form-control" id="exampleTextarea" name="pins" rows="10" readonly/><?php echo $row["ins1"]; ?></textarea></td>
    ...
    <?php $count++; } ?>
	<tr><td align="right" colspan="10"><button onclick="self.close()">Close</button></td>
</tr>	
</table>
</form>
