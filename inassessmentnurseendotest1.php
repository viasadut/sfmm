...
$ins_query="insert into nurseassessendo 
(`pname`,`pmrn`,`psex`,`cname`,`crelation`,`cphone`,`page`,`pphone`,`aform`,`adate`,`astime`,`ma`,`acc`,`shistory`,`language`,`nip`,`edus`,`comor`,`valueableb`,`bodys`,`du`,`remarks`,`eid`) values
('$pname','$pmrn','$psex','$cname','$crelation','$cphone','$page','$pphone','$aform','$adate','$astime','$ma','$acc','$shistory','$language','$nip','$edus','$comor','$valueableb','$bodys','$du','$remarks','$eid')";
