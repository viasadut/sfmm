...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','imo','nurse')"; 
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><a href="edocgcs22?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><b>Patient Triage<b></a></td></tr>
