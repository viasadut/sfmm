<?php 
    ...
    if(!isset($_SESSION['sess_username']) || $role!="gpopd"){
...
<tr>
	<td colspan="5"align="center"><a href="prescription/prescription/viewnew_gopd"><font size="4.5">OPD</a></td>
		<td colspan="5" align="center"><a href="medicalcer"><font size="4.5">Issue Certificates</a></td>
...
<tr>
   ...
   <td colspan="3"align="center"><a href="cafe/OwnBill.php?m=<?= date('m') ?>"><font size="4.5">Current Month Cafe Bill</a></td>
   <td colspan="3"align="center"><a href="DRP/index.php"><font size="4.5">Diagnostic Reporting Portal</a></td>
</tr>
