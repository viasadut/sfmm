...
<p align="center" class="style1">List Of Approved Report </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecg where datenew between '$test' and '$date' and status1='Confirmed' and dname1='$full';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from echo where datenew between '$test' and '$date' and status1='Confirmed' and dname='$full';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ett where status1='Confirmed' and dname='$full';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from cathreport where status1='Confirmed' and dname='$full' ;";
