...
<td colspan="10" align="center"><h4><label><strong>Password</strong></label><h4></td>
...
<input type='text' list="browsers111" name="uname"  size="100" required autocomplete="off">
...
<td colspan="10" align="center"bgcolor="lightblue"><input type="password" name="upass" required value="" /></td>
