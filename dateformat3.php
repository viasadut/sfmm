...
$ins_query1="insert into patient (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone')";
...
<input name="dd" type="text" maxlength="2" size="1" value="">	/

<input name="mm" type="text" maxlength="2" size="1" value=""> /	

<input name="yy" type="text" maxlength="4" size="1" value="">		  
	  <br><br>
