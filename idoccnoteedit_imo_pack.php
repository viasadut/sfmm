...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('imo','diet','physio')"; 
...
$query5 = mysqli_query($db,"select * from icnote_pack where id='$id';");
...
$ins_query="update icnote_pack set infusion='$infu',inves='$inves',pnote='$pnote',euser='$full',etime='$adate1' where id='$id';";
...
<tr><td colspan="20"><?php echo $data["padd"]; ?></td></tr>
		...
		<tr>
             		...
             		<td colspan="3"><?php echo $data["sdate"]; ?></td>					 	
