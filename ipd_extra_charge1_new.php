...
if($user!=''){
$ins_query1="insert into ipd_extra_charge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`price`,`date1`,`add_user`,`add_time`,`qty`,`pms_code`,`doc_code`,`medi1`) values 
('$pmrn','$pname','$medi1','$eid','$date1','$price','$code','$price','$date2','$user','$time','$qty','$pms_code','$doc_code','$only')";
mysqli_query($con,$ins_query1) or die(mysql_error());
