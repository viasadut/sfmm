...
<p align="center" class="style1">Company Add Approval Panel </p> 
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from add_company where status='Forwared to CFO' ORDER BY id desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["con_name"]; ?></td>

      <td align="center"><?php echo $row["bin"]; ?></td>
	  <td align="center"><?php echo $row["remarks"]; ?></td>
	  
	  <td align="center"><a href="company_approve_mng?id=<?php echo $row["id"]; ?>">Proceed</a></td>
	  <td align="center"><a href="company_reject?id=<?php echo $row["id"]; ?>"><strong>Delete</strong></a></td>
