...
$ins_query61="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu2','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
mysqli_query($con,$ins_query61) or die(mysql_error());}

if (!empty ($_POST['infu3'])){
$ins_query62="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu3','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
mysqli_query($con,$ins_query62) or die(mysql_error());}

if (!empty ($_POST['infu4'])){
$ins_query63="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu4','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
mysqli_query($con,$ins_query63) or die(mysql_error());}

if (!empty ($_POST['infu5'])){
$ins_query64="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values ('$pmrn','$dname','$eid','$infu','$infu5','$ddate','$alert','$user','$date1','Active','$root','Rupdated')";
mysqli_query($con,$ins_query64) or die(mysql_error());}
}
...
$query49 = mysqli_query($db,"select * from imedi2 where pmrn='$pmrn' and eid='$eid'");
$data59 = mysqli_fetch_assoc($query4);

if(isset($_POST['ADD For Tomorrow'])){
$query="insert into imedi2 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$orderby','$odate','Active','$root','Rupdated')";
...
<option value='SOS'>SOS</option>
		...
		<td colspan="20"align="right">&nbsp;&nbsp;<a href="datewisemediimo?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><br><b>(See Datewise Medicine List)<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="Submit">Confirm</button></td>
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="imoinmeditomorrow?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&time=<?php echo $row["time"]; ?>&instruc=<?php echo $row["instruc"]; ?>&orderby=<?php echo $user; ?>&root=<?php echo $row["root"]; ?>&alert=<?php echo $row["alert"]; ?>">ADD For Tomorrow</a></td>
    ...
    <?php $count++; } ?>
	 <tr><td colspan="10"><a href="testpdf.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
