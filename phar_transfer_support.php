...
$query = "SELECT * FROM staff3 where sid= '$user'"; 
...
$url = "phar_transfer_support?sno=$sno";
header("Location: $url"); 
...
<input type="text" id="dept" class="form-control action" list="ddd" autocomplete="off" name='dept' required style="font-weight: bold;font-size:22px;color:green" value="<?php echo $row9['dept'];?>" readonly>

    <datalist id="ddd">
	<option value='<?php echo $row9['dept'];?>'><?php echo $row9['dept'];?></option>
