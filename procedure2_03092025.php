...
$ins_query="update procedure1 set proname1='$proname1', pnote='$pnote', diagnosis='$diagnosis', procharge='$procharge', ustatus='Updated',rstatus='DONE',remarks1='$o_ins' where id='$id'";
