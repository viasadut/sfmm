...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
      ...
      $query_p = "select * FROM iinves WHERE id='$updateid'"; 
...
$strSQL4 = "update iinves set t_status='1' where id='$updateid'";
$objQuery4 = mysqli_query($objConnect,$strSQL4);
      ...
      ('$updateid','CR','$cr_code','','$cost_centre','$date','1','$amount','IPD-INVES')";
      ...
      ('$updateid','DR','$dr_code','','$cost_centre','$date','1','$amount','IPD-INVES')";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
echo $end;
	 ...
	 $sel_query="Select * from iinves where dis_date BETWEEN '$start' and '$end' and rstatus='RECEIVED'";
...
<td align="center"><?php echo $row["charge"]; ?></td>
