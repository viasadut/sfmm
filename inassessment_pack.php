...
$query43 = "SELECT COUNT(pmrn) FROM package_screening where pmrn= '$pmrn' and status='Active';"; 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);
$count =$row43['COUNT(pmrn)'];
$count1 = $count+1;
$query = "SELECT * from package_screening where pmrn= '$pmrn' and eid='$eid' and status='Active'"; 
...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from massess_pack where pmrn='$pmrn' and eid='$eid'"; 
...
$ins_query="insert into massess_pack (`dname`,`pname`,`pmrn`,`eid`,`psex`,`page`,`pphone`,`ward`,`bed`,`aform`,`adate`,`astime`,`shistory`,`ccom`,`pill`,`gexam`,`abdomen`,`res`,`car`,`nsys`,`ent`,`breast`,`gen`,`mus`,`ex`,`uro`,`func`,`diag`,`mplan`,`dplan`) values
('$full','$pname','$pmrn','$eid','$psex','$page','$pphone','$ward','$bed','$aform','$adate','$astime','$shistory','$ccom','$pill','$gexam','$abdomen','$resp','$car','$nsys','$ent','$breast','$gen','$mus','$ex','$uro','$func','$diag','$mplan','$dplan')";
...
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Personal Particulars / History :</strong></label></td></tr>
		...
		<tr>
					 ...
					 <td colspan="4"><select name="aform" placeholder="Admitted From" >
             		 ...
             		 <td colspan="4"><input type="text" name="adate"style="background-color:skyblue;" value="<?php echo $row['sdate'];?>" /></td>					 	
...
<tr><td colspan="20"><textarea id="exampleTextarea" name="shistory" rows="5" placeholder="Source Of History"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Chief Complaints:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="ccom" rows="5" placeholder="Chief Complaints"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label for="age"><strong>History Of Present Illness:</strong></label></td></tr>
<tr><td colspan="20"><textarea id="exampleTextarea" name="pill" rows="5" placeholder="History Of Present Illness"></textarea></td>  </tr>	




<tr><td colspan="20" bgcolor="lightgreen"><h3><a target='_blank' href="nivacine?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Vaccine History</a>&nbsp;&nbsp;<a target='_blank' href="bbhistory1?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Birth History</a>&nbsp;&nbsp;<a target='_blank' href="nipasthistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Past History</a>&nbsp;&nbsp;<a target='_blank' href="icmedi?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Current Medication</a>&nbsp;&nbsp;<a target='_blank' href="psurgery?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Past Surgery History</a>&nbsp;&nbsp;<a target='_blank' href="obgyn?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">OBGYN History</a><br><a target='_blank' href="familyhistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Family History</a>&nbsp;&nbsp;<a target='_blank' href="feedhistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Feeding History</a>&nbsp;&nbsp;<a target='_blank' href="dhistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Development History&nbsp;&nbsp;<a target='_blank' href="comorimo?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Comorbidities</a></td></tr>		
...
<tr><td colspan="20"><textarea id="exampleTextarea" name="gexam" rows="5" placeholder="General Examination"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Abdomen:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="abdomen" rows="5" placeholder="Abdomen"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Respiratory:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="res" rows="5" placeholder="Respiratory"></textarea></td>  </tr>	
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Cardiovascular:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="car" rows="5" placeholder="Cardiovascular"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Nervous System:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="nsys" rows="5" placeholder="Nervous System"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>ENT:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="ent" rows="5" placeholder="ENT:"></textarea></td>  </tr>	
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Breast:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="breast" rows="5" placeholder="Breast"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Genitalia:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="gen" rows="5" placeholder="Genitalia"></textarea></td>  </tr>	
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Musculoskeletal:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="mus" rows="5" placeholder="Musculoskeletal"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Extrimities:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="ex" rows="5" placeholder="Extrimities"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Urological:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="uro" rows="5" placeholder="Urological"></textarea></td>  </tr>	
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Functional Assessment:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="func" rows="5" placeholder="Functional Assessment"></textarea></td>  </tr>	
<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Diagnosis:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="diag" rows="5" placeholder="Diagnosis"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Management Plan:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="mplan" rows="5" placeholder="Management Plan"></textarea></td>  </tr>	

<tr><td colspan="20" bgcolor="#00CCCC"><label><strong>Discharge Plan:</strong></label></td>  </tr>

<tr><td colspan="20"><textarea id="exampleTextarea" name="dplan" rows="5" placeholder="Discharge Plan"></textarea></td>  </tr>	
