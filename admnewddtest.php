...
$pdf->Cell('38',5,$data['adate'],1,0,'L');
$pdf->Cell('5');
$pdf->Cell('30',5,'Ward:',1,0,'L');
$pdf->Cell('28',5,$data['room'],1,1,'L');
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->ln(2);
$pdf->Cell('30',5,'Visitor Card:',1,0,'L');
$pdf->Cell('2');
$pdf->Cell('27',5,$data1['vcard'],1,0,'L');
$pdf->Cell('2');
$pdf->Cell('27',5,$data1['vcard1'],1,0,'L');
$pdf->Cell('2');
$pdf->Cell('33',5,$data1['acard'],1,0,'L');
$pdf->Cell('2');
$pdf->Cell('18',5,'Bed:',1,0,'L');
$pdf->Cell('40',5,$data['room1'],1,1,'L');
$pdf->ln(2);
$pdf->Cell('30',5,'Payment Type:',1,0,'L');
$pdf->Cell(2);
$pdf->Cell('60',5,$data1['pmode'],1,0,'L');
$pdf->Cell(2);
$pdf->Cell('30',5,'Payment By:',1,0,'L');
$pdf->Cell(2);
$pdf->Cell('57',5,$data1['premarks'],1,1,'L');

$pdf->ln(5);
$pdf->SetFont('Arial' , 'b' , 16);
$pdf->Cell('183',6,'FINDINGS ON ADMISSION',1,1,'C');
$pdf->ln(5);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('60',5,'Diagnosis:',1,0,'L');
$pdf->MultiCell('123',5,$data1['diagnosis'],1,1);
$pdf->ln(2);
$pdf->Cell('60',5,'Instruction On Admission:',1,0,'L');
$pdf->MultiCell('123',5,$data1['formo'],1,1);
$pdf->ln(2);
$pdf->Cell('60',5,'Suggested Date Of Admission:',1,0,'L');
$pdf->MultiCell('123',5,$data1['adate'],1,1);
...
$pdf->ln(5);
$pdf->SetFont('Arial' , 'b' , 16);
$pdf->Cell('183',6,'OTHER DETAILS',1,1,'C');
$pdf->ln(5);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('60',5,'Father Name:',1,0,'L');
...
$pdf->MultiCell('123',5,$data1['nidcard'],0,1);
$pdf->MultiCell('123',5,$data1['bcard'],0,1);
$pdf->MultiCell('123',5,$data1['vgcard'],0,1);
$pdf->MultiCell('123',5,$data1['ocard'],0,1);
$pdf->MultiCell('123',5,$data1['wcard'],0,1);
$pdf->MultiCell('123',5,$data1['hcard'],0,1);
$pdf->MultiCell('123',5,$data1['fcard'],0,1);
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->ln(1);
$pdf->Cell('183',5,'Father of the Nation Bangabandhu Sheikh Mujibur Rahman Memorial Trust',0,1,'C');
$pdf->ln(2);

$pdf->MultiCell('183',5,'Application form to get the treatment facilities for very poor patients from the income of the fund donated by the Honorable Chairman of Bangabandhu Memorial Trust and Honorable Prime Minister of the Republic of Bangladesh Government to Sheikh Fazilatunnessa Mujib Memorial KPJ Specialized Hospital.',0,1);
$pdf->ln(2);
$pdf->SetFont('Arial' , 'b' , 16);
...
$pdf->Cell('30',5,'Admission Date:',1,0,'L');
$pdf->Cell('38',5,$data1['rdate'],1,1,'L');
$pdf->ln(2);
$pdf->Cell('60',5,'Primary Consultant:',1,0,'L');
$pdf->Cell('120',5,$data1['dname'],1,1,'L');
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->ln(2);
...
$pdf->ln(2);
$pdf->Cell('60',15,'Clinical Condition:',1,0,'L');
$pdf->MultiCell('123',15,$data1['cinfo'],1,1);

$pdf->ln(2);
$pdf->Cell('183',5,'Mention if considered as a special case and give reasons ',1,1,'L');
$pdf->MultiCell('183',10,'',1,1);
$pdf->ln(2);
$pdf->Cell('60',5,'Financial condition of the patient',1,0,'L');
$pdf->MultiCell('123',5,'Very Poor',1,1);
...
$pdf->ln(2);
$pdf->Cell('70',20,'Chairman / Medical Directors Signature:',1,0,'L');
$pdf->MultiCell('123',20,'',1,1);
$pdf->Image('signature.jpg', 90,158);
$pdf->ln(2);
...
//$pdf->Cell(0,8,$pdf->Image('logo4.jpg', 15,8),'',1,0,'R');

$pdf->Image('signature.jpg', 45,87);
