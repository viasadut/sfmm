...
<td align="center"><a href="idocdetailsphysio?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
...
$query46 = mysqli_query($db,"select * from irefferal where pmrn='$tt1' and eid='$eid4' and sid='Physiotherapy'");
$data46=mysqli_num_rows($query46);

?>

<td align="center"><a target='_blank' href="pcovidresult?pmrn=<?php echo "$tt1"; ?>"><?php if($tt=='P' and $dcon=='confirmed'){echo "<span style='color:red;text-align:center;'><b>POSITIVE"; }else if($tt=='N' and $dcon=='confirmed'){echo "<span style='color:green;text-align:center;'><b>NEGATIVE"; }else if($co==0){echo "<span style='color:black;text-align:center;'><b>Test Not Done Yet";} else {echo "<span style='color:blue;text-align:center;'><b>Result Pending";} ?></a>  </td>
	  
	  <td align="center"><a target='_blank' href="idocnote?pmrn=<?php echo "$tt1"; ?>&eid=<?php echo "$eid4"; ?>"><?php if ($data46>0){echo "<span style='color:red;text-align:center;'><b>Referral"; }else {echo "<span style='color:blue;text-align:center;'><b>";} ?></a>  </td>
