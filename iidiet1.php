...
$query45 = mysqli_query($db,"select * from iidiet where pmrn='$pmrn' and id='$id'");
...
$update="update iidiet set dtime='$dtime',ddate='$ddate', status='Rupdated', duser='$user' where `id`='$id'";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Diet Order Form</strong></label></td> </tr>
...
<td colspan="8" align="center"><label><strong>Diet</strong></label></td> 
