...
$update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='DONE' where id='$id'";
mysqli_query($con,$update) or die(mysql_error());
...
<tr>
<td colspan="10" align="center"><input list="browsers5555" name="mm1" size=60% class="form-control" autocomplete="off" required value="<?php echo $smm1;?>">
...
<tr>
<td colspan="10" align="center"><input list="browsers50" name="mm11" size=60% class="form-control" autocomplete="off" required value="<?php echo $smm11;?>">
...
<tr>
<td colspan="10" align="center"><input list="browsers1" name="medi1" size=60% class="form-control" autocomplete="off" required>
...
<td colspan="5" align="center"><input list="browsers2" name="pins1" size=60% class="form-control" autocomplete="off" required>
