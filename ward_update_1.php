...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('nurse','doctor','imo','staff','bill','billin')"; 
...
else if($tb_result['tb_op']=='')
{
  ...
  values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$dname','Data Updated','Doctor','$charge','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre')";
  }

  else if($time!='Emergency' and $ptype=='Continuous'){
    $sql = "insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`,`dcode`,`ccode`,`ip`,`op`,`app_con`,`ccentre`) 
    values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$dname','Data Updated','Doctor','$charge','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre')";
    }

    else if($time!='Emergency' and $ptype!=''){
      $sql = "insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`,`dcode`,`ccode`,`ip`,`op`,`app_con`,`ccentre`,`cstatus`) 
      values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$dname','Data Updated','Doctor','$charge','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','Closed')";
      }

  else if($time=='Emergency' and $ptype==''){
    $sql = "insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`,`dcode`,`ccode`,`ip`,`op`,`app_con`,`ccentre`) 
    values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$dname','Data Updated','Doctor','900','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre')";
    }
      ...
      values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$dname','Data Updated','Doctor','900','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre')";
        ...
        $sql = "insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`,`dcode`,`ccode`,`ip`,`op`,`app_con`,`ccentre`,`cstatus`) 
        values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$dname','Data Updated','Doctor','900','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','Closed')";
        }
...
$result2 = mysqli_query($con,$sql2);
  ...
  $ee=$row2['eid'];
  $blank='';
  $morn_q="SELECT COUNT(id) FROM `icnote` WHERE pmrn='$pp1' and eid='$ee1' and user='$dname' and daten='$today'";
...
$result24 = mysqli_query($con,$sql24);
  ...
  $morn_q4="SELECT COUNT(id) FROM `icnote` WHERE pmrn='$pp14' and eid='$ee14' and user='$dname' and daten='$today'";
