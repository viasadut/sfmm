...
if($full ='$adoc' and $vtype=='Regular Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','600','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}


else if($full ='$adoc' and $vtype=='Emergency Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','800','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}


else if($full ='$adoc' and $vtype=='ICU Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','1200','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}


else if($full ='$adoc' and $vtype=='CCU Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','1200','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}

else if($full ='$adoc' and $vtype=='Covid Unit Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','1500','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}

else if($full ='$adoc' and $vtype=='Tele Consultation'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','300','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}
...
else if($full !='' and $rtype=='Continuous' and $vtype=='Regular Visit'){
...
else if($full !='' and $rtype=='Continuous' and $vtype=='Emergency Visit'){
...
else if($full !='' and $rtype=='Continuous' and $vtype=='ICU Visit'){
...
else if($full !='' and $rtype=='Continuous' and $vtype=='CCU Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','1200','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}

else if($full !='' and $rtype=='Continuous' and $vtype=='Covid Unit Visit'){

$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','Doctor','1500','$vtype','$daten')";
mysqli_query($con,$ins_query) or die(mysql_error());
}

else if($full !='' and $rtype=='Continuous' and $vtype=='Tele Consultation'){
...
<td colspan="3"><textarea name="inves" id="inves" class="form-control action" cols="30" rows="10"></textarea></td>
