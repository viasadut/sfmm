...
if (($_POST['staff'])=="All"){
$sel_query="Select * from tm3 where dept='$dept' and date1 between '$start' and '$end' order by uid asc";}

else 
	
	{$sel_query="Select * from tm3 where dept='$dept'and uid='$staff' and date1 between '$start' and '$end' order by date1 asc";}
//$start=$row["aadate"];
$count=1;
