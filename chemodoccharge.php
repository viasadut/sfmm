...
$query4 = mysqli_query($db,"select * from chemopapp where pmrn='$pmrn' and eid='$eid'and discharge=''");
...
$ins_query="insert into ivisitchemo (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`vtype`,`cdate`) values 
...
$count=1;
$sel_query="Select * from ivisitchemo where pmrn= '$pmrn' and eid='$episode'  order by `id` DESC;";
