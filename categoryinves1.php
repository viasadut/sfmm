...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<?php 
			$sql = "Select DISTINCT subtype  from radio;";
...
{ ?>    <tr>
	  ...
	  <td align="center"><input type="checkbox" name="check_list[]" value="{$row['id']}"><label><?php echo $row['id'];?></label>
	  ...
	  <td align="center"><input type="textbox" name="subtype[{$row['id']}]" value="<?php echo $row["subtype"]; ?>">
...
foreach ($_POST['check_list'] as $rowId){
   $email = $_POST['subtype'][$rowId];
   //$name = $_POST['name'][$rowId]; 
