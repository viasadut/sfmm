...
<p align="center" class="style1">Infection Management Beds List</p> 
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='5A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='5B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='5C' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='5D' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='6A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='6B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='6C' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='6D' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='7A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='7B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='7C' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='7D' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='ICU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='HDU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management) and block='NICU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='CCU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='Covid ICU' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='Any Block' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='NC5A' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='NC5B' and bed_status='Active' order by status asc";	
...
$count=1;	
$sel_query="Select * from bed where status in ('Under Infection Control Management') and block='Dialysis Unit' and bed_status='Active' order by status asc";	
