...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from conleavedetails where sid='$fullname' and  status not in ('Approved By all','Cancel','Rejected') order by id desc" ;
//$start=$row["aadate"];
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <td align="center"><?php echo $row["apdate"]; ?> 	
...
$count=1;
$sel_query1="Select * from conleavedetails where sid='$fullname' and status in('Approved By all','Cancel','Rejected') and sdate between '$date2' and '$date3' order by id desc";
//$start=$row["aadate"];


$row1 = mysqli_query($con,$sel_query1);
echo "APPROVED LEAVE";
while($row2 = mysqli_fetch_assoc($row1)) { ?>
      <td align="center"><?php echo $count; ?></td>
      <td align="center"><?php echo $row2["sname"]; ?></a></td>
      <td align="center"><?php echo $row2["tleave"]; ?>
	  <td align="center"><?php echo $row2["tdays"]; ?>
      <td align="center"><?php echo $row2["sdate"]; ?>
      <td align="center"><?php echo $row2["edate"]; ?> 
	<td align="center"><?php echo $row2["apdate"]; ?> 	  
	  <td align="center"><?php echo $row2["reason"]; ?>  
	  <td align="center"><?php echo $row2["rdoc"]; ?>  
	  <td align="center"><?php echo $row2["status"]; ?>  
