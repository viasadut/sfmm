...
$ins_query="insert into stret (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
<td colspan="4" align="center"><label><strong>Special Treatment</strong></label></td> 
...
<td colspan="4" align="center"><input type="text" name="dtime" required value="" /></td>
