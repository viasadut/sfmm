...
$ins_query2="update purchase_stock3 set `add_qty`='$new_qty', `req_qty`='$new_qty' where id='$row_id' and location='Store'";
mysqli_query($con,$ins_query2) or die(mysql_error());
...
mysqli_query($con,$ins_query2) or die(mysql_error());
        ...
        $sel95r="SELECT SUM(t_price) FROM purchase_stock3 WHERE `grn`='$grn' and b_remarks='';";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="8"><a target='_blank' href="all_product_list5_purchase?id=<?php echo $row['pid'];?>"><?php echo $row["name"]; ?></a></td>
	  ...
	  <td align="center"colspan="2"><?php echo $row["o_qty"]; ?></td>
<td align="center"colspan="2"><?php echo $row["r_qty"]; ?></td>	  
<td align="center"colspan="2"><?php echo $row["tprice"]; ?></td> 	  
...
<select class="js-example-basic-single" name="check_by" required>
				...
				<?php 
			$sql76 = "select * from `staff3` where status='Active' and dept in ('Purchasing And Store Services') ";
...
<td align="center"colspan="1"><a target='_Blank' href="medi_bar?g_name=<?php echo $row['g_name']; ?>&rfid=<?php echo $row['rfid']; ?>">Barcode</a></td>	  
