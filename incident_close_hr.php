...
if($user !='')
{
	...
	$ins_query1="update incident1 set closing_remarks='$com',close_by='$user',close_time='$adate',status='Closed' where id='$id'";
...
<!-- Form Title -->
		<h1>Closing Remarks of The Incident </h1>


        
			
	  <label for="age"><strong>Closing Remarks:
	  ...
	  <a target='_blank' href='incident_report?id=<?php echo $id;?>'>Upload Final Report</a>
