...
<td colspan="20" align="center"><strong>Fluid CHART<br>
...
<tr>
      <td colspan="2" align="center"><strong>S.No</strong></td>
      
	  <td colspan="3" align="center"><strong>Date</strong></td>
	  
	  
	  
      <td colspan="5" align="center"><strong>Total Intake Quantity (ml)</strong></td>  
	  <td colspan="5" align="center"><strong>Total Output Qty (ml)</strong></td>   
	  <td colspan="5" align="center"><strong>Difference</strong></td>   
...
$count=1;
$sel_query="Select * from influid where pmrn= '$pmrn' and eid='$eid' group by date1 desc;";
...
{ ?>    <tr>
      ...
      <td align="center" colspan="2"><?php echo $count; ?></td>
      
      
	  <td align="center"colspan="3"><font size="6.5" ><a target='_blank' href="influiddoctest1nurse.php?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&date=<?php echo $row["date1"]; ?>"><strong><?php echo $row["date1"]; ?></td>
...
$query298 = "SELECT type, SUM(qty) FROM influid where date='$date3' and pmrn='$pmrn' and eid='$eid'and type='intake'GROUP BY type"; 
...
$query198 = "SELECT type1, SUM(qty1) FROM influid where date='$date3' and pmrn='$pmrn'and eid='$eid'and type1='Output 'GROUP BY type1"; 
...
$query398 = "SELECT route, SUM(qty) FROM influid where date='$date3' and pmrn='$pmrn' and eid='$eid'and route='oral'GROUP BY route"; 
...
$query498 = "SELECT route, SUM(qty) FROM influid where date='$date3' and pmrn='$pmrn' and eid='$eid'and route='IV'GROUP BY route"; 
...
?>
	  ...
	  <td align="center"colspan="5" bgcolor="lightgreen"><font size="6.5" ><strong><?php echo $test; ?></td>
	  <td align="center"colspan="5"bgcolor="lightblue"><font size="6.5" ><strong><?php echo $test1; ?></td>
	  <td align="center"colspan="5"bgcolor="red"><font size="6.5" ><strong><?php echo $test3; ?></td>
