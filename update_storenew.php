...
$eqty5 = $_POST['eqty2_'.$updateid];
			...
			$strSQL = "update storenew set price='".$eqty5."' where id='".$updateid."'";
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Brand Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from storenew where price='0'";
     ...
     <td align="center" colspan="1" ><?php echo $count; ?></td>
      ...
      <td align="center"colspan="9" ><?php echo $row["ename"]; ?></td>
	  
	  	  <td align="center"colspan="2" ><?php echo $row["price"]; ?></td>
		  <td align="center"colspan="2" ><?php echo $row["priceold"]; ?></td>
...
<td align="center"colspan="1"><input name="eqty2_<?= $id ?>" id="eqty2" type="text" value="<?php echo $row['priceold'];?>" readonly ></td>
