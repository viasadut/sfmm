...
<?php 
    ...
    $query5 = mysqli_query($con,"select * from chikun where pmrn='$pmrn' and sno='$sno'");
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="chikun2" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['chikun2']?>" required>
        </fieldset>
        <table>
            <tr>
