...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Approx. Cost</strong>  
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from preadm where status='' and tstatus='Approved'order by id desc;";
    ...
    <tr>
	  ...
	  <td align="center"><?php echo $row["gender"]; ?> 
	  	  ...
	  	  <td align="center"><?php echo $row["page"]; ?> 
		  	  <td align="center"><?php echo $row["approx_amount"]; ?> 
	  ...
	  <td align="center"><?php echo $row["btype"]; ?> 
