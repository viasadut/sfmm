...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Referred Doctos's Name</strong>   
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ecgapp where dname='$full' and status='';";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="ecg?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row['dname'];?>&rname=<?php echo $row['rname'];?>&proname=<?php echo $row['proname'];?>&id=<?php echo $row['id'];?>">UPDATE</a></td>
