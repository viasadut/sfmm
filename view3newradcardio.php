...
<form action="view3newradcardio" method="POST">
...
$count=1;
$sel_query="Select * from ecg where pmrn= '$pmrn' and dname1='$full';";
...
<td align="center"><a href="ecgmanualedit?eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Edit</a></td>	  
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from echo where pmrn= '$pmrn' and status1='Confirmed' and rname='$full';";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="echo1edit?eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">EDIT</a></td>

 <td align="center"><a target='_blank' class="thumbnail fancybox" rel="ligthbox" href="spd1pic/<?php echo $row['upload'] ?>">
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from ett where pmrn= '$pmrn';";
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from cathreport where pmrn= '$pmrn';";
