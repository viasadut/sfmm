...
$query = mysqli_query($db,"select * from endopapp where id='$id'");
...
$pdf->Cell('41',5,$data1['adate'],1,1,'L');
$pdf->ln(2);
...
$pdf->Cell('93',15,'Chairman / Deputy Medical Director Signature:',1,0,'L');
$pdf->MultiCell('90',15,'',1,1);
//$pdf->Image($data1['mdsign'],110,158);
$pdf->Image('424.jpg',110,158);
$pdf->ln(2);
$pdf->Cell('92',5,'Name: Dr. J.M.H Qausar Alam',1,0,'L');
...
$pdf->ln(6);
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('183',5,'Approved by Chief Executive Officer (CEO) / Medical Director of the hospital (MD):',0,1);
...
$pdf->ln(2);
$pdf->Cell('183',20,'Medical Director / CEO Signature:',1,1,'L');
//$pdf->Image($data1['ceosign'],55,240);
$pdf->Image($data1['mdsign'],80,240);

$pdf->ln(2);
$pdf->Cell('75',15,'Name: Dr. Razeeb Hassan',1,0,'L');
//$pdf->Cell('49',15,'Date:'.$data1['ceoa'],1,0,'L');
$pdf->Cell('49',15,'Date:',1,0,'L');
