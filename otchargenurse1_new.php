...
$sel96="SELECT * FROM purchase_stock WHERE `sno`='$rfid' and status='Served';";
...
$sel990="SELECT * FROM purchase_stock WHERE `sno`='$rfid' and add_qty>0  and status='Served';";
...
if($res990=mysqli_num_rows($result990)==0)
{
    ...
    echo 'alert("Unsuccessful !!! The storenew Name is not in your department Stock.."); ';
    echo '</script>';
    }
...
$query1="update purchase_stock set `add_qty`='$m_qty1' where `sno`='$rfid'";
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "purchase_stock_test2.php?pmrn=" + str, true);
