...
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid' and odate ='$dd' and status='Cancel' order by infusion;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row["server"]; ?></td>
