...
if($pack=='P2')
{
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`,`adate1`,`bill`,`pack`) values ('$name', '$pmrn','$pphone','$padd','Dr. Md. Mostofa Kaisar','$date10','Consultation Package-2','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$adate1','BILLED','Consultation Package-1')";
mysqli_query($con,$ins_query) or die(mysql_error());


$ins_query2="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`,`adate1`,`bill`,`pack`) values ('$name', '$pmrn','$pphone','$padd','Dr. Farzana Sultana Borna','$date10','Consultation Package-2','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$adate1','BILLED','Consultation Package-1')";
...
$ins_query32="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`,`adate1`,`bill`,`pack`) values ('$name', '$pmrn','$pphone','$padd','Physiotherapy','$date10','Consultation Package-2','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$adate1','BILLED','Consultation Package-1')";
...
<label><strong>Package:</strong></label>
		...
		<option value="">-Select-</option>;
			<option value="P1">Consultation Package-1</option>;
			<option value="P2">Consultation Package-2</option>;
