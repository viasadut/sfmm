...
$bill_user=$row['user'];
$bill_date=$row['date'];
$query43 = "SELECT SUM(amount_receive) FROM pms_bill where user= '$bill_user'and date='$bill_date' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi');"; 
...
$query43_o = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date='$bill_date' and refund NOT IN ('1','2');"; 
	 
$result43_o = mysqli_query($con, $query43_o) or die(mysqli_error());
$temp_opd_collection_all = mysqli_fetch_assoc($result43_o);

$query43_dis = "SELECT SUM(dis_amount) FROM pms_payment where user= '$bill_user'and date='$bill_date';"; 
	 
$result43_dis = mysqli_query($con, $query43_dis) or die(mysqli_error());
$opd_collection_dis = mysqli_fetch_assoc($result43_dis);

$query43_refund = "SELECT SUM(amount) FROM pms_payment where user= '$bill_user'and date='$bill_date' and refund IN ('1','2');"; 
...
$query43_refund_phar_indu = "SELECT SUM(r_amount) FROM refund_bill where date='$bill_date' and refund_by='$bill_user' and location!='IPD';"; 
...
$outstanding_query = "SELECT SUM(amount) FROM pms_bill where amount_receive='0' and user= '$bill_user'and date='$bill_date' AND amount!='0' AND dname!='IPD ADVANCE' AND amount>dis_amount"; 
...
$cash_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date='$bill_date' and refund NOT IN ('1','2') and p_mode='Cash';"; 
...
$card_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date='$bill_date' and refund NOT IN ('1','2') and p_mode='Card';"; 
...
$cheque_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date='$bill_date' and refund NOT IN ('1','2') and p_mode='Cheque';"; 
...
$bkash_query = "SELECT SUM(amount) FROM pms_payment where user='$bill_user'and date='$bill_date' and refund NOT IN ('1','2') and p_mode in ('bKash','Bkash');"; 
...
$net_collection=$phar_collection['SUM(amount_receive)']+$temp_opd_collection_all['SUM(amount)']-$opd_collection_dis['SUM(dis_amount)']-$phar_collection_dis['SUM(dis_amount)']-$opd_collection_refund['SUM(amount)']-$opd_collection_refund_phar_indu['SUM(r_amount)'];
      ...
      <td align="center">
      <a target='_blank' href="cashier_details_cash?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $cash;
      ...
      ?></a> </td>
           ...
           <td align="center">
      <a target='_blank' href="cashier_details_card?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $card; 
   
      ?></a> </td>

<td align="center">
      <a target='_blank' href="cashier_details_cheque?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $cheque; 
...
<td align="center">
      <a target='_blank' href="cashier_details_bkash?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $bkash; 
...
<td align="center">
      <a target='_blank' href="cashier_details_discount?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $opd_collection_dis['SUM(dis_amount)']
   
      ?></a> </td>

<td align="center">
      <a target='_blank' href="cashier_details_total?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $opd_collection;
   
      ?></a> </td>

<td align="center">
      <a target='_blank' href="cashier_details_refund?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
...
<td align="center">
      <a target='_blank' href="cashier_details_net?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
      <?php echo $net_collection 
   
      ?></a> </td>

<td align="center">
      <a target='_blank' href="cashier_outstanding?user=<?php echo $row['user'];?>&date=<?php echo $bill_date; ?>">
...
$query43_t = "SELECT SUM(amount_receive) FROM pms_bill where date between '$start' and '$end' and location IN ('OPD_DIS','OTC_Sale','OPD_Medi');"; 
