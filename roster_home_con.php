...
for ($m=1; $m<=12; $m++) {
     ...
     //$month;
		 ...
		 $url = "roaster_details1_new2?id=$jan&id1=$jan1"; 
		 $url2 = "roaster_details1_new2?id=$feb&id1=$feb1"; 
		 $url3 = "roaster_details1_new2?id=$mar&id1=$mar1"; 
		 $url4 = "roaster_details1_new2?id=$apr&id1=$apr1"; 
		 $url5 = "roaster_details1_new2?id=$may&id1=$may1"; 
		 $url6 = "roaster_details1_new2?id=$jun&id1=$jun1"; 
		 $url7 = "roaster_details1_new2?id=$jul&id1=$jul1"; 
		 $url8 = "roaster_details1_new2?id=$aug&id1=$aug1"; 
		 $url9 = "roaster_details1_new2?id=$sep&id1=$sep1"; 
		 $url10 = "roaster_details1_new2?id=$oct&id1=$oct1"; 
		 $url11 = "roaster_details1_new2?id=$nov&id1=$nov1"; 
		 $url12 = "roaster_details1_new2?id=$dec&id1=$dec1"; 
