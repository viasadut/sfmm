...
$number_of_digits;
 ...
 if($icode==61010163)
			...
			$strSQL = "UPDATE iinves set rstatus='RECEIVED', status='RECEIVED', rby='$user', rtime='$dtime' , barcode1='$new_bar',barcode='$new_bar',otime='$dtime1',rdate='$pdate',s_no='$mno',barcode2='$a1',barcode3='$b1'";
...
mysqli_query($con,$ins_lis1_2);
			...
			$strSQL = "UPDATE iinves set rstatus='RECEIVED', status='RECEIVED', rby='$user', rtime='$dtime' , barcode1='$new_bar',barcode='$new_bar',otime='$dtime1',rdate='$pdate',s_no='$mno',barcode2='$a1'";
			$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
...
mysqli_query($con,$ins_lis1);
	...
	$url = "lab_sample_receive_bar_lab_test21.php?barcode=$new_bar";
header("Location: $url"); 
