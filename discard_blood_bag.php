...
$query4 = mysqli_query($db,"select * from bcross1 where id='$id'");
$data = mysqli_fetch_assoc($query4);
      if($_POST["employee_id3"] != '' and $user !='')  {
            ...
            $query = "update bcross1 set status='Discard (Expired)',discard_remarks='$return_remarks',discard_by='$user',discard_time='$etime' WHERE id = '$id'";  
