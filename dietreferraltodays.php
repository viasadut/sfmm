...
<h1 align="center">Today's Diet Referral</h1>
...
$sel_query="Select * from pappnew where dname='Ms. Maisha Musharrat Nazia' and adate ='$date' order by ID";
$count=1;
...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="historynewphysiodiet?pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row["eid"]?>&date=<?php echo $row["adate"]?>&dname=<?php echo $row["dreffer"]?>"><b>Details<b></a></td>	  
      </tr>
