...
$queryd = "SELECT * FROM doctor where dname= '$dname'"; 
...

{
    ...
    echo 'alert("Surgeon Name is Matched !!"); ';
    echo '</script>';
...
('$dname', '$dcode','$pro_name','$pname','$pmrn','$pphone','$psex','$page','$date1','$s_date','$user','$remarks','Pending','$loc')";
...
$url = "work_report1?pmrn=$pmrn&dname=$dname";
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<input list="24" name="dname"  class="country" value="" required size='150'>
			        <datalist id="24" name="dname"  class="country" >
...
<input list="23" name="pro_name"  class="form-control" value="" required>
