...
$ins_query33="select COUNT(id) from opd_appoint1 where `dname`='$name' and `dslot`='$select' and `date1`='$dd'";
mysqli_query($con,$ins_query33);
$row5 = mysqli_fetch_array($ins_query33);
...
function showUser() {
    ...
    xmlhttp.open("GET","getuser_1.php?q="+q+"&q1="+q1,true);
    xmlhttp.send();
}
</script>
