...
$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`entry_time`,`daten`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated','$entry_time','$daten')";
...
$count=1;
$sel_query="Select * from icnote where pmrn= '$pmrn' and eid='$episode' order by `id` DESC;";
...
$diff_minutes = round(abs($to_time - $from_time) / 60,2);
	  ...
	  $url7 = "idoccnoteedit_imo?pmrn=$pmrn&eid=$eid&id=$id"; 
