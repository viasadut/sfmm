...
<td colspan="3"><button type="submit" name="bsearch">Search</button></td>
    ...
    <tr>
      ...
      <td colspan="1"align="center"><strong>DOB </strong></td>
...
{ ?>    <tr>
      ...
      <td colspan="1"align="center"><?php echo $row["bdate"]; ?> </td> 
      <td colspan="2"align="center"><?php echo $row["padd"]; ?></td>
      <td colspan="1"align="center"><?php echo $row["pphone"]; ?> </td>
	  <td align="center"><a href="manual_spd_request?pmrn=<?php echo "$pmrn"; ?>&ID=<?php echo $row["ID"]; ?>">GO</a></td>
