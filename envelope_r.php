...
$pdf->SetXY(75,35);
//$pdf->SetXY(23,1);
$pdf->Cell('140',2,$data1['invitee'],0,0,'R');
$pdf->SetXY(75,38);
$pdf->Cell('140',2,$data1['desig'],0,1,'R');
$pdf->SetXY(75,41);
$pdf->Cell('140',2,$data1['organization'],0,1,'R');
...
$pdf->SetXY(75,56);
$pdf->Cell('140',2,'Scan for Update Deliver Status',0,1,'R');
}
$pdf->SetXY(134.5,45);
$pdf->Cell( 160, 25, $pdf->Image($image2, $pdf->GetX(), $pdf->GetY(), 10.78), 0, 0, 'L', false );
$pdf->SetFont('Arial' , 'b' , 5.5);
$pdf->SetXY(140,56);
