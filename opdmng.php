...
$sel_query="Select * from pappnew where  adate1 BETWEEN '$start' and '$end' and status='SEEN'";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from pappnew where dname='$bt' and adate1 BETWEEN '$start' and '$end' and status='SEEN' ";
 } 
$count=1;
