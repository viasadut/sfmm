...
<head>
<meta charset="utf-8">
<title>Purchase & Store Products</title>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from storenew where estatus='Active' and etype in ('Disposable','MEDICAL DISPOSAL') ORDER BY ename desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  $query5 = "SELECT SUM(add_qty) from purchase_stock where code='$ccd' and location='Store'"; 
