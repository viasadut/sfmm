...
//$id =$_GET['id'];
$count=1;
$sel_query="Select distinct dname,pmrn,eid from pmedi where date='$date' order by id desc;";
...
$row1 = mysqli_fetch_assoc($re);
	  ...
	  <td align="center"><a href="phar_update_bill3_new_opd?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&sno=<?php echo $runningTime+$row['pmrn']+$row['eid'];?>">UPDATE</a></td>
