...
$query3 = "SELECT * FROM histo where sno= '$sno' and pmrn='$pmrn' and eeid='$eid'"; 
...
$update33="update histo set (`cinfo`='$cinfo',`spe`='$spe',`gdes`='$gdes',`mdes`='$mdes',`dia`='$dia',`hno`='$hno' where pmrn='$pmrn' and eid='$eid' and sno='$sno' ";
mysqli_query($con,$update33) or die("Problem in Update pappnew");



//$gg= $_REQUEST['pname'];
$update="update iinves set resultstatus='Updated By Technologist',resulttime='$rtime' where `id`='$id'";
mysqli_query($con,$update) or die(mysql_error());

//$url = "histoview?pmrn=$pmrn&eid=$count1";
//header("Location: $url");
...
<tr>				 <td colspan="10"><input type="text" name="pname"  value="<?php echo $row39['pname'];?>" readonly/></td>
					...
					<td colspan="2"><input type="text" name="page" required value="<?php echo $row39['page'];?>" /></td>  	
					 <td colspan="2"><input type="text" name="psex" required value="<?php echo $row39['pgender'];?>" /></td>
				...
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea" name="cinfo" rows="5" ><?php echo $row39['room'];?></textarea></td>  </tr>
						 
						 <tr><td colspan="20"><label><strong>HISTOPATHOLOGY No:</strong></label></td>  </tr>
						 <tr><td colspan="20"><input type="text" name="hno" style="text-transform:uppercase" required value="<?php echo $row3['hno'];?>" /></td>  </tr>


						 <tr><td colspan="20"><label><strong>Specimen:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="spe" rows="5"><?php echo $row3['spe'];?></textarea></td>  </tr>
						<tr><td colspan="20"><label><strong>Gross Description:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="gdes" rows="5"><?php echo $row3['gdes'];?></textarea></td>  </tr>
				<tr><td colspan="20"><label><strong>Microscopic Description</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="mdes" rows="5"><?php echo $row3['mdes'];?></textarea></td>  </tr>
														

<tr><td colspan="20"><label><strong>Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="dia" rows="5"><?php echo $row3['dia'];?></textarea></td>  </tr>
