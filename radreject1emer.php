...
$query45 = mysqli_query($db,"select * from einves where id='$id'");
...
//$id1=$_REQUEST['ID'];
$url = "emerrad1?pmrn=$pmrn&eid=$eid";
$query = "UPDATE einves set rb='$user',rtime='$dtime', rstatus='REJECTED', rcomments='$result',status='REJECTED' where id='$id'"; 
