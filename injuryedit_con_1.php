...
*/
$ins_query="update injury set `fdate`='$adate',`fdate_new`='$adate1',`remark`='$remark',`ddate`='$ddate',`ddate_new`='$ddate1',`dtime`='$dtime',`diagnosis`='$diag',`ffor`='$ifind',`fdate1`='$atime',status='Waiting For Acknowledgement',confirmby='$full', con_time='$time' where id='$id'";
