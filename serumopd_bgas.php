...
$ins_query1="insert into serumtbl_gas (`pname`,`pmrn`,`pphone`,`psex`,`page`,`s1`,`p1`,`c11`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`hco3`,`tco2`,`ph`) values 
('$pname','$pmrn','$pphone','$psex','$page','$sodium','$potassium','$chloride','$user','$adate','$eid','$iname','$id','$sno','$hco3','$tco2','$ph')";
...
$update1="update alllab set resultstatus='Updated By Technologist',result='$rr',resulttime='$adate',resultby='$user',r1='$sodium',r2='$potassium',r3='$chloride',result1='$rr1'
where `sno`='$sno'";
...
<!-- Form Title -->
      ...
      <input name="hco3" type="text" size="70" style="text-transform:uppercase" value=""required/>
