...
{
$url = "preeditphysio?pmrn=$pm&eid=$eid1&dname=$pd&date=$dt1&id=$id1&ID=$id";
header("Location: $url");
}
?>
<!DOCTYPE html>
...
<?php $query1 = "select * from tphysio where pmrn='$pmrn' and dname='$dname' and eid='$eid'";
$result = mysqli_query($con,$query1);
while($data1 = mysqli_fetch_array($result))
...
<td colspan="5"><a target='_blank' href="p4newphysio.php?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&date=<?php echo "$dt"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
<td colspan="5"><a href="viewnewphysio54.php"><b>BACK</a></td>
</tr>
