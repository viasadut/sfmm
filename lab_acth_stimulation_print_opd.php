...
$query = mysqli_query($db,"select * from lab_acth_stimulation where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$query3 = mysqli_query($db,"select * from alltest where pmrn='$pmrn' and eid='$eid' ");
...
$query4 = mysqli_query($db,"select * from radio where iname='$inves'");
...
$pdf->Cell('80',5,'S. Cortisol(0 Minute) ',1,0,'C');
$pdf->Cell('30',5,$data['0min'],1,0,'C');
$pdf->Cell('31',5,'μg/dl',1,0,'C');
$pdf->Cell('40',5,'6.2-19.4',1,1,'C');

$pdf->Cell('80',5,'S. Cortisol (30 Minute) ',1,0,'C');
$pdf->Cell('30',5,$data['30min'],1,0,'C');
$pdf->Cell('31',5,'μg/dl',1,0,'C');
$pdf->Cell('40',5,'6.2-19.4',1,1,'C');

$pdf->Cell('80',5,'S. Cortisol (60 Minute) ',1,0,'C');
$pdf->Cell('30',5,$data['60min'],1,0,'C');
$pdf->Cell('31',5,'μg/dl',1,0,'C');
$pdf->Cell('40',5,'6.2-19.4',1,1,'C');

$pdf->ln(10);

$pdf->Cell('180',5,'Interpretation:',0,1,'L');
$pdf->MultiCell('180',5,$data4['interpretation']);
