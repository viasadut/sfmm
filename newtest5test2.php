...
<tr>
<td colspan="10" align="center"><input list="browsers111" name="medi1" size=60% class="form-control" />
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><input type="text" name="medi2" value="<?php echo $row["medi"]; ?>"></td>
			      <td align="center"colspan="5">
				  
				  
				  
<input type="text" name="test" id="test" value="<?php echo $row["pdos"]; ?>"/></td>
				  
				  
				  
				  
				  
<td colspan="20"align="right"><button type="submit" name="Submit11">ADD</button></td>
...
//echo $medi2;
////echo $pdos1;
//$url = "newtest5test2.php?pmrn=$pmrn&eid=$eid&dname=$dname&eido=$eid1";
$query="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`pdos`,`eid`) values ('$full','$pmrn','$pname','$medi2','$pdos1','$eid')";
...
<input type="text" name="test" id="test" value="<?php echo $row["pdos"]; ?>"/></td>
				  ...
				  <td align="center" colspan="2"><a href="delete1?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid1=<?php echo "$eid1"; ?>&eid=<?php echo "$eid"; ?>&pname=<?php echo $row["pname"]; ?>&medi=<?php echo $row["medi"]; ?>&test=" onclick="this.href+=document.getElementById('test').value; return true;" >ADD</a></td>
