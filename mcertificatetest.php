...
<label for="name"><strong>Paients Identify:</strong></label>
      ...
      <textarea rows="5"  name="diag" required value=""></textarea>
			...
			<select name="ufor" value="" required>
		...
		<label for="mail"><strong>From :</strong></label>
									...
									<p>
									  <input type="text" name="tdate" id="datepicker1" placeholder="Select Date" size="15" value="">
									  
									  
									  <label for="mail"><strong>Re-Examination Date :</strong></label>
									<p>
									  <input type="text" name="rdate" id="datepicker2" placeholder="Select Date" size="15" value="">
