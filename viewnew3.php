...
$lab = "SELECT COUNT(id) from alltest where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and date1 between '$test' and '$apdate'"; 
$lab_result= mysqli_query($con, $lab) or die(mysqli_error());
$lab_row = mysqli_fetch_array($lab_result);
$lab_r=$lab_row['COUNT(id)'];

$lab1 = "SELECT COUNT(id) from iinves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and ndate between '$test' and '$apdate'"; 
$lab_result1= mysqli_query($con, $lab1) or die(mysqli_error());
$lab_row1 = mysqli_fetch_array($lab_result1);
$lab_r1=$lab_row1['COUNT(id)'];

$lab2 = "SELECT COUNT(id) from einves where type='lab' and rstatus ='RECEIVED' and status ='RECEIVED' and resultstatus='Updated By Technologist' and ndate between '$test' and '$apdate'"; 
$lab_result2= mysqli_query($con, $lab2) or die(mysqli_error());
$lab_row2 = mysqli_fetch_array($lab_result2);
$lab_r2=$lab_row2['COUNT(id)'];

$lab_all=$lab_r + $lab_r1 + $lab_r;
...
<tr>
	<td colspan="5"align="center"><a href="prescription/prescription/viewnew"><font size="4.5">OPD</a></td>
		...
		<td colspan="2" align="center"><a href="labome"><font size="4.5">LAB</font><font size="4.5" color="red"><strong>('.$sasdas.')</strong></font></a></td>
...
<a href="imset"><font size="4.5">	Make Your Own Medicine & Investigation Set </a>
	...
	<tr><td colspan="5"align="center"><a href="recruit/manpower_requisition"><font size="4.5">Recruitment</a></td></tr>
';}
...
<?php if($c1>0 and $uuid!='' and $fullname!=929 and $c1_inves<=0){
	echo'
