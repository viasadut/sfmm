...
$query5 = mysqli_query($con,"select * from 24urineelectro where pmrn='$pmrn' and sno='$sno'");
...
$rr='Sodium, Urine:'.$chikun1."<br />".'Potassium, Urine:'.$chikun2."<br />".'Chloride, Urine:'.$chikun3;

$rr1='Sodium, Urine :'.$chikun1.' '.'mmol/L'."<br />".'Potassium, Urine :'.$chikun2.' '.'mmol/L'."<br />".'Chloride, Urine :'.$chikun3.' '.'mmol/L';



// $ins_query1="insert into 24urinealbumin (`pname`,`pmrn`,`psex`,`page`,`uv`,`uc`,`cu`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
// ('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$chikun3','$user','$adate','$eid','$iname','$id','$sno')";
// mysqli_query($con,$ins_query1) or die(mysql_error());

    $ins_query1="UPDATE 24urineelectro SET 
        `uv`='$chikun1',
        `uc`='$chikun2',
        `ratio`='$chikun3',
        `uby`='$user',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <label for="age"><strong>Urine Electrolyte Test Report:</strong></label>

            <label for="tibc"><strong>Sodium, Urine </strong></label>
            <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['uv']?>" required>
            <label for="tibc"><strong>Potassium, Urine </strong></label>
            <input name="chikun2" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['uv']?>" required>
            <label for="tibc"><strong>Chloride, Urine </strong></label>
