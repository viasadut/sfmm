...
$q90 = "SELECT * from roaster_2 where mor='$ssid2' and date='$rd1'"; 
$re90 = mysqli_query($con, $q90) or die ( mysqli_error());
$r90 = mysqli_fetch_assoc($re90);
$duty_1=$r90['emor'];

$q91 = "SELECT * from roster_duty_schedule where schedule_name='$duty_1'"; 
$re91 = mysqli_query($con, $q91) or die ( mysqli_error());
$r91 = mysqli_fetch_assoc($re91);

$duty_name1=$r91['start'];
$duty_name2=$r91['end'];

echo $ty2=date('His', strtotime('duty_name1'));
...
<td><input type="text" name="status1[]" id="status1<?php echo $i;?>" value="<?php if($stime3>0 && $mname !='') {echo 'LT';}else if($stime3<=0 && $mname !='') {echo "P"; } else if($r9=mysqli_num_rows($re9)>0){echo "L";} else if($rh=mysqli_num_rows($reh)>0){echo "H";} else {echo 'A';}?>" readonly></td>
