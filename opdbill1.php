<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('bill','mng','doctor','billin')"; 
...
if(isset($_POST['Submit1'])){
	...
	$total_bill=$_REQUEST['total_bill'];
		...
		$due_remarks=$_REQUEST['due_remarks'];
            ...
            $bill_remarks=$_REQUEST['bill_remarks'];
...
$sql = "insert into pms_bill(pmrn,eid,location,amount,date,time,user,remarks,dname,s_no,p_mode,`p_remarks`,`b_remarks`) VALUES
('$pmrn','$eid','OPD Procedure Room','$total_bill','$appdate','$apptime','$user','OPD Procedure Room','OPD_PRO','$mno','$vehicle1','$due_remarks','$bill_remarks')";
...
$date=date('Y-m-d');
  $ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','CR','615100','$date','$total_bill','OPD PROCEDURE')";
		mysqli_query($con,$ins_query) or die(mysql_error());

		
		$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','DR','619210','$date','$total_bill','OPD PROCEDURE')";
...
header("Location:new_bill/new_procedure_payment.php?adate1=$adate1&pmrn=$pmrn&dname=$dname&billno=$last_id&eid=$eid");
...
$dis_amount=$total_bill-$taka;

$sql = "insert into pms_bill(pmrn,eid,location,amount,date,time,user,remarks,dname,s_no,p_mode,p_remarks,dis_amount,`b_remarks`) VALUES
('$pmrn','$eid','OPD Procedure Room','$total_bill','$appdate','$apptime','$user','OPD Procedure Room','OPD_PRO','$mno','$vehicle1','$due_remarks','$taka','$bill_remarks')";
...
$date=date('Y-m-d');
  $ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','CR','615100','$date','$taka','OPD PROCEDURE')";
		mysqli_query($con,$ins_query) or die(mysql_error());

		
		$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','DR','221170','$date','$taka','OPD PROCEDURE')";
		mysqli_query($con,$ins_query2) or die(mysql_error());
...
$conn->close();
  ...
  $dis_amount=$total_bill-$dis_percentage_amount;
$sql = "insert into pms_bill(pmrn,eid,location,amount,date,time,user,remarks,dname,s_no,p_mode,`p_remarks`,`dis_amount`,`b_remarks`) VALUES
('$pmrn','$eid','OPD Procedure Room','$total_bill','$appdate','$apptime','$user','OPD Procedure Room','OPD_PRO','$mno','$vehicle1','$due_remarks','$dis_percentage_amount','$bill_remarks')";
...
$date=date('Y-m-d');
  $ins_query="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','CR','615100','$date','$dis_percentage_amount','OPD PROCEDURE')";
		mysqli_query($con,$ins_query) or die(mysql_error());

		
		$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
		values ('$last_id','DR','221170','$date','$dis_percentage_amount','OPD PROCEDURE')";
		mysqli_query($con,$ins_query2) or die(mysql_error());
...
<tr >
	...
	<td colspan="10"align="right" style="font-weight: bold;font-size:35px;color:red">Remarks</td>
	<td colspan="10"align="right"><textarea name='bill_remarks' style="font-weight: bold;font-size:35px;color:red" value=""></textarea></td>
</tr>
...
<input type="number" name="percentage" id="sdate1" class="style1" placeholder="Discount In Percentage" max="50" hidden style="font-size:20px;color:red;font-weight:bold;">
