<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('lab','cath')"; 
...
$dnam= $row['dname'];
  ...
  $query43 = "SELECT COUNT(pmrn) FROM lab_test where pmrn= '$pmrn' and ron='$inves';"; 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);
$count =$row43['COUNT(pmrn)'];
$count1 = $count+1;

$query43l = "SELECT COUNT(id) FROM lab_test where lid= '$lid';"; 
...
{
$ins_query_format="insert into lab_report_format (`dname`,`dcode`,`inves`,`add_by`,`add_time`,`status`,`type`,`iname`) 
...
$ins_query="insert into lab_test (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`details`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`,`datenew`,`ron`,`lid`,`r_u_by`,`r_u_t`) 
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$cdetails','$count1','$date1','$date2','$stime','Updated','IPD','$date_d','$inves','$lid','$user','$add_time')";
mysqli_query($con,$ins_query);

//$update="update alltest set status='Updated', report='$plaintext' where `id`='$id'";
//mysqli_query($con,$update);

$update="update iinves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$plaintext' where id='$id'";
mysqli_query($con,$update) or die(mysql_error());


$ins_query="insert into lab_test1 (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`details`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`,`datenew`,`ron`,`lid`,`r_u_by`,`r_u_t`) 
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$cdetails','$count1','$date1','$date2','$stime','Updated','IPD','$date_d','$inves','$lid','$user','$add_time')";
mysqli_query($con,$ins_query);

$url = "lab_test_report_view_in?id=$id";
...
$url = "lab_test_report_view?id=$id";
...
<!-- Form Title -->
        ...
        <option value='Dr. Abu Anis Khan'>Dr. Abu Anis Khan</option>
        <option value='Dr. Mst. Maksuda Pervin'>Dr. Mst. Maksuda Pervin</option>
				...
				<tr>
						...
						<tr>
						<td colspan="20" style="font-size:18px;color:green;"><label><strong>Speciemen Informtion:</strong></label></td>
				...
				<tr>
						<td colspan="20" style="font-size:18px;color:green;"><textarea readonly style="font-size:20px;color:red; font-weight:bold"><?php echo $row['ins'];?></textarea></td>
...
<td colspan="20">
	...
	<option value=''>-Select-</option>
            ...
            $query_1 = "select * from lab_report_format where status='Active'";
...
//var variables = "pmrn=str&string=$pd";
				...
				xmlhttp.open("GET", "pro_lab.php?pmrn=" + str + "&porder=<?php echo $pd;?>", true);
