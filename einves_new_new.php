...
echo '<script language="javascript">';
    echo 'alert("Successfully Submitted !!'.$edate1.'"); ';
    echo '</script>';	}
...
<td colspan="7"><input type="date" class="style1" name="sdate" id="sdate" placeholder="Select Date" size="15" min="<?php echo date('Y-01-31');?>" max="<?php echo date('Y-12-31');?>" required></td>
<td colspan="6"><input type="date" class="style1" name="edate" id="edate" placeholder="Select Date" size="15" required min="<?php echo date('Y-01-31');?>" max="<?php echo date('Y-12-31');?>" required hidden>


<input type="date" class="style1" name="edate" id="edate1" placeholder="Select Date" size="15" required hidden></td>
...
<tr><td colspan="20">
  ...
  <select class="js-example-basic-single" name="replacement" required>
				...
				<?php 
			$sql76 = "select * from `staff3` where status='Active' and dept='$idept' and cat in ('Staff','HOD','Incharge') and sid !='$user'";
