...
$query43 = "SELECT COUNT(id) FROM idprocedure where mname= '$infu';"; 
...
if($row43['COUNT(id)']<1)
    ...
    echo 'alert("Procedure Name is Not Matched"); ';
    echo '</script>';
	}
	else {

$ins_query="insert into idprocedure (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`pdate`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated','$pdate')";
...
<tr>
	  ...
	  <td colspan="4" align="center"><strong>Procedure Note</strong></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from idprocedure where pmrn= '$pmrn'and eid='$episode' order by `id` DESC;";
