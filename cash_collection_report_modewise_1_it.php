...
$card=$card_data['SUM(amount)']+$phar_collection_card['SUM(amount_receive)'];
...
$bkash=$bkash_data['SUM(amount)']+$phar_collection_bkash['SUM(receive_amount)'];;
...
$net_collection=$phar_collection['SUM(amount_receive)']+$phar_collection_card['SUM(amount_receive)']+$phar_collection_bkash['SUM(amount_receive)']+$temp_opd_collection_all['SUM(amount)']-$opd_collection_dis['SUM(dis_amount)']-$phar_collection_dis['SUM(dis_amount)']-$opd_collection_refund['SUM(amount)']-$opd_collection_refund_phar_indu['SUM(r_amount)'];
      ?>
