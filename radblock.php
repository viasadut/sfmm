...
$update="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='10:00AM'";
mysqli_query($con,$update) or die(mysql_error());
}

if (!empty ($_POST['select'])&& ($_POST['dname'])=="USG"){
		
$update1="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='10:20AM'";
mysqli_query($con,$update1) or die(mysql_error());
}
if (!empty ($_POST['select'])&& ($_POST['dname'])=="USG"){
		
$update2="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='10:40AM'";
mysqli_query($con,$update2) or die(mysql_error());
}
if (!empty ($_POST['select2'])&& ($_POST['dname'])=="USG"){
		
$update3="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='11:00AM'";
mysqli_query($con,$update3) or die(mysql_error());
}
if (!empty ($_POST['select2'])&& ($_POST['dname'])=="USG"){
		
$update4="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='11:20AM'";
mysqli_query($con,$update4) or die(mysql_error());
}

if (!empty ($_POST['select2'])&& ($_POST['dname'])=="USG"){
		
$update5="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='11:40AM'";
mysqli_query($con,$update5) or die(mysql_error());
}
if (!empty ($_POST['select3'])&& ($_POST['dname'])=="USG"){
		
$update6="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='12:00PM'";
mysqli_query($con,$update6) or die(mysql_error());
}

if (!empty ($_POST['select3'])&& ($_POST['dname'])=="USG"){
		
$update7="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='12:20PM'";
mysqli_query($con,$update7) or die(mysql_error());
}
if (!empty ($_POST['select3'])&& ($_POST['dname'])=="USG"){
		
$update8="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='12:40PM'";
mysqli_query($con,$update8) or die(mysql_error());
}
if (!empty ($_POST['select4'])&& ($_POST['dname'])=="USG"){
		
$update9="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='02:00PM'";
mysqli_query($con,$update9) or die(mysql_error());
}
if (!empty ($_POST['select4'])&& ($_POST['dname'])=="USG"){
		
$update10="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='02:20PM'";
mysqli_query($con,$update10) or die(mysql_error());
}
if (!empty ($_POST['select4'])&& ($_POST['dname'])=="USG"){
		
$update11="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='02:40PM'";
mysqli_query($con,$update11) or die(mysql_error());
}

if (!empty ($_POST['select5'])&& ($_POST['dname'])=="USG"){
		
$update12="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='03:00PM'";
mysqli_query($con,$update12) or die(mysql_error());
}
if (!empty ($_POST['select5'])&& ($_POST['dname'])=="USG"){
		
$update13="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='03:20PM'";
mysqli_query($con,$update13) or die(mysql_error());
}
if (!empty ($_POST['select5'])&& ($_POST['dname'])=="USG"){
		
$update14="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='03:40PM'";
mysqli_query($con,$update14) or die(mysql_error());
}

if (!empty ($_POST['select6'])&& ($_POST['dname'])=="USG"){
		
$update15="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='04:00PM'";
mysqli_query($con,$update15) or die(mysql_error());
}
if (!empty ($_POST['select6'])&& ($_POST['dname'])=="USG"){
		
$update16="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='04:20PM'";
mysqli_query($con,$update16) or die(mysql_error());
}
if (!empty ($_POST['select6'])&& ($_POST['dname'])=="USG"){
		
$update17="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='04:40PM'";
mysqli_query($con,$update17) or die(mysql_error());
}
if (!empty ($_POST['select7'])&& ($_POST['dname'])=="USG"){
		
$update18="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='05:00PM'";
mysqli_query($con,$update18) or die(mysql_error());
}
if (!empty ($_POST['select7'])&& ($_POST['dname'])=="USG"){
		
$update19="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='05:20PM'";
mysqli_query($con,$update19) or die(mysql_error());
}

if (!empty ($_POST['select7'])&& ($_POST['dname'])=="USG"){
		
$update20="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='05:40PM'";
mysqli_query($con,$update20) or die(mysql_error());
}
if (!empty ($_POST['select8'])&& ($_POST['dname'])=="USG"){
		
$update21="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='06:00PM'";
mysqli_query($con,$update21) or die(mysql_error());
}
if (!empty ($_POST['select8'])&& ($_POST['dname'])=="USG"){
		
$update22="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='06:20PM'";
mysqli_query($con,$update22) or die(mysql_error());
}
if (!empty ($_POST['select8'])&& ($_POST['dname'])=="USG"){
		
$update23="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='06:40PM'";
mysqli_query($con,$update23) or die(mysql_error());
}
if (!empty ($_POST['select9'])&& ($_POST['dname'])=="USG"){
		
$update24="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='07:00PM'";
mysqli_query($con,$update24) or die(mysql_error());
}
if (!empty ($_POST['select9'])&& ($_POST['dname'])=="USG"){
		
$update25="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='07:20PM'";
mysqli_query($con,$update25) or die(mysql_error());
}
if (!empty ($_POST['select9'])&& ($_POST['dname'])=="USG"){
		
$update26="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='07:40PM'";
mysqli_query($con,$update26) or die(mysql_error());
}
if (!empty ($_POST['select10'])&& ($_POST['dname'])=="USG"){
		
$update27="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='08:00PM'";
mysqli_query($con,$update27) or die(mysql_error());
}
if (!empty ($_POST['select10'])&& ($_POST['dname'])=="USG"){
		
$update28="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='08:20PM'";
mysqli_query($con,$update28) or die(mysql_error());
}
if (!empty ($_POST['select10'])&& ($_POST['dname'])=="USG"){
		
$update29="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='08:40PM'";
mysqli_query($con,$update29) or die(mysql_error());
}
if (!empty ($_POST['select11'])&& ($_POST['dname'])=="USG"){
		
$update30="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='09:00PM'";
mysqli_query($con,$update30) or die(mysql_error());
}
if (!empty ($_POST['select11'])&& ($_POST['dname'])=="USG"){
		
$update31="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='09:20PM'";
mysqli_query($con,$update31) or die(mysql_error());
}
if (!empty ($_POST['select11'])&& ($_POST['dname'])=="USG"){
		
$update32="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='09:40PM'";
mysqli_query($con,$update32) or die(mysql_error());
}
if (!empty ($_POST['select12'])&& ($_POST['dname'])=="USG"){
		
$update33="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='10:00PM'";
mysqli_query($con,$update33) or die(mysql_error());
}

if (!empty ($_POST['select12'])&& ($_POST['dname'])=="USG"){
		
$update34="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='10:20PM'";
mysqli_query($con,$update34) or die(mysql_error());
}
if (!empty ($_POST['select12'])&& ($_POST['dname'])=="USG"){
		
$update35="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='10:40PM'";
mysqli_query($con,$update35) or die(mysql_error());
}
if (!empty ($_POST['select13'])&& ($_POST['dname'])=="USG"){
		
$update36="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='11:00PM'";
mysqli_query($con,$update36) or die(mysql_error());
}
if (!empty ($_POST['select13'])&& ($_POST['dname'])=="USG"){
		
$update37="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='11:20PM'";
mysqli_query($con,$update37) or die(mysql_error());
}
if (!empty ($_POST['select13'])&& ($_POST['dname'])=="USG"){
		
$update38="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='11:40PM'";
mysqli_query($con,$update38) or die(mysql_error());
}
if (!empty ($_POST['select14'])&& ($_POST['dname'])=="USG"){
		
$update39="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='09:00AM'";
mysqli_query($con,$update39) or die(mysql_error());
}
if (!empty ($_POST['select14'])&& ($_POST['dname'])=="USG"){
		
$update40="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='09:20AM'";
mysqli_query($con,$update40) or die(mysql_error());
}
if (!empty ($_POST['select14'])&& ($_POST['dname'])=="USG"){
		
$update41="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='09:40AM'";
mysqli_query($con,$update41) or die(mysql_error());
}

if (!empty ($_POST['select15'])&& ($_POST['dname'])=="USG"){
		
$update42="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='08:00AM'";
mysqli_query($con,$update42) or die(mysql_error());
}
if (!empty ($_POST['select15'])&& ($_POST['dname'])=="USG"){
		
$update43="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='08:20AM'";
mysqli_query($con,$update43) or die(mysql_error());
}
if (!empty ($_POST['select15'])&& ($_POST['dname'])=="USG"){
		
$update44="update rapp set status='NOT AVAILABLE' where dname='$name' and  ddate='$date' and dslot='08:40AM'";
mysqli_query($con,$update44) or die(mysql_error());
}


echo '<script language="javascript">';
    echo 'alert("Appointment Slot Blocked Successfully !!"); ';
    echo '</script>';}
?>
...
<!-- Form Title -->
		<h1>BLOCK RADIOLOGY DATE &amp; TIME </h1>
        <fieldset>
...
<!-- Password Input --><!-- Age Dropdown -->
	  ...
	  <br>
		...
		<button type="submit" name="submit">Block Confirm</button>
