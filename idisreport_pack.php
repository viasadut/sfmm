...
$query = mysqli_query($db,"select * from idischarge1_pack where pmrn='$pmrn' and eid='$eid'");
$data = mysqli_fetch_array($query);

$query2 = mysqli_query($db,"select * from package_screening where pmrn='$pmrn' and eid='$eid'");
	...
	{$output .='
		...
		';
				...
				$output .='<table>
                            ...
                            <table>';
                $query1a = mysqli_query($con,"Select * from allergy where pmrn= '$pmrn' and status!='Cancel'");
                $count=1;
                while ($data1a = mysqli_fetch_array($query1a)) {
                    ...
                    $output .='
                            <tr>
                                ...
                                <td style="font-family: freesans; font-size: 14px;"> '.$data1a['medi'].'</td>
                            </tr>
           ...
           /* $mpdf->SetWatermarkImage(
			...
			MRN-'.$data['pmrn'].'
                ...
                <table style="border: 1px solid black" width="100%" >
                    <tr>
                        <td style="font-family: freesans; text-align:left"> <b>Patient Name : '.$data['pname'].'</b></td>
                    ...
                    <tr>
                        <td style="font-family: freesans; text-align:left"><b>Admission Date :</b> '.date('d/m/Y', strtotime($data2['sdate'])).'</td>
