...
$query45 = mysqli_query($db,"select * from emedi2 where pmrn='$pmrn' and id='$id'");
...
$update="update emedi2 set donet='$ddate',status='Rupdated', udone='$user',status1='implemented' where `id`='$id'";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>High Alert Medication Form</strong></label></td> </tr>
<tr><td colspan="4" align="center"><label><strong>Order By</strong></label></td> 
<td colspan="2" align="center"><label><strong>Order Date</strong></label></td> 
<td colspan="8" align="center"><label><strong>High Alert Medication</strong></label></td> 
<td colspan="4" align="center"><label><strong>Instruction</strong></label></td> 
<td colspan="2" align="center"><label><strong>Status</strong></label></td></tr>
<tr><td colspan="4" align="center"><input type="text"  name="odate" required value="<?php echo $data45["orderby"]; ?>" readonly/></td>
<td colspan="2" align="center"><input type="text" name="otime" required value="<?php echo $data45["odate"]; ?>" readonly/></td>
<td colspan="8" align="center"><input type="text" name="infu" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
<td colspan="4" align="center"><input type="text" name="infu" required value="<?php echo $data45["instruc"]; ?>" readonly/></td>
<td colspan="2" align="center"><select name="dtime" value="" size="1"height="2">
			        <option value='Given'>Given</option>
					<option value='Checked'>Checked</option></td></tr> 
...
<tr>
	  ...
	  <td colspan="3" align="center"><strong>Coution</strong></td>
...
$count=1;
$sel_query="Select * from emedi2 where pmrn= '$pmrn' and eid='$eid'and status ='rupdated'order by `id` DESC;";
