...
{
return confirm("Are you Sure to Send the SMS ?");
}
...
echo "   OPD-  ";	 
echo $row43['COUNT(diagnosis)'];

echo " ,  IPD-  ";	 
echo $row44['COUNT(ddia)'];

echo " ,  A&E-  ";	 
echo $row45['COUNT(ddia)'];
echo " ,  ";

echo "<font color=red font size=6> TOTAL  -  ";	 
echo $row43['COUNT(diagnosis)'] + $row44['COUNT(ddia)']+ $row45['COUNT(ddia)'];
...
$sel_query1="Select distinct(pmrn),pname,diagnosis,dname,psex,page,pphone from presnew where diagnosis LIKE '%$bt%'  order by id";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row1["diagnosis"]; ?>
	  <td align="center"><?php echo $row1["pphone"]; ?>
         <td align="center"><a onclick="return confirm_click();" href="sms_rela?phone=<?php echo $row2["pphone"]; ?>&pname=<?php echo $row2["pname"]; ?>&psex=<?php echo $row2["psex"]; ?>"><strong></strong></a></td>
	...
	$sel_query2="Select DISTINCT(pmrn),pname,dname,ddia,psex,page,pphone from idischarge1 where ddia LIKE '%$bt%' order by id";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row2["ddia"]; ?>
	  <td align="center"><?php echo $row2["pphone"]; ?>
	   <td align="center"><a onclick="return confirm_click();" href="sms_rela?phone=<?php echo $row2["pphone"]; ?>&pname=<?php echo $row2["pname"]; ?>&psex=<?php echo $row2["psex"]; ?>"><strong></strong></a></td>
	...
	<?php
	$sel_query3="Select DISTINCT(pmrn),pname,dname,ddia,pphone from discharge1 where ddia LIKE '%$bt%' order by id";
...
<td align="center"><a  target='_blank' href="deathstatdetailsmng?pmrn=<?php echo $row3["pmrn"]; ?>"><?php echo $row3["pmrn"]; ?>
	  ...
	  <td align="center"><?php echo $row3["psex"]; ?>
	  <td align="center"><?php echo $row3["page"]; ?>
	  <td align="center"><?php echo $row3["dname"]; ?>
      <td align="center"><?php echo $row3["ddia"]; ?>
	  <td align="center"><?php echo $row3["pphone"]; ?>
	  <td align="center"><a onclick="return confirm_click();" href="sms_rela?phone=<?php echo $row3["pphone"]; ?>&pname=<?php echo $row3["pname"]; ?>&psex=<?php echo $row3["psex"]; ?>"><strong></strong></a></td>
