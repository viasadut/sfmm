...
$query1="update medi_stock set `add_qty`='$m_qty1' where `sno`='$dilu' and location in ('ICU','CCU','NICU','HMD','5AB Medicine stock','5CD Medicine stock','6AB Medicine stock','6CD Medicine stock','5AB emergency trolley','5CD emergency trolley','6CD emergency trolley','6th Fl emergency trolley','6th Fl C Block', '6th Fl D Block') and code='51840290'";
...
$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`brand`,`rfid`,`status`,`location`,`code`) values
			('$g_name','1','$u_price','$u_price','$user','$adate','$bb_name','$dilu','Finished','Nursing Block','$code')";
...
<!-- Form Title -->
  ...
  <datalist id="stock">
				...
				<?php 
			$sql76 = "select * from `medi_stock` where add_qty>0 and location in ('ICU','CCU','NICU','HMD','5AB Medicine stock','5CD Medicine stock','6AB Medicine stock','6CD Medicine stock','5AB emergency trolley','5CD emergency trolley','6CD emergency trolley','6th Fl emergency trolley') and code='51840290'";
