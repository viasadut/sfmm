...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and rstatus!='REVEIVED' and type='lab' order by `id` DESC;";
...
<td colspan="2" align="center"><select name="rcomments" value="" class="style1" required>
...
<td colspan="2" align="center"><a onclick="return confirm_click2();" href="labresult2?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&user=<?php echo "$user"; ?>&user=<?php echo "$rcomments"; ?>"><strong>REJECT</strong></a></td>
