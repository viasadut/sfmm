...
$ins_query33="select COUNT(id) from opd_appoint1 where `dname`='$name',`dslot`='$select',`date1`='$dd'";
...
<!-- E-mail Input -->
			<label for="mail"><strong>Appointment Date :</strong></label>
									<input type="text" name="date" id="datepicker" placeholder="Select Date" value="<?php echo date('m/d/Y', strtotime($date2));?>" required/>
