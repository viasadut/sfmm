...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos','$eid','$date1')";
...
$objDB1 = mysql_select_db("sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
			...
			
		{
			...
			$strSQL = "insert into pmedi (`dname`,`pmrn`,`medi`,`brand`,`pdos`,`eid`,`date`) values ('$dname','$pmrn','$medi','$brand','$pdos','$eid','$date1')";
  ...
  <datalist id="browsers111">
			...
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->mname."'>".$row->brand1."</option>";
				}
			}
			?>  </datalist></td>
...
<tr>
	  ...
	  <td align="center"colspan="8"><input type="text" name="test2" id="test2" value="<?php echo $row["medi"].' ('.$row["brand"].')'; ?>" readonly></td>
	  <td align="center"colspan="5"><input type="text" name="test3" id="test3" value="<?php echo $row["pdos"]; ?>";readonly></td>
				  
				  
<td align="center" colspan="2"><a href="delete1test?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&brand=<?php echo $row["brand"]; ?>&eid1=<?php echo "$eid1"; ?>&eid=<?php echo "$eid"; ?>&pname=<?php echo $row["pname"]; ?>&medi=<?php echo $row["medi"]; ?>&test=<?php echo $row["pdos"]; ?>">ADD</a></td>
