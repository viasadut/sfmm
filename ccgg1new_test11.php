    ...
    $("#date4").val(ret1);
			...
			<?php
				...
				$slot1=$_REQUEST['slot'];
					...
					echo "<option value='".$slot1."'>".$slot1."</option>";
	 ...
	 <input name="cr" type="text" id="cr"size="85" placeholder="Covid Result"value="<?php
				if(isset($_POST['load'])==1){
				$cr1=$_REQUEST['cr'];
			echo "$cr1";}?>" readonly>	  
			
	<label for="age"><strong>Patient's MRN :</strong></label>
<input name="pmrn" id="pmrn"onkeyup="GetDetail(this.value)" type="text" size="85" placeholder="MRN" value="<?php
				if(isset($_POST['load'])==1){
				$pmrn1=$_REQUEST['pmrn'];
			echo "$pmrn1";}?>" required>
	...
	<label for="age"><strong>Patient's Name :</strong></label>
      <input name="name" id="pname" type="text" size="85" value="<?php
				if(isset($_POST['load'])==1){
				$pname1=$_REQUEST['name'];
			echo "$pname1";}?>" required readonly>
 	  
	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" id="padd" type="text" size="85" value="<?php
				if(isset($_POST['load'])==1){
				$padd1=$_REQUEST['padd'];
			echo "$padd1";}?>" required readonly>
...
<option value='Sylhet'>Sylhet</option> 
	  ...
	  <label for="age"><strong>Patient's Gender :</strong></label>
		...
		<?php
				if(isset($_POST['load'])==1){
				$psex1=$_REQUEST['psex'];
			echo "<option value='".$psex1."'>".$psex1."</option>";}?>		
		<option value=""></option>
	 ...
	 <input name="pphone" type="text" id="pphone"size="85" placeholder="Phone No"value="<?php
				if(isset($_POST['load'])==1){
				$pphone1=$_REQUEST['pphone'];
			echo "$pphone1";}?>" required readonly>	  
...
<input name="dd" id="dd" type="text" maxlength="2" size="1" value="<?php
				if(isset($_POST['load'])==1){
				$dd1=$_REQUEST['dd'];
			echo "$dd1";}?>"readonly required placeholder="DD">	/

<input name="mm" id="mm" type="text" maxlength="2" size="1" value="<?php
				if(isset($_POST['load'])==1){
				$mm1=$_REQUEST['mm'];
			echo "$mm1";}?>"readonly required placeholder="MM"> /	

<input name="yy" id="yy" type="text" maxlength="4" size="1" value="<?php
				if(isset($_POST['load'])==1){
				$yy1=$_REQUEST['yy'];
				echo "$yy1";}?>"readonly required placeholder="YYYY">		  
...
<label for="age"><strong>Patient's Type :</strong></label>
	  ...
	  <br><br>  
	    	...
	    	<input name="load" type="submit" id="load" value="Check Payable Amount">		  
...
$query_a = "SELECT * FROM doctor where dname= '$dd5'"; 
...
$query_b = "SELECT * FROM pappnew where dname= '$dd5' and pmrn='$pp' and status='SEEN' order by ID DESC limit 1"; 
...
if($diff1_b<=3 and $pp!=0)
{echo "<span style='color:red;text-align:center;font-size:22px;'>0 Taka";} 

else if($diff1_b>3 and $diff1_b<=10 and $pp!=0)
{echo"<span style='color:red;text-align:center;font-size:22px;'> ".$v2." Taka";}

else if($diff1_b>10 and $pp!=0)
{echo"<span style='color:red;text-align:center;font-size:22px;'> ".$v1." Taka";}



else if($pp==0)
{echo"<span style='color:red;text-align:center;font-size:22px;'>'600 Taka";}
