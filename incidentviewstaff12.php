...
while($rowz = mysqli_fetch_assoc($row1z)) { ?>
	  ...
	  <td align="center"align="right"><a href="incident_print?id=<?php echo $rowz['id']; ?>">Complete Report</a>
	  
	  <a target='_blank'  class="thumbnail fancybox" rel="ligthbox" href="incidentpic/<?php echo $rowz['image'] ?>">
                        <img class="img-responsive" alt="" src="incidentpic/<?php echo $rowz['image'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><b>View Uploaded Report</b></small>
                        </div> <!-- text-center / end -->
                    </a>
