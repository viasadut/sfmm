...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from inpatient where discharge= '' and api_status in ('0','2','1') and OUT_ADMISSION_NO_PK='0' order by id desc";
...
echo $diff->format("%R%a days");?>  </td>
	  <td align="center"><a href="api_admission_manual1_jdjs?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission Without MRN(IPD)</a></td>
     <td align="center"><a href="api_admission_manual1_1"L?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission With MRN(IPD)</a></td>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from emergency where discharge= '' and api_status in ('0','1') and OUT_ADMISSION_NO_PK='0' order by id desc";
...
?>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo "EMERGECY DEPT";?>  
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo "A&E";?>  
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["pphone"];?>  
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php $start=$row["aadate"];$date1=date_create("$start");
$date2=date_create("$date");
$diff=date_diff($date1,$date2);
echo $diff->format("%R%a days");?>  </td>
	  <td align="center"><a href="api_admission_manual1_ae>jk?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission Without MRN(A&E)</a></td>
     <td align="center"><a href="api_admission_manual1_ae1__((?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Manual Admission With MRN (A&E)</a></td>
