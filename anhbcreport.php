...
$query = mysqli_query($db,"select * from antihbc where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
$pdf->Cell('80',5,'Parameters',1,1,'C');
$pdf->Cell('160',5,'Result(Index Value):'.$data['result'],1,1,'C');
$pdf->MultiCell('160',5,'Reference(Index Value):'.$remarks,1,1);
$pdf->MultiCell('160',5,'Opinion:'.$data['opinion'],1,1);
