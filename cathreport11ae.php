...
$query90 = "UPDATE iinves set rby='$user',rtime='$dtime',rstatus='RECEIVED' where id='$id'"; 
...
<!-- Form Title -->
		...
		<label for="age"><strong>Referral Doctor's Name :</strong></label>
				...
				<input type="text" size="70"name="rname"  required value="A&E" readonly/>
	  
	  <label for="age"><strong>Patient's Name :</strong></label>
      <input name="pname" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row2['pname'];?>"required/>
 	  

	  <label for="age"><strong>Patient's Details :</strong></label>
	  	
      <input name="psex" type="text" size="5"value="<?php echo $row2['gender'];?>" required/>
														
						
            <input name="pmrn" type="text" size="15" value="<?php echo $row2['pmrn'];?>" required/>
      <input name="pphone" type="text" size="13" value="<?php echo $row2['pphone'];?>"  required/>	  
	  <input name="page" type="text" size="2"value="<?php echo $row2['age'];?>" required/>
