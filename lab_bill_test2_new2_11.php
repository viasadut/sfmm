...
$query44 = mysqli_query($db,"select * from presnew where id='$id'");
...
$ncharge = $_POST['ncharge'];
			...
			if($eqty2 >0 and $ncharge=='')
	{
			
			
						$strSQL1 = "update alltest set billstatus='Billed', billby='$user', billdate='$pdate',barcode1='$bar',barcode='$bar',billtime='$pdate1' where id='".$updateid."'";
			...
			else if($eqty2 >0 and $ncharge!='')
	{
			
			
						$strSQL1 = "update alltest set billstatus='Billed', billby='$user', billdate='$pdate',barcode1='$bar',barcode='$bar',billtime='$pdate1',discount='$ncharge' where id='".$updateid."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
<h1 align="left"style="background-color:lightgreen;">Patient Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data4['pname'];?>
<br>MRN:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data4['pmrn'];?>
<br>Consultant Name:&nbsp;&nbsp;<?php echo $data4['dname'];?>
<br>Episode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data4['eid'];?>
<br>Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data4['date'];?>
...
<tr>
	...
	<td colspan="5"align="right"><input type="number"name="ncharge" id='hh1' min="0" max="20" size="70"  style="font-size:35px; color:red;font-weight:bold;" onchange="subTotal1()"></td>
...
//itotal[i].innerText=(iprice[i].value)*10/100*(iquantity[i].value);
//gt1=gt1+(iprice[i].value)*(iquantity[i].value)/100*(iquantity[i].value);


}
//var hh1=document.getElementById('hh1');
gtotal.innerText=gt;
//hh.innerText=gt-gt*hh1/100;
}
subTotal();
...
//var hh1=document.getElementById('hh1');
 ...
 gtotal.innerText=gt;
var aa=gt-gt*hh1/100;
  document.getElementById("hh").innerHTML = Math.round(aa);
}
