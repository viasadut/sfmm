...
$query43 = "SELECT COUNT(barcode) FROM iinves where ndate BETWEEN '$start' and '$end' and barcode !='' and status IN ('RECEIVED','DONE') ;"; 
...
<h1 align="center">DATEWISE LAB RECEIVED & RESULT REPORT</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="17%"><strong>Barcode No</strong></th>
	  <th width="14%"><strong>Patient Name</strong>
...
$count=1;
$sel_query="Select * from iinves where ndate BETWEEN '$start' and '$end' and status IN ('RECEIVED','DONE') and barcode !='';";
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["ndate"]; ?>
...
<td colspan="10" align="right"><a target='_blank' href="barcodeprint?start=<?php echo "$start"; ?>&end=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
