...
{
$update="update inpatient set medi_legal='1' where `pmrn`='$pmrn' and `eid`='$eid'";
mysqli_query($con,$update) or die(mysql_error());
$url = "imoidetails?pmrn=$pmrn&eid=$eid";
header("Location: $url");
}
...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and type in('LAB','Lab','lab') and rstatus!='Cancelled' order by `id` DESC limit 8;";
...
<tr>
		...
		<td colspan="3" align="center"><button type="submit" name="Submit12">Doctor's Note</button></td>
...
<tr>
	<td colspan="5" align="center"><button type="submit" name="Submit1mmmm">Infusion</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row14['COUNT(pmrn)']; ?>)<b></td>
	
	<td colspan="5" align="center"><button type="submit" name="Submit6">MO Order</button><font size="4.5" color="#FF0000"><b>(<?php echo  $row19['COUNT(pmrn)']; ?>)<b></td>
...
<?php if($f1r>0)
{
	...
	if($diff1>7){echo'<button type="submit" name="pac_req"><font size="4.5" color="green"><b>Send PAC Request</button>';}

else if($f1r and $diff1<=7){echo'<button type="submit" name="pac_req" disabled><font size="4.5" color="#FF000"><b>Already One PAC Request Sent</button>';}
	...
	else {echo'<button type="submit" name="pac_req"><font size="4.5" color="green"><b>Send PAC Request</button>';}
...
<td colspan="5" align="center"><button type="submit" name="adverse">Report Adverse Reaction</button></td>
<td colspan="3" align="center"><button type="submit" name="up_pic">Upload Image</button></td>

<td colspan="3" align="center" style="color:red;font-size:20px;font-weight:bold;"><button type="submit" name="ot_book">OT Booking</button></td>

<td colspan="2" align="center">
		
		<?php if($data['medi_legal']==0){echo'
		<button onclick="return confirm_click4();" type="submit" name="Submit_medi" style="color:green;font-size:12px;font-weight:bold;">Set As Medico Legal Case</button>';}
		
		else if($data['medi_legal']==1){echo'
		<button type="submit" name="Submit_medi" disabled style="color:green;font-size:12px;font-weight:bold;">Already Set As Medico Legal Case</button>';}
		
		?>
		
		
		</td>
		<td colspan="3" align="center" style="color:red;font-size:15px;font-weight:bold;"><button type="submit" name="all_consent_form">All Consent Form</button></td>
    
</tr>
<tr>

<td colspan="5" align="center"><button type="submit" name="dsummary"><font size="4.5" color="#FF000"><b>Death Summary</b></button></td>
<td colspan="5" align="center"><button type="submit" name="cath_pro"><font size="4.5" color="green"><b>Cathlab</b></button></td>
<td colspan="2" align="center">
		
		<?php 
    if($user=='1839' || $user=='1840' || $user=='1841' || $user=='1864')
    {echo'
		<button onclick="return confirm_click4();" type="submit" name="Submit_pac" style="color:green;font-size:22px;font-weight:bold;">PAC</button>
    ';}
