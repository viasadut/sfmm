...
$query43 = "SELECT COUNT(type) FROM alltest where status='' and type='rad' ;"; 
...
<form action="allpen" method="POST">
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Referral Doctor</strong>   
...
$count=1;
$sel_query="Select * from alltest where type='rad' and status='' order by date desc;";
