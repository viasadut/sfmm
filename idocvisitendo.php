...
$sql = "insert into ivisitendo (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`vtype`,`cdate`,`ieid`,`dcode`,`ccode`,`app_con`,`ip`,`op`,`ccentre`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$full','$user','$remarks','$infu','$date','$ieid','$doc_code','$code','$app_con','$ip','$op','$ccentre')";
...
$date=date('Y-m-d');
		...
		values ('$last_id','CR','$tb_data','$date','$remarks','ENDOSCOPY')";
		...
		values ('$last_id','DR','615100','$date','$remarks','ENDOSCOPY')";
