...
//$conn->query($sql1);
header("Location: phar_update_new1_dis_test.php?pmrn=$pmrn&dname=$dname&eid=$eid&sno=$sno");
...
<tr>
	  ...
	  <td colspan="5" align="center"><strong>Instruction</strong></td>
	    ...
	    <?php 
                    //$query = "select * from idismedi where pmrn='$pmrn' and dname='$dname' and eid='$eid' order by page_order asc";
...
<input type="radio" id="vehicle1" name="vehicle1" value="Card"id="chkPassport2" onclick="EnableDisableTextBox2(this)" style="height:20px; width:20px; color:red;"><span style="font-size:20px;color:red;font-weight:bold;">Card</span>				 
	...
	<td colspan="10"align="right"><a target="_blank" href="opd_bill_pdf22_new_medi_dis_pos.php?pmrn='.$pmrn.'&dname='.$dname.'&billno='.$row39['billno'].'&eid='.$eid.'"><img src="phar_pic/print.png" title="Print Receipt" width="100" height="80" /></a>
