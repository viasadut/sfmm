...
values ('$select', '$pmrn','$pname','$page','$psex','$pphone','$dname','$cdetails','$ptemp','$count1','SEEN','$date','$date1','$find','$user','$date2','$dname1','$stime','$ano','Updated By Technologist','$ineid','$emerid')";
...
Lumbar lordotic curvature is maintained.
