...
$ins_query="insert into chemodnote (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`pnote`,`user`,`status`) values ( '$pmrn','$eid','$pname','$page','$adm','$psex','$pphone','$adate1','$inves','$pnote','$user','Data Updated')";
...
$count=1;
$sel_query="Select * from chemodnote where pmrn= '$pmrn' and eid='$episode'order by `id` DESC;";
