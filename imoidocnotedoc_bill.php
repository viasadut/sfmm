<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('billin','bill','mng','imo','nurse')"; 
...
$ins_query="insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$inves','$infu','$pnote','$full','Data Updated')";
...
<tr>
	  ...
	  <td colspan="8" align="center"><strong>Charge</strong></td>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="4"style='font-weight:bold;color:red;font-size:12px;'><?php echo $row["user"]; ?></td>
	  ...
	  <td align="center"colspan="3"style='font-weight:bold;color:red;font-size:12px;'><?php echo $row["pnote"]; ?></td>
      <td align="center"colspan="8"style='font-weight:bold;color:red;font-size:12px;'><?php echo $row["inves"]; ?></td>  
	  <?php 
	  $id=$row["id"];
	  $user7=$row["user"];
...
{ ?>    <tr>
      ...
      <td align="center"colspan="8"><?php echo $row["charge"]; ?></td>  
	  
  	  <td><a href="doc_visit_delete_bill?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&invoice_no=<?php echo $row['invoice_no']; ?>&admission_no=<?php echo $api_adminssion_no; ?>&code=<?php echo $rrt; ?>&pdos=<?php echo $row['pdos']; ?>&price=<?php echo $row['price']; ?>">DELETE</a></td>
