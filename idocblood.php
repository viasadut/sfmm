...
$ins_query="insert into iblood (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`bed`,`status`,`bbstatus`) values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','$infu1','Data Updated','Request')";
...
<tr>
						...
						<td colspan="2"><label><strong>Unit (/Bag):</strong></label></td>
...
<td colspan="5" align="center"><input list="browsers1" name="infu" size=60% class="form-control">
  ...
  <datalist id="browsers3">
						...
						<option value='GYOPRECIPITATE'>GYOPRECIPITATE</option>
  			...
  			<td colspan="2" align="center"><input list="browsers2" name="infu1" size=60% class="form-control">
  <datalist id="browsers2">

						<option value=''>-Select No Of Unit</option>
