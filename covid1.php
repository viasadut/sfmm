...
$ins_query1="insert into covid (`cp`,`name`,`depart`,`ssent`,`tresult`,`cduration`,`distance`,`quntil`,`retest`,`adate`,`user`,`ldate`,`ldate1`,`ssent1`,`retest1`,`desig`,`remarks`,`quntil1`,`pcase`,`sentto`,`padd`,`phone`,`advice`,`page`,`psex`,`district`,`specimen`,`rdate`,`rdate1`,`type`,`sid`,`fresult`) values
 ('$cp','$name','$depart','$ssent','$tresult','$cduration','$distance','$quntil','$retest','$adate','$user','$ldate','$ldate1','$ssent1','$retest1','$desig','$remarks','$quntil1','$pcase','$sentto','$padd','$phone','$advice','$page','$psex','$district','$specimen','$rdate','$rdate1','Consultant','$sid','$fresult')";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query2="update staff1 set tt='done' where id='$id'";
...
header("Location:$url");
	...
	$ins_query1="insert into covid (`cp`,`name`,`depart`,`ssent`,`tresult`,`cduration`,`distance`,`quntil`,`retest`,`adate`,`user`,`ldate`,`ldate1`,`ssent1`,`retest1`,`desig`,`remarks`,`quntil1`,`pcase`,`sentto`,`padd`,`phone`,`advice`,`page`,`psex`,`district`,`specimen`,`rdate`,`rdate1`,`type`,`sid`,`fresult`) values
 ('$cp','$name','$depart','$ssent','$tresult','$cduration','$distance','$quntil','$retest','$adate','$user','$ldate','$ldate1','$ssent1','$retest1','$desig','$remarks','$quntil1','$pcase','$sentto','$padd','$phone','$advice','$page','$psex','$district','$specimen','$rdate','$rdate1','Medical Officer','$sid','$fresult')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<input type="text" name="depart" id="email" class="input-text" placeholder="Department" size="70"value="<?php echo $row39['category'];?>"readonly>     
<label for="age"><strong>Designation:</strong></label>
<input type="text" name="desig" id="email" class="input-text" placeholder="Designation" size="70"value="<?php echo $row39['designation'];?>"readonly>     

<label for="age"><strong>Phone:</strong></label>
<input type="text" name="phone" id="email" class="input-text" placeholder="Designation" size="70"value="<?php echo $row39['phone'];?>"readonly>     

<label for="age"><strong>Address:</strong></label>
<input type="text" name="padd" id="email" class="input-text" placeholder="padd" size="70"value="<?php echo $row39['preadd'];?>"readonly>     
...
<input type="text" name="ssent" id="datepicker" placeholder="Select Date" size="15" >
