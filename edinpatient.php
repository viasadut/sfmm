...
$ins_query="insert into einfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`status`,`alert`,`odate1`,`pstatus`,`code`) values 
( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$adate1','$infu','$user','$infu1','Data Updated','$alert','$odate1','ordered','$cc')";
...
<td colspan="4" align="center"><label><strong>Coution</strong></label></td> 
</tr>
<tr>
...
<input list="in" name="infu" class="form-control">
  <datalist id="in">
...
<td colspan="4" align="left"><input type="radio" name="alert" value="" checked="checked"> Regular <br> <input type="radio" name="alert" value="H. Alert"> <b>High Alert Medication<b></td>
</tr> 
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="2"><a href="edinpatientdelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td> 
      </tr>
    <?php $count++; } ?>
<tr><td colspan="10"><a target='_blank' href="testpdf1111.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	</tr>
</table>
</form>
</body>
