...
$pname=$data1["pname"];
$date1 = date('d/m/Y');
$ins_query1="insert into dismedi (`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`,`duration`,`ins`) values ('$pmrn','$pname','$medi1','$pdos','$eid','$date1','$duration','$ins')";
...
<tr><td colspan="5" align="center"><label><strong>Medicine</strong></label></td> 

<td colspan="5" align="center"><label><strong>Dosage</strong></label></td> 
<td colspan="5" align="center"><label><strong>Duration</strong></label></td> 
<td colspan="5" align="center"><label><strong>Food Relation</strong></label></td> 

</tr>
<tr>
<td colspan="5" align="center"><input list="browsers111" name="medi1" size=60% class="form-control" required/>
...
<td  colspan="5"align="center"><input list="browsers12" name="duration" class="form-control">
...
<td  colspan="5"align="center"><input list="browsers13" name="ins" class="form-control">
...
$count=1;
$sel_query="Select * from dismedi where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
			      <td align="center"colspan="5"><?php echo $row["pdos"].'-'.$row["duration"].'-'.$row["ins"]; ?></td>
				  <td align="center" colspan="2"><a href="dismomedidelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
