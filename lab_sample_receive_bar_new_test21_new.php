...
$query1 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2='' and barcode3=''");
...
$query11 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2 !='' and barcode3 !=''");
...
$query111 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2 !='' and barcode3 =''");
...
$query2 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode2 !=''");
...
$query3 = mysqli_query($db,"select * from alltest where barcode1='$barcode' and type in('lab','LAB','Lab') and billstatus='Billed' and barcode3 !=''");
