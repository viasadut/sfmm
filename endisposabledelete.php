...
//$id1=$_REQUEST['ID'];
$url = "endisposable.php?pmrn=$pmrn&eid=$eid";
$query = "DELETE FROM edisposible WHERE id=$id"; 
...
values ('$last_id','DR','$tb_data','$date','$price','AE_HOS_CHARGE_DEL')";
mysqli_query($con,$ins_query) or die(mysql_error());


$ins_query2="insert into pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`) 
values ('$last_id','CR','111999','$date','$price','AE_HOS_CHARGE_DEL')";
...
header("Location:endisposable.php?pmrn=$pmrn&eid=$eid");
