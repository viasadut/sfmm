...
$q = "SELECT COUNT(id) FROM lab_report_format where type= '$type'"; 
...
$url = "lab_format_view?type=$type&dname=$full";
header("Location: $url");
...
$ins_query_format="update lab_report_format set `inves`='$cdetails' where type='$type'";
mysqli_query($con,$ins_query_format);
