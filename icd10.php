...
$query159 = mysqli_query($con,"select * from icd where Diseasesub='$icd11'");
$data159 = mysqli_fetch_assoc($query159);
$Category=$data159["Category"];
$Block=$data159["Block"];
$Topic=$data159["Topic"];
$code=$data159["code"];
$Disease=$data159["Disease"];
$suncode=$data159["suncode"];
$sname=$data159["sname"];

$query559 = mysqli_query($con,"select * from icd where Diseasesub='$icd2'");
$data559 = mysqli_fetch_assoc($query559);
$Category2=$data559["Category"];
$Block2=$data559["Block"];
$Topic2=$data559["Topic"];
$code2=$data559["code"];
$Disease2=$data559["Disease"];
$suncode2=$data559["suncode"];
$sname2=$data559["sname"];


$query560 = mysqli_query($con,"select * from icd where Diseasesub='$icd3'");
$data560 = mysqli_fetch_assoc($query560);
$Category3=$data560["Category"];
$Block3=$data560["Block"];
$Topic3=$data560["Topic"];
$code3=$data560["code"];
$Disease3=$data560["Disease"];
$suncode3=$data560["suncode"];
$sname3=$data560["sname"];

$query561 = mysqli_query($con,"select * from icd where Diseasesub='$icd4'");
$data561 = mysqli_fetch_assoc($query561);
$Category4=$data561["Category"];
$Block4=$data561["Block"];
$Topic4=$data561["Topic"];
$code4=$data561["code"];
$Disease4=$data561["Disease"];
$suncode4=$data561["suncode"];
$sname4=$data561["sname"];

$query562 = mysqli_query($con,"select * from icd where Diseasesub='$icd5'");
$data562 = mysqli_fetch_assoc($query562);
$Category5=$data562["Category"];
$Block5=$data562["Block"];
$Topic5=$data562["Topic"];
$code5=$data562["code"];
$Disease5=$data562["Disease"];
$suncode5=$data562["suncode"];
$sname5=$data562["sname"];

$query563 = mysqli_query($con,"select * from icd where Diseasesub='$icd6'");
$data563 = mysqli_fetch_assoc($query563);
$Category6=$data563["Category"];
$Block6=$data563["Block"];
$Topic6=$data563["Topic"];
$code6=$data563["code"];
$Disease6=$data563["Disease"];
$suncode6=$data563["suncode"];
$sname6=$data563["sname"];

$query564 = mysqli_query($con,"select * from icd where Diseasesub='$icd7'");
$data564 = mysqli_fetch_assoc($query560);
$Category7=$data564["Category"];
$Block7=$data564["Block"];
$Topic7=$data564["Topic"];
$code7=$data564["code"];
$Disease7=$data564["Disease"];
$suncode7=$data564["suncode"];
$sname7=$data564["sname"];

$query565 = mysqli_query($con,"select * from icd where Diseasesub='$icd8'");
$data565 = mysqli_fetch_assoc($query565);
$Category8=$data565["Category"];
$Block8=$data565["Block"];
$Topic8=$data565["Topic"];
$code8=$data565["code"];
$Disease8=$data565["Disease"];
$suncode8=$data565["suncode"];
$sname8=$data565["sname"];


$query566 = mysqli_query($con,"select * from icd where Diseasesub='$icd9'");
$data566 = mysqli_fetch_assoc($query566);
$Category9=$data566["Category"];
$Block9=$data566["Block"];
$Topic9=$data566["Topic"];
$code9=$data566["code"];
$Disease9=$data566["Disease"];
$suncode9=$data566["suncode"];
$sname9=$data566["sname"];

$query567 = mysqli_query($con,"select * from icd where Diseasesub='$icd10'");
$data567 = mysqli_fetch_assoc($query567);
$Category10=$data567["Category"];
$Block10=$data567["Block"];
$Topic10=$data567["Topic"];
$code10=$data567["code"];
$Disease10=$data567["Disease"];
$suncode10=$data567["suncode"];
$sname10=$data567["sname"];

//echo $Category;


$ins_query="insert into presnew (`dname`,`pname`,`pmrn`,`pphone`,`cdetails`,`diagnosis`,`other`,`date`,`page`,`pdiet`,`pdiet2`,`pdiet3`,`pdiet4`,`pdiet5`,`pdiet6`,`pdiet7`,`reffer`,`reffer2`,`reffer3`,`reffer4`,`reffer5`,`reffer6`,`psex`,`eid`,`dstatus`) values ('$dname', '$pname','$pmrn','$pphone','$cdetails','$diagnosis','$other','$pdate','$page','$pdiet','$ref1','$ref2','$ref3','$ref4','$ref5','$ref6','$reffer','$reffer2','$reffer3','$reffer4','$reffer5','$reffer6','$psex','$count1','SEEN')";
...
$update33="update pappnew set `height`='$pheight',`weight`='$pweight',`temp`='$ptemp',`pbp`='$pbp',`pbmi`='$pbmi',`phyper`='$phyper',`ppluse`='$ppluse',`pheart`='$pheart',`pdm`='$pdm',`pkid`='$pkid',`ptb`='$ptb',`pasthma`='$pasthma',`pthyroid`='$pthyroid',`pneuro`='$pneuro',`psurgery`='$psurgery',`pperiod`='$pperiod',`plmp`='$plmp',`pnochild`='$pnochild',`plchild`='$plchild',`palcohol`='$palcohol',`psmoking`='$psmoking',`pfamily`='$pfamily',`pdrug`='$pdrug',`mstatus`='$pmstatus',`occupation`='$poccupation',`eid`='$count1', `status`='SEEN',`stime`='$stime',`spo2`='$spo2',`rr`='$rr',`pperiod1`='$pperiod1',`plmp1`='$plmp1',`pnochild1`='$pnochild1',`plchild1`='$plchild1',`psurgery1`='$psurgery1',`palcohol1`='$palcohol1',`psmoking1`='$psmoking1',`pfamily1`='$pfamily1',`pdrug1`='$pdrug1',`phyper1`='$phyper1',`pheart1`='$pheart1',`pdm1`='$pdm1',`pkid1`='$pkid1',`ptb1`='$ptb1',`pasthma1`='$pasthma1',`pthyroid1`='$pthyroid1',`pneuro1`='$pneuro1',`liver`='$liver',`liver1`='$liver1',`para`='$para',`para1`='$para1',`gravida`='$gravida',`gravida1`='$gravida1',`clist`='$clist',`clist1`='$clist1'where `ID`='$id'";
mysqli_query($con,$update33) or die("Problem in Update pappnew");




if (!empty ($_POST['icd11'])){
$ins_query268="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category','$Block','$Topic','$code','$Disease','$suncode','$sname','$icd11')";
mysqli_query($con,$ins_query268) or die("Problem in Reffer6");}


if (!empty ($_POST['icd2'])){
$ins_query269="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category2','$Block2','$Topic2','$code2','$Disease2','$suncode2','$sname2','$icd2')";
mysqli_query($con,$ins_query269) or die("Problem in Reffer6");}

if (!empty ($_POST['icd3'])){
$ins_query270="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category3','$Block3','$Topic3','$code3','$Disease3','$suncode3','$sname3','$icd3')";
mysqli_query($con,$ins_query270) or die("Problem in Reffer6");}


if (!empty ($_POST['icd4'])){
$ins_query271="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category4','$Block4','$Topic4','$code4','$Disease4','$suncode4','$sname4','$icd4')";
mysqli_query($con,$ins_query271) or die("Problem in Reffer6");}


if (!empty ($_POST['icd5'])){
$ins_query272="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category5','$Block5','$Topic5','$code5','$Disease5','$suncode5','$sname5','$icd5')";
mysqli_query($con,$ins_query272) or die("Problem in Reffer6");}

if (!empty ($_POST['icd6'])){
$ins_query273="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category6','$Block6','$Topic6','$code6','$Disease6','$suncode6','$sname6','$icd6')";
mysqli_query($con,$ins_query273) or die("Problem in Reffer6");}


if (!empty ($_POST['icd7'])){
$ins_query274="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category7','$Block7','$Topic7','$code7','$Disease7','$suncode7','$sname7','$icd7')";
mysqli_query($con,$ins_query274) or die("Problem in Reffer6");}

if (!empty ($_POST['icd8'])){
$ins_query275="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category8','$Block8','$Topic8','$code8','$Disease8','$suncode8','$sname8','$icd8')";
mysqli_query($con,$ins_query275) or die("Problem in Reffer6");}

if (!empty ($_POST['icd9'])){
$ins_query276="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category9','$Block9','$Topic9','$code9','$Disease9','$suncode9','$sname9','$icd9')";
mysqli_query($con,$ins_query276) or die("Problem in Reffer6");}

if (!empty ($_POST['icd10'])){
$ins_query277="insert into icd1 (`pname`,`pmrn`,`dname`,`eid`,`pdate`,`Category`,`Block`,`Topic`,`code`,`Disease`,`suncode`,`sname`,`Diseasesub`) values 
('$pname', '$pmrn','$dname','$count1','$pdate','$Category10','$Block10','$Topic10','$code10','$Disease10','$suncode10','$sname10','$icd10')";
mysqli_query($con,$ins_query277) or die("Problem in Reffer6");}


$url = "historynewviewicd?pmrn=$pm&eid=$count1&date=$pdate&dname=$pd" ;
header("Location:$url");
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="view3newtest?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>"><b>Record of Previous Visits<b></a>&nbsp&nbsp&nbsp&nbsp<a href="view3newtesttest?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>&eid=<?php echo "$count1"?>"><b>Edit Previous Visits<b></a>&nbsp;&nbsp;
...
<tr>
<td colspan="4"><input type="text" name="psurgery1" placeholder="Remarks" value="" /></td>
<td colspan="4"><input type="text" name="palcohol1" placeholder="Remarks" value="" /></td>
<td colspan="4"><input type="text" name="psmoking1" placeholder="Remarks" value=""/></td>
<td colspan="4"><input type="text" name="pfamily1"placeholder="Remarks"  value="" /></td>
<td colspan="4"><input type="text" name="pdrug1"  placeholder="Remarks"value=""/></td>
</tr>
...
<tr>
<td colspan="7"><input type="text" name="pperiod" required value="<?php echo $row['pperiod'];?>" /></td>
<td colspan="7"><input type="text" name="plmp" required value="<?php echo $row['plmp'];?>" /></td>
<td colspan="6"><input type="text" name="clist" required value="<?php echo $row['clist'];?>" /></td>
</tr>
<tr>
<td colspan="7"><input type="text" name="pperiod1" placeholder="Remarks" value="" /></td>
<td colspan="7"><input type="text" name="plmp1" placeholder="Remarks" value="" /></td>
<td colspan="6"><input type="text" name="clist1" placeholder="Remarks" value="" /></td>
</tr>
...
<td colspan="5"><input type="text" name="para" required value="<?php echo $row['para'];?>" /></td>
<td colspan="5"><input type="text" name="gravida" required value="<?php echo $row['gravida'];?>" /></td>
<td colspan="5"><input type="text" name="plchild" required value="<?php echo $row['plchild'];?>" /></td>
<td colspan="5"><input type="text" name="pnochild" required value="<?php echo $row['pnochild'];?>" /></td>
</tr>
<tr>

<td colspan="5"><input type="text" name="para1" placeholder="Remarks" value="" /></td>
<td colspan="5"><input type="text" name="gravida1" placeholder="Remarks" value="" /></td>
<td colspan="5"><input type="text" name="plchild1" placeholder="Remarks" value="" /></td>
<td colspan="5"><input type="text" name="pnochild1" placeholder="Remarks" value="" /></td>
</tr>
<tr><td colspan="20" bgcolor="lightgreen"><h3><a target='_blank' href="vacine?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Vaccine History</a>&nbsp;&nbsp;<a target='_blank' href="bhistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Birth History</a>&nbsp;&nbsp;<a target='_blank' href="pasthistory?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$pd"?>">Past History</a>&nbsp;&nbsp;<a target='_blank' href="comordoc?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"?>">Comorbidities</a></td></tr>					
				<tr><td colspan="20" bgcolor="#00CCCC"><label><strong></strong></label></td></tr>					
						 ...
						 <tr><td colspan="20"><label><strong>ICD10 Diagnosis:</strong></label></td>  </tr>
						 <tr><td colspan="4"><input list=icd1 name="icd11" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd1">	
			...
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
					echo "<option value='".$row->Diseasesub."'>".$row->Diseasesub."</option>";
				}
			}
			?>	
	...
	<td colspan="4"><input list=icd2 name="icd2" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd2">	
						
						<option value=''>-Select ICD10-</option>
				 <?php 
			$sql = "select * from `icd`";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
...
<td colspan="4"><input list=icd3 name="icd3" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd3">	
...
<td colspan="4"><input list=icd4 name="icd4" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd4">	
...
<td colspan="4"><input list=icd5 name="icd5" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd5">	
 ...
 <tr><td colspan="4"><input list=icd6 name="icd6" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd6">	
	...
	<td colspan="4"><input list=icd7 name="icd7" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd7">	
...
<td colspan="4"><input list=icd8 name="icd8" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd8">	
...
<td colspan="4"><input list=icd9 name="icd9" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd9">	
...
<td colspan="4"><input list=icd10 name="icd10" placeholder="Select ICD10" class="form-control" >
					<datalist id="icd10">	
			...
			?>	
						 ...
						 <tr><td colspan="20"><label><strong>Patient's Diagnosis:</strong></label></td>  </tr>
						  <tr><td colspan="20"><textarea class="form-control" id="exampleTextarea1" name="diagnosis" rows="5"></textarea></td>  </tr>
...
<tr>
	...
	<td colspan="10"><a target='_blank' href="docadm?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$full"; ?>&eid=<?php echo "$count"; ?>"><img src="adm.jpg" title="Admission Request" width="120" height="75" /></a></td>  
