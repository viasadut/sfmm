...
$sel90="SELECT * FROM radio WHERE `id`='$medi';";
$result90 = mysqli_query($con,$sel90);


//$dtime = $_REQUEST['dtime'];
$query159 = mysqli_query($db,"select * from radio where id='$medi'");
$data159 = mysqli_fetch_assoc($query159);
$type=$data159["type"];
$price=$data159["price"];
$code=$data159["code"];
$subtype=$data159["subtype"];
$iiname=$data159["iname"];
//echo $type;
//echo $type;
...
$ins_query="insert into alltest (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`price`,`code`,`link`,`date1`,`linkv`,`report`,`reportv`,`location`,`page`,`pgender`,`subtype`,`billstatus`,`billby`,`billdate`,`pphone`,`barcode`,`barcode1`,`billtime`,`ip`,`op`,`acct_code`,`ccentre`) 
values ('$dname', '$pmrn','$pname','$eid','$iiname','$pins','$date','$type','$price','$code','$link','$date77','$linkv','$report','$reportv','OPD','$bdate','$psex','$subtype','Billed','$user','$pdate','$pphone','$bar','$bar','$pdate1','$ip','$op','$acct_code','$ccentre')";
...
<tr>
<td colspan="10" align="center"><select name="medi" class="con_charge" required>
  

						<option value=''>-Select Investigation</option>
				<?php 
			$sql = "select * from `radio` where status='Active' and type!='Package'";
