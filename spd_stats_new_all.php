...
$query43 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by!='';"; 
...
$query44 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44=mysqli_fetch_assoc($result44);

$query1 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron='ECG';"; 
	 
$result1= mysqli_query($con, $query1) or die(mysqli_error());
$row1=mysqli_fetch_assoc($result1);

$query2 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron LIKE '%Echo%';"; 
	 
$result2= mysqli_query($con, $query2) or die(mysqli_error());
$row2=mysqli_fetch_assoc($result2);

$query3 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron='ETT';"; 
	 
$result3= mysqli_query($con, $query3) or die(mysqli_error());
$row3=mysqli_fetch_assoc($result3);

$query4 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron LIKE '%HOLTER%';"; 
	 
$result4= mysqli_query($con, $query4) or die(mysqli_error());
$row4=mysqli_fetch_assoc($result4);

$query5 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron LIKE '%Spirometry%';"; 
	 
$result5= mysqli_query($con, $query5) or die(mysqli_error());
$row5=mysqli_fetch_assoc($result5);

$query6 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron LIKE '%EEG%';"; 
	 
$result6= mysqli_query($con, $query6) or die(mysqli_error());
$row6=mysqli_fetch_assoc($result6);


$query7 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron='CORONARY ANGIOGRAM';"; 
	 
$result7= mysqli_query($con, $query7) or die(mysqli_error());
$row7=mysqli_fetch_assoc($result7);


$query8 = "SELECT COUNT(id) FROM ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' and ron='Coronary angioplasty';"; 
...
<h1 align="center">SPD Reports Stats</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Referral Doctor's Name</strong>
	  <th width="14%"><strong>Performing Doctor's Name</strong>
...
$sel_query="Select * from ecg_test where  datenew BETWEEN '$start' and '$end' and con_by!='' order by datenew desc";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
echo   $row43['COUNT(id)'];
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from ecg_test where datenew BETWEEN '$start' and '$end' and con_by !='' order by ron asc ";
 } 
$count=1;
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["ron"]; ?>  
