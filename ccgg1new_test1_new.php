...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('vvb')"; 
...
$sel43="SELECT * FROM opd_appoint1 WHERE `dname`='$dname2' and `date1`='$date22' and dslot='$slot' and status='Booked';";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<button type="submit" name="Submit4">Take Photo</button>
			</td>
