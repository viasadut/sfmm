...
<div id='cssmenu'>
<ul>
   <li><a href='cviewsp'><span>Home</span></a></li>
...
<form action="cviewsp" method="Post">
...
$sel_query="Select * from pappnew where adate= '$date' and dname='$bt' and `bill`='Billed' and status='Not SEEN' ORDER BY aslot asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["status"];?> </td> 
	       ...
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="gg545?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"];?>">UPDATE</a> </td>
...
$sel_query="Select * from pappnew where adate= '$date' and dname='$bt' and `bill`='Billed' and status='SEEN' ORDER BY aslot asc;";
