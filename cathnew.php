...
$sel43="SELECT * FROM cath WHERE `dname`='$dname' and `ddate`='$date1' and dslot='$slot' and status='Booked';";
...
$ins_query="insert into cathpapp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`dreffer`,`tname`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$page','$psex','$tname23','$tname2')";
mysqli_query($con,$ins_query);
$update="update cathapp set status='Booked' where `ddate`='$date1' and `dslot`='$slot'";
