...
if($cat=='HOD' or $cat=='Incharge'){
	...
	<tr><td colspan="20"align="left"bgcolor="lightblue" style="color:blue;text-align:left;font-size:25px;font-weight:bold;"><h2>Todays Departmental Attendance At a Glance </h2></td></tr>
	<tr>
...
;}
	...
	<?php if($user=='72' or $user=='338' or $user=='45'){	echo'	

<tr>	<td colspan="20"align="left"><a href="storeedit_test1"><font size="4.5">Edit Hospital Equipment</a></td></tr>
<tr>	<td colspan="20"align="left"><a href="dmaterialstore"><font size="4.5">Add Hospital Equipment / Disposible</a></td></tr>	'
;}
