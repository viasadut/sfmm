...
$stest = mysqli_real_escape_string($connect, $_POST["stest"]);		 
...
$sel95 = "SELECT * from medicine where mname='$infu' and pre in('Tablet','Vaginal Suppository','VT','Suppository','Soft Capsule','Sachet','Capsule','Injection','Infusion','Laxative Saline','Nebuliser Suspension','Inhalation  Solution','Rectal Solution','Solution','')"; 
...
$query="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`uprice`,`ndate`,`code`,`pre`,`stest`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$dtime','$dilu','$uprice','$ndate','$code','$pre','$stest')";
...
$query="insert into imedi3 (`pmrn`,`dname`,`eid`,`infusion`,`time`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`dilu`,`reuse`,`uprice`,`ndate`,`code`,`pre`,`stest`) values 
('$pmrn','$dname','$eid','$infu','$time','$instruc','$alert','$user','$odate','Active','$root','Rupdated','Ordered','$dtime','$dilu','Reuse','0','$ndate','$code','$pre','$stest')";
