...
//$id1=$_REQUEST['ID'];
$url = "labinpendo?pmrn=$pmrn&eid=$eid";
$query = "UPDATE endolab set luser='$user',rtime='$dtime', status='REJECTED', rcomments='$result' where id='$id'"; 
...
<td colspan="4" align="center"><label><strong>Reject With Comments</strong></label></td>
...
<td colspan="4" align="center"><select name="result" value="" class="style1" required>
<option value=''>-Rejection Comments-</option>

						<option value='HEMOLYZED'>HEMOLYZED</option>
						<option value='WRONG MRN'>WRONG MRN</option>
						<option value='WRONG LAB ID'>WRONG LAB ID</option>
						<option value='UNLABELED NOT PROPERLY LABELED'>UNLABELED NOT PROPERLY LABELED</option>
						<option value='INCORRECT CONTAINER'>INCORRECT CONTAINER</option>
						<option value='INSUFFICIENT SPECIMEN'>INSUFFICIENT SPECIMEN</option>
						<option value='MISPLACED BARCODE'>MISPLACED BARCODE</option>					
