...
/*$q9 = "SELECT * from conleavedetails where status in('Approval Pending','Approved By MD','Approved By ALL','Approved By Replacement Consultant') and sid='$user' and '$sdate' between sdate and edate and '$edate' between sdate and edate"; 
