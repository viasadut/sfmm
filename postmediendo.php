...
$ins_query1="insert into postendomedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`frelation`,`duration`) values ('$full','$pmrn','$pname','$medi1','$brand2','$pdos','$eid','$date1','$pdos1','$duration')";
...
/*$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`eid`,`brand`,`pdos`,`date`,`ndate`,`duration`,`frelation`) values 
('$full','$pmrn','$pname','$ii','$eid','$brand2','$ii2','$date1','$date2','$ii3','$ii4')";
mysqli_query($con,$ins_query1) or die(mysql_error());
*/
$ins_query1="insert into postendomedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`duration`,`frelation`) values 
('$full','$pmrn','$pname','$ii','$brand2','$ii2','$eid','$date1','$ii3','$ii4')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
...
$count=1;
$sel_query="Select * from postendomedi where pmrn= '$pmrn' and eid='$eid' ORDER BY page_order;";
...
<tr id="<?php echo $row['id'] ?>">
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
				  ...
				  <td align="left" colspan="10"><?php echo $row["brand"].' ('.$row["medi"].')'; ?></td>
			      <td align="left"colspan="5"><?php echo $row["pdos"].' ('.$row["duration"].')'.' ('.$row["frelation"].')'; ?> <input type="button" name="edit_co" value="E" id="<?php echo $row['id']; ?>" class="btn btn-info btn-xs edit_data_co" /></td>
				  <td align="center" colspan="2"><a href="delpostmedi?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
	...
	<td colspan="10"><a target='_blank' href="endopostmedireport.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
</table>
</form>
</body>
