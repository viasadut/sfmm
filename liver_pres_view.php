...
$query = "SELECT * from pappnew where pmrn='$pmrn'and adate='$dt' and status='SEEN' and liver_opd='SFMM LIVER CLINIC';" ;
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><b>Date:<?php echo $row['adate'];?>&nbsp;&nbsp; Time:<?php echo $row['aslot'];?><b></td></tr>
				...
				<tr>	  
				<td colspan="20"><?php if($row43['did']==''){echo $row43["dname"];} else {echo $bb.' -'.$row43["dname"];}?>
            ...
            <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="7" style="background:lightgreen;">
            <strong>Patient's Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</strong><span style="font-size:20px;color:red;"><?php echo $pn;?></span><br>
            <strong>Patient's MRN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</strong><span style="font-size:20px;color:red;"><?php echo $pm;?></span><br>
            <strong>Patient's Age&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</strong><span style=""><?php echo $row['page'];?></span><br>
            <strong>Patient's Phone No&nbsp;:&nbsp;</strong><span style=""><?php echo $row['pphone'];?></span><br>
            ...
            <td colspan="8" style="background:lightgreen;">
            <strong>Patient's Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</strong><span style="font-size:20px;color:red;"><?php echo $pn;?></span><br>
            <strong>Patient's MRN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</strong><span style="font-size:20px;color:red;"><?php echo $pm;?></span><br>
            <strong>Patient's Age &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</strong><?php echo $row['page'];?><br>
            <strong>Patient's Phone No &nbsp;:&nbsp;</strong><?php echo $row['pphone'];?><br>
...
<?php $query1 = "select * from alltest where pmrn='$pmrn'  and eid='$eid'";
...
<?php $query1 = "select * from pmedi where pmrn='$pmrn'  and eid='$eid'";
$result = mysqli_query($con,$query1);
while($data1 = mysqli_fetch_array($result))
...
{ ?>    <tr>
      ...
      <td colspan="12"><?php echo $data1["medi"]; ?></td>
	        <td colspan="8"><?php echo $data1["pdos"].''.$data1['duration'].','.$data1['frelation']; ?></td>
	  </tr>
    <?php } ?>
...
<?php $query1 = "select * from opd_referral where pmrn='$pmrn' and ref_by='$dname' and eid='$eid'";
$result = mysqli_query($con,$query1);
while($data1 = mysqli_fetch_array($result))

{ ?>    <tr>

      <td colspan="12"><?php echo $data1["ref_name"]; ?></td>
	        <td colspan="8"><?php echo $data1["reason"]; ?></td>
	  </tr>
    <?php } ?>
