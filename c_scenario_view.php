...
<tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr>
    ...
    <tr>
      ...
      <th width="10%"><strong>Clinical Scenario:</strong></th>
	  <th width="17%"><strong>Key Words</strong></th>
      <th width="15%"><strong>Recommended Antibiotics:
</strong>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from c_scenario order by id desc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
	...
	<td align="center"><a href="c_scenario_view1?id=<?php echo $row["id"]; ?>">DETAILS</a></td> 
	<td align="center">
	<?php
