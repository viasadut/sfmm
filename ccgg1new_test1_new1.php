...
('$name', '$pmrn','$pphone','$padd','$dname','$date23','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$adate1','$ptype','ccgg1new_test1_new1')";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="dis" id="dis" placeholder="District" required style="background-color:lightgreen;font-size:18px;font-weight:bold;color:red;width:200px" class="dictrict"> 
