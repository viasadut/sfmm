...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>POST ORDER</strong>
	  <th width="14%"><strong>Anaesthesia Document</strong>
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="ot2viewdoc?id=<?php echo $row["id"]; ?>">View</a></td>
			  ...
			  <td align="center"><a target='_blank' href="postotordernew?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["id"]; ?>"><img src="print.png" title="Post Order" width="150" height="60" /></a></td>
			  <td align="center"><a target='_blank' href="otanaesprint?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["id"]; ?>"><img src="print.png" title="Post Order" width="150" height="60" /></a></td>
