...
$ins_query1="insert into medicineedit (`mname`,`brand1`,`eby`,`etime`,`uprice`,`status`,`mid`,`code`,`uprice1`,`cprice`,`fby`,`cfo`,`ceo`,`it`,`ittime1`,`md`,`oprice`,`oprice1`)
 values ('$mname','$bname','$user','$adate','$uprice','Waiting For Finance Fowrading','$id','$code','$uprice1','$cprice','338','cfo','ceo','322','$ittime1','md','$oprice','$oprice1')";
