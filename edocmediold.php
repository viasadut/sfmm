...
$ins_query="insert into emedi (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`dtime`,`status`) values ('$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$infu','$user','$remarks','Data Updated')";
...
<tr>
<td colspan="14" align="center"><label><strong>Medicine</strong></label></td> 
...
<tr>
      ...
      <td colspan="3" align="center"><strong>Medicine</strong></td>
