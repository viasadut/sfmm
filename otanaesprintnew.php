...
$pdf->Cell('183',5,'Date & Time: '.$print_time,0,1,'R');
...
$queryr = mysqli_query($db,"select * from otanaesmedi where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datar['time'].', Medication - '.$datar['infusion'].',Doasge- '.$datar['instruc'],0,1);
...
$querys = mysqli_query($db,"select * from otanaesinfusion where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datas['otime'].', Infusion - '.$datas['infusion'].',Additive- '.$datas['addi'].' + '.$datas['add1'].',Doasge- '.$datas['infu1'],0,1);
...
$queryt = mysqli_query($db,"select * from otanaesn2o where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datat['odate'].', Infusion - '.$datat['infusion'].' Flow- '.$datat['room'],0,1);
...
$queryu = mysqli_query($db,"select * from otanaesagent where pmrn='$pmrn' and eid='$eid'");

while($datau = mysqli_fetch_array($queryu))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datau['odate'].', Medication - '.$datau['infusion'].' Flow- '.$datau['room'],0,1);
...
$queryv = mysqli_query($db,"select * from otanaesbsugar1 where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datav['odate'].', Blood Sugar - '.$datav['infusion'].' Remarks-  '.$datav['room'],0,1);
...
$queryw = mysqli_query($db,"select * from otanaesbloss where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$dataw['odate'].', Blood Loss - '.$dataw['infusion'].' Remarks-  '.$dataw['room'],0,1);
...
$queryx = mysqli_query($db,"select * from otanaesurine where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datax['odate'].', Amount - '.$datax['infusion'].' Remarks- '.$datax['room'],0,1);
...
$queryy = mysqli_query($db,"select * from otanaesinves where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datay['odate'].', Investigation - '.$datay['infusion'].' Result-  '.$datay['room'],0,1);
...
$queryz = mysqli_query($db,"select * from otanaesbtrans where pmrn='$pmrn' and eid='$eid'");

while($dataz = mysqli_fetch_array($queryz))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$dataz['odate'].', Blood Type - '.$dataz['infusion'].' Amount- '.$dataz['room'],0,1);
...
$queryaa = mysqli_query($db,"select * from otanaesother where pmrn='$pmrn' and eid='$eid'");

while($dataaa = mysqli_fetch_array($queryaa))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$dataaa['odate'].', Type - '.$dataaa['infusion'].' Amount- '.$dataaa['room'],0,1);
...
$querybb = mysqli_query($db,"select * from otanaestour where pmrn='$pmrn' and eid='$eid'");

while($databb = mysqli_fetch_array($querybb))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$databb['odate'].', Type - '.$databb['infusion'].' Site- , '.$databb['room'].' Padding- , '.$databb['pad'].' Application Time- , '.$databb['atime'].' Release Time- , '.$databb['rtime'],0,1);
...
$querycc = mysqli_query($db,"select * from otanaespulse where pmrn='$pmrn' and eid='$eid'");

while($datacc = mysqli_fetch_array($querycc))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datacc['date2'].', Score - '.$datacc['score1'],0,1);
...
$querydd = mysqli_query($db,"select * from otanaessbp where pmrn='$pmrn' and eid='$eid'");

while($datadd = mysqli_fetch_array($querydd))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datadd['date2'].', Score - '.$datadd['score1'],0,1);
...
$queryee = mysqli_query($db,"select * from otanaessbp where pmrn='$pmrn' and eid='$eid'");
...
//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$dataee['date2'].', Score - '.$dataee['score2'],0,1);
...
$queryff = mysqli_query($db,"select * from otanaesrr where pmrn='$pmrn' and eid='$eid'");

while($dataff = mysqli_fetch_array($queryff))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$dataff['date2'].', Score - '.$dataff['score1'],0,1);
...
$querygg = mysqli_query($db,"select * from otanaestemp where pmrn='$pmrn' and eid='$eid'");

while($datagg = mysqli_fetch_array($querygg))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datagg['date2'].', Score - '.$datagg['score1'],0,1);
...
$queryhh = mysqli_query($db,"select * from otanaesspo2 where pmrn='$pmrn' and eid='$eid'");

while($datahh = mysqli_fetch_array($queryhh))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datahh['date2'].', Score - '.$datahh['score1'],0,1);
...
$queryii = mysqli_query($db,"select * from otanaesetco2 where pmrn='$pmrn' and eid='$eid'");

while($dataii = mysqli_fetch_array($queryii))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$dataii['date2'].', Score - '.$dataii['score1'],0,1);
...
$queryjj = mysqli_query($db,"select * from otanaescvp where pmrn='$pmrn' and eid='$eid'");

while($datajj = mysqli_fetch_array($queryjj))
{


//$pdf->MultiCell('182', 5,$data1['medi'],1,1);
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,'Time - '.$datajj['date2'].', Score - '.$datajj['score1'],0,1);
