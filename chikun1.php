...
$rr1='Chikungunya IgM- :'.$chikun1."<br />".'Chikungunya IgG:'.$chikun2;

$rr='Chikungunya IgM- :'.$chikun1."<br />".'Chikungunya IgG:'.$chikun2;
...
$ins_query1="insert into chikun (`pname`,`pmrn`,`psex`,`page`,`chikun1`,`chikun2`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Chikungunya Test:</strong></label>
	  <label for="iron"><strong>Chikungunya IgM</strong></label>
      <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="tibc"><strong>Chikungunya IgG</strong></label>
