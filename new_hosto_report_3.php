...
$update33="update histo set `report`='$cinfo',`status`='REPORT DONE',`dname1`='$full',`rtime`='$time',`rdate`='$date1',`date1`='$dd',`hno`='$hno',`cstatus`='Waiting For Consultant Confirmation',`ruby`='$full',`rutime`='$udate' where `id`='$id'";
...
<tr>				 <td colspan="10"><input type="text" name="pname"  value="<?php echo $row39['pname'];?>" readonly></td>
					...
					<td colspan="2"><input type="text" name="page" required value="<?php echo $row39['page'];?>" readonly></td>  	
					 <td colspan="2"><input type="text" name="psex" required value="<?php echo $row39['pgender'];?>" readonly></td>
					 <td colspan="4"><input type="text" name="pphone" required value="<?php echo $row39['pphone'];?>" readonly></td>  
