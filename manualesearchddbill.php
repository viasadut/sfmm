...
$sel_query="Select * from preadm where pphone= '$pmrn' and ddrequest='Request' and arequest !='' order by id desc;";}
 else{
	 $sel_query="Select * from preadm where pmrn= '$pmrn' and ddrequest='Request' and arequest !='' order by id desc;";
 } 
$count=1;	 
...
{ ?>    <tr>
	  ...
	  <td align="center"><a href="ebilladmddbill?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
