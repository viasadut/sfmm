...
$count=1;
	...
	if($user=='md' or $user=='332'){	
$sel_query="Select * from medicineedit where status='waiting' ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["pcat"]; ?>  
		  ...
		  <td align="Left"><?php echo $row["appby"]; ?>  
	  	  
	  	  

	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a onclick="return confirm_click();" href="approvemediedit?id=<?php echo $row["id"]; ?>&user=<?php echo "$fullname";?>">Approve</a> </td>
	  
	  <td align="center"><a onclick="return confirm_click2();" href="rejectedit?id=<?php echo $row["id"]; ?>"><strong>Reject</strong></a></td>
