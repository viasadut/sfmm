...
$sel900="select * from `inpatient` where pmrn='$pmrn'and discharge='';";
...
$ins_query="insert into cath_receive (`dname`,`dname2`,`pname`,`pmrn`,`pphone`,`page`,`psex`,`pdate`,`ptime`,`proname`,`type`,`date1`,`ll`,`ieid`) values 
('$dname', '$dname2','$pname','$pmrn','$pphone','$page','$psex','$pdate','$ptime','$proname','OPD','$date1','$ll','$ieid')";
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				<tr><td colspan="10"><label><strong>Primary Doctors's Name :</strong></label></td>
        <td colspan="10"><label><strong>Assisting Doctors's Name :</strong></label></td></tr>
				<tr>	  
				<td colspan="10"><select name="dname3" value="" class="country">
...
"jsnew/select2.min.css" />
            ...
            <td colspan="10"><select name="dname_2" value="" class="country2">
			        <option value=''>-Select Doctor-</option>
				<?php 
			$sql = "select * from `doctor` where status='Active'";
			$res = mysqli_query($con, $sql);
...
$(document).ready(function() {
    $('.country2').select2();
                    ...
                    <tr><td colspan="20"><label><strong>Procedure Name :</strong></label></td>
        </tr>
                    <tr>				
...
<tr>				<td colspan="2"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly></td>
					 ...
					 <td colspan="3"><input type="text1" name="type" required value="IPD" readonly></td>
		...
		<tr>
			    	 ...
			    	 <td colspan="3"><input type="text" name="pdate" id="datepicker1" placeholder="Select Date" value="<?php echo date('m/d/Y');?>"size="15" ></td>  
