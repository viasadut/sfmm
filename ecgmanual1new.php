...
$ins_query="insert into ecg (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`ron`,`find`,`comments`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`) 
values('$dname','$select','$pmrn','$pname','$page','$psex','$pphone','$ron','$find','$comments','$count1','$date1','$date2','$stime','Updated','OPD')";
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
	...
	<tr><td colspan="20"bgcolor='lightgreen'align="center"><label><strong>ELECTROCARDIOGRAPHY REPORT</label></strong></td></tr>				 
					 ...
					 <tr>
						...
						<tr>				
						<td colspan="20"><textarea class="form-control" id="exampleTextarea" name="find" rows="5" ></textarea></td>  
