...
$ins_query="insert into anaesn2o (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
<td colspan="7" align="center"><label><strong>N2O/Air</strong></label></td> 
...
$count=1;
$sel_query="Select * from anaesn2o where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
