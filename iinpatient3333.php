...
$query45 = mysqli_query($db,"select * from iinfusion where pmrn='$pmrn' and id='$id'");
...
$update="update iinfusion set ddate='$ddate',status='Rupdated', duser='$user' where `id`='$id'";
...
<tr><td colspan="5" align="center"><label><strong>Order By</strong></label></td> 
<td colspan="5" align="center"><label><strong>Order Date</strong></label></td> 
<td colspan="10" align="center"><label><strong>Infusion</strong></label></td> 
<tr>
<td colspan="5" align="center"><input type="text"  name="odate" required value="<?php echo $data45["user"]; ?>" readonly/></td>
<td colspan="5" align="center"><input type="text"  name="odate" required value="<?php echo $data45["odate"]; ?>" readonly/></td>
<td colspan="10" align="center"><input type="text" name="infu" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
</tr> 
