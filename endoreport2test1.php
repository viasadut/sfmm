...
$servername = "localhost";
  ...
  $sql = "insert into ivisitendo (`pmrn`,`eid`,`pname`,`page`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`room`,`vtype`,`cdate`,`ieid`,`dcode`,`ccode`,`app_con`,`ip`,`op`,`ccentre`) values 
  ( '$pmrn','$eid','$pname','$page','$psex','$pphone','$daten','$full','$user','$charge','$tname','$date11','$ieid','$dcode','$code','$app_con','$ip','$op','$ccentre')";
...
$date=date('Y-m-d');
		...
		values ('$last_id','CR','$tb_data','$date','$charge','ENDOSCOPY')";
		...
		values ('$last_id','DR','615100','$date','$charge','ENDOSCOPY')";
