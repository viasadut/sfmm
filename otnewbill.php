...
$ins_query1="update procedure1 set ustatus='Paid' where id='$id'";
...
<form action="" method="post">
		...
		<tr><td colspan="20" align="left"bgcolor="#F8DE7E"><label><strong>Patient Name & MRN </strong></label></td> </tr>
		
		 <tr><td align="left"colspan="20"><b><?php echo $pname. ' & ' . $result9["pmrn"]; ?><b></td></tr>
		 
		 <tr><td colspan="20" align="Left"bgcolor="lightgreen"><label><strong>Primary Consultant Name</strong></label></td> </tr>
		
		 <tr><td align="left"colspan="20"><b><?php echo $result9["dname"];?><b></td></tr>
		
		
		<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Consultant & Anaesthetist Charge </strong></label></td> </tr>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
		  ...
		  <td colspan="5" align="center"><strong>Charge</strong></td>
...
$count=1;
$sel_query="Select * from otivisitendo where pmrn= '$pmrn' and eid='$id'order by `id` DESC;";
...
<tr><td colspan="20" align="center"bgcolor="#FA8072"><label><strong>List Of Medicine & Disposible & Equipment Used</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
