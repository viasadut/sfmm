...
$query43 = "SELECT COUNT(dname) FROM radpapp where dname= '$bt' and adate BETWEEN '$start' and '$end'and status !='Cancel';"; 
...
<form action="radapp22" method="POST">
...
$count=1;
$sel_query="Select * from radpapp where dname='$bt' and adate BETWEEN '$start' and '$end' and status !='Cancel' order by location asc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["btime"]; ?>
      ...
      <td alf ign="center"><?php echo $row["tname"]; ?>  
...
<td align="center"><?php echo $row["remarks"]; ?> 	   
    ...
    <?php $count++; } }?>
      ...
      <td colspan="10" align="right"><a target='_blank' href="radreport12?dname=<?php echo "$bt";?>&date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
  </tbody>
</table>
