...
$nqty=$tqty-$sqty;
	...
	*/
	...
	$querym = mysqli_query($con, "SELECT * FROM medi_stock WHERE sno='$p_rfid'");
...
$query2="update medi_stock set `add_qty`='$nqty' where sno='$p_rfid'";
...
values('$code2','$rloc','$g_name','$b_name','$sqty','$reqty','$exdate','$batch_no','$p_rfid','$medi_id','$id','$billno')";
