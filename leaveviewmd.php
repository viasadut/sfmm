...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from conleavedetails where status='Approved By Replacement Consultant' and md in ('$full','Dr. Razeeb Hassan') and ceo !='$full' and tdays<=3";
//$sel_query="Select * from conleavedetails where status='Approved By Replacement Consultant' and md in ('$full') and ceo !='$full' and tdays<=3";
//$start=$row["aadate"];
...
$date= date('m/d/Y');
//$count=1;
$sel_query="Select * from conleavedetails where status='Approved By Replacement Consultant' and md in ('$full','Dr. Razeeb Hassan') and tdays>3";
//$start=$row["aadate"];
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from conleavedetails where status='Approved By MD' and '$full'='Dr. Razeeb Hassan' and tdays>3";
//$start=$row["aadate"];
