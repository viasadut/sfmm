...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th ><strong>Admission Date</strong>
      <th ><strong>Discharge Date</strong>   
      <th ><strong>Doctor's Name</strong>
      <th ><strong>Bed NO</strong></th>
	  <th ><strong>Ward / Cabin</strong></th>
	  <th ><strong>Staying Duration(in Days)</strong>
...
$sel_query="Select * from newbed where  adatenew BETWEEN '$start' and '$end' order by bno asc";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from newbed where bno='$bt' and adatenew BETWEEN '$start' and '$end'";
 } 
$count=1;
...
{ ?>    <tr>
      ...
      <td align="center"><?php echo $row["adatenew"]; ?></td>  
      <td align="center"><?php echo $row["adatenew1"]; ?>  </td>  
...
{echo $fday= round($datediff1/(60*60*24),2) ;
}
