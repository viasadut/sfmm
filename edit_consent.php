...
$ins_query_format="update mc_report_format set `inves`='$cdetails',`status`='Waiting' where id='$id'";
mysqli_query($con,$ins_query_format);

$url = "mc_format_view1?id=$id";
header("Location: $url");
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr><td colspan="20" style="font-size:18px;color:green;"><label><strong> Editied BY: <?php echo $full;?></strong></label></td></tr>
...
<td colspan="20">
	 ...
	 <input type="text" id="type" name='type' required style="background-color:white;font-size:20px;color:red; font-weight:bold;" placeholder="Set New Template Name " value="<?php echo $row['type'];?>" readonly>
</td>
