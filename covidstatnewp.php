...
$query43 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sam='NEW'and tresult='P'"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sam='FollowUp' and tresult='P'"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);

$query45 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sam='Death' and tresult='P'"; 
	 
$result45 = mysqli_query($con, $query45) or die(mysqli_error());
$row45 = mysqli_fetch_assoc($result45);

$query46 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and tresult !=''"; 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Blood Group</strong></th>
      <th width="10%"><strong>Collection Date</strong></th>
      <th width="15%"><strong>Phone</strong>
       
      <th width="10%"><strong>Address</strong>
	  <th width="10%"><strong>Ward</strong>
	  <th width="10%"><strong>District</strong>
      <th width="10%"><strong>Sample Type</strong>
	  <th width="10%"><strong>Patient Type</strong>
	  <th width="10%"><strong>Result</strong>
	  <th width="10%"><strong>Status</strong>
	  <th width="10%"><strong>Edit</strong>
	  
	  <th width="10%"><strong>Print Report</strong>
...
echo "<font color=blue font size=5> Positive Case Found";
echo "<font color=blue font size=5> Out of- ";
echo   $row46['COUNT(sid)'];
echo "<font color=blue font size=5> Samples";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and tresult='P' order by ssent desc;";
...
<?php $count++; } }?>
      ...
      <td colspan ="2" align="right"><a target='_blank' href="test_pdf11p?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
