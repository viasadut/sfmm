...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Due Status</strong></th>
...
$count=1;
//echo   $bt;
echo "Patients List For Due Payment";

$sel_query="Select * from patient where remarks in ('Due','Partial Due') ORDER BY remarks asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><a href="patient_due_history?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>"><?php echo $row["pmrn"]; ?></a></td>
	  ...
	  <td align="center"><?php echo $row["due_remarks"]; ?>  </td>
    <td align="center"><a href="pedit_due?pmrn=<?php echo $row["pmrn"]; ?>&ID=<?php echo $row["ID"]; ?>&phone=<?php echo $row["pphone"]; ?>">Edit</a></td>
