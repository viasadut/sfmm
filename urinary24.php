...
$rr='24 Hours Urine Volume:'.$chikun1."<br />".'24 Hours Urine Creatinine:'.$chikun2;

$rr1='24 Hours Urine Volume:'.$chikun1.' '.'mL'."<br />".'24 Hours Urine Creatinine:'.$chikun2.' '.'mmol/24hr';



$ins_query1="insert into 24urinary (`pname`,`pmrn`,`psex`,`page`,`uv`,`uc`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Urinary Creatinine(24hrs Urine) Report:</strong></label>
