...
$query43 = "SELECT COUNT(dname) FROM presnew where dname= '$bt' and date1 BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from presnew where dname='$bt' and date1 BETWEEN '$start' and '$end'";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["reffer"]; ?>  
	  <td align="center"><a target='_blank' href="p5new?pmrn=<?php echo $row['pmrn']; ?>&date=<?php echo $row['date'];?>&dname=<?php echo $row["dname"];?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
	  <td align="center"><a target='_blank' href="prescription/prescription/pdf_p_12?pmrn=<?php echo $row['pmrn']; ?>&date=<?php echo $row['date'];?>&dname=<?php echo $row["dname"];?>&eid=<?php echo $row["eid"];?>"><img src="print.png" title="Print Report" width="50" height="40" /></a></td>
      </tr>
