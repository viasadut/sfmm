...
$ins_query1="insert into 24ccrate (`pname`,`pmrn`,`psex`,`page`,`sc`,`uv`,`uc`,`cc`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$psex','$page','$chikun1','$chikun2','$chikun3','$chikun4','$user','$adate','$eid','$iname','$id','$sno')";
