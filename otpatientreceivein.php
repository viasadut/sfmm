...
<!-- Form Title -->
		...
		<br>
			  ...
			  <input name="tname" type="text" size="70"class="style1" value="<?php echo $row39['proce'].''.$row39['Otherins'];?>" readonly >
			<br>
            <!-- Name Input -->
