...
<tr><td colspan="4"><label for="age"><strong>Follow Up Date (MM/DD/YYYY):</strong></label></td><tr>

<tr><td colspan="4" align="left"><input type="text1" class="style" name="fdate" id="datepicker" placeholder="Select Date" value="<?php echo date( 'm/d/Y', strtotime( $row43["fdate"]) ); ?>"></td></tr>
