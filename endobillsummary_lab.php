...
$sel_query="Select * from endopapp where adate= '$date' and status in('Received','SEEN') and bstatus!='Billed';";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["dreffer"]; ?>  
	       		   ...
	       		   <td align="left" ><a target='_blank' href="labinpendo_new?pmrn=<?php echo $row["pmrn"]; ?>&dreffer=<?php echo $row["dreffer"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["ID"]; ?>">Details</a></td>
