...
$query = mysqli_query($db,"select * from 24urineelectro where pmrn='$pmrn' and eid='$eid' and sno='$id'");
...
//$pdf->Cell('80',5,'--24 Hours Urine Sodium Test--',0,1,'L');
...
$pdf->Cell('80',5,'Sodium, Urine',1,0,'L');
$pdf->Cell('30',5,$data['uv'],1,0,'C');
$pdf->Cell('31',5,'mmol/L',1,0,'C');
$pdf->Cell('40',5,'54-150',1,1,'C');
...
//$pdf->Cell('80',5,'--24 Hours Urine Potassium Test--',0,1,'L');
...
$pdf->Cell('80',5,'Potassium, Urine',1,0,'L');
$pdf->Cell('30',5,$data['uc'],1,0,'C');
$pdf->Cell('31',5,'mmol/L',1,0,'C');
$pdf->Cell('40',5,'20-80',1,1,'C');


/*$pdf->ln(3);
$pdf->SetFont('Arial' , 'b' , 14);
$pdf->Cell('80',5,'--24 Hours Urine Chloride Test--',0,1,'L');
...
$pdf->Cell('80',5,'Chloride, Urine',1,0,'L');
$pdf->Cell('30',5,$data['cu'],1,0,'C');
$pdf->Cell('31',5,'mmol/L',1,0,'C');
$pdf->Cell('40',5,'46-168',1,1,'C');
...
lab_render_approval_footer($pdf, $db1, 'BIOCHEMISTRY', (isset($data3['resultby'])?$data3['resultby']:(isset($data['resultby'])?$data['resultby']:'')), (isset($data3['checked_by'])?$data3['checked_by']:''), (isset($data3['cby'])?$data3['cby']:''));
$pdf->Ln(10);
