...
$query43 = "SELECT COUNT(dname) FROM endoreport where dname= '$bt' and rdate BETWEEN '$start' and '$end';"; 
...
<h1 align="center">Number of Endoscopy Patient Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Refferal Doctor</strong>
	<th width="14%"><strong>Print</strong>
	<th width="14%"><strong>Endo Capture</strong>
...
$sel_query="Select * from endoreport where  rdate BETWEEN '$start' and '$end'";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * FROM endoreport where dname= '$bt' and rdate BETWEEN '$start' and '$end';"; 
 } 
$count=1;
...
{ ?>    <tr>
	  ...
	  <td><a target='_blank' href="photo333doc?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"];?>"><b>Endoscopy Capture<b></a></td>
      </tr>
