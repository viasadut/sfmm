...
$query39 = "SELECT * FROM chemopapp where ID= '$ID'"; 
...
$query43t = "SELECT COUNT(pmrn) FROM chemopapp where pmrn= '$pmrn' and status !='Cancel';"; 
...
$ins_query="update chemopapp set dreffer='$dname', tname='$tname',anes='$anes',eid='$count1t',status='Received' where ID='$ID'";
