...
{echo'
  <td align="center"colspan="2"><input class="paid1" name="vat_'.$id.'" id="paid" value="0"type="number" max="'.$tt.'" required onchange="subTotal()" style="font-weight: bold;font-size:35px;color:red">
  ...
  <td align="center" colspan="2"><input class="paid" name="tax_'.$id.'" id="paid" value="0"type="number" max="'.$tt.'" required onchange="subTotal()" style="font-weight: bold;font-size:35px;color:red">
