...
$update212="update preadm set pname='$pname',fname='$fname', mname='$mname', peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Pending',pphone='$pphone2',user='$user',scase='$scase',vpoor='$vpoor' where `id`='$id'";
mysqli_query($con,$update212);

$update22="update inpatient set bfigure='$bfigure',dia1='$dia1',cinfo='$cinfo',nidcard='$nidcard',ecost1='$ecost1',arequest='$arequest',user='$user' where `pmrn`='$pmrn' and eid='$eid1'";
...
<td align="center"><a href="phistoryqc?eid=<?php echo $eid1; ?>&pmrn=<?php echo $pmrn; ?>"><strong>History</strong></a></td>	   
        <fieldset>
