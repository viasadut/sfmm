<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','nurse','imo')"; 
...
$result398 = mysqli_query($dbhandle,$query398) or die(mysqli_error());
...
$result11 = mysqli_query($dbhandle,$query11) or die(mysqli_error());
...
$result22 = mysqli_query($dbhandle,$query22) or die(mysqli_error());
...
$result33 = mysqli_query($dbhandle,$query33) or die(mysqli_error());
...
$result55 = mysqli_query($dbhandle,$query55) or die(mysqli_error());
...
$result66 = mysqli_query($dbhandle,$query66) or die(mysqli_error());
...
$result77 = mysqli_query($dbhandle,$query77) or die(mysqli_error());
...
$result88 = mysqli_query($dbhandle,$query88) or die(mysqli_error());
...
$result99 = mysqli_query($dbhandle,$query99) or die(mysqli_error());
...
$result00 = mysqli_query($dbhandle,$query00) or die(mysqli_error());
...
$result009 = mysqli_query($dbhandle,$query009) or die(mysqli_error());
...
<h1 align="center">Datewise Intake-Outake Stats</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="4"><label><strong>Start Date:</strong></label></td>
						

							<td colspan="4"><label><strong>Start Time</strong></label></td> 
							
							<td colspan="4"><label><strong>End Date:</strong></label></td>	
							<td colspan="4"><label><strong>End Time</strong></label></td> 
			    	 ...
			    	 <td colspan="4"><input type="text" name="stdate" id="datepicker1" placeholder="Select Date" size="15" required></td>  
					 
					 <td colspan="4"><select name="bt" required>
					 ...
					 <td colspan="4"><input type="text" name="endate" id="datepicker2" placeholder="Select Date" size="15"required></td>  
					 

<td colspan="4"><select name="bt1"required>
...
<td colspan="5" align="Right"bgcolor="lightgreen"><strong>'.$test5.'</strong></td>
<td colspan="5" align="Right"bgcolor="lightgreen"><strong>Vomitus</strong></td>
<td colspan="5" align="Right"bgcolor="lightgreen"><strong>'.$test11.'</strong></td>
</tr>

<tr>

<td colspan="5" align="Right"bgcolor="lightgreen"><strong>IV</strong></td>
<td colspan="5" align="Right"bgcolor="lightgreen"><strong>'.$test4.'</strong></td>
<td colspan="5" align="Right"bgcolor="lightgreen"><strong>NG</strong></td>
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test22.'  </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test33.' </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test009.' </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test44.' </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test55.' </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test66.' </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test77.'</strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test88.' </strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test99.'</strong></td>
...
<td colspan="5" align="right"bgcolor="lightgreen"><strong>'.$test00.' </strong></td>
...
<td colspan="3" align="center"><font size="4.5"><strong>'.$test.' ml</strong></td>
<td colspan="3" align="center"bgcolor="lightblue"><strong>Total Outake</strong></td>
<td colspan="3" align="center"><font size="4.5"><strong>'.$test1.' ml</strong></td>
<td colspan="4" align="center"bgcolor="red"><strong>Difference</strong></td>
<td colspan="4" align="center"><font size="4.5" color="#FF0000"><strong>'.$test3.' ml</strong></td>
</tr>';
}?>
