...
?>
 ...
 $connect = mysqli_connect("localhost", "root", "Godiloveu16", "sfmmkpjnew");  
      ...
      $output = '';  
      $message = '';  
      $sbp = mysqli_real_escape_string($connect, $_POST["temp"]);  
       
      
	  $remarks = mysqli_real_escape_string($connect, $_POST["remarks"]);
	  
	 $id = mysqli_real_escape_string($connect, $_POST["employee_idtemp"]);	
	 $eid = mysqli_real_escape_string($connect, $_POST["eid"]);	
	 $pmrn = mysqli_real_escape_string($connect, $_POST["pmrn"]);	

	 
$query1="update vitalstemp set score1='$sbp',remarks='$remarks',edit_by='$user',edit_time='$dtime' where id='$id'";
