...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('mrd','msuite','mng')"; 
...
$query43 = "SELECT COUNT(dname) FROM m_suite where dname= '$bt' and date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated');"; 
...
$query44 = "SELECT COUNT(dname) FROM m_suite where date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated') ;"; 
...
<h1 align="center">OPD Procedure Stats Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Hospital & Consultant Charge</strong>
	  <th width="14%"><strong>Procedure Note</strong>
...
$sel_query="Select * from m_suite where  date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated')";}
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end;
	 $sel_query="Select * from m_suite where dname='$bt' and date1 BETWEEN '$start' and '$end' and ustatus in ('Paid','Updated') ";
 } 
$count=1;
...
{ ?>    <tr>
	  ...
	  <td colspan="5"><a target='_blank' href="proreport_ms.php?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
      </tr>
