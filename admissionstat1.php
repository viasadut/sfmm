...
if (($_POST['bt'])=="Approved"){
$query43 = "SELECT COUNT(pmrn) FROM preadm where rdate BETWEEN '$start' and '$end' and staff='Staff' and tstatus='Approved';"; 
...
$query44 = "SELECT COUNT(pmrn) FROM preadm where rdate BETWEEN '$start' and '$end' and staff='Staff' and tstatus='Cancelled';"; 
...
<h1 align="center">Admission Request Stat</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>TM Comments</strong>
...
$sel_query="Select * from preadm where staff='Staff' and tstatus='Approved' and rdate BETWEEN '$start' and '$end'order by rdate asc";}
 else{
	 
	 $sel_query="Select * from preadm where staff='Staff' and tstatus='Cancelled' and rdate BETWEEN '$start'and '$end' order by rdate asc";
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["rcom"]; ?>
...
<td colspan="10" align="right"><a target='_blank' href="admissionprint?dname=<?php echo "$bt";?>&date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	      
  </tbody>
</table>
