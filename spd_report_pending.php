...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="15%"><strong>Referral Consultant </strong>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where medi !='OAE HEARING SCREENING TEST' and rstatus='RECEIVED' and status='RECEIVED' and report='' and date1>'2023-04-01' and type in ('spd','spd1') order by id desc;";
...
//$id =$_GET['id'];
//$count=1;
$sel_query="Select * from iinves where infusion !='OAE HEARING SCREENING TEST' and rstatus='RECEIVED' and status='RECEIVED' and report='' and ndate>'2023-04-01' and type in ('spd','spd1') order by id desc;";
...
//$id =$_GET['id'];
//$count=1;
$sel_query="Select * from einves where infusion !='OAE HEARING SCREENING TEST' and rstatus='RECEIVED' and status='RECEIVED' and report='' and ndate>'2023-04-01' and type in ('spd','spd1') order by id desc;";
