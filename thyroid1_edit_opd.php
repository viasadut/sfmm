...
$query5 = mysqli_query($con,"select * from thyroid where pmrn='$pmrn' and sno='$sno'");
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="atpo" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['atpo']?>" required>
            <label for="age"><strong>Anti-Thyoglobulin(Anti-TG):</strong></label>
            <input name="atg" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['atg']?>" required>
