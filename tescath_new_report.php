...
<ul>
   <li><a href='tesrad'><span>Home</span></a></li>
      <li class='active has-sub'><a href='eadmspd'><span>New Patient </span></a></li>
	  <li class='active has-sub'><a href='carmanualsearch'><span>Old Patient</span></a></li>
...
<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>OPD Request</strong></label></td> </tr>	
    ...
    <tr>
      ...
      <th width="14%"><strong>Reprot</strong>
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where date1 between '$test' and '$date' and type='spd1' and status='RECEIVED' and per_doc!='' order by id desc;";
...
//$id =$_GET['id'];
//$count=1;
$sel_query3="Select * from iinves where ndate between '$test' and '$date' and type='spd1' and status='RECEIVED' and per_doc!='' order by id desc;";
...
$sel_query="Select * from einves where type='spd1' and status='RECEIVED' and odate1='$date' and per_doc!='' order by id desc;";
