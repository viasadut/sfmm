...
$ins_query1="insert into pmedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`frequency`,`duration`,`frelation`,`ctaken`,`eid`,`date`) values ('$full','$pmrn','$pname','$medi1','$brand2','$frequency','$duration','$frelation','$ctaken','$eid','$date1')";
...
<td colspan="3" align="center"bgcolor="lightblue"><label><strong>F. Relation</strong></label></td> 
<td colspan="1" align="center"bgcolor="lightblue"><label><strong>Continue</strong></label></td> 


</tr>
<tr><td colspan="10"><input list="browsers131" name="medi1" class="form-control"size="70">
...
?> 
		...
		<datalist id="browsers11"name="bno" class="state" value=''required>
		<option selected value="PPP">PPP</option>
		</datalist></td>

		<td colspan="3"><input list="browsers111" name="duration" class="statel" value="" size="20">
		<datalist id="browsers111"name="bno2" class="state1" value=''required></datalist></td>
		
			
	<td colspan="3"><input list="browsers114" name="frelation" class="state2" value="" size="20">
		<datalist id="browsers114"name="bno25" class="state2" value=''required></datalist></td>
