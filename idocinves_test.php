...
$query6 = mysqli_query($db,"select * from user where uname='$user'");
$data1 = mysqli_fetch_assoc($query6);
$d_name=$data1['fullname'];  
?>
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right" style="font-size:22px; font-weight:bold;"><a href='idocdetails?pmrn=<?php echo $pmrn;?>&eid=<?php echo $eid;?>&id=<?php echo $did;?>&dname=<?php echo $full;?>'>Back</a></td></tr>
...
<tr>
		...
		<td colspan="20"align="right"><button type="submit" name="Submit">Confirm</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="Submit1_a">ADD SET</button></td>
...
$strSQL = "Select * from iinves where pmrn= '$pmrn' and eid='$eid'and rstatus ='Ordered' order by `id` DESC;";
...
<tr>
 ...
 <td align="center" colspan="2"><a href="delete1iinvesimodoc?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>  	  
...
<td align="center" ><input type="checkbox" name="chkDel[]" id="chkDel<?php echo $i;?>" value="<?php echo $row["id"];?>"></td>
 ...
 $count++;}
?>
<tr><td colspan="22" align="right"><button type="submit" id="btnDelete" name="btnDelete">Delete</button><input type="hidden" name="hdnCount" value="<?php echo $i;?>"></td>
</tr>
