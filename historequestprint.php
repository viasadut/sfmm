...
<ul>
   ...
   <li><a href='histomrndoc'><span>View Done Reports</span></a></li>
...
{ ?>    <tr>
      ...
      <td colspan="1"align="center"><?php echo $row["pphone"]; ?> </td>
	   <td colspan="10"><a target='_blank' href="historeq.php?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&dname1=<?php echo $row["dname"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
