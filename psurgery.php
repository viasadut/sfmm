...
$ins_query="insert into pastsurgery (`dname`,`pmrn`,`pname`,`ins`,`date`) values ('$full', '$pmrn','$pname','$pins','$date')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Past Surgery History</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from pastsurgery where pmrn= '$pmrn' order by `id` DESC;";
