...
$sql = "insert into prohoscharge (`dname`,`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`type`,`ieid`,`code`,`qty`,`ins`,`price`,`ip`,`op`,`acct_code`,`ccentre`) values 
('$full','$pmrn','$pname','$medi1','$eid','$date1','$pdos','$type','$ieid','$code','$price','$btype','$tprice','$ip','$op','$acct_code','$ccentre')";
...
values ('$last_id','CR','$tb_data','$date','$tprice','OPD PROCEDURE')";
...
$(document).ready(function() {
    $('.con_charge1').select2();
			...
			<td  colspan="5"align="center"><input list="browsers11" name="pdos" class="form-control" type="number" required>
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="prohosdelete1?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo "$dname"; ?>&eid=<?php echo "$eid"; ?>&ID=<?php echo "$id"; ?>&ieid=<?php echo "$ieid"; ?>&type=<?php echo "$type"; ?>&pdos=<?php echo $row["pdos"];?>&admission_no=<?php echo $api_adminssion_no;?>&invoice_no=<?php echo $row['invoice_no'];?>&code=<?php echo $row['code'];?>&price=<?php echo $row['price'];?>">DELETE</a></td>
