...
$query = mysqli_query($db,"select * from discharge1 where pmrn='$pmrn' and eid='$eid'");
...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers:  Ambulance:  +880244077029, +8801791987466, Appointments: +880244077030, +8801703788561 (SFMMKPJSH/A&E/MR-02)',0,0,'C');
...
$pdf->ln(5);
$pdf->SetFont('Arial' , 'b' , 12);
$pdf->Cell('60',5,'Consultant(s) Involed:',0,0,'L');
$pdf->Cell('70',5,$data['dname'],0,0,'L');

//$pdf->Image('1001.jpg',173,39);
$pdf->ln(8);
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'History Of Present Illness:',0,1,'L');
$pdf->SetFont('Arial' , '' , 10);
...
$pdf->ln(3);
$query1 = mysqli_query($db,"select * from dismedi where pmrn='$pmrn'and eid='$eid'");
...
$pdf->MultiCell('182' , 5,$data1['pdos'].','.$data1['duration'].','.$data1['ins'],0,1);
$pdf->ln(1);
}
...
$pdf->ln(3);
$query11 = mysqli_query($db,"select * from dinves where pmrn='$pmrn'and eid='$eid'");
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'EMO / Consultants Signature:',0,1,'R');
