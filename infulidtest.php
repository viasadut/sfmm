...
if (!empty($_POST['rr2']) && !empty($_POST['rr3'])){
$ins_query6="insert into influid (`date`,`type`,`route`,`time`,`qty`,`pmrn`) values ('$rr1','Intake','$rr3','$rr2','$rr4','$pmrn')";
mysqli_query($con,$ins_query6) or die(mysql_error());}

else if (!empty($_POST['rr2']) && !empty($_POST['rr5'])){
$ins_query6="insert into influid (`date`,`type`,`route`,`time`,`qty`,`pmrn`) values ('$rr1','Outtake','$rr5','$rr2','$rr4','$pmrn')";
mysqli_query($con,$ins_query6) or die(mysql_error());}
...
$query298 = "SELECT type, SUM(qty) FROM influid where date='$date' and type='intake'GROUP BY type"; 
...
$row298 = mysql_fetch_array($result298);
	...
	$test=$row298['SUM(qty)'];
$query198 = "SELECT type, SUM(qty) FROM influid where date='$date' and type='Outtake 'GROUP BY type"; 
...
$count=1;
$sel_query="Select * from influid where pmrn= '$pmrn' and date='$date';";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="3"><?php echo $row["date"]; ?></td>
	  <td align="center"colspan="3"><?php echo $row["type"]; ?></td>
      <td align="center"colspan="3"><?php echo $row["pmrn"]; ?></td>  
	  <td align="center"colspan="5"><?php echo $row["time"]; ?></td>
	  <td align="center"colspan="5"><?php echo $row["route"]; ?></td>
