...
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`aatime`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$page','$psex','$user','$aatime')";
mysqli_query($con,$ins_query)or die("Unsuccessful...Pls dont use apostrophe");;
  ...
  <script type="text/javascript">
	jQuery(function() {		
		...
		$('#datepicker').datepicker({
			...
			maxDate: new Date(currentYear, currentMonth, currentDate+70)
		});
	});
</script>
