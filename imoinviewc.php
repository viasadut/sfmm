...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from inpatient where discharge NOT IN('Discharged','Death') order by room asc";

$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      <td align="center"><?php echo $count; ?></td>
      <td align="center"><a href="imoidetails?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>"><?php echo $row["pname"]; ?></a></td>
