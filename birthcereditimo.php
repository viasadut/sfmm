...
$ins_query="update birth set pmrn='$pmrn',idate='$bdate1',bname='$bname',fname='$fname',mname='$mname',sex='$sex',weight='$weight',bdate='$bdate',btime='$btime',dname='$dname',eby='$fullname',year='$year',bdate1='$bdate1',rdate='$rdate',dname1='$dname1',iby='$iby'";
mysqli_query($con,$ins_query) or die(mysql_error());


  echo '<script language="javascript">';
    echo 'alert("Birth Certificate Successfully Edited !!"); ';
    echo '</script>';
...
<label for="age"><strong>Patient's Details (MRN/Gender) :</strong></label>
	  ...
	  <input name="sex" type="text" size="15" value="<?php echo $row3["sex"]; ?>"readonly/>
...
<td colspan="20" align="right"><a target='_blank' href="birthprinteditimo.php?pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
