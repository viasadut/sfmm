...
$ins_query="insert into bbhistory (`dname`,`pname`,`pmrn`,`psex`,`pdate`,`ptime`,`bweight`,`busg`,`bgroup`,`mbirth`,`a1`,`a2`,`a3`,`p1`,`p2`,`p3`,`g1`,`g2`,`g3`,`aa1`,`aa2`,`aa3`,`r1`,`r2`,`r3`,`mhistory`,`pre`,`h1`,`h2`,`h3`,`h4`,`a4`,`p4`,`g4`,`aa4`,`r4`) values
('$full','$pname','$pmrn','$psex','$bdate','$btime','$bweight','$busg','$bgroup','$mbirth','$a1','$a2','$a3','$p1','$p2','$p3','$g1','$g2','$g3','$aa1','$aa2','$aa3','$r1','$r2','$r3','$mhistory','$pre','$h1','$h2','$h3','$h4','$a4','$p4','$g4','$aa4','$r4')";
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><h2><a href="bbhistory?pmrn=<?php echo "$pmrn"; ?>">ADD BIRTH HISTORY</a></td></tr>
				<tr>
...
<tr><td colspan="10"><a target='_blank' href="bhistoryprint.php?pmrn=<?php echo "$pmrn"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr>
</table>
</body>
