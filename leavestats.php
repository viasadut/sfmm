...
$query43 = "SELECT COUNT(sid) FROM conleavedetails where sid= '$user' and status='Approved By ALL' and sdate BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from conleavedetails where sid= '$user' and status='Approved By ALL' and sdate BETWEEN '$start' and '$end' order by id desc;"; 
