...
{
$url = "preeditgm?pmrn=$pm&eid=$eid1&dname=$pd&date=$dt1&id=$id1&ID=$id";
header("Location: $url");
}
?>
<!DOCTYPE html>
...
<td colspan="5"><a target='_blank' href="p4new.php?pmrn=<?php echo "$pm"; ?>&dname=<?php echo "$pd"; ?>&date=<?php echo "$dt1"; ?>&eid=<?php echo "$eid1"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>						
