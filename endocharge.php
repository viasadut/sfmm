...
$query = mysql_query($db,"SELECT * FROM endocharge1 where groupid='$eitem'") or die(mysql_error());
...
//$ins_query="insert into endocharge (`pmrn`,`eid`,`eitem`,`qty`) values ('$pmrn','$eid','$eitem','$qty')";
...
<tr>
<td colspan="10" align="center"><input list="browsers111" name="eitem" size=60% class="form-control" required/>
  <datalist id="browsers111">

						<option value=''>-Select Medicine</option>
				<?php 
			$sql = "select distinct groupid from `endocharge1`";
...
<td  colspan="10"align="center"><input list="browsers11" name="qty" class="form-control">
