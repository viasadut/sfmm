...
<?php 
$dd= date('m/d/Y',strtotime("-2 days")); 
$pmrn=$_REQUEST["pmrn"];
$eid=$_REQUEST["eid"];
?>
...
<h1 align="center">Day Before Yesterday's Medicine</h1>
...
$count=1;
$sel_query="Select * from imedi2 where pmrn= '$pmrn' and eid='$eid' and odate ='$dd';";
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="1"><a onclick="return confirm_click();" href="inmediadd?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&time=<?php echo $row["time"]; ?>&instruc=<?php echo $row["instruc"]; ?>&orderby=<?php echo $user; ?>&root=<?php echo $row["root"]; ?>&alert=<?php echo $row["alert"]; ?>">ADD</a></td>
      </tr>
