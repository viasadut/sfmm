...
$query2 = "SELECT * from inpatient where pmrn='$pmrn' and eid='$eeid'"; 
...
values('$dname','$select','$pmrn','$pname','$page','$psex','$pphone','$ron','$vent','$qwave','$arate','$st','$rhy','$twave','$pwave','$qt','$pr','$qtc','$qrs','$uwave','$qrsc','$ebeats','$qrsvol','$others','$eaxis','$poro','$comments','$count1','$date1','$date2','$stime','Updated','IPD','$datenew')";
...
//$id1=$_REQUEST['ID'];
//$url = "tescath";
$query90 = "UPDATE iinves set rby='$fullname',rtime='$dtime',rstatus='RECEIVED' where id='$id'"; 
...
<!-- Form Title -->
		...
		<tr><td align="right" colspan="20"><a target='_blank' href="viewradrecord?pmrn=<?php echo "$pmrn"; ?>&dname=<?php echo $row['dreffer'];?>"><b>See Clinical Details<b></a></td></tr>
				...
				<td colspan="10" ><input type="text" name="dname"  required value="<?php echo $row2['adoc'];?>" readonly/></td>
