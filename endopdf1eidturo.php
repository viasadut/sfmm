...
$query = mysqli_query($db,"select * from endoreport where id='$id' ");
$data = mysqli_fetch_array($query);

$queryn = mysqli_query($db,"select * from endopapp where id='$id'");
...
$query11 = mysqli_query($db,"select * from endoreport where id='$id'");
...
$pdf->Cell('70',5,'',0,0,'L');
$pdf->MultiCell('112' , 5,'Comments:'.$data11['report'],0,0);
