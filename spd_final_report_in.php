...
$query43l = "SELECT COUNT(id) FROM ecg_test where lid= '$lid';"; 
...
{
$ins_query_format="insert into spd_report_format (`dname`,`dcode`,`inves`,`add_by`,`add_time`,`status`,`type`,`iname`,`ieid`) 
values ('$full', '$fullname','$cdetails','$fullname','$add_time','Active','$type','$ptemp','$ieid')";
mysqli_query($con,$ins_query_format);




$ins_query="insert into ecg_test (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`details`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`,`datenew`,`ron`,`lid`,`r_u_by`,`r_u_t`,`upload`,`pic_upload`) 
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$cdetails','$count2','$date1','$date2','$stime','Updated','IPD','$date_d','$inves','$lid','$user','$add_time','$upload','$upload_by')";
mysqli_query($con,$ins_query);

$update="update iinves set status='Updated', report='$plaintext' where `id`='$id'";
mysqli_query($con,$update);

$ins_query="insert into ecg_test1 (`dname`,`dname1`,`pmrn`,`pname`,`page`,`psex`,`pphone`,`details`,`eid`,`date1`,`date2`,`stime`,`status1`,`location`,`datenew`,`ron`,`lid`,`r_u_by`,`r_u_t`,`upload`,`pic_upload`) 
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$cdetails','$count2','$date1','$date2','$stime','Updated','IPD','$date_d','$inves','$lid','$user','$add_time','$upload','$upload_by')";
mysqli_query($con,$ins_query);
...
values('$dnam','$dname','$pm','$pn','$pa','$ps','$pp','$cdetails','$count2','$date1','$date2','$stime','Updated','IPD','$date_d','$inves','$lid','$user','$add_time')";
mysqli_query($con,$ins_query);
