...
//$pmrn=$_REQUEST['pmrn'];
$bid=$_REQUEST['id'];
$query43 = "SELECT COUNT(id) FROM bed_photo where bid= '$bid';"; 
...
<div class="container">
    ...
    <h3>Bed ID: <?php echo $bid?></h3>
    <form action="bedupload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
			...
			<input type="hidden" name="eid" value="<?php echo $bid; ?>">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from bed_photo where bid='$bid';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="bedpic/<?php echo $image['image'] ?>">
                        <img class="img-responsive" alt="" src="bedpic/<?php echo $image['image'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['image'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="bed_delete.php" method="POST">
