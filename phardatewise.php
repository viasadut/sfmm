...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					...
					<tr><td colspan="20"><label><strong><a href="addpharmedi?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">Tomorrow's Medicine</a></strong></td></tr>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <th width="10%"><strong>Served User</strong>
    <th width="10%"><strong>Served Time</strong>
...
{ ?>    <tr>
    ...
    <td align="center"><?php echo $row["puser"]; ?>  
