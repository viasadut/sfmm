...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><h1 style="color:red"><strong>Outstadning Report</strong></h1></label></td> </tr>
...
';
                    ...
                    $query = "Select * from pms_bill where date between '$start' and '$end' and amount>(amount_receive+dis_amount) and dname !='IPD ADVANCE' and amount!='0' order by user";
