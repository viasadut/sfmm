...
/*$dateb='1985-06-16';
$datebb='2020-06-16';
$date1=date_create($dateb);
$date2=date_create($datebb);
...
$query = mysqli_query($db,"select * from iinves where id='$id'");
...
$query3 = mysqli_query($db,"select * from patient where pmrn='$pmrn'");
$data3 = mysqli_fetch_array($query3);
$bdate=date_create($data3['bdate']);
$ordate=date_create($data['ndate']);
$diff=date_diff($ordate,$bdate);
$diff1= $diff->format("%y");
...
if($diff1>30 && $data['result']>15 &&$data['pgender']=='M'){
	$pdf->SetFont('Arial' , 'b' , 10);
