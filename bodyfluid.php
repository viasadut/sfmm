...
$rr='Protein, Serous Fluid- :'.$chikun1."<br />".'Glucose, Serous Fluid:'.$chikun2;

$rr1='Protein, Serous Fluid- :'.$chikun1.' '.'g/L'."<br />".'Glucose, Serous Fluid:'.$chikun2.' '.'mmol/L';
...
$ins_query1="insert into bfluid (`pname`,`pmrn`,`psex`,`page`,`psf`,`gsf`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
		<h1>Body Fluid For Biochemical Analysis </h1>
	  ...
	  <label for="iron"><strong>Protein, Serous Fluid</strong></label>
      <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="tibc"><strong>Glucose, Serous Fluid</strong></label>
