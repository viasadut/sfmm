...
<?php
$full = $row39['fullname'];
$querymax = "SELECT max(pvno) FROM endopapp"; 
...
$update212="update preadm set pvno='$pvno',pvdate='$pvdate',chno='$chno' where `id`='$id'";
mysqli_query($con,$update212);

$update22="update inpatient set pvno='$pvno',pvdate='$pvdate',chno='$chno' where `pmrn`='$pmrn' and eid='$eid1'";
...
<input type="text" name="aldate" id="" placeholder="MM/DD/YYYY" size="15" value="<?php echo date('d/m/Y',strtotime($ddate));?>" required readonly>

<label for="age"><strong>Payment Voucher NO :</strong></label>
<input name="pvno" type="text" size="70" value="<?php echo $max;?>"  required readonly>		<b>	  
...
<input name="chno" type="text" size="70" value="<?php echo $data444['chno'];?>" required >		<b>	  
