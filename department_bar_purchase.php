...
$query1 = mysqli_query($db,"select * from purchase_stock where id='$id'");
...
$pdf->SetFont('Arial' , '' , 4.5);
if($data1['location1']==''){
$pdf->Cell('5',1,$data1['location'].'-'.$data1['code'],0,1,'L');}

else{
$pdf->Cell('5',1,$data1['location1'].'-'.$data1['code'],0,1,'L');}
$pdf->SetXY(1,5);
$pdf->SetFont('Arial' , '' , 4.5);
