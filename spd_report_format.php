...
<table width="100%" height ="100%" border="1" align="left" bgcolor="#FFFF99" style="border-collapse:collapse;">
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from spd_report_format where status='Active';";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td ><a target='_blank' href="spd_format_pdf.php?id=<?php echo $row["id"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&ac_no=<?php echo $row["lid"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
<td align="center"><a onclick ="return confirm_click();" href="spd_report_delete?id=<?php echo $row['id']; ?>&user=<?php echo $fullname; ?>">Delete</a></td>
      </tr>
    <?php $count++; } ?>
