...
$queryn = mysqli_query($db,"select * from user where uname='$user'");
$datan = mysqli_fetch_assoc($queryn);
$fname=$datan['fullname'];
...
<!-- Form Title -->
		...
		<tr><td colspan="20" align="right"><a href='idocdetails?pmrn=<?php echo $pmrn;?>&eid=<?php echo $eid;?>&dname=<?php echo $adoc;?>'>Back</a></td></tr>
...
<td colspan="8" align="center"><input list="browsers1" name="infu"  class="form-control">
  ...
  <datalist id="browsers4">
				 ...
				 <td colspan="4" align="center"><textarea rows="5"  name="rnote" required value=""></textarea></td>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Referral Date  </strong></td>
      <td colspan="2" align="center"><strong>Referred To</strong></td>
      <td colspan="2" align="center"><strong>Referral Mode</strong></td>  
	  <td colspan="2" align="center"><strong>Referral Type</strong></td>   
      <td colspan="4" align="center"><strong>Referral Note</strong></td>
	  <td colspan="2" align="center"><strong>Referral Status</strong></td>
...
{ ?>    <tr>
     ...
     <td align="center"colspan="1"><?php echo $row["pmrn"]; ?></td>
       <td align="center"colspan="3"><?php echo $row["user"]; ?></td>
...
<td align="center"colspan="2"><?php echo $row["bed"]; ?></td>	  
      ...
      <td align="center"colspan="4"><?php echo $row["rnote"]; ?></td>
	  <td align="center"colspan="2"><?php 
    if($row["cstatus"]=='Cancel'){
    echo '<span style="color:red;font-weight:bold;">'.$row["cstatus"].'</span>'
    
    ;} 
    
    else{
      echo '<span style="color:green;font-weight:bold;">'.$row["cstatus"].'</span>';
    ...
    $eee=$row['eid'];
	  ...
	  $url4="can_refer?id=$id&pmrn=$ppp&eid=$eee";
	  ?>
	  
	  
	  
	   <td align="center"><?php 
     if($fname==$uu and $row['cstatus']!='Cancel'){echo"<a onclick='return confirm_click();' href='$url4'><strong>Cancel</strong></a>";}
     else if($fname==$adoc and $row['cstatus']!='Cancel'){echo"<a onclick='return confirm_click();' href='$url4'><strong>Cancel</strong></a>";} 
     else {echo '';}?></td>
