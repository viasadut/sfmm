...
<div class="container">
    <div class="row">
        ...
        <?php
			...
			$query_eye = "SELECT SUM(tprice),location,r_by,adate FROM purchase_sale where sno= '$sno';"; 
			...
			$aby1=$row_eye['r_by'];
			$adate1=date('d/m/Y',strtotime($row_eye['adate']));
			
			
			$query_eye1 = "SELECT * FROM user where uname= '$aby1';"; 
            $result_eye1 = mysqli_query($con, $query_eye1) or die(mysqli_error());
            $row_eye1 = mysqli_fetch_assoc($result_eye1);
            $aby=$row_eye1['fullname'];
                ...
                $output .='<br><br><br>
                        <table width="100%">
                            <tr>
								...
								<td width="55%" align="left"><b>Disposable</b></td>
                ...
                $query1 = mysqli_query($con,"select * from purchase_sale where sno='$sno' order by id asc");
                $count=1;
...
<br><br><br><p align="left"><b>Received By</b></p>			';
            $mpdf = new \Mpdf\Mpdf([
                // 'default_font' => 'bangla',
                'default_font' => 'Roboto',
                'default_font_size' => 9,
            ...
            $mpdf->SetHTMLHeader('
                ...
                <table width="100%">
                    <tr>
                        <td width="23%"></td>
                        <td width="67%"><b><h1 align="laft">STORE & PURCHASE DEPARTMENT</h1> </b></td>
               ...
               <br>
                <table width="100%">
					...
					<tr>
                        <td width="30%" ><h2 align="laft"><b>DEPARTMENT:</b></h2></td>
                        <td width="70%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$row_eye['location'].'</h2></b></td>
                    </tr>
					
					<tr>
                        <td width="30%" ><h2 align="laft"><b>REQUEST BY:</b></h2></td>
                        <td width="70%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$aby.'</h2></b></td>
                    </tr>
					
					<tr>
                        <td width="30%" ><h2 align="laft"><b>Date:</b></h2></td>
                        <td width="70%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$adate1.'</h2></b></td>
                    </tr>
