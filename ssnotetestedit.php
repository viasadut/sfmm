...
$query44 = mysqli_query($db,"select * from otreport where id='$id1'");
$data4 = mysqli_fetch_assoc($query44);
$sreporte=$data4['sreport'];
$pnamee=$data4['pname'];
$others=$data4['others'];
$charge=$data4['charge'];
...
$others = $_REQUEST['otherins'];
$charge1 = $_REQUEST['charge1'];
$adate1= date('d/m/Y H:i:s');
$proname = $_REQUEST['proname11'];

$ins_query="update otreport set sreport='$sreport',pname='$proname',eby='$full',etime='$adate1',others='$others',charge='$charge1' where id='$id1'";
mysqli_query($con,$ins_query) or die(mysql_error());

$ins_query66="update otivisitendo set room='$charge1' where pmrn='$pmrn' and eid='$id' and vtype='$proname'";
...
<td colspan="15" align="center"><label><strong>Doctor's Note</strong></label></td> 
<td colspan="5" align="center"><label><strong>Investigation/Treatment Plan</strong></label></td></tr>
...
<tr><td colspan="20"><input list="proname11" name="proname11" class="form-control" value="<?php if(isset($_POST['load'])==1)
...
}else {echo $pnamee;}?>" autocomplete="off">
...
<tr><td colspan="20"><input type="text" name="otherins" value="<?php echo $others;?>" ></td>	 </tr>
<tr>
<td colspan="20" align="center"><textarea rows="40"  name="sreport" required><?php if(isset($_POST['load'])==1){echo $data45['sformat'];}else {echo $sreporte;}?></textarea></td>

</tr>
<tr><td colspan="20" align="left"bgcolor="lightgreen"><label><strong>Charge</strong></label></td> </tr><tr>
<td colspan="20" ><input type="text" name="charge1" readonly required value="<?php if(isset($_POST['load'])==1){echo $data45['charge'];}else {echo $charge;} ?>"></td>
</tr>
