...
if(isset($_POST['Submit'])){
	...
	$sel_attendant_rfid     = "SELECT COUNT(`id`) FROM `rfid` WHERE  `rfid`='$attendant_rfid' AND `status`='0' AND `use_for`='Visitor Card' ";
...
*/
	...
	// }
		...
		if ($patient_rfid_count==1 && $attendant_rfid_count==1 &&  $visitor_rfid_count==1 ) {
			...
			$ins_query33="insert into inpatient (`adoc`,`pname`,`pmrn`,`padd`,`gender`,`age`,`bdate`,`adate`,`room`,`room1`,`eid`,`pphone`,`aadate`,`card2`,`acard`,`type`,`anew`,`yage`,`emerid`,`alert1`,`alert2`,`rfid`)
			values ('$dname', '$pname','$pmrn','$padd','$gender','$diff1','$date91','$adate','$btype','$bno','$count1','$pphone','$aadate','$visitor_rfid','$attendant_rfid','$staff','$anew','$diff2','$eeid','$ad','$ad1','$patient_rfid')";
