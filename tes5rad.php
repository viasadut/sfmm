...
$query43 = "SELECT COUNT(rstatus) FROM presnew where rstatus= '$bt' and date BETWEEN '$start' and '$end';"; 
...
<ul>
   <li><a href='tesrad'><span>Home</span></a></li>
      ...
      <ul>
		 ...
		 <li class='has-sub'><a href='tes5rad'><span>Prescription Status Wise Report </span></a>
            
         </li>
         <li class='has-sub'><a href='tes6rad'><span>Consultant Wise Report</span></a>
...
</div><h1 align="center">Number of Radiology Test request SERVED  </h1>
...
<form action="tes5rad" method="POST">
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
					 ...
					 <td colspan="3"><select name="bt">
						...
						<option value=''>Not Served</option>
...
$count=1;
$sel_query="Select * from presnew where rstatus='$bt' and date BETWEEN '$start' and '$end';";
...
<?php	  $date=$row["date"] ;?>
    ...
    <?php $count++; } }?>
      ...
      <td colspan="10" align="right"><a target='_blank' href="pp?status=<?php echo "$bt";?>&date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
  </tbody>
</table>
