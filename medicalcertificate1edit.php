...
$sel43="SELECT * FROM mcertificate WHERE `id`='$id' ;";
...
$ins_query="update mcertificate set `nid`='$passno',`nid1`='$passno1',`ffor`='$ufor',`fdate`='$fdate',`fdate1`='$fdate1',`tdate`='$tdate',`tdate1`='$tdate1',`rdate`='$rdate',`rdate1`='$rdate1',`tdays`='$e',`diagnosis`='$diag',`staff`='$staff' where id='$id'"; 
mysqli_query($con,$ins_query) or die(mysql_error());


  echo '<script language="javascript">';
    echo 'alert("Medical Certificate Successfully Updated !!"); ';
echo '</script>';
...
<!-- Form Title -->
		<h1>Medical Certificate (Issue UNFIT Certificate) </h1>
...
<label for="name"><strong>Paients Identify:</strong></label>
			<select name="staff" value="" required>
			        <option value='<?php echo $row3["staff"]; ?>'selected ><?php echo $row3["staff"]; ?></option>
      ...
      <select name="passno" value="" required>
			        <option value='<?php echo $row3["nid"]; ?>'selected ><?php echo $row3["nid"]; ?></option>
					<option value='IC NO' >IC NO</option>
					<option value='Passport NO' >Passport NO</option>
					<option value='NID NO'>NID NO</option>
      ...
      <textarea rows="5"  name="diag" required value=""><?php echo $row3["diagnosis"]; ?></textarea>

		
			<label for="name"><strong>Unfit For:</strong></label>
			<select name="ufor" value="<?php echo $row3["ffor"]; ?>" required>
			        <option value='<?php echo $row3["ffor"]; ?>'selected ><?php echo $row3["ffor"]; ?></option>
					<option value='Duties'>Duties</option>
					<option value='Attend School' >Attend School</option>
		...
		<label for="mail"><strong>From :</strong></label>
									<p>
									  <input type="text" name="fdate" id="datepicker" placeholder="Select Date" size="15" value="<?php echo $row3["fdate"]; ?>">
									  
									  
									  <label for="mail"><strong>TO :</strong></label>
									<p>
									  <input type="text" name="tdate" id="datepicker1" placeholder="Select Date" size="15" value="<?php echo $row3["tdate"]; ?>">
									  
									  
									  <label for="mail"><strong>Re-Examination Date :</strong></label>
									<p>
									  <input type="text" name="rdate" id="datepicker2" placeholder="Select Date" size="15" value="<?php echo $row3["rdate"]; ?>">
...
<td><a target='_blank' href="printmcedit.php?id=<?php echo "$id"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  
</form>
