...
<form>
<h1 align="center" style="background-color:lightgreen;text-align:left"><a href='po_approval_pin' >Purchase</a>&nbsp;&nbsp;&nbsp;<a href='po_approval_pin_phar' style="color:red">Pharmacy</a></h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>PO Type</strong></th>
...
$sel_query="Select * from po_table where status='FORWARD FOR CEO APPROVAL' and '$user' in ('md','md01') and po_type='Pharmacy' ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row['po_type']; ?></td>
...
<a href="po_prepare_mng_pin?ono=<?php echo $ono1; ?>">View/Edit</a>


</td>
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold">
       <input type="button" name="edit" value="Approve" id="<?php echo $row["id"];?>" class="btn btn-info btn-xs edit_data">
     </td>
...
$sel_query="Select * from po_table where status='FORWARD FOR APPROVAL' and '$user'='1601' and po_type='Pharmacy' ORDER BY id asc;";
...
<a href="po_prepare_mng_pin?ono=<?php echo $encryption; ?>">View/Edit</a>


</td>
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><input type="button" name="edit" value="Approve" id="<?php echo $row["id"];?>" class="btn btn-info btn-xs edit_data"></td>
	  
	  <td align="center"><a onclick="return confirm_click2();" href="po_reject_con?id=<?php echo $row["id"]; ?>"><strong>Reject</strong></a>
 ...
 <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title"align='center'>Approve PO</h4>  
                </div>  
