...
<br><span style="color:black;font-size:28px;text-align:center;font-weight:bold"><a target='_blank' href='phar_opd_opd'>(<?php echo $row_opd['COUNT(distinct(pmrn))'];?>)</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a href="phar_out_new_bill1_test_opd?sno=<?php echo $runningTime;?>">OPD Sale</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_scan_opd">Scan Prescription</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_scan_return_opd">Return Medicine(OPD)</a></span>
...
<br><span style="color:black;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_stock_view_opd">Real Time Stock(OPD Pharmacy)</a></span>
...
<br><span style="color:black;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_stock_view_all_opd">Real Time Stock(All)</a></span>
...
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_opd_dispense_opd">Dispense Medicine</a></span>
...
<span><img src='phar_pic/return.png' title='Add_Stock' height='60' width='75'align='center'></span>
<br><span style="color:red;font-size:22px;text-align:center;font-weight:bold"><a target='_blank' href="phar_transfer_phar_opd?sno=<?php echo $runningTime;?>">Request OPD Pharmacy Stock</a></span>
