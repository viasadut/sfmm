<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('clinicalgp','clinicalmedi','clinicalcardio','clinical','clinicalet','staff')"; 
...
$update33="update pappnew set `height`='$pheight',`weight`='$pweight',`temp`='$ptemp',`pbp`='$pbp',`phyper`='$phyper',`ppluse`='$ppluse',`pheart`='$pheart',`pdm`='$pdm',`pkid`='$pkid',`ptb`='$ptb',`pasthma`='$pasthma',`pthyroid`='$pthyroid',`pneuro`='$pneuro',`psurgery`='$psurgery',`pperiod`='$pperiod',`plmp`='$plmp',`pnochild`='$pnochild',`plchild`='$plchild',`palcohol`='$palcohol',`psmoking`='$psmoking',`pfamily`='$pfamily',`pdrug`='$pdrug',`mstatus`='$pmstatus',`occupation`='$poccupation', `status`='HISTORY UPDATED',`spo2`='$spo2',`rr`='$rr',`liver`='$liver',`para`='$para',`clist`='$clist',`gravida`='$gravida',`vby`='$user',`vtime`='$vtime',`pbp1`='$pbp1',`hwc`='$hwc',`hhc`='$hhc',fever='$fever' where `ID`='$id' and status !='SEEN'";
...
<!-- Form Title -->
    ...
    <h3 style="color:red;font-weight:bold;text-align:right"><a target='_blank' href="idocinvesstat?pmrn=<?php echo $pmrn;?>"style="color:red">Update Outside Investigation History</a></h1>
...
<br><br>
 ...
 <b><span style="color:red;font-weight:bold;font-size:22px;">Fever In Last 7 Days ??? : <input type="radio" name="fever" value="YES" required style="width: 20px;height: 20px;order: 2px solid #999;border-radius: 50%;"> YES <input type="radio" name="fever" value="NO" required style="width: 20px;height: 20px;order: 2px solid #999;border-radius: 50%;"> NO </span>
