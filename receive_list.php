...
$sel_query="Select * from storenew where estatus= 'Active' and elocation_s='BioMedical' and trans_to in ('ICU','CCU','WARD','LAB','RADIOLOGY') ORDER BY id asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["p_by"]; ?>
	        ...
	        <td><a target='_blank' href="receive_by.php?id=<?php echo $row['id']; ?>">Receive</a></td>	
