...
$strSQL = "Select * from einfusion where pmrn= '$pmrn'and eid='$eid' and status='Rupdated'order by `id` DESC;";
...
<tr>
	  ...
	  $ii=$row['id'];
	  $query44 = "SELECT COUNT(pstatus) FROM einfusion where id= '$ii' and pstatus='ordered' and status1 !='Cancel';"; 
...
$url8 = "inurseinfusion_new1?pmrn=$pm&eid=$ed&id=$idd&mcode=$cc&rf=$rf"; 
?>
...
$count=1;
$sel_query="Select * from einfusion where pmrn= '$pmrn'and eid='$eid' order by `id` DESC;";
...
//var tt=document.getElementById("address1").innerHTML;
  ...
  <datalist id="stock">
				...
				<?php 
			$sql76 = "select * from `medi_stock` where location='AE' and add_qty!='0' and status='Served'";
 ...
 $(document).ready(function(){  
      ...
      $('#insert_form7').on("submit", function(event){  
           ...
           {  
          $.ajax({  
                     url:"edit_update_nurse1_infu_ae.php",  
                     method:"POST",  
