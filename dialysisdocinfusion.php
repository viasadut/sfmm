...
$ins_query="insert into dialysisinfusion (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`alert`,`status1`,`odate1`,`otime`,`addi`,`otime1`,`infu1`,`add1`,`qty1`,`qty2`,`pstatus`,`ortime`) 
...
{
return confirm("Are You Sure The Infusion Is Given ?");
}
...
<td colspan="1" align="center"><strong>Given</strong></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from dialysisinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status1='Active' and status='Data Updated' order by `ddate` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="dialysisinfugiven?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Given</a></td>
	  
      </tr>
    <?php $count++; } ?>
	
	
<tr><td colspan="20"><b> Given Infusion List<b></td></tr>	
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from dialysisinfusion where pmrn= '$pmrn'and eid='$episode'and odate='$ad' and status='Given' order by `ddate` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row["duser"]; ?></td>
  	  ...
  	  <td align="center"colspan="1"<?php if($row['alert']== "H. Alert"): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightblue;" <?php endif ; ?>>
        <?php echo $row['alert'];?></td>
<td align="center" colspan="1">Already Given</td>
