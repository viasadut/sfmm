...
$sel14=mysqli_query($db,"SELECT * FROM alltest WHERE `id`='$updateid';");
...
$ccentre=$result1["ccentre"];
			...
			if($eqty2 >0)
	{
						...
						$strSQL1 = "update alltest set billstatus='Billed', billby='$user', billdate='$pdate',barcode1='$bar',barcode='$bar',billtime='$pdate1',ip='$ip',op='$op',acct_code='$acct_code',ccentre='$ccentre' where id='".$updateid."'";
...
<head>
  <meta charset="UTF-8">
  <title>OPD Investigation Portal</title>
