...
$ins_query="insert into fnac (`dname`,`pname`,`pmrn`,`padd`,`gender`,`page`,`pphone`,`cfind`,`rfor`,`guide`,`remarks`,`adate`,`adate1`) values 
('$doc','$pname','$pmrn','$padd','$psex','$page','$pphone','$diagnosis','$rfor','$guide','NOT SEEN','$adate','$adate1')";
