...
$objDB = mysql_select_db("sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			$strSQL = "UPDATE istat set pstatus='Served', puser='$user', pdate='$pdate' ";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Ordered Stat Medicine List</strong></label></td> </tr>



		<td colspan="20"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Medicine List)<b></a></td>
...
$objConnect = mysql_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysql_select_db("sfmmkpjnew");
$strSQL = "Select * from istat where pmrn= '$pmrn' and eid='$eid'and odate1='$dd' and status1='Active'and pstatus='Ordered'";
...
<table align="center" class="table table-bordered" id="dynamic_field">  
 <tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Served Stat Medicine List</strong></label></td> </tr>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from istat where pmrn= '$pmrn' and eid='$eid'and pstatus ='served' and odate1='$dd'";
