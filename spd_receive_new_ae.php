...
$query46 = mysqli_query($db,"select * from user where uname='$uu'");
$data46 = mysqli_fetch_assoc($query46);

$dnam=$data46['fullname'];
...
$query = "UPDATE einves set reby='$user',rtime='$dtime', rdate='$date_d', rstatus='RECEIVED', status='RECEIVED',per_doc='$per_doc',dname='$dnam',price='$hos_price',doc_price='$doc_price' where id='$id'"; 
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="20"><?php echo $dnam;?></td></tr>
