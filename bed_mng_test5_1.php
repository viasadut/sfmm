...
$count=1;	
$sel_query="Select * from bed where status in ('occupied','Vacant','Under Housekeeping','Under Maintenance','Reservation') and block='5A' and bed_status='Active' order by status asc";	
...
$url_vcall = "vc8/index1.html?id=5A01"; 
$pmrn=$row['pmrn'];
$query43 = "SELECT * FROM inpatient where pmrn= '$pmrn' and discharge='';"; 
...
<blink><a target='_blank' href='$url_vcall'><img src='audio/alert.png' title='Oxygen Alert'></blink>";}
