		...
		//window.print();
		 ...
		 $mpdf = new \Mpdf\Mpdf([
                ...
                $query1 = mysqli_query($con,"select * from pappnew where ID='$id'");
                //$count=1;
...
$mpdf->AddPage();
         ...
         ';*/
			   ...
			   <div style="font-family: freesans; font-size: 16px; text-align:left; position: relative;left: 100px; font-weight:bold;" >
