...
if($res90=mysqli_num_rows($result3)>0){
		...
		$ins_query1="Update othoscharge set pdos='$pdos2' where eid='$id' and pmrn='$pmrn' and medi='$medi1'";
...
$ins_query1="insert into othoscharge (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`type`) values ('$pmrn','$pname','$medi1','$id','$date1','$pdos','$dcode','Consignment')";
mysqli_query($con,$ins_query1) or die(mysql_error());
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>ADD HOSPITAL CHARGES (ONLY FOR CONSIGNMENT ITEMS)</strong></label></td> </tr>
...
$count=1;
$sel_query="Select * from othoscharge where pmrn= '$pmrn' and eid='$id' and type='Consignment'order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["pmrn"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["medi"]; ?></td>
				 ...
				 <td align="center" colspan="2"><a href="othosdelete_con?id3=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&id=<?php echo "$id"; ?>">DELETE</a></td>
