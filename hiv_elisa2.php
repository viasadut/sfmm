...
$ins_query1="insert into hiv (`pname`,`pmrn`,`psex`,`page`,`pvalue`,`cvalue`,`inter`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>HIV ELISA Report:</strong></label>
