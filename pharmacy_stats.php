...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','doctor','qc','mrd','covid','call','imo','mofficer','nurse','emergency','staff','ot','endo','bill','billin','lab')"; 
...
$query43 = "SELECT COUNT(medi) FROM pmedi where medi= '$bt'and ndate BETWEEN '$start' and '$end';"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(infusion) FROM imedi2 where infusion= '$bt'and ndate BETWEEN '$start' and '$end' and status1='SEEN';"; 
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);


$query45 = "SELECT COUNT(infusion) FROM estat where infusion= '$bt'and ndate BETWEEN '$start' and '$end' and udone!='';"; 
...
$sel_query1="Select * from pmedi where medi='$bt' and ndate BETWEEN '$start' and '$end' order by id desc";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row1["ndate"]; ?></td>
	...
	$sel_query2="Select * from imedi2 where infusion='$bt' and ndate BETWEEN '$start' and '$end' and status1='SEEN' order by id desc";
...
$pname=$row_p['pname'];
	...
	<?php
	$sel_query3="Select * from estat where infusion='$bt' and ndate BETWEEN '$start' and '$end' and udone!='' order by id desc";
