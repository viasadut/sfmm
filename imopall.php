...
{ ?>    <tr>
	...
	<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Careshope Items Ordered</strong></label></td> </tr>
	<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
...
//$count=1;
$sel_query="Select * from careshope1 where pmrn= '$pmrn' and eid='$eid' order by `id` DESC;";
