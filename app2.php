...
<ul>
   ...
   <li class='active has-sub'><a href='#'><span>Appointment</span></a>
      <ul>
		 ...
		 <li class='has-sub'><a href='app2'><span>Today's Appointment</span></a>
...
<p align="center" class="style1"> List Of <?php echo $row39['fullname']; ?>'s Patients</P>
...
$date= date('m/d/Y');
$conname=$row39['fullname'];
$count=1;
$sel_query="Select * from pappnew where adate= '$date' and dname= '$conname' and `bill`!='' ORDER BY aslot asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["bill"];?> </td> 
