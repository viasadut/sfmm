...
$rr1='p-ANCA/MPO- :'.$chikun1. 'U/ml'."<br />".'ANCA/PR3:'.$chikun2. 'U/ml';

$rr='p-ANCA/MPO- :'.$chikun1."<br />".'ANCA/PR3:'.$chikun2;
...
$ins_query1="insert into anca (`pname`,`pmrn`,`psex`,`page`,`dengue1`,`dengue2`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
		<h1>ANCA (Anti-neutrophil cytoplasm antigen) FORM </h1>
	  ...
	  <label for="iron"><strong>p-ANCA/MPO</strong></label>
      <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="tibc"><strong>ANCA/PR3</strong></label>
