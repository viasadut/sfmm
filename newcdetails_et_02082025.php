...
$update33="update pappnew set `height`='$pheight',`weight`='$pweight',`temp`='$ptemp',`pbp`='$pbp',`phyper`='$phyper',`ppluse`='$ppluse',`pheart`='$pheart',`pdm`='$pdm',`pkid`='$pkid',`ptb`='$ptb',`pasthma`='$pasthma',`pthyroid`='$pthyroid',`pneuro`='$pneuro',`psurgery`='$psurgery',`pperiod`='$pperiod',`plmp`='$plmp',`pnochild`='$pnochild',`plchild`='$plchild',`palcohol`='$palcohol',`psmoking`='$psmoking',`pfamily`='$pfamily',`pdrug`='$pdrug',`mstatus`='$pmstatus',`occupation`='$poccupation', `status`='HISTORY UPDATED',`spo2`='$spo2',`rr`='$rr',`liver`='$liver',`para`='$para',`clist`='$clist',`gravida`='$gravida',`vby`='$user',`vtime`='$vtime',`pbp1`='$pbp1',`hwc`='$hwc',`hhc`='$hhc' where `ID`='$id' and status !='SEEN'";
