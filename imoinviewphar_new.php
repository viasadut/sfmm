...
$mo_confirm=$row['confirmdn'];
$doc_confirm=$row['dconfirm'];
...
$query445d12 = "SELECT * FROM phar_sale where pmrn= '$pmrn1' and eid='$eid1' and location='IPD STOCK' and ins='';"; 
...
<?php if($mo_confirm!='' || $doc_confirm!='')
{ echo'

			      
				 <td align="center"><a href="discharge_medicine_phar?id='.$row["id"].'&pmrn='.$pmrn.'&eid='.$eid.'&sid='.$rru.'">Dis Medi</a></td>';
				 
}
				 
				 else {
				echo '<td align="center">Discharge Medicine Not Confirmed Yet</a></td>';	 
