...
$query4 = mysqli_query($db,"select * from package_screening where pmrn='$pmrn' and status='Active'");
...
$ins_query21="insert into vitals_package (`pmrn`,`eid`,`time`,`height`,`weight`,`bmi`,`pulse`,`sbp`,`dbp`,`spo2`,`temp`,`rr`,`pain_score`,`user`,`stime`) values 
('$pmrn','$eid','$time','$height','$weight','$bmi','$pulse','$sbp','$dbp','$spo2','$temp','$rr','$pscore','$user','$stime')";
...
$count=1;
$sel_query="Select * from vitals_package where pmrn= '$pmrn' and eid='$eid' order by `id` DESC;";
...
<td colspan="2" align="center"><label><strong><?php echo  $row['time'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['height'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['weight'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['pulse'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['sbp'];?></strong></label></td>
<td colspan="2" align="center"><label><strong><?php echo $row['dbp'];?></strong></label></td>
<td colspan="2" align="center"><label><strong><?php echo $row['spo2'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['temp'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['rr'];?></strong></label></td> 
<td colspan="2" align="center"><label><strong><?php echo $row['pain_score'];?></strong></label></td> 
