...
<input type="text" name="page" id="email" class="input-text" placeholder="Age" size="70"value="<?php echo $row39['page'];?>"readonly>     
...
<input type="text" name="nid" id="email" class="input-text" placeholder="ID" size="70" value="<?php echo $row39['nid'];?>"readonly>
...
<input type="text" name="ward" id="email" class="input-text" placeholder="Ward" size="70"value="<?php echo $row39['ward'];?>"readonly>     
