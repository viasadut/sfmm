...
$query = "SELECT * from staff3 where sid='$sid'"; 
...
$date = date('Y/m/d');
	...
	if(move_uploaded_file($tmp, 'staff/'.$image_name)){


	$sql = "INSERT INTO staffnid (image,sid,date,user) VALUES 
		('".$image_name."','".$sid."','".$date."','".$user."')";
		//$mysqli->query($sql);
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
				...
				<tr>	  
				<td colspan="5">	<input type="text" name="sid" id="sid" class="input-text" placeholder="Staff ID" value="<?php echo $row['sid'] ?>"required readonly></td>
				<td colspan="5">	<input type="text" name="mname" id="mname" class="input-text" placeholder="Staff Name" value="<?php echo $row['sname'] ?>"readonly required></td>
				<td colspan="5">	<input type="text" name="dob" id="datepicker" class="input-text" placeholder="Date Of Birth" value="<?php echo $row['doj'] ?>" readonly required></td>
		...
		<tr>		<td colspan="10"><label><strong>Upload Staff NID / Passport:</strong></label></td></tr>
		<tr>				 
