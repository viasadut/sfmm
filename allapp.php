...
$query43 = "SELECT COUNT(dname) FROM radpapp where dname= '$bt' and adate BETWEEN '$start' and '$end';"; 
...
<form action="allapp" method="POST">
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Inves Name</strong>   
      
      <th width="14%"><strong>Refferal</strong>
	  <th width="14%"><strong>Status</strong>
    <th width="14%"><strong>R_Con</strong>
...
$count=1;
$sel_query="Select * from radpapp where dname='$bt' and adate BETWEEN '$start' and '$end' and status!='Cancel' order by status desc;";
