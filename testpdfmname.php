...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"Select DISTINCT(infusion),instruc,root from imedi3 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pre LIKE ('%infusion%') order by `infusion` asc;",$prop);
...
$prop1 = array('HeaderColor'=>array(255,150,100),
			...
			'color4'=>array(255,255,210),
            'padding'=>2);
$pdf->Table($link,"Select DISTINCT(infusion),instruc,root from imedi3 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pre NOT LIKE ('%infusion%') order by `infusion` asc;",$prop1);
