...
{
return confirm("Are you Sure to Cancel this Leave ?");
}
...
<h1 align="center">Datewise Leave Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="15%"><strong>Leave Type</strong>
	  <th width="15%"><strong>Start Date</strong>
	  <th width="15%"><strong>End Date</strong>
      <th width="14%"><strong>Reason</strong>
	  <th width="14%"><strong>Status</strong>
	  <th width="14%"><strong>Cancel Leave</strong>
...
$sel_query="Select * from dleave where `sdate` between '$start' and '$end' or `edate` between '$start' and '$end' order by dept asc";
...
while($row = mysqli_fetch_assoc($row1)) { ?>
	  ...
	  <?php
	   $uu=$row['uname'];
	   	   $queryz = "SELECT * from staff3 where sid='$uu'"; 
$resultz = mysqli_query($con, $queryz) or die ( mysqli_error());
$row2 = mysqli_fetch_assoc($resultz);
$uu1=$row2['sname'];
	   
	   	   ?>
	   
	  
	   <td align="center"><?php echo $uu1?></td>
	  
<td align="center"><?php echo $row["dept"]; ?></a></td>	  
	  <td align="center"><?php echo $row["tleave"]; ?></a></td>
	  
	  <td align="center"><?php echo $row["sdate"]; ?></a></td>
	  <td align="center"><?php echo $row["edate"]; ?></a></td>
	  
	  <td align="center"><?php echo $row["reason"]; ?></a></td>
	  <td align="center"><?php echo $row["hstatus"]; ?></a></td>
...
<?php
	  ...
	  $hh=$row['hstatus'];
		...
		$url = "com_cancel?id=$id&type=$type&bal=$bal&uname=$uname"; 
		if($hh=='Confirmed By TM')
		{
echo "<a onclick='return confirm_click();'  target='_blank' href='$url'>Cancel Leave</a>";
		}
