...
$sel_query="Select * from endopapp where adate= '$date'  and status='NOT SEEN' ORDER BY aslot asc;";
...
$rowm = mysqli_fetch_array($resultm);
	  ...
	  echo $rowm["machine_name"];?> </td> 
	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="endoapp4nursetest?ID=<?php echo $row["ID"]; ?>">RECEIVE PATIENT</a> </td>
