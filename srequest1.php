...
$objDB1 = mysqli_select_db($objConnect,"sfmmkpjnew");
			...
			else if($eqty > $eqty1)
	{
			...
			$strSQL = "update srequest set eqty1='$eqty1', status='Partially Given',remarks='$eqty5' where id='".$_POST["chkDel"][$i]."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
			
			$strSQL1 = "Insert into srequest1 (`rdept`,`sdept`,`rid`,`rdate`,`ename`,`status`,`rtime`,`rby`,`eqty1`,`eqty`,`remarks`) values('$rdept5','$sdept5','$rid5','$rdate5','$ename5','Partially Given','$ortime','$user','$eqty2','$eqty','$eqty5')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
...
header("Location:$url");
	...
	else if($eqty == $eqty1)
	{
			...
			$strSQL = "update srequest set eqty1=$eqty1, status='Closed' where id='".$_POST["chkDel"][$i]."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);

	
			$strSQL1 = "Insert into srequest1 (`rdept`,`sdept`,`rid`,`rdate`,`ename`,`status`,`rtime`,`rby`,`eqty1`,`eqty`) values('$rdept5','$sdept5','$rid5','$rdate5','$ename5','Closed','$ortime','$user','$eqty2','$eqty')";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery1 = mysqli_query($objConnect,$strSQL1);
...
$strSQL = "Select * from srequest where rid= '$sid' and status in ('Pending','Partially Given') order by `id` DESC;";
...
<tr>
      ...
      <td colspan="2" align="center"><strong>Request_Item</strong></td>
     	  <td colspan="10" align="center"><strong>Request_Dept</strong></td>
		  <td colspan="10" align="center"><strong>Request_Time</strong></td>
...
?>
     ...
     <td align="center" colspan="1"><?php echo $count; ?></td>
      ...
      <td align="center"colspan="2"><?php echo $row["sdept"]; ?></td>
	        <td align="center"colspan="10"><?php echo $row["rdept"]; ?></td>
			<td align="center"colspan="10"><?php echo $row["rtime"]; ?></td>
				        <td align="center"colspan="2"><?php echo $row["eqty"]; ?></td>
						<td align="center"colspan="2"><?php echo $row["eqty1"]; ?></td>
						
						<td colspan="2"><input type="text" name="eqty1[]" id="eqty1<?php echo $i;?>" value="" /></td>
						<td colspan="2"><input type="text" name="eqty2[]" id="eqty2<?php echo $i;?>" value="" /></td>
