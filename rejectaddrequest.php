...
//$id1=$_REQUEST['ID'];
$url = "admview";
$query = "UPDATE preadm set tstatus='Cancelled',tname='$user',ttime='$dtime',rcom='$rcom' where id='$id'"; 
...
<h1 align="center"style="background-color:lightgreen;">Admission Request Rejection Panel</h1>
