...
$query43 = "SELECT COUNT(pmrn) FROM iidiet where  odate BETWEEN '$start' and '$end' and infusion !='NPO' and dmenu !='N/A' and diettime= '$bt'and status in('Diet Ordered','Given') ;"; 
...
$query44 = "SELECT COUNT(pmrn) FROM iidiet where odate BETWEEN '$start' and '$end' and infusion !='NPO' and dmenu !='N/A'and status in('Diet Ordered','Given');"; 
...
<h1 align="center">Diet Order Stat Report</h1>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Diet Time</strong></th>
      <th width="15%"><strong>Diet Type </strong>
      <th width="14%"><strong>Details Menu</strong>   
      <th width="14%"><strong>Forwarded Time</strong>
      <th width="14%"><strong>Forwarded By</strong>
	  <th width="14%"><strong>Served Time</strong>
...
$sel_query="Select * FROM iidiet where  odate BETWEEN '$start' and '$end' and infusion !='NPO' and dmenu !='N/A' and status in('Diet Ordered','Given') order by diettime asc"; }
 else{
	 echo "<font color=blue font size=5> Total Record found in the search  -";
...
echo "  To  ";
echo $end1;
	 $sel_query="Select * FROM iidiet where  odate BETWEEN '$start' and '$end' and infusion !='NPO' and dmenu !='N/A' and status in('Diet Ordered','Given') and diettime='$bt'"; }
...
{ ?>    <tr>
      ...
      <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><?php echo $row["otime"];?> 
      <td align="center"><?php echo $row["duser"]; ?>  
	  <td align="center"><?php echo $row["gtime"]; ?>  
