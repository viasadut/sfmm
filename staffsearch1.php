...
$query43 = "SELECT COUNT(sname) FROM staff3 where dept= '$bt';"; 
...
$sel_query1="Select * from staff3 where dept='$bt' order by id";
...
{ ?>    <tr>
	  ...
	  <td align="center"><?php echo $row["cno"]; ?></td>
        <td><a target='_blank' href="covid.php?id=<?php echo $row['id']; ?>">Add</a></td>
