...
$ins_query="insert into hmedi (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`ddate`,`dtime`,`infusion`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$ddate','$dtime','$infu')";
...
<tr><td colspan="4" align="center"><label><strong>Order Date</strong></label></td> 
<td colspan="4" align="center"><label><strong>Order Time</strong></label></td> 
<td colspan="4" align="center"><label><strong>High Alert Medication</strong></label></td> 
<td colspan="4" align="center"><label><strong>Done Date</strong></label></td>
<td colspan="4" align="center"><label><strong>Done Time</strong></label></td></tr>
...
<td colspan="4" align="center"><input type="date" name="ddate" required value="" /></td>
<td colspan="4" align="center"><select name="dtime" value="" size="1"height="2">
