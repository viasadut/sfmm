...
//$_SESSION['user_id'] = $row['sess_username'];
?>
<?php
require('db1.php');
$creditor=$_REQUEST['cname'];
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="17%"><strong>DP NO</strong></th>
      <th width="10%"><strong>DP Remarks</strong></th>
...
if($stdate!='' && $endate!='')
{
$sel_query="Select * from fund_transfer_master where sub_ledger='$creditor' and approve_status IN ('1','2') and posting_date BETWEEN '$stdate' AND '$endate' ORDER BY id desc;";
}
else
{
$sel_query="Select * from fund_transfer_master where sub_ledger='$creditor' and approve_status IN ('1','2')  ORDER BY id desc;";
}
$result = mysqli_query($con,$sel_query);
//echo   $bt;
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><?php echo $row["journal_code"]; ?></td>
	  <td align="center"><?php echo $row['notes']; ?></td>
      <td align="center"><?php echo $row["sub_ledger"]; ?></td>
	  <td align="center"><?php echo $row["amount_discount"]; ?></td>
	  <td align="center"><?php echo $row["total_amount"]; ?></td>
...
<?php if($row['status']=='Approved' and $fullname=='1603' || $fullname=='54' || $fullname=='71'){
echo "<a href=po_prepare1_purchase_grn?ono=$ono1&grn=$grn>View/Edit</a>";
}
else {
...
<a href="fams/FundTransferPrint?id=<?php echo $row["id"]; ?>">Print</a> 
