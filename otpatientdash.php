...
$query44 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' order by id desc");
...
$url = "all_consent_form?pmrn=$pmrn&id=$id&eid=$eid";
header("Location: $url");
}
...
<?php
if(isset($_POST['surgical_forms']))
{


$url = "surgical_form?pmrn=$pmrn&id=$id";
header("Location: $url");
}
...
<?php
if(isset($_POST['otidocblood_1']))
{


$url = "iblood1_ot?pmrn=$pmrn&id=$id&eid=$eid";
header("Location: $url");
}
...
<td colspan="4" align="center"><button type="submit" name="surgical_forms"><font style="color:red; font-weight:bold">Surgical Forms</font> </button></td>
<td colspan="4" align="center"><button type="submit" name="otidocblood_1"><font style="color:red; font-weight:bold">Blood Request</font> </button></td>
