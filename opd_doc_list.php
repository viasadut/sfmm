...
{ ?>    <tr>
	  ...
	  <td align="center"><a target='_blank' href="chkattntm?sid=<?php echo $row["sid"]; ?>"><?php echo $row["sid"]; ?></a></td>
      <td align="center"><a target='_blank' href="chkleavetm?sid=<?php echo $row["sid"]; ?>"><?php echo $row["mname"]; ?></a></td>
...
$cyear=date('Y');
	  ...
	  $query39 = "SELECT * FROM staff1 where sid= '$sname'"; 
...
?>
	  ...
	  <td align="center"><?php echo $row["opd"]; ?></td>
...
<td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="doc_edit?sid=<?php echo $row["sid"]; ?>">Edit</a> </td>
