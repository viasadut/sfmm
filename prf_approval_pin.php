...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="10%"><strong>PRF Type</strong></th>
...
$sel_query="Select * from po_table where status='FORWARD FOR CEO APPROVAL' and '$user'='md' ORDER BY id asc;";
...
$sel_query="Select * from po_table where status='FORWARD FOR APPROVAL' and '$user'='1601' ORDER BY id asc;";
