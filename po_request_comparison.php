...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','ot','nurse','mng')"; 
...
$sel95="SELECT * FROM po_comparison WHERE `rfid`='$sno';";
...
$url = "new_bill/test_prf_purchase?sno=$sno";
header("Location: $url"); 
...
<?php 
  ...
  if($fstatus==5){echo'<div style="position: relative;left: 1000px;">
...
<tr><td colspan="20">
<textarea class="form-control" id="charge" name="charge" rows="40" >
<?php echo $b_chk['image'];?>
