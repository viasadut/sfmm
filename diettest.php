...
$ins_query="insert into iidiet (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`dtime`,`user`,`status`,`rtime`,`ordate`) 
...
<tr>
<td colspan="20"align="right"><font size="4.5" color="#FF0000"><b><label><strong><a href="viewidiettomorrowdoc?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">View Tomorrow's Diet</a></strong>&nbsp;&nbsp;<a href="datewiseidietdoc?pmrn=<?php echo $pmrn; ?>&eid=<?php echo $eid; ?>"><font size="4.5" color="#FF0000"><b>(See Datewise Diet Order)<b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
$odate = date('m/d/Y');
$count=1;
$sel_query="Select * from iidiet where pmrn= '$pmrn' and eid='$eid' and odate='$odate' and status1 != 'Cancel'order by `id` DESC;";
...
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="idiettomorrowdoc?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["dtime"]; ?>&rtime=<?php echo $row["rtime"]; ?>&orderby=<?php echo $user; ?>">ADD For Tomorrow</a></td>  	  
<td align="center" colspan="1"><a onclick="return confirm_click();" href="imediupdate1indietdoc?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>&user=<?php echo $user; ?>">Cancel</a></td>
