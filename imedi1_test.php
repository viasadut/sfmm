...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			$strSQL = "UPDATE imedi2 set nstatus='Received', nuser='$user', nurdate='$pdate' ";
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from imedi2 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd' and pstatus='served' order by `time` and `infusion` asc;";
...
$idd=$row['id'];
$ps=$row['pstatus'];
$url8 = "imedi2test?pmrn=$pm&eid=$ed&id=$idd&user=$user"; 
?>
