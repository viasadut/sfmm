...
$query45 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' order by id desc limit 1;");
...
<td colspan="20">
<?php
$query1 = mysqli_query($db,"Select * from ot where pmrn= '$pmrn' and ieid='$id';");
$count=1;
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from otivisitendo where pmrn= '$pmrn' and ieid='$id' and c_status='0' order by `id` desc;";
...
?>
  ...
  <td align="center" colspan="1"><?php echo $count; ?></td>
    ...
    <td align="center"colspan="4"><a href="update_ot_charge.php?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>">Edit</a></td>
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198j_doc = "SELECT SUM(room) FROM otivisitendo where pmrn= '$pmrn' and ieid='$id' and c_status='0'"; 
...
$test1c_doc=	$row198j_doc['SUM(room)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Consultant Charge is:<?php echo $test1c_doc;?> (BDT)</strong></td></tr>
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from othoscharge where pmrn= '$pmrn' and ieid='$id' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
?>
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198j_dis = "SELECT SUM(ins) FROM othoscharge where pmrn= '$pmrn' and ieid='$id' "; 
...
$test1c_dis=	$row198j_dis['SUM(ins)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Disposible Charge is:<?php echo $test1c_dis;?> (BDT)</strong></td></tr>
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from othoscharge1 where pmrn= '$pmrn' and ieid='$id' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
?>
...
$c_code=$result1["c_code"];


$sel1_cc=mysqli_query($db,"SELECT * FROM medicine WHERE `mname`='$qqt';");
$result1_cc = mysqli_fetch_assoc($sel1_cc);
//$dcode=$result1["dcode"];
$price_cc=$result1_cc["uprice"];
$c_code_cc=$result1_cc["c_code"];
*/
...
/*if($c_code=='')
{echo'
<td align="center"colspan="1">'.$row["pdos"]*$price.'</td>';}

else 
{echo'
<td align="center"colspan="1">'.$row["pdos"]*$price_cc.'</td>';}
...
$query198j_medi = "SELECT SUM(ins) FROM othoscharge1 where pmrn= '$pmrn' and ieid='$id' "; 
...
$test1c_medi=	$row198j_medi['SUM(ins)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Medication Charge is:<?php echo $test1c_medi;?> (BDT)</strong></td></tr>
...
$test1c_amedi=	$row198j_amedi['SUM(price)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Anaesthesia Medication Charge is:<?php echo $test1c_amedi;?> (BDT)</strong></td></tr>
...
$test1c_ainfu=	$row198j_ainfu['SUM(price)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Anaesthesia Infusion Charge is:<?php echo $test1c_ainfu;?> (BDT)</strong></td></tr>
...
$total_dis=$test1c_medi+$test1c_dis;

?>

<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Grand Total is:<?php echo $test1c_doc+$test1c_dis+$test1c_medi+$test1c_amedi+$test1c_ainfu;?> (BDT)</strong></td></tr>	
<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong><a href="update_ot_hos_charge.php?id=<?php echo $id; ?>&pmrn=<?php echo $pmrn; ?>&tdis=<?php echo $total_dis; ?>">Hospital Discount:</a><?php echo $data45['ot_hos_dis'];?> (BDT)</strong></td></tr>	
<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong><a href="update_ot_hos_charge.php?id=<?php echo $id; ?>&pmrn=<?php echo $pmrn; ?>&tdis=<?php echo $total_dis; ?>">Consultant Discount:</a><?php echo $data45['ot_doc_dis'];?> (BDT)</strong></td></tr>	

<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Payable Amount is:<?php echo $test1c_doc+$test1c_dis+$test1c_medi+$test1c_amedi+$test1c_ainfu-$data45['ot_hos_dis']-$data45['ot_doc_dis'];?> (BDT)</strong></td></tr>	
</table>
