...
$ins_query="insert into dhistory (`dname`,`pmrn`,`pname`,`ins`,`date`) values ('$full', '$pmrn','$pname','$pins','$date')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Development History</strong></label></td> </tr>
...
<tr>
      ...
      <td colspan="2" align="center"><strong>MRN</strong></td>
      	  ...
      	  <td colspan="16" align="center"><strong>Development History</strong></td>
...
$count=1;
$sel_query="Select * from dhistory where pmrn= '$pmrn' order by `id` DESC;";
