...
<td align="center"colspan="1"><a target='_blank' href="<?php echo $row['reportv']?>?id=<?php echo $row['id']; ?>&pmrn=<?php echo $row['pmrn']; ?>&eid=<?php echo $row['eid']; ?>">REPORT</a></td>
      </tr>
    <?php $count++; }}
    ...
    echo 'alert("Only Anaesthetist have privilege to do PAC... Thank You !!"); ';
    echo '</script>';
