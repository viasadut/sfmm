...
$sel_query="Select * from iinves where infusion in ('HISTOLOGY- SMALL','HISTOLOGY - LARGE','REQUEST FOR HISTOLOGY PARAFFIN','REQUEST FOR HISTOLOGY/CYTOLOGY','SECOND OPINION HISTOPATHOLOGY','HISTOPATHOLOGY-MEDIUM') ORDER BY id asc;";
...
$sel_query="Select * from proinves where medi in ('HISTOLOGY- SMALL','HISTOLOGY - LARGE','REQUEST FOR HISTOLOGY PARAFFIN','REQUEST FOR HISTOLOGY/CYTOLOGY','SECOND OPINION HISTOPATHOLOGY','HISTOPATHOLOGY-MEDIUM') ORDER BY id asc;";
