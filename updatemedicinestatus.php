...
$ins_query1="update medicinerequest set a1='Approved',a1time='$ortime',a1time1='$aa' where id='$id';";
...
$ins_query2="update medicinerequest set a2='Approved',a2time='$ortime',a2time1='$aa' where id='$id';";
