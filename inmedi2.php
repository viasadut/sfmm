...
$query45 = mysqli_query($db,"select * from inmedi2 where pmrn='$pmrn' and id='$id'");
...
$aadate= date('m-d-Y H:i:s');



$update="update inmedi2 set status='$ddate', donet='$aadate', udone='$user' where `id`='$id'";
...
<td colspan="6" align="center"><label><strong>Done Date</strong></label></td></tr>
<tr>
<td colspan="4" align="center"><input type="text" name="infu" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
<td colspan="10" align="center"><input type="text" name="otime" required value="<?php echo $data45["time"]; ?>" readonly/></td>



<td colspan="6" align="center"><input list="rr5" name="ddate" size=60% class="form-control">
  <datalist id="rr5">
