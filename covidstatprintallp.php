...
$stmt1 = $db->query("SELECT COUNT(name) as tt FROM covid where fresult='P'");
...
$this->Cell(13,10,'SID',1,0,'C');
$this->Cell(45,10,'Name',1,0,'C');

$this->Cell(35,10,'Desigation',1,0,'C');
...
$stmt = $db->query("Select * from covid where fresult='P' order by ssent desc");
while($data = $stmt->Fetch(PDO::FETCH_OBJ)){
$this->Cell(5,10,$count,1,0,'L');
$this->Cell(13,10,'SFMM'.$data->sid,1,0,'L');
$this->Cell(45,10,$data->name,1,0,'L');

$this->Cell(35,10,$data->desig,1,0,'L');
$this->Cell(18,10,$data->phone,1,0,'L');
$this->Cell(13,10,$data->sentto,1,0,'L');
$this->Cell(15,10,$data->ssent1,1,0,'L');
if($data->tresult=='N'){
	
$this->Cell(8,10,$data->fresult,1,0,'L');}
