...
<?php
    ...
    $query5 = mysqli_query($con,"select * from dlc where pmrn='$pmrn' and sno='$sno'");
...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        $adate1= date('m/d/Y');
        $rr='Neutrophil:'.$neu."<br />".'Lymphocyte:'.$lym."<br />".'Eosinophil:'.$eos."<br />".'Monocyte:'.$mono."<br />".'Basophil:'.$bas;
        $rr1='Neutrophil:'.$neu.' '.'%'."<br />".'Lymphocyte:'.$lym.' '.'%'."<br />".'Eosinophil:'.$eos.' '.'%'."<br />".'Monocyte:'.$mono.' '.'%'."<br />".'Basophil:'.$bas.' '.'%';

        $ins_query1="UPDATE dlc SET 
            `pname`='$pname',
            `pmrn`='$pmrn',
            `psex`='$psex',
            `page`='$page',
