...
<?php
    ...
    $eid=$data['eid'];
    $iname=$data['medi'];
    $query5 = mysqli_query($con,"select * from antihcv where pmrn='$pmrn' and sno='$sno'");
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <label for="age"><strong>Anti-HCV ELISA:</strong></label>
