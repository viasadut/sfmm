...
$pname=$result9["pname"];
 ...
 $url = "promedicine.php?pmrn=$pmrn&dname=$full&id=$id&eid=$eid&type=$type&ieid=$ieid"; 
?>
...
$ins_query1="insert into promedi (`dname`,`pmrn`,`pname`,`medi`,`brand`,`pdos`,`eid`,`date`,`type`,`ieid`,`duration`,`frelation`,`code`) 
