...
$query45 = mysqli_query($db,"select * from iidiet where id='$id'");
...
$eid=$_REQUEST['eid'];
$pmrn=$_REQUEST['pmrn'];
$newdiet=$_REQUEST['newdiet'];
$result=$_REQUEST['result'];
$dtime= date('d/m/Y H:i:s');
//$id1=$_REQUEST['ID'];
$url = "idocdietdiet?pmrn=$pmrn&eid=$eid";
$query = "UPDATE iidiet set dmenu='$newdiet', etime='$dtime', eby='$user' where id='$id'"; 
...
<td colspan="2" align="center"><label><strong>Diet Type</strong></label></td> 
<td colspan="6" align="center"><label><strong>Original Order</strong></label></td>
<td colspan="10" align="center"><label><strong>New Order</strong></label></td>


<tr><td colspan="2" align="center"><input type="text"  name="odate" required value="<?php echo $data45["odate"]; ?>" readonly/></td>
<td colspan="2" align="center"><input type="text" name="otime" required value="<?php echo $data45["infusion"]; ?>" readonly/></td>
<td colspan="6" align="center"><input type="text" name="infu" required value="<?php echo $data45["dmenu"]; ?>" readonly/></td>
<td colspan="10" align="center"><input type="text" name="newdiet" required value="" ></td>
