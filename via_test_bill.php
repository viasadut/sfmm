...
$sel_query="Select * from alltest where billdate= '$date' and billstatus='Billed' and medi='VIA Test' and status='' order by id asc ;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["billdate"]; ?>
      <td align="center"><?php echo $row["medi"]; ?>  
	  <td align="center"><?php echo 'Gaynae Procedure Room'; ?> 
	  	  

	       <td align="center" style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold"><a href="via_report?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"];?>">UPDATE</a> </td>
