...
$ins_query="insert into otanaesposition (`pmrn`,`eid`,`pname`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
('$pmrn','$id','$pname','$page','$adm','$psex','$pphone','$odate','$tan','$full','Data Updated','$odate1','$time','$date','Active','$remarks')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>TYPE OF ANESTHESIA </strong></label></td> </tr>
<tr>
<td colspan="2" align="center"><label><strong>Date</strong></label></td> 
<td colspan="2" align="center"><label><strong>Time</strong></label></td> 

<td colspan="6" align="center"><label><strong>Anesthesia</strong></label></td>
...
<td colspan="2" align="center"><input list="browsers1" name="time" class="form-control">
...
<option value="23:50">23:50</option></datalist></td>
			

			<td colspan="6" align="left">
			<select id="browsers1" name="tan">

						<option value=''>-select-</option>
						<option value='Supine'>Supine</option>
						<option value='Lithotomy'>Lithotomy</option>
						<option value='Fowlers Position'>Fowlers Position</option>
						<option value='High Fowlers Position'>High Fowlers Position</option>
						<option value='Jackknife Position'>Jackknife Position</option>
						...
						<option value='Reverse Trendelenburg Position'>Reverse Trendelenburg Position</option>
...
$count=1;
$sel_query="Select * from otanaesposition where pmrn= '$pmrn' and eid='$id' and status1='Active'order by `id` DESC;";
