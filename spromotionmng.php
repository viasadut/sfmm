...
$ins_query="insert into spromotion (`sid`,`cname`,`cyear`,`remarks`,`date`,`user`,`status`) values ('$sid', '$cname','$cyear','$remarks','$date','$user','active')";
...
<tr><td colspan="4" align="center"><label><strong>New Position</strong></label></td> 
...
$count=1;
$sel_query="Select * from spromotion where sid= '$sid' and status='active' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["sid"]; ?></td>
				  ...
				  <td align="center" colspan="1"><a href="deletepromotion?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>">DELETE</a></td>
