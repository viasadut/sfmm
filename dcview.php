...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from ipres where discharge= 'discharge'";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="discharge?pmrn=<?php echo $row["pmrn"]; ?>&id=<?php echo $row["id"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>">GO</a></td>
