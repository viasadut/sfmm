...
<td align="center"><?php echo $row["category"]; ?> 	  
...
$cat=$row['category'];		  
		  ...
		  $query44 = "SELECT COUNT(id) FROM ccomm where cname='$cat' and uid='$user' and mrole='Secretary' and status='Active';"; 
...
echo'<td align="center"colspan="2"><a  target="_blank" href="minutes?id='.$row["id"].'&topic='.$row['topic'].'">Upload Minutes</td>';  		
