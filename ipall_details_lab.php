...
$count=1;
$sel_query="Select * from iinves where pmrn= '$pmrn' and eid='$eid' and infusion='$medi' and status='RECEIVED' and type='$type' order by `ddate` DESC;";
...
$selected = mysqli_select_db($dbhandle,"sfmmkpjnew") 
  or die("Could not select examples");
	...
	$query198 = "SELECT SUM(price) FROM iinves where pmrn= '$pmrn' and eid='$eid' and infusion='$medi' and type='$type' and status='RECEIVED'"; 
...
$test1=	$row198['SUM(price)'];
	...
	<td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Lab Charge is:<?php echo $test1;?> (BDT)</strong></td></tr>
