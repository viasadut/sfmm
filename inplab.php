...
<tr> <td align="right" colspan="10"><a href="barstats"><strong>PRINT DAILY REPORT</strong></a></td><td align="right" colspan="10"><a href="labsearchbar"><strong>SEARCH</strong></a></td></tr>
<tr> <td align="left" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr><tr> <td align="right" colspan="20"></td></tr>
...
echo $diff->format("%R%a days");?>  </td>
	  <td align="center"><a href="labinp?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">VIEW LAB REQUEST</a></td>
	    <td align="center"><a href="labinpedit?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">EDIT</a></td>
	  <td align="center"><a href="labblood?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>">VIEW BLOOD REQUEST</a></td>	  
<?php 
$pmrn1=$row['pmrn'];
$eid1=$row['eid'];
$sel90="Select * from iinves where pmrn='$pmrn1' and eid='$eid1'and ordate='$dd' and type in ('lab','LAB','Lab');";
$result90 = mysqli_query($con,$sel90);
$row3 = mysqli_fetch_assoc($result90);


$query43 = "SELECT COUNT(rstatus) FROM iinves where pmrn= '$pmrn1' and eid='$eid1' and ordate='$dd' and rstatus='Ordered' and type in('lab','LAB','Lab');"; 
