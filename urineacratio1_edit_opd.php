...
$query5 = mysqli_query($con,"select * from urineacratio where pmrn='$pmrn' and sno='$sno'");
...
$rr1='Creatinine, Urine:'.$chikun1.' '.'mmol/L'."<br />".'Microalbumin, Urine:'.$chikun2.' '.'mg/L'.'Urine Albumin / Creatinine Ratio:'.$chikun3.' '.'mg/mmoL';
    ...
    $ins_query1="UPDATE urineacratio SET 
        `uv`='$chikun1',
        `uc`='$chikun2',
        `ratio`='$chikun3',
        `uby`='$user',
...
<body>
    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <input name="chikun1" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['uv']?>" required>
            <label for="tibc"><strong>Microalbumin, Urine</strong></label>
            <input name="chikun2" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['uc']?>" required>

            <label for="tibc"><strong>Urine Albumin / Creatinine Ratio</strong></label>
            <input name="chikun3" type="text" size="70" style="text-transform:uppercase" value="<?php echo $data1['ratio']?>" required>
