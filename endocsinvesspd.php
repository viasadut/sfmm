...
$dd=date('Y-m-d');
$dd1=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from endolab where pmrn='$pmrn' and eid='$eid' " );
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from endolab where pmrn='$pmrn' and eid='$eid' and odate='$dd' and status='Ordered' and type='spd1'",$prop);
$pdf->Output();
?>