...
$query3 = "SELECT COUNT(hrd) FROM otanaesetco2 where pmrn='$pmrn' and date1='$odate1'"; 
...
$querybp = "SELECT COUNT(hrd) FROM otanaessbp where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypulse = "SELECT COUNT(hrd) FROM otanaespulse where pmrn='$pmrn' and date1='$odate1'"; 
...
$queryspo2 = "SELECT COUNT(hrd) FROM otanaesspo2 where pmrn='$pmrn' and date1='$odate1'"; 
...
$querytemp = "SELECT COUNT(hrd) FROM otanaestemp where pmrn='$pmrn' and date1='$odate1'"; 
...
$queryrr = "SELECT COUNT(hrd) FROM otanaesrr where pmrn='$pmrn' and date1='$odate1'"; 
...
$querypscore = "SELECT COUNT(hrd) FROM otanaescvp where pmrn='$pmrn' and date1='$odate1'"; 
...
$btrans = $_REQUEST['btrans'];
$floss = $_REQUEST['floss'];
$ibp = $_REQUEST['ibp'];

if (!empty ($_POST['etco2'])){

$ins_query21="insert into otanaesetco2 (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','ETCO2','$etco2','$count1','$user','$odate','$time')";
mysqli_query($con,$ins_query21) or die("Problem in entry");}

if (!empty ($_POST['sbp'])){
$ins_querybp="insert into otanaessbp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`vitails2`,`score2`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','sbp','$sbp','dbp','$dbp','$countbp1','$user','$odate','$time')";
mysqli_query($con,$ins_querybp) or die("Problem in entry");}

if (!empty ($_POST['pulse'])){
$ins_querypulse="insert into otanaespulse (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','Pulse','$pulse','$countpulse1','$user','$odate','$time')";
mysqli_query($con,$ins_querypulse) or die("Problem in entry");}

if (!empty ($_POST['spo2'])){
$ins_queryspo2="insert into otanaesspo2 (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','SPO2','$spo2','$countspo21','$user','$odate','$time')";
mysqli_query($con,$ins_queryspo2) or die("Problem in entry");}

if (!empty ($_POST['temp'])){
$ins_querytemp="insert into otanaestemp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','Temperature','$temp','$counttemp1','$user','$odate','$time')";
mysqli_query($con,$ins_querytemp) or die("Problem in entry");}

if (!empty ($_POST['rr'])){
$ins_queryrr="insert into otanaesrr (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','RR','$rr','$countrr1','$user','$odate','$time')";
mysqli_query($con,$ins_queryrr) or die("Problem in entry");}

if (!empty ($_POST['cvp'])){
$ins_querypscore="insert into otanaescvp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','CVP','$cvp','$countpscore1','$user','$odate','$time')";
mysqli_query($con,$ins_querypscore) or die("Problem in entry");}



if (!empty ($_POST['ibp'])){
$ins_querypibp="insert into otanaesibp (`pname`,`pmrn`,`eid`,`date1`,`vitails1`,`score1`,`hrd`,`user`,`date2`,`time`) values ('$pname', '$pmrn','$id','$odate1','IBP','$ibp','$countpscore1','$user','$odate','$time')";
mysqli_query($con,$ins_querypibp) or die("Problem in entry");}


if (!empty ($_POST['urine'])){
$ins_queryurine="insert into otanaesurine (`pmrn`,`eid`,`pname`,`odate`,`infusion`,`user`,`odate1`,`time`) values 
('$pmrn','$id','$pname','$odate','$urine','$user','$odate1','$time')";
mysqli_query($con,$ins_queryurine) or die(mysql_error());}


if (!empty ($_POST['bsugar'])){
$ins_querybsugar="insert into otanaesbsugar1 (`pmrn`,`eid`,`pname`,`odate`,`infusion`,`user`,`odate1`,`time`) values 
('$pmrn','$id','$pname','$odate','$bsugar','$user','$odate1','$time')";
mysqli_query($con,$ins_querybsugar) or die(mysql_error());}



if (!empty ($_POST['bloss'])){
$ins_querybloss="insert into otanaesbloss (`pmrn`,`eid`,`pname`,`odate`,`infusion`,`user`,`odate1`,`time`) values 
('$pmrn','$id','$pname','$odate','$bloss','$user','$odate1','$time')";
mysqli_query($con,$ins_querybloss) or die(mysql_error());
}



if (!empty ($_POST['btrans'])){
$ins_querybtrans="insert into otanaesbtrans (`pmrn`,`eid`,`pname`,`odate`,`infusion`,`user`,`odate1`,`time`) values 
('$pmrn','$id','$pname','$odate','$btrans','$user','$odate1','$time')";
mysqli_query($con,$ins_querybtrans) or die(mysql_error());
}



if (!empty ($_POST['floss'])){
$ins_queryfloss="insert into otanaesother (`pmrn`,`eid`,`pname`,`odate`,`infusion`,`user`,`odate1`,`time`) values 
('$pmrn','$id','$pname','$odate','$floss','$user','$odate1','$time')";
mysqli_query($con,$ins_queryfloss) or die(mysql_error());
}
...
<input list="rr10" name="time" size=60% class="form-control">
<datalist id="rr10">
...
<td colspan="2" align="center"><input type="text" name="ibp" class="form-control"placeholder="IBP"></td>


</tr>

<tr>
<td colspan="2" align="center"><label><strong>Urine output</strong></label></td>
<td colspan="2" align="center"><label><strong>Blood sugar </strong></label></td>
<td colspan="2" align="center"><label><strong>Blood loss (ml)</strong></label></td> 
<td colspan="2" align="center"><label><strong>Blood transfusion (ml)</strong></label></td> 
<td colspan="2" align="center"><label><strong>Other fluid loss (ml)</strong></label></td> 
</tr>


<tr>

<td colspan="2" align="center"><input type="text" name="urine" class="form-control"placeholder="Urine Output"></td>
<td colspan="2" align="center"><input type="text" name="bsugar" class="form-control"placeholder="Blood Sugar"></td>

<td colspan="2" align="center"><input type="text" name="bloss" class="form-control"placeholder="Blood Loss"></td>
<td colspan="2" align="center"><input type="text" name="btrans" class="form-control"placeholder="Blood Transfusion"></td>
<td colspan="2" align="center"><input type="text" name="floss" class="form-control"placeholder="Fluid Loss"></td>
...
<tr>
    ...
    <td>
    <a target='_blank' href="otanaesprintnew?id=<?php echo "$id"; ?>&pmrn=<?php echo "$pmrn"; ?>"><img src="print.png" title="Print Report" width="50" height="60" /></a>
...
$count=1;
$sel_query="Select * from otanaessbp where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from otanaespulse where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from otanaesspo2 where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from otanaestemp where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from otanaesrr where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from otanaesetco2 where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
$count=1;
$sel_query="Select * from otanaescvp where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
<td align="center"colspan="4"><?php echo $row["time"]; ?></td>  
	...
	<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Patients IBP</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Order By</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>IBP</strong></td>
<td colspan="4" align="center"><strong>Checked Time</strong></td>
      <td colspan="3" align="center"><strong>Checking Episode</strong></td>
	  <td colspan="2" align="center"><strong>Date</strong></td>
...
$count=1;
$sel_query="Select * from otanaesibp where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
<td align="center"colspan="4"><?php echo $row["time"]; ?></td>  
	...
	<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Patients Urine output</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Order By</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Urine Output</strong></td>
<td colspan="4" align="center"><strong>Checked Time</strong></td>
...
$count=1;
$sel_query="Select * from otanaesurine where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
<td align="center"colspan="4"><?php echo $row["time"]; ?></td>  
	...
	<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Patients Blood sugar</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Order By</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Blood Sugar(ml)</strong></td>
<td colspan="4" align="center"><strong>Checked Time</strong></td>
...
$count=1;
$sel_query="Select * from otanaesbsugar1 where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
<td align="center"colspan="4"><?php echo $row["time"]; ?></td>  
	...
	<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Patients Blood Loss</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Order By</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Blood Loss(ml)</strong></td>
<td colspan="4" align="center"><strong>Checked Time</strong></td>
...
$count=1;
$sel_query="Select * from otanaesbloss where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
<td align="center"colspan="4"><?php echo $row["time"]; ?></td>  
	...
	<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Patients Blood transfusion (ml)</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Order By</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Blood Transfusion(ml)</strong></td>
<td colspan="4" align="center"><strong>Checked Time</strong></td>
...
$count=1;
$sel_query="Select * from otanaesbtrans where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
...
<td align="center"colspan="4"><?php echo $row["time"]; ?></td>  
	...
	<tr><td colspan="20" align="center"bgcolor="lightblue"><label><strong>Patients Other fluid loss (ml)</strong></label></td> </tr>
<tr>
      <td colspan="1" align="center"><strong>S.No</strong></td>
      <td colspan="4" align="center"><strong>Order By</strong></td>
      <td colspan="1" align="center"><strong>MRN</strong></td>
      <td colspan="4" align="center"><strong>Other Fluid Loss Transfusion(ml)</strong></td>
<td colspan="4" align="center"><strong>Checked Time</strong></td>
...
$count=1;
$sel_query="Select * from otanaesother where pmrn= '$pmrn' and eid='$id' order by `id` DESC;";
