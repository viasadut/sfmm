...
$query_bed1 = mysqli_query($db,"select * from newbed where type='$ward_no' and bno='$bed_no' and pmrn='$pmrn' and eid='$eid'");
...
$fday_t= round($datediff/(60*60*24),2) ;



$update="update inpatient set disstatus='Discharge Requested', dstatustime='$adate1', duser='$user' where `eid`='$eid' and pmrn='$pmrn'";
mysqli_query($con,$update) or die(mysql_error());

$insert="insert into dis_request (`pmrn`,`pname`,`eid`,`dname`,`disstatus`,`dstatustime`,`duser`,`drdate`) values
('$pmrn','$pname','$eid','$dname','Discharge Requested','$adate1','$user','$date4') ";
...
<td colspan="20" align="center"><input type="text" name="infu" required value="Confirm Discharge Request" readonly></td>
</tr> 
...
<tr>
	  ...
	  <td colspan="6" align="center"><strong>User Bill Confirmed</strong></td>
...
$episode=$data["eid"];
$count=1;
$sel_query="Select * from inpatient where pmrn= '$pmrn' and eid='$episode' and disstatus='Discharge Requested' order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="6"><?php echo $row["buser"]; ?></td>  
