...
$query4 = mysqli_query($db,"select * from procedure1 where id='$id'");
...
$query43 = "SELECT COUNT(pmrn) FROM procedure1 where pmrn='$pmrn' and ustatus!='Cancel';"; 
...
$update33="update procedure1 set `temp`='$temp',`pulse`='$pulse',`temp`='$temp',`bp`='$bp',`remarks`='$remarks',`pscore`='$pscore',`ustatus`='Updated',`eid`='$count1' where `id`='$id'";
