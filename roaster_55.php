...
<select type="text" name="loc" id="loc" class="form-control" required>
				...
				$loc1=$_REQUEST['loc'];
					...
					echo "<option value='".$loc1."'>".$loc1."</option>";
		...
		<label>Office Duty</label>  
						  <select type="text" name="pbp1_3[]" id="pbp1_3" multiple="multiple" class="3col active" >
		...
		<label>Morning</label>  
						  <select type="text" name="pbp1[]" id="pbp1" multiple="multiple" class="3col active">
...
<label>Evening</label>  
						  <select type="text" name="pbp1_1[]" id="pbp1" multiple="multiple" class="3col active">
...
<label>Night</label>  
						  <select type="text" name="pbp1_2[]" id="pbp1" multiple="multiple" class="3col active">
		  ...
		  <label>24 Hour Duty</label>  
						  <select type="text" name="pbp1_4[]" id="pbp1_4" multiple="multiple" class="3col active">
		  ...
		  <label>24 Hour On-Call</label>  
						  <select type="text" name="pbp1_5[]" id="pbp1_5" multiple="multiple" class="3col active">
		  ...
		  <label>Off Day</label>  
						  <select type="text" name="pbp1_6[]" id="pbp1_6" multiple="multiple" class="3col active">
		  ...
		  <label>Night Off</label>  
						  <select type="text" name="pbp1_7[]" id="pbp1_7" multiple="multiple" class="3col active">
