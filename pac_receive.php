...
$query45 = mysqli_query($db,"select * from pac_request where id='$id'");
...
$query = "UPDATE pac_request set reby='$user',retime='$dtime', status='RECEIVED',per_doc='$per_doc' where id='$id'"; 
...
<h1 align="center"style="background-color:lightgreen;">PAC RECEIVE PANEL</h1>
...
<td colspan="10"><select name="per_doc"  required>
            ...
            require('db1.php');
            $uname = '';
            $query_1 = "select * from `privilege` where status='Approved' and pname='PAC'";
...
<td colspan="2" align="center"><input type="text"  name="odate" required value="<?php echo $data45["r_s_t"]; ?>" readonly/></td>
<td colspan="8" align="center"><input type="text" name="otime" required value="<?php echo 'PAC'; ?>" readonly/></td>
