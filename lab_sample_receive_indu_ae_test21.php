...
$query1 = mysqli_query($db,"select * from einves where id='$barcode' and barcode2='' and barcode3=''");
...
$query11 = mysqli_query($db,"select * from einves where id='$barcode' and barcode2 !='' and barcode3 !=''");
...
$query111 = mysqli_query($db,"select * from einves where id='$barcode' and barcode2 !='' and barcode3 =''");
...
$query2 = mysqli_query($db,"select * from einves where id='$barcode' and barcode2 !=''");
...
$query3 = mysqli_query($db,"select * from einves where id='$barcode' and barcode3 !=''");
