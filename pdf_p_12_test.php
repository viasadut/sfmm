...
<div class="container">
	...
	if($data1['pdos']!='' and $data1['duration']!='' and $data1['frelation']!='')
				{			
                    $output .='
                            <tr>
                                <td><b>'.$count.'. </b></td>
				...
				else if($data1['pdos']!='' and $data1['duration']=='' and $data1['frelation']=='')
				{			
                    $output .='
                            <tr>
                                <td><b>'.$count.'. </b></td>
				...
				{			
                    $output .='
                            ...
                            <tr>
								...
								<td>'.$data1['pdos'].'('.$data1['duration'].')</td>
                            </tr>
                    ';
                    $count++;
                }
				...
				{			
                    $output .='
                            ...
                            <tr>
								...
								<td>'.$data1['pdos'].'('.$data1['frelation'].')</td>
                            </tr>
                    ';
                    $count++;
                }
