...
/*$query43 = "SELECT COUNT() FROM set_pic where pmrn= '$pmrn' and eid='$eid';"; 
...
<html>
<head>
    <title>Create Your Set Picture</title>
...
<div class="container">
    ...
    <h3>User ID: <?php echo $user?></h3>
    <form action="set_pic_upload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from set_pic where dname='$user';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="set_pic/<?php echo $image['iname'] ?>">
                        <img class="img-responsive" alt="" src="set_pic/<?php echo $image['iname'] ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $image['iname'] ?></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="set_pic_delete.php" method="POST">
