...
$ins_query="insert into papp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`height`,`weight`,`temp`,`page`,`psex`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$pheight','$pweight','$ptemp','$page','$psex')";
...
<div id='cssmenu'>
<ul>
   <li><a href='gg1.php'><span>Home</span></a></li>
...
<div1 align="left" style="font-weight:bold"><a href="view.php">BACK</a></div>
...
?>" size ="57">
			...
			<select name="slot"> <option>--Select--</option>
	   <?php 
	   $doc1= $_REQUEST['doc'];
			$sql = "select * from `test` where `dname`='$doc1' and `status`='AVAILABLE'and `ddate`='$date1'";
			$res = mysqli_query($con, $sql);
			if(mysqli_num_rows($res) > 0) {
				while($row = mysqli_fetch_object($res)) {
      ...
      <input name="padd" type="text" size="80">

	  <label for="age"><strong>Patient's Details :</strong></label>
	  	<select name="psex"> <option>--GENDER--</option>
			<option value="MALE">MALE</option>;
			<option value="FEMALE">FEMALE</option>;
			<option value="OTHERS">OTHERS</option>;
				
      </select>
      <input name="pmrn" type="text" size="15"Placeholder="Patient's MRN">
      <input name="pphone" type="text" size="13" Placeholder="Patient's Phone NO">	  
	  <input name="page" type="text" size="11"Placeholder="Patient's AGE">
      
	    <label for="age"  size="20%"><strong>Patient's Physical Examination :</strong></label>

	        <input name="pheight" type="text" size="21" placeholder="Height">
	        <input name="pweight" type="text" size="21" placeholder="Weight">
	        <input name="ptemp" type="text" size="20" placeholder="Temperature">
