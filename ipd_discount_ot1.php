  ...
  try {
      ...
      foreach ($_POST['update'] as $updateid) {
          ...
          $sqlTB1 = "INSERT INTO pms_tb (`trans_id`,`trans_type`,`acct_code`,`date`,`amount`,`location`)
                     VALUES ('$pmrn','DR','211170','$date','$eqty22','IPD_OT_DISCOUNT')";
...
?>
    <tr>
      ...
      <td align="center"><?php echo number_format($sum_bill5, 2); ?></td>
      <td align="center"><?php echo number_format($sum_bill55, 2); ?></td>
      <td align="center">
        <input name="eqty1_<?php echo $idRow; ?>" type="number"
               min="0" step="0.01" max="<?php echo $maxDis; ?>" required>
        <small style="display:block;color:#555;">
          Max: <?php echo number_format($maxDis, 2); ?>
        </small>
