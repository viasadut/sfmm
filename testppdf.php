...
$pdf->AddColMultiple('infusion',105,'Medicine');
$pdf->AddCol('instruc',100,'Instruction');
$pdf->AddCol('root',25,'Route','R');
$pdf->AddCol('time',14,'Time','C');
$pdf->AddCol('alert',16,'Caution','R');
$pdf->AddCol('signature',15,'Sign','R');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>1);
$pdf->Table($link,"select * from imedi2 where pmrn='$pmrn' and eid='$eid' and odate ='$dd' and status='Active'order by time",$prop);
$pdf->Output();
?>