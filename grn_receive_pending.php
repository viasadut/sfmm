...
<head>
<meta charset="utf-8">
<title>PO List (Excluding Full Received & Rejected)</title>
...
Today's <?php echo htmlspecialchars($full); ?>'s PO List (Pending / Partial Only)
</p>

<p align="right"><?php echo "Date: " . date('d/m/Y'); ?></p>

<form action="" method="GET">
<p ><a style="font-size:18px; font-weight:bold; color:green" href='grn_receive_pending'><span>Approved</span></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
WHERE p.po_type != 'Pharmacy'
  AND p.status != 'Rejected'   -- ❌ remove rejected
