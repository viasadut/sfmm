...
$query43 = "SELECT COUNT(pmrn) FROM dialysispapp where pmrn= '$pmrn' and discharge='';"; 
...
//$pt= $row['temp'];
//$pa= $row['padd'];
$query2 = "SELECT * from dialysismassess where pmrn='$pmrn' and eid='$eid'"; 
...
$ins_query="insert into dialysismassess (`dname`,`pname`,`pmrn`,`eid`,`psex`,`page`,`pphone`,`ward`,`bed`,`aform`,`adate`,`astime`,`shistory`,`ccom`,`pill`,`gexam`,`abdomen`,`res`,`car`,`nsys`,`ent`,`breast`,`gen`,`mus`,`ex`,`uro`,`func`,`diag`,`mplan`,`dplan`) values
...
<tr>
	  ...
	  <td colspan="10"><a target='_blank' href="dialysisdocassessprint.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>	
