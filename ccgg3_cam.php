...
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`,`user`,`yage`,`bdate`,`dis`,`aatime`,`adate1`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date10','$slot','NOT SEEN','$diff1','$psex','$fullname','$diff2','$date91','$dis','$aatime','$adate1')";
...
<!-- Form Title -->
        ...
        <fieldset>
			...
			<td><img alt="" src="prescription/prescription/upload/<?php echo $data['pic'] ?>" class="img-flex-rounded" width="100"  height="120" align="center"/>
			
			<a target='_blank' href="webcam?pmrn=<?php echo "$pmrn"; ?>"style="color:green" "font-weight:bold"><b>Take Picture</b></a>

<a target='_blank' href="https://192.168.100.252/sfmm/webcam?pmrn=<?php echo "$pmrn"; ?>"style="color:green" "font-weight:bold"><b>Take Picture</b></a>			
