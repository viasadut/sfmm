...
if($res95=mysqli_num_rows($result95)==0)
{
    ...
    echo '</script>';
			...
			*/
			...
			$ins_query1="insert into medi_stock (`code`,`g_name`,`b_name`,`add_qty`,`req_loc`,`status`,`location`,`rfid`,`sno`)
 values ('$code','$medi','$brand','$tprice','$p_mrn1','Pending','$p_mrn1','$sno','$runningTime')";
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "store_out.php?pmrn=" + str, true);
