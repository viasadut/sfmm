...
<?php	  $date=$row["date"] ;?>
	  <td align="center"><a target='_blank' href="historynewtest?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo $row["eid"]?>&date=<?php echo $row["date"]?>&dname=<?php echo $row["dname"]?>"><b>Details<b></a></td>
