...
$objDB1 = mysqli_select_db($objConnect,"sfmmkpjnew");
			...
			
	{
			...
			$strSQL = "update staff3_test set cfleave='8', c_forwad='8' where id='".$_POST["chkDel"][$i]."'";
...
//header("Location:$url");
	...
	else if($eqty2 < 8)
	{
			...
			$strSQL = "update staff3_test set cfleave='$eqty2', c_forward='$eqty2' where id='".$_POST["chkDel"][$i]."'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
			$objQuery = mysqli_query($objConnect,$strSQL);
...
$strSQL = "Select * from staff3_test where status= 'Active' order by `id` Asc;";
...
?>
     ...
     <td align="center" colspan="1"><?php echo $count; ?></td>
      ...
      <td align="center"colspan="2"><?php echo $row["sid"]; ?></td>
			...
			<td align="center"colspan="2"><?php echo $row["doj"]; ?></td>
