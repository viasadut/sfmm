...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(pmrn) FROM alltest WHERE pmrn='$pmrn' and eid='$eid'"));
...
$strSQL = "Select * from alltest where pmrn= '$pmrn' and eid='$eid' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");

$strSQL1 = "Select * from alltest where pmrn= '$pmrn' and eid='$eid' order by `id` desc;";
$objQuery1 = mysqli_query($objConnect,$strSQL1) or die ("Error Query [".$strSQL1."]");
$row4=mysqli_fetch_array($objQuery1);
$dname=$row4['dname'];

$strSQL2 = "Select * from doctor where dname= '$dname' and status in ('Active','active') order by `did` desc;";
$objQuery2 = mysqli_query($objConnect,$strSQL2) or die ("Error Query [".$strSQL2."]");
$row49=mysqli_fetch_array($objQuery2);



$row45=mysqli_fetch_assoc(mysqli_query($db,"SELECT SUM(price) FROM alltest WHERE pmrn='$pmrn' and eid='$eid'"));
...
<br><br>
	...
	<table width="100%">
            ...
            <table  width="100%" >
              <tr>
                        <td style="font-family: freesans;font-size:14px;" width="60%"> <b>Patient Name : <?php echo $row4['pname'];?></b>
                        <br><b>MRN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        : <?php echo $row4['pmrn'];?></b>
                        <br><b>Age &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        : <?php echo $row4['page'];?></b>
                        <br><b>Gender &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        : <?php echo $row4['pgender'];?></b><br>
                        
                        
                        </td>
                        
                        <td style="font-family: freesans; text-align:left;font-size:14px;" width="40%"><b>Consultant Name: <?php echo $row4['dname'];?></b>
...
<table width="100%">
              ...
              <tr>
                        ...
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="85%"><b>Investigation Name</b>
                        </td>
...
?>
                    ...
                    <tr>
                        ...
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="85%"><?php echo $row['medi'];?>
                        </td>
                        <td style="font-family: freesans; text-align:left;font-size:12px;" width="10%"><?php echo $row['price'];?>
                        </td>
...
?>
                ...
                <td style="font-family: freesans; text-align:left;font-size:14px;" width="30%"><b>Paymant Mode:</b>'.$row43['pmethod'].'
                </td>
                <td style="font-family: freesans; text-align:right;font-size:16px;" width="30%"><b>Grand Total:'.$row45['SUM(price)'].'</b>
                </td>';
                }
...
/*    function printPage(divName){
        ...
        $(document).ready(function() {
          let barcodeValue = <?= $_REQUEST['pmrn'] ?>;
