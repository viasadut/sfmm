...
$sel3="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '6C%' order by id desc limit 1";
...
$sel4="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '6D%' order by id desc limit 1";
...
$sel6="Select COUNT(id) from inpatient where room1 like '6C%' and discharge=''";

$resu6 = mysqli_query($con,$sel6);
$rw6 = mysqli_fetch_assoc($resu6);


$sel66="Select COUNT(id) from inpatient where room1 like '6D%' and discharge=''";
...
$sql="Select * from inpatient where room1 like '6C%' and discharge='' order by room1 asc";
$result = mysqli_query($con,$sql);
$count=1;



$sql1="Select * from inpatient where room1 like '6D%' and discharge='' order by room1 asc";
...
<tr>
		...
		<strong>6th Floor C Block</strong>&nbsp;&nbsp;
...
<tr>
		...
		<strong>6th Floor D Block</strong>&nbsp;&nbsp;
...
$txt='One Patient is Admitted in Block - 6C, Patient Name is-'.$tt4.' And Patient- '.'MRN'.$tt3;
