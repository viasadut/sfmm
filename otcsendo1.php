...
$ins_query="insert into endolab (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`status`) values ('$dname', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','Ordered')";
...
$count=1;
$sel_query="Select * from endolab where pmrn= '$pmrn' and eid='$eid' order by `id` DESC;";
