...
if($bt=="ALL")
{
$query43 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and status='collected'and lstatus='Received'"; 
...
$query44 = "SELECT COUNT(sid) FROM covidopd where ssent BETWEEN '$start' and '$end' and sentto='$bt' and status='collected' and lstatus='Received'"; 
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and status='collected' and lstatus='Received' order by ssent desc;";}
...
echo "  To  ";
echo $end;
	$sel_query="Select * from covidopd where ssent BETWEEN '$start' and '$end' and sentto='$bt' and status='collected' and lstatus='Received' order by lid asc;";}
