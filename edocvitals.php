...
<!-- Form Title -->
<h4>
<a target="_blank" href="g_chart_bp.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">BP Graph</a>&nbsp;&nbsp;<a target="_blank" href="g_chart_pulse.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Pulse Graph</a>&nbsp;&nbsp;<a target="_blank" href="g_chart_temp.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Temperature Chart</a>
&nbsp;&nbsp;<a target="_blank" href="saturation_chart.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Saturation Chart</a>
&nbsp;&nbsp;<a target="_blank" href="rr_chart.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Respiratory Rate Chart</a>
&nbsp;&nbsp;<a target="_blank" href="pain_score_chart.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Pain Score Chart</a>
&nbsp;&nbsp;<a target="_blank" href="g_chart_dia.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Diabetic Chart</a>
&nbsp;&nbsp;<a target="_blank" href="g_chart_fluid.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid";?>&odate1=<?php echo "$odate1";?>">Fluid Chart</a>
...
<td colspan="2" align="center"><label><strong>Pulse(BPM)</strong></label></td> 
...
<td colspan="2" align="center"><label><strong>Temperature (*F)</strong></label></td> 
