...
$end=date($id1 . date('t', strtotime($date)));
	   ...
	   while(strtotime($date) <= strtotime($end)) {
        ...
        echo "<th align='center'><a href='$url'>$day_num <br/> $day_name</a></th>";
    }
    ?>
...
$sel_query="Select * from staff3 where status ='Active' and dept='$dept' order by dept asc";
//$start=$row["aadate"];
$count=1;
...
$end1=date($id1 . date('t', strtotime($date1)));
	   ...
	   while(strtotime($date1) <= strtotime($end1)) {
		...
		//echo "<td>$date1</td>";
		 ...
		 $s2="Select COUNT(distinct(mor)),emor,id,location from roaster_2 where date='$dd' and mor='$uuid'";
$r2 = mysqli_query($con, $s2) or die(mysqli_error());
$row2 = mysqli_fetch_array($r2);
$n2=$row2['COUNT(distinct(mor))'];

		
  	 $s1="Select * from roaster_2 where date='$dd' and mor='$uuid'";
...
if($n2>0 and $row1['emor']=='Early') 
{
echo '<input type="button" style="background-color:lightgreen;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}


else if($n2>0 and $row1['emor']=='Morning') 
{
echo '<input type="button" style="background-color:green;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}

else if($n2>0 and $row1['emor']=='Late') 
{
echo '<input type="button" style="background-color:lime;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}


else if($n2>0 and $row1['emor']=='Night') 
{
echo '<input type="button" style="background-color:Olive;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}

else if($n2>0 and $row1['emor']=='On-Call') 
{
echo '<input type="button" style="background-color:purple;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}

else if($n2>0 and $row1['emor']=='24 Hour On-Call') 
{
echo '<input type="button" style="background-color:lightblue;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}

else if($n2>0 and $row1['emor']=='Off') 
{
echo '<input type="button" style="background-color:red;color:white;" name="edit" value="'.$row1['emor'].'-'.$row1['location'].'" id="'.$row1['id'].'" class="btn btn-info btn-xs edit_data">';
}
