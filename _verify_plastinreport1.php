...
$query = mysqli_query($db,"select * from plastin where pmrn='$pmrn' and eid='$eid' and sno='$id' order by id desc");
...
lab_render_approval_footer($pdf, $db1, 'HAEMATOLOGY', (isset($data3['resultby'])?$data3['resultby']:(isset($data['resultby'])?$data['resultby']:'')), (isset($data3['checked_by'])?$data3['checked_by']:''), (isset($data3['cby'])?$data3['cby']:''));
$pdf->Ln(10);
