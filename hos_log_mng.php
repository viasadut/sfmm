		...
		<tr><td colspan="20" align="right"><button onClick="goBack()">Back</button></td></tr>
				...
				<td colspan="20"><?php echo $data['sname'];?></td></tr>
					...
					<input type="hidden" name="new" value="1" />
						...
						<td colspan="5"><label><strong>Staff's ID:</strong></label></td>
						
						<td colspan="12"><label><strong>Staff's Name:</strong></label></td>
...
<tr>
	  ...
	  <td colspan="2" align="center"><strong>Staff Name</strong></td>
...
//$episode=$data["eid"];
$count=1;
$sel_query="Select * from hoslog where status!='Closed' order by `id` DESC;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><a href="hos_log_mng3?pmrn=<?php echo "$row[pmrn]"; ?>"><?php echo $row["pname"]; ?></a></td>
  ...
  <tr> <td colspan="20" bgcolor="lightgreen"style="font:Verdana, Arial, Helvetica, sans-serif large" style="font-weight:bold;color:red;"><b>Closed Work List<b> </td> </tr>
