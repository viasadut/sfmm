...
$ins_query1="insert into covid_r (`pname`,`pmrn`,`psex`,`page`,`dengue1`,`dengue2`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
...
<!-- Form Title -->
		<h1>COVID-19 Rapid Antibody Test FORM </h1>
	  ...
	  <label for="age"><strong>COVID-19 Rapid Antibody Test:</strong></label>
	  <label for="iron"><strong>Covid-19 IgM</strong></label>
      <input name="chikun1" type="text" size="70"  value=""required>
	  <label for="tibc"><strong>Covid-19 IgG</strong></label>
