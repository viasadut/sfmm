...
$query6 = mysqli_query($db,"select * from pylori where sno='$sno' and pmrn='$pmrn'");
$data66 = mysqli_fetch_assoc($query6);
...
$rr1='Sample Rate- :'.$chikun1."<br />".'Cut off Rate:'.$chikun3."<br />".'Opinion:'.$chikun2;

$rr='Sample Rate- :'.$chikun1."<br />".'Cut off Rate:'.$chikun3."<br />".'Opinion:'.$chikun2;



$ins_query1="update pylori set result='$chikun1',opinion='$chikun2',crate='$chikun3' where sno='$sno' and pmrn='$pmrn'";
mysqli_query($con,$ins_query1) or die(mysql_error());

$update="update alltest set resultstatus='Updated By Technologist',edittime='$adate',editby='$user',result='$rr',result1='$rr1' where id='$id'";
...
<!-- Form Title -->
		<h1>H.Pylori Qualitative Test</h1>
      ...
      <input name="chikun1" type="text" size="70" value="<?php echo $data66['result'];?>"required>
	  <label for="iron"><strong>Cut Off Rate</strong></label>
      <input name="chikun3" type="text" size="70"  value="<?php echo $data66['crate'];?>"required>
	  
	  <label for="tibc"><strong>Opinion</strong></label>
      <input name="chikun2" type="text" size="70" value="<?php echo $data66['opinion'];?>"required>
