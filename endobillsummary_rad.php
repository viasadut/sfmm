...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="Left"><?php echo $row["dreffer"]; ?>  
	       		   ...
	       		   <td align="left" ><a target='_blank' href="endobill_rad?pmrn=<?php echo $row["pmrn"]; ?>&dreffer=<?php echo $row["dreffer"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["ID"]; ?>">Details</a></td>
