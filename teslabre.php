...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from alltest where date='$date' and type='lab' and status='Received' and rstatus !='UPDATED' order by id desc;";
...
<td align="center"colspan="2"><a href="labtestin4?pmrn=<?php echo $row['pmrn']; ?>&id=<?php echo $row['id']; ?>&eid=<?php echo $row['eid']; ?>"><strong>UPDATE</strong></a></td>  	  

      </tr>
    <?php $count++; } ?>
	
<tr><td colspan='20'></td></tr><tr><td colspan='20'></td></tr><tr><td colspan='20'></td></tr><tr><td colspan='20'></td></tr><tr><td colspan='20'></td></tr><tr><td colspan='20'></td></tr><tr><td colspan='20'></td></tr><tr><td colspan='20'align="center"><strong>DONE REPORTS</strong></td></tr>
