...
$sel_query="Select * from emergency where discharge= '' order by adate2 desc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
	  ...
	  <td align="center"><a href="estat_new_phar?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Medicine</a></td>
	  <td align="center"><a href="infusionphar_new_ae?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Infusion</a></td>
