...
$query43 = "SELECT COUNT(ddrequest) FROM preadm where drsend between '$start' and '$end' and ddrequest='settled' and apstatus ='Approved' order by id desc";
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);

$query44 = "SELECT COUNT(ddrequest) FROM endopapp where drsend between '$start' and '$end' and ddrequest='settled' and apstatus ='Approved' order by id desc";
	 
$result44 = mysqli_query($con, $query44) or die(mysqli_error());
$row44 = mysqli_fetch_assoc($result44);

$c=$row43['COUNT(ddrequest)'] + $row44['COUNT(ddrequest)'];;
...
<h1 align="center">ALL Approved DD Request</h1>
...
$count=1;
$sel_query="Select * from preadm where drsend between '$start' and '$end' and ddrequest='settled' and apstatus ='Approved' order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td colspan="10">		<a target='_blank' href="finalprintdd1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
...
$sel_query="Select * from endopapp where drsend between '$start' and '$end' and ddrequest='settled' and apstatus ='Approved' order by id desc;";
...
{ ?>    <tr>
	  ...
	  <td colspan="10">	<a target='_blank' href="finalprintdd1endo?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["ID"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
	  <td colspan="5"><a target='_blank' href="dd_pv1?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["ID"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
