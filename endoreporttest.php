...
$sel90="SELECT * FROM mma1 WHERE `Proname`='$tname';";
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
		...
		<input list="tname" name="tname" class="form-control" value="" autocomplete="off">
...
$count=1;
$sel_query="Select * from endoreport where pmrn= '$pmrn' and eid='$eid'order by `id` DESC;";
