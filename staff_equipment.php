...
$ins_query="insert into staff_item (`sid`,`cname`,`cyear`,`remarks`,`date`,`user`,`status`,`date1`) values ('$sid', '$cname','$cyear','$remarks','$date','$user','active','$date1')";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Supply Form</strong></label></td> </tr>
<tr><td colspan="10" align="center"><label><strong>Item Name</strong></label></td> 
...
<td colspan="10">
	...
	<select  name="cname" required>
						...
						<?php 
			$sql76 = "select * from `sequipment` where status='approved' order by ename asc";
...
<td colspan="4"><input type="text" name="cyear" placeholder="Quantity" required></td>  
...
$count=1;
$sel_query="Select * from staff_item where sid= '$sid' and status='active' order by `id` DESC;";
...
{ ?>    <tr>
      ...
      <td align="center"colspan="2"><?php echo $row["sid"]; ?></td>
				  ...
				  <td align="center"colspan="3"><?php echo date('d/m/Y h:i:s',strtotime($row["date"])); ?></td>
				  <td align="center" colspan="1"><a href="deletepromotion12?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>">DELETE</a></td>
	...
	<tr><td colspan="20" align="right"bgcolor="lightgreen"><font size="6" color="#FF0000"><strong>Total Material Given:<?php echo $test1;?> (PC/S)</strong></td></tr>
</table>
</form>
</body>
