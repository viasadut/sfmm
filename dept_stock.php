...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from purchase_stock3 where add_qty>0 and location='Information Technology'  and status in('Served','Partially Served') and ack_by!='' ORDER BY id desc;";
...
<td align="center"style="font-size:18px;font-weight:bold;color:green;"><?php echo $row["sno"]; ?></td>
	  ...
	  <td align="left" colspan="20"><a target='_blank' href="department_bar_store.php?id=<?php echo $row['id']; ?>">bar_print</a></td>
