...
$queryn = "SELECT * FROM staff1 where mname= '$full'"; 
...
$query43 = "SELECT COUNT(sid) FROM attendance where sid= '$fullname' and adate BETWEEN '$start' and '$end';"; 
...
$count=1;
$sel_query="Select * from attendance where sid= '$fullname' and adate BETWEEN '$start' and '$end' order by id desc;"; 
