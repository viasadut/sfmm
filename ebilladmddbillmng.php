...
$update212="update preadm set pphone='$pphone1',fname='$fname', mname='$mname', dia1='$dia1',peradd='$peradd', nid='$nid1', pocu='$pocu', mincome='$mincome', wife='$wife', child='$child', isource='$isource', land='$land', service='$service', poss='$poss', political='$political',dia1='$dia1',cinfo='$cinfo',nidcard='$nidcard',bcard='$bcard',vgcard='$vgcard',ocard='$ocard',wcard='$wcard',hcard='$hcard',fcard='$fcard',bfigure='$bfigure',bword='$bword',ecost1='$ecost1', ddrequest='Settled',user='$user',scase='$scase',vpoor='$vpoor',aldate='$aldate',pvno='$pvno',pvdate='$pvdate',spcase='$spcase' where id='$id'";
mysqli_query($con,$update212);

$update22="update inpatient set bfigure='$bfigure',dia1='$dia1',cinfo='$cinfo',nidcard='$nidcard',ecost1='$ecost1',arequest='$arequest',user='$user',aldate='$aldate',pvno='$pvno',pvdate='$pvdate' where `pmrn`='$pmrn' and eid='$eid1'";
mysqli_query($con,$update22);
...
<label for="age" align="right"><strong><a  target='_blank' href="deathstatdetailsmng?pmrn=<?php echo $pmrn; ?>">Patient History</a></strong></label>
      ...
      <input name="pphone4" type="text" size="13" value="<?php echo $pphone6;?>" placeholder="Phone No" required>	  
	  <input name="page" type="text" size="2"value="<?php echo $data59['page'];?>" placeholder="Age" required readonly>
	  		...
	  		<label for="age"><strong>Patient's Diagnosis:</strong></label>
			  	...
			  	<textarea name="diagno" ><?php echo $data444['dia1'];?></textarea>
		
		<br><br>

		<label for="age"><strong>Father's / Husband Name :</strong></label>
...
<input name="vpoor" type="text" size="70" value="Very Poor"  >		<b>	  
<label for="age"><strong>Allocation Date:</strong></label>
<input type="text" name="aldate" id="datepicker" placeholder="MM/DD/YYYY" size="15" >

<label for="age"><strong>Payment Voucher NO :</strong></label>
<input name="pvno" type="text" size="70" value="<?php echo $data444['pvno'];?>"  />		<b>	  


<label for="age"><strong>Payment Voucher Date:</strong></label>
<input type="text" name="pvdate" id="datepicker1" placeholder="MM/DD/YYYY" size="15" >
...
//$id=$_REQUEST['ID'];
//$adate=$_REQUEST['adate'];
$query49 = mysqli_query($db,"select * from inpatient where pmrn='$pmrn' and eid='$eid';");
...
<td colspan="10">		<a target='_blank' href="admnewddnew?pmrn=<?php echo "$pmrn"; ?>&adoc=<?php echo $data49["adoc"]; ?>&adate=<?php echo $data49["adate"]; ?>&eid=<?php echo $eid; ?>&id=<?php echo $id; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr></table>
