...
$query39 = "SELECT * FROM endohoscharge1 where id= '$id'"; 
...
$data = array(
  ...
  $invoice_no=$decoded_response['invoice_id'];
   ...
   if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
      ...
      $ins_query="UPDATE endohoscharge1 SET api_status='1', invoice_no='$invoice_no' WHERE id='$id'";
