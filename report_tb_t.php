...
<tr>
	    ...
	    <?php 
                    $query = "Select SUM(amount) from pms_tb where date='2025-12-22' and trans_type='DR'";
                    ...
                    $query4 = "Select SUM(amount) from pms_tb where date='2025-12-22' and trans_type='CR'";
                    //$query = "Select * from medi_stock where add_qty>0 and status NOT IN ('Pending','Rejected')";
     ...
     <td align="center" ><?php echo $row4['SUM(amount)']; ?></td>
