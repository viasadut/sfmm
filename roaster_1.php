...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from roaster where date between '2021-08-01' and '2021-8-31' order by date asc";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><a href="roaster_11?date=<?php echo $row["date"]; ?>"><?php echo $row["date"]; ?></a>  
	  <td align="center"><a href="roaster_view2?id=<?php echo $row["location"]; ?>"><?php echo $row["location"]; ?></a>  
	  <?php
	  $id_in=$row['id'];
	  ?>
