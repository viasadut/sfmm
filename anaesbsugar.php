...
$ins_query="insert into anaesbsugar1 (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`infusion`,`user`,`status`,`odate1`,`time`,`date`,`status1`,`room`) values 
...
<td colspan="7" align="center"><label><strong>Blood Sugar</strong></label></td> 
...
$count=1;
$sel_query="Select * from anaesbsugar1 where pmrn= '$pmrn' and eid='$episode' and status1='Active'order by `id` DESC;";
