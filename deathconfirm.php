...
$sel_query1="Select * from death1 where estatus='Waiting Approval' and rto='$full' ORDER BY id asc;";
...
while($row1 = mysqli_fetch_assoc($result1)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row1["ward"]; ?>
      <td align="center"><?php echo $row1["bed"]; ?>  
	  <td align="center"><?php echo $row1["eid"]; ?>  


	  <td><a target='_blank' href="deathprint3.php?pmrn=<?php echo $row1["pmrn"]; ?>&eid=<?php echo $row1["eid"]; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>  

<td align="center" colspan="1"><a onclick="return confirm_click();" href="ideathupdate?id=<?php echo $row1["id"]; ?>&user=<?php echo "$fullname"; ?>">Confirm</a></td>	  
<td align="center" colspan="1"><a onclick="return confirm_click1();" href="ideathupdatere?id=<?php echo $row1["id"]; ?>&user=<?php echo "$fullname"; ?>">Reject</a></td>	  
      </tr>
    <?php $count++; } ?>
