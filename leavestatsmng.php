...
$queryn = "SELECT * FROM staff1 where mname= '$bt'"; 
...
$query43 = "SELECT COUNT(sid) FROM conleavedetails where (sid= '$bt' and status='Approved By ALL' and sdate BETWEEN '$start' and '$end') OR (sid= '$bt' and status='Approved By ALL' and edate BETWEEN '$start' and '$end');"; 
...
<h1 align="center">Leave Stats</h1>
...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
						...
						<td colspan="3"><label><strong>Select Consultant Name:</strong></label></td>	
...
<td colspan="3"><select name="bt" required>
						...
						<?php 
			$sql = "select * from `staff1` where ugroup='doctor' and astatus='Active' and stype='Permanent'";
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
   ...
   <tr>
	  ...
	  <th width="14%"><strong>Leave</strong>
...
$count=1;
$sel_query="Select * from conleavedetails where (sid= '$bt' and status='Approved By ALL' and sdate BETWEEN '$start' and '$end') OR (sid= '$bt' and status='Approved By ALL' and edate BETWEEN '$start' and '$end') order by id desc;"; 
