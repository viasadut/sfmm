<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('bill','mng','billin','staff')"; 
...
echo "<td align='center' style='background-color:lightgreen;'>".$tr."</td>";
	  ...
	  ?>
	  	  ...
	  	  <td align="Left"><a target='_blank' href="billotbill_new1_new?pmrn=<?php echo $row['pmrn']; ?>&id=<?php echo $row['id']; ?>&proce=<?php echo $row['proce']; ?>"><?php echo $row["proce"]; ?></a> 
