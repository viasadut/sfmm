...
$sel3="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '5C%' order by id desc limit 1";
...
$sel4="Select * from inpatient where '$ad3' between alert1 and alert2 and discharge='' and room1 like '5D%' order by id desc limit 1";
...
$sel6="Select COUNT(id) from inpatient where room1 like '5C%' and discharge=''";
...
$sel66="Select COUNT(id) from inpatient where room1 like '5D%' and discharge=''";
...
$sql="Select * from inpatient where room1 like '5C%' and discharge='' order by room1 asc";
$result = mysqli_query($con,$sql);
$count=1;



$sql1="Select * from inpatient where room1 like '5D%' and discharge='' order by room1 asc";
...
<tr>
		...
		<strong>5th Floor C Block</strong>&nbsp;&nbsp;
...
$n1=$data_baby1['beid'];
 ...
 echo"
  ...
  echo "</td>";
  $doc=substr($row['adoc'], 0, 20); 
  echo "<td colspan='2' >" . $doc . "</td>";
...
<tr>
		...
		<strong>5th Floor D Block</strong>&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
		...
		<td colspan='1' style='color:white;text-align:center;'></td>
	   </tr>
...
{ 
echo "<td colspan='1' style='background-color:lightgblue;'>C. Pending</td>";
}
...
$txt='One Patient is Admitted in Block - 5C, Patient Name is-'.$tt4.' And Patient- '.'MRN'.$tt3;
...
if($rw4==true){
							$txt='One Patient is Admitted in Block - 6D, Patient Name is-'.$tt66.' And Patient- '.'MRN'.$tt55;
  $txt1=htmlspecialchars($txt);
  $txt2=rawurlencode($txt1);
  $html=file_get_contents('https://translate.google.com/translate_tts?ie=UTF-8&client=gtx&q='.$txt2.'&tl=en-US');
