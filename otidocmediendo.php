...
$sel997="SELECT * FROM medicine WHERE `mname`='$infu';";
$result997 = mysqli_query($con,$sel997);
$res997=mysqli_fetch_assoc($result997);
$code=$res997['code'];
...
$selm="SELECT * FROM otendomedi WHERE `pmrn`='$pmrn' and eid='$id' and infusion='$infu';";
$resultm = mysqli_query($con,$selm);
...
$ins_query6="insert into otendomedi (`pmrn`,`pname`,`dname`,`eid`,`infusion`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`,`code`) values 
('$pmrn','$pname','$dname','$id','$infu','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime','$code')";
...
<td colspan="7" align="center"><input list="rr" name="infu"  class="form-control">
  <datalist id="rr">
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from otendomedi where pmrn= '$pmrn' and eid='$id'and status !='Cancel' and odate='$dd' and status1 !='Given' order by `infusion` and `time` asc;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="otidocstopendo?id3=<?php echo $row["id"]; ?>&id=<?php echo $id; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from otendomedi where pmrn= '$pmrn' and eid='$id'and status !='Cancel' and status1='Given' and odate='$dd'order by `infusion` and `time` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row["cuser"]; ?></td>
	  
	  <td align="center"colspan="2"><?php echo $row["cdate"]; ?></td>
	  <td align="center"colspan="1"<?php if($row['alert']== "H. Medi"): ?> style="background-color:RED;"<?php else: ?> style="background-color:lightblue;" <?php endif ; ?>>
        <?php echo $row['alert'];?></td>
  	  <td align="center"colspan="1"><?php echo $row["status1"]; ?></td>
