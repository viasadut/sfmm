...
$query = mysqli_query($db,"select * from con_work where pmrn='$pmrn' and dname='$dname' order by id desc limit 1");
...
$pdf->Cell('183',6,'PLAN FOR PROCEDURE',1,1,'C');
...
$pdf->Cell('48',5,$data['date'],0,0,'L');


$pdf->ln(5);
$pdf->SetFont('Arial' , 'b' , 12);
$pdf->Cell('40',5,'Consultant Name:',0,0,'L');
$pdf->Cell('100',5,$data['dname'],0,0,'L');
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['pro_name'],0,1);
$pdf->ln(3);

$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'LOCATION:',0,1,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['loc'],0,1);
