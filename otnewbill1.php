...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Second Surgeon Name</strong>
	  <th width="14%"><strong>Third Surgeon Name</strong>
...
$sel_query="Select * from ot where status='Received' and otdate='$date' ORDER BY dname asc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["pmrn"]; ?></a>
	  ...
	  <td align="center"><?php echo $row["procedure2"]; ?>  
		   ...
		   <td align="left" ><a target='_blank' href="otnewbill?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&id=<?php echo $row["id"]; ?>">Details</a></td>
