...
function showUser(str) {
  ...
  xmlhttp.open("GET","get_ap_data.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form>
 ...
 <select id="eee" name="users" onchange="showUser(this.value)" style='background-color:lightbllue;font-size:22px;font-weight:bold'>
