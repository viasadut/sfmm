...
$ins_query="insert into pappnew (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`height`,`weight`,`temp`,`page`,`psex`,`bill`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$pheight','$pweight','$ptemp','$page','$psex','$bill')";
...
?>" size="57">
		...
		<label for="mail"><strong>Appointment Date :</strong></label>
									<p>
									  <input type="text" name="date" id="datepicker" placeholder="Select Date" size="15" required/>
									  <input name="date11" type="text" value="HH<?php if(isset($_POST['load'])==1)
{ $date1 = $_REQUEST['date'];
echo $date1;
}
?>" size ="57">
      ...
      <input name="name" type="text" size="80" value="<?php echo $data["pname"]; ?>">
...
<label for="age"  size="20%"><strong>Patient's Physical Examination :</strong></label>
	        ...
	        <input name="ptemp" type="text" size="20" placeholder="Temperature" value="">
