...
$update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr' where id='$id'";
mysqli_query($con,$update) or die(mysql_error());
}

else if($curine=='Negative' and $crurine=='Negative' and $sediment=='Present'){
  $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr_1' where id='$id'";
  mysqli_query($con,$update) or die(mysql_error());
  }

else if($curine=='Positive' and $crurine=='Negative' and $sediment=='Absent'){
  $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr1' where id='$id'";
  mysqli_query($con,$update) or die(mysql_error());
  }

  else if($curine=='Positive' and $crurine=='Negative' and $sediment=='Present'){
    $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr1_1' where id='$id'";
    mysqli_query($con,$update) or die(mysql_error());
    }

  else if($curine=='Positive' and $crurine=='Positive' and $sediment=='Absent'){
    $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr3' where id='$id'";
    mysqli_query($con,$update) or die(mysql_error());
    }

    else if($curine=='Positive' and $crurine=='Positive' and $sediment=='Present'){
      $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr3_3' where id='$id'";
      mysqli_query($con,$update) or die(mysql_error());
      }

    else if($curine=='Negative' and $crurine=='Positive' and $sediment=='Absent'){
      $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr2' where id='$id'";
      mysqli_query($con,$update) or die(mysql_error());
      }

      else if($curine=='Negative' and $crurine=='Positive' and $sediment=='Present'){
        $update="update einves set resultstatus='Updated By Technologist',resulttime='$adate',resultby='$user',result='$rr2_2' where id='$id'";
        mysqli_query($con,$update) or die(mysql_error());
        }
...
r1='$aurine',r2='$surine',r3='$purine',
 r4='$prurine',r5='$gurine',r6='$kurine',r7='$burine',r8='$uurine',r9='$blurine',r10='$wurine',r11='$eurine',r12='$curine',r13='$crurine',r14='$baurine',r15='$yurine',r16='$ourine',result1='$rr1' where `sno`='$sno'";
