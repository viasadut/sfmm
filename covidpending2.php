...
$stmt1 = $db->query("SELECT COUNT(mname) as tt1 FROM staff1 where astatus='Active' and ugroup in ('imo','mofficer','mofficer') and tt=''");
...
$stmt = $db->query("Select * from staff1 where astatus='Active' and ugroup in ('imo','mofficer','mofficer') and tt='' order by sdepartment asc;");
