...
function Header()
{
    ...
    $this->Cell(0,6,' Inpatient Investigation Request Form (OT)',0,1,'C');
...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers: Ambulance: +880244077029, +8801791987466,Appointments: +880244077030,+8801703788561 (SFMMKPJSH/LAB/MR-01)',0,0,'C');
...
$dd=date('m/d/Y');
$dd1=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from iinves where pmrn='$pmrn' and eid='$eid' " );
...
$pdf->AddCol('user',35,'Order BY','L');
$pdf->AddCol('odate',45,'Order Date','L');
$pdf->AddCol('infusion',95,'Investigation');
$pdf->AddCol('room',30,'Instruction');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from iinves where pmrn='$pmrn' and eid='$eid' and ordate='$dd' and type='lab'and location='OT' and rstatus  not in ('RECEIVED','REJECTED','Cancelled')",$prop);
$pdf->Output();
?>