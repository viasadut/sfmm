...
<!-- Form Title -->
        <table align="center" class="table table-bordered" id="dynamic_field">  
           ...
           <option value='Pharmacy_opd'>Pharmacy_opd</option>
           <option value='Pharmacy_ipd'>Pharmacy_ipd</option>
...
<option value='HMD'>HMD</option>
	...
	<option value='Maternity Suite'>Maternity Suite</option>
		...
		<option value='Radiology And Imaging Services'>Radiology And Imaging Services</option>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <th width="14%"style="font-size:20px;font-weight:bold;color:red;"><strong>Serve QTY</strong>
    <th width="14%"style="font-size:20px;font-weight:bold;color:red;"><strong>Given QTY</strong>
...
$sel_query="Select distinct(code),g_name,b_name,location,given_qty,s_qty from medi_stock where location='$start' and add_qty>0 and status NOT IN ('Pending','Rejected') ORDER BY g_name asc;";
...
$id = $row['id'];
 ...
 $sum = "SELECT SUM(add_qty), SUM(given_qty), SUM(s_qty) FROM medi_stock where code='$mcode' and location='$start' and status in('Served','Partially Served','')" ;
...
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $sumr['SUM(s_qty)']; ?></td>
<td align="center"style="font-size:20px;font-weight:bold;color:green;"><?php echo $sumr['SUM(given_qty)']; ?></td>
