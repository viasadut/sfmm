...
$ff=date('Y-m-d');
$query43 = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid'"; 
	 
$result43 = mysqli_query($con, $query43) or die(mysqli_error());
$row43 = mysqli_fetch_assoc($result43);


$query43s = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp='Staff'"; 
	 
$result43s = mysqli_query($con, $query43s) or die(mysqli_error());
$row43s = mysqli_fetch_assoc($result43s);

$query43o = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp in('OPD')"; 
	 
$result43o = mysqli_query($con, $query43o) or die(mysqli_error());
$row43o = mysqli_fetch_assoc($result43o);

$query43i = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp='InPatient'"; 
	 
$result43i = mysqli_query($con, $query43i) or die(mysqli_error());
$row43i = mysqli_fetch_assoc($result43i);

$query43c = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp='Corporate'"; 
	 
$result43c = mysqli_query($con, $query43c) or die(mysqli_error());
$row43c = mysqli_fetch_assoc($result43c);

$query43p = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp='Police'"; 
	 
$result43p = mysqli_query($con, $query43p) or die(mysqli_error());
$row43p = mysqli_fetch_assoc($result43p);

$query43ot = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp='Outsource'"; 
	 
$result43ot = mysqli_query($con, $query43ot) or die(mysqli_error());
$row43ot = mysqli_fetch_assoc($result43ot);

$query43out = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid' and tp='Outside'"; 
...
<h1 align="center">Covid-19 Stats Report (<?php echo "Date:" ?> <?php echo date('d/m/Y')?>)</h1>
...
echo   $row43['COUNT(id)'].'( Staff - '.$row43s['COUNT(id)'].', OPD - '.$row43o['COUNT(id)'].', IPD - '.$row43i['COUNT(id)'].', Corporate - '.$row43c['COUNT(id)'].', Police - '.$row43p['COUNT(id)'].', Outsource - '.$row43ot['COUNT(id)'].', Outside - '.$row43out['COUNT(id)'].')';
	 ...
	 $sel_query="Select count(id) as s,udone from covidopd where ssent='$ff' and bstatus='Paid' group by udone;";
...
{ ?>    <tr>
	  ...
	  <?php 
$query46 = "SELECT COUNT(id) FROM covidopd where ssent='$ff' and bstatus='Paid'"; 
