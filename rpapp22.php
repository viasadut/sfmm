...
<?php 
    ...
    if(!isset($_SESSION['sess_username']) || $role!="sfsdf"){
...
$ins_query1="insert into patient (`pname`,`pmrn`,`padd`,`psex`,`page`,`pphone`,`bdate`) values ('$pname','$pmrn','$padd','$psex','$diff1','$pphone','$date91')";
...
echo '<script language="javascript">';
    echo 'alert("Entry Not Successful"); ';
    echo '</script>';
