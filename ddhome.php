...
<tr><td colspan="20"align="center"bgcolor="lightgreen"><h3> Please Select Your Desire Module</h3></td></tr>
		...
		<tr><td colspan="20"align="left"><a href="ddpendingrequestmd"><font size="4.5">	Pending DD Fund Request For Approval</a>
		
		
		<font size="4.5" color="#FF0000"><b>(
	<?php
	if($full==='Dr. J.M.H Qausar Alam')
	{ 
echo  $row25['COUNT(apstatus)'] + $row26['COUNT(apstatus)'];
} 
else if
($full==='Dr. Razeeb Hassan')
	{ 
	echo  $row23['COUNT(apstatus)'] + $row24['COUNT(apstatus)'];}
	
	else if
($full==='Amit Kumar Dhali')
	{ 
	...
	?>)<b>
		...
		<tr><td colspan="20"align="left"><a href="ddstatssp"><font size="4.5">	Doridro Fund Stats(Special Case)</a></td>	</tr>
	<tr><td colspan="20"align="left"><a href="ddstats1"><font size="4.5">	Amount Wise Doridro Fund Stats (Based on Suggested Date Of Admission)</a></td>	</tr>
	<tr><td colspan="20"align="left"><a href="ddstats2"><font size="4.5">	Consultant Wise Doridro Fund Stats (Based on Suggested Date Of Admission)</a></td>	</tr>
	<tr><td colspan="20"align="left"><a href="ddstats3"><font size="4.5">	Allocation Datewise Doridro Fund Stats</a></td>	</tr>
	<tr><td colspan="20"align="left"><a href="ddstats4"><font size="4.5">	Payment Voucher Datewise Doridro Fund Stats</a></td>	</tr>
		<tr><td colspan="20"align="left"><a href="manualesearchdd1"><font size="4.5">Pending Doridro Fund Request</a></td>	</tr>
		<tr><td colspan="20"align="left"><a href="manualesearchddbillmng"><font size="4.5">Retrive DD Request(IPD)</a></td>	</tr>
		<tr><td colspan="20"align="left"><a href="manualesearchddbillendomng"><font size="4.5">Retrive DD Request(ENDO DAYCARE)</a></td>	</tr>
		
		<tr><td colspan="20"align="left"><a href="ddstats7"><font size="4.5">Datewise Amount (Approved/Unapproved)</a></td>	</tr>
		<tr><td colspan="20"align="left"><a href="ddmanualbill"><font size="4.5">Manual Request</a></td>	</tr>
		<tr><td colspan="20"align="left"><a href="dd_fund"><font size="4.5">Set Monthly Amount</a></td>	</tr>
		<tr><td colspan="20"align="left"><a href="ddpendingrequestmdpv"><font size="4.5">Update PV NO</a></td>	</tr>
