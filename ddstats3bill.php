...
$query443 = "SELECT COUNT(bfigure) FROM preadm where bfigure >5000 and bfigure <=10000  and  aldate BETWEEN '$start' and '$end';"; 
	 
$result443 = mysqli_query($con, $query443) or die(mysqli_error());
$row443 = mysqli_fetch_assoc($result443);


$querye443 = "SELECT COUNT(bfigure) FROM endopapp where bfigure >5000 and bfigure <=10000 and  aldate BETWEEN '$start' and '$end';"; 
...
$querye50 = "SELECT bfigure, SUM(bfigure) FROM endopapp where bfigure !='0'  and aldate BETWEEN '$start' and '$end';";
