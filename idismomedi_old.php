...
$ins_query="insert into alltest (`dname`,`pmrn`,`pname`,`eid`,`medi`,`ins`,`date`,`type`,`date`,`otime`,`oby`,`status`) values ('$full', '$pmrn','$pname','$eid','$medi','$pins','$date','$type','$date','$otime','$user','Active')";
...
$ins_query1="insert into idismedi (`pmrn`,`pname`,`medi`,`pdos`,`eid`,`date`,`brand`,`status`,`otime`,`oby`) values ('$pmrn','$pname','$medi1','$pdos','$eid','$date1','$brand2','Active','$otime','$user')";
...
<td align="center" colspan="2"><a href="idismomedidelete?id=<?php echo $row["id"]; ?>&pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>">DELETE</a></td>
