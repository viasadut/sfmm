...
$ins_query="insert into radpapp (`pname`,`pmrn`,`pphone`,`dname`,`status`,`page`,`psex`,`dreffer`,`tname`,`btime`,`a_no`,`link`,`adate`,`aslot`,`ineid`,`location`,`adate1`) 
values ('$pname', '$pmrn','$pphone','$dname','NOT SEEN','$ppage','$psex','$ddname','$tname','$btime','$a_id','$link','$date1','$slot','$eidin','A&E','$adate1')";
mysqli_query($con,$ins_query);
...
$ins_querypac="insert into his_order (`Accession_Number`,`Modality`,`Patient_Name`,`Patient_ID`,`Patient_Sex`,`Req_Proc_Desc`,`Sch_Station_AE_Title`,`Sch_Station_Name`,
`Sch_Proc_Step_Start_Date`,`Sch_Proc_Step_Start_Time`,`Sch_Proc_Step_Desc`,`Sch_Proc_Step_ID`,`Req_Proc_ID`,`Order_Status`,`Ref_Physician_Name`,`Patient_Age`,`Requesting_Physician`,`Institution_Name`,`Patient_Birth_Date`,`Patient_Weight`,`adate1`) values 
('$a_id','$dname','$pname','$pmrn','$psex','$tname','CALYPSO','$dname','$app_date','$slot','$tname','$a_id','$a_id','1','$ddname','','','SFMMKPJSH','$age1','000.000','$adate1')";
mysqli_query($con,$ins_querypac);
...
$ins_query="insert into radpapp (`pname`,`pmrn`,`pphone`,`dname`,`status`,`page`,`psex`,`dreffer`,`tname`,`btime`,`a_no`,`link`,`ineid`,`location`,`adate1`) 
values ('$pname', '$pmrn','$pphone','$dname','NOT SEEN','$ppage','$psex','$ddname','$tname','$btime','$a_id','$link','$date1','$slot','$eidin','A&E','$adate1')";
mysqli_query($con,$ins_query);
...
$ins_query="insert into radpapp (`pname`,`pmrn`,`pphone`,`dname`,`status`,`page`,`psex`,`dreffer`,`tname`,`btime`,`a_no`,`link`,`adate`,`aslot`,`ineid`,`location`,`adate1`) 
values ('$pname', '$pmrn','$pphone','DX','NOT SEEN','$ppage','$psex','$ddname','$tname','$btime','$a_id','$link','$date1','$slot','$eidin','A&E','$adate1')";
mysqli_query($con,$ins_query);
...
$ins_query="insert into radpapp (`pname`,`pmrn`,`pphone`,`dname`,`status`,`page`,`psex`,`dreffer`,`tname`,`btime`,`a_no`,`link`,`adate`,`aslot`,`ineid`,`location`,`adate1`) 
values ('$pname', '$pmrn','$pphone','US','NOT SEEN','$ppage','$psex','$ddname','$tname','$btime','$a_id','$link','$date1','$slot','$eidin','A&E','$adate1')";
mysqli_query($con,$ins_query);
