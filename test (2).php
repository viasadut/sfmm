...
<p align="center" class="style1">PRINT OPD PRESCRIPTION </p> 
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
      ...
      <th width="14%"><strong>Doctor's Name</strong>   
	        <th width="14%"><strong>Patient's P.No</strong>   
...
//$id =$_GET['id'];
$count=1;
$sel_query="Select * from presnew where date='$date' ORDER BY date desc;";
