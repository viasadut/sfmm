...
<h1 align="center">Consultant Wise Death Stats</h1>
...
$sel_query="Select * from deathn where  rdate BETWEEN '$start' and '$end' order by rdate asc";}
 else{
	 
	 $sel_query="Select * from deathn where rdoc='$bt' and rdate BETWEEN '$start'and '$end' order by rdate asc";
	 echo "<font color=blue font size=5> Total Record found in the search  -";
