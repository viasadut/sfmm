...
$query = mysqli_query($con,"select * from pac_new where id='$id'");
...
<table width="100%">
                    <tr>
                        ...
                        <td width="100%" align="center" style="font-size:17px;text-decoration: underline;"><b>PAC REPORT</b></td>
...
<br><br>
                <table style=cellspacing="0" cellpadding="1">
					...
					<tr>
                        <td align="left"><b>Proposed Anaesthesia:</b> '.$data['p_anaes'].'</td>
                        
                    </tr>
					<tr>
                        <td align="left"><b>Mallampati Score: </b>'.$data['mala'].'</td>
                        
                    </tr>
					<tr>
                        <td align="left"><b>ECoG Performance score:</b> '.$data['ecog'].'</td>
                        
                    </tr>
					<tr>
                        <td align="left"><b>ASA physical status classification:</b> '.$data['asa'].'</td>
                        
                    </tr>
					<tr>
                        <td align="left"><b>Final Comments:</b> '.$data['f_com'].'</td>
