...
//{
	...
	$url = "cbc_view_result1_test?inid=$sno&id=$id" ;
header("Location:$url");
...
<!-- Form Title -->
	 ...
	 <label for="age"><strong>Patient's Name :</strong></label>
      ...
      <span><input name="wbc" id="wbc" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
document.getElementById('wbc').onchange= f_color6;
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="red" id="red" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('red').onchange= f_color14;
	   ...
	   <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input name="haemo" id="haemo" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('haemo').onchange= f_color15;
	  ...
	  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input name="pcv" id="pcv" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('pcv').onchange= f_color13;
      ...
      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mcv" id="mcv" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('mcv').onchange= f_color12;
      ...
      <input name="mch" id="mch" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('mch').onchange= f_color11;
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mchc" id="mchc" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="pla" id="pla" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('pla').onchange= f_color8;
	  ...
	  <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="rdw" id="rdw" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('rdw').onchange= f_color9;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mpv" id="mpv" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('mpv').onchange= f_color7;
	  ...
	  <input name="neu" id="neu" type="number"  style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('neu').onchange= f_color5;
	  ...
	  <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="lym" id="lym" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('lym').onchange= f_color4;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mono" type="number" id="mono" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('mono').onchange= f_color2;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="eos" id="eos" type="number" style="font-weight: bold;font-size:22px;" value=""required step=".01">
...
document.getElementById('eos').onchange= f_color3;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="bas" type="number" value="" id="bas" required style="font-weight: bold;font-size:22px;" step=".01">
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="esr" type="number" value=""required id="esr" style="font-weight: bold;font-size:22px;" step=".01">
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="promyclocyte" type="number" value=""required style="font-weight: bold;font-size:22px;" step=".01">
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="metamyclocyte" type="number" value=""required style="font-weight: bold;font-size:22px;" step=".01">
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="lymphoblast" type="number" value=""required style="font-weight: bold;font-size:22px;" step=".01">
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="myoblast" type="number" value=""required style="font-weight: bold;font-size:22px;" step=".01" >
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
<input name="nrbc" type="number" value=""required style="font-weight: bold;font-size:22px;" step=".01">
...
Confirm: <input type="checkbox" id="vehicle1" name="vehicle1" value="." required>
