...
<p align="right"style="color:white;"> <b><?php echo "(Agreed- Means Consultant will take responsibilities of the consultant who is going on leave) " ?>  <b></p>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="14%"><strong>Agreed</strong>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from conleavedetails where status='Approval Pending' and rdoc='$full'";
//$start=$row["aadate"];
...
<td align="center"><a onclick="return confirm_click();" href="leaveapprove1doc?id=<?php echo $row["id"]; ?>"><strong>Agreed</strong></a></td>
<td align="center"><a href="rejectrdoc?id=<?php echo $row["id"]; ?>"><strong>Reject</strong></a></td>
