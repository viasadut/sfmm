...
function Header()
{
    ...
    $this->Cell(0,6,' Daily Special Treatment Order Sheet',0,1,'C');
...
$this->ln(2);
$this->SetFont('Arial','B',8);
$this->Cell(0,10,'Contact Numbers:  Ambulance:  +880244077029, +8801791987466, Appointments: +880244077030, +8801703788561 (SFMMKPJSH/IPD/MR-06)',0,0,'C');
...
$eid=$_REQUEST['eid'];
$dd=date('m/d/Y');
$query = mysqli_query($link,"SELECT * from istret where pmrn='$pmrn' and eid='$eid' " );
...
$pdf->AddCol('infusion',45,'Special Treatment');
$pdf->AddCol('dtime',160,'Instruction');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from istret where pmrn='$pmrn' and eid='$eid' and odate='$dd' and status1 !='Cancel'order by odate",$prop);
$pdf->Output();
?>