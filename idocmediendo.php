...
$ins_query6="insert into endomedi (`pmrn`,`dname`,`eid`,`infusion`,`instruc`,`alert`,`orderby`,`odate`,`status`,`root`,`status1`,`pstatus`,`ortime`) values ('$pmrn','$dname','$eid','$infu','$ddate','$alert','$user','$date1','Active','$root','Rupdated','Ordered','$ortime')";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from endomedi where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and odate='$dd'order by `infusion` and `time` asc;";
...
<td align="center" colspan="1"><a onclick="return confirm_click();" href="idocstopendo?id=<?php echo $row["id"]; ?>&eid=<?php echo $row["eid"]; ?>&pmrn=<?php echo $row["pmrn"]; ?>">Stop</a></td>
