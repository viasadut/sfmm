...
$query43 = "SELECT COUNT(bfigure) FROM preadm where bfigure !='0' and ddrequest='settled' and  snew BETWEEN '$start' and '$end';"; 
...
$query498 = "SELECT bfigure, SUM(bfigure) FROM preadm where bfigure !='0' and snew BETWEEN '$start' and '$end';";
...
<h1 align="center">Doriddro Fund Reports</h1>
