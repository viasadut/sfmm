...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			$strSQL = "UPDATE imedi3 set status1='Returned', ruser='$user', rdate='$pdate' ";
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid'and status in ('Cancel','Active') and status1 in ('Rupdated','Cancel') and pstatus='Served' order by `infusion` asc;";
...
<tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>List Of Unsed Infusion</strong></label></td> </tr>
...
$sel_query1="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid'and status in ('Data Updated','Cancel') and status1 in ('Active','Cancel') and pstatus='Served' order by `infusion` asc;";
...
{ ?>    <tr>
	  ...
	  <td align="center"colspan="1"><?php echo $row1["user"]; ?></td>
	  <td align="center"colspan="1"><?php echo $row1["odate"]; ?></td>
      <td align="center"colspan="1"><?php echo $row1["otime"].' TO '.$row1["otime1"]; ?></td>  
	  <td align="center"colspan="7"><?php echo $row1["infusion"]; ?></td>
	  <td align="center"colspan="2"><?php echo $row1["addi"]. '  '.$row1["add1"]; ?></td>
	  <td align="center"colspan="5"><?php echo $row1["infu1"]; ?></td>
	  <td align="center"colspan="1"><?php echo $row1["pstatus"]; ?></td>
	...
	<tr><td colspan="20"><a target='_blank' href="returnmeditest.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td>
...
<table align="center" class="table table-bordered" id="dynamic_field">  
 <tr><td colspan="20" align="center"bgcolor="lightgreen"><label><strong>Returned Medicine List</strong></label></td> </tr>
...
$dd=date('m/d/Y');
$count=1;
$sel_query="Select * from imedi3 where pmrn= '$pmrn' and eid='$eid'and status !='Cancel' and status1='Returned' and pstatus='Served' order by `infusion` asc;";
...
$sel_query1="Select * from iinfusion where pmrn= '$pmrn' and eid='$eid'and status in ('Returned') and status1 in ('Active','Cancel') and pstatus='Served' order by `infusion` asc;";
...
<tr><td colspan="5"><a target='_blank' href="testpdfpharreturntest.php?pmrn=<?php echo "$pmrn"; ?>&eid=<?php echo "$eid"; ?>"><img src="print.png" title="Print Report" width="150" height="60" /></a></td></tr>	 
</table>
