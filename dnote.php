...
$ins_query="insert into cnote (`dname`,`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`room`,`bed`,`odate`,`otime`,`inves`,`infusion`,`pnote`) values ('$dname', '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$room','$bed','$odate','$otime','$inves','$infu','$pnote')";
...
<tr><td colspan="1" align="center"><label><strong>Date</strong></label></td> 
<td colspan="2" align="center"><label><strong>Time</strong></label></td> 
<td colspan="3" align="center"><label><strong>Pain Score</strong></label></td> 
<td colspan="6" align="center"><label><strong>Progress Note</strong></label></td> 
<td colspan="8" align="center"><label><strong>Investigation/Treatment Plan</strong></label></td></tr>

<tr>
<td colspan="1" align="center"><input type="date"  name="odate" required value="" /></td>
<td colspan="2" align="center"><input type="text" name="otime" required value="" /></td>
<td colspan="3" align="center"><input type="text" name="infu" required value="" /></td>
<td colspan="6" align="center"><textarea rows="2"  name="pnote" required value=""></textarea></td>
