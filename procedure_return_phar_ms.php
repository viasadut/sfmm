...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','msuite')"; 
...
<input type="text" id="pmrn" onkeyup="GetDetail(this.value)" class="form-control action" list="categoryname" autocomplete="off" name='code' required style="font-weight: bold;font-size:22px;color:green">
	...
	<option value=''>-Select-</option>
            ...
            require('db1.php');
            $uname = '';
            $query = "select * from `medi_stock` where add_qty>0 and location in('Maternity Suite')";
...
$count=1;
//$count=1;
$sel_query="Select * from medi_stock1 where rfid= '$sno' and req_loc in('Maternity Suite') order by `id` DESC;";
