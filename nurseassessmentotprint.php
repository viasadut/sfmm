...
$query = mysqli_query($db,"SELECT * from nurseassessot where pmrn='$pmrn' and eid='$id'" );
$data = mysqli_fetch_array($query);
//$dname=$data['dname'];

$query2 = mysqli_query($db,"SELECT * from ot where pmrn='$pmrn' and id='$id'");
...
$query4 = mysqli_query($db,"SELECT * from friskot where pmrn='$pmrn' and eid='$id'");
