...
$ins_query1="update radio set remarks='$remarks',reference='$reference', ref2='$ref2', etime='$adate', eby='$user' where id='$id'";
mysqli_query($con,$ins_query1) or die(mysql_error());

$ins_query2="update radio1 set remarks='$remarks',reference='$reference', ref2='$ref2',etime='$adate', eby='$user' where id='$id'";
mysqli_query($con,$ins_query2) or die(mysql_error());

$ins_query3="update radio2 set remarks='$remarks',reference='$reference', ref2='$ref2',etime='$adate', eby='$user' where id='$id'";
...
<!-- Form Title -->
      ...
      <input name="bname" type="text" size="70" style="text-transform:uppercase" value="<?php echo $row1["type"];?>"readonly/>
	   
      <label for="age"><strong>Reference(From) :</strong></label>
      <input type="number" name="reference" id="reference" style="text-transform:uppercase" value="<?php echo $row1["reference"];?>" step="any"></input>

	  <label for="age"><strong>Reference(To) :</strong></label>
    <input type="number" name="ref2" id="reference4" style="text-transform:uppercase" value="<?php echo $row1["ref2"];?>" step="any"></input>
