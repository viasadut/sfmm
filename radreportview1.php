...
<td colspan="3"><label><strong>TB:</strong></label></td>
<td colspan="3"><label><strong>Asthma:</strong></label></td>
...
<td colspan="3"><?php echo $row['ptb'];?></td>
<td colspan="3"><?php echo $row['pasthma'];?></td>
...
<td colspan="3"><?php echo $row['ptb1'];?></td>
<td colspan="3"><?php echo $row['pasthma1'];?></td>
...
<tr>
<td colspan="4"><?php echo $row['pperiod'];?></td>
<td colspan="4"><?php echo $row['plmp'];?></td>
<td colspan="4"><?php echo $row['pnochild'];?></td>
<td colspan="4"><?php echo $row['plchild'];?></td>
<td colspan="4"><?php echo $row['pmeno'];?></td>
</tr>
<tr>
<td colspan="4"><?php echo $row['pperiod1'];?></td>
<td colspan="4"><?php echo $row['plmp1'];?></td>
<td colspan="4"><?php echo $row['pnochild1'];?></td>
<td colspan="4"><?php echo $row['plchild1'];?></td>
<td colspan="4"><?php echo $row['pmanopause1'];?></td>
</tr>
