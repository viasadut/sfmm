...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('ot','pharmacy')"; 
...
$sel96="SELECT * FROM medi_stock1 WHERE `rfid`='$code' and add_qty!='0' limit 1;";
...
$new_qty=$b_chk_m['add_qty']-$tprice;

$query3 = "SELECT * FROM othoscharge1 where pmrn= '$pmrn' and eid='$id' and date='$date1' and medi='$medi1'"; 
	 
$result3 = mysqli_query($con, $query3);

// Print out result

$query4 = "SELECT * FROM othoscharge1 where pmrn= '$pmrn' and eid='$id' and date='$date1'and medi='$medi1'"; 
	 
$result4 = mysqli_query($con, $query4);

$row3 = mysqli_fetch_array($result4);
$pdos1=$row3['pdos'];
$pdos2=$row3['pdos']+$tprice;
...
$ins_query3="update medi_stock1 set `add_qty`='0' where id='$row_id'";
mysqli_query($con,$ins_query3) or die(mysql_error());
			
$sel97="SELECT * FROM medi_stock1 WHERE `rfid`='$code' and add_qty!='0' limit 1;";
$result97 = mysqli_query($con,$sel97);
$b_chk_8=mysqli_fetch_assoc($result97);

$row_id2=$b_chk_8['id'];
$l_qty=$b_chk_8['add_qty'];


$sec_qty=$l_qty-($tprice-$mm_qty);



$ins_query4="update medi_stock1 set `add_qty`='$sec_qty' where id='$row_id2'";
...
if($res90=mysqli_num_rows($result3)>0){
		...
		$ins_query1="Update othoscharge1 set pdos='$pdos2',ins='$pp2' where eid='$id' and pmrn='$pmrn' and medi='$medi1'";
...
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`dateb`,`pdos`,`code`,`ins`) values ('$pmrn','$pname','$medi1','$id','$date1','$tprice','$dcode','$pp1')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
}
...
$ins_query3="update medi_stock1 set `add_qty`='$new_qty' where id='$row_id'";
mysqli_query($con,$ins_query3) or die(mysql_error());
...
$ins_query1="insert into othoscharge1 (`pmrn`,`pname`,`medi`,`eid`,`date`,`pdos`,`code`,`ins`) values ('$pmrn','$pname','$medi1','$id','$date1','$tprice','$dcode','$pp1')";
mysqli_query($con,$ins_query1) or die(mysql_error());}
}
...
<tr>
<td colspan="10" align="center"><input type="text" name="p_name" id="" required value="<?php echo $pname;?>" style="font-weight: bold;font-size:22px;color:green"></td> 
<td colspan="10" align="center"><input type="text" name="p_mrn" id=""  value="<?php echo $pmrn;?>" style="font-weight: bold;font-size:22px;color:green"></td>
</tr>
...
//						document.getElementById(
	//						"page").value = myObj[1];
				...
				xmlhttp.open("GET", "dept_medicine_panel1.php?pmrn=" + str, true);
