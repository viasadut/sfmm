...
$query27 = "SELECT COUNT(id) FROM tm3 where date1='$dt'"; 
$result27 = mysqli_query($con, $query27) or die(mysqli_error());
$row27 = mysqli_fetch_array($result27);


$query28 = "SELECT COUNT(id) FROM tm3 where date1='$dt' and status='P'"; 
$result28 = mysqli_query($con, $query28) or die(mysqli_error());
$row28 = mysqli_fetch_array($result28);


$query29 = "SELECT COUNT(id) FROM tm3 where date1='$dt' and status='LT'"; 
$result29 = mysqli_query($con, $query29) or die(mysqli_error());
$row29 = mysqli_fetch_array($result29);


$query30 = "SELECT COUNT(id) FROM tm3 where date1='$dt' and status='A'"; 
$result30 = mysqli_query($con, $query30) or die(mysqli_error());
$row30 = mysqli_fetch_array($result30);



$query31 = "SELECT COUNT(id) FROM tm3 where date1='$dt' and status='L'"; 
$result31 = mysqli_query($con, $query31) or die(mysqli_error());
$row31 = mysqli_fetch_array($result31);


$tp1=$row28['COUNT(id)']+$row29['COUNT(id)'];
$tmp1=$row27['COUNT(id)'];
$ta1=$row30['COUNT(id)']+$row31['COUNT(id)'];
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"style="color:black;text-align:center;font-size:25px;font-weight:bold;"><strong>Absent(%)</strong></th>
	   ...
	   <tr>
      <th width="4%"style="color:Black;text-align:center;font-size:25px;font-weight:bold;"><strong></strong></th>
      <th width="17%"style="color:Green;text-align:center;font-size:25px;font-weight:bold;"><strong><?php echo'TOTAL' ;?></strong></th>
	  <th width="17%"style="color:Green;text-align:center;font-size:25px;font-weight:bold;"><strong><?php echo $row27['COUNT(id)'] ;?></strong></th>
	  <th width="17%"style="color:Green;text-align:center;font-size:25px;font-weight:bold;"><strong><?php echo $row28['COUNT(id)'] ;?></strong></th>
	  <th width="17%"style="color:Green;text-align:center;font-size:25px;font-weight:bold;"><strong><?php echo $row29['COUNT(id)'] ;?></strong></th>
	  <th width="17%"style="color:RED;text-align:center;font-size:25px;font-weight:bold;"><strong><?php echo $row30['COUNT(id)'] ;?></strong></th>
	  
      <th width="10%"style="color:RED;text-align:center;font-size:25px;font-weight:bold;"><strong><?php echo $row31['COUNT(id)'] ;?></strong></th>
	  <th width="10%"style="color:Green;text-align:center;font-size:25px;font-weight:bold;"><strong>		<?php 
...
if($tmp1 > 0){
       ...
       echo 0; // or whatever you want
		...
		?></strong></th>
	  <th width="10%"style="color:red;text-align:center;font-size:25px;font-weight:bold;"><strong><?php 
...
$sel_query="Select distinct dept from staff3 order by dept asc";
//$start=$row["aadate"];
$countz=1;
