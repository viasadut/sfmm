        ...
        <?php
            ...
            $mpdf->SetHTMLHeader('
                ...
                <table width="100%">
                    <tr>
                        <td width="23%"></td>
                        <td width="50%"><b><h2 align="laft">WEIGHT LOSS PROGRAM RECORD</h2> </b></td>
                        <td width="31%"><p align="right">Day Count: '.$data['day'].', <br>Date: '.$b.'</p></td>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        ...
                        <td width="70%" style="font-weight: bold !important;"><h2 align="laft"><b>'.$a_by.'</h2></b></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>'.$data3['degree'].'</td>
