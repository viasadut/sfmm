...
//lis data
$query_WBC = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='WBC' order by response_no_pk desc limit 1");
$data_WBC= mysqli_fetch_assoc($query_WBC);


$query_RBC = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='RBC' order by response_no_pk desc limit 1");
$data_RBC= mysqli_fetch_assoc($query_RBC);

$query_HGB = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='HGB' order by response_no_pk desc limit 1");
$data_HGB= mysqli_fetch_assoc($query_HGB);

$query_HCT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='HCT' order by response_no_pk desc limit 1");
$data_HCT= mysqli_fetch_assoc($query_HCT);

$query_MCV = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MCV' order by response_no_pk desc limit 1");
$data_MCV= mysqli_fetch_assoc($query_MCV);

$query_MCH = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MCH' order by response_no_pk desc limit 1");
$data_MCH= mysqli_fetch_assoc($query_MCH);

$query_MCHC = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MCHC' order by response_no_pk desc limit 1");
$data_MCHC= mysqli_fetch_assoc($query_MCHC);

$query_PLT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='PLT' order by response_no_pk desc limit 1");
$data_PLT= mysqli_fetch_assoc($query_PLT);

$query_NEUTP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='NEUT%' order by response_no_pk desc limit 1");
$data_NEUTP= mysqli_fetch_assoc($query_NEUTP);

$query_LYMPHP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='LYMPH%' order by response_no_pk desc limit 1");
$data_LYMPHP= mysqli_fetch_assoc($query_LYMPHP);

$query_MONOP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MONO%' order by response_no_pk desc limit 1");
$data_MONOP= mysqli_fetch_assoc($query_MONOP);

$query_EOP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='EO%' order by response_no_pk desc limit 1");
$data_EOP= mysqli_fetch_assoc($query_EOP);

$query_BASOP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='BASO%' order by response_no_pk desc limit 1");
$data_BASOP= mysqli_fetch_assoc($query_BASOP);

$query_NEUTT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='NEUT#' order by response_no_pk desc limit 1");
$data_NEUTT= mysqli_fetch_assoc($query_NEUTT);

$query_LYMPHT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='LYMPH#' order by response_no_pk desc limit 1");
$data_LYMPHT= mysqli_fetch_assoc($query_LYMPHT);

$query_MONOT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MONO#' order by response_no_pk desc limit 1");
$data_MONOT= mysqli_fetch_assoc($query_MONOT);

$query_EOT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='EO#' order by response_no_pk desc limit 1");
$data_EOT= mysqli_fetch_assoc($query_EOT);

$query_BASOT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='BASO#' order by response_no_pk desc limit 1");
$data_BASOT= mysqli_fetch_assoc($query_BASOT);

$query_IGP = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='IG%' order by response_no_pk desc limit 1");
$data_IGP= mysqli_fetch_assoc($query_IGP);

$query_IGT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='IG#' order by response_no_pk desc limit 1");
$data_IGT= mysqli_fetch_assoc($query_IGT);

$query_RDWSD = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='RDW-SD' order by response_no_pk desc limit 1");
$data_RDWSD= mysqli_fetch_assoc($query_RDWSD);

$query_RDWCV = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='RDW-CV' order by response_no_pk desc limit 1");
$data_RDWCV= mysqli_fetch_assoc($query_RDWCV);

$query_MICROR = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MICROR' order by response_no_pk desc limit 1");
$data_MICROR= mysqli_fetch_assoc($query_MICROR);

$query_MACROR = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MACROR' order by response_no_pk desc limit 1");
$data_MACROR= mysqli_fetch_assoc($query_MACROR);

$query_PDW = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='PDW' order by response_no_pk desc limit 1");
$data_PDW= mysqli_fetch_assoc($query_PDW);

$query_MPV = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='MPV' order by response_no_pk desc limit 1");
$data_MPV= mysqli_fetch_assoc($query_MPV);

$query_PLCR = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='P-LCR' order by response_no_pk desc limit 1");
$data_PLCR= mysqli_fetch_assoc($query_PLCR);

$query_PCT = mysqli_query($db,"select * from lab_machine_response where LAB_CODE='4801280076' and machine_ATTRIB='PCT' order by response_no_pk desc limit 1");
...
$ins_query1="insert into cbctbl (`pname`,`pmrn`,`pphone`,`psex`,`page`,`haemo`,`red`,`pcv`,`mcv`,`mch`,`mchc`,`rdw`,`pla`,`mpv`,`wbc`,`neu`,`lym`,`eos`,`mono`,`bas`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`,`esr`,`promyclocyte`,`metamyclocyte`,`myoblast`,`lymphoblast`,`nrbc`,`remarks`) values 
('$pname','$pmrn','$pphone','$psex','$page','$haemo','$red','$pcv','$mcv','$mch','$mchc','$rdw','$pla','$mpv','$wbc','$neu','$lym','$eos','$mono','$bas','$user','$adate','$eid','$iname','$id','$sno','$esr','$promyclocyte','$metamyclocyte','$myoblast','$lymphoblast','$nrbc','$remarks')";
...
document.getElementById('lym').onchange= f_color4;
      ...
      <span>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="mono" type="number" id="mono" style="font-weight: bold;font-size:22px;" value="<?php echo $data_MONO['machine_result'];?>"required step=".01">
...
<input name="esr" type="text" value=""required id="esr" style="font-weight: bold;font-size:22px;" step=".01">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-weight: bold;font-size:18px;color:red"> <?php echo $data_opd['esr'];?></strong>
</span>
<script>
function f_color(){
