...
function Header()
{
    ...
    $this->Cell(0,6,' Emergency Stat Medicine Order Sheet',0,1,'C');
...
$eid=$_REQUEST['eid'];
$dd=date('d/m/Y');
$query = mysqli_query($link,"SELECT * from estat where pmrn='$pmrn' and eid='$eid' " );
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select * from estat where pmrn='$pmrn' and eid='$eid' ",$prop);
$pdf->Output();
?>