...
$count=1;
$sel_query="Select * from cmea where sid= $sid order by `id` DESC;";
...
<td align="center"colspan="2"><a  target='_blank' href="percmedetails?id=<?php echo $row["id"]; ?>&sid=<?php echo $row["sid"]; ?>&topic=<?php echo $row['ctopic'];?>">Details</td>  		
