...
if($mno>$mno1){
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		...
		if($number_of_digits==1){
				...
				//echo '1';
			$lis = substr($_POST["chkDel"][$i], -2);
			$new_bar1=$lis.$two.date('d').'000'.$mno;
			$new_bar2=$lis.$two.date('d').'00'.$mno;
			$new_bar3=$lis.$two.date('d').'0'.$mno;
			$new_bar4=$lis.$two.date('d').$mno;
...
values ('XN_550', '66','$new_bar1','$new_bar1','$ii','$lis_date','44','$lis_date','55','88')";
...
$url = "lab_sample_receive_bar_new.php?barcode=$new_bar1&sno=$mno";
header("Location: $url"); 
			}
...
mysqli_query($con,$ins_lis1);
				...
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar2&sno=$mno";
header("Location: $url"); 
			}
...
mysqli_query($con,$ins_lis1);
				...
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar3&sno=$mno";
header("Location: $url"); 
...
mysqli_query($con,$ins_lis1);
				...
				$url = "lab_sample_receive_bar_new.php?barcode=$new_bar4&sno=$mno";
header("Location: $url"); 
			}
