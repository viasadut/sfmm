...
$ins_query1="insert into storenew_edit (`ename`,`iid`,`price`,`cprice`,`eid`,`finance`,`estatus`,`ceo`,`cfo`,`it`,`eid1`,`aby`,`adate`,`oprice`,`ittime1`,`md`) values 
('$ename','$id','$uprice','$cprice','$eid','338','Waiting For Finance Fowrading','ceo','cfo','322','$eid1','$user','$adate','$oprice','$ittime1','md')";
