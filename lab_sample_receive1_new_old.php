...
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
	...
	for($i=0;$i<count($_POST["chkDel"]);$i++)
	{
		if($_POST["chkDel"][$i] != "")
		{
			...
			$strSQL = "UPDATE alltest set rstatus='RECEIVED', status='RECEIVED', reby='$user', retime='$pdate' ,rdate='$pdate', barcode1='$result'";
...
?>
    ...
    <td colspan="4" align="left"><h3><input type="text" name="result[]" id="result<?php echo $i;?>" required readonly value="<?php echo $row['barcode1'];?>" style="font-size:20px; color:red;font-weight:bold;"></h3></td></td>
...
$objConnect = mysqli_connect("localhost","root","Godiloveu16") or die("Error Connect to Database");
$objDB = mysqli_select_db($objConnect,"sfmmkpjnew");
$strSQL = "Select * from alltest where pmrn= '$pmrn' and billstatus='Billed' and type='lab' and rstatus ='RECEIVED' and billdate='$dd'";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
?>
