...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','Store','pharmacy')"; 
...
if(empty($_REQUEST['update']))
{
    ...
    echo '</script>';
			...
			$qq = mysqli_query($db,"select * from purchase_stock where id='".$updateid."'");
...
$sel96="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store'  order by id asc limit 1;";
...
if($eqty5 >= $eqty2 and $mqty=='' and $mm_qty>=$eqty2 and $eqty2>0)
	...
	$ins_query3="update purchase_stock set `add_qty`='$m_qty1' where id='$mid' and location='Store'";
mysqli_query($con,$ins_query3) or die(mysql_error());



$strSQL1 = "update purchase_stock set status='Served',add_qty='$eqty2',given_qty='$eqty2',exdate='$exdate',u_price='$p_price',t_price='$u_price',batch_no='$bb_no',add_by='$user',add_time='$add_time' where id='".$updateid."'";
...
$ins_query3="update purchase_stock set `add_qty`='0' where id='$mid' and location='Store'";
mysqli_query($con,$ins_query3) or die(mysql_error());




			$sel97="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
//#2
			...
			{
			$ins_query4="update purchase_stock set `add_qty`='$second_qty' where id='$mid1' and location='Store'";
			...
			$ins_query4="update purchase_stock set `add_qty`='0' where id='$mid1' and location='Store'";
			mysqli_query($con,$ins_query4) or die(mysql_error());
				

$sel97b="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$third_qtyb' where id='$midb' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
...
else if($b_chk_7b['add_qty']<$second_qty1)
{
	...
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$midb' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
		

$sel97c="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$forth_qtyc' where id='$midc' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7c['add_qty']<$third_qtyb1)
{
	
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$midc' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
		

$sel97d="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$fifth_qtyd' where id='$midd' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7d['add_qty']<$forth_qtyc1)
{
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$midd' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97e="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$sixth_qtyd' where id='$mide' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7e['add_qty']<$fifth_qtyd1)
{
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$mide' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97f="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$seven_qtyd' where id='$midf' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7f['add_qty']<$sixth_qtyd1)
{
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$midf' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97g="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$eight_qtyd' where id='$midf' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
...
$sel97h="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$nine_qtyd' where id='$midh' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7h['add_qty']<$eight_qtyd1)
{
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$midh' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());

$sel97i="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by id asc limit 1;";
...
{
$ins_query4="update purchase_stock set `add_qty`='$ten_qtyd' where id='$midi' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());
}
else if($b_chk_7i['add_qty']<$nine_qtyd1)
{
	$ins_query4="update purchase_stock set `add_qty`='0' where id='$midi' and location='Store'";
mysqli_query($con,$ins_query4) or die(mysql_error());

/*$sel97i="SELECT * FROM purchase_stock WHERE `code`='$code_1' and add_qty>0 and location='Store' order by exdate asc limit 1;";
$result97i = mysqli_query($con,$sel97i);
$b_chk_7i=mysqli_fetch_assoc($result97i);
$rfid1i=$b_chk_7i['rfid'];
$ten_qtyd=$b_chk_7i['add_qty']-$eight_qtyd1;
...
<tr>
	  ...
	  <td colspan="7" align="center"><strong>Instruction</strong></td>
	    ...
	    <?php 
                    $query = "select * from purchase_stock where sno='$sno' and req_loc='$req_loc' and status='Pending'";
