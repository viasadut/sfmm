...
else if($tb_result['tb_op']=='')
{
  ...
  $check_visit = "SELECT COUNT(id) FROM icnote where user='$dname' and pmrn='$pmrn' and eid='$eid' and daten='$daten'"; 
...
$count=$check_data['COUNT(id)'];
  ...
  values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$inves','$infu','$pnote','$dname','Data Updated','Doctor','$charge','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','$user')";
    ...
    values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$inves','$infu','$pnote','$dname','Data Updated','Doctor','$charge','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','$user')";
      ...
      $sql = "insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`,`dcode`,`ccode`,`ip`,`op`,`app_con`,`ccentre`,`cstatus`,`user_e`) 
      values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$inves','$infu','$pnote','$dname','Data Updated','Doctor','$charge','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','Closed','$user')";
      }
    ...
    values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$inves','$infu','$pnote','$dname','Data Updated','Doctor','900','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','$user')";
      ...
      values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$inves','$infu','$pnote','$dname','Data Updated','Doctor','900','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','$user')";
        ...
        $sql = "insert into icnote (`pmrn`,`eid`,`pname`,`padd`,`page`,`padmission`,`pgender`,`pphone`,`odate`,`inves`,`infusion`,`pnote`,`user`,`status`,`ugroup`,`charge`,`vtype`,`daten`,`entry_time`,`dcode`,`ccode`,`ip`,`op`,`app_con`,`ccentre`,`cstatus`,`user_e`) 
        values ( '$pmrn','$eid','$pname','$padd','$page','$adm','$psex','$pphone','$odate','$inves','$infu','$pnote','$dname','Data Updated','Doctor','900','$time','$daten','$entry_time','$dcode','$code','$ip','$op','$app_con','$ccentre','Closed','$user')";
        }
