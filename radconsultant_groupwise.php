...
$count=1;
$sel_query="Select COUNT(id),type,code from radreport where dname='$bt' and rdate BETWEEN '$start' and '$end' group by type;";
...
<td align="center"><?php echo $row["code"]; ?> 	  
      <td align="center"><?php echo $row['COUNT(id)']; ?></td>
    ...
    <?php $count++; } }?>
	  ...
	  <td colspan ="7" align="right"><a target='_blank' href="rad_con_excel_g?date=<?php echo "$start"; ?>&date1=<?php echo "$end"; ?>&dname=<?php echo "$bt"; ?>">Download In Excel</a></td>	      
  </tbody>
</table>
