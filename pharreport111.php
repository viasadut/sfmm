...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Investigation Advised(LAB):',1,1,'L');
$pdf->SetFont('Arial' , '' , 10);
...
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->Cell('182',5,'Investigation Advised(Radiology):',1,1,'L');
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['xl2'],1,1);
...
$pdf->SetFont('Arial' , '' , 10);
$pdf->MultiCell('182' , 5,$data['reffer']."-".$data['pdiet2'].", ".$data['reffer2']."-".$data['pdiet3'].", ".$data['reffer3']."-".$data['pdiet4'].", ".$data['reffer4']."-".$data['pdiet5'].", ".$data['reffer5']."-".$data['pdiet6'].", ".$data['reffer6']."-".$data['pdiet7'],1,1);
