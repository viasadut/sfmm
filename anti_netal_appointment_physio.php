...
('$name', '$pmrn','$pphone','$padd','$doc1','$date_nn1','$slot','NOT SEEN','$diff1','$psex','$user','$diff2','$date91','$dis','$aatime','$date_nn','Anti_netal_physio','BILLED','$user','$aatime','$ptype')";
//mysqli_query($con,$ins_query) or die(mysql_error());

if(mysqli_query($con,$ins_query)==true){
	
	
	$query44 = "SELECT * FROM pappnew where pmrn='$pmrn' and adate='$date_nn1' and page1='Anti_netal_physio'"; 
