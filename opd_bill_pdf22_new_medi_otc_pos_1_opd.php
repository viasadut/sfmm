...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(id) FROM phar_sale WHERE location='OPD' and billno='$billno'"));
...
$strSQL = "Select * from phar_sale where billno='$billno' and location='OPD' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");

$strSQL1 = "Select * from phar_sale where billno= '$billno' and location='OPD'  order by `id` desc;";
