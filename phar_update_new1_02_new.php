...
$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('staff','pharmacy02','pharmacy')"; 
...
if($eqty5 >= $eqty2 and $mqty=='' and $mm_qty>=$eqty2 and $eqty2>0)
	...
	$strSQL2 = "insert into phar_sale(`medi`,`qty`,`uprice`,`tprice`,`aby`,`adate`,`sno`,`brand`,`ins`,`location`,`code`,`pmrn`,`pname`,`rfid`) values
			('$medi_1','$eqty2','$p_price','$u_price','$user','$adate','$sno','$brand','$ins','OPD-2nd Fl Pharmacy','$code_1','$p_mrn','$p_name','$rf')";
