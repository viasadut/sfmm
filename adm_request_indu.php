...
<p align="center" class="style1">List of Admission Request</p>
...
<table width="100%" height ="100%" border="1" align="center" bgcolor="#FFFF99" style="border-collapse:collapse;">
    ...
    <tr>
	  ...
	  <th width="10%"><strong>Phone No</strong></th>
...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from preadm where tstatus='Approved' and snew between '$test' and '$test1' and dname='$full' order by snew desc;";
...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      <td align="center"><?php echo $row["sda"]; ?>  </td>
	  ...
	  <td align="center" style="color:red;font-size:20px;font-weight:bold"><?php echo $row["status"]; ?> </td>
	  	  <td><a target='_blank' href="admdoc_indu.php?pmrn=<?php echo $row['pmrn']; ?>&id=<?php echo $row['id']; ?>">Print</a></td>
