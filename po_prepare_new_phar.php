...
"jsnew/select2.min.css" />
	   ...
	   <option value='Cash'>Cash</option>
		...
		<tr>				
						...
						<select name="sup_code" class="sup_code" required style="font-weight: bold;font-size:14px;color:green" id="sup_code" onchange="GetDetail(this.value)"> 
...
"jsnew/select2.min.css" />					
  ...
  <tr>
		...
		<tr>				
						<td colspan="5" hidden><input type="text" name="auth_person" id="location"  value="" style="font-weight: bold;font-size:14px;color:green"></td>
		...
		<tr>				
						<td colspan="5" hidden><input type="date" name="po_date" id="location"  value="<?php echo $date;?>" style="font-weight: bold;font-size:14px;color:green"></td>
