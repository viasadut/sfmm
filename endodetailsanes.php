...
<td colspan="4" align="center"><button type="submit" name="Submit111">PAC</butto</td>
<td colspan="4" align="center"><button type="submit" name="Submit99">Intra Procedual Document</button></td>
<td colspan="4" align="center"><button type="submit" name="Submit">Post Procedure Order</button></td>
<td colspan="4" align="center"><button type="submit" name="Submit">Histo Request</butto</td>
