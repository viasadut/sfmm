...
$date= date('m/d/Y');
$count=1;
$sel_query="Select * from mcertificate where staff='Staff' and fdate='$date' or tdate='$date'";
//$start=$row["aadate"];
...
<td align="center"><a onclick="return confirm_click();" href="leaveapprove1?id=<?php echo $row["id"]; ?>&uname=<?php echo $row["uname"]; ?>&type=<?php echo $row["type"]; ?>&bal=<?php echo $row["bal"]; ?>"><strong>Confirm</strong></a></td>
