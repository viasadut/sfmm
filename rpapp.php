...
$ins_query="insert into radpapp (`pname`,`pmrn`,`pphone`,`padd`,`dname`,`adate`,`aslot`,`status`,`page`,`psex`) values ('$name', '$pmrn','$pphone','$padd','$dname','$date1','$slot','NOT SEEN','$page','$psex')";
...
?>" size ="57" >
      ...
      <input name="name" type="text" size="70" class="style1" >
 	  <label for="age"><strong>Patient's ADDRESS :</strong></label>
      <input name="padd" type="text" size="70" class="style1">
	  ...
	  <input name="page" type="text" size="5"Placeholder="Patient's AGE" class="style1">
