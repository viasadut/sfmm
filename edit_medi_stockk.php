...
<?php 
   session_start();
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('nurse','emergency','ot','cath','endo','opdpro','pharmacy')"; 
...
$ins_query2="update medi_stock set `g_name`='$g_name',`b_name`='$b_name', `code`='$code', `exdate`='$exdate', `remarks`='$remarks', `code`='$code', `add_qty`='$add_qty', `p_stock`='$add_qty', `batch_no`='$batch_no', `p_by`='$user' where id='$id'";
