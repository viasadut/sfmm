...
."<br />".'Rapid Progressive Motility:'.$rpm."<br />".'Slow or Sluggish forward progression:'.$sfp."<br />".'Non Progressive Motility:'.$npm."<br />".'Immotile Sperm:'.$iss."<br />".'Normal form Sprem:'.$nfss."<br />".'Head Defect Sperm:'.$hds."<br />".'Neck or Midpiece defect sprem:'.$nmdf.
"<br />".'Tail Defect Sperm:'.$tds."<br />".'Immature Sperm:'.$ims."<br />".'Red Blood Cell(RBC), Seminal Fluid:'.$rbcf.
"<br />".'White Blood Cell(WBC), Seminal Fluid:'.$wbcsf."<br />".'Epithelial Cells, Seminal Fluid:'.$ecsf.
...
$ins_query1="insert into semen (`pname`,`pmrn`,`pphone`,`psex`,`page`,`ap`,`vo`,`vis`,`sc`,`sm`,`rpm`,`sfp`,`npm`,`iss`,`nfss`,`hds`,`nmdf`,`tds`,`ims`,`sv`,`rbcf`,`ecsf`,`wbcsf`,`cdsf`,`sasf`,`inter`,`advice`,`uby`,`udate`,`eid`,`iname`,`inid`,`sno`) values 
('$pname','$pmrn','$pphone','$psex','$page','$ap','$vo','$vis','$sc','$sm','$rpm','$sfp','$npm','$iss','$nfss','$hds','$nmdf','$tds','$ims','$sv','$rbcf','$ecsf','$wbcsf','$cdsf','$sasf','$inter','$advice','$user','$adate','$eid','$iname','$id','$sno')";
...
<!-- Form Title -->
      ...
      <input name="ap" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>Volume, Seminal Fluid:</strong></label>
      <input name="vo" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>Viscosity, Seminal Fluid:</strong></label>
      <input name="vis" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>Sperm Count, Seminal Fluid:</strong></label>
      <input name="sc" type="text" size="70" style="text-transform:uppercase" value=""required>
	  <label for="age"><strong>Total Motility:</strong></label>
      <input name="sm" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  
	  <label for="age"><strong>Rapid Progressive Motility:</strong></label>
      <input name="rpm" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Slow Or Sluggish Forward Progression:</strong></label>
      <input name="sfp" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Non-Progressive Motility:</strong></label>
      <input name="npm" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  
	  <label for="age"><strong>Immotile Sperm:</strong></label>
      <input name="iss" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  
	  <label for="age"><strong>Normal Form Sprem:</strong></label>
      <input name="nfss" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Head Defect Sperm:</strong></label>
      <input name="hds" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Neck or Midpiece defect sperm:</strong></label>
      <input name="nmdf" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Tail Defect Sperm:</strong></label>
      <input name="tds" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Immature Sperm:</strong></label>
      <input name="ims" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Sprem Viability:</strong></label>
      <input name="sv" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Red Blood (RBC), Seminal Fluid:</strong></label>
      <input name="rbcf" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Epithelial Cells, Seminal Fluid:</strong></label>
      <input name="ecsf" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>White Blood Cell(WBC), Seminal Fluid:</strong></label>
      <input name="wbcsf" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Cellular Debris, Seminal Fluid:</strong></label>
      <input name="cdsf" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Sperm Agglutination, Seminal Fluid:</strong></label>
      <input name="sasf" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Interpretation:</strong></label>
      <input name="inter" type="text" size="70" style="text-transform:uppercase" value=""required>
	  
	  <label for="age"><strong>Advice:</strong></label>
      <input name="advice" type="text" size="70" style="text-transform:uppercase" value=""required>
