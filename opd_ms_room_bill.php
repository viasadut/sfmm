...
$row44=mysqli_fetch_assoc(mysqli_query($db,"SELECT COUNT(id) FROM m_suite WHERE billno='$billno'"));
...
$strSQL = "Select * from m_suite where billno='$billno' order by `id` desc;";
$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");

$strSQL1 = "Select * from m_suite where billno= '$billno' order by `id` desc;";
...
$strSQL15 = "Select * from m_suite where billno= '$billno' order by `id` desc;";
...
<br><br><br>
                ...
                <td style="font-family: freesans; text-align:right;font-size:16px;" width="30%"><b>Grand Total:'.$row435['amount_receive'].'</b>
                </td>';
                }
