...
$sel="SELECT * FROM alltest where pmrn= '$pmrn' and type='spd1' and medi='ECG' and status='' and date1='$datenew';"; 
...
if($res3=mysqli_num_rows($result)>0)
{
    ...
    echo 'alert("Unsuccessful !!The patient Already Have pending ECG Request"); ';
    echo '</script>';
    }
...
values('$dname','$select','$pmrn','$pname','$page','$psex','$pphone','$ron','$vent','$qwave','$arate','$st','$rhy','$twave','$pwave','$qt','$pr','$qtc','$qrs','$uwave','$qrsc','$ebeats','$qrsvol','$others','$eaxis','$poro','$comments','$count1','$date1','$date2','$stime','Updated','Manual','$datenew')";
...
<tr>
					 ...
					 <td colspan="5"><input type="text" name="poro"  value=""></td>
						...
						<tr><td colspan="20"><label><strong>Comments / Observation / Remarks:</strong></label></td>  </tr>
						 <tr><td  colspan="20"align="center"><input list="browsers11" name="comments" class="form-control" value='Normal ECG'required>
