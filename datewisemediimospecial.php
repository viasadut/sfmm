...
$count=1;
$sel_query="Select * from istret where pmrn= '$pmrn' and eid='$eid' and odate BETWEEN '$start' and '$end';";
...
{ ?>    <tr>
	  ...
	  <td align="center" colspan="1"><a onclick="return confirm_click1();" href="imoinmeditomorrowspecial?pmrn=<?php echo $row["pmrn"]; ?>&eid=<?php echo $row["eid"]; ?>&infusion=<?php echo $row["infusion"]; ?>&instruc=<?php echo $row["dtime"]; ?>&rtime=<?php echo $row["rtime"]; ?>&orderby=<?php echo $user; ?>">ADD</a></td>  	  
      </tr>
