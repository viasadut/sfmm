...
<div class="container">
    ...
    <form action="consentupload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
			...
			$sel_query="Select * from consent_form where pmrn='$pmrn';";
            ...
            ?>
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    ...
                    <form action="consent_delete.php" method="POST">
