...
$row1 = mysqli_fetch_assoc($re);
	  ...
	  <td align="center"><a href="phar_update_02?pmrn=<?php echo $row["pmrn"]; ?>&dname=<?php echo $row["dname"]; ?>&eid=<?php echo $row["eid"]; ?>&sno=<?php echo $runningTime+$row['pmrn']+$row['eid'];?>">UPDATE</a></td>
