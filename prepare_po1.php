...
<!-- Form Title -->
	  ...
	  <label for="age"><strong>Code:</strong></label>
	  			 ...
	  			 <input type="text" class="country" list="eee" autocomplete="off" name='code' required style="font-weight: bold;font-size:22px;color:green" id="pmrn" onkeyup="GetDetail(this.value)">
...
<label for="age"><strong>Brand Name:</strong></label>						
		...
		<label for="mail"><strong>Approved Vendor:</strong></label>
									<p>
