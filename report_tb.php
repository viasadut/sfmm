...
<tr>
      ...
      <td align="center"><strong>Account Name</strong></td>
	    ...
	    <?php 
                    $query = "Select * from pms_tb where date='2025-12-21' group by acct_code";
                        ...
                        if($acct_group=='0')
{
                        ...
                        else if($data22['acct_type']=='A' || $data22['acct_type']=='R' || $data22['acct_type']=='E' and $dr>0 and $cr>0)
                        {
                          ...
                          $value=$data1['SUM(amount)']-$data2['SUM(amount)'];
                        }

                        else if($data22['acct_type']=='A' || $data22['acct_type']=='R' || $data22['acct_type']=='E' and $dr>0 and $cr=='0')
                        {

                          $value1=$data1['SUM(amount)'];
                        }

                        else if($data22['acct_type']=='A' || $data22['acct_type']=='R' || $data22['acct_type']=='E' and $dr=='0' and $cr>0)
                        {

                          $value2=$data2['SUM(amount)'];
                        }

                        else if($data22['acct_type']=='L')
{
                          $value3=$data2['SUM(amount)']-$data1['SUM(amount)'];
                        }
