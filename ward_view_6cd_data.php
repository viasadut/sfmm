...
<tr>
		...
		<strong>6th Floor C Block - <span style='color:red'>".$rw6['COUNT(id)']." Patients</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
		...
		<strong>6th Floor C Block - <span style='color:red'>".$rw6['COUNT(id)']." Patient</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;
		<img src='kpj_logo/1.png' style='width:60px;height:40px;'>
...
$n1=$data_baby1['beid'];
 ...
 echo"
  ...
  echo "<td colspan='2' style='background-color:#eed7a1;font-size:14px;font-weight:bold'>" . $row['adate'] . "</td>";
...
<tr>
		...
		<strong>6th Floor D Block - <span style='color:red'>".$rw66['COUNT(id)']." Patients</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;
		<img src='kpj_logo/1.png' style='width:60px;height:40px;'>
...
<tr>
		...
		<strong>6th Floor D Block - <span style='color:red'>".$rw66['COUNT(id)']." Patient</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;
		<img src='kpj_logo/1.png' style='width:60px;height:40px;'>
