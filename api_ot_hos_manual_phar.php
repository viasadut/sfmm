...
$query39 = "SELECT * FROM othoscharge where id= '$id'"; 
...
$data = array(
  ...
  $invoice_no=$decoded_response['invoice_id'];
   ...
   if($decoded_response['invoice_no']!='' and $decoded_response['invoice_id']!=''){
    ...
    $ins_query="UPDATE othoscharge SET api_status='1', invoice_no='$invoice_no' WHERE id='$id'";
 ...
 header("Location:inpatient_api_phar?pmrn=$pmrn&eid=$eid_in");
 }
