...
('$pmrn', '$eid', 'IPD_DIS_RETURN', '$return_amount', $dis_amount, $return_amount, '$appdate', '$apptime', '$user', '$ipd', '$location','$mno', '$vehicle1', '$due_remarks','$pid','$b_remarks')";
...
$eqty44=$eqty2+$rqty;			
$refund_qty=$eqty44-$rqty;			
$refund_total=$chk_row['tprice']-($refund_qty*$sale_price);			
...
$strSQL2221 = "update medi_stock set add_qty='$medi_stock_qty' where id='$medi_stock_id'";
			...
			$strSQL222 = "update phar_sale set r_qty='$eqty44',tprice='$refund_total' where id='$phar_sale_id'";
			//$strSQL .="WHERE id = '".$_POST["chkDel"][$i]."' ";
...
header("Location: refund_phar_bill_pdf_ipd.php?adate1=$adate1&pmrn=$pmrn&dname=$dname&refundno=$last_id&billno=$pid&eid=$eid");			
