...
`advice`='$advice',`etime`='$adate1',`email`='$email',`eby`='$user',`sam`='$sam',`tp`='$tp',`lid`='$lid',bgroup='$bgroup' where id='$id'";
...
<input type="text" name="rdate" id="datepicker6" placeholder="Select Date" size="15" value="<?php if($row39['rdate']=='1970-01-01' ||$row39['rdate']== '0000-00-00'){echo '';} else {echo date('m/d/Y',strtotime($row39['rdate']));}?>">
