<?php 
	...
	$queryc = "SELECT COUNT(utype) FROM user where '$role' in ('doctor','nurse','imo','mng')"; 
...
$data49 = mysqli_fetch_assoc($db,$query49);
$i1=$data49['rr1'];
$i2=$data49['rr2'];
$i3=$data49['rr3'];
$i4=$data49['rr4'];
...
$result98 = mysqli_query($dbhandle,$query98) or die(mysqli_error());

// Print out result
while($row98 = mysqli_fetch_array($result98)){
...
// Print out result
while($row198 = mysqli_fetch_array($result198)){
...
mysqli_query($con,$ins_query66) or die(mysqli_error());
echo '<script language="javascript">';
...
('$rr1','Intake','$rr3','$rr2','$rr4','$pmrn','$user','$eid','Output','$rr6','$rr5','$date1','$time1')";
...
$result98 = mysqli_query($dbhandle,$query98) or die(mysql_error());
...
// Print out result
$row398 = mysqli_fetch_array($dbhandle,$result398);
