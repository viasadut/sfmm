...
`rbc`,`wbc`,`hyaline_c`,`granular_c`,`cal_ox`,`uric_acid`,`triple_phosphate`,`c_others`,`comment`,`color`) values 
...
'$rbc','$wbc','$hyaline_c','$granular_c','$cal_ox','$uric_acid','$triple_phosphate','$c_others','$comment','$color')";
