...
$pdf->ln(2);
$pdf->SetFont('Arial' , 'b' , 12);
$pdf->Cell('20',5,'Pulmonary Vein:',0,1,'L');
$pdf->SetFont('Arial' , '' , 9);
$pdf->Cell('18',5,'A-duration:',1,0,'L');
$pdf->Cell('25',5,$data['aduration'].' m/sec',1,0,'L');

$pdf->Cell('15',5,'SV/DV:',1,0,'L');
$pdf->Cell('25',5,$data['srdv'].' cm/sec',1,0,'L');

$pdf->Cell('10',5,'ARV:',1,0,'L');
$pdf->Cell('25',5,$data['apv'].' cm/sec',1,0,'L');

$pdf->Cell('40',5,'A dur (MVA du-PVA du):',1,0,'L');
$pdf->Cell('25',5,$data['apv'].' mmHg',1,1,'L');
...
$pdf->Cell('30',5,'Wall Motion:',0,0,'L');
$pdf->SetFont('Arial' , 'b' , 10);
$pdf->MultiCell('100',5,$data['wall'],0,1);
