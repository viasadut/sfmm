...
$query4 = mysqli_query($db,"select * from cathreport where pmrn='$pmrn' and eid='$eid'");
...
values('$dname','$select','$pmrn','$pname','$page','$psex','$pphone','$ron','$vent','$qwave','$arate','$st','$rhy','$twave','$pwave','$qt','$pr','$qtc','$qrs','$uwave','$qrsc','$ebeats','$qrsvol','$others','$eaxis','$poro','$comments','$count1','$date1','$date2','$stime')";
...
<tr>				<td colspan="10"><input type="text" name="pmrn"  required value="<?php echo $pm;?>" readonly/></td>
	...
	<tr><td colspan="20"bgcolor='lightgreen'align="center"><label><strong>ELECTROCARDIOGRAPHY REPORT</label></strong></td></tr>				 
					 ...
					 <tr><td><strong>PROCEDURES PERFORMED:</strong></td>
      <td colspan="3" align="center"><input type="text" name="pphone" required value="<?php echo $data['pperform']?>"></td></tr>
	  
	   <tr><td><strong>INDICATIONS FOR PROCEDURE:</strong></td>
      <td colspan="3" align="center"><input type="text" name="pphone" required value="<?php echo $data['iprocedure']?>"></td></tr>
	  
	   <tr><td><strong>TECHNIQUE OF PROCEDURE:</strong></td>
      <td colspan="3" align="center"><input type="text" name="pphone" required value="<?php echo $data['tprocedure']?>"></td></tr>
	  
	   <tr><td><strong>ANTICOAGULATION & OTHER MED :</strong></td>
      <td colspan="3" align="center"><input type="text" name="pphone" required value="<?php echo $data['anti']?>"></td></tr>
	  
	   <tr><td><strong>PROCEDURE FINDINGS :</strong></td>
      <td colspan="3" align="center"><input type="text" name="pphone" required value="<?php echo $data['pfind']?>"></td></tr>
	  
	   <tr><td><strong>CONCLUSIONS : </strong></td>
      <td align="center" value=""><input type="text" name="pphone" required value="<?php echo $data['con']?>"></td></tr>
	  
	   <tr><td><strong>PLAN :</strong></td>
      <td colspan="3" align="center"><input type="text" name="pphone" required value="<?php echo $data['plan']?>"></td></tr>
